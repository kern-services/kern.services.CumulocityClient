...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "authConfig_signatureVerificationConfig_aad")]
    public partial class AuthConfigSignatureVerificationConfigAad : IEquatable<AuthConfigSignatureVerificationConfigAad>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthConfigSignatureVerificationConfigAad" /> class.
        /// </summary>
        /// <param name="publicKeyDiscoveryUrl">URL used to retrieve the public key used for signature verification..</param>
        public AuthConfigSignatureVerificationConfigAad(string publicKeyDiscoveryUrl = default(string))
        {
        ...
        /// </summary>
        /// <value>URL used to retrieve the public key used for signature verification.</value>
        [DataMember(Name = "publicKeyDiscoveryUrl", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  PublicKeyDiscoveryUrl: ").Append(PublicKeyDiscoveryUrl).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as AuthConfigSignatureVerificationConfigAad);
        }

        /// <summary>
        /// Returns true if AuthConfigSignatureVerificationConfigAad instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthConfigSignatureVerificationConfigAad to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthConfigSignatureVerificationConfigAad input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.PublicKeyDiscoveryUrl == input.PublicKeyDiscoveryUrl ||
                    (this.PublicKeyDiscoveryUrl != null &&
                    this.PublicKeyDiscoveryUrl.Equals(input.PublicKeyDiscoveryUrl))
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.PublicKeyDiscoveryUrl != null)
                {
                    hashCode = (hashCode * 59) + this.PublicKeyDiscoveryUrl.GetHashCode();
                }
                return hashCode;
            }
        }
