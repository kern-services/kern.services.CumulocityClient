...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DevicePermissionOwners")]
    public partial class DevicePermissionOwners : IEquatable<DevicePermissionOwners>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DevicePermissionOwners" /> class.
        /// </summary>
        /// <param name="users">users.</param>
        /// <param name="groups">groups.</param>
        public DevicePermissionOwners(List<User> users = default(List<User>), List<Group> groups = default(List<Group>))
        {
            this.Users = users;
            this.Groups = groups;
        }
        ...
        {
            return this.Equals(input as DevicePermissionOwners);
        }

        /// <summary>
        /// Returns true if DevicePermissionOwners instances are equal
        /// </summary>
        /// <param name="input">Instance of DevicePermissionOwners to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DevicePermissionOwners input)
        {
            if (input == null)
            {
                return false;
