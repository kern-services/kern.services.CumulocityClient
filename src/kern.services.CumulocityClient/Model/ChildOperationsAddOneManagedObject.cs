...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "childOperationsAddOne_managedObject")]
    public partial class ChildOperationsAddOneManagedObject : IEquatable<ChildOperationsAddOneManagedObject>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ChildOperationsAddOneManagedObject" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ChildOperationsAddOneManagedObject() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ChildOperationsAddOneManagedObject" /> class.
        /// </summary>
        /// <param name="id">Unique identifier of the object. (required).</param>
        public ChildOperationsAddOneManagedObject(string id = default(string))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for ChildOperationsAddOneManagedObject and cannot be null");
            }
            this.Id = id;
        }
        ...
        {
            return this.Equals(input as ChildOperationsAddOneManagedObject);
        }

        /// <summary>
        /// Returns true if ChildOperationsAddOneManagedObject instances are equal
        /// </summary>
        /// <param name="input">Instance of ChildOperationsAddOneManagedObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChildOperationsAddOneManagedObject input)
        {
            if (input == null)
            {
                return false;
