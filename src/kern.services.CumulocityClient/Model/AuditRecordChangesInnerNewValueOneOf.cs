...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "auditRecord_changes_inner_newValue_oneOf")]
    public partial class AuditRecordChangesInnerNewValueOneOf : IEquatable<AuditRecordChangesInnerNewValueOneOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditRecordChangesInnerNewValueOneOf" /> class.
        /// </summary>
        /// <param name="cpu">Number of CPUs or CPU time limit..</param>
        /// <param name="memory">Memory usage limit..</param>
        public AuditRecordChangesInnerNewValueOneOf(string cpu = default(string), string memory = default(string))
        {
            this.Cpu = cpu;
            this.Memory = memory;
        }
        ...
        /// </summary>
        /// <value>Number of CPUs or CPU time limit.</value>
        ...
        /// Memory usage limit.
        /// </summary>
        /// <value>Memory usage limit.</value>
        ...
        {
            return this.Equals(input as AuditRecordChangesInnerNewValueOneOf);
        }

        /// <summary>
        /// Returns true if AuditRecordChangesInnerNewValueOneOf instances are equal
        /// </summary>
        /// <param name="input">Instance of AuditRecordChangesInnerNewValueOneOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuditRecordChangesInnerNewValueOneOf input)
        {
            if (input == null)
            {
                return false;
