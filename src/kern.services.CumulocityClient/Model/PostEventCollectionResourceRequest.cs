...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "postEventCollectionResource_request")]
    public partial class PostEventCollectionResourceRequest : IEquatable<PostEventCollectionResourceRequest>, IValidatableObject
    {
        ...
        public PostEventCollectionResourceRequest(Object source = default(Object), string text = default(string), DateTime time = default(DateTime), string type = default(string))
        {
            ...
            if (source == null)
            {
                throw new ArgumentNullException("source is a required property for PostEventCollectionResourceRequest and cannot be null");
            }
            this.Source = source;
            // to ensure "text" is required (not null)
            if (text == null)
            {
                throw new ArgumentNullException("text is a required property for PostEventCollectionResourceRequest and cannot be null");
            }
            this.Text = text;
            this.Time = time;
            ...
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for PostEventCollectionResourceRequest and cannot be null");
            }
            this.Type = type;
        }
