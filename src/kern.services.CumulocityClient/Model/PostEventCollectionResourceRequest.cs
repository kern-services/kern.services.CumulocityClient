...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PostEventCollectionResourceRequest :  IEquatable<PostEventCollectionResourceRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostEventCollectionResourceRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostEventCollectionResourceRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostEventCollectionResourceRequest" /> class.
        /// </summary>
        /// <param name="source">source (required).</param>
        /// <param name="text">Description of the event. (required).</param>
        /// <param name="time">The date and time when the event is updated. (required).</param>
        /// <param name="type">Identifies the type of this event. (required).</param>
        public PostEventCollectionResourceRequest(Object source = default(Object), string text = default(string), DateTime time = default(DateTime), string type = default(string))
        {
            // to ensure "source" is required (not null)
            if (source == null)
            {
                throw new InvalidDataException("source is a required property for PostEventCollectionResourceRequest and cannot be null");
            }
            else
            {
                this.Source = source;
            ...
            if (text == null)
            {
                throw new InvalidDataException("text is a required property for PostEventCollectionResourceRequest and cannot be null");
            }
            else
            {
                this.Text = text;
            ...
            if (time == null)
            {
                throw new InvalidDataException("time is a required property for PostEventCollectionResourceRequest and cannot be null");
            }
            else
            {
                this.Time = time;
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for PostEventCollectionResourceRequest and cannot be null");
            }
            else
            {
                this.Type = type;
        ...
        /// </summary>
        /// <value>The date and time when the event was created.</value>
        ...
        /// </summary>
        /// <value>The date and time when the event was last updated.</value>
        ...
        /// </summary>
        /// <value>The date and time when the event is updated.</value>
        ...
        /// </summary>
        /// <value>Identifies the type of this event.</value>
        ...
        {
            return this.Equals(input as PostEventCollectionResourceRequest);
        }

        /// <summary>
        /// Returns true if PostEventCollectionResourceRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PostEventCollectionResourceRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostEventCollectionResourceRequest input)
        {
            if (input == null)
                return false;
