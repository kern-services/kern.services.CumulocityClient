...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "putEventResource_request")]
    public partial class PutEventResourceRequest : IEquatable<PutEventResourceRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PutEventResourceRequest" /> class.
        /// </summary>
        /// <param name="text">Description of the event..</param>
        public PutEventResourceRequest(string text = default(string))
        {
            this.Text = text;
        }
        ...
        {
            return this.Equals(input as PutEventResourceRequest);
        }

        /// <summary>
        /// Returns true if PutEventResourceRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PutEventResourceRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PutEventResourceRequest input)
        {
            if (input == null)
            {
                return false;
