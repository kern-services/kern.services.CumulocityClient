...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// NewDeviceRequest
    /// </summary>
    [DataContract(Name = "newDeviceRequest")]
    public partial class NewDeviceRequest : IEquatable<NewDeviceRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NewDeviceRequest" /> class.
        /// </summary>
        /// <param name="id">External ID of the device..</param>
        /// <param name="status">Status of this new device request..</param>
        public NewDeviceRequest(string id = default(string), StatusEnum? status = default(StatusEnum?))
        {
            this.Id = id;
            this.Status = status;
        }
        ...
        {
            return this.Equals(input as NewDeviceRequest);
        }

        /// <summary>
        /// Returns true if NewDeviceRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of NewDeviceRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewDeviceRequest input)
        {
            if (input == null)
            {
                return false;
