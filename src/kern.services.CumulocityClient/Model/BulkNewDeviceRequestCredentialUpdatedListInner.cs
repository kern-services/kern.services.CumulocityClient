...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "bulkNewDeviceRequest_credentialUpdatedList_inner")]
    public partial class BulkNewDeviceRequestCredentialUpdatedListInner : IEquatable<BulkNewDeviceRequestCredentialUpdatedListInner>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BulkNewDeviceRequestCredentialUpdatedListInner" /> class.
        /// </summary>
        ...
        public BulkNewDeviceRequestCredentialUpdatedListInner(BulkNewDeviceStatusEnum? bulkNewDeviceStatus = default(BulkNewDeviceStatusEnum?), string deviceId = default(string))
        {
        ...
        {
            return this.Equals(input as BulkNewDeviceRequestCredentialUpdatedListInner);
        }

        /// <summary>
        /// Returns true if BulkNewDeviceRequestCredentialUpdatedListInner instances are equal
        /// </summary>
        /// <param name="input">Instance of BulkNewDeviceRequestCredentialUpdatedListInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BulkNewDeviceRequestCredentialUpdatedListInner input)
        {
            if (input == null)
            {
                return false;
