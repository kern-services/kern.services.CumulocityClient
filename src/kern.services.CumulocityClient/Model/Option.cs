...
namespace kern.services.CumulocityClient.Model
{
    ...
    public partial class Option : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="category">Name of the option category..</param>
        /// <param name="key">A unique identifier for this option..</param>
        /// <param name="value">Value of this option..</param>
        public Option(string category = default(string), string key = default(string), string value = default(string))
        {
