...
{
    /// <summary>
    /// GetManagedObjectChildAssetResource200ResponseAllOf
    /// </summary>
    [DataContract(Name = "getManagedObjectChildAssetResource_200_response_allOf")]
    public partial class GetManagedObjectChildAssetResource200ResponseAllOf : IEquatable<GetManagedObjectChildAssetResource200ResponseAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetManagedObjectChildAssetResource200ResponseAllOf" /> class.
        /// </summary>
        /// <param name="self">self.</param>
        public GetManagedObjectChildAssetResource200ResponseAllOf(Object self = default(Object))
        {
            this.Self = self;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetManagedObjectChildAssetResource200ResponseAllOf {\n");
        ...
        {
            return this.Equals(input as GetManagedObjectChildAssetResource200ResponseAllOf);
        }

        /// <summary>
        /// Returns true if GetManagedObjectChildAssetResource200ResponseAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of GetManagedObjectChildAssetResource200ResponseAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetManagedObjectChildAssetResource200ResponseAllOf input)
        {
            if (input == null)
            {
                return false;
