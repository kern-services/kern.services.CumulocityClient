...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "c8y_Network")]
    public partial class C8yNetwork : IEquatable<C8yNetwork>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="C8yNetwork" /> class.
        /// </summary>
        /// <param name="c8yLAN">c8yLAN.</param>
        /// <param name="c8yWAN">c8yWAN.</param>
        /// <param name="c8yDHCP">c8yDHCP.</param>
        public C8yNetwork(C8yNetworkC8yLAN c8yLAN = default(C8yNetworkC8yLAN), C8yNetworkC8yWAN c8yWAN = default(C8yNetworkC8yWAN), C8yNetworkC8yDHCP c8yDHCP = default(C8yNetworkC8yDHCP))
        {
            this.C8yLAN = c8yLAN;
            this.C8yWAN = c8yWAN;
        ...
        /// Gets or Sets C8yLAN
        /// </summary>
        [DataMember(Name = "c8y_LAN", EmitDefaultValue = false)]
        public C8yNetworkC8yLAN C8yLAN { get; set; }

        /// <summary>
        /// Gets or Sets C8yWAN
        /// </summary>
        [DataMember(Name = "c8y_WAN", EmitDefaultValue = false)]
        public C8yNetworkC8yWAN C8yWAN { get; set; }

        /// <summary>
        /// Gets or Sets C8yDHCP
        /// </summary>
        [DataMember(Name = "c8y_DHCP", EmitDefaultValue = false)]
        public C8yNetworkC8yDHCP C8yDHCP { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  C8yLAN: ").Append(C8yLAN).Append("\n");
            sb.Append("  C8yWAN: ").Append(C8yWAN).Append("\n");
            sb.Append("  C8yDHCP: ").Append(C8yDHCP).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as C8yNetwork);
        }

        /// <summary>
        /// Returns true if C8yNetwork instances are equal
        /// </summary>
        /// <param name="input">Instance of C8yNetwork to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(C8yNetwork input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.C8yLAN == input.C8yLAN ||
                    (this.C8yLAN != null &&
                    this.C8yLAN.Equals(input.C8yLAN))
                ) && 
                (
                    this.C8yWAN == input.C8yWAN ||
                    (this.C8yWAN != null &&
                    this.C8yWAN.Equals(input.C8yWAN))
                ) && 
                (
                    this.C8yDHCP == input.C8yDHCP ||
                    (this.C8yDHCP != null &&
                    this.C8yDHCP.Equals(input.C8yDHCP))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.C8yLAN != null)
                {
                    hashCode = (hashCode * 59) + this.C8yLAN.GetHashCode();
                }
                if (this.C8yWAN != null)
                {
                    hashCode = (hashCode * 59) + this.C8yWAN.GetHashCode();
                }
                if (this.C8yDHCP != null)
                {
                    hashCode = (hashCode * 59) + this.C8yDHCP.GetHashCode();
                }
                return hashCode;
            }
        }
