...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// UserTfaData
    /// </summary>
    [DataContract(Name = "userTfaData")]
    public partial class UserTfaData : IEquatable<UserTfaData>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UserTfaData" /> class.
        /// </summary>
        /// <param name="strategy">Two-factor authentication strategy..</param>
        /// <param name="tfaEnabled">Indicates whether the user has enabled two-factor authentication or not..</param>
        /// <param name="tfaEnforced">Indicates whether two-factor authentication is enforced by the tenant admin or not..</param>
        public UserTfaData(StrategyEnum? strategy = default(StrategyEnum?), bool tfaEnabled = default(bool), bool tfaEnforced = default(bool))
        {
        ...
        /// </summary>
        /// <value>Latest date and time when the user has used two-factor authentication to log in.</value>
        [DataMember(Name = "lastTfaRequestTime", EmitDefaultValue = false)]
        public DateTime LastTfaRequestTime { get; private set; }

        /// <summary>
        /// Returns false as LastTfaRequestTime should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeLastTfaRequestTime()
        {
            return false;
        }
        /// <summary>
        ...
        /// </summary>
        /// <value>Indicates whether the user has enabled two-factor authentication or not.</value>
        [DataMember(Name = "tfaEnabled", EmitDefaultValue = true)]
        public bool TfaEnabled { get; set; }

        /// <summary>
        /// Indicates whether two-factor authentication is enforced by the tenant admin or not.
        /// </summary>
        /// <value>Indicates whether two-factor authentication is enforced by the tenant admin or not.</value>
        [DataMember(Name = "tfaEnforced", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  LastTfaRequestTime: ").Append(LastTfaRequestTime).Append("\n");
            sb.Append("  Strategy: ").Append(Strategy).Append("\n");
            sb.Append("  TfaEnabled: ").Append(TfaEnabled).Append("\n");
            sb.Append("  TfaEnforced: ").Append(TfaEnforced).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as UserTfaData);
        }

        /// <summary>
        /// Returns true if UserTfaData instances are equal
        /// </summary>
        /// <param name="input">Instance of UserTfaData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserTfaData input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.LastTfaRequestTime == input.LastTfaRequestTime ||
                    (this.LastTfaRequestTime != null &&
                    this.LastTfaRequestTime.Equals(input.LastTfaRequestTime))
                ) && 
                (
                ...
                (
                    this.TfaEnforced == input.TfaEnforced ||
                    this.TfaEnforced.Equals(input.TfaEnforced)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.LastTfaRequestTime != null)
                {
                    hashCode = (hashCode * 59) + this.LastTfaRequestTime.GetHashCode();
                }
                hashCode = (hashCode * 59) + this.Strategy.GetHashCode();
                hashCode = (hashCode * 59) + this.TfaEnabled.GetHashCode();
                hashCode = (hashCode * 59) + this.TfaEnforced.GetHashCode();
                return hashCode;
            }
        }
