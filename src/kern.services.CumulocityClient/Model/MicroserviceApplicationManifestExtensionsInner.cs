...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "microservice_application_manifest_extensions_inner")]
    public partial class MicroserviceApplicationManifestExtensionsInner : IEquatable<MicroserviceApplicationManifestExtensionsInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MicroserviceApplicationManifestExtensionsInner" /> class.
        /// </summary>
        /// <param name="path">The relative path in Cumulocity IoT for this microservice application..</param>
        /// <param name="type">The type of this extension..</param>
        public MicroserviceApplicationManifestExtensionsInner(string path = default(string), string type = default(string))
        {
            this.Path = path;
            this.Type = type;
        }
        ...
        /// </summary>
        /// <value>The relative path in Cumulocity IoT for this microservice application.</value>
        ...
        /// </summary>
        /// <value>The type of this extension.</value>
        ...
        {
            return this.Equals(input as MicroserviceApplicationManifestExtensionsInner);
        }

        /// <summary>
        /// Returns true if MicroserviceApplicationManifestExtensionsInner instances are equal
        /// </summary>
        /// <param name="input">Instance of MicroserviceApplicationManifestExtensionsInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MicroserviceApplicationManifestExtensionsInner input)
        {
            if (input == null)
            {
                return false;
