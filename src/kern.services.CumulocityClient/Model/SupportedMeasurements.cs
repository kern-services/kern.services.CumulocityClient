...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SupportedMeasurements")]
    public partial class SupportedMeasurements : IEquatable<SupportedMeasurements>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SupportedMeasurements" /> class.
        /// </summary>
        /// <param name="c8ySupportedMeasurements">An array containing all supported measurements of the specified managed object..</param>
        public SupportedMeasurements(List<string> c8ySupportedMeasurements = default(List<string>))
        {
        ...
        /// </summary>
        /// <value>An array containing all supported measurements of the specified managed object.</value>
        [DataMember(Name = "c8y_SupportedMeasurements", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  C8ySupportedMeasurements: ").Append(C8ySupportedMeasurements).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as SupportedMeasurements);
        }

        /// <summary>
        /// Returns true if SupportedMeasurements instances are equal
        /// </summary>
        /// <param name="input">Instance of SupportedMeasurements to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SupportedMeasurements input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.C8ySupportedMeasurements == input.C8ySupportedMeasurements ||
                    this.C8ySupportedMeasurements != null &&
                    input.C8ySupportedMeasurements != null &&
                    this.C8ySupportedMeasurements.SequenceEqual(input.C8ySupportedMeasurements)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.C8ySupportedMeasurements.GetHashCode();
                }
                return hashCode;
            }
        }
