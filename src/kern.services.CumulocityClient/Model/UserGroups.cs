...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UserGroups :  IEquatable<UserGroups>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserGroups" /> class.
        /// </summary>
        /// <param name="references">A list of user group references..</param>
        /// <param name="statistics">statistics.</param>
        public UserGroups(List<GroupReference> references = default(List<GroupReference>), PageStatistics statistics = default(PageStatistics))
        {
        ...
        /// </summary>
        /// <value>A list of user group references.</value>
        ...
        {
            return this.Equals(input as UserGroups);
        }

        /// <summary>
        /// Returns true if UserGroups instances are equal
        /// </summary>
        /// <param name="input">Instance of UserGroups to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserGroups input)
        {
            if (input == null)
                return false;
