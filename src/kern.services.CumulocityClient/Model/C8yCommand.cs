...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "c8y_Command")]
    public partial class C8yCommand : IEquatable<C8yCommand>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="C8yCommand" /> class.
        /// </summary>
        /// <param name="type">The command sent to the device..</param>
        /// <param name="result">To communicate the results of a particular command, the device adds a property &#x60;result&#x60;..</param>
        public C8yCommand(string type = default(string), string result = default(string))
        {
            this.Type = type;
            this.Result = result;
        }
        ...
        /// </summary>
        /// <value>The command sent to the device.</value>
        ...
        /// </summary>
        /// <value>To communicate the results of a particular command, the device adds a property &#x60;result&#x60;.</value>
        ...
        {
            return this.Equals(input as C8yCommand);
        }

        /// <summary>
        /// Returns true if C8yCommand instances are equal
        /// </summary>
        /// <param name="input">Instance of C8yCommand to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(C8yCommand input)
        {
            if (input == null)
            {
                return false;
