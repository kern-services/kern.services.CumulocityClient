...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SubscribedUser_user")]
    public partial class SubscribedUserUser : IEquatable<SubscribedUserUser>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscribedUserUser" /> class.
        /// </summary>
        /// <param name="self">A URL linking to this resource..</param>
        public SubscribedUserUser(string self = default(string))
        {
            this.Self = self;
        }
        ...
        {
            return this.Equals(input as SubscribedUserUser);
        }

        /// <summary>
        /// Returns true if SubscribedUserUser instances are equal
        /// </summary>
        /// <param name="input">Instance of SubscribedUserUser to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubscribedUserUser input)
        {
            if (input == null)
            {
                return false;
