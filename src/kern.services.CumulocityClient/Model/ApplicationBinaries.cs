...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// ApplicationBinaries
    /// </summary>
    [DataContract(Name = "ApplicationBinaries")]
    public partial class ApplicationBinaries : IEquatable<ApplicationBinaries>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationBinaries" /> class.
        /// </summary>
        /// <param name="attachments">An array of attachments..</param>
        public ApplicationBinaries(List<ApplicationBinariesAttachmentsInner> attachments = default(List<ApplicationBinariesAttachmentsInner>))
        {
        ...
        /// </summary>
        /// <value>An array of attachments.</value>
        [DataMember(Name = "attachments", EmitDefaultValue = false)]
        public List<ApplicationBinariesAttachmentsInner> Attachments { get; set; }
        ...
        {
            return this.Equals(input as ApplicationBinaries);
        }

        /// <summary>
        /// Returns true if ApplicationBinaries instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationBinaries to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationBinaries input)
        {
            if (input == null)
            {
                return false;
