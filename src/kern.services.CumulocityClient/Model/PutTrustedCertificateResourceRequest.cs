...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "putTrustedCertificateResource_request")]
    public partial class PutTrustedCertificateResourceRequest : IEquatable<PutTrustedCertificateResourceRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>Indicates if the certificate is active and can be used by the device to establish a connection to the Cumulocity IoT platform.</value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PutTrustedCertificateResourceRequest" /> class.
        /// </summary>
        /// <param name="autoRegistrationEnabled">Indicates whether the automatic device registration is enabled or not. (default to false).</param>
        /// <param name="name">Name of the certificate..</param>
        /// <param name="status">Indicates if the certificate is active and can be used by the device to establish a connection to the Cumulocity IoT platform..</param>
        public PutTrustedCertificateResourceRequest(bool autoRegistrationEnabled = false, string name = default(string), StatusEnum? status = default(StatusEnum?))
        {
        ...
        /// </summary>
        /// <value>Algorithm used to decode/encode the certificate.</value>
        [DataMember(Name = "algorithmName", EmitDefaultValue = false)]
        public string AlgorithmName { get; private set; }

        /// <summary>
        /// Returns false as AlgorithmName should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeAlgorithmName()
        {
            return false;
        }
        /// <summary>
        ...
        /// </summary>
        /// <value>Indicates whether the automatic device registration is enabled or not.</value>
        [DataMember(Name = "autoRegistrationEnabled", EmitDefaultValue = true)]
        public bool AutoRegistrationEnabled { get; set; }

        /// <summary>
        /// Gets or Sets CertInPemFormat
        /// </summary>
        [DataMember(Name = "certInPemFormat", EmitDefaultValue = true)]
        public Object CertInPemFormat { get; private set; }

        /// <summary>
        /// Returns false as CertInPemFormat should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeCertInPemFormat()
        {
            return false;
        }
        /// <summary>
        ...
        /// </summary>
        /// <value>Unique identifier of the trusted certificate.</value>
        ...
        /// </summary>
        /// <value>The name of the organization which signed the certificate.</value>
        ...
        /// </summary>
        /// <value>The end date and time of the certificate&#39;s validity.</value>
        ...
        /// </summary>
        /// <value>The start date and time of the certificate&#39;s validity.</value>
        ...
        /// </summary>
        /// <value>The certificate&#39;s serial number.</value>
        ...
        /// </summary>
        /// <value>Name of the organization to which the certificate belongs.</value>
        ...
        /// </summary>
        /// <value>Version of the X.509 certificate standard.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AutoRegistrationEnabled: ").Append(AutoRegistrationEnabled).Append("\n");
            sb.Append("  CertInPemFormat: ").Append(CertInPemFormat).Append("\n");
        ...
        {
            return this.Equals(input as PutTrustedCertificateResourceRequest);
        }

        /// <summary>
        /// Returns true if PutTrustedCertificateResourceRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PutTrustedCertificateResourceRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PutTrustedCertificateResourceRequest input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.AutoRegistrationEnabled == input.AutoRegistrationEnabled ||
                    this.AutoRegistrationEnabled.Equals(input.AutoRegistrationEnabled)
                ) && 
                (
                    this.CertInPemFormat == input.CertInPemFormat ||
                    (this.CertInPemFormat != null &&
                    this.CertInPemFormat.Equals(input.CertInPemFormat))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.AutoRegistrationEnabled.GetHashCode();
                if (this.CertInPemFormat != null)
                {
                    hashCode = (hashCode * 59) + this.CertInPemFormat.GetHashCode();
                }
