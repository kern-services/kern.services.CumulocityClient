...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PostRetentionRuleCollectionResourceRequest :  IEquatable<PostRetentionRuleCollectionResourceRequest>, IValidatableObject
    {
        /// <summary>
        /// The data type(s) to which the rule is applied.
        /// </summary>
        /// <value>The data type(s) to which the rule is applied.</value>
        ...
        public enum DataTypeEnum
        {
            ...
            /// <summary>
            /// Enum BULKOPERATION for value: BULK_OPERATION
            /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostRetentionRuleCollectionResourceRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostRetentionRuleCollectionResourceRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostRetentionRuleCollectionResourceRequest" /> class.
        /// </summary>
        /// <param name="dataType">The data type(s) to which the rule is applied. (default to DataTypeEnum.Star).</param>
        /// <param name="editable">Indicates whether the rule is editable or not. It can be updated only by the Management tenant. (default to true).</param>
        /// <param name="fragmentType">The fragment type(s) to which the rule is applied. Used by the data types EVENT, MEASUREMENT, OPERATION and BULK_OPERATION. (default to &quot;*&quot;).</param>
        /// <param name="maximumAge">Maximum age expressed in number of days. (required).</param>
        /// <param name="source">The source(s) to which the rule is applied. Used by all data types. (default to &quot;*&quot;).</param>
        /// <param name="type">The type(s) to which the rule is applied. Used by the data types ALARM, AUDIT, EVENT and MEASUREMENT. (default to &quot;*&quot;).</param>
        public PostRetentionRuleCollectionResourceRequest(DataTypeEnum? dataType = DataTypeEnum.Star, bool editable = true, string fragmentType = "*", int maximumAge = default(int), string source = "*", string type = "*")
        {
            // to ensure "maximumAge" is required (not null)
            if (maximumAge == null)
            {
                throw new InvalidDataException("maximumAge is a required property for PostRetentionRuleCollectionResourceRequest and cannot be null");
            }
            else
            {
            ...
            if (dataType == null)
            {
                this.DataType = DataTypeEnum.Star;
            }
            else
            {
            ...
            // use default value if no "fragmentType" provided
        ...
        /// </summary>
        /// <value>Indicates whether the rule is editable or not. It can be updated only by the Management tenant.</value>
        ...
        /// </summary>
        /// <value>The fragment type(s) to which the rule is applied. Used by the data types EVENT, MEASUREMENT, OPERATION and BULK_OPERATION.</value>
        [DataMember(Name="fragmentType", EmitDefaultValue=false)]
        public string FragmentType { get; set; }

        /// <summary>
        /// Unique identifier of the retention rule.
        /// </summary>
        /// <value>Unique identifier of the retention rule.</value>
        ...
        /// </summary>
        /// <value>Maximum age expressed in number of days.</value>
        [DataMember(Name="maximumAge", EmitDefaultValue=true)]
        ...
        /// </summary>
        /// <value>The source(s) to which the rule is applied. Used by all data types.</value>
        ...
        /// </summary>
        /// <value>The type(s) to which the rule is applied. Used by the data types ALARM, AUDIT, EVENT and MEASUREMENT.</value>
        ...
        {
            return this.Equals(input as PostRetentionRuleCollectionResourceRequest);
        }

        /// <summary>
        /// Returns true if PostRetentionRuleCollectionResourceRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PostRetentionRuleCollectionResourceRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostRetentionRuleCollectionResourceRequest input)
        {
            if (input == null)
                return false;
