...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "pageStatistics")]
    public partial class PageStatistics : IEquatable<PageStatistics>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PageStatistics" /> class.
        /// </summary>
        ...
        public PageStatistics(int currentPage = default(int), int pageSize = default(int), int totalElements = default(int), int totalPages = default(int))
        {
        ...
        {
            return this.Equals(input as PageStatistics);
        }

        /// <summary>
        /// Returns true if PageStatistics instances are equal
        /// </summary>
        /// <param name="input">Instance of PageStatistics to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageStatistics input)
        {
            if (input == null)
            {
                return false;
