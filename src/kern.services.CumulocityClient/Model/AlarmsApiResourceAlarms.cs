...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "alarmsApiResource_alarms")]
    public partial class AlarmsApiResourceAlarms : IEquatable<AlarmsApiResourceAlarms>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AlarmsApiResourceAlarms" /> class.
        /// </summary>
        /// <param name="alarms">alarms.</param>
        public AlarmsApiResourceAlarms(List<Alarm> alarms = default(List<Alarm>))
        {
            this.Alarms = alarms;
        }
        ...
        /// Gets or Sets Alarms
        /// </summary>
        [DataMember(Name = "alarms", EmitDefaultValue = true)]
        ...
        {
            return this.Equals(input as AlarmsApiResourceAlarms);
        }

        /// <summary>
        /// Returns true if AlarmsApiResourceAlarms instances are equal
        /// </summary>
        /// <param name="input">Instance of AlarmsApiResourceAlarms to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AlarmsApiResourceAlarms input)
        {
            if (input == null)
            {
                return false;
