...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// EventsApiResource
    /// </summary>
    [DataContract(Name = "eventsApiResource")]
    public partial class EventsApiResource : IEquatable<EventsApiResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EventsApiResource" /> class.
        /// </summary>
        /// <param name="events">events.</param>
        /// <param name="eventsForSource">Read-only collection of all events for a specific source object. The placeholder {source} must be a unique ID of an object in the inventory..</param>
        /// <param name="eventsForSourceAndType">Read-only collection of all events of a particular type and a specific source object..</param>
        /// <param name="eventsForType">Read-only collection of all events of a particular type..</param>
        /// <param name="eventsForFragmentType">Read-only collection of all events containing a particular fragment type..</param>
        /// <param name="eventsForTime">Read-only collection of all events for a particular time range..</param>
        /// <param name="eventsForSourceAndTime">Read-only collection of all events for a specific source object in a particular time range..</param>
        public EventsApiResource(EventsApiResourceEvents events = default(EventsApiResourceEvents), string eventsForSource = default(string), string eventsForSourceAndType = default(string), string eventsForType = default(string), string eventsForFragmentType = default(string), string eventsForTime = default(string), string eventsForSourceAndTime = default(string))
        {
            this.Events = events;
        ...
        public EventsApiResourceEvents Events { get; set; }
        ...
        /// </summary>
        /// <value>Read-only collection of all events for a specific source object. The placeholder {source} must be a unique ID of an object in the inventory.</value>
        [DataMember(Name = "eventsForSource", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>Read-only collection of all events of a particular type and a specific source object.</value>
        [DataMember(Name = "eventsForSourceAndType", EmitDefaultValue = false)]
        public string EventsForSourceAndType { get; set; }

        /// <summary>
        /// Read-only collection of all events of a particular type.
        /// </summary>
        /// <value>Read-only collection of all events of a particular type.</value>
        [DataMember(Name = "eventsForType", EmitDefaultValue = false)]
        public string EventsForType { get; set; }

        /// <summary>
        /// Read-only collection of all events containing a particular fragment type.
        /// </summary>
        /// <value>Read-only collection of all events containing a particular fragment type.</value>
        [DataMember(Name = "eventsForFragmentType", EmitDefaultValue = false)]
        public string EventsForFragmentType { get; set; }

        /// <summary>
        /// Read-only collection of all events for a particular time range.
        /// </summary>
        /// <value>Read-only collection of all events for a particular time range.</value>
        [DataMember(Name = "eventsForTime", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>Read-only collection of all events for a specific source object in a particular time range.</value>
        [DataMember(Name = "eventsForSourceAndTime", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  EventsForSource: ").Append(EventsForSource).Append("\n");
            sb.Append("  EventsForSourceAndType: ").Append(EventsForSourceAndType).Append("\n");
            sb.Append("  EventsForType: ").Append(EventsForType).Append("\n");
            sb.Append("  EventsForFragmentType: ").Append(EventsForFragmentType).Append("\n");
            sb.Append("  EventsForTime: ").Append(EventsForTime).Append("\n");
            sb.Append("  EventsForSourceAndTime: ").Append(EventsForSourceAndTime).Append("\n");
        ...
        {
            return this.Equals(input as EventsApiResource);
        }

        /// <summary>
        /// Returns true if EventsApiResource instances are equal
        /// </summary>
        /// <param name="input">Instance of EventsApiResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EventsApiResource input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.EventsForSource == input.EventsForSource ||
                    (this.EventsForSource != null &&
                    this.EventsForSource.Equals(input.EventsForSource))
                ) && 
                (
                    this.EventsForSourceAndType == input.EventsForSourceAndType ||
                    (this.EventsForSourceAndType != null &&
                    this.EventsForSourceAndType.Equals(input.EventsForSourceAndType))
                ) && 
                (
                    this.EventsForType == input.EventsForType ||
                    (this.EventsForType != null &&
                    this.EventsForType.Equals(input.EventsForType))
                ) && 
                (
                    this.EventsForFragmentType == input.EventsForFragmentType ||
                    (this.EventsForFragmentType != null &&
                    this.EventsForFragmentType.Equals(input.EventsForFragmentType))
                ) && 
                (
                    this.EventsForTime == input.EventsForTime ||
                    (this.EventsForTime != null &&
                    this.EventsForTime.Equals(input.EventsForTime))
                ) && 
                (
                    this.EventsForSourceAndTime == input.EventsForSourceAndTime ||
                    (this.EventsForSourceAndTime != null &&
                    this.EventsForSourceAndTime.Equals(input.EventsForSourceAndTime))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.EventsForSource != null)
                {
                    hashCode = (hashCode * 59) + this.EventsForSource.GetHashCode();
                }
                if (this.EventsForSourceAndType != null)
                {
                    hashCode = (hashCode * 59) + this.EventsForSourceAndType.GetHashCode();
                }
                if (this.EventsForType != null)
                {
                    hashCode = (hashCode * 59) + this.EventsForType.GetHashCode();
                }
                if (this.EventsForFragmentType != null)
                {
                    hashCode = (hashCode * 59) + this.EventsForFragmentType.GetHashCode();
                }
                if (this.EventsForTime != null)
                {
                    hashCode = (hashCode * 59) + this.EventsForTime.GetHashCode();
                }
                if (this.EventsForSourceAndTime != null)
                {
                    hashCode = (hashCode * 59) + this.EventsForSourceAndTime.GetHashCode();
                }
                if (this.Self != null)
                {
