...
{
    /// <summary>
    /// PostNewDeviceRequestCollectionResourceRequestAllOf
    /// </summary>
    [DataContract(Name = "postNewDeviceRequestCollectionResource_request_allOf")]
    public partial class PostNewDeviceRequestCollectionResourceRequestAllOf : IEquatable<PostNewDeviceRequestCollectionResourceRequestAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostNewDeviceRequestCollectionResourceRequestAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public PostNewDeviceRequestCollectionResourceRequestAllOf()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostNewDeviceRequestCollectionResourceRequestAllOf {\n");
        ...
        {
            return this.Equals(input as PostNewDeviceRequestCollectionResourceRequestAllOf);
        }

        /// <summary>
        /// Returns true if PostNewDeviceRequestCollectionResourceRequestAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of PostNewDeviceRequestCollectionResourceRequestAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostNewDeviceRequestCollectionResourceRequestAllOf input)
        {
            if (input == null)
            {
                return false;
