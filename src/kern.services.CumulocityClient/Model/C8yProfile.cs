...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class C8yProfile :  IEquatable<C8yProfile>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="C8yProfile" /> class.
        /// </summary>
        /// <param name="profileName">The name of the profile..</param>
        /// <param name="profileId">The ID of the profile..</param>
        /// <param name="profileExecuted">Indicates whether the profile has been executed..</param>
        public C8yProfile(string profileName = default(string), string profileId = default(string), bool profileExecuted = default(bool))
        {
        ...
        /// </summary>
        /// <value>Indicates whether the profile has been executed.</value>
        [DataMember(Name="profileExecuted", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ProfileExecuted: ").Append(ProfileExecuted).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as C8yProfile);
        }

        /// <summary>
        /// Returns true if C8yProfile instances are equal
        /// </summary>
        /// <param name="input">Instance of C8yProfile to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(C8yProfile input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ProfileExecuted == input.ProfileExecuted ||
                    (this.ProfileExecuted != null &&
                    this.ProfileExecuted.Equals(input.ProfileExecuted))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ProfileExecuted != null)
                    hashCode = hashCode * 59 + this.ProfileExecuted.GetHashCode();
                return hashCode;
            }
        }
