...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "managedObjectReferenceTuple")]
    public partial class ManagedObjectReferenceTuple : IEquatable<ManagedObjectReferenceTuple>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ManagedObjectReferenceTuple" /> class.
        /// </summary>
        /// <param name="managedObject">managedObject.</param>
        public ManagedObjectReferenceTuple(ManagedObjectReferenceTupleManagedObject managedObject = default(ManagedObjectReferenceTupleManagedObject))
        {
        ...
        public ManagedObjectReferenceTupleManagedObject ManagedObject { get; set; }
        ...
        {
            return this.Equals(input as ManagedObjectReferenceTuple);
        }

        /// <summary>
        /// Returns true if ManagedObjectReferenceTuple instances are equal
        /// </summary>
        /// <param name="input">Instance of ManagedObjectReferenceTuple to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ManagedObjectReferenceTuple input)
        {
            if (input == null)
            {
                return false;
