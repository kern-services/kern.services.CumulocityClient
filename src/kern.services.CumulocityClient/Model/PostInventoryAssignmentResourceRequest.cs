...
namespace kern.services.CumulocityClient.Model
{
    ...
    public partial class PostInventoryAssignmentResourceRequest : IValidatableObject
    {
        /// <summary>
        ...
        /// <example>https://&lt;TENANT_DOMAIN&gt;/user/{tenantId}/users/jdoe/roles/inventory/1</example>
