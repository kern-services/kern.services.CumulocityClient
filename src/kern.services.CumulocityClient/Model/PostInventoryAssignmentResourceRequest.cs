...
namespace kern.services.CumulocityClient.Model
{
    ...
    public partial class PostInventoryAssignmentResourceRequest :  IEquatable<PostInventoryAssignmentResourceRequest>, IValidatableObject
    {
        ...
        public PostInventoryAssignmentResourceRequest(string managedObject = default(string), List<PostInventoryAssignmentResourceRequestAllOfRolesInner> roles = default(List<PostInventoryAssignmentResourceRequestAllOfRolesInner>))
        {
            ...
            {
                throw new InvalidDataException("managedObject is a required property for PostInventoryAssignmentResourceRequest and cannot be null");
            }
            else
            {
            ...
            if (roles == null)
            {
                throw new InvalidDataException("roles is a required property for PostInventoryAssignmentResourceRequest and cannot be null");
            }
            else
            {
                this.Roles = roles;
        ...
        [DataMember(Name="managedObject", EmitDefaultValue=true)]
