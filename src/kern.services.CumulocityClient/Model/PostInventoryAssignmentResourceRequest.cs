...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "postInventoryAssignmentResource_request")]
    public partial class PostInventoryAssignmentResourceRequest : IEquatable<PostInventoryAssignmentResourceRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostInventoryAssignmentResourceRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostInventoryAssignmentResourceRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostInventoryAssignmentResourceRequest" /> class.
        /// </summary>
        /// <param name="managedObject">A unique identifier for the managed object for which the roles are assigned. (required).</param>
        /// <param name="roles">roles (required).</param>
        public PostInventoryAssignmentResourceRequest(string managedObject = default(string), List<PostInventoryAssignmentResourceRequestAllOfRolesInner> roles = default(List<PostInventoryAssignmentResourceRequestAllOfRolesInner>))
        {
            // to ensure "managedObject" is required (not null)
            if (managedObject == null)
            {
                throw new ArgumentNullException("managedObject is a required property for PostInventoryAssignmentResourceRequest and cannot be null");
            }
            this.ManagedObject = managedObject;
            // to ensure "roles" is required (not null)
            if (roles == null)
            {
                throw new ArgumentNullException("roles is a required property for PostInventoryAssignmentResourceRequest and cannot be null");
            }
            this.Roles = roles;
        }
        ...
        /// </summary>
        /// <value>A unique identifier for this inventory assignment.</value>
        ...
        /// </summary>
        /// <value>A unique identifier for the managed object for which the roles are assigned.</value>
        ...
        public List<PostInventoryAssignmentResourceRequestAllOfRolesInner> Roles { get; set; }
        ...
        {
            return this.Equals(input as PostInventoryAssignmentResourceRequest);
        }

        /// <summary>
        /// Returns true if PostInventoryAssignmentResourceRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PostInventoryAssignmentResourceRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostInventoryAssignmentResourceRequest input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.ManagedObject == input.ManagedObject ||
                    (this.ManagedObject != null &&
                    this.ManagedObject.Equals(input.ManagedObject))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.ManagedObject.GetHashCode();
                }
                if (this.Roles != null)
                {
