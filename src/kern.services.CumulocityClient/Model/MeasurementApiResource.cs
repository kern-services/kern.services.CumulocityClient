...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "measurementApiResource")]
    public partial class MeasurementApiResource : IEquatable<MeasurementApiResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MeasurementApiResource" /> class.
        /// </summary>
        /// <param name="measurements">measurements.</param>
        /// <param name="measurementsForSource">Read-only collection of all measurements for a specific source object. The placeholder {source} must be a unique ID of an object in the inventory..</param>
        /// <param name="measurementsForSourceAndType">Read-only collection of all measurements of a particular type and a specific source object..</param>
        /// <param name="measurementsForType">Read-only collection of all measurements of a particular type..</param>
        /// <param name="measurementsForValueFragmentType">Read-only collection of all measurements containing a particular fragment type..</param>
        /// <param name="measurementsForDate">Read-only collection of all measurements for a particular time range..</param>
        /// <param name="measurementsForSourceAndDate">Read-only collection of all measurements for a specific source object in a particular time range..</param>
        /// <param name="measurementsForDateAndFragmentType">Read-only collection of all measurements for a specific fragment type and a particular time range..</param>
        /// <param name="measurementsForSourceAndValueFragmentTypeAndValueFragmentSeries">Read-only collection of all measurements for a specific source object, particular fragment type and series, and an event type..</param>
        public MeasurementApiResource(MeasurementApiResourceMeasurements measurements = default(MeasurementApiResourceMeasurements), string measurementsForSource = default(string), string measurementsForSourceAndType = default(string), string measurementsForType = default(string), string measurementsForValueFragmentType = default(string), string measurementsForDate = default(string), string measurementsForSourceAndDate = default(string), string measurementsForDateAndFragmentType = default(string), string measurementsForSourceAndValueFragmentTypeAndValueFragmentSeries = default(string))
        {
        ...
        public MeasurementApiResourceMeasurements Measurements { get; set; }
        ...
        /// </summary>
        /// <value>Read-only collection of all measurements for a specific source object. The placeholder {source} must be a unique ID of an object in the inventory.</value>
        [DataMember(Name = "measurementsForSource", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>Read-only collection of all measurements of a particular type and a specific source object.</value>
        [DataMember(Name = "measurementsForSourceAndType", EmitDefaultValue = false)]
        public string MeasurementsForSourceAndType { get; set; }

        /// <summary>
        /// Read-only collection of all measurements of a particular type.
        /// </summary>
        /// <value>Read-only collection of all measurements of a particular type.</value>
        [DataMember(Name = "measurementsForType", EmitDefaultValue = false)]
        public string MeasurementsForType { get; set; }

        /// <summary>
        /// Read-only collection of all measurements containing a particular fragment type.
        /// </summary>
        /// <value>Read-only collection of all measurements containing a particular fragment type.</value>
        [DataMember(Name = "measurementsForValueFragmentType", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>Read-only collection of all measurements for a particular time range.</value>
        [DataMember(Name = "measurementsForDate", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>Read-only collection of all measurements for a specific source object in a particular time range.</value>
        [DataMember(Name = "measurementsForSourceAndDate", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>Read-only collection of all measurements for a specific fragment type and a particular time range.</value>
        [DataMember(Name = "measurementsForDateAndFragmentType", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>Read-only collection of all measurements for a specific source object, particular fragment type and series, and an event type.</value>
        [DataMember(Name = "measurementsForSourceAndValueFragmentTypeAndValueFragmentSeries", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  MeasurementsForSource: ").Append(MeasurementsForSource).Append("\n");
            sb.Append("  MeasurementsForSourceAndType: ").Append(MeasurementsForSourceAndType).Append("\n");
            sb.Append("  MeasurementsForType: ").Append(MeasurementsForType).Append("\n");
            sb.Append("  MeasurementsForValueFragmentType: ").Append(MeasurementsForValueFragmentType).Append("\n");
            sb.Append("  MeasurementsForDate: ").Append(MeasurementsForDate).Append("\n");
            sb.Append("  MeasurementsForSourceAndDate: ").Append(MeasurementsForSourceAndDate).Append("\n");
            sb.Append("  MeasurementsForDateAndFragmentType: ").Append(MeasurementsForDateAndFragmentType).Append("\n");
            sb.Append("  MeasurementsForSourceAndValueFragmentTypeAndValueFragmentSeries: ").Append(MeasurementsForSourceAndValueFragmentTypeAndValueFragmentSeries).Append("\n");
        ...
        {
            return this.Equals(input as MeasurementApiResource);
        }

        /// <summary>
        /// Returns true if MeasurementApiResource instances are equal
        /// </summary>
        /// <param name="input">Instance of MeasurementApiResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MeasurementApiResource input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.MeasurementsForSource == input.MeasurementsForSource ||
                    (this.MeasurementsForSource != null &&
                    this.MeasurementsForSource.Equals(input.MeasurementsForSource))
                ) && 
                (
                    this.MeasurementsForSourceAndType == input.MeasurementsForSourceAndType ||
                    (this.MeasurementsForSourceAndType != null &&
                    this.MeasurementsForSourceAndType.Equals(input.MeasurementsForSourceAndType))
                ) && 
                (
                    this.MeasurementsForType == input.MeasurementsForType ||
                    (this.MeasurementsForType != null &&
                    this.MeasurementsForType.Equals(input.MeasurementsForType))
                ) && 
                (
                    this.MeasurementsForValueFragmentType == input.MeasurementsForValueFragmentType ||
                    (this.MeasurementsForValueFragmentType != null &&
                    this.MeasurementsForValueFragmentType.Equals(input.MeasurementsForValueFragmentType))
                ) && 
                (
                    this.MeasurementsForDate == input.MeasurementsForDate ||
                    (this.MeasurementsForDate != null &&
                    this.MeasurementsForDate.Equals(input.MeasurementsForDate))
                ) && 
                (
                    this.MeasurementsForSourceAndDate == input.MeasurementsForSourceAndDate ||
                    (this.MeasurementsForSourceAndDate != null &&
                    this.MeasurementsForSourceAndDate.Equals(input.MeasurementsForSourceAndDate))
                ) && 
                (
                    this.MeasurementsForDateAndFragmentType == input.MeasurementsForDateAndFragmentType ||
                    (this.MeasurementsForDateAndFragmentType != null &&
                    this.MeasurementsForDateAndFragmentType.Equals(input.MeasurementsForDateAndFragmentType))
                ) && 
                (
                    this.MeasurementsForSourceAndValueFragmentTypeAndValueFragmentSeries == input.MeasurementsForSourceAndValueFragmentTypeAndValueFragmentSeries ||
                    (this.MeasurementsForSourceAndValueFragmentTypeAndValueFragmentSeries != null &&
                    this.MeasurementsForSourceAndValueFragmentTypeAndValueFragmentSeries.Equals(input.MeasurementsForSourceAndValueFragmentTypeAndValueFragmentSeries))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.MeasurementsForSource != null)
                {
                    hashCode = (hashCode * 59) + this.MeasurementsForSource.GetHashCode();
                }
                if (this.MeasurementsForSourceAndType != null)
                {
                    hashCode = (hashCode * 59) + this.MeasurementsForSourceAndType.GetHashCode();
                }
                if (this.MeasurementsForType != null)
                {
                    hashCode = (hashCode * 59) + this.MeasurementsForType.GetHashCode();
                }
                if (this.MeasurementsForValueFragmentType != null)
                {
                    hashCode = (hashCode * 59) + this.MeasurementsForValueFragmentType.GetHashCode();
                }
                if (this.MeasurementsForDate != null)
                {
                    hashCode = (hashCode * 59) + this.MeasurementsForDate.GetHashCode();
                }
                if (this.MeasurementsForSourceAndDate != null)
                {
                    hashCode = (hashCode * 59) + this.MeasurementsForSourceAndDate.GetHashCode();
                }
                if (this.MeasurementsForDateAndFragmentType != null)
                {
                    hashCode = (hashCode * 59) + this.MeasurementsForDateAndFragmentType.GetHashCode();
                }
                if (this.MeasurementsForSourceAndValueFragmentTypeAndValueFragmentSeries != null)
                {
                    hashCode = (hashCode * 59) + this.MeasurementsForSourceAndValueFragmentTypeAndValueFragmentSeries.GetHashCode();
                }
                if (this.Self != null)
                {
