...
namespace kern.services.CumulocityClient.Model
{
    ...
    public partial class Measurement : IValidatableObject
    {
        ...
        public Measurement(MeasurementSource source = default(MeasurementSource), DateTime time = default(DateTime), string type = default(string), C8ySteam c8ySteam = default(C8ySteam))
        {
