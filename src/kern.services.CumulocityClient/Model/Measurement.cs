...
namespace kern.services.CumulocityClient.Model
{
    ...
    public partial class Measurement : Dictionary<String, Object>, IEquatable<Measurement>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="time">The date and time when the measurement is created. (required).</param>
        /// <param name="type">Identifies the type of this measurement. (required).</param>
        /// <param name="c8ySteam">c8ySteam.</param>
        public Measurement(MeasurementSource source = default(MeasurementSource), DateTime time = default(DateTime), string type = default(string), C8ySteam c8ySteam = default(C8ySteam)) : base()
        {
            // to ensure "source" is required (not null)
            if (source == null)
            {
                throw new ArgumentNullException("source is a required property for Measurement and cannot be null");
            }
            this.Source = source;
            this.Time = time;
            ...
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for Measurement and cannot be null");
            }
            this.Type = type;
        ...
        /// </summary>
        /// <value>Unique identifier of the measurement.</value>
        ...
        /// </summary>
        /// <value>The date and time when the measurement is created.</value>
        ...
        /// </summary>
        /// <value>Identifies the type of this measurement.</value>
        [DataMember(Name = "type", IsRequired = true, EmitDefaultValue = true)]
        public string Type { get; set; }

        /// <summary>
        /// Gets or Sets C8ySteam
        /// </summary>
        [DataMember(Name = "c8y_Steam", EmitDefaultValue = false)]
        public C8ySteam C8ySteam { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  C8ySteam: ").Append(C8ySteam).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(Measurement input)
        {
            ...
            return base.Equals(input) && 
                ...
                (
                    this.C8ySteam == input.C8ySteam ||
                    (this.C8ySteam != null &&
                    this.C8ySteam.Equals(input.C8ySteam))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.C8ySteam != null)
                {
                    hashCode = (hashCode * 59) + this.C8ySteam.GetHashCode();
                }
                return hashCode;
            }
        }
