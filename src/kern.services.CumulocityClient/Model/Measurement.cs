...
namespace kern.services.CumulocityClient.Model
{
    ...
    public partial class Measurement : Dictionary<String, Object>,  IEquatable<Measurement>, IValidatableObject
    {
        ...
        public Measurement(MeasurementSource source = default(MeasurementSource), DateTime time = default(DateTime), string type = default(string), C8ySteam c8ySteam = default(C8ySteam)) : base()
        {
            ...
            if (time == null)
            {
                throw new InvalidDataException("time is a required property for Measurement and cannot be null");
            }
            else
            {
                this.Time = time;
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for Measurement and cannot be null");
            }
            else
            {
                this.Type = type;
