...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "c8y_Mobile")]
    public partial class C8yMobile : Dictionary<String, string>, IEquatable<C8yMobile>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="C8yMobile" /> class.
        /// </summary>
        ...
        /// Initializes a new instance of the <see cref="C8yMobile" /> class.
        /// </summary>
        /// <param name="imei">The equipment identifier (IMEI) of the modem in the device. (required).</param>
        /// <param name="cellId">The identifier of the cell in the mobile network that the device is currently connected with. (required).</param>
        /// <param name="iccid">The identifier of the SIM card that is currently in the device (often printed on the card). (required).</param>
        public C8yMobile(string imei = default(string), string cellId = default(string), string iccid = default(string)) : base()
        {
            // to ensure "imei" is required (not null)
            if (imei == null)
            {
                throw new ArgumentNullException("imei is a required property for C8yMobile and cannot be null");
            }
            this.Imei = imei;
            // to ensure "cellId" is required (not null)
            if (cellId == null)
            {
                throw new ArgumentNullException("cellId is a required property for C8yMobile and cannot be null");
            }
            this.CellId = cellId;
            // to ensure "iccid" is required (not null)
            if (iccid == null)
            {
                throw new ArgumentNullException("iccid is a required property for C8yMobile and cannot be null");
            }
            this.Iccid = iccid;
        }
        ...
        /// </summary>
        /// <value>The equipment identifier (IMEI) of the modem in the device.</value>
        [DataMember(Name = "imei", IsRequired = true, EmitDefaultValue = true)]
        public string Imei { get; set; }

        /// <summary>
        /// The identifier of the cell in the mobile network that the device is currently connected with.
        /// </summary>
        /// <value>The identifier of the cell in the mobile network that the device is currently connected with.</value>
        ...
        /// </summary>
        /// <value>The identifier of the SIM card that is currently in the device (often printed on the card).</value>
        [DataMember(Name = "iccid", IsRequired = true, EmitDefaultValue = true)]
        ...
        {
            return this.Equals(input as C8yMobile);
        }

        /// <summary>
        /// Returns true if C8yMobile instances are equal
        /// </summary>
        /// <param name="input">Instance of C8yMobile to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(C8yMobile input)
        {
            if (input == null)
            {
                return false;
