...
namespace kern.services.CumulocityClient.Model
{
    ...
    public partial class C8yMobile : Dictionary<String, string>,  IEquatable<C8yMobile>, IValidatableObject
    {
        ...
        public C8yMobile(string imei = default(string), string cellId = default(string), string iccid = default(string)) : base()
        {
            ...
            if (imei == null)
            {
                throw new InvalidDataException("imei is a required property for C8yMobile and cannot be null");
            }
            else
            {
                this.Imei = imei;
            ...
            if (cellId == null)
            {
                throw new InvalidDataException("cellId is a required property for C8yMobile and cannot be null");
            }
            else
            {
                this.CellId = cellId;
            ...
            if (iccid == null)
            {
                throw new InvalidDataException("iccid is a required property for C8yMobile and cannot be null");
            }
            else
            {
                this.Iccid = iccid;
        ...
        [DataMember(Name="iccid", EmitDefaultValue=true)]
