...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BulkOperationCollection")]
    public partial class BulkOperationCollection : IEquatable<BulkOperationCollection>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BulkOperationCollection" /> class.
        /// </summary>
        /// <param name="bulkOperations">An array of bulk operations..</param>
        /// <param name="statistics">statistics.</param>
        public BulkOperationCollection(List<BulkOperation> bulkOperations = default(List<BulkOperation>), PageStatistics statistics = default(PageStatistics))
        {
        ...
        /// </summary>
        /// <value>An array of bulk operations.</value>
        [DataMember(Name = "bulkOperations", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  BulkOperations: ").Append(BulkOperations).Append("\n");
        ...
        {
            return this.Equals(input as BulkOperationCollection);
        }

        /// <summary>
        /// Returns true if BulkOperationCollection instances are equal
        /// </summary>
        /// <param name="input">Instance of BulkOperationCollection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BulkOperationCollection input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.BulkOperations == input.BulkOperations ||
                    this.BulkOperations != null &&
                    input.BulkOperations != null &&
                    this.BulkOperations.SequenceEqual(input.BulkOperations)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.BulkOperations.GetHashCode();
                }
                if (this.Next != null)
                {
