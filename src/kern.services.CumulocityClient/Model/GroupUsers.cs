...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GroupUsers :  IEquatable<GroupUsers>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupUsers" /> class.
        /// </summary>
        /// <param name="references">The list of users in this group..</param>
        public GroupUsers(List<User> references = default(List<User>))
        {
        ...
        {
            return this.Equals(input as GroupUsers);
        }

        /// <summary>
        /// Returns true if GroupUsers instances are equal
        /// </summary>
        /// <param name="input">Instance of GroupUsers to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GroupUsers input)
        {
            if (input == null)
                return false;
