...
namespace kern.services.CumulocityClient.Model
{
    ...
    public partial class PostOptionCollectionResourceRequest :  IEquatable<PostOptionCollectionResourceRequest>, IValidatableObject
    {
        ...
        public PostOptionCollectionResourceRequest(string category = default(string), string key = default(string), string value = default(string))
        {
            ...
            if (category == null)
            {
                throw new InvalidDataException("category is a required property for PostOptionCollectionResourceRequest and cannot be null");
            }
            else
            {
            ...
            if (key == null)
            {
                throw new InvalidDataException("key is a required property for PostOptionCollectionResourceRequest and cannot be null");
            }
            else
            {
                this.Key = key;
