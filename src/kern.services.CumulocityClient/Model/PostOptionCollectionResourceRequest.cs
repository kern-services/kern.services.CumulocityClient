...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "postOptionCollectionResource_request")]
    public partial class PostOptionCollectionResourceRequest : IEquatable<PostOptionCollectionResourceRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionCollectionResourceRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostOptionCollectionResourceRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOptionCollectionResourceRequest" /> class.
        /// </summary>
        /// <param name="category">Name of the option category. (required).</param>
        /// <param name="key">A unique identifier for this option. (required).</param>
        /// <param name="value">Value of this option..</param>
        public PostOptionCollectionResourceRequest(string category = default(string), string key = default(string), string value = default(string))
        {
            // to ensure "category" is required (not null)
            if (category == null)
            {
                throw new ArgumentNullException("category is a required property for PostOptionCollectionResourceRequest and cannot be null");
            }
            this.Category = category;
            // to ensure "key" is required (not null)
            if (key == null)
            {
                throw new ArgumentNullException("key is a required property for PostOptionCollectionResourceRequest and cannot be null");
            }
            this.Key = key;
            this.Value = value;
        }
        ...
        /// </summary>
        /// <value>Name of the option category.</value>
        ...
        /// </summary>
        /// <value>A unique identifier for this option.</value>
        ...
        /// </summary>
        /// <value>Value of this option.</value>
        ...
        {
            return this.Equals(input as PostOptionCollectionResourceRequest);
        }

        /// <summary>
        /// Returns true if PostOptionCollectionResourceRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOptionCollectionResourceRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOptionCollectionResourceRequest input)
        {
            if (input == null)
            {
                return false;
