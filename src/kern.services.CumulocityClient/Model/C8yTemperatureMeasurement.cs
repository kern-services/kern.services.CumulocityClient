...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "c8y_TemperatureMeasurement")]
    public partial class C8yTemperatureMeasurement : IEquatable<C8yTemperatureMeasurement>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="C8yTemperatureMeasurement" /> class.
        /// </summary>
        /// <param name="t">t.</param>
        public C8yTemperatureMeasurement(C8yTemperatureMeasurementT t = default(C8yTemperatureMeasurementT))
        {
            this.T = t;
        }
        ...
        public C8yTemperatureMeasurementT T { get; set; }
        ...
        {
            return this.Equals(input as C8yTemperatureMeasurement);
        }

        /// <summary>
        /// Returns true if C8yTemperatureMeasurement instances are equal
        /// </summary>
        /// <param name="input">Instance of C8yTemperatureMeasurement to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(C8yTemperatureMeasurement input)
        {
            if (input == null)
            {
                return false;
