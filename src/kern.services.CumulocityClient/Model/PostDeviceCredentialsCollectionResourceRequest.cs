...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "postDeviceCredentialsCollectionResource_request")]
    public partial class PostDeviceCredentialsCollectionResourceRequest : IEquatable<PostDeviceCredentialsCollectionResourceRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostDeviceCredentialsCollectionResourceRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostDeviceCredentialsCollectionResourceRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostDeviceCredentialsCollectionResourceRequest" /> class.
        /// </summary>
        /// <param name="id">The external ID of the device. (required).</param>
        public PostDeviceCredentialsCollectionResourceRequest(string id = default(string))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for PostDeviceCredentialsCollectionResourceRequest and cannot be null");
            }
            this.Id = id;
        }
        ...
        /// </summary>
        /// <value>The external ID of the device.</value>
        ...
        /// </summary>
        /// <value>Password of these device credentials.</value>
        ...
        /// </summary>
        /// <value>Tenant ID for these device credentials.</value>
        ...
        /// </summary>
        /// <value>Username of these device credentials.</value>
        ...
        {
            return this.Equals(input as PostDeviceCredentialsCollectionResourceRequest);
        }

        /// <summary>
        /// Returns true if PostDeviceCredentialsCollectionResourceRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PostDeviceCredentialsCollectionResourceRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostDeviceCredentialsCollectionResourceRequest input)
        {
            if (input == null)
            {
                return false;
