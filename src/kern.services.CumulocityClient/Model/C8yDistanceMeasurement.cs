...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "c8y_DistanceMeasurement")]
    public partial class C8yDistanceMeasurement : IEquatable<C8yDistanceMeasurement>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="C8yDistanceMeasurement" /> class.
        /// </summary>
        /// <param name="distance">distance.</param>
        public C8yDistanceMeasurement(C8yDistanceMeasurementDistance distance = default(C8yDistanceMeasurementDistance))
        {
        ...
        public C8yDistanceMeasurementDistance Distance { get; set; }
        ...
        {
            return this.Equals(input as C8yDistanceMeasurement);
        }

        /// <summary>
        /// Returns true if C8yDistanceMeasurement instances are equal
        /// </summary>
        /// <param name="input">Instance of C8yDistanceMeasurement to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(C8yDistanceMeasurement input)
        {
            if (input == null)
            {
                return false;
