...
namespace kern.services.CumulocityClient.Model
{
    ...
    public partial class ExternalId :  IEquatable<ExternalId>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="ExternalId" /> class.
        /// </summary>
        /// <param name="externalId">The identifier used in the external system that Cumulocity IoT interfaces with. (required).</param>
        /// <param name="managedObject">managedObject.</param>
        /// <param name="type">The type of the external identifier. (required).</param>
        public ExternalId(string externalId = default(string), ExternalIdManagedObject managedObject = default(ExternalIdManagedObject), string type = default(string))
        {
            // to ensure "externalId" is required (not null)
            if (externalId == null)
            {
                throw new InvalidDataException("externalId is a required property for ExternalId and cannot be null");
            }
            else
            {
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for ExternalId and cannot be null");
            }
            else
            {
                this.Type = type;
        ...
        /// </summary>
        /// <value>The identifier used in the external system that Cumulocity IoT interfaces with.</value>
        ...
        public ExternalIdManagedObject ManagedObject { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  _ExternalId: ").Append(_ExternalId).Append("\n");
        ...
        public bool Equals(ExternalId input)
        {
            ...
            return 
                (
                    this._ExternalId == input._ExternalId ||
                    (this._ExternalId != null &&
                    this._ExternalId.Equals(input._ExternalId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this._ExternalId != null)
                    hashCode = hashCode * 59 + this._ExternalId.GetHashCode();
