...
namespace kern.services.CumulocityClient.Model
{
    ...
    public partial class ExternalId : IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="ExternalId" /> class.
        /// </summary>
        /// <param name="varExternalId">The identifier used in the external system that Cumulocity IoT interfaces with. (required).</param>
        /// <param name="managedObject">managedObject.</param>
        /// <param name="type">The type of the external identifier. (required).</param>
        public ExternalId(string varExternalId = default(string), ExternalIdManagedObject managedObject = default(ExternalIdManagedObject), string type = default(string))
        {
