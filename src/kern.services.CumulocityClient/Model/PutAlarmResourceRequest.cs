...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "putAlarmResource_request")]
    public partial class PutAlarmResourceRequest : IEquatable<PutAlarmResourceRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PutAlarmResourceRequest" /> class.
        /// </summary>
        ...
        public PutAlarmResourceRequest(SeverityEnum? severity = default(SeverityEnum?), StatusEnum? status = default(StatusEnum?), string text = default(string))
        {
        ...
        {
            return this.Equals(input as PutAlarmResourceRequest);
        }

        /// <summary>
        /// Returns true if PutAlarmResourceRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PutAlarmResourceRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PutAlarmResourceRequest input)
        {
            if (input == null)
            {
                return false;
