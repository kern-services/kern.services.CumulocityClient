...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// BinaryCollection
    /// </summary>
    [DataContract(Name = "BinaryCollection")]
    public partial class BinaryCollection : IEquatable<BinaryCollection>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BinaryCollection" /> class.
        /// </summary>
        /// <param name="managedObjects">An array containing the results (managed objects) of the request..</param>
        /// <param name="statistics">statistics.</param>
        public BinaryCollection(List<byte[]> managedObjects = default(List<byte[]>), PageStatistics statistics = default(PageStatistics))
        {
        ...
        public List<byte[]> ManagedObjects { get; set; }
        ...
        {
            return this.Equals(input as BinaryCollection);
        }

        /// <summary>
        /// Returns true if BinaryCollection instances are equal
        /// </summary>
        /// <param name="input">Instance of BinaryCollection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BinaryCollection input)
        {
            if (input == null)
            {
                return false;
