...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "c8y_HumidityMeasurement_h")]
    public partial class C8yHumidityMeasurementH : IEquatable<C8yHumidityMeasurementH>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="C8yHumidityMeasurementH" /> class.
        /// </summary>
        /// <param name="value">value.</param>
        /// <param name="unit">unit.</param>
        public C8yHumidityMeasurementH(decimal value = default(decimal), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        {
            return this.Equals(input as C8yHumidityMeasurementH);
        }

        /// <summary>
        /// Returns true if C8yHumidityMeasurementH instances are equal
        /// </summary>
        /// <param name="input">Instance of C8yHumidityMeasurementH to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(C8yHumidityMeasurementH input)
        {
            if (input == null)
            {
                return false;
