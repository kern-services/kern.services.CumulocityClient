...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpdatedDevicePermissions")]
    public partial class UpdatedDevicePermissions : IEquatable<UpdatedDevicePermissions>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdatedDevicePermissions" /> class.
        /// </summary>
        /// <param name="users">users.</param>
        /// <param name="groups">groups.</param>
        public UpdatedDevicePermissions(List<UpdatedDevicePermissionsUsersInner> users = default(List<UpdatedDevicePermissionsUsersInner>), List<UpdatedDevicePermissionsGroupsInner> groups = default(List<UpdatedDevicePermissionsGroupsInner>))
        {
            this.Users = users;
            this.Groups = groups;
        }
        ...
        public List<UpdatedDevicePermissionsUsersInner> Users { get; set; }

        /// <summary>
        /// Gets or Sets Groups
        /// </summary>
        [DataMember(Name = "groups", EmitDefaultValue = false)]
        public List<UpdatedDevicePermissionsGroupsInner> Groups { get; set; }
        ...
        {
            return this.Equals(input as UpdatedDevicePermissions);
        }

        /// <summary>
        /// Returns true if UpdatedDevicePermissions instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdatedDevicePermissions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdatedDevicePermissions input)
        {
            if (input == null)
            {
                return false;
