...
{
    /// <summary>
    /// PostAlarmCollectionResourceRequestAllOf
    /// </summary>
    [DataContract(Name = "postAlarmCollectionResource_request_allOf")]
    public partial class PostAlarmCollectionResourceRequestAllOf : IEquatable<PostAlarmCollectionResourceRequestAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostAlarmCollectionResourceRequestAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostAlarmCollectionResourceRequestAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostAlarmCollectionResourceRequestAllOf" /> class.
        /// </summary>
        /// <param name="source">source (required).</param>
        public PostAlarmCollectionResourceRequestAllOf(PostAlarmCollectionResourceRequestAllOfSource source = default(PostAlarmCollectionResourceRequestAllOfSource))
        {
            // to ensure "source" is required (not null)
            if (source == null)
            {
                throw new ArgumentNullException("source is a required property for PostAlarmCollectionResourceRequestAllOf and cannot be null");
            }
            this.Source = source;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostAlarmCollectionResourceRequestAllOf {\n");
        ...
        {
            return this.Equals(input as PostAlarmCollectionResourceRequestAllOf);
        }

        /// <summary>
        /// Returns true if PostAlarmCollectionResourceRequestAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of PostAlarmCollectionResourceRequestAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostAlarmCollectionResourceRequestAllOf input)
        {
            if (input == null)
            {
                return false;
