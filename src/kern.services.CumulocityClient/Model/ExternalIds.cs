...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// ExternalIds
    /// </summary>
    [DataContract(Name = "externalIds")]
    public partial class ExternalIds : IEquatable<ExternalIds>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExternalIds" /> class.
        /// </summary>
        /// <param name="externalIds">An array containing the details of all external IDs (if any)..</param>
        public ExternalIds(List<ExternalId> externalIds = default(List<ExternalId>))
        {
        ...
        /// </summary>
        /// <value>An array containing the details of all external IDs (if any).</value>
        [DataMember(Name = "externalIds", EmitDefaultValue = false)]
        public List<ExternalId> _ExternalIds { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  _ExternalIds: ").Append(_ExternalIds).Append("\n");
        ...
        {
            return this.Equals(input as ExternalIds);
        }

        /// <summary>
        /// Returns true if ExternalIds instances are equal
        /// </summary>
        /// <param name="input">Instance of ExternalIds to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExternalIds input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this._ExternalIds == input._ExternalIds ||
                    this._ExternalIds != null &&
                    input._ExternalIds != null &&
                    this._ExternalIds.SequenceEqual(input._ExternalIds)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this._ExternalIds.GetHashCode();
                }
                if (this.Self != null)
                {
