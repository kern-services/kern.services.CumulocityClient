...
namespace kern.services.CumulocityClient.Model
{
    ...
    public partial class ExternalIds : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExternalIds" /> class.
        /// </summary>
        /// <param name="varExternalIds">An array containing the details of all external IDs (if any)..</param>
        public ExternalIds(List<ExternalId> varExternalIds = default(List<ExternalId>))
        {
            this.VarExternalIds = varExternalIds;
        }
        ...
        public List<ExternalId> VarExternalIds { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  VarExternalIds: ").Append(VarExternalIds).Append("\n");
