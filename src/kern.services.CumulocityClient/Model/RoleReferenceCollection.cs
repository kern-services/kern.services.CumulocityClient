...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RoleReferenceCollection")]
    public partial class RoleReferenceCollection : IEquatable<RoleReferenceCollection>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RoleReferenceCollection" /> class.
        /// </summary>
        /// <param name="references">references.</param>
        /// <param name="statistics">statistics.</param>
        public RoleReferenceCollection(RoleReference references = default(RoleReference), PageStatistics statistics = default(PageStatistics))
        {
        ...
        {
            return this.Equals(input as RoleReferenceCollection);
        }

        /// <summary>
        /// Returns true if RoleReferenceCollection instances are equal
        /// </summary>
        /// <param name="input">Instance of RoleReferenceCollection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RoleReferenceCollection input)
        {
            if (input == null)
            {
                return false;
