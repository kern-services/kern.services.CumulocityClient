...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// UserGroupCollection
    /// </summary>
    [DataContract(Name = "UserGroupCollection")]
    public partial class UserGroupCollection : IEquatable<UserGroupCollection>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserGroupCollection" /> class.
        /// </summary>
        /// <param name="self">self.</param>
        /// <param name="groups">An array of user groups..</param>
        /// <param name="prev">prev.</param>
        /// <param name="next">next.</param>
        /// <param name="statistics">statistics.</param>
        public UserGroupCollection(string self = default(string), List<Group> groups = default(List<Group>), string prev = default(string), string next = default(string), PageStatistics statistics = default(PageStatistics))
        {
            this.Self = self;
            this.Groups = groups;
            this.Prev = prev;
        ...
        {
            return this.Equals(input as UserGroupCollection);
        }

        /// <summary>
        /// Returns true if UserGroupCollection instances are equal
        /// </summary>
        /// <param name="input">Instance of UserGroupCollection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserGroupCollection input)
        {
            if (input == null)
            {
                return false;
