...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "customProperties")]
    public partial class CustomProperties : Dictionary<String, Object>, IEquatable<CustomProperties>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomProperties" /> class.
        /// </summary>
        /// <param name="language">The preferred language to be used in the platform..</param>
        public CustomProperties(string language = default(string)) : base()
        {
        ...
        /// </summary>
        /// <value>The preferred language to be used in the platform.</value>
