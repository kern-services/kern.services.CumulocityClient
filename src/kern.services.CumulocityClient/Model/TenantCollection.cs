...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// TenantCollection
    /// </summary>
    [DataContract(Name = "TenantCollection")]
    public partial class TenantCollection : IEquatable<TenantCollection>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TenantCollection" /> class.
        /// </summary>
        /// <param name="statistics">statistics.</param>
        /// <param name="tenants">An array containing the results (subtenants) of the request..</param>
        public TenantCollection(PageStatistics statistics = default(PageStatistics), List<Tenant> tenants = default(List<Tenant>))
        {
        ...
        /// </summary>
        /// <value>An array containing the results (subtenants) of the request.</value>
        ...
        {
            return this.Equals(input as TenantCollection);
        }

        /// <summary>
        /// Returns true if TenantCollection instances are equal
        /// </summary>
        /// <param name="input">Instance of TenantCollection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TenantCollection input)
        {
            if (input == null)
            {
                return false;
