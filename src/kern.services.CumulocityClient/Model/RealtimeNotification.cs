...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "realtimeNotification")]
    public partial class RealtimeNotification : IEquatable<RealtimeNotification>, IValidatableObject
    {
        /// <summary>
        /// The channel name as a URI.
        /// </summary>
        /// <value>The channel name as a URI.</value>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum ChannelEnum
        {
            /// <summary>
            /// Enum Handshake for value: /meta/handshake
            /// </summary>
            [EnumMember(Value = "/meta/handshake")]
            Handshake = 1,

            /// <summary>
            /// Enum Subscribe for value: /meta/subscribe
            /// </summary>
            [EnumMember(Value = "/meta/subscribe")]
            Subscribe = 2,

            /// <summary>
            /// Enum Unsubscribe for value: /meta/unsubscribe
            /// </summary>
            [EnumMember(Value = "/meta/unsubscribe")]
            Unsubscribe = 3,

            /// <summary>
            /// Enum Connect for value: /meta/connect
            /// </summary>
            [EnumMember(Value = "/meta/connect")]
            Connect = 4,

            /// <summary>
            /// Enum Disconnect for value: /meta/disconnect
            /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RealtimeNotification" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RealtimeNotification() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RealtimeNotification" /> class.
        /// </summary>
        /// <param name="advice">advice.</param>
        /// <param name="channel">The channel name as a URI. (required).</param>
        /// <param name="connectionType">Selected connection type..</param>
        /// <param name="ext">ext.</param>
        /// <param name="id">ID of the message passed in a request. Required to match the response message..</param>
        /// <param name="minimumVersion">Minimum server-side Bayeux protocol version required by the client (in a request) or minimum client-side Bayeux protocol version required by the server (in a response)..</param>
        /// <param name="subscription">Name of the channel to subscribe to. Subscription channels are available for [Alarms](#tag/Alarm-notification-API), [Device control](#tag/Device-control-notification-API), [Events](#tag/Event-notification-API), [Inventory](#tag/Inventory-notification-API) and [Measurements](#tag/Measurement-notification-API)..</param>
        /// <param name="supportedConnectionTypes">Connection types supported by both client and server, that is, intersection between client and server options..</param>
        /// <param name="version">[Bayeux protocol](https://docs.cometd.org/current/reference/#_concepts_bayeux_protocol) version used by the client (in a request) or server (in a response). .</param>
        public RealtimeNotification(RealtimeNotificationAdvice advice = default(RealtimeNotificationAdvice), ChannelEnum channel = default(ChannelEnum), string connectionType = default(string), RealtimeNotificationExt ext = default(RealtimeNotificationExt), string id = default(string), string minimumVersion = default(string), string subscription = default(string), List<string> supportedConnectionTypes = default(List<string>), string version = default(string))
        {
        ...
        public RealtimeNotificationAdvice Advice { get; set; }

        /// <summary>
        /// Unique client ID generated by the server during handshake. Required for all other operations.
        /// </summary>
        /// <value>Unique client ID generated by the server during handshake. Required for all other operations.</value>
        ...
        /// </summary>
        /// <value>Selected connection type.</value>
        ...
        /// </summary>
        /// <value>List of notifications from the channel.</value>
        ...
        /// </summary>
        /// <value>Operation failure reason (only present if the operation was not successful).</value>
        ...
        public RealtimeNotificationExt Ext { get; set; }

        /// <summary>
        /// ID of the message passed in a request. Required to match the response message.
        /// </summary>
        /// <value>ID of the message passed in a request. Required to match the response message.</value>
        ...
        /// </summary>
        /// <value>Minimum server-side Bayeux protocol version required by the client (in a request) or minimum client-side Bayeux protocol version required by the server (in a response).</value>
        ...
        /// </summary>
        /// <value>Name of the channel to subscribe to. Subscription channels are available for [Alarms](#tag/Alarm-notification-API), [Device control](#tag/Device-control-notification-API), [Events](#tag/Event-notification-API), [Inventory](#tag/Inventory-notification-API) and [Measurements](#tag/Measurement-notification-API).</value>
        ...
        /// <summary>
        /// Returns false as Successful should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeSuccessful()
        {
            return false;
        }
        /// <summary>
        ...
        /// </summary>
        /// <value>Connection types supported by both client and server, that is, intersection between client and server options.</value>
        [DataMember(Name = "supportedConnectionTypes", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>[Bayeux protocol](https://docs.cometd.org/current/reference/#_concepts_bayeux_protocol) version used by the client (in a request) or server (in a response). </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SupportedConnectionTypes: ").Append(SupportedConnectionTypes).Append("\n");
        ...
        {
            return this.Equals(input as RealtimeNotification);
        }

        /// <summary>
        /// Returns true if RealtimeNotification instances are equal
        /// </summary>
        /// <param name="input">Instance of RealtimeNotification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RealtimeNotification input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.SupportedConnectionTypes == input.SupportedConnectionTypes ||
                    this.SupportedConnectionTypes != null &&
                    input.SupportedConnectionTypes != null &&
                    this.SupportedConnectionTypes.SequenceEqual(input.SupportedConnectionTypes)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.SupportedConnectionTypes.GetHashCode();
                }
