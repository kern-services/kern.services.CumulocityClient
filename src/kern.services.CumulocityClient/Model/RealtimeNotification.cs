...
namespace kern.services.CumulocityClient.Model
{
    ...
    public partial class RealtimeNotification : IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="varVersion">[Bayeux protocol](https://docs.cometd.org/current/reference/#_concepts_bayeux_protocol) version used by the client (in a request) or server (in a response). .</param>
        public RealtimeNotification(RealtimeNotificationAdvice advice = default(RealtimeNotificationAdvice), ChannelEnum channel = default(ChannelEnum), string connectionType = default(string), RealtimeNotificationExt ext = default(RealtimeNotificationExt), string id = default(string), string minimumVersion = default(string), string subscription = default(string), List<string> supportedConnectionTypes = default(List<string>), string varVersion = default(string))
        {
