...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// DeviceCredentials
    /// </summary>
    [DataContract(Name = "deviceCredentials")]
    public partial class DeviceCredentials : IEquatable<DeviceCredentials>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceCredentials" /> class.
        /// </summary>
        /// <param name="id">The external ID of the device..</param>
        public DeviceCredentials(string id = default(string))
        {
            this.Id = id;
        }
        ...
        {
            return this.Equals(input as DeviceCredentials);
        }

        /// <summary>
        /// Returns true if DeviceCredentials instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceCredentials to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceCredentials input)
        {
            if (input == null)
            {
                return false;
