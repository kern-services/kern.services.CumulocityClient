...
namespace kern.services.CumulocityClient.Model
{
    ...
    public partial class GetApplicationsByUserCollectionResource200Response : IEquatable<GetApplicationsByUserCollectionResource200Response>, IValidatableObject
    {
        /// <summary>
        ...
        public GetApplicationsByUserCollectionResource200Response(List<Application> applications = default(List<Application>), string next = default(string), string prev = default(string), string self = default(string), PageStatistics statistics = default(PageStatistics))
        {
        ...
        {
            return this.Equals(input as GetApplicationsByUserCollectionResource200Response);
        }

        /// <summary>
        /// Returns true if GetApplicationsByUserCollectionResource200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of GetApplicationsByUserCollectionResource200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetApplicationsByUserCollectionResource200Response input)
        {
            if (input == null)
            {
                return false;
