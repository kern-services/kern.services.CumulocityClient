...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getApplicationsByUserCollectionResource_200_response")]
    public partial class GetApplicationsByUserCollectionResource200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetApplicationsByUserCollectionResource200Response" /> class.
        /// </summary>
        /// <param name="applications">An array of applications..</param>
        /// <param name="next">next.</param>
        /// <param name="prev">prev.</param>
        /// <param name="self">self.</param>
        /// <param name="statistics">statistics.</param>
        public GetApplicationsByUserCollectionResource200Response(List<Application> applications = default(List<Application>), GetApplicationsByUserCollectionResource200ResponseAllOfNext next = default(GetApplicationsByUserCollectionResource200ResponseAllOfNext), GetApplicationsByUserCollectionResource200ResponseAllOfPrev prev = default(GetApplicationsByUserCollectionResource200ResponseAllOfPrev), GetApplicationsByUserCollectionResource200ResponseAllOfSelf self = default(GetApplicationsByUserCollectionResource200ResponseAllOfSelf), PageStatistics statistics = default(PageStatistics))
        {
        ...
        /// </summary>
        /// <value>An array of applications.</value>
        ...
        public GetApplicationsByUserCollectionResource200ResponseAllOfNext Next { get; set; }

        /// <summary>
        /// Gets or Sets Prev
        /// </summary>
        [DataMember(Name = "prev", EmitDefaultValue = false)]
        public GetApplicationsByUserCollectionResource200ResponseAllOfPrev Prev { get; set; }

        /// <summary>
        /// Gets or Sets Self
        /// </summary>
        [DataMember(Name = "self", EmitDefaultValue = false)]
        public GetApplicationsByUserCollectionResource200ResponseAllOfSelf Self { get; set; }
