...
{
    /// <summary>
    /// PostOperationCollectionResourceRequestAllOf
    /// </summary>
    [DataContract(Name = "postOperationCollectionResource_request_allOf")]
    public partial class PostOperationCollectionResourceRequestAllOf : IEquatable<PostOperationCollectionResourceRequestAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOperationCollectionResourceRequestAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public PostOperationCollectionResourceRequestAllOf()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostOperationCollectionResourceRequestAllOf {\n");
        ...
        {
            return this.Equals(input as PostOperationCollectionResourceRequestAllOf);
        }

        /// <summary>
        /// Returns true if PostOperationCollectionResourceRequestAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOperationCollectionResourceRequestAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOperationCollectionResourceRequestAllOf input)
        {
            if (input == null)
            {
                return false;
