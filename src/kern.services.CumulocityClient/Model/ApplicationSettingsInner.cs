...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApplicationSettingsInner :  IEquatable<ApplicationSettingsInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationSettingsInner" /> class.
        /// </summary>
        /// <param name="key">The name of the setting..</param>
        /// <param name="valueSchema">valueSchema.</param>
        /// <param name="defaultValue">The default value..</param>
        /// <param name="editable">Indicates if the value is editable..</param>
        /// <param name="inheritFromOwner">Indicated wether this setting is inherited..</param>
        public ApplicationSettingsInner(string key = default(string), ApplicationSettingsInnerValueSchema valueSchema = default(ApplicationSettingsInnerValueSchema), string defaultValue = default(string), bool editable = default(bool), bool inheritFromOwner = default(bool))
        {
            this.Key = key;
        ...
        /// </summary>
        [DataMember(Name="valueSchema", EmitDefaultValue=false)]
        public ApplicationSettingsInnerValueSchema ValueSchema { get; set; }
        ...
        /// </summary>
        /// <value>Indicates if the value is editable.</value>
        ...
        /// </summary>
        /// <value>Indicated wether this setting is inherited.</value>
        [DataMember(Name="inheritFromOwner", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  InheritFromOwner: ").Append(InheritFromOwner).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as ApplicationSettingsInner);
        }

        /// <summary>
        /// Returns true if ApplicationSettingsInner instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationSettingsInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationSettingsInner input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.InheritFromOwner == input.InheritFromOwner ||
                    (this.InheritFromOwner != null &&
                    this.InheritFromOwner.Equals(input.InheritFromOwner))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.InheritFromOwner != null)
                    hashCode = hashCode * 59 + this.InheritFromOwner.GetHashCode();
                return hashCode;
            }
        }
