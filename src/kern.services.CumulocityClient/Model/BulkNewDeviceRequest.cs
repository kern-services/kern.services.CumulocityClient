...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BulkNewDeviceRequest :  IEquatable<BulkNewDeviceRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BulkNewDeviceRequest" /> class.
        /// </summary>
        /// <param name="numberOfAll">Number of lines processed from the CSV file, without the first line (column headers)..</param>
        /// <param name="numberOfCreated">Number of created device credentials..</param>
        /// <param name="numberOfFailed">Number of failed creations of device credentials..</param>
        /// <param name="numberOfSuccessful">Number of successful creations of device credentials. This counts both create and update operations..</param>
        /// <param name="credentialUpdatedList">An array with the updated device credentials..</param>
        /// <param name="failedCreationList">An array with details of the failed device credentials..</param>
        public BulkNewDeviceRequest(int numberOfAll = default(int), int numberOfCreated = default(int), int numberOfFailed = default(int), int numberOfSuccessful = default(int), List<BulkNewDeviceRequestCredentialUpdatedListInner> credentialUpdatedList = default(List<BulkNewDeviceRequestCredentialUpdatedListInner>), List<BulkNewDeviceRequestFailedCreationListInner> failedCreationList = default(List<BulkNewDeviceRequestFailedCreationListInner>))
        {
        ...
        /// </summary>
        /// <value>Number of lines processed from the CSV file, without the first line (column headers).</value>
        [DataMember(Name="numberOfAll", EmitDefaultValue=false)]
        public int NumberOfAll { get; set; }

        /// <summary>
        /// Number of created device credentials.
        /// </summary>
        /// <value>Number of created device credentials.</value>
        [DataMember(Name="numberOfCreated", EmitDefaultValue=false)]
        public int NumberOfCreated { get; set; }

        /// <summary>
        /// Number of failed creations of device credentials.
        /// </summary>
        /// <value>Number of failed creations of device credentials.</value>
        [DataMember(Name="numberOfFailed", EmitDefaultValue=false)]
        ...
        /// </summary>
        /// <value>Number of successful creations of device credentials. This counts both create and update operations.</value>
        [DataMember(Name="numberOfSuccessful", EmitDefaultValue=false)]
        public int NumberOfSuccessful { get; set; }

        /// <summary>
        /// An array with the updated device credentials.
        /// </summary>
        /// <value>An array with the updated device credentials.</value>
        [DataMember(Name="credentialUpdatedList", EmitDefaultValue=false)]
        public List<BulkNewDeviceRequestCredentialUpdatedListInner> CredentialUpdatedList { get; set; }

        /// <summary>
        /// An array with details of the failed device credentials.
        /// </summary>
        /// <value>An array with details of the failed device credentials.</value>
        [DataMember(Name="failedCreationList", EmitDefaultValue=false)]
        public List<BulkNewDeviceRequestFailedCreationListInner> FailedCreationList { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  NumberOfAll: ").Append(NumberOfAll).Append("\n");
            sb.Append("  NumberOfCreated: ").Append(NumberOfCreated).Append("\n");
            sb.Append("  NumberOfFailed: ").Append(NumberOfFailed).Append("\n");
            sb.Append("  NumberOfSuccessful: ").Append(NumberOfSuccessful).Append("\n");
            sb.Append("  CredentialUpdatedList: ").Append(CredentialUpdatedList).Append("\n");
            sb.Append("  FailedCreationList: ").Append(FailedCreationList).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as BulkNewDeviceRequest);
        }

        /// <summary>
        /// Returns true if BulkNewDeviceRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of BulkNewDeviceRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BulkNewDeviceRequest input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.NumberOfAll == input.NumberOfAll ||
                    (this.NumberOfAll != null &&
                    this.NumberOfAll.Equals(input.NumberOfAll))
                ) && 
                (
                    this.NumberOfCreated == input.NumberOfCreated ||
                    (this.NumberOfCreated != null &&
                    this.NumberOfCreated.Equals(input.NumberOfCreated))
                ) && 
                (
                    this.NumberOfFailed == input.NumberOfFailed ||
                    (this.NumberOfFailed != null &&
                    this.NumberOfFailed.Equals(input.NumberOfFailed))
                ) && 
                (
                    this.NumberOfSuccessful == input.NumberOfSuccessful ||
                    (this.NumberOfSuccessful != null &&
                    this.NumberOfSuccessful.Equals(input.NumberOfSuccessful))
                ) && 
                (
                    this.CredentialUpdatedList == input.CredentialUpdatedList ||
                    this.CredentialUpdatedList != null &&
                    input.CredentialUpdatedList != null &&
                    this.CredentialUpdatedList.SequenceEqual(input.CredentialUpdatedList)
                ) && 
                (
                    this.FailedCreationList == input.FailedCreationList ||
                    this.FailedCreationList != null &&
                    input.FailedCreationList != null &&
                    this.FailedCreationList.SequenceEqual(input.FailedCreationList)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.NumberOfAll != null)
                    hashCode = hashCode * 59 + this.NumberOfAll.GetHashCode();
                if (this.NumberOfCreated != null)
                    hashCode = hashCode * 59 + this.NumberOfCreated.GetHashCode();
                if (this.NumberOfFailed != null)
                    hashCode = hashCode * 59 + this.NumberOfFailed.GetHashCode();
                if (this.NumberOfSuccessful != null)
                    hashCode = hashCode * 59 + this.NumberOfSuccessful.GetHashCode();
                if (this.CredentialUpdatedList != null)
                    hashCode = hashCode * 59 + this.CredentialUpdatedList.GetHashCode();
                if (this.FailedCreationList != null)
                    hashCode = hashCode * 59 + this.FailedCreationList.GetHashCode();
                return hashCode;
            }
        }
