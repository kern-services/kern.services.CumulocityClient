...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// UserCollection
    /// </summary>
    [DataContract(Name = "UserCollection")]
    public partial class UserCollection : IValidatableObject
    {
        /// <summary>
        ...
        public UserCollection(PageStatistics statistics = default(PageStatistics), List<User> users = default(List<User>))
        {
