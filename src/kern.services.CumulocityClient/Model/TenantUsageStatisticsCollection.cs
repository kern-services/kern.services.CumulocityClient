...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TenantUsageStatisticsCollection")]
    public partial class TenantUsageStatisticsCollection : IEquatable<TenantUsageStatisticsCollection>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TenantUsageStatisticsCollection" /> class.
        /// </summary>
        /// <param name="statistics">statistics.</param>
        /// <param name="usageStatistics">An array containing the tenant usage statistics..</param>
        public TenantUsageStatisticsCollection(PageStatistics statistics = default(PageStatistics), List<DailyUsageStatistics> usageStatistics = default(List<DailyUsageStatistics>))
        {
        ...
        /// </summary>
        /// <value>An array containing the tenant usage statistics.</value>
        ...
        {
            return this.Equals(input as TenantUsageStatisticsCollection);
        }

        /// <summary>
        /// Returns true if TenantUsageStatisticsCollection instances are equal
        /// </summary>
        /// <param name="input">Instance of TenantUsageStatisticsCollection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TenantUsageStatisticsCollection input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.UsageStatistics == input.UsageStatistics ||
                    this.UsageStatistics != null &&
                    input.UsageStatistics != null &&
                    this.UsageStatistics.SequenceEqual(input.UsageStatistics)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.UsageStatistics.GetHashCode();
                }
                return hashCode;
            }
        }
