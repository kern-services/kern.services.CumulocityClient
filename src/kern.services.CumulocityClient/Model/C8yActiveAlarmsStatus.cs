...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "c8y_ActiveAlarmsStatus")]
    public partial class C8yActiveAlarmsStatus : IEquatable<C8yActiveAlarmsStatus>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="C8yActiveAlarmsStatus" /> class.
        /// </summary>
        /// <param name="critical">critical.</param>
        /// <param name="major">major.</param>
        /// <param name="minor">minor.</param>
        /// <param name="warning">warning.</param>
        public C8yActiveAlarmsStatus(int critical = default(int), int major = default(int), int minor = default(int), int warning = default(int))
        {
        ...
        {
            return this.Equals(input as C8yActiveAlarmsStatus);
        }

        /// <summary>
        /// Returns true if C8yActiveAlarmsStatus instances are equal
        /// </summary>
        /// <param name="input">Instance of C8yActiveAlarmsStatus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(C8yActiveAlarmsStatus input)
        {
            if (input == null)
            {
                return false;
