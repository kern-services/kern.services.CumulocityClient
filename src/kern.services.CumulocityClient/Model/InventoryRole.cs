...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// An inventory role.
    /// </summary>
    [DataContract(Name = "inventoryRole")]
    public partial class InventoryRole : IEquatable<InventoryRole>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InventoryRole" /> class.
        /// </summary>
        /// <param name="description">A description for this inventory role..</param>
        /// <param name="name">The name of this inventory role..</param>
        /// <param name="permissions">A set of permissions for this inventory role..</param>
        public InventoryRole(string description = default(string), string name = default(string), List<InventoryRolePermission> permissions = default(List<InventoryRolePermission>))
        {
        ...
        {
            return this.Equals(input as InventoryRole);
        }

        /// <summary>
        /// Returns true if InventoryRole instances are equal
        /// </summary>
        /// <param name="input">Instance of InventoryRole to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InventoryRole input)
        {
            if (input == null)
            {
                return false;
