...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "deviceControlApiResource_operations")]
    public partial class DeviceControlApiResourceOperations : IEquatable<DeviceControlApiResourceOperations>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceControlApiResourceOperations" /> class.
        /// </summary>
        /// <param name="operations">An array containing the registered operations..</param>
        public DeviceControlApiResourceOperations(List<OperationReference> operations = default(List<OperationReference>))
        {
        ...
        /// </summary>
        /// <value>An array containing the registered operations.</value>
        [DataMember(Name = "operations", EmitDefaultValue = true)]
        public List<OperationReference> Operations { get; set; }
        ...
        {
            return this.Equals(input as DeviceControlApiResourceOperations);
        }

        /// <summary>
        /// Returns true if DeviceControlApiResourceOperations instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceControlApiResourceOperations to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceControlApiResourceOperations input)
        {
            if (input == null)
            {
                return false;
