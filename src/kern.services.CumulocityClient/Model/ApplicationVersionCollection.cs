...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ApplicationVersionCollection")]
    public partial class ApplicationVersionCollection : IEquatable<ApplicationVersionCollection>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationVersionCollection" /> class.
        /// </summary>
        /// <param name="versions">An array of application versions..</param>
        public ApplicationVersionCollection(List<ApplicationVersion> versions = default(List<ApplicationVersion>))
        {
        ...
        /// </summary>
        /// <value>An array of application versions.</value>
        ...
        {
            return this.Equals(input as ApplicationVersionCollection);
        }

        /// <summary>
        /// Returns true if ApplicationVersionCollection instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationVersionCollection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationVersionCollection input)
        {
            if (input == null)
            {
                return false;
