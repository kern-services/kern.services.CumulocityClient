...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "objectAssetParents")]
    public partial class ObjectAssetParents : IEquatable<ObjectAssetParents>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ObjectAssetParents" /> class.
        /// </summary>
        /// <param name="references">An array with the references to asset parent objects..</param>
        /// <param name="self">Link to this resource&#39;s asset parent objects..</param>
        public ObjectAssetParents(List<ManagedObjectReferenceTuple> references = default(List<ManagedObjectReferenceTuple>), string self = default(string))
        {
        ...
        /// </summary>
        /// <value>An array with the references to asset parent objects.</value>
        ...
        /// </summary>
        /// <value>Link to this resource&#39;s asset parent objects.</value>
        ...
        {
            return this.Equals(input as ObjectAssetParents);
        }

        /// <summary>
        /// Returns true if ObjectAssetParents instances are equal
        /// </summary>
        /// <param name="input">Instance of ObjectAssetParents to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ObjectAssetParents input)
        {
            if (input == null)
            {
                return false;
