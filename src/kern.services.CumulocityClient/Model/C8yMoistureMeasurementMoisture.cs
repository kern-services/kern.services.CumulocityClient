...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "c8y_MoistureMeasurement_moisture")]
    public partial class C8yMoistureMeasurementMoisture : IEquatable<C8yMoistureMeasurementMoisture>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="C8yMoistureMeasurementMoisture" /> class.
        /// </summary>
        /// <param name="value">value.</param>
        /// <param name="unit">unit.</param>
        public C8yMoistureMeasurementMoisture(decimal value = default(decimal), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        {
            return this.Equals(input as C8yMoistureMeasurementMoisture);
        }

        /// <summary>
        /// Returns true if C8yMoistureMeasurementMoisture instances are equal
        /// </summary>
        /// <param name="input">Instance of C8yMoistureMeasurementMoisture to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(C8yMoistureMeasurementMoisture input)
        {
            if (input == null)
            {
                return false;
