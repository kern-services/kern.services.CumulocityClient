...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inventoryRolePermission")]
    public partial class InventoryRolePermission : IEquatable<InventoryRolePermission>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The scope of this permission.</value>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum ScopeEnum
        {
            ...
            /// <summary>
            /// Enum MANAGEDOBJECT for value: MANAGED_OBJECT
            /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InventoryRolePermission" /> class.
        /// </summary>
        /// <param name="permission">The permission level..</param>
        /// <param name="scope">The scope of this permission..</param>
        /// <param name="type">The type of this permission. It can be the name of a fragment, for example, &#x60;c8y_Restart&#x60;..</param>
        public InventoryRolePermission(PermissionEnum? permission = default(PermissionEnum?), ScopeEnum? scope = default(ScopeEnum?), string type = default(string))
        {
        ...
        /// </summary>
        /// <value>A unique identifier for this permission.</value>
        ...
        /// </summary>
        /// <value>The type of this permission. It can be the name of a fragment, for example, &#x60;c8y_Restart&#x60;.</value>
        ...
        {
            return this.Equals(input as InventoryRolePermission);
        }

        /// <summary>
        /// Returns true if InventoryRolePermission instances are equal
        /// </summary>
        /// <param name="input">Instance of InventoryRolePermission to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InventoryRolePermission input)
        {
            if (input == null)
            {
                return false;
