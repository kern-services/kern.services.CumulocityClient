...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// EventCollection
    /// </summary>
    [DataContract(Name = "EventCollection")]
    public partial class EventCollection : IEquatable<EventCollection>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EventCollection" /> class.
        /// </summary>
        /// <param name="events">An array containing the results (events) of the request..</param>
        /// <param name="statistics">statistics.</param>
        public EventCollection(List<Event> events = default(List<Event>), PageStatistics statistics = default(PageStatistics))
        {
            this.Events = events;
        ...
        /// </summary>
        /// <value>An array containing the results (events) of the request.</value>
        ...
        {
            return this.Equals(input as EventCollection);
        }

        /// <summary>
        /// Returns true if EventCollection instances are equal
        /// </summary>
        /// <param name="input">Instance of EventCollection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EventCollection input)
        {
            if (input == null)
            {
                return false;
