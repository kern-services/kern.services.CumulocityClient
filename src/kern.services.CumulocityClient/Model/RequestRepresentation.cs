...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RequestRepresentation")]
    public partial class RequestRepresentation : IEquatable<RequestRepresentation>, IValidatableObject
    {
        /// <summary>
        /// HTTP request method.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RequestRepresentation" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as RequestRepresentation);
        }

        /// <summary>
        /// Returns true if RequestRepresentation instances are equal
        /// </summary>
        /// <param name="input">Instance of RequestRepresentation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RequestRepresentation input)
        {
            if (input == null)
            {
                return false;
