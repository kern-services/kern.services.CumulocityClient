...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [JsonConverter(typeof(AuditRecordChangesInnerNewValueJsonConverter))]
    [DataContract(Name = "auditRecord_changes_inner_newValue")]
    public partial class AuditRecordChangesInnerNewValue : AbstractOpenAPISchema, IEquatable<AuditRecordChangesInnerNewValue>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditRecordChangesInnerNewValue" /> class.
        /// </summary>
        public AuditRecordChangesInnerNewValue()
        {
        ...
        public AuditRecordChangesInnerNewValue(string actualInstance)
        {
            this.IsNullable = true;
            this.SchemaType= "oneOf";
        ...
        public AuditRecordChangesInnerNewValue(AuditRecordChangesInnerNewValueOneOf actualInstance)
        {
            this.IsNullable = true;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AuditRecordChangesInnerNewValue {\n");
        ...
        {
            return JsonConvert.SerializeObject(this.ActualInstance, AuditRecordChangesInnerNewValue.SerializerSettings);
        }

        /// <summary>
        /// Converts the JSON string into an instance of AuditRecordChangesInnerNewValue
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of AuditRecordChangesInnerNewValue</returns>
        public static AuditRecordChangesInnerNewValue FromJson(string jsonString)
        {
            AuditRecordChangesInnerNewValue newAuditRecordChangesInnerNewValue = null;

            if (string.IsNullOrEmpty(jsonString))
            {
                return newAuditRecordChangesInnerNewValue;
            }
            int match = 0;
            ...
            try
            {
                ...
                {
                    newAuditRecordChangesInnerNewValue = new AuditRecordChangesInnerNewValue(JsonConvert.DeserializeObject<AuditRecordChangesInnerNewValueOneOf>(jsonString, AuditRecordChangesInnerNewValue.SerializerSettings));
                }
                else
                {
                    newAuditRecordChangesInnerNewValue = new AuditRecordChangesInnerNewValue(JsonConvert.DeserializeObject<AuditRecordChangesInnerNewValueOneOf>(jsonString, AuditRecordChangesInnerNewValue.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newAuditRecordChangesInnerNewValue = new AuditRecordChangesInnerNewValue(JsonConvert.DeserializeObject<string>(jsonString, AuditRecordChangesInnerNewValue.SerializerSettings));
                }
                else
                {
                    newAuditRecordChangesInnerNewValue = new AuditRecordChangesInnerNewValue(JsonConvert.DeserializeObject<string>(jsonString, AuditRecordChangesInnerNewValue.AdditionalPropertiesSerializerSettings));
                }
        ...
        {
            return this.Equals(input as AuditRecordChangesInnerNewValue);
        }

        /// <summary>
        /// Returns true if AuditRecordChangesInnerNewValue instances are equal
        /// </summary>
        /// <param name="input">Instance of AuditRecordChangesInnerNewValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuditRecordChangesInnerNewValue input)
        {
            if (input == null)
                return false;
    ...
    /// <summary>
    /// Custom JSON converter for AuditRecordChangesInnerNewValue
    /// </summary>
    public class AuditRecordChangesInnerNewValueJsonConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            writer.WriteRawValue((string)(typeof(AuditRecordChangesInnerNewValue).GetMethod("ToJson").Invoke(value, null)));
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                return AuditRecordChangesInnerNewValue.FromJson(JObject.Load(reader).ToString(Formatting.None));
            }
            return null;
        }
