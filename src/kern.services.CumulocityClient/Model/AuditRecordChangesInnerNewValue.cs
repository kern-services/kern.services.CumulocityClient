...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AuditRecordChangesInnerNewValue :  IEquatable<AuditRecordChangesInnerNewValue>, IValidatableObject
    {
        /// <summary>
        ...
        public AuditRecordChangesInnerNewValue(string cpu = default(string), string memory = default(string))
        {
            this.Cpu = cpu;
            this.Memory = memory;
        }
