...
{
    /// <summary>
    /// GetApplicationsByOwnerCollectionResource200ResponseAllOf
    /// </summary>
    [DataContract(Name = "getApplicationsByOwnerCollectionResource_200_response_allOf")]
    public partial class GetApplicationsByOwnerCollectionResource200ResponseAllOf : IEquatable<GetApplicationsByOwnerCollectionResource200ResponseAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetApplicationsByOwnerCollectionResource200ResponseAllOf" /> class.
        /// </summary>
        /// <param name="self">self.</param>
        /// <param name="prev">prev.</param>
        /// <param name="next">next.</param>
        public GetApplicationsByOwnerCollectionResource200ResponseAllOf(string self = default(string), string prev = default(string), string next = default(string))
        {
            this.Self = self;
            this.Prev = prev;
            this.Next = next;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetApplicationsByOwnerCollectionResource200ResponseAllOf {\n");
        ...
        {
            return this.Equals(input as GetApplicationsByOwnerCollectionResource200ResponseAllOf);
        }

        /// <summary>
        /// Returns true if GetApplicationsByOwnerCollectionResource200ResponseAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of GetApplicationsByOwnerCollectionResource200ResponseAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetApplicationsByOwnerCollectionResource200ResponseAllOf input)
        {
            if (input == null)
            {
                return false;
