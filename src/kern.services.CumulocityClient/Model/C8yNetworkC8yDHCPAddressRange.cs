...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// IP address range.
    /// </summary>
    [DataContract(Name = "c8y_Network_c8y_DHCP_addressRange")]
    public partial class C8yNetworkC8yDHCPAddressRange : IEquatable<C8yNetworkC8yDHCPAddressRange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="C8yNetworkC8yDHCPAddressRange" /> class.
        /// </summary>
        /// <param name="start">Start of address range assigned to DHCP clients..</param>
        /// <param name="end">End of address range assigned to DHCP clients..</param>
        public C8yNetworkC8yDHCPAddressRange(string start = default(string), string end = default(string))
        {
            this.Start = start;
            this.End = end;
        }
        ...
        /// </summary>
        /// <value>Start of address range assigned to DHCP clients.</value>
        ...
        /// </summary>
        /// <value>End of address range assigned to DHCP clients.</value>
        ...
        {
            return this.Equals(input as C8yNetworkC8yDHCPAddressRange);
        }

        /// <summary>
        /// Returns true if C8yNetworkC8yDHCPAddressRange instances are equal
        /// </summary>
        /// <param name="input">Instance of C8yNetworkC8yDHCPAddressRange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(C8yNetworkC8yDHCPAddressRange input)
        {
            if (input == null)
            {
                return false;
