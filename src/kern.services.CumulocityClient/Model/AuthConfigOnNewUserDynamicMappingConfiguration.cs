...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AuthConfigOnNewUserDynamicMappingConfiguration :  IEquatable<AuthConfigOnNewUserDynamicMappingConfiguration>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthConfigOnNewUserDynamicMappingConfiguration" /> class.
        /// </summary>
        /// <param name="mapRolesOnlyForNewUser">Indicates whether the mapping should be evaluated always or only during the first external login when the internal user is created..</param>
        public AuthConfigOnNewUserDynamicMappingConfiguration(bool mapRolesOnlyForNewUser = default(bool))
        {
        ...
        /// </summary>
        /// <value>Indicates whether the mapping should be evaluated always or only during the first external login when the internal user is created.</value>
        [DataMember(Name="mapRolesOnlyForNewUser", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  MapRolesOnlyForNewUser: ").Append(MapRolesOnlyForNewUser).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as AuthConfigOnNewUserDynamicMappingConfiguration);
        }

        /// <summary>
        /// Returns true if AuthConfigOnNewUserDynamicMappingConfiguration instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthConfigOnNewUserDynamicMappingConfiguration to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthConfigOnNewUserDynamicMappingConfiguration input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.MapRolesOnlyForNewUser == input.MapRolesOnlyForNewUser ||
                    (this.MapRolesOnlyForNewUser != null &&
                    this.MapRolesOnlyForNewUser.Equals(input.MapRolesOnlyForNewUser))
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.MapRolesOnlyForNewUser != null)
                    hashCode = hashCode * 59 + this.MapRolesOnlyForNewUser.GetHashCode();
                return hashCode;
            }
        }
