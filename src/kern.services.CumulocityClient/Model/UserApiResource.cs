...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// UserApiResource
    /// </summary>
    [DataContract(Name = "userApiResource")]
    public partial class UserApiResource : IEquatable<UserApiResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserApiResource" /> class.
        /// </summary>
        /// <param name="users">Collection of all users belonging to a given tenant..</param>
        /// <param name="userByName">Reference to a resource of type user..</param>
        /// <param name="currentUser">Reference to the resource of the logged in user..</param>
        /// <param name="groups">Collection of all users belonging to a given tenant..</param>
        /// <param name="groupByName">Reference to a resource of type group..</param>
        /// <param name="roles">Collection of all roles..</param>
        public UserApiResource(string users = default(string), string userByName = default(string), string currentUser = default(string), string groups = default(string), string groupByName = default(string), string roles = default(string))
        {
            this.Users = users;
        ...
        /// </summary>
        /// <value>Collection of all users belonging to a given tenant.</value>
        ...
        /// </summary>
        /// <value>Reference to a resource of type user.</value>
        [DataMember(Name = "userByName", EmitDefaultValue = false)]
        public string UserByName { get; set; }

        /// <summary>
        /// Reference to the resource of the logged in user.
        /// </summary>
        /// <value>Reference to the resource of the logged in user.</value>
        ...
        /// </summary>
        /// <value>Reference to a resource of type group.</value>
        [DataMember(Name = "groupByName", EmitDefaultValue = false)]
        public string GroupByName { get; set; }

        /// <summary>
        /// Collection of all roles.
        /// </summary>
        /// <value>Collection of all roles.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  UserByName: ").Append(UserByName).Append("\n");
            sb.Append("  CurrentUser: ").Append(CurrentUser).Append("\n");
            sb.Append("  Groups: ").Append(Groups).Append("\n");
            sb.Append("  GroupByName: ").Append(GroupByName).Append("\n");
        ...
        {
            return this.Equals(input as UserApiResource);
        }

        /// <summary>
        /// Returns true if UserApiResource instances are equal
        /// </summary>
        /// <param name="input">Instance of UserApiResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserApiResource input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.UserByName == input.UserByName ||
                    (this.UserByName != null &&
                    this.UserByName.Equals(input.UserByName))
                ) && 
                (
                ...
                (
                    this.GroupByName == input.GroupByName ||
                    (this.GroupByName != null &&
                    this.GroupByName.Equals(input.GroupByName))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.UserByName != null)
                {
                    hashCode = (hashCode * 59) + this.UserByName.GetHashCode();
                }
                ...
                if (this.GroupByName != null)
                {
                    hashCode = (hashCode * 59) + this.GroupByName.GetHashCode();
                }
                if (this.Roles != null)
                {
