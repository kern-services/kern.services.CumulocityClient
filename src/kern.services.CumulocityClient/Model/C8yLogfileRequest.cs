...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "c8y_LogfileRequest")]
    public partial class C8yLogfileRequest : IEquatable<C8yLogfileRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="C8yLogfileRequest" /> class.
        /// </summary>
        /// <param name="logFile">Indicates the log file to select..</param>
        /// <param name="dateFrom">Start date and time of log entries in the log file to be sent..</param>
        /// <param name="dateTo">End date and time of log entries in the log file to be sent..</param>
        /// <param name="searchText">Provide a text that needs to be present in the log entry..</param>
        /// <param name="maximumLines">Upper limit of the number of lines that should be sent to Cumulocity IoT after filtering..</param>
        public C8yLogfileRequest(string logFile = default(string), DateTime dateFrom = default(DateTime), DateTime dateTo = default(DateTime), string searchText = default(string), int maximumLines = default(int))
        {
        ...
        /// </summary>
        /// <value>Indicates the log file to select.</value>
        ...
        /// </summary>
        /// <value>Start date and time of log entries in the log file to be sent.</value>
        ...
        /// </summary>
        /// <value>End date and time of log entries in the log file to be sent.</value>
        ...
        /// </summary>
        /// <value>Provide a text that needs to be present in the log entry.</value>
        ...
        /// </summary>
        /// <value>Upper limit of the number of lines that should be sent to Cumulocity IoT after filtering.</value>
        [DataMember(Name = "maximumLines", EmitDefaultValue = false)]
        public int MaximumLines { get; set; }

        /// <summary>
        /// A link to the log file request.
        /// </summary>
        /// <value>A link to the log file request.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  MaximumLines: ").Append(MaximumLines).Append("\n");
        ...
        {
            return this.Equals(input as C8yLogfileRequest);
        }

        /// <summary>
        /// Returns true if C8yLogfileRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of C8yLogfileRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(C8yLogfileRequest input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.MaximumLines == input.MaximumLines ||
                    this.MaximumLines.Equals(input.MaximumLines)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.MaximumLines.GetHashCode();
                if (this.File != null)
                {
