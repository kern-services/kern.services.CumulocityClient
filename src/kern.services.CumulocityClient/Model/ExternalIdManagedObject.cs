...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "externalId_managedObject")]
    public partial class ExternalIdManagedObject : IEquatable<ExternalIdManagedObject>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExternalIdManagedObject" /> class.
        /// </summary>
        /// <param name="id">Unique identifier of the object..</param>
        public ExternalIdManagedObject(string id = default(string))
        {
            this.Id = id;
        }
        ...
        {
            return this.Equals(input as ExternalIdManagedObject);
        }

        /// <summary>
        /// Returns true if ExternalIdManagedObject instances are equal
        /// </summary>
        /// <param name="input">Instance of ExternalIdManagedObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExternalIdManagedObject input)
        {
            if (input == null)
            {
                return false;
