...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ManagedObjectReferenceCollection_references_inner")]
    public partial class ManagedObjectReferenceCollectionReferencesInner : IEquatable<ManagedObjectReferenceCollectionReferencesInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ManagedObjectReferenceCollectionReferencesInner" /> class.
        /// </summary>
        /// <param name="managedObject">managedObject.</param>
        public ManagedObjectReferenceCollectionReferencesInner(ManagedObject managedObject = default(ManagedObject))
        {
        ...
        {
            return this.Equals(input as ManagedObjectReferenceCollectionReferencesInner);
        }

        /// <summary>
        /// Returns true if ManagedObjectReferenceCollectionReferencesInner instances are equal
        /// </summary>
        /// <param name="input">Instance of ManagedObjectReferenceCollectionReferencesInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ManagedObjectReferenceCollectionReferencesInner input)
        {
            if (input == null)
            {
                return false;
