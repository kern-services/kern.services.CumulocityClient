...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// ManagedObject
    /// </summary>
    [DataContract(Name = "managedObject")]
    public partial class ManagedObject : Dictionary<String, Object>, IEquatable<ManagedObject>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ManagedObject" /> class.
        /// </summary>
        /// <param name="name">Human-readable name that is used for representing the object in user interfaces..</param>
        /// <param name="type">The fragment type can be interpreted as _device class_, this means, devices with the same type can receive the same types of configuration, software, firmware and operations. The type value is indexed and is therefore used for queries..</param>
        /// <param name="childAdditions">childAdditions.</param>
        /// <param name="childAssets">childAssets.</param>
        /// <param name="childDevices">childDevices.</param>
        /// <param name="additionParents">additionParents.</param>
        /// <param name="assetParents">assetParents.</param>
        /// <param name="deviceParents">deviceParents.</param>
        /// <param name="c8yIsDevice">A fragment which identifies this managed object as a device..</param>
        /// <param name="c8yDeviceTypes">This fragment must be added in order to publish sample commands for a subset of devices sharing the same device type. If the fragment is present, the list of sample commands for a device type will be extended with the sample commands for the &#x60;c8y_DeviceTypes&#x60;. New sample commands created from the user interface will be created in the context of the &#x60;c8y_DeviceTypes&#x60;..</param>
        /// <param name="c8ySupportedOperations">Lists the operations that are available for a particular device, so that applications can trigger the operations..</param>
        public ManagedObject(string name = default(string), string type = default(string), ObjectChildAdditions childAdditions = default(ObjectChildAdditions), ObjectChildAssets childAssets = default(ObjectChildAssets), ObjectChildDevices childDevices = default(ObjectChildDevices), ObjectAdditionParents additionParents = default(ObjectAdditionParents), ObjectAssetParents assetParents = default(ObjectAssetParents), ObjectDeviceParents deviceParents = default(ObjectDeviceParents), Object c8yIsDevice = default(Object), List<string> c8yDeviceTypes = default(List<string>), List<string> c8ySupportedOperations = default(List<string>)) : base()
        {
            this.Name = name;
            this.Type = type;
        ...
        /// </summary>
        /// <value>The date and time when the object was updated for the last time.</value>
        ...
        /// </summary>
        /// <value>Human-readable name that is used for representing the object in user interfaces.</value>
        ...
        /// </summary>
        /// <value>Username of the device&#39;s owner.</value>
        ...
        /// </summary>
        /// <value>The fragment type can be interpreted as _device class_, this means, devices with the same type can receive the same types of configuration, software, firmware and operations. The type value is indexed and is therefore used for queries.</value>
        [DataMember(Name = "type", EmitDefaultValue = false)]
        public string Type { get; set; }

        /// <summary>
        /// Gets or Sets ChildAdditions
        /// </summary>
        [DataMember(Name = "childAdditions", EmitDefaultValue = false)]
        public ObjectChildAdditions ChildAdditions { get; set; }

        /// <summary>
        /// Gets or Sets ChildAssets
        /// </summary>
        [DataMember(Name = "childAssets", EmitDefaultValue = false)]
        public ObjectChildAssets ChildAssets { get; set; }

        /// <summary>
        /// Gets or Sets ChildDevices
        /// </summary>
        [DataMember(Name = "childDevices", EmitDefaultValue = false)]
        public ObjectChildDevices ChildDevices { get; set; }

        /// <summary>
        /// Gets or Sets AdditionParents
        /// </summary>
        [DataMember(Name = "additionParents", EmitDefaultValue = false)]
        public ObjectAdditionParents AdditionParents { get; set; }

        /// <summary>
        /// Gets or Sets AssetParents
        /// </summary>
        [DataMember(Name = "assetParents", EmitDefaultValue = false)]
        public ObjectAssetParents AssetParents { get; set; }

        /// <summary>
        /// Gets or Sets DeviceParents
        /// </summary>
        [DataMember(Name = "deviceParents", EmitDefaultValue = false)]
        public ObjectDeviceParents DeviceParents { get; set; }

        /// <summary>
        /// A fragment which identifies this managed object as a device.
        /// </summary>
        /// <value>A fragment which identifies this managed object as a device.</value>
        [DataMember(Name = "c8y_IsDevice", EmitDefaultValue = false)]
        public Object C8yIsDevice { get; set; }
        ...
        /// </summary>
        /// <value>This fragment must be added in order to publish sample commands for a subset of devices sharing the same device type. If the fragment is present, the list of sample commands for a device type will be extended with the sample commands for the &#x60;c8y_DeviceTypes&#x60;. New sample commands created from the user interface will be created in the context of the &#x60;c8y_DeviceTypes&#x60;.</value>
        [DataMember(Name = "c8y_DeviceTypes", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>Lists the operations that are available for a particular device, so that applications can trigger the operations.</value>
        [DataMember(Name = "c8y_SupportedOperations", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ChildAdditions: ").Append(ChildAdditions).Append("\n");
            sb.Append("  ChildAssets: ").Append(ChildAssets).Append("\n");
            sb.Append("  ChildDevices: ").Append(ChildDevices).Append("\n");
            sb.Append("  AdditionParents: ").Append(AdditionParents).Append("\n");
            sb.Append("  AssetParents: ").Append(AssetParents).Append("\n");
            sb.Append("  DeviceParents: ").Append(DeviceParents).Append("\n");
            sb.Append("  C8yIsDevice: ").Append(C8yIsDevice).Append("\n");
            sb.Append("  C8yDeviceTypes: ").Append(C8yDeviceTypes).Append("\n");
            sb.Append("  C8ySupportedOperations: ").Append(C8ySupportedOperations).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as ManagedObject);
        }

        /// <summary>
        /// Returns true if ManagedObject instances are equal
        /// </summary>
        /// <param name="input">Instance of ManagedObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ManagedObject input)
        {
            if (input == null)
            {
                return false;
            ...
            return base.Equals(input) && 
                ...
                (
                    this.ChildAdditions == input.ChildAdditions ||
                    (this.ChildAdditions != null &&
                    this.ChildAdditions.Equals(input.ChildAdditions))
                ) && base.Equals(input) && 
                (
                    this.ChildAssets == input.ChildAssets ||
                    (this.ChildAssets != null &&
                    this.ChildAssets.Equals(input.ChildAssets))
                ) && base.Equals(input) && 
                (
                    this.ChildDevices == input.ChildDevices ||
                    (this.ChildDevices != null &&
                    this.ChildDevices.Equals(input.ChildDevices))
                ) && base.Equals(input) && 
                (
                    this.AdditionParents == input.AdditionParents ||
                    (this.AdditionParents != null &&
                    this.AdditionParents.Equals(input.AdditionParents))
                ) && base.Equals(input) && 
                (
                    this.AssetParents == input.AssetParents ||
                    (this.AssetParents != null &&
                    this.AssetParents.Equals(input.AssetParents))
                ) && base.Equals(input) && 
                (
                    this.DeviceParents == input.DeviceParents ||
                    (this.DeviceParents != null &&
                    this.DeviceParents.Equals(input.DeviceParents))
                ) && base.Equals(input) && 
                (
                    this.C8yIsDevice == input.C8yIsDevice ||
                    (this.C8yIsDevice != null &&
                    this.C8yIsDevice.Equals(input.C8yIsDevice))
                ) && base.Equals(input) && 
                (
                    this.C8yDeviceTypes == input.C8yDeviceTypes ||
                    this.C8yDeviceTypes != null &&
                    input.C8yDeviceTypes != null &&
                    this.C8yDeviceTypes.SequenceEqual(input.C8yDeviceTypes)
                ) && base.Equals(input) && 
                (
                    this.C8ySupportedOperations == input.C8ySupportedOperations ||
                    this.C8ySupportedOperations != null &&
                    input.C8ySupportedOperations != null &&
                    this.C8ySupportedOperations.SequenceEqual(input.C8ySupportedOperations)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.ChildAdditions.GetHashCode();
                }
                ...
                if (this.AdditionParents != null)
                {
                    hashCode = (hashCode * 59) + this.AdditionParents.GetHashCode();
                }
                if (this.AssetParents != null)
                {
                    hashCode = (hashCode * 59) + this.AssetParents.GetHashCode();
                }
                if (this.DeviceParents != null)
                {
                    hashCode = (hashCode * 59) + this.DeviceParents.GetHashCode();
                }
                if (this.C8yIsDevice != null)
                {
                    hashCode = (hashCode * 59) + this.C8yIsDevice.GetHashCode();
                }
                if (this.C8yDeviceTypes != null)
                {
                    hashCode = (hashCode * 59) + this.C8yDeviceTypes.GetHashCode();
                }
                if (this.C8ySupportedOperations != null)
                {
                    hashCode = (hashCode * 59) + this.C8ySupportedOperations.GetHashCode();
                }
                return hashCode;
            }
        }
