...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ApplicationCollection")]
    public partial class ApplicationCollection : IEquatable<ApplicationCollection>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationCollection" /> class.
        /// </summary>
        /// <param name="applications">An array of applications..</param>
        /// <param name="statistics">statistics.</param>
        public ApplicationCollection(List<Application> applications = default(List<Application>), PageStatistics statistics = default(PageStatistics))
        {
        ...
        {
            return this.Equals(input as ApplicationCollection);
        }

        /// <summary>
        /// Returns true if ApplicationCollection instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationCollection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationCollection input)
        {
            if (input == null)
            {
                return false;
