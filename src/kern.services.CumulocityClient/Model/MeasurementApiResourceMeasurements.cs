...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "measurementApiResource_measurements")]
    public partial class MeasurementApiResourceMeasurements : IEquatable<MeasurementApiResourceMeasurements>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MeasurementApiResourceMeasurements" /> class.
        /// </summary>
        /// <param name="measurements">measurements.</param>
        public MeasurementApiResourceMeasurements(List<Measurement> measurements = default(List<Measurement>))
        {
        ...
        {
            return this.Equals(input as MeasurementApiResourceMeasurements);
        }

        /// <summary>
        /// Returns true if MeasurementApiResourceMeasurements instances are equal
        /// </summary>
        /// <param name="input">Instance of MeasurementApiResourceMeasurements to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MeasurementApiResourceMeasurements input)
        {
            if (input == null)
            {
                return false;
