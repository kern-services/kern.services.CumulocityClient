...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// Current measurement.
    /// </summary>
    [DataContract(Name = "c8y_CurrentMeasurement")]
    public partial class C8yCurrentMeasurement : IEquatable<C8yCurrentMeasurement>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="C8yCurrentMeasurement" /> class.
        /// </summary>
        /// <param name="current">current.</param>
        public C8yCurrentMeasurement(C8yCurrentMeasurementCurrent current = default(C8yCurrentMeasurementCurrent))
        {
        ...
        public C8yCurrentMeasurementCurrent Current { get; set; }
        ...
        {
            return this.Equals(input as C8yCurrentMeasurement);
        }

        /// <summary>
        /// Returns true if C8yCurrentMeasurement instances are equal
        /// </summary>
        /// <param name="input">Instance of C8yCurrentMeasurement to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(C8yCurrentMeasurement input)
        {
            if (input == null)
            {
                return false;
