...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NotificationApiResource_notificationSubscriptions")]
    public partial class NotificationApiResourceNotificationSubscriptions : IEquatable<NotificationApiResourceNotificationSubscriptions>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NotificationApiResourceNotificationSubscriptions" /> class.
        /// </summary>
        /// <param name="subscriptions">subscriptions.</param>
        public NotificationApiResourceNotificationSubscriptions(List<NotificationSubscription> subscriptions = default(List<NotificationSubscription>))
        {
        ...
        {
            return this.Equals(input as NotificationApiResourceNotificationSubscriptions);
        }

        /// <summary>
        /// Returns true if NotificationApiResourceNotificationSubscriptions instances are equal
        /// </summary>
        /// <param name="input">Instance of NotificationApiResourceNotificationSubscriptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NotificationApiResourceNotificationSubscriptions input)
        {
            if (input == null)
            {
                return false;
