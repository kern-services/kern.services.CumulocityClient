...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// RoleReference
    /// </summary>
    [DataContract(Name = "roleReference")]
    public partial class RoleReference : IEquatable<RoleReference>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RoleReference" /> class.
        /// </summary>
        /// <param name="role">role.</param>
        public RoleReference(Role role = default(Role))
        {
            this.Role = role;
        }
        ...
        {
            return this.Equals(input as RoleReference);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(RoleReference input)
        {
            if (input == null)
            {
                return false;
