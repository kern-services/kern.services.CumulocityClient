...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// EventBinary
    /// </summary>
    [DataContract(Name = "eventBinary")]
    public partial class EventBinary : IEquatable<EventBinary>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EventBinary" /> class.
        /// </summary>
        /// <param name="name">Name of the attachment. If it is not provided in the request, it will be set as the event ID..</param>
        /// <param name="type">Media type of the attachment..</param>
        public EventBinary(string name = default(string), string type = default(string))
        {
            this.Name = name;
            this.Type = type;
        }
        ...
        /// </summary>
        /// <value>Name of the attachment. If it is not provided in the request, it will be set as the event ID.</value>
        ...
        /// </summary>
        /// <value>Media type of the attachment.</value>
        ...
        {
            return this.Equals(input as EventBinary);
        }

        /// <summary>
        /// Returns true if EventBinary instances are equal
        /// </summary>
        /// <param name="input">Instance of EventBinary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EventBinary input)
        {
            if (input == null)
            {
                return false;
