...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "currentUserTotpSecret")]
    public partial class CurrentUserTotpSecret : IEquatable<CurrentUserTotpSecret>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CurrentUserTotpSecret" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public CurrentUserTotpSecret()
        {
        }
        ...
        /// </summary>
        /// <value>Secret used by two-factor authentication applications to generate the TFA codes.</value>
        [DataMember(Name = "rawSecret", EmitDefaultValue = false)]
        public string RawSecret { get; private set; }

        /// <summary>
        /// Returns false as RawSecret should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeRawSecret()
        {
            return false;
        }
        /// <summary>
        ...
        /// </summary>
        /// <value>URL used to set the two-factor authentication secret for the TFA application.</value>
        [DataMember(Name = "secretQrUrl", EmitDefaultValue = false)]
        public string SecretQrUrl { get; private set; }

        /// <summary>
        /// Returns false as SecretQrUrl should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeSecretQrUrl()
        {
            return false;
        }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SecretQrUrl: ").Append(SecretQrUrl).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as CurrentUserTotpSecret);
        }

        /// <summary>
        /// Returns true if CurrentUserTotpSecret instances are equal
        /// </summary>
        /// <param name="input">Instance of CurrentUserTotpSecret to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CurrentUserTotpSecret input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.RawSecret == input.RawSecret ||
                    (this.RawSecret != null &&
                    this.RawSecret.Equals(input.RawSecret))
                ) && 
                (
                    this.SecretQrUrl == input.SecretQrUrl ||
                    (this.SecretQrUrl != null &&
                    this.SecretQrUrl.Equals(input.SecretQrUrl))
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.RawSecret != null)
                {
                    hashCode = (hashCode * 59) + this.RawSecret.GetHashCode();
                }
                if (this.SecretQrUrl != null)
                {
                    hashCode = (hashCode * 59) + this.SecretQrUrl.GetHashCode();
                }
                return hashCode;
            }
        }
