...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ApplicationBinaries_attachments_inner")]
    public partial class ApplicationBinariesAttachmentsInner : IEquatable<ApplicationBinariesAttachmentsInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationBinariesAttachmentsInner" /> class.
        /// </summary>
        /// <param name="contextPath">The application context path..</param>
        /// <param name="created">The date and time when the attachment was created..</param>
        /// <param name="description">A description for the attachment..</param>
        /// <param name="downloadUrl">A download URL for the attachment..</param>
        /// <param name="id">The ID of the attachment..</param>
        /// <param name="length">The length of the attachment, in bytes..</param>
        /// <param name="name">The name of the attachment..</param>
        public ApplicationBinariesAttachmentsInner(string contextPath = default(string), DateTime created = default(DateTime), string description = default(string), string downloadUrl = default(string), string id = default(string), int length = default(int), string name = default(string))
        {
        ...
        /// </summary>
        /// <value>The application context path.</value>
        ...
        /// </summary>
        /// <value>The date and time when the attachment was created.</value>
        ...
        /// </summary>
        /// <value>A description for the attachment.</value>
        ...
        /// </summary>
        /// <value>A download URL for the attachment.</value>
        ...
        /// </summary>
        /// <value>The length of the attachment, in bytes.</value>
        ...
        {
            return this.Equals(input as ApplicationBinariesAttachmentsInner);
        }

        /// <summary>
        /// Returns true if ApplicationBinariesAttachmentsInner instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationBinariesAttachmentsInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationBinariesAttachmentsInner input)
        {
            if (input == null)
            {
                return false;
