...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "application_settings_inner_valueSchema")]
    public partial class ApplicationSettingsInnerValueSchema : IEquatable<ApplicationSettingsInnerValueSchema>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationSettingsInnerValueSchema" /> class.
        /// </summary>
        /// <param name="type">The value schema type..</param>
        public ApplicationSettingsInnerValueSchema(string type = default(string))
        {
            this.Type = type;
        }
        ...
        /// </summary>
        /// <value>The value schema type.</value>
        ...
        {
            return this.Equals(input as ApplicationSettingsInnerValueSchema);
        }

        /// <summary>
        /// Returns true if ApplicationSettingsInnerValueSchema instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationSettingsInnerValueSchema to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationSettingsInnerValueSchema input)
        {
            if (input == null)
            {
                return false;
