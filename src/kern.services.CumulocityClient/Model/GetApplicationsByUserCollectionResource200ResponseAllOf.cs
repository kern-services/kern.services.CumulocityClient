...
{
    /// <summary>
    /// GetApplicationsByUserCollectionResource200ResponseAllOf
    /// </summary>
    [DataContract(Name = "getApplicationsByUserCollectionResource_200_response_allOf")]
    public partial class GetApplicationsByUserCollectionResource200ResponseAllOf : IEquatable<GetApplicationsByUserCollectionResource200ResponseAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetApplicationsByUserCollectionResource200ResponseAllOf" /> class.
        /// </summary>
        /// <param name="self">self.</param>
        /// <param name="prev">prev.</param>
        /// <param name="next">next.</param>
        public GetApplicationsByUserCollectionResource200ResponseAllOf(string self = default(string), string prev = default(string), string next = default(string))
        {
            this.Self = self;
            this.Prev = prev;
            this.Next = next;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetApplicationsByUserCollectionResource200ResponseAllOf {\n");
        ...
        {
            return this.Equals(input as GetApplicationsByUserCollectionResource200ResponseAllOf);
        }

        /// <summary>
        /// Returns true if GetApplicationsByUserCollectionResource200ResponseAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of GetApplicationsByUserCollectionResource200ResponseAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetApplicationsByUserCollectionResource200ResponseAllOf input)
        {
            if (input == null)
            {
                return false;
