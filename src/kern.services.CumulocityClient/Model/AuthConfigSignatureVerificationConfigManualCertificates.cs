...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "authConfig_signatureVerificationConfig_manual_certificates")]
    public partial class AuthConfigSignatureVerificationConfigManualCertificates : IEquatable<AuthConfigSignatureVerificationConfigManualCertificates>, IValidatableObject
    {
        /// <summary>
        /// The signing algorithm of the JWT access token.
        /// </summary>
        /// <value>The signing algorithm of the JWT access token.</value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthConfigSignatureVerificationConfigManualCertificates" /> class.
        /// </summary>
        /// <param name="alg">The signing algorithm of the JWT access token..</param>
        /// <param name="publicKey">The public key certificate..</param>
        /// <param name="validFrom">The validity start date of the certificate..</param>
        /// <param name="validTill">The expiry date of the certificate..</param>
        public AuthConfigSignatureVerificationConfigManualCertificates(AlgEnum? alg = default(AlgEnum?), string publicKey = default(string), DateTime validFrom = default(DateTime), DateTime validTill = default(DateTime))
        {
            this.Alg = alg;
        ...
        /// </summary>
        /// <value>The public key certificate.</value>
        ...
        /// </summary>
        /// <value>The validity start date of the certificate.</value>
        ...
        /// </summary>
        /// <value>The expiry date of the certificate.</value>
        ...
        {
            return this.Equals(input as AuthConfigSignatureVerificationConfigManualCertificates);
        }

        /// <summary>
        /// Returns true if AuthConfigSignatureVerificationConfigManualCertificates instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthConfigSignatureVerificationConfigManualCertificates to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthConfigSignatureVerificationConfigManualCertificates input)
        {
            if (input == null)
            {
                return false;
