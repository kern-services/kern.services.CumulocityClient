...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// TrustedCertificate
    /// </summary>
    [DataContract(Name = "TrustedCertificate")]
    public partial class TrustedCertificate : IEquatable<TrustedCertificate>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TrustedCertificate" /> class.
        /// </summary>
        ...
        /// <param name="certInPemFormat">Trusted certificate in PEM format..</param>
        ...
        public TrustedCertificate(bool autoRegistrationEnabled = false, string certInPemFormat = default(string), string name = default(string), StatusEnum? status = default(StatusEnum?))
        {
        ...
        /// </summary>
        /// <value>Trusted certificate in PEM format.</value>
        [DataMember(Name = "certInPemFormat", EmitDefaultValue = false)]
        ...
        {
            return this.Equals(input as TrustedCertificate);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(TrustedCertificate input)
        {
            if (input == null)
            {
                return false;
