...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "bulkNewDeviceRequest_failedCreationList_inner")]
    public partial class BulkNewDeviceRequestFailedCreationListInner : IEquatable<BulkNewDeviceRequestFailedCreationListInner>, IValidatableObject
    {
        /// <summary>
        /// The device credentials creation status.
        /// </summary>
        /// <value>The device credentials creation status.</value>
        ...
        public enum BulkNewDeviceStatusEnum
        {
            ...
            /// <summary>
            /// Enum CREDENTIALUPDATED for value: CREDENTIAL_UPDATED
            /// </summary>
        ...
        /// </summary>
        /// <value>The device credentials creation status.</value>
        [DataMember(Name = "bulkNewDeviceStatus", EmitDefaultValue = false)]
        public BulkNewDeviceStatusEnum? BulkNewDeviceStatus { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="BulkNewDeviceRequestFailedCreationListInner" /> class.
        /// </summary>
        /// <param name="bulkNewDeviceStatus">The device credentials creation status..</param>
        /// <param name="deviceId">Unique identifier of the device..</param>
        /// <param name="failureReason">Reason for the failure..</param>
        /// <param name="line">Line where the failure occurred..</param>
        public BulkNewDeviceRequestFailedCreationListInner(BulkNewDeviceStatusEnum? bulkNewDeviceStatus = default(BulkNewDeviceStatusEnum?), string deviceId = default(string), string failureReason = default(string), string line = default(string))
        {
        ...
        /// </summary>
        /// <value>Line where the failure occurred.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  BulkNewDeviceStatus: ").Append(BulkNewDeviceStatus).Append("\n");
        ...
        {
            return this.Equals(input as BulkNewDeviceRequestFailedCreationListInner);
        }

        /// <summary>
        /// Returns true if BulkNewDeviceRequestFailedCreationListInner instances are equal
        /// </summary>
        /// <param name="input">Instance of BulkNewDeviceRequestFailedCreationListInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BulkNewDeviceRequestFailedCreationListInner input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.BulkNewDeviceStatus == input.BulkNewDeviceStatus ||
                    this.BulkNewDeviceStatus.Equals(input.BulkNewDeviceStatus)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                hashCode = (hashCode * 59) + this.BulkNewDeviceStatus.GetHashCode();
