...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inventoryAssignment")]
    public partial class InventoryAssignment : IEquatable<InventoryAssignment>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InventoryAssignment" /> class.
        /// </summary>
        /// <param name="managedObject">A unique identifier for the managed object for which the roles are assigned..</param>
        /// <param name="roles">An array of roles that are assigned to the managed object for the user..</param>
        public InventoryAssignment(string managedObject = default(string), List<InventoryRole> roles = default(List<InventoryRole>))
        {
        ...
        /// </summary>
        /// <value>An array of roles that are assigned to the managed object for the user.</value>
        ...
        {
            return this.Equals(input as InventoryAssignment);
        }

        /// <summary>
        /// Returns true if InventoryAssignment instances are equal
        /// </summary>
        /// <param name="input">Instance of InventoryAssignment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InventoryAssignment input)
        {
            if (input == null)
            {
                return false;
