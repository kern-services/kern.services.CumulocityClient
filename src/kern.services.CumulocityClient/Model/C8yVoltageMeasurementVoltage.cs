...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "c8y_VoltageMeasurement_voltage")]
    public partial class C8yVoltageMeasurementVoltage : IEquatable<C8yVoltageMeasurementVoltage>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="C8yVoltageMeasurementVoltage" /> class.
        /// </summary>
        /// <param name="value">value.</param>
        /// <param name="unit">unit.</param>
        public C8yVoltageMeasurementVoltage(decimal value = default(decimal), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        {
            return this.Equals(input as C8yVoltageMeasurementVoltage);
        }

        /// <summary>
        /// Returns true if C8yVoltageMeasurementVoltage instances are equal
        /// </summary>
        /// <param name="input">Instance of C8yVoltageMeasurementVoltage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(C8yVoltageMeasurementVoltage input)
        {
            if (input == null)
            {
                return false;
