...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "childOperationsAddMultiple_references_inner_managedObject")]
    public partial class ChildOperationsAddMultipleReferencesInnerManagedObject : IEquatable<ChildOperationsAddMultipleReferencesInnerManagedObject>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ChildOperationsAddMultipleReferencesInnerManagedObject" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ChildOperationsAddMultipleReferencesInnerManagedObject() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ChildOperationsAddMultipleReferencesInnerManagedObject" /> class.
        /// </summary>
        /// <param name="id">Unique identifier of the object. (required).</param>
        public ChildOperationsAddMultipleReferencesInnerManagedObject(string id = default(string))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for ChildOperationsAddMultipleReferencesInnerManagedObject and cannot be null");
            }
            this.Id = id;
        }
        ...
        {
            return this.Equals(input as ChildOperationsAddMultipleReferencesInnerManagedObject);
        }

        /// <summary>
        /// Returns true if ChildOperationsAddMultipleReferencesInnerManagedObject instances are equal
        /// </summary>
        /// <param name="input">Instance of ChildOperationsAddMultipleReferencesInnerManagedObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChildOperationsAddMultipleReferencesInnerManagedObject input)
        {
            if (input == null)
            {
                return false;
