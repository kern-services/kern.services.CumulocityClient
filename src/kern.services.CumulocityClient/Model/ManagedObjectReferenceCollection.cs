...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ManagedObjectReferenceCollection")]
    public partial class ManagedObjectReferenceCollection : IEquatable<ManagedObjectReferenceCollection>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ManagedObjectReferenceCollection" /> class.
        /// </summary>
        ...
        public ManagedObjectReferenceCollection(string prev = default(string), string self = default(string), string next = default(string), List<ManagedObjectReferenceCollectionReferencesInner> references = default(List<ManagedObjectReferenceCollectionReferencesInner>), PageStatistics statistics = default(PageStatistics))
        {
            this.Prev = prev;
            this.Self = self;
            this.Next = next;
        ...
        {
            return this.Equals(input as ManagedObjectReferenceCollection);
        }

        /// <summary>
        /// Returns true if ManagedObjectReferenceCollection instances are equal
        /// </summary>
        /// <param name="input">Instance of ManagedObjectReferenceCollection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ManagedObjectReferenceCollection input)
        {
            if (input == null)
            {
                return false;
