...
{
    /// <summary>
    /// PutAlarmResourceRequestAllOf
    /// </summary>
    [DataContract(Name = "putAlarmResource_request_allOf")]
    public partial class PutAlarmResourceRequestAllOf : IEquatable<PutAlarmResourceRequestAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PutAlarmResourceRequestAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public PutAlarmResourceRequestAllOf()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PutAlarmResourceRequestAllOf {\n");
        ...
        {
            return this.Equals(input as PutAlarmResourceRequestAllOf);
        }

        /// <summary>
        /// Returns true if PutAlarmResourceRequestAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of PutAlarmResourceRequestAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PutAlarmResourceRequestAllOf input)
        {
            if (input == null)
            {
                return false;
