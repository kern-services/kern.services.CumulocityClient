...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "c8y_Connection")]
    public partial class C8yConnection : IEquatable<C8yConnection>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="C8yConnection" /> class.
        /// </summary>
        /// <param name="status">status.</param>
        public C8yConnection(C8yAvailabilityStatus? status = default(C8yAvailabilityStatus?))
        {
            this.Status = status;
        }
        ...
        {
            return this.Equals(input as C8yConnection);
        }

        /// <summary>
        /// Returns true if C8yConnection instances are equal
        /// </summary>
        /// <param name="input">Instance of C8yConnection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(C8yConnection input)
        {
            if (input == null)
            {
                return false;
