...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LoginOptionCollection")]
    public partial class LoginOptionCollection : IEquatable<LoginOptionCollection>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LoginOptionCollection" /> class.
        /// </summary>
        /// <param name="loginOptions">An array containing the available login options..</param>
        public LoginOptionCollection(List<LoginOption> loginOptions = default(List<LoginOption>))
        {
        ...
        /// </summary>
        /// <value>An array containing the available login options.</value>
        [DataMember(Name = "loginOptions", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  LoginOptions: ").Append(LoginOptions).Append("\n");
        ...
        {
            return this.Equals(input as LoginOptionCollection);
        }

        /// <summary>
        /// Returns true if LoginOptionCollection instances are equal
        /// </summary>
        /// <param name="input">Instance of LoginOptionCollection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LoginOptionCollection input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.LoginOptions == input.LoginOptions ||
                    this.LoginOptions != null &&
                    input.LoginOptions != null &&
                    this.LoginOptions.SequenceEqual(input.LoginOptions)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.LoginOptions.GetHashCode();
                }
                if (this.Self != null)
                {
