...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AuditRecordCollection")]
    public partial class AuditRecordCollection : IEquatable<AuditRecordCollection>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditRecordCollection" /> class.
        /// </summary>
        /// <param name="statistics">statistics.</param>
        /// <param name="auditRecords">An array containing the results of the request..</param>
        public AuditRecordCollection(PageStatistics statistics = default(PageStatistics), List<AuditRecord> auditRecords = default(List<AuditRecord>))
        {
        ...
        /// </summary>
        /// <value>An array containing the results of the request.</value>
        ...
        {
            return this.Equals(input as AuditRecordCollection);
        }

        /// <summary>
        /// Returns true if AuditRecordCollection instances are equal
        /// </summary>
        /// <param name="input">Instance of AuditRecordCollection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuditRecordCollection input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    ...
                    input.AuditRecords != null &&
                    this.AuditRecords.SequenceEqual(input.AuditRecords)
                );
        }
