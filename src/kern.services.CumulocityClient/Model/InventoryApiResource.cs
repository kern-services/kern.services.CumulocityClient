...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inventoryApiResource")]
    public partial class InventoryApiResource : IEquatable<InventoryApiResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InventoryApiResource" /> class.
        /// </summary>
        /// <param name="managedObjectsForFragmentType">Read-only collection of all managed objects with a particular fragment type or capability (placeholder {fragmentType})..</param>
        /// <param name="managedObjectsForType">Read-only collection of all managed objects of a particular type (placeholder {type})..</param>
        /// <param name="managedObjectsForListOfIds">Read-only collection of managed objects fetched for a given list of ids, for example, “ids&#x3D;41,43,68”..</param>
        /// <param name="managedObjects">managedObjects.</param>
        public InventoryApiResource(string managedObjectsForFragmentType = default(string), string managedObjectsForType = default(string), string managedObjectsForListOfIds = default(string), InventoryApiResourceManagedObjects managedObjects = default(InventoryApiResourceManagedObjects))
        {
        ...
        /// </summary>
        /// <value>Read-only collection of all managed objects with a particular fragment type or capability (placeholder {fragmentType}).</value>
        [DataMember(Name = "managedObjectsForFragmentType", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>Read-only collection of all managed objects of a particular type (placeholder {type}).</value>
        [DataMember(Name = "managedObjectsForType", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>Read-only collection of managed objects fetched for a given list of ids, for example, “ids&#x3D;41,43,68”.</value>
        [DataMember(Name = "managedObjectsForListOfIds", EmitDefaultValue = false)]
        public string ManagedObjectsForListOfIds { get; set; }

        /// <summary>
        /// Gets or Sets ManagedObjects
        /// </summary>
        [DataMember(Name = "managedObjects", EmitDefaultValue = false)]
        public InventoryApiResourceManagedObjects ManagedObjects { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ManagedObjectsForFragmentType: ").Append(ManagedObjectsForFragmentType).Append("\n");
            sb.Append("  ManagedObjectsForType: ").Append(ManagedObjectsForType).Append("\n");
            sb.Append("  ManagedObjectsForListOfIds: ").Append(ManagedObjectsForListOfIds).Append("\n");
            sb.Append("  ManagedObjects: ").Append(ManagedObjects).Append("\n");
        ...
        {
            return this.Equals(input as InventoryApiResource);
        }

        /// <summary>
        /// Returns true if InventoryApiResource instances are equal
        /// </summary>
        /// <param name="input">Instance of InventoryApiResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InventoryApiResource input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.ManagedObjectsForFragmentType == input.ManagedObjectsForFragmentType ||
                    (this.ManagedObjectsForFragmentType != null &&
                    this.ManagedObjectsForFragmentType.Equals(input.ManagedObjectsForFragmentType))
                ) && 
                (
                    this.ManagedObjectsForType == input.ManagedObjectsForType ||
                    (this.ManagedObjectsForType != null &&
                    this.ManagedObjectsForType.Equals(input.ManagedObjectsForType))
                ) && 
                (
                    this.ManagedObjectsForListOfIds == input.ManagedObjectsForListOfIds ||
                    (this.ManagedObjectsForListOfIds != null &&
                    this.ManagedObjectsForListOfIds.Equals(input.ManagedObjectsForListOfIds))
                ) && 
                (
                    this.ManagedObjects == input.ManagedObjects ||
                    (this.ManagedObjects != null &&
                    this.ManagedObjects.Equals(input.ManagedObjects))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.ManagedObjectsForFragmentType != null)
                {
                    hashCode = (hashCode * 59) + this.ManagedObjectsForFragmentType.GetHashCode();
                }
                if (this.ManagedObjectsForType != null)
                {
                    hashCode = (hashCode * 59) + this.ManagedObjectsForType.GetHashCode();
                }
                if (this.ManagedObjectsForListOfIds != null)
                {
                    hashCode = (hashCode * 59) + this.ManagedObjectsForListOfIds.GetHashCode();
                }
                if (this.ManagedObjects != null)
                {
                    hashCode = (hashCode * 59) + this.ManagedObjects.GetHashCode();
                }
                if (this.Self != null)
                {
