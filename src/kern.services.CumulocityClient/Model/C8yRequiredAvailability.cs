...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "c8y_RequiredAvailability")]
    public partial class C8yRequiredAvailability : IEquatable<C8yRequiredAvailability>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="C8yRequiredAvailability" /> class.
        /// </summary>
        /// <param name="responseInterval">responseInterval.</param>
        public C8yRequiredAvailability(int responseInterval = default(int))
        {
            this.ResponseInterval = responseInterval;
        }

        /// <summary>
        /// Gets or Sets ResponseInterval
        /// </summary>
        [DataMember(Name = "responseInterval", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ResponseInterval: ").Append(ResponseInterval).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as C8yRequiredAvailability);
        }

        /// <summary>
        /// Returns true if C8yRequiredAvailability instances are equal
        /// </summary>
        /// <param name="input">Instance of C8yRequiredAvailability to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(C8yRequiredAvailability input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.ResponseInterval == input.ResponseInterval ||
                    this.ResponseInterval.Equals(input.ResponseInterval)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                hashCode = (hashCode * 59) + this.ResponseInterval.GetHashCode();
                return hashCode;
            }
        }
