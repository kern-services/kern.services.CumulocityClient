...
{
    /// <summary>
    /// GetManagedObjectChildAssetsResource200ResponseAllOf
    /// </summary>
    [DataContract(Name = "getManagedObjectChildAssetsResource_200_response_allOf")]
    public partial class GetManagedObjectChildAssetsResource200ResponseAllOf : IEquatable<GetManagedObjectChildAssetsResource200ResponseAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetManagedObjectChildAssetsResource200ResponseAllOf" /> class.
        /// </summary>
        /// <param name="prev">prev.</param>
        /// <param name="self">self.</param>
        /// <param name="next">next.</param>
        public GetManagedObjectChildAssetsResource200ResponseAllOf(Object prev = default(Object), Object self = default(Object), Object next = default(Object))
        {
            this.Prev = prev;
            this.Self = self;
            this.Next = next;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetManagedObjectChildAssetsResource200ResponseAllOf {\n");
        ...
        {
            return this.Equals(input as GetManagedObjectChildAssetsResource200ResponseAllOf);
        }

        /// <summary>
        /// Returns true if GetManagedObjectChildAssetsResource200ResponseAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of GetManagedObjectChildAssetsResource200ResponseAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetManagedObjectChildAssetsResource200ResponseAllOf input)
        {
            if (input == null)
            {
                return false;
