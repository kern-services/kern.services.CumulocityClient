...
namespace kern.services.CumulocityClient.Model
{
    ...
    public partial class Operation : Dictionary<String, Object>, IEquatable<Operation>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <param name="deviceId">Identifier of the target device where the operation should be performed..</param>
        /// <param name="deviceExternalIDs">deviceExternalIDs.</param>
        /// <param name="status">The status of the operation..</param>
        public Operation(string deviceId = default(string), ExternalIds deviceExternalIDs = default(ExternalIds), StatusEnum? status = default(StatusEnum?)) : base()
        {
