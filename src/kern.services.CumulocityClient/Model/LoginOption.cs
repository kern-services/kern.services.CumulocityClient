...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LoginOption :  IEquatable<LoginOption>, IValidatableObject
    {
        /// <summary>
        /// The grant type of the OAuth configuration.
        /// </summary>
        /// <value>The grant type of the OAuth configuration.</value>
        ...
        /// <param name="enforceStrength">Indicates if password strength is enforced..</param>
        /// <param name="grantType">The grant type of the OAuth configuration..</param>
        /// <param name="greenMinLength">Minimum length for the password when the strength validation is enforced..</param>
        /// <param name="id">Unique identifier of this login option..</param>
        /// <param name="initRequest">A URL linking to the token generating endpoint..</param>
        /// <param name="loginRedirectDomain">The tenant domain..</param>
        /// <param name="sessionConfiguration">sessionConfiguration.</param>
        /// <param name="strengthValidity">Enforce password strength validation on subtenant level. &#x60;enforceStrength&#x60; enforces it on all tenants in the platform..</param>
        /// <param name="tfaStrategy">Two-factor authentication being used by this login option. TFA supported: SMS and TOTP..</param>
        /// <param name="type">The type of authentication. See [Authentication](#section/Authentication) for more details..</param>
        /// <param name="userManagementSource">Specifies if the users are managed internally by Cumulocity IoT (&#x60;INTERNAL&#x60;) or if the users data are managed by a external system (&#x60;REMOTE&#x60;)..</param>
        /// <param name="visibleOnLoginPage">Indicates if this login option is available in the login page (only for SSO)..</param>
        /// <param name="type">The type of authentication..</param>
        public LoginOption(BasicAuthenticationRestrictions authenticationRestrictions = default(BasicAuthenticationRestrictions), bool enforceStrength = default(bool), GrantTypeEnum? grantType = default(GrantTypeEnum?), int greenMinLength = default(int), string id = default(string), string initRequest = default(string), string loginRedirectDomain = default(string), OAuthSessionConfiguration sessionConfiguration = default(OAuthSessionConfiguration), bool strengthValidity = default(bool), string tfaStrategy = default(string), string type = default(string), string userManagementSource = default(string), bool visibleOnLoginPage = default(bool))
        {
        ...
        /// </summary>
        /// <value>Indicates if password strength is enforced.</value>
        [DataMember(Name="enforceStrength", EmitDefaultValue=false)]
        ...
        /// </summary>
        /// <value>Minimum length for the password when the strength validation is enforced.</value>
        [DataMember(Name="greenMinLength", EmitDefaultValue=false)]
        ...
        /// </summary>
        /// <value>A URL linking to the token generating endpoint.</value>
        [DataMember(Name="initRequest", EmitDefaultValue=false)]
        public string InitRequest { get; set; }

        /// <summary>
        /// The tenant domain.
        /// </summary>
        /// <value>The tenant domain.</value>
        [DataMember(Name="loginRedirectDomain", EmitDefaultValue=false)]
        ...
        /// </summary>
        /// <value>Enforce password strength validation on subtenant level. &#x60;enforceStrength&#x60; enforces it on all tenants in the platform.</value>
        [DataMember(Name="strengthValidity", EmitDefaultValue=false)]
        public bool StrengthValidity { get; set; }

        /// <summary>
        /// Two-factor authentication being used by this login option. TFA supported: SMS and TOTP.
        /// </summary>
        /// <value>Two-factor authentication being used by this login option. TFA supported: SMS and TOTP.</value>
        [DataMember(Name="tfaStrategy", EmitDefaultValue=false)]
        public string TfaStrategy { get; set; }

        /// <summary>
        /// The type of authentication. See [Authentication](#section/Authentication) for more details.
        /// </summary>
        /// <value>The type of authentication. See [Authentication](#section/Authentication) for more details.</value>
        ...
        /// </summary>
        /// <value>Specifies if the users are managed internally by Cumulocity IoT (&#x60;INTERNAL&#x60;) or if the users data are managed by a external system (&#x60;REMOTE&#x60;).</value>
        ...
        /// </summary>
        /// <value>Indicates if this login option is available in the login page (only for SSO).</value>
        [DataMember(Name="visibleOnLoginPage", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  EnforceStrength: ").Append(EnforceStrength).Append("\n");
            sb.Append("  GrantType: ").Append(GrantType).Append("\n");
            sb.Append("  GreenMinLength: ").Append(GreenMinLength).Append("\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  InitRequest: ").Append(InitRequest).Append("\n");
            sb.Append("  LoginRedirectDomain: ").Append(LoginRedirectDomain).Append("\n");
            sb.Append("  Self: ").Append(Self).Append("\n");
            sb.Append("  SessionConfiguration: ").Append(SessionConfiguration).Append("\n");
            sb.Append("  StrengthValidity: ").Append(StrengthValidity).Append("\n");
            sb.Append("  TfaStrategy: ").Append(TfaStrategy).Append("\n");
        ...
        {
            return this.Equals(input as LoginOption);
        }

        /// <summary>
        /// Returns true if LoginOption instances are equal
        /// </summary>
        /// <param name="input">Instance of LoginOption to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LoginOption input)
        {
            if (input == null)
                return false;
            ...
            return
                (
                    this.AuthenticationRestrictions == input.AuthenticationRestrictions ||
                    (this.AuthenticationRestrictions != null &&
                    this.AuthenticationRestrictions.Equals(input.AuthenticationRestrictions))
                ) &&
                (
                    this.EnforceStrength == input.EnforceStrength ||
                    (this.EnforceStrength != null &&
                    this.EnforceStrength.Equals(input.EnforceStrength))
                ) &&
                (
                ...
                (
                    this.GreenMinLength == input.GreenMinLength ||
                    (this.GreenMinLength != null &&
                    this.GreenMinLength.Equals(input.GreenMinLength))
                ) &&
                (
                    this.Id == input.Id ||
                    (this.Id != null &&
                ...
                (
                    ...
                    this.InitRequest.Equals(input.InitRequest))
                ) &&
                (
                    this.LoginRedirectDomain == input.LoginRedirectDomain ||
                    (this.LoginRedirectDomain != null &&
                    this.LoginRedirectDomain.Equals(input.LoginRedirectDomain))
                ) &&
                (
                ...
                (
                    this.SessionConfiguration == input.SessionConfiguration ||
                    (this.SessionConfiguration != null &&
                    this.SessionConfiguration.Equals(input.SessionConfiguration))
                ) &&
                (
                    this.StrengthValidity == input.StrengthValidity ||
                    (this.StrengthValidity != null &&
                    this.StrengthValidity.Equals(input.StrengthValidity))
                ) &&
                (
                    this.TfaStrategy == input.TfaStrategy ||
                    (this.TfaStrategy != null &&
                    this.TfaStrategy.Equals(input.TfaStrategy))
                ) &&
                (
                ...
                (
                    this.UserManagementSource == input.UserManagementSource ||
                    (this.UserManagementSource != null &&
                    this.UserManagementSource.Equals(input.UserManagementSource))
                ) &&
                (
                    this.VisibleOnLoginPage == input.VisibleOnLoginPage ||
                    (this.VisibleOnLoginPage != null &&
                    this.VisibleOnLoginPage.Equals(input.VisibleOnLoginPage))
                ) &&
                (
                    this.Type == input.Type ||
                    (this.Type != null &&
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.AuthenticationRestrictions != null)
                    hashCode = hashCode * 59 + this.AuthenticationRestrictions.GetHashCode();
                if (this.EnforceStrength != null)
                    hashCode = hashCode * 59 + this.EnforceStrength.GetHashCode();
                if (this.GrantType != null)
                    hashCode = hashCode * 59 + this.GrantType.GetHashCode();
                if (this.GreenMinLength != null)
                    hashCode = hashCode * 59 + this.GreenMinLength.GetHashCode();
                if (this.Id != null)
                    hashCode = hashCode * 59 + this.Id.GetHashCode();
                if (this.InitRequest != null)
                    hashCode = hashCode * 59 + this.InitRequest.GetHashCode();
                if (this.LoginRedirectDomain != null)
                    hashCode = hashCode * 59 + this.LoginRedirectDomain.GetHashCode();
                if (this.Self != null)
                    hashCode = hashCode * 59 + this.Self.GetHashCode();
                if (this.SessionConfiguration != null)
                    hashCode = hashCode * 59 + this.SessionConfiguration.GetHashCode();
                if (this.StrengthValidity != null)
                    hashCode = hashCode * 59 + this.StrengthValidity.GetHashCode();
                if (this.TfaStrategy != null)
                    hashCode = hashCode * 59 + this.TfaStrategy.GetHashCode();
                if (this.Type != null)
                    hashCode = hashCode * 59 + this.Type.GetHashCode();
                if (this.UserManagementSource != null)
                    hashCode = hashCode * 59 + this.UserManagementSource.GetHashCode();
                if (this.VisibleOnLoginPage != null)
                    hashCode = hashCode * 59 + this.VisibleOnLoginPage.GetHashCode();
                if (this.Type != null)
                    hashCode = hashCode * 59 + this.Type.GetHashCode();
                return hashCode;
            }
