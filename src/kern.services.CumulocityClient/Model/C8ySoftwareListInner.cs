...
namespace kern.services.CumulocityClient.Model
{
    ...
    public partial class C8ySoftwareListInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="C8ySoftwareListInner" /> class.
        /// </summary>
        /// <param name="name">The name of the software..</param>
        /// <param name="varVersion">The version of the software..</param>
        /// <param name="url">The URL of the software, for example, its code repository..</param>
        public C8ySoftwareListInner(string name = default(string), string varVersion = default(string), string url = default(string))
        {
            this.Name = name;
