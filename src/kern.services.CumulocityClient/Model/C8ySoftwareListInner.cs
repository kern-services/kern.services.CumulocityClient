...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "c8y_SoftwareList_inner")]
    public partial class C8ySoftwareListInner : IEquatable<C8ySoftwareListInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="C8ySoftwareListInner" /> class.
        /// </summary>
        /// <param name="name">The name of the software..</param>
        /// <param name="version">The version of the software..</param>
        /// <param name="url">The URL of the software, for example, its code repository..</param>
        public C8ySoftwareListInner(string name = default(string), string version = default(string), string url = default(string))
        {
            this.Name = name;
        ...
        /// </summary>
        /// <value>The version of the software.</value>
        ...
        /// </summary>
        /// <value>The URL of the software, for example, its code repository.</value>
        ...
        {
            return this.Equals(input as C8ySoftwareListInner);
        }

        /// <summary>
        /// Returns true if C8ySoftwareListInner instances are equal
        /// </summary>
        /// <param name="input">Instance of C8ySoftwareListInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(C8ySoftwareListInner input)
        {
            if (input == null)
            {
                return false;
