...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "c8y_HumidityMeasurement")]
    public partial class C8yHumidityMeasurement : IEquatable<C8yHumidityMeasurement>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="C8yHumidityMeasurement" /> class.
        /// </summary>
        /// <param name="h">h.</param>
        public C8yHumidityMeasurement(C8yHumidityMeasurementH h = default(C8yHumidityMeasurementH))
        {
            this.H = h;
        }
        ...
        public C8yHumidityMeasurementH H { get; set; }
        ...
        {
            return this.Equals(input as C8yHumidityMeasurement);
        }

        /// <summary>
        /// Returns true if C8yHumidityMeasurement instances are equal
        /// </summary>
        /// <param name="input">Instance of C8yHumidityMeasurement to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(C8yHumidityMeasurement input)
        {
            if (input == null)
            {
                return false;
