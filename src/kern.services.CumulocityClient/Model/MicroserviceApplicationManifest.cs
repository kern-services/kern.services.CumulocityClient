...
namespace kern.services.CumulocityClient.Model
{
    ...
    public partial class MicroserviceApplicationManifest : IValidatableObject
    {
        /// <summary>
        ...
        /// <example>devicemanagement</example>
