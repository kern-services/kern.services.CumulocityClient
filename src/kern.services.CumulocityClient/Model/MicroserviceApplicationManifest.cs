...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MicroserviceApplicationManifest :  IEquatable<MicroserviceApplicationManifest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MicroserviceApplicationManifest" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as MicroserviceApplicationManifest);
        }

        /// <summary>
        /// Returns true if MicroserviceApplicationManifest instances are equal
        /// </summary>
        /// <param name="input">Instance of MicroserviceApplicationManifest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MicroserviceApplicationManifest input)
        {
            if (input == null)
                return false;
