...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// TenantApiResource
    /// </summary>
    [DataContract(Name = "tenantApiResource")]
    public partial class TenantApiResource : IEquatable<TenantApiResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TenantApiResource" /> class.
        /// </summary>
        /// <param name="options">options.</param>
        /// <param name="tenants">tenants.</param>
        /// <param name="tenantApplications">Retrieves subscribed applications..</param>
        /// <param name="tenantApplicationForId">Represents an individual application reference that can be viewed..</param>
        /// <param name="tenantForId">Represents an individual tenant that can be viewed..</param>
        /// <param name="tenantOptionsForCategory">Represents a category of tenant options..</param>
        /// <param name="tenantOptionForCategoryAndKey">Retrieves a key of the category of tenant options..</param>
        /// <param name="tenantSystemOptions">Retrieves the tenant system options..</param>
        /// <param name="tenantSystemOptionsForCategoryAndKey">Retrieves the tenant system options based on category and key..</param>
        public TenantApiResource(TenantApiResourceOptions options = default(TenantApiResourceOptions), TenantApiResourceTenants tenants = default(TenantApiResourceTenants), string tenantApplications = default(string), string tenantApplicationForId = default(string), string tenantForId = default(string), string tenantOptionsForCategory = default(string), string tenantOptionForCategoryAndKey = default(string), string tenantSystemOptions = default(string), string tenantSystemOptionsForCategoryAndKey = default(string))
        {
        ...
        public TenantApiResourceOptions Options { get; set; }
        ...
        public TenantApiResourceTenants Tenants { get; set; }

        /// <summary>
        /// Retrieves subscribed applications.
        /// </summary>
        /// <value>Retrieves subscribed applications.</value>
        [DataMember(Name = "tenantApplications", EmitDefaultValue = false)]
        public string TenantApplications { get; set; }

        /// <summary>
        /// Represents an individual application reference that can be viewed.
        /// </summary>
        /// <value>Represents an individual application reference that can be viewed.</value>
        [DataMember(Name = "tenantApplicationForId", EmitDefaultValue = false)]
        public string TenantApplicationForId { get; set; }

        /// <summary>
        /// Represents an individual tenant that can be viewed.
        /// </summary>
        /// <value>Represents an individual tenant that can be viewed.</value>
        [DataMember(Name = "tenantForId", EmitDefaultValue = false)]
        public string TenantForId { get; set; }

        /// <summary>
        /// Represents a category of tenant options.
        /// </summary>
        /// <value>Represents a category of tenant options.</value>
        [DataMember(Name = "tenantOptionsForCategory", EmitDefaultValue = false)]
        public string TenantOptionsForCategory { get; set; }

        /// <summary>
        /// Retrieves a key of the category of tenant options.
        /// </summary>
        /// <value>Retrieves a key of the category of tenant options.</value>
        [DataMember(Name = "tenantOptionForCategoryAndKey", EmitDefaultValue = false)]
        public string TenantOptionForCategoryAndKey { get; set; }

        /// <summary>
        /// Retrieves the tenant system options.
        /// </summary>
        /// <value>Retrieves the tenant system options.</value>
        [DataMember(Name = "tenantSystemOptions", EmitDefaultValue = false)]
        public string TenantSystemOptions { get; set; }

        /// <summary>
        /// Retrieves the tenant system options based on category and key.
        /// </summary>
        /// <value>Retrieves the tenant system options based on category and key.</value>
        [DataMember(Name = "tenantSystemOptionsForCategoryAndKey", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  TenantApplications: ").Append(TenantApplications).Append("\n");
            sb.Append("  TenantApplicationForId: ").Append(TenantApplicationForId).Append("\n");
            sb.Append("  TenantForId: ").Append(TenantForId).Append("\n");
            sb.Append("  TenantOptionsForCategory: ").Append(TenantOptionsForCategory).Append("\n");
            sb.Append("  TenantOptionForCategoryAndKey: ").Append(TenantOptionForCategoryAndKey).Append("\n");
            sb.Append("  TenantSystemOptions: ").Append(TenantSystemOptions).Append("\n");
            sb.Append("  TenantSystemOptionsForCategoryAndKey: ").Append(TenantSystemOptionsForCategoryAndKey).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as TenantApiResource);
        }

        /// <summary>
        /// Returns true if TenantApiResource instances are equal
        /// </summary>
        /// <param name="input">Instance of TenantApiResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TenantApiResource input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.TenantApplications == input.TenantApplications ||
                    (this.TenantApplications != null &&
                    this.TenantApplications.Equals(input.TenantApplications))
                ) && 
                (
                    this.TenantApplicationForId == input.TenantApplicationForId ||
                    (this.TenantApplicationForId != null &&
                    this.TenantApplicationForId.Equals(input.TenantApplicationForId))
                ) && 
                (
                    this.TenantForId == input.TenantForId ||
                    (this.TenantForId != null &&
                    this.TenantForId.Equals(input.TenantForId))
                ) && 
                (
                    this.TenantOptionsForCategory == input.TenantOptionsForCategory ||
                    (this.TenantOptionsForCategory != null &&
                    this.TenantOptionsForCategory.Equals(input.TenantOptionsForCategory))
                ) && 
                (
                    this.TenantOptionForCategoryAndKey == input.TenantOptionForCategoryAndKey ||
                    (this.TenantOptionForCategoryAndKey != null &&
                    this.TenantOptionForCategoryAndKey.Equals(input.TenantOptionForCategoryAndKey))
                ) && 
                (
                    this.TenantSystemOptions == input.TenantSystemOptions ||
                    (this.TenantSystemOptions != null &&
                    this.TenantSystemOptions.Equals(input.TenantSystemOptions))
                ) && 
                (
                    this.TenantSystemOptionsForCategoryAndKey == input.TenantSystemOptionsForCategoryAndKey ||
                    (this.TenantSystemOptionsForCategoryAndKey != null &&
                    this.TenantSystemOptionsForCategoryAndKey.Equals(input.TenantSystemOptionsForCategoryAndKey))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.TenantApplications != null)
                {
                    hashCode = (hashCode * 59) + this.TenantApplications.GetHashCode();
                }
                if (this.TenantApplicationForId != null)
                {
                    hashCode = (hashCode * 59) + this.TenantApplicationForId.GetHashCode();
                }
                if (this.TenantForId != null)
                {
                    hashCode = (hashCode * 59) + this.TenantForId.GetHashCode();
                }
                if (this.TenantOptionsForCategory != null)
                {
                    hashCode = (hashCode * 59) + this.TenantOptionsForCategory.GetHashCode();
                }
                if (this.TenantOptionForCategoryAndKey != null)
                {
                    hashCode = (hashCode * 59) + this.TenantOptionForCategoryAndKey.GetHashCode();
                }
                if (this.TenantSystemOptions != null)
                {
                    hashCode = (hashCode * 59) + this.TenantSystemOptions.GetHashCode();
                }
                if (this.TenantSystemOptionsForCategoryAndKey != null)
                {
                    hashCode = (hashCode * 59) + this.TenantSystemOptionsForCategoryAndKey.GetHashCode();
                }
                return hashCode;
            }
        }
