...
{
    /// <summary>
    /// PostInventoryAssignmentResourceRequestAllOf
    /// </summary>
    [DataContract(Name = "postInventoryAssignmentResource_request_allOf")]
    public partial class PostInventoryAssignmentResourceRequestAllOf : IEquatable<PostInventoryAssignmentResourceRequestAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostInventoryAssignmentResourceRequestAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostInventoryAssignmentResourceRequestAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostInventoryAssignmentResourceRequestAllOf" /> class.
        /// </summary>
        /// <param name="roles">roles (required).</param>
        public PostInventoryAssignmentResourceRequestAllOf(List<PostInventoryAssignmentResourceRequestAllOfRolesInner> roles = default(List<PostInventoryAssignmentResourceRequestAllOfRolesInner>))
        {
            // to ensure "roles" is required (not null)
            if (roles == null)
            {
                throw new ArgumentNullException("roles is a required property for PostInventoryAssignmentResourceRequestAllOf and cannot be null");
            }
            this.Roles = roles;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostInventoryAssignmentResourceRequestAllOf {\n");
        ...
        {
            return this.Equals(input as PostInventoryAssignmentResourceRequestAllOf);
        }

        /// <summary>
        /// Returns true if PostInventoryAssignmentResourceRequestAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of PostInventoryAssignmentResourceRequestAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostInventoryAssignmentResourceRequestAllOf input)
        {
            if (input == null)
            {
                return false;
