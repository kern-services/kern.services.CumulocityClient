...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "application_owner")]
    public partial class ApplicationOwner : IEquatable<ApplicationOwner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationOwner" /> class.
        /// </summary>
        /// <param name="tenant">tenant.</param>
        public ApplicationOwner(ApplicationOwnerTenant tenant = default(ApplicationOwnerTenant))
        {
            this.Tenant = tenant;
        }
        ...
        public ApplicationOwnerTenant Tenant { get; set; }
        ...
        {
            return this.Equals(input as ApplicationOwner);
        }

        /// <summary>
        /// Returns true if ApplicationOwner instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationOwner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationOwner input)
        {
            if (input == null)
            {
                return false;
