...
{
    /// <summary>
    /// PutAlarmCollectionResourceRequestAllOf
    /// </summary>
    [DataContract(Name = "putAlarmCollectionResource_request_allOf")]
    public partial class PutAlarmCollectionResourceRequestAllOf : IEquatable<PutAlarmCollectionResourceRequestAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PutAlarmCollectionResourceRequestAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public PutAlarmCollectionResourceRequestAllOf()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PutAlarmCollectionResourceRequestAllOf {\n");
        ...
        {
            return this.Equals(input as PutAlarmCollectionResourceRequestAllOf);
        }

        /// <summary>
        /// Returns true if PutAlarmCollectionResourceRequestAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of PutAlarmCollectionResourceRequestAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PutAlarmCollectionResourceRequestAllOf input)
        {
            if (input == null)
            {
                return false;
