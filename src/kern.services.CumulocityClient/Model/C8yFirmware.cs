...
namespace kern.services.CumulocityClient.Model
{
    ...
    public partial class C8yFirmware : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="C8yFirmware" /> class.
        /// </summary>
        /// <param name="name">Name of the firmware..</param>
        /// <param name="varVersion">A version identifier of the firmware..</param>
        /// <param name="url">A URI linking to the location to download the firmware from..</param>
        public C8yFirmware(string name = default(string), string varVersion = default(string), string url = default(string))
        {
            this.Name = name;
        ...
        /// <example>raspberrypi-bootloader</example>
        ...
        /// <example>https://example.com/support/firmware-download</example>
