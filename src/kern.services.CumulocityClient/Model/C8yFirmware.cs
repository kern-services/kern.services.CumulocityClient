...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "c8y_Firmware")]
    public partial class C8yFirmware : IEquatable<C8yFirmware>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="C8yFirmware" /> class.
        /// </summary>
        /// <param name="name">Name of the firmware..</param>
        /// <param name="version">A version identifier of the firmware..</param>
        /// <param name="url">A URI linking to the location to download the firmware from..</param>
        public C8yFirmware(string name = default(string), string version = default(string), string url = default(string))
        {
            this.Name = name;
        ...
        /// </summary>
        /// <value>Name of the firmware.</value>
        ...
        /// </summary>
        /// <value>A version identifier of the firmware.</value>
        ...
        /// </summary>
        /// <value>A URI linking to the location to download the firmware from.</value>
        ...
        {
            return this.Equals(input as C8yFirmware);
        }

        /// <summary>
        /// Returns true if C8yFirmware instances are equal
        /// </summary>
        /// <param name="input">Instance of C8yFirmware to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(C8yFirmware input)
        {
            if (input == null)
            {
                return false;
