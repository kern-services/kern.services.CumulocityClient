...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// MeasurementSeries
    /// </summary>
    [DataContract(Name = "MeasurementSeries")]
    public partial class MeasurementSeries : IEquatable<MeasurementSeries>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MeasurementSeries" /> class.
        /// </summary>
        /// <param name="values">Each property contained here is a date taken from the measurement and it contains an array of objects specifying &#x60;min&#x60; and &#x60;max&#x60; pair of values. Each pair corresponds to a single series object in the &#x60;series&#x60; array. If there is no aggregation used, &#x60;min&#x60; is equal to &#x60;max&#x60; in every pair..</param>
        /// <param name="series">An array containing the type of series and units..</param>
        /// <param name="truncated">If there were more than 5000 values, the final result was truncated..</param>
        public MeasurementSeries(Object values = default(Object), List<MeasurementFragmentSeries> series = default(List<MeasurementFragmentSeries>), bool truncated = default(bool))
        {
            this.Values = values;
            this.Series = series;
        ...
        /// </summary>
        /// <value>Each property contained here is a date taken from the measurement and it contains an array of objects specifying &#x60;min&#x60; and &#x60;max&#x60; pair of values. Each pair corresponds to a single series object in the &#x60;series&#x60; array. If there is no aggregation used, &#x60;min&#x60; is equal to &#x60;max&#x60; in every pair.</value>
        ...
        /// </summary>
        /// <value>An array containing the type of series and units.</value>
        ...
        /// </summary>
        /// <value>If there were more than 5000 values, the final result was truncated.</value>
        ...
        {
            return this.Equals(input as MeasurementSeries);
        }

        /// <summary>
        /// Returns true if MeasurementSeries instances are equal
        /// </summary>
        /// <param name="input">Instance of MeasurementSeries to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MeasurementSeries input)
        {
            if (input == null)
            {
                return false;
