...
{
    /// <summary>
    /// PutTrustedCertificateResourceRequestAllOf
    /// </summary>
    [DataContract(Name = "putTrustedCertificateResource_request_allOf")]
    public partial class PutTrustedCertificateResourceRequestAllOf : IEquatable<PutTrustedCertificateResourceRequestAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PutTrustedCertificateResourceRequestAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public PutTrustedCertificateResourceRequestAllOf()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PutTrustedCertificateResourceRequestAllOf {\n");
        ...
        {
            return this.Equals(input as PutTrustedCertificateResourceRequestAllOf);
        }

        /// <summary>
        /// Returns true if PutTrustedCertificateResourceRequestAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of PutTrustedCertificateResourceRequestAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PutTrustedCertificateResourceRequestAllOf input)
        {
            if (input == null)
            {
                return false;
