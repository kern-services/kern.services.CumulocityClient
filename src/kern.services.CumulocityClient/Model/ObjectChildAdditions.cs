...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "objectChildAdditions")]
    public partial class ObjectChildAdditions : IEquatable<ObjectChildAdditions>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ObjectChildAdditions" /> class.
        /// </summary>
        /// <param name="count">The total number of child additions. Only present if the value is greater than 0..</param>
        /// <param name="references">An array with the references to child devices..</param>
        /// <param name="self">Link to this resource&#39;s child additions..</param>
        public ObjectChildAdditions(int count = default(int), List<ManagedObjectReferenceTuple> references = default(List<ManagedObjectReferenceTuple>), string self = default(string))
        {
            this.Count = count;
        ...
        /// </summary>
        /// <value>The total number of child additions. Only present if the value is greater than 0.</value>
        ...
        /// </summary>
        /// <value>An array with the references to child devices.</value>
        ...
        /// </summary>
        /// <value>Link to this resource&#39;s child additions.</value>
        ...
        {
            return this.Equals(input as ObjectChildAdditions);
        }

        /// <summary>
        /// Returns true if ObjectChildAdditions instances are equal
        /// </summary>
        /// <param name="input">Instance of ObjectChildAdditions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ObjectChildAdditions input)
        {
            if (input == null)
            {
                return false;
