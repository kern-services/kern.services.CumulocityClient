...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RangeStatisticsFile :  IEquatable<RangeStatisticsFile>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RangeStatisticsFile" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RangeStatisticsFile() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RangeStatisticsFile" /> class.
        /// </summary>
        /// <param name="dateFrom">Statistics generation start date. (required).</param>
        /// <param name="dateTo">Statistics generation end date. (required).</param>
        public RangeStatisticsFile(DateTime dateFrom = default(DateTime), DateTime dateTo = default(DateTime))
        {
            // to ensure "dateFrom" is required (not null)
            if (dateFrom == null)
            {
                throw new InvalidDataException("dateFrom is a required property for RangeStatisticsFile and cannot be null");
            }
            else
            {
            ...
            if (dateTo == null)
            {
                throw new InvalidDataException("dateTo is a required property for RangeStatisticsFile and cannot be null");
            }
            else
            {
                this.DateTo = dateTo;
        ...
        /// </summary>
        /// <value>Statistics generation start date.</value>
        ...
        /// </summary>
        /// <value>Statistics generation end date.</value>
        ...
        {
            return this.Equals(input as RangeStatisticsFile);
        }

        /// <summary>
        /// Returns true if RangeStatisticsFile instances are equal
        /// </summary>
        /// <param name="input">Instance of RangeStatisticsFile to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RangeStatisticsFile input)
        {
            if (input == null)
                return false;
