...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InventoryAssignmentCollection")]
    public partial class InventoryAssignmentCollection : IEquatable<InventoryAssignmentCollection>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InventoryAssignmentCollection" /> class.
        /// </summary>
        /// <param name="self">self.</param>
        /// <param name="inventoryAssignments">An array of inventory assignments..</param>
        public InventoryAssignmentCollection(string self = default(string), List<InventoryAssignment> inventoryAssignments = default(List<InventoryAssignment>))
        {
            this.Self = self;
        ...
        /// </summary>
        /// <value>An array of inventory assignments.</value>
        [DataMember(Name = "inventoryAssignments", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  InventoryAssignments: ").Append(InventoryAssignments).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as InventoryAssignmentCollection);
        }

        /// <summary>
        /// Returns true if InventoryAssignmentCollection instances are equal
        /// </summary>
        /// <param name="input">Instance of InventoryAssignmentCollection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InventoryAssignmentCollection input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.InventoryAssignments == input.InventoryAssignments ||
                    this.InventoryAssignments != null &&
                    input.InventoryAssignments != null &&
                    this.InventoryAssignments.SequenceEqual(input.InventoryAssignments)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.InventoryAssignments.GetHashCode();
                }
                return hashCode;
            }
        }
