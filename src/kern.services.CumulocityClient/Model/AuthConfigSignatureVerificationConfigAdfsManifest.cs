...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "authConfig_signatureVerificationConfig_adfsManifest")]
    public partial class AuthConfigSignatureVerificationConfigAdfsManifest : IEquatable<AuthConfigSignatureVerificationConfigAdfsManifest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthConfigSignatureVerificationConfigAdfsManifest" /> class.
        /// </summary>
        /// <param name="manifestUrl">The URI to the manifest resource..</param>
        public AuthConfigSignatureVerificationConfigAdfsManifest(string manifestUrl = default(string))
        {
        ...
        /// </summary>
        /// <value>The URI to the manifest resource.</value>
        ...
        {
            return this.Equals(input as AuthConfigSignatureVerificationConfigAdfsManifest);
        }

        /// <summary>
        /// Returns true if AuthConfigSignatureVerificationConfigAdfsManifest instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthConfigSignatureVerificationConfigAdfsManifest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthConfigSignatureVerificationConfigAdfsManifest input)
        {
            if (input == null)
            {
                return false;
