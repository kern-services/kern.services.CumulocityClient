...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NotificationSubscriptionCollection")]
    public partial class NotificationSubscriptionCollection : IEquatable<NotificationSubscriptionCollection>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NotificationSubscriptionCollection" /> class.
        /// </summary>
        /// <param name="statistics">statistics.</param>
        /// <param name="subscriptions">An array containing the subscriptions of the request..</param>
        public NotificationSubscriptionCollection(PageStatistics statistics = default(PageStatistics), List<NotificationSubscription> subscriptions = default(List<NotificationSubscription>))
        {
        ...
        /// </summary>
        /// <value>An array containing the subscriptions of the request.</value>
        ...
        {
            return this.Equals(input as NotificationSubscriptionCollection);
        }

        /// <summary>
        /// Returns true if NotificationSubscriptionCollection instances are equal
        /// </summary>
        /// <param name="input">Instance of NotificationSubscriptionCollection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NotificationSubscriptionCollection input)
        {
            if (input == null)
            {
                return false;
