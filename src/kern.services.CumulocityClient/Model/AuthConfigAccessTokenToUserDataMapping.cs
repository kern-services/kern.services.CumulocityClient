...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "authConfig_accessTokenToUserDataMapping")]
    public partial class AuthConfigAccessTokenToUserDataMapping : IEquatable<AuthConfigAccessTokenToUserDataMapping>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthConfigAccessTokenToUserDataMapping" /> class.
        /// </summary>
        /// <param name="emailClaimName">The name of the field containing the user&#39;s email..</param>
        /// <param name="firstNameClaimName">The name of the field containing the user&#39;s first name..</param>
        /// <param name="lastNameClaimName">The name of the field containing the user&#39;s last name..</param>
        /// <param name="phoneNumberClaimName">The name of the field containing the user&#39;s phone number..</param>
        public AuthConfigAccessTokenToUserDataMapping(string emailClaimName = default(string), string firstNameClaimName = default(string), string lastNameClaimName = default(string), string phoneNumberClaimName = default(string))
        {
        ...
        /// </summary>
        /// <value>The name of the field containing the user&#39;s email.</value>
        [DataMember(Name = "emailClaimName", EmitDefaultValue = false)]
        public string EmailClaimName { get; set; }

        /// <summary>
        /// The name of the field containing the user&#39;s first name.
        /// </summary>
        /// <value>The name of the field containing the user&#39;s first name.</value>
        [DataMember(Name = "firstNameClaimName", EmitDefaultValue = false)]
        public string FirstNameClaimName { get; set; }

        /// <summary>
        /// The name of the field containing the user&#39;s last name.
        /// </summary>
        /// <value>The name of the field containing the user&#39;s last name.</value>
        [DataMember(Name = "lastNameClaimName", EmitDefaultValue = false)]
        public string LastNameClaimName { get; set; }

        /// <summary>
        /// The name of the field containing the user&#39;s phone number.
        /// </summary>
        /// <value>The name of the field containing the user&#39;s phone number.</value>
        [DataMember(Name = "phoneNumberClaimName", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  EmailClaimName: ").Append(EmailClaimName).Append("\n");
            sb.Append("  FirstNameClaimName: ").Append(FirstNameClaimName).Append("\n");
            sb.Append("  LastNameClaimName: ").Append(LastNameClaimName).Append("\n");
            sb.Append("  PhoneNumberClaimName: ").Append(PhoneNumberClaimName).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as AuthConfigAccessTokenToUserDataMapping);
        }

        /// <summary>
        /// Returns true if AuthConfigAccessTokenToUserDataMapping instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthConfigAccessTokenToUserDataMapping to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthConfigAccessTokenToUserDataMapping input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.EmailClaimName == input.EmailClaimName ||
                    (this.EmailClaimName != null &&
                    this.EmailClaimName.Equals(input.EmailClaimName))
                ) && 
                (
                    this.FirstNameClaimName == input.FirstNameClaimName ||
                    (this.FirstNameClaimName != null &&
                    this.FirstNameClaimName.Equals(input.FirstNameClaimName))
                ) && 
                (
                    this.LastNameClaimName == input.LastNameClaimName ||
                    (this.LastNameClaimName != null &&
                    this.LastNameClaimName.Equals(input.LastNameClaimName))
                ) && 
                (
                    this.PhoneNumberClaimName == input.PhoneNumberClaimName ||
                    (this.PhoneNumberClaimName != null &&
                    this.PhoneNumberClaimName.Equals(input.PhoneNumberClaimName))
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.EmailClaimName != null)
                {
                    hashCode = (hashCode * 59) + this.EmailClaimName.GetHashCode();
                }
                if (this.FirstNameClaimName != null)
                {
                    hashCode = (hashCode * 59) + this.FirstNameClaimName.GetHashCode();
                }
                if (this.LastNameClaimName != null)
                {
                    hashCode = (hashCode * 59) + this.LastNameClaimName.GetHashCode();
                }
                if (this.PhoneNumberClaimName != null)
                {
                    hashCode = (hashCode * 59) + this.PhoneNumberClaimName.GetHashCode();
                }
                return hashCode;
            }
        }
