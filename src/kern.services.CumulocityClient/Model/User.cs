...
namespace kern.services.CumulocityClient.Model
{
    ...
    public partial class User : IEquatable<User>, IValidatableObject
    {
        ...
        /// <param name="userName">The user&#39;s username. It can have a maximum of 1000 characters..</param>
        /// <param name="devicePermissions">An object with a list of the user&#39;s device permissions..</param>
        public User(CustomProperties customProperties = default(CustomProperties), string displayName = default(string), string email = default(string), bool enabled = true, string firstName = default(string), UserGroups groups = default(UserGroups), string lastName = default(string), bool newsletter = default(bool), string password = default(string), string phone = default(string), UserRoles roles = default(UserRoles), bool sendPasswordResetEmail = default(bool), string userName = default(string), Dictionary<string, List<string>> devicePermissions = default(Dictionary<string, List<string>>))
        {
        ...
        /// </summary>
        /// <value>An object with a list of the user&#39;s device permissions.</value>
        [DataMember(Name = "devicePermissions", EmitDefaultValue = false)]
        [Obsolete]
        public Dictionary<string, List<string>> DevicePermissions { get; set; }
        ...
        public bool Equals(User input)
        {
            ...
            return 
                ...
                (
                    ...
                    input.DevicePermissions != null &&
                    this.DevicePermissions.SequenceEqual(input.DevicePermissions)
                );
        }
