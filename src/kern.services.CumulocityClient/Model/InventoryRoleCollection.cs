...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InventoryRoleCollection")]
    public partial class InventoryRoleCollection : IEquatable<InventoryRoleCollection>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InventoryRoleCollection" /> class.
        /// </summary>
        /// <param name="roles">An array of inventory roles..</param>
        /// <param name="statistics">statistics.</param>
        public InventoryRoleCollection(List<InventoryRole> roles = default(List<InventoryRole>), PageStatistics statistics = default(PageStatistics))
        {
            this.Roles = roles;
        ...
        /// </summary>
        /// <value>An array of inventory roles.</value>
        ...
        {
            return this.Equals(input as InventoryRoleCollection);
        }

        /// <summary>
        /// Returns true if InventoryRoleCollection instances are equal
        /// </summary>
        /// <param name="input">Instance of InventoryRoleCollection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InventoryRoleCollection input)
        {
            if (input == null)
            {
                return false;
