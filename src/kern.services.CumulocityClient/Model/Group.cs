...
namespace kern.services.CumulocityClient.Model
{
    ...
    public partial class Group : IEquatable<Group>, IValidatableObject
    {
        ...
        public Group(CustomProperties customProperties = default(CustomProperties), string description = default(string), Dictionary<string, List<string>> devicePermissions = default(Dictionary<string, List<string>>), string name = default(string), GroupRoles roles = default(GroupRoles), GroupUsers users = default(GroupUsers))
        {
