...
namespace kern.services.CumulocityClient.Model
{
    ...
    public partial class ApplicationVersion : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationVersion" /> class.
        /// </summary>
        /// <param name="varVersion">Unique identifier of the version..</param>
        ...
        public ApplicationVersion(string varVersion = default(string), string binaryId = default(string), List<string> tag = default(List<string>))
        {
