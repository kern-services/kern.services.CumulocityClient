...
namespace kern.services.CumulocityClient.Model
{
    ...
    public partial class ApplicationVersion : IEquatable<ApplicationVersion>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="version">Unique identifier of the version..</param>
        /// <param name="binaryId">Unique identifier of the binary file assigned to the version..</param>
        /// <param name="tag">Tag assigned to the version. Version tags must be unique across all versions and version fields of application versions..</param>
        public ApplicationVersion(string version = default(string), string binaryId = default(string), List<string> tag = default(List<string>))
        {
        ...
        /// </summary>
        /// <value>Unique identifier of the version.</value>
        ...
        /// </summary>
        /// <value>Unique identifier of the binary file assigned to the version.</value>
        [DataMember(Name = "binaryId", EmitDefaultValue = false)]
        ...
        public bool Equals(ApplicationVersion input)
        {
            ...
            return 
                ...
                (
                    this.BinaryId == input.BinaryId ||
                    (this.BinaryId != null &&
                    this.BinaryId.Equals(input.BinaryId))
                ) && 
                (
                    this.Tag == input.Tag ||
                    this.Tag != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.BinaryId.GetHashCode();
                }
                if (this.Tag != null)
                {
