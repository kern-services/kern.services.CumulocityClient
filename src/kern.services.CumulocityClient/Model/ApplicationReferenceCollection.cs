...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ApplicationReferenceCollection")]
    public partial class ApplicationReferenceCollection : IEquatable<ApplicationReferenceCollection>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationReferenceCollection" /> class.
        /// </summary>
        /// <param name="references">An array containing all subscribed applications..</param>
        /// <param name="statistics">statistics.</param>
        public ApplicationReferenceCollection(List<Application> references = default(List<Application>), PageStatistics statistics = default(PageStatistics))
        {
        ...
        /// </summary>
        /// <value>An array containing all subscribed applications.</value>
        ...
        {
            return this.Equals(input as ApplicationReferenceCollection);
        }

        /// <summary>
        /// Returns true if ApplicationReferenceCollection instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationReferenceCollection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationReferenceCollection input)
        {
            if (input == null)
            {
                return false;
