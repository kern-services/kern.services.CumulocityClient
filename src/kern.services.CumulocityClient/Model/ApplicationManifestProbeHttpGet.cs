...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "application_manifest_probe_httpGet")]
    public partial class ApplicationManifestProbeHttpGet : IEquatable<ApplicationManifestProbeHttpGet>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationManifestProbeHttpGet" /> class.
        /// </summary>
        /// <param name="path">The HTTP path..</param>
        /// <param name="port">The HTTP port..</param>
        public ApplicationManifestProbeHttpGet(string path = default(string), int port = default(int))
        {
            this.Path = path;
            this.Port = port;
        }
        ...
        {
            return this.Equals(input as ApplicationManifestProbeHttpGet);
        }

        /// <summary>
        /// Returns true if ApplicationManifestProbeHttpGet instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationManifestProbeHttpGet to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationManifestProbeHttpGet input)
        {
            if (input == null)
            {
                return false;
