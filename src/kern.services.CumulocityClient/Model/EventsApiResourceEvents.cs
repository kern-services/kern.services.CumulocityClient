...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "eventsApiResource_events")]
    public partial class EventsApiResourceEvents : IEquatable<EventsApiResourceEvents>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EventsApiResourceEvents" /> class.
        /// </summary>
        /// <param name="events">events.</param>
        public EventsApiResourceEvents(List<Event> events = default(List<Event>))
        {
            this.Events = events;
        }
        ...
        {
            return this.Equals(input as EventsApiResourceEvents);
        }

        /// <summary>
        /// Returns true if EventsApiResourceEvents instances are equal
        /// </summary>
        /// <param name="input">Instance of EventsApiResourceEvents to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EventsApiResourceEvents input)
        {
            if (input == null)
            {
                return false;
