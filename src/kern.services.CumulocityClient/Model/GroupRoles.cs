...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "group_roles")]
    public partial class GroupRoles : IEquatable<GroupRoles>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupRoles" /> class.
        /// </summary>
        /// <param name="references">A list of user role references..</param>
        /// <param name="statistics">statistics.</param>
        public GroupRoles(List<RoleReference> references = default(List<RoleReference>), PageStatistics statistics = default(PageStatistics))
        {
        ...
        /// </summary>
        /// <value>A list of user role references.</value>
        ...
        {
            return this.Equals(input as GroupRoles);
        }

        /// <summary>
        /// Returns true if GroupRoles instances are equal
        /// </summary>
        /// <param name="input">Instance of GroupRoles to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GroupRoles input)
        {
            if (input == null)
            {
                return false;
