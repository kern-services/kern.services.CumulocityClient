...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SubscribedRole_role")]
    public partial class SubscribedRoleRole : IEquatable<SubscribedRoleRole>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscribedRoleRole" /> class.
        /// </summary>
        /// <param name="self">A URL linking to this resource..</param>
        public SubscribedRoleRole(string self = default(string))
        {
            this.Self = self;
        }
        ...
        {
            return this.Equals(input as SubscribedRoleRole);
        }

        /// <summary>
        /// Returns true if SubscribedRoleRole instances are equal
        /// </summary>
        /// <param name="input">Instance of SubscribedRoleRole to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubscribedRoleRole input)
        {
            if (input == null)
            {
                return false;
