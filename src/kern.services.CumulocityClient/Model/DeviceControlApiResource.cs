...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "deviceControlApiResource")]
    public partial class DeviceControlApiResource : IEquatable<DeviceControlApiResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceControlApiResource" /> class.
        /// </summary>
        /// <param name="operations">operations.</param>
        /// <param name="operationsByStatus">Read-only collection of all operations with a particular status..</param>
        /// <param name="operationsByAgentId">Read-only collection of all operations targeting a particular agent..</param>
        /// <param name="operationsByAgentIdAndStatus">Read-only collection of all operations targeting a particular agent and with a particular status..</param>
        /// <param name="operationsByDeviceId">Read-only collection of all operations to be executed on a particular device..</param>
        /// <param name="operationsByDeviceIdAndStatus">Read-only collection of all operations with a particular status, that should be executed on a particular device..</param>
        public DeviceControlApiResource(DeviceControlApiResourceOperations operations = default(DeviceControlApiResourceOperations), string operationsByStatus = default(string), string operationsByAgentId = default(string), string operationsByAgentIdAndStatus = default(string), string operationsByDeviceId = default(string), string operationsByDeviceIdAndStatus = default(string))
        {
        ...
        public DeviceControlApiResourceOperations Operations { get; set; }

        /// <summary>
        /// Read-only collection of all operations with a particular status.
        /// </summary>
        /// <value>Read-only collection of all operations with a particular status.</value>
        [DataMember(Name = "operationsByStatus", EmitDefaultValue = false)]
        public string OperationsByStatus { get; set; }

        /// <summary>
        /// Read-only collection of all operations targeting a particular agent.
        /// </summary>
        /// <value>Read-only collection of all operations targeting a particular agent.</value>
        [DataMember(Name = "operationsByAgentId", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>Read-only collection of all operations targeting a particular agent and with a particular status.</value>
        [DataMember(Name = "operationsByAgentIdAndStatus", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>Read-only collection of all operations to be executed on a particular device.</value>
        [DataMember(Name = "operationsByDeviceId", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>Read-only collection of all operations with a particular status, that should be executed on a particular device.</value>
        [DataMember(Name = "operationsByDeviceIdAndStatus", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  OperationsByStatus: ").Append(OperationsByStatus).Append("\n");
            sb.Append("  OperationsByAgentId: ").Append(OperationsByAgentId).Append("\n");
            sb.Append("  OperationsByAgentIdAndStatus: ").Append(OperationsByAgentIdAndStatus).Append("\n");
            sb.Append("  OperationsByDeviceId: ").Append(OperationsByDeviceId).Append("\n");
            sb.Append("  OperationsByDeviceIdAndStatus: ").Append(OperationsByDeviceIdAndStatus).Append("\n");
        ...
        {
            return this.Equals(input as DeviceControlApiResource);
        }

        /// <summary>
        /// Returns true if DeviceControlApiResource instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceControlApiResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceControlApiResource input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.OperationsByStatus == input.OperationsByStatus ||
                    (this.OperationsByStatus != null &&
                    this.OperationsByStatus.Equals(input.OperationsByStatus))
                ) && 
                (
                    this.OperationsByAgentId == input.OperationsByAgentId ||
                    (this.OperationsByAgentId != null &&
                    this.OperationsByAgentId.Equals(input.OperationsByAgentId))
                ) && 
                (
                    this.OperationsByAgentIdAndStatus == input.OperationsByAgentIdAndStatus ||
                    (this.OperationsByAgentIdAndStatus != null &&
                    this.OperationsByAgentIdAndStatus.Equals(input.OperationsByAgentIdAndStatus))
                ) && 
                (
                    this.OperationsByDeviceId == input.OperationsByDeviceId ||
                    (this.OperationsByDeviceId != null &&
                    this.OperationsByDeviceId.Equals(input.OperationsByDeviceId))
                ) && 
                (
                    this.OperationsByDeviceIdAndStatus == input.OperationsByDeviceIdAndStatus ||
                    (this.OperationsByDeviceIdAndStatus != null &&
                    this.OperationsByDeviceIdAndStatus.Equals(input.OperationsByDeviceIdAndStatus))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.OperationsByStatus != null)
                {
                    hashCode = (hashCode * 59) + this.OperationsByStatus.GetHashCode();
                }
                if (this.OperationsByAgentId != null)
                {
                    hashCode = (hashCode * 59) + this.OperationsByAgentId.GetHashCode();
                }
                if (this.OperationsByAgentIdAndStatus != null)
                {
                    hashCode = (hashCode * 59) + this.OperationsByAgentIdAndStatus.GetHashCode();
                }
                if (this.OperationsByDeviceId != null)
                {
                    hashCode = (hashCode * 59) + this.OperationsByDeviceId.GetHashCode();
                }
                if (this.OperationsByDeviceIdAndStatus != null)
                {
                    hashCode = (hashCode * 59) + this.OperationsByDeviceIdAndStatus.GetHashCode();
                }
                if (this.Self != null)
                {
