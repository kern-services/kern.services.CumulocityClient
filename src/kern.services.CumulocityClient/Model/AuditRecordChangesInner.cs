...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "auditRecord_changes_inner")]
    public partial class AuditRecordChangesInner : IEquatable<AuditRecordChangesInner>, IValidatableObject
    {
        /// <summary>
        /// The type of change that was carried out.
        /// </summary>
        /// <value>The type of change that was carried out.</value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditRecordChangesInner" /> class.
        /// </summary>
        /// <param name="attribute">The attribute that was changed..</param>
        /// <param name="changeType">The type of change that was carried out..</param>
        /// <param name="newValue">newValue.</param>
        /// <param name="previousValue">previousValue.</param>
        /// <param name="type">The type of the object..</param>
        public AuditRecordChangesInner(string attribute = default(string), ChangeTypeEnum? changeType = default(ChangeTypeEnum?), AuditRecordChangesInnerNewValue newValue = default(AuditRecordChangesInnerNewValue), AuditRecordChangesInnerPreviousValue previousValue = default(AuditRecordChangesInnerPreviousValue), string type = default(string))
        {
        ...
        /// </summary>
        /// <value>The attribute that was changed.</value>
        ...
        public AuditRecordChangesInnerNewValue NewValue { get; set; }

        /// <summary>
        /// Gets or Sets PreviousValue
        /// </summary>
        [DataMember(Name = "previousValue", EmitDefaultValue = true)]
        public AuditRecordChangesInnerPreviousValue PreviousValue { get; set; }
        ...
        {
            return this.Equals(input as AuditRecordChangesInner);
        }

        /// <summary>
        /// Returns true if AuditRecordChangesInner instances are equal
        /// </summary>
        /// <param name="input">Instance of AuditRecordChangesInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuditRecordChangesInner input)
        {
            if (input == null)
            {
                return false;
