...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "postTenantCollectionResource_request")]
    public partial class PostTenantCollectionResourceRequest : IValidatableObject
    {
        /// <summary>
        ...
        public PostTenantCollectionResourceRequest(string adminEmail = default(string), string adminName = default(string), string adminPass = default(string), TenantApplications applications = default(TenantApplications), string company = default(string), string contactName = default(string), string contactPhone = default(string), CustomProperties customProperties = default(CustomProperties), string domain = default(string), TenantOwnedApplications ownedApplications = default(TenantOwnedApplications))
        {
            ...
            if (adminName == null)
            {
                throw new ArgumentNullException("adminName is a required property for PostTenantCollectionResourceRequest and cannot be null");
            }
            this.AdminName = adminName;
            // to ensure "company" is required (not null)
            if (company == null)
            {
                throw new ArgumentNullException("company is a required property for PostTenantCollectionResourceRequest and cannot be null");
            }
            this.Company = company;
            // to ensure "domain" is required (not null)
            if (domain == null)
            {
                throw new ArgumentNullException("domain is a required property for PostTenantCollectionResourceRequest and cannot be null");
            }
            this.Domain = domain;
        ...
        [DataMember(Name = "adminName", IsRequired = true, EmitDefaultValue = true)]
