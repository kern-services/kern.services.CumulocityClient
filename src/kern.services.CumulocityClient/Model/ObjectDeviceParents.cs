...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "objectDeviceParents")]
    public partial class ObjectDeviceParents : IEquatable<ObjectDeviceParents>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ObjectDeviceParents" /> class.
        /// </summary>
        /// <param name="references">An array with the references to parent objects..</param>
        /// <param name="self">Link to this resource&#39;s parent objects..</param>
        public ObjectDeviceParents(List<ManagedObjectReferenceTuple> references = default(List<ManagedObjectReferenceTuple>), string self = default(string))
        {
        ...
        /// </summary>
        /// <value>An array with the references to parent objects.</value>
        ...
        /// </summary>
        /// <value>Link to this resource&#39;s parent objects.</value>
        ...
        {
            return this.Equals(input as ObjectDeviceParents);
        }

        /// <summary>
        /// Returns true if ObjectDeviceParents instances are equal
        /// </summary>
        /// <param name="input">Instance of ObjectDeviceParents to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ObjectDeviceParents input)
        {
            if (input == null)
            {
                return false;
