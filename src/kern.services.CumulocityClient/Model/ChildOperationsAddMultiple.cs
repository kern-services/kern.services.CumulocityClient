...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "childOperationsAddMultiple")]
    public partial class ChildOperationsAddMultiple : IEquatable<ChildOperationsAddMultiple>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ChildOperationsAddMultiple" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ChildOperationsAddMultiple() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ChildOperationsAddMultiple" /> class.
        /// </summary>
        /// <param name="references">An array containing the IDs of the managed objects (children). (required).</param>
        public ChildOperationsAddMultiple(List<ChildOperationsAddMultipleReferencesInner> references = default(List<ChildOperationsAddMultipleReferencesInner>))
        {
            // to ensure "references" is required (not null)
            if (references == null)
            {
                throw new ArgumentNullException("references is a required property for ChildOperationsAddMultiple and cannot be null");
            }
        ...
        /// </summary>
        /// <value>An array containing the IDs of the managed objects (children).</value>
        [DataMember(Name = "references", IsRequired = true, EmitDefaultValue = true)]
        public List<ChildOperationsAddMultipleReferencesInner> References { get; set; }
        ...
        {
            return this.Equals(input as ChildOperationsAddMultiple);
        }

        /// <summary>
        /// Returns true if ChildOperationsAddMultiple instances are equal
        /// </summary>
        /// <param name="input">Instance of ChildOperationsAddMultiple to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChildOperationsAddMultiple input)
        {
            if (input == null)
            {
                return false;
