...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "systemOption")]
    public partial class SystemOption : IEquatable<SystemOption>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SystemOption" /> class.
        /// </summary>
        /// <param name="category">Name of the system option category..</param>
        /// <param name="key">A unique identifier for this system option..</param>
        /// <param name="value">Value of this system option..</param>
        public SystemOption(string category = default(string), string key = default(string), string value = default(string))
        {
        ...
        /// </summary>
        /// <value>Name of the system option category.</value>
        ...
        /// </summary>
        /// <value>A unique identifier for this system option.</value>
        ...
        /// </summary>
        /// <value>Value of this system option.</value>
        ...
        {
            return this.Equals(input as SystemOption);
        }

        /// <summary>
        /// Returns true if SystemOption instances are equal
        /// </summary>
        /// <param name="input">Instance of SystemOption to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SystemOption input)
        {
            if (input == null)
            {
                return false;
