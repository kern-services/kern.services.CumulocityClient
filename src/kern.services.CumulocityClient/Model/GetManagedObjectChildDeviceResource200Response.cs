...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getManagedObjectChildDeviceResource_200_response")]
    public partial class GetManagedObjectChildDeviceResource200Response : IEquatable<GetManagedObjectChildDeviceResource200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetManagedObjectChildDeviceResource200Response" /> class.
        /// </summary>
        /// <param name="managedObject">managedObject.</param>
        /// <param name="self">self.</param>
        public GetManagedObjectChildDeviceResource200Response(ManagedObject managedObject = default(ManagedObject), Object self = default(Object))
        {
        ...
        {
            return this.Equals(input as GetManagedObjectChildDeviceResource200Response);
        }

        /// <summary>
        /// Returns true if GetManagedObjectChildDeviceResource200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of GetManagedObjectChildDeviceResource200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetManagedObjectChildDeviceResource200Response input)
        {
            if (input == null)
            {
                return false;
