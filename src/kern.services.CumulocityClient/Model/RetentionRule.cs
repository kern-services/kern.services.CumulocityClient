...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// RetentionRule
    /// </summary>
    [DataContract(Name = "retentionRule")]
    public partial class RetentionRule : IEquatable<RetentionRule>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="maximumAge">Maximum age expressed in number of days..</param>
        ...
        public RetentionRule(DataTypeEnum? dataType = DataTypeEnum.Star, bool editable = true, string fragmentType = "*", int maximumAge = default(int), string source = "*", string type = "*")
        {
        ...
        {
            return this.Equals(input as RetentionRule);
        }

        /// <summary>
        /// Returns true if RetentionRule instances are equal
        /// </summary>
        /// <param name="input">Instance of RetentionRule to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RetentionRule input)
        {
            if (input == null)
            {
                return false;
