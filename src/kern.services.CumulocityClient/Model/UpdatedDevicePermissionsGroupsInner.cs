...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpdatedDevicePermissions_groups_inner")]
    public partial class UpdatedDevicePermissionsGroupsInner : IEquatable<UpdatedDevicePermissionsGroupsInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdatedDevicePermissionsGroupsInner" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="devicePermissions">An object with a list of the user&#39;s device permissions..</param>
        public UpdatedDevicePermissionsGroupsInner(string id = default(string), Dictionary<string, List<string>> devicePermissions = default(Dictionary<string, List<string>>))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as UpdatedDevicePermissionsGroupsInner);
        }

        /// <summary>
        /// Returns true if UpdatedDevicePermissionsGroupsInner instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdatedDevicePermissionsGroupsInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdatedDevicePermissionsGroupsInner input)
        {
            if (input == null)
            {
                return false;
