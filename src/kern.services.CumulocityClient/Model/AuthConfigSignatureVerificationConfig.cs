...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "authConfig_signatureVerificationConfig")]
    public partial class AuthConfigSignatureVerificationConfig : IEquatable<AuthConfigSignatureVerificationConfig>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthConfigSignatureVerificationConfig" /> class.
        /// </summary>
        /// <param name="aad">aad.</param>
        /// <param name="adfsManifest">adfsManifest.</param>
        /// <param name="jwks">jwks.</param>
        /// <param name="manual">manual.</param>
        public AuthConfigSignatureVerificationConfig(AuthConfigSignatureVerificationConfigAad aad = default(AuthConfigSignatureVerificationConfigAad), AuthConfigSignatureVerificationConfigAdfsManifest adfsManifest = default(AuthConfigSignatureVerificationConfigAdfsManifest), AuthConfigSignatureVerificationConfigJwks jwks = default(AuthConfigSignatureVerificationConfigJwks), AuthConfigSignatureVerificationConfigManual manual = default(AuthConfigSignatureVerificationConfigManual))
        {
            this.Aad = aad;
        ...
        /// Gets or Sets Aad
        /// </summary>
        [DataMember(Name = "aad", EmitDefaultValue = false)]
        public AuthConfigSignatureVerificationConfigAad Aad { get; set; }

        /// <summary>
        /// Gets or Sets AdfsManifest
        /// </summary>
        [DataMember(Name = "adfsManifest", EmitDefaultValue = false)]
        public AuthConfigSignatureVerificationConfigAdfsManifest AdfsManifest { get; set; }

        /// <summary>
        /// Gets or Sets Jwks
        /// </summary>
        [DataMember(Name = "jwks", EmitDefaultValue = false)]
        public AuthConfigSignatureVerificationConfigJwks Jwks { get; set; }

        /// <summary>
        /// Gets or Sets Manual
        /// </summary>
        [DataMember(Name = "manual", EmitDefaultValue = false)]
        public AuthConfigSignatureVerificationConfigManual Manual { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  Aad: ").Append(Aad).Append("\n");
            sb.Append("  AdfsManifest: ").Append(AdfsManifest).Append("\n");
        ...
        {
            return this.Equals(input as AuthConfigSignatureVerificationConfig);
        }

        /// <summary>
        /// Returns true if AuthConfigSignatureVerificationConfig instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthConfigSignatureVerificationConfig to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthConfigSignatureVerificationConfig input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.Aad == input.Aad ||
                    (this.Aad != null &&
                    this.Aad.Equals(input.Aad))
                ) && 
                (
                    this.AdfsManifest == input.AdfsManifest ||
                    (this.AdfsManifest != null &&
                    this.AdfsManifest.Equals(input.AdfsManifest))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Aad != null)
                {
                    hashCode = (hashCode * 59) + this.Aad.GetHashCode();
                }
                if (this.AdfsManifest != null)
                {
                    hashCode = (hashCode * 59) + this.AdfsManifest.GetHashCode();
                }
                if (this.Jwks != null)
                {
