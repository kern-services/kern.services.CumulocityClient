...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "operationReference_operation")]
    public partial class OperationReferenceOperation : IEquatable<OperationReferenceOperation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OperationReferenceOperation" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as OperationReferenceOperation);
        }

        /// <summary>
        /// Returns true if OperationReferenceOperation instances are equal
        /// </summary>
        /// <param name="input">Instance of OperationReferenceOperation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OperationReferenceOperation input)
        {
            if (input == null)
            {
                return false;
