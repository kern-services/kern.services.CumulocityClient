...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NotificationSubscription_subscriptionFilter")]
    public partial class NotificationSubscriptionSubscriptionFilter : IEquatable<NotificationSubscriptionSubscriptionFilter>, IValidatableObject
    {
        /// <summary>
        /// Defines Apis
        /// </summary>
        ...
        public enum ApisEnum
        {
            ...
            /// <summary>
            /// Enum AlarmsWithChildren for value: alarmsWithChildren
            /// </summary>
            [EnumMember(Value = "alarmsWithChildren")]
            AlarmsWithChildren = 2,
            ...
            /// <summary>
            /// Enum EventsWithChildren for value: eventsWithChildren
            /// </summary>
            [EnumMember(Value = "eventsWithChildren")]
            EventsWithChildren = 4,

            /// <summary>
            /// Enum Managedobjects for value: managedobjects
            /// </summary>
            [EnumMember(Value = "managedobjects")]
            Managedobjects = 5,

            /// <summary>
            /// Enum Measurements for value: measurements
            /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NotificationSubscriptionSubscriptionFilter" /> class.
        /// </summary>
        /// <param name="apis">The Notifications are available for Alarms, Alarms with children, Device control, Events, Events with children, Inventory and Measurements for the &#x60;mo&#x60; context and for Alarms and Inventory for the &#x60;tenant&#x60; context. Alternatively, the wildcard &#x60;*&#x60; can be used to match all the permissible APIs within the bound context.  &gt; **&amp;#9432; Info:** the wildcard &#x60;*&#x60; cannot be used in conjunction with other values. .</param>
        /// <param name="typeFilter">The data needs to have the specified value in its &#x60;type&#x60; property to meet the filter criteria..</param>
        public NotificationSubscriptionSubscriptionFilter(List<ApisEnum> apis = default(List<ApisEnum>), string typeFilter = default(string))
        {
            this.Apis = apis;
        ...
        /// <summary>
        /// The Notifications are available for Alarms, Alarms with children, Device control, Events, Events with children, Inventory and Measurements for the &#x60;mo&#x60; context and for Alarms and Inventory for the &#x60;tenant&#x60; context. Alternatively, the wildcard &#x60;*&#x60; can be used to match all the permissible APIs within the bound context.  &gt; **&amp;#9432; Info:** the wildcard &#x60;*&#x60; cannot be used in conjunction with other values. 
        /// </summary>
        /// <value>The Notifications are available for Alarms, Alarms with children, Device control, Events, Events with children, Inventory and Measurements for the &#x60;mo&#x60; context and for Alarms and Inventory for the &#x60;tenant&#x60; context. Alternatively, the wildcard &#x60;*&#x60; can be used to match all the permissible APIs within the bound context.  &gt; **&amp;#9432; Info:** the wildcard &#x60;*&#x60; cannot be used in conjunction with other values. </value>
        [DataMember(Name = "apis", EmitDefaultValue = false)]
        public List<NotificationSubscriptionSubscriptionFilter.ApisEnum> Apis { get; set; }

        /// <summary>
        /// The data needs to have the specified value in its &#x60;type&#x60; property to meet the filter criteria.
        /// </summary>
        /// <value>The data needs to have the specified value in its &#x60;type&#x60; property to meet the filter criteria.</value>
        ...
        {
            return this.Equals(input as NotificationSubscriptionSubscriptionFilter);
        }

        /// <summary>
        /// Returns true if NotificationSubscriptionSubscriptionFilter instances are equal
        /// </summary>
        /// <param name="input">Instance of NotificationSubscriptionSubscriptionFilter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NotificationSubscriptionSubscriptionFilter input)
        {
            if (input == null)
            {
                return false;
