...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MeasurementCollection")]
    public partial class MeasurementCollection : IEquatable<MeasurementCollection>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MeasurementCollection" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MeasurementCollection() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MeasurementCollection" /> class.
        /// </summary>
        /// <param name="measurements">An array containing the measurements of the request. (required).</param>
        /// <param name="statistics">statistics.</param>
        public MeasurementCollection(List<Measurement> measurements = default(List<Measurement>), MeasurementCollectionStatistics statistics = default(MeasurementCollectionStatistics))
        {
            // to ensure "measurements" is required (not null)
            if (measurements == null)
            {
                throw new ArgumentNullException("measurements is a required property for MeasurementCollection and cannot be null");
            }
        ...
        /// </summary>
        /// <value>An array containing the measurements of the request.</value>
        ...
        public MeasurementCollectionStatistics Statistics { get; set; }
        ...
        {
            return this.Equals(input as MeasurementCollection);
        }

        /// <summary>
        /// Returns true if MeasurementCollection instances are equal
        /// </summary>
        /// <param name="input">Instance of MeasurementCollection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MeasurementCollection input)
        {
            if (input == null)
            {
                return false;
