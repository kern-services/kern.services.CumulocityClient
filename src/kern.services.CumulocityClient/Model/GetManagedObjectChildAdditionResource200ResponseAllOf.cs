...
{
    /// <summary>
    /// GetManagedObjectChildAdditionResource200ResponseAllOf
    /// </summary>
    [DataContract(Name = "getManagedObjectChildAdditionResource_200_response_allOf")]
    public partial class GetManagedObjectChildAdditionResource200ResponseAllOf : IEquatable<GetManagedObjectChildAdditionResource200ResponseAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetManagedObjectChildAdditionResource200ResponseAllOf" /> class.
        /// </summary>
        /// <param name="self">self.</param>
        public GetManagedObjectChildAdditionResource200ResponseAllOf(Object self = default(Object))
        {
            this.Self = self;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetManagedObjectChildAdditionResource200ResponseAllOf {\n");
        ...
        {
            return this.Equals(input as GetManagedObjectChildAdditionResource200ResponseAllOf);
        }

        /// <summary>
        /// Returns true if GetManagedObjectChildAdditionResource200ResponseAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of GetManagedObjectChildAdditionResource200ResponseAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetManagedObjectChildAdditionResource200ResponseAllOf input)
        {
            if (input == null)
            {
                return false;
