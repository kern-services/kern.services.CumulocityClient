...
namespace kern.services.CumulocityClient.Model
{
    ...
    public partial class JSONPredicateRepresentation : IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="varOperator">Operator executed on the parameter from the JWT access token claim pointed by &#x60;parameterPath&#x60; and the provided parameter &#x60;value&#x60;..</param>
        ...
        public JSONPredicateRepresentation(List<JSONPredicateRepresentation> childPredicates = default(List<JSONPredicateRepresentation>), OperatorEnum? varOperator = default(OperatorEnum?), string parameterPath = default(string), string value = default(string))
        {
