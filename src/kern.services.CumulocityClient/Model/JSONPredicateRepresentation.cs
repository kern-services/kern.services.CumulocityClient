...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "JSONPredicateRepresentation")]
    public partial class JSONPredicateRepresentation : IEquatable<JSONPredicateRepresentation>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>Operator executed on the parameter from the JWT access token claim pointed by &#x60;parameterPath&#x60; and the provided parameter &#x60;value&#x60;.</value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="JSONPredicateRepresentation" /> class.
        /// </summary>
        /// <param name="childPredicates">Nested predicates..</param>
        /// <param name="_operator">Operator executed on the parameter from the JWT access token claim pointed by &#x60;parameterPath&#x60; and the provided parameter &#x60;value&#x60;..</param>
        /// <param name="parameterPath">Path to the claim from the JWT access token from the external authorization server..</param>
        /// <param name="value">Given value used for parameter verification..</param>
        public JSONPredicateRepresentation(List<JSONPredicateRepresentation> childPredicates = default(List<JSONPredicateRepresentation>), OperatorEnum? _operator = default(OperatorEnum?), string parameterPath = default(string), string value = default(string))
        {
        ...
        /// Nested predicates.
        /// </summary>
        /// <value>Nested predicates.</value>
        [DataMember(Name = "childPredicates", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>Path to the claim from the JWT access token from the external authorization server.</value>
        [DataMember(Name = "parameterPath", EmitDefaultValue = false)]
        public string ParameterPath { get; set; }

        /// <summary>
        /// Given value used for parameter verification.
        /// </summary>
        /// <value>Given value used for parameter verification.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ChildPredicates: ").Append(ChildPredicates).Append("\n");
            sb.Append("  Operator: ").Append(Operator).Append("\n");
            sb.Append("  ParameterPath: ").Append(ParameterPath).Append("\n");
        ...
        {
            return this.Equals(input as JSONPredicateRepresentation);
        }

        /// <summary>
        /// Returns true if JSONPredicateRepresentation instances are equal
        /// </summary>
        /// <param name="input">Instance of JSONPredicateRepresentation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JSONPredicateRepresentation input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.ChildPredicates == input.ChildPredicates ||
                    this.ChildPredicates != null &&
                    input.ChildPredicates != null &&
                    this.ChildPredicates.SequenceEqual(input.ChildPredicates)
                ) && 
                (
                ...
                (
                    this.ParameterPath == input.ParameterPath ||
                    (this.ParameterPath != null &&
                    this.ParameterPath.Equals(input.ParameterPath))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.ChildPredicates.GetHashCode();
                }
                hashCode = (hashCode * 59) + this.Operator.GetHashCode();
                if (this.ParameterPath != null)
                {
                    hashCode = (hashCode * 59) + this.ParameterPath.GetHashCode();
                }
                if (this.Value != null)
                {
