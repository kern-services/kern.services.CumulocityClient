...
namespace kern.services.CumulocityClient.Model
{
    ...
    public partial class CurrentUser : IEquatable<CurrentUser>, IValidatableObject
    {
        ...
        /// <param name="password">The user&#39;s password. Only Latin1 characters are allowed..</param>
        ...
        public CurrentUser(string email = default(string), string firstName = default(string), string lastName = default(string), string password = default(string), string phone = default(string), string userName = default(string), Dictionary<string, List<string>> devicePermissions = default(Dictionary<string, List<string>>))
        {
            this.Email = email;
        ...
        /// </summary>
        /// <value>A list of user roles.</value>
        [DataMember(Name = "effectiveRoles", EmitDefaultValue = false)]
        public List<Role> EffectiveRoles { get; private set; }

        /// <summary>
        /// Returns false as EffectiveRoles should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeEffectiveRoles()
        {
            return false;
        }
        /// <summary>
        ...
        /// </summary>
        /// <value>The user&#39;s password. Only Latin1 characters are allowed.</value>
        ...
        public bool Equals(CurrentUser input)
        {
            ...
            return 
                (
                    this.EffectiveRoles == input.EffectiveRoles ||
                    this.EffectiveRoles != null &&
                    input.EffectiveRoles != null &&
                    this.EffectiveRoles.SequenceEqual(input.EffectiveRoles)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.EffectiveRoles.GetHashCode();
                }
                if (this.Email != null)
                {
