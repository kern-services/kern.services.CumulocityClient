...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "realtimeNotification_advice")]
    public partial class RealtimeNotificationAdvice : IEquatable<RealtimeNotificationAdvice>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RealtimeNotificationAdvice" /> class.
        /// </summary>
        /// <param name="interval">Period (milliseconds) after which the server will close the session, if it doesn&#39;t received the next connect message from the client. Overrides server default settings for current request-response conversation..</param>
        /// <param name="timeout">Interval (milliseconds) between the sending of the connect message and the response from the server. Overrides server default settings for the current request-response conversation..</param>
        public RealtimeNotificationAdvice(int interval = default(int), int timeout = default(int))
        {
        ...
        /// </summary>
        /// <value>Period (milliseconds) after which the server will close the session, if it doesn&#39;t received the next connect message from the client. Overrides server default settings for current request-response conversation.</value>
        ...
        /// </summary>
        /// <value>Interval (milliseconds) between the sending of the connect message and the response from the server. Overrides server default settings for the current request-response conversation.</value>
        ...
        {
            return this.Equals(input as RealtimeNotificationAdvice);
        }

        /// <summary>
        /// Returns true if RealtimeNotificationAdvice instances are equal
        /// </summary>
        /// <param name="input">Instance of RealtimeNotificationAdvice to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RealtimeNotificationAdvice input)
        {
            if (input == null)
            {
                return false;
