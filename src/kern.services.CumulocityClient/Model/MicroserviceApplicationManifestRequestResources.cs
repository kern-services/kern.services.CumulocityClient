...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "microservice_application_manifest_requestResources")]
    public partial class MicroserviceApplicationManifestRequestResources : IEquatable<MicroserviceApplicationManifestRequestResources>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MicroserviceApplicationManifestRequestResources" /> class.
        /// </summary>
        /// <param name="cpu">The required CPU resource for this microservice application..</param>
        /// <param name="memory">The required memory resource for this microservice application..</param>
        public MicroserviceApplicationManifestRequestResources(string cpu = default(string), string memory = default(string))
        {
            this.Cpu = cpu;
            this.Memory = memory;
        }
        ...
        /// </summary>
        /// <value>The required CPU resource for this microservice application.</value>
        ...
        /// </summary>
        /// <value>The required memory resource for this microservice application.</value>
        ...
        {
            return this.Equals(input as MicroserviceApplicationManifestRequestResources);
        }

        /// <summary>
        /// Returns true if MicroserviceApplicationManifestRequestResources instances are equal
        /// </summary>
        /// <param name="input">Instance of MicroserviceApplicationManifestRequestResources to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MicroserviceApplicationManifestRequestResources input)
        {
            if (input == null)
            {
                return false;
