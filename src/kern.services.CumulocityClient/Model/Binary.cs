...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Binary :  IEquatable<Binary>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Binary" /> class.
        /// </summary>
        /// <param name="c8yIsBinary">Fragment to identify this managed object as a file..</param>
        ...
        /// <param name="name">Name of the managed object. It is set from the &#x60;object&#x60; contained in the payload..</param>
        /// <param name="owner">Username of the owner of the file..</param>
        /// <param name="type">Type of the managed object. It is set from the &#x60;object&#x60; contained in the payload..</param>
        public Binary(Object c8yIsBinary = default(Object), string contentType = default(string), string id = default(string), int length = default(int), string name = default(string), string owner = default(string), string type = default(string))
        {
        ...
        /// </summary>
        /// <value>Fragment to identify this managed object as a file.</value>
        [DataMember(Name="c8y_IsBinary", EmitDefaultValue=false)]
        public Object C8yIsBinary { get; set; }
        ...
        /// </summary>
        /// <value>Date and time of the file&#39;s last update.</value>
        ...
        /// </summary>
        /// <value>Name of the managed object. It is set from the &#x60;object&#x60; contained in the payload.</value>
        ...
        /// </summary>
        /// <value>Username of the owner of the file.</value>
        ...
        /// </summary>
        /// <value>Type of the managed object. It is set from the &#x60;object&#x60; contained in the payload.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  C8yIsBinary: ").Append(C8yIsBinary).Append("\n");
        ...
        {
            return this.Equals(input as Binary);
        }

        /// <summary>
        /// Returns true if Binary instances are equal
        /// </summary>
        /// <param name="input">Instance of Binary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Binary input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.C8yIsBinary == input.C8yIsBinary ||
                    (this.C8yIsBinary != null &&
                    this.C8yIsBinary.Equals(input.C8yIsBinary))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.C8yIsBinary != null)
                    hashCode = hashCode * 59 + this.C8yIsBinary.GetHashCode();
