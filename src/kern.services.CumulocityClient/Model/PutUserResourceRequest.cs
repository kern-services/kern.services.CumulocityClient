...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "putUserResource_request")]
    public partial class PutUserResourceRequest : IEquatable<PutUserResourceRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PutUserResourceRequest" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as PutUserResourceRequest);
        }

        /// <summary>
        /// Returns true if PutUserResourceRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PutUserResourceRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PutUserResourceRequest input)
        {
            if (input == null)
            {
                return false;
