...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UserReferenceCollection")]
    public partial class UserReferenceCollection : IEquatable<UserReferenceCollection>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserReferenceCollection" /> class.
        /// </summary>
        /// <param name="references">An array of user references..</param>
        /// <param name="statistics">statistics.</param>
        public UserReferenceCollection(List<UserReference> references = default(List<UserReference>), PageStatistics statistics = default(PageStatistics))
        {
        ...
        /// </summary>
        /// <value>An array of user references.</value>
        ...
        {
            return this.Equals(input as UserReferenceCollection);
        }

        /// <summary>
        /// Returns true if UserReferenceCollection instances are equal
        /// </summary>
        /// <param name="input">Instance of UserReferenceCollection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserReferenceCollection input)
        {
            if (input == null)
            {
                return false;
