...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "childOperationsAddMultiple_references_inner")]
    public partial class ChildOperationsAddMultipleReferencesInner : IEquatable<ChildOperationsAddMultipleReferencesInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ChildOperationsAddMultipleReferencesInner" /> class.
        /// </summary>
        /// <param name="managedObject">managedObject.</param>
        public ChildOperationsAddMultipleReferencesInner(ChildOperationsAddMultipleReferencesInnerManagedObject managedObject = default(ChildOperationsAddMultipleReferencesInnerManagedObject))
        {
            this.ManagedObject = managedObject;
        }

        /// <summary>
        /// Gets or Sets ManagedObject
        /// </summary>
        [DataMember(Name = "managedObject", EmitDefaultValue = false)]
        public ChildOperationsAddMultipleReferencesInnerManagedObject ManagedObject { get; set; }
        ...
        {
            return this.Equals(input as ChildOperationsAddMultipleReferencesInner);
        }

        /// <summary>
        /// Returns true if ChildOperationsAddMultipleReferencesInner instances are equal
        /// </summary>
        /// <param name="input">Instance of ChildOperationsAddMultipleReferencesInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChildOperationsAddMultipleReferencesInner input)
        {
            if (input == null)
            {
                return false;
