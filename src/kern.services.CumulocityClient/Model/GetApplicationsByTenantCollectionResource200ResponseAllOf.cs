...
{
    /// <summary>
    /// GetApplicationsByTenantCollectionResource200ResponseAllOf
    /// </summary>
    [DataContract(Name = "getApplicationsByTenantCollectionResource_200_response_allOf")]
    public partial class GetApplicationsByTenantCollectionResource200ResponseAllOf : IEquatable<GetApplicationsByTenantCollectionResource200ResponseAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetApplicationsByTenantCollectionResource200ResponseAllOf" /> class.
        /// </summary>
        /// <param name="self">self.</param>
        /// <param name="prev">prev.</param>
        /// <param name="next">next.</param>
        public GetApplicationsByTenantCollectionResource200ResponseAllOf(string self = default(string), string prev = default(string), string next = default(string))
        {
            this.Self = self;
            this.Prev = prev;
            this.Next = next;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetApplicationsByTenantCollectionResource200ResponseAllOf {\n");
        ...
        {
            return this.Equals(input as GetApplicationsByTenantCollectionResource200ResponseAllOf);
        }

        /// <summary>
        /// Returns true if GetApplicationsByTenantCollectionResource200ResponseAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of GetApplicationsByTenantCollectionResource200ResponseAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetApplicationsByTenantCollectionResource200ResponseAllOf input)
        {
            if (input == null)
            {
                return false;
