...
{
    /// <summary>
    /// PutOperationResourceRequestAllOf
    /// </summary>
    [DataContract(Name = "putOperationResource_request_allOf")]
    public partial class PutOperationResourceRequestAllOf : IEquatable<PutOperationResourceRequestAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PutOperationResourceRequestAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public PutOperationResourceRequestAllOf()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PutOperationResourceRequestAllOf {\n");
        ...
        {
            return this.Equals(input as PutOperationResourceRequestAllOf);
        }

        /// <summary>
        /// Returns true if PutOperationResourceRequestAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of PutOperationResourceRequestAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PutOperationResourceRequestAllOf input)
        {
            if (input == null)
            {
                return false;
