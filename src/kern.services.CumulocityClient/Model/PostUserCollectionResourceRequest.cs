...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "postUserCollectionResource_request")]
    public partial class PostUserCollectionResourceRequest : IEquatable<PostUserCollectionResourceRequest>, IValidatableObject
    {
        /// <summary>
        /// Indicates the password strength. The value can be GREEN, YELLOW or RED for decreasing password strengths.
        /// </summary>
        /// <value>Indicates the password strength. The value can be GREEN, YELLOW or RED for decreasing password strengths.</value>
        ...
        /// <summary>
        /// Returns false as PasswordStrength should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializePasswordStrength()
        {
            return false;
        }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostUserCollectionResourceRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostUserCollectionResourceRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostUserCollectionResourceRequest" /> class.
        /// </summary>
        /// <param name="customProperties">customProperties.</param>
        /// <param name="displayName">The user&#39;s display name in Cumulocity IoT..</param>
        /// <param name="email">The user&#39;s email address. (required).</param>
        /// <param name="enabled">Indicates whether the user is enabled or not. Disabled users cannot log in or perform API requests. (default to true).</param>
        /// <param name="firstName">The user&#39;s first name..</param>
        /// <param name="groups">groups.</param>
        /// <param name="lastName">The user&#39;s last name..</param>
        /// <param name="newsletter">Indicates whether the user is subscribed to the newsletter or not..</param>
        /// <param name="password">The user&#39;s password. Only Latin1 characters are allowed.  If you do not specify a password when creating a new user with a POST request, it must contain the property &#x60;sendPasswordResetEmail&#x60; with a value of &#x60;true&#x60;. .</param>
        /// <param name="phone">The user&#39;s phone number..</param>
        /// <param name="roles">roles.</param>
        /// <param name="sendPasswordResetEmail">When set to &#x60;true&#x60;, this field will cause Cumulocity IoT to send a password reset email to the email address specified.  If there is no password specified when creating a new user with a POST request, this must be specified and it must be set to &#x60;true&#x60;. .</param>
        /// <param name="userName">The user&#39;s username. It can have a maximum of 1000 characters. (required).</param>
        public PostUserCollectionResourceRequest(CustomProperties customProperties = default(CustomProperties), string displayName = default(string), string email = default(string), bool enabled = true, string firstName = default(string), UserGroups groups = default(UserGroups), string lastName = default(string), bool newsletter = default(bool), string password = default(string), string phone = default(string), UserRoles roles = default(UserRoles), bool sendPasswordResetEmail = default(bool), string userName = default(string))
        {
            // to ensure "email" is required (not null)
            if (email == null)
            {
                throw new ArgumentNullException("email is a required property for PostUserCollectionResourceRequest and cannot be null");
            }
            this.Email = email;
            // to ensure "userName" is required (not null)
            if (userName == null)
            {
                throw new ArgumentNullException("userName is a required property for PostUserCollectionResourceRequest and cannot be null");
            }
        ...
        /// </summary>
        /// <value>A list of applications for this user.</value>
        ...
        /// </summary>
        /// <value>The user&#39;s display name in Cumulocity IoT.</value>
        ...
        /// </summary>
        /// <value>Indicates whether the user is enabled or not. Disabled users cannot log in or perform API requests.</value>
        ...
        /// </summary>
        /// <value>A unique identifier for this user.</value>
        ...
        /// </summary>
        /// <value>The date and time when the user&#39;s password was last changed, in [ISO 8601 datetime format](https://www.w3.org/TR/NOTE-datetime).</value>
        ...
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeLastPasswordChange()
        {
            return false;
        }
        /// <summary>
        ...
        /// </summary>
        /// <value>Indicates whether the user is subscribed to the newsletter or not.</value>
        ...
        /// </summary>
        /// <value>Identifier of the parent user. If present, indicates that a user belongs to a user hierarchy by pointing to its direct ancestor. Can only be set by users with role USER_MANAGEMENT_ADMIN during user creation. Otherwise it&#39;s assigned automatically.</value>
        ...
        /// <summary>
        /// The user&#39;s password. Only Latin1 characters are allowed.  If you do not specify a password when creating a new user with a POST request, it must contain the property &#x60;sendPasswordResetEmail&#x60; with a value of &#x60;true&#x60;. 
        /// </summary>
        /// <value>The user&#39;s password. Only Latin1 characters are allowed.  If you do not specify a password when creating a new user with a POST request, it must contain the property &#x60;sendPasswordResetEmail&#x60; with a value of &#x60;true&#x60;. </value>
        ...
        /// <summary>
        /// When set to &#x60;true&#x60;, this field will cause Cumulocity IoT to send a password reset email to the email address specified.  If there is no password specified when creating a new user with a POST request, this must be specified and it must be set to &#x60;true&#x60;. 
        /// </summary>
        /// <value>When set to &#x60;true&#x60;, this field will cause Cumulocity IoT to send a password reset email to the email address specified.  If there is no password specified when creating a new user with a POST request, this must be specified and it must be set to &#x60;true&#x60;. </value>
        [DataMember(Name = "sendPasswordResetEmail", EmitDefaultValue = true)]
        public bool SendPasswordResetEmail { get; set; }

        /// <summary>
        /// Indicates if the user should reset the password on the next login.
        /// </summary>
        /// <value>Indicates if the user should reset the password on the next login.</value>
        [DataMember(Name = "shouldResetPassword", EmitDefaultValue = true)]
        public bool ShouldResetPassword { get; private set; }

        /// <summary>
        /// Returns false as ShouldResetPassword should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeShouldResetPassword()
        {
            return false;
        }
        /// <summary>
        ...
        /// </summary>
        /// <value>Indicates if the user has to use two-factor authentication to log in.</value>
        [DataMember(Name = "twoFactorAuthenticationEnabled", EmitDefaultValue = true)]
        public bool TwoFactorAuthenticationEnabled { get; private set; }

        /// <summary>
        /// Returns false as TwoFactorAuthenticationEnabled should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeTwoFactorAuthenticationEnabled()
        {
            return false;
        }
        /// <summary>
        ...
        /// </summary>
        /// <value>The user&#39;s username. It can have a maximum of 1000 characters.</value>
        [DataMember(Name = "userName", IsRequired = true, EmitDefaultValue = true)]
        public string UserName { get; set; }

        /// <summary>
        /// Gets or Sets DevicePermissions
        /// </summary>
        [DataMember(Name = "devicePermissions", EmitDefaultValue = true)]
        public Object DevicePermissions { get; private set; }

        /// <summary>
        /// Returns false as DevicePermissions should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeDevicePermissions()
        {
            return false;
        }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SendPasswordResetEmail: ").Append(SendPasswordResetEmail).Append("\n");
            sb.Append("  ShouldResetPassword: ").Append(ShouldResetPassword).Append("\n");
            sb.Append("  TwoFactorAuthenticationEnabled: ").Append(TwoFactorAuthenticationEnabled).Append("\n");
            sb.Append("  UserName: ").Append(UserName).Append("\n");
            sb.Append("  DevicePermissions: ").Append(DevicePermissions).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as PostUserCollectionResourceRequest);
        }

        /// <summary>
        /// Returns true if PostUserCollectionResourceRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PostUserCollectionResourceRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostUserCollectionResourceRequest input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.LastPasswordChange == input.LastPasswordChange ||
                    (this.LastPasswordChange != null &&
                    this.LastPasswordChange.Equals(input.LastPasswordChange))
                ) && 
                (
                ...
                (
                    this.SendPasswordResetEmail == input.SendPasswordResetEmail ||
                    this.SendPasswordResetEmail.Equals(input.SendPasswordResetEmail)
                ) && 
                (
                ...
                (
                    this.TwoFactorAuthenticationEnabled == input.TwoFactorAuthenticationEnabled ||
                    this.TwoFactorAuthenticationEnabled.Equals(input.TwoFactorAuthenticationEnabled)
                ) && 
                (
                ...
                (
                    this.DevicePermissions == input.DevicePermissions ||
                    (this.DevicePermissions != null &&
                    this.DevicePermissions.Equals(input.DevicePermissions))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.LastPasswordChange.GetHashCode();
                }
                ...
                hashCode = (hashCode * 59) + this.SendPasswordResetEmail.GetHashCode();
                hashCode = (hashCode * 59) + this.ShouldResetPassword.GetHashCode();
                hashCode = (hashCode * 59) + this.TwoFactorAuthenticationEnabled.GetHashCode();
                ...
                {
                    hashCode = (hashCode * 59) + this.DevicePermissions.GetHashCode();
                }
                return hashCode;
            }
        }
