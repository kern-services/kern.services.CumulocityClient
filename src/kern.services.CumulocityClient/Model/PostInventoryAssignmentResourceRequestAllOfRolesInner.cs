...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "postInventoryAssignmentResource_request_allOf_roles_inner")]
    public partial class PostInventoryAssignmentResourceRequestAllOfRolesInner : IEquatable<PostInventoryAssignmentResourceRequestAllOfRolesInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostInventoryAssignmentResourceRequestAllOfRolesInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public PostInventoryAssignmentResourceRequestAllOfRolesInner()
        {
        }
        ...
        {
            return this.Equals(input as PostInventoryAssignmentResourceRequestAllOfRolesInner);
        }

        /// <summary>
        /// Returns true if PostInventoryAssignmentResourceRequestAllOfRolesInner instances are equal
        /// </summary>
        /// <param name="input">Instance of PostInventoryAssignmentResourceRequestAllOfRolesInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostInventoryAssignmentResourceRequestAllOfRolesInner input)
        {
            if (input == null)
            {
                return false;
