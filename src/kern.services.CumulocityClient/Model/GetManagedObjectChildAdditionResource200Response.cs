...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getManagedObjectChildAdditionResource_200_response")]
    public partial class GetManagedObjectChildAdditionResource200Response : IEquatable<GetManagedObjectChildAdditionResource200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetManagedObjectChildAdditionResource200Response" /> class.
        /// </summary>
        /// <param name="managedObject">managedObject.</param>
        /// <param name="self">self.</param>
        public GetManagedObjectChildAdditionResource200Response(ManagedObject managedObject = default(ManagedObject), Object self = default(Object))
        {
        ...
        {
            return this.Equals(input as GetManagedObjectChildAdditionResource200Response);
        }

        /// <summary>
        /// Returns true if GetManagedObjectChildAdditionResource200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of GetManagedObjectChildAdditionResource200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetManagedObjectChildAdditionResource200Response input)
        {
            if (input == null)
            {
                return false;
