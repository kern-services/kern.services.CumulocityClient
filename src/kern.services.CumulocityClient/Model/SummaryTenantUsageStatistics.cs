...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SummaryTenantUsageStatistics :  IEquatable<SummaryTenantUsageStatistics>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SummaryTenantUsageStatistics" /> class.
        /// </summary>
        ...
        /// <param name="day">Date of this usage statistics summary..</param>
        ...
        /// </summary>
        /// <value>Date of this usage statistics summary.</value>
        ...
        {
            return this.Equals(input as SummaryTenantUsageStatistics);
        }

        /// <summary>
        /// Returns true if SummaryTenantUsageStatistics instances are equal
        /// </summary>
        /// <param name="input">Instance of SummaryTenantUsageStatistics to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SummaryTenantUsageStatistics input)
        {
            if (input == null)
                return false;
