...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MeasurementCollection_statistics")]
    public partial class MeasurementCollectionStatistics : IEquatable<MeasurementCollectionStatistics>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MeasurementCollectionStatistics" /> class.
        /// </summary>
        /// <param name="currentPage">The current page of the paginated results..</param>
        /// <param name="pageSize">Indicates the number of objects that the collection may contain per page. The upper limit for one page is 2,000 objects..</param>
        /// <param name="totalElements">The total number of results (elements)..</param>
        /// <param name="totalPages">The total number of paginated results (pages).  &gt; **&amp;#9432; Info:** This property is returned by default except when an operation retrieves all records where values are between an upper and lower boundary, for example, querying ranges using &#x60;dateFrom&#x60;–&#x60;dateTo&#x60;. In such cases, the query parameter &#x60;withTotalPages&#x3D;true&#x60; should be used to include the total number of pages (at the expense of slightly slower performance). .</param>
        public MeasurementCollectionStatistics(int currentPage = default(int), int pageSize = default(int), int totalElements = default(int), int totalPages = default(int))
        {
        ...
        /// </summary>
        /// <value>Indicates the number of objects that the collection may contain per page. The upper limit for one page is 2,000 objects.</value>
        ...
        /// </summary>
        /// <value>The total number of results (elements).</value>
        ...
        /// </summary>
        /// <value>The total number of paginated results (pages).  &gt; **&amp;#9432; Info:** This property is returned by default except when an operation retrieves all records where values are between an upper and lower boundary, for example, querying ranges using &#x60;dateFrom&#x60;–&#x60;dateTo&#x60;. In such cases, the query parameter &#x60;withTotalPages&#x3D;true&#x60; should be used to include the total number of pages (at the expense of slightly slower performance). </value>
        ...
        {
            return this.Equals(input as MeasurementCollectionStatistics);
        }

        /// <summary>
        /// Returns true if MeasurementCollectionStatistics instances are equal
        /// </summary>
        /// <param name="input">Instance of MeasurementCollectionStatistics to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MeasurementCollectionStatistics input)
        {
            if (input == null)
            {
                return false;
        ...
        {
            // CurrentPage (int) minimum
            if (this.CurrentPage < (int)1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for CurrentPage, must be a value greater than or equal to 1.", new [] { "CurrentPage" });
            }

            // PageSize (int) maximum
            if (this.PageSize > (int)2000)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for PageSize, must be a value less than or equal to 2000.", new [] { "PageSize" });
            }
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for TotalElements, must be a value greater than or equal to 0.", new [] { "TotalElements" });
            }
