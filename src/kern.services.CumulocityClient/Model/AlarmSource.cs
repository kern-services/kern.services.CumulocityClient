...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "alarm_source")]
    public partial class AlarmSource : IEquatable<AlarmSource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AlarmSource" /> class.
        /// </summary>
        ...
        public AlarmSource(string id = default(string), string name = default(string))
        {
            this.Id = id;
            this.Name = name;
        }
        ...
        {
            return this.Equals(input as AlarmSource);
        }

        /// <summary>
        /// Returns true if AlarmSource instances are equal
        /// </summary>
        /// <param name="input">Instance of AlarmSource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AlarmSource input)
        {
            if (input == null)
            {
                return false;
