...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "StatisticsFile")]
    public partial class StatisticsFile : IEquatable<StatisticsFile>, IValidatableObject
    {
        /// <summary>
        /// The type of statistics: * REAL - generated by the system on the first day of the month and including statistics from the previous month. * TEST - generated by the user with a time range specified in the query parameters (&#x60;dateFrom&#x60;, &#x60;dateTo&#x60;). 
        /// </summary>
        /// <value>The type of statistics: * REAL - generated by the system on the first day of the month and including statistics from the previous month. * TEST - generated by the user with a time range specified in the query parameters (&#x60;dateFrom&#x60;, &#x60;dateTo&#x60;). </value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StatisticsFile" /> class.
        /// </summary>
        /// <param name="id">Unique identifier of the file..</param>
        /// <param name="instanceName">Domain name where the statistics file come from..</param>
        /// <param name="generationDate">File generation date..</param>
        /// <param name="dateFrom">Start date or date and time of the statistics attached in the file..</param>
        /// <param name="dateTo">End date or date and time of the statistics attached in the file..</param>
        /// <param name="type">The type of statistics: * REAL - generated by the system on the first day of the month and including statistics from the previous month. * TEST - generated by the user with a time range specified in the query parameters (&#x60;dateFrom&#x60;, &#x60;dateTo&#x60;). .</param>
        public StatisticsFile(string id = default(string), string instanceName = default(string), DateTime generationDate = default(DateTime), DateTime dateFrom = default(DateTime), DateTime dateTo = default(DateTime), TypeEnum? type = default(TypeEnum?))
        {
            this.Id = id;
        ...
        /// </summary>
        /// <value>Domain name where the statistics file come from.</value>
        ...
        /// </summary>
        /// <value>File generation date.</value>
        ...
        /// </summary>
        /// <value>Start date or date and time of the statistics attached in the file.</value>
        ...
        /// </summary>
        /// <value>End date or date and time of the statistics attached in the file.</value>
        ...
        {
            return this.Equals(input as StatisticsFile);
        }

        /// <summary>
        /// Returns true if StatisticsFile instances are equal
        /// </summary>
        /// <param name="input">Instance of StatisticsFile to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StatisticsFile input)
        {
            if (input == null)
            {
                return false;
