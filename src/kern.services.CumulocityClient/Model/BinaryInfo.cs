...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "binaryInfo")]
    public partial class BinaryInfo : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BinaryInfo" /> class.
        /// </summary>
        /// <param name="name">Name of the binary object..</param>
        /// <param name="type">Media type of the file..</param>
        public BinaryInfo(string name = default(string), string type = default(string))
        {
            this.Name = name;
            this.Type = type;
        }
        ...
        /// </summary>
        /// <value>Name of the binary object.</value>
