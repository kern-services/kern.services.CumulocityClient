...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "c8y_TemperatureMeasurement_T")]
    public partial class C8yTemperatureMeasurementT : IEquatable<C8yTemperatureMeasurementT>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="C8yTemperatureMeasurementT" /> class.
        /// </summary>
        /// <param name="value">value.</param>
        /// <param name="unit">unit.</param>
        public C8yTemperatureMeasurementT(decimal value = default(decimal), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        {
            return this.Equals(input as C8yTemperatureMeasurementT);
        }

        /// <summary>
        /// Returns true if C8yTemperatureMeasurementT instances are equal
        /// </summary>
        /// <param name="input">Instance of C8yTemperatureMeasurementT to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(C8yTemperatureMeasurementT input)
        {
            if (input == null)
            {
                return false;
