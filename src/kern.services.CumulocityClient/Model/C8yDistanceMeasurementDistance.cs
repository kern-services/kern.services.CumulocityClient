...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "c8y_DistanceMeasurement_distance")]
    public partial class C8yDistanceMeasurementDistance : IEquatable<C8yDistanceMeasurementDistance>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="C8yDistanceMeasurementDistance" /> class.
        /// </summary>
        /// <param name="value">value.</param>
        /// <param name="unit">unit.</param>
        public C8yDistanceMeasurementDistance(decimal value = default(decimal), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        {
            return this.Equals(input as C8yDistanceMeasurementDistance);
        }

        /// <summary>
        /// Returns true if C8yDistanceMeasurementDistance instances are equal
        /// </summary>
        /// <param name="input">Instance of C8yDistanceMeasurementDistance to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(C8yDistanceMeasurementDistance input)
        {
            if (input == null)
            {
                return false;
