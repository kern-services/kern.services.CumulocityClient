...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// AlarmsApiResource
    /// </summary>
    [DataContract(Name = "alarmsApiResource")]
    public partial class AlarmsApiResource : IEquatable<AlarmsApiResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AlarmsApiResource" /> class.
        /// </summary>
        /// <param name="alarms">alarms.</param>
        /// <param name="alarmsForSource">Read-only collection of all alarms for a specific source object. The placeholder {source} must be a unique ID of an object in the inventory..</param>
        /// <param name="alarmsForStatus">Read-only collection of all alarms in a particular status. The placeholder {status} can be one of the following values: ACTIVE, ACKNOWLEDGED or CLEARED.</param>
        /// <param name="alarmsForSourceAndStatusAndTime">Read-only collection of all alarms for a specific source, status and time range..</param>
        /// <param name="alarmsForStatusAndTime">Read-only collection of all alarms for a particular status and time range..</param>
        /// <param name="alarmsForSourceAndTime">Read-only collection of all alarms for a specific source and time range..</param>
        /// <param name="alarmsForTime">Read-only collection of all alarms for a particular time range..</param>
        /// <param name="alarmsForSourceAndStatus">Read-only collection of all alarms for a specific source object in a particular status..</param>
        public AlarmsApiResource(AlarmsApiResourceAlarms alarms = default(AlarmsApiResourceAlarms), string alarmsForSource = default(string), string alarmsForStatus = default(string), string alarmsForSourceAndStatusAndTime = default(string), string alarmsForStatusAndTime = default(string), string alarmsForSourceAndTime = default(string), string alarmsForTime = default(string), string alarmsForSourceAndStatus = default(string))
        {
            this.Alarms = alarms;
        ...
        public AlarmsApiResourceAlarms Alarms { get; set; }
        ...
        /// </summary>
        /// <value>Read-only collection of all alarms for a specific source object. The placeholder {source} must be a unique ID of an object in the inventory.</value>
        [DataMember(Name = "alarmsForSource", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>Read-only collection of all alarms in a particular status. The placeholder {status} can be one of the following values: ACTIVE, ACKNOWLEDGED or CLEARED</value>
        [DataMember(Name = "alarmsForStatus", EmitDefaultValue = false)]
        public string AlarmsForStatus { get; set; }

        /// <summary>
        /// Read-only collection of all alarms for a specific source, status and time range.
        /// </summary>
        /// <value>Read-only collection of all alarms for a specific source, status and time range.</value>
        [DataMember(Name = "alarmsForSourceAndStatusAndTime", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>Read-only collection of all alarms for a particular status and time range.</value>
        [DataMember(Name = "alarmsForStatusAndTime", EmitDefaultValue = false)]
        public string AlarmsForStatusAndTime { get; set; }

        /// <summary>
        /// Read-only collection of all alarms for a specific source and time range.
        /// </summary>
        /// <value>Read-only collection of all alarms for a specific source and time range.</value>
        [DataMember(Name = "alarmsForSourceAndTime", EmitDefaultValue = false)]
        public string AlarmsForSourceAndTime { get; set; }

        /// <summary>
        /// Read-only collection of all alarms for a particular time range.
        /// </summary>
        /// <value>Read-only collection of all alarms for a particular time range.</value>
        [DataMember(Name = "alarmsForTime", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>Read-only collection of all alarms for a specific source object in a particular status.</value>
        [DataMember(Name = "alarmsForSourceAndStatus", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AlarmsForSource: ").Append(AlarmsForSource).Append("\n");
            sb.Append("  AlarmsForStatus: ").Append(AlarmsForStatus).Append("\n");
            sb.Append("  AlarmsForSourceAndStatusAndTime: ").Append(AlarmsForSourceAndStatusAndTime).Append("\n");
            sb.Append("  AlarmsForStatusAndTime: ").Append(AlarmsForStatusAndTime).Append("\n");
            sb.Append("  AlarmsForSourceAndTime: ").Append(AlarmsForSourceAndTime).Append("\n");
            sb.Append("  AlarmsForTime: ").Append(AlarmsForTime).Append("\n");
            sb.Append("  AlarmsForSourceAndStatus: ").Append(AlarmsForSourceAndStatus).Append("\n");
        ...
        {
            return this.Equals(input as AlarmsApiResource);
        }

        /// <summary>
        /// Returns true if AlarmsApiResource instances are equal
        /// </summary>
        /// <param name="input">Instance of AlarmsApiResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AlarmsApiResource input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    ...
                    (this.Alarms != null &&
                    this.Alarms.Equals(input.Alarms))
                ) && 
                (
                    this.AlarmsForSource == input.AlarmsForSource ||
                    (this.AlarmsForSource != null &&
                    this.AlarmsForSource.Equals(input.AlarmsForSource))
                ) && 
                (
                    this.AlarmsForStatus == input.AlarmsForStatus ||
                    (this.AlarmsForStatus != null &&
                    this.AlarmsForStatus.Equals(input.AlarmsForStatus))
                ) && 
                (
                    this.AlarmsForSourceAndStatusAndTime == input.AlarmsForSourceAndStatusAndTime ||
                    (this.AlarmsForSourceAndStatusAndTime != null &&
                    this.AlarmsForSourceAndStatusAndTime.Equals(input.AlarmsForSourceAndStatusAndTime))
                ) && 
                (
                    this.AlarmsForStatusAndTime == input.AlarmsForStatusAndTime ||
                    (this.AlarmsForStatusAndTime != null &&
                    this.AlarmsForStatusAndTime.Equals(input.AlarmsForStatusAndTime))
                ) && 
                (
                    this.AlarmsForSourceAndTime == input.AlarmsForSourceAndTime ||
                    (this.AlarmsForSourceAndTime != null &&
                    this.AlarmsForSourceAndTime.Equals(input.AlarmsForSourceAndTime))
                ) && 
                (
                    this.AlarmsForTime == input.AlarmsForTime ||
                    (this.AlarmsForTime != null &&
                    this.AlarmsForTime.Equals(input.AlarmsForTime))
                ) && 
                (
                    this.AlarmsForSourceAndStatus == input.AlarmsForSourceAndStatus ||
                    (this.AlarmsForSourceAndStatus != null &&
                    this.AlarmsForSourceAndStatus.Equals(input.AlarmsForSourceAndStatus))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AlarmsForSource != null)
                {
                    hashCode = (hashCode * 59) + this.AlarmsForSource.GetHashCode();
                }
                if (this.AlarmsForStatus != null)
                {
                    hashCode = (hashCode * 59) + this.AlarmsForStatus.GetHashCode();
                }
                if (this.AlarmsForSourceAndStatusAndTime != null)
                {
                    hashCode = (hashCode * 59) + this.AlarmsForSourceAndStatusAndTime.GetHashCode();
                }
                if (this.AlarmsForStatusAndTime != null)
                {
                    hashCode = (hashCode * 59) + this.AlarmsForStatusAndTime.GetHashCode();
                }
                if (this.AlarmsForSourceAndTime != null)
                {
                    hashCode = (hashCode * 59) + this.AlarmsForSourceAndTime.GetHashCode();
                }
                if (this.AlarmsForTime != null)
                {
                    hashCode = (hashCode * 59) + this.AlarmsForTime.GetHashCode();
                }
                if (this.AlarmsForSourceAndStatus != null)
                {
                    hashCode = (hashCode * 59) + this.AlarmsForSourceAndStatus.GetHashCode();
                }
                if (this.Self != null)
                {
