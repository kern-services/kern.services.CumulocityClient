...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SummaryAllTenantsUsageStatistics :  IEquatable<SummaryAllTenantsUsageStatistics>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SummaryAllTenantsUsageStatistics" /> class.
        /// </summary>
        ...
        /// <param name="creationTime">Date and time of the tenant&#39;s creation..</param>
        ...
        /// <param name="externalReference">Tenant external reference..</param>
        ...
        /// <param name="peakDeviceCount">Peak value of &#x60;deviceCount&#x60; calculated for the requested time period of the summary..</param>
        /// <param name="peakDeviceWithChildrenCount">Peak value of &#x60;deviceWithChildrenCount&#x60; calculated for the requested time period of the summary..</param>
        /// <param name="peakStorageSize">Peak value of used storage size in bytes, calculated for the requested time period of the summary..</param>
        ...
        /// <param name="tenantCompany">The tenant&#39;s company name..</param>
        /// <param name="tenantCustomProperties">tenantCustomProperties.</param>
        /// <param name="tenantDomain">URL of the tenant&#39;s domain. The domain name permits only the use of alphanumeric characters separated by dots &#x60;.&#x60;, hyphens &#x60;-&#x60; and underscores &#x60;_&#x60;..</param>
        /// <param name="totalResourceCreateAndUpdateCount">Sum of all inbound transfers..</param>
        public SummaryAllTenantsUsageStatistics(int alarmsCreatedCount = default(int), int alarmsUpdatedCount = default(int), DateTime creationTime = default(DateTime), int deviceCount = default(int), int deviceEndpointCount = default(int), int deviceRequestCount = default(int), int deviceWithChildrenCount = default(int), string externalReference = default(string), int eventsCreatedCount = default(int), int eventsUpdatedCount = default(int), int inventoriesCreatedCount = default(int), int inventoriesUpdatedCount = default(int), int measurementsCreatedCount = default(int), int peakDeviceCount = default(int), int peakDeviceWithChildrenCount = default(int), int peakStorageSize = default(int), int requestCount = default(int), UsageStatisticsResources resources = default(UsageStatisticsResources), int storageSize = default(int), List<string> subscribedApplications = default(List<string>), string tenantCompany = default(string), CustomProperties tenantCustomProperties = default(CustomProperties), string tenantDomain = default(string), int totalResourceCreateAndUpdateCount = default(int))
        {
        ...
        /// </summary>
        /// <value>Date and time of the tenant&#39;s creation.</value>
        ...
        /// </summary>
        /// <value>Tenant external reference.</value>
        ...
        public string ParentTenantId { get; private set; }

        /// <summary>
        /// Peak value of &#x60;deviceCount&#x60; calculated for the requested time period of the summary.
        /// </summary>
        /// <value>Peak value of &#x60;deviceCount&#x60; calculated for the requested time period of the summary.</value>
        [DataMember(Name="peakDeviceCount", EmitDefaultValue=false)]
        ...
        /// </summary>
        /// <value>Peak value of &#x60;deviceWithChildrenCount&#x60; calculated for the requested time period of the summary.</value>
        [DataMember(Name="peakDeviceWithChildrenCount", EmitDefaultValue=false)]
        ...
        /// </summary>
        /// <value>Peak value of used storage size in bytes, calculated for the requested time period of the summary.</value>
        [DataMember(Name="peakStorageSize", EmitDefaultValue=false)]
        ...
        /// </summary>
        /// <value>The tenant&#39;s company name.</value>
        [DataMember(Name="tenantCompany", EmitDefaultValue=false)]
        public string TenantCompany { get; set; }

        /// <summary>
        /// Gets or Sets TenantCustomProperties
        /// </summary>
        [DataMember(Name="tenantCustomProperties", EmitDefaultValue=false)]
        ...
        /// </summary>
        /// <value>URL of the tenant&#39;s domain. The domain name permits only the use of alphanumeric characters separated by dots &#x60;.&#x60;, hyphens &#x60;-&#x60; and underscores &#x60;_&#x60;.</value>
        [DataMember(Name="tenantDomain", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  PeakDeviceCount: ").Append(PeakDeviceCount).Append("\n");
            sb.Append("  PeakDeviceWithChildrenCount: ").Append(PeakDeviceWithChildrenCount).Append("\n");
            sb.Append("  PeakStorageSize: ").Append(PeakStorageSize).Append("\n");
            ...
            sb.Append("  TenantCompany: ").Append(TenantCompany).Append("\n");
            sb.Append("  TenantCustomProperties: ").Append(TenantCustomProperties).Append("\n");
        ...
        {
            return this.Equals(input as SummaryAllTenantsUsageStatistics);
        }

        /// <summary>
        /// Returns true if SummaryAllTenantsUsageStatistics instances are equal
        /// </summary>
        /// <param name="input">Instance of SummaryAllTenantsUsageStatistics to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SummaryAllTenantsUsageStatistics input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    ...
                    (this.InventoriesUpdatedCount != null &&
                ...
                (
                    ...
                    (this.MeasurementsCreatedCount != null &&
                ...
                (
                    this.PeakDeviceCount == input.PeakDeviceCount ||
                    (this.PeakDeviceCount != null &&
                    this.PeakDeviceCount.Equals(input.PeakDeviceCount))
                ) && 
                (
                    this.PeakDeviceWithChildrenCount == input.PeakDeviceWithChildrenCount ||
                    (this.PeakDeviceWithChildrenCount != null &&
                    this.PeakDeviceWithChildrenCount.Equals(input.PeakDeviceWithChildrenCount))
                ) && 
                (
                    this.PeakStorageSize == input.PeakStorageSize ||
                    (this.PeakStorageSize != null &&
                    this.PeakStorageSize.Equals(input.PeakStorageSize))
                ) && 
                (
                ...
                (
                    this.TenantCompany == input.TenantCompany ||
                    (this.TenantCompany != null &&
                    this.TenantCompany.Equals(input.TenantCompany))
                ) && 
                (
                    this.TenantCustomProperties == input.TenantCustomProperties ||
                    (this.TenantCustomProperties != null &&
                    this.TenantCustomProperties.Equals(input.TenantCustomProperties))
                ) && 
                (
                    this.TenantDomain == input.TenantDomain ||
                    (this.TenantDomain != null &&
                    this.TenantDomain.Equals(input.TenantDomain))
                ) && 
                (
                ...
                (
                    ...
                    (this.TotalResourceCreateAndUpdateCount != null &&
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.AlarmsCreatedCount != null)
                    hashCode = hashCode * 59 + this.AlarmsCreatedCount.GetHashCode();
                if (this.AlarmsUpdatedCount != null)
                ...
                if (this.PeakDeviceCount != null)
                    hashCode = hashCode * 59 + this.PeakDeviceCount.GetHashCode();
                if (this.PeakDeviceWithChildrenCount != null)
                    hashCode = hashCode * 59 + this.PeakDeviceWithChildrenCount.GetHashCode();
                if (this.PeakStorageSize != null)
                    hashCode = hashCode * 59 + this.PeakStorageSize.GetHashCode();
                ...
                if (this.TenantCompany != null)
                    hashCode = hashCode * 59 + this.TenantCompany.GetHashCode();
                if (this.TenantCustomProperties != null)
                    hashCode = hashCode * 59 + this.TenantCustomProperties.GetHashCode();
                if (this.TenantDomain != null)
                    hashCode = hashCode * 59 + this.TenantDomain.GetHashCode();
                if (this.TenantId != null)
                    hashCode = hashCode * 59 + this.TenantId.GetHashCode();
                if (this.TotalResourceCreateAndUpdateCount != null)
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // TenantCompany (string) maxLength
            if(this.TenantCompany != null && this.TenantCompany.Length > 256)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for TenantCompany, length must be less than 256.", new [] { "TenantCompany" });
            }

            // TenantCompany (string) minLength
            if(this.TenantCompany != null && this.TenantCompany.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for TenantCompany, length must be greater than 1.", new [] { "TenantCompany" });
            }

            // TenantDomain (string) maxLength
            if(this.TenantDomain != null && this.TenantDomain.Length > 256)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for TenantDomain, length must be less than 256.", new [] { "TenantDomain" });
            }

            // TenantDomain (string) minLength
            if(this.TenantDomain != null && this.TenantDomain.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for TenantDomain, length must be greater than 1.", new [] { "TenantDomain" });
            }

            // TenantId (string) maxLength
            if(this.TenantId != null && this.TenantId.Length > 32)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for TenantId, length must be less than 32.", new [] { "TenantId" });
            }

            // TenantId (string) minLength
            if(this.TenantId != null && this.TenantId.Length < 2)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for TenantId, length must be greater than 2.", new [] { "TenantId" });
            }
