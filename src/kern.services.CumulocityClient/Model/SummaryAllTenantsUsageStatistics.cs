...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SummaryAllTenantsUsageStatistics")]
    public partial class SummaryAllTenantsUsageStatistics : IEquatable<SummaryAllTenantsUsageStatistics>, IValidatableObject
    {
        ...
        /// <summary>
        /// Returns false as ParentTenantId should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeParentTenantId()
        {
            return false;
        }
        /// <summary>
