...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "putTenantResource_request")]
    public partial class PutTenantResourceRequest : IEquatable<PutTenantResourceRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PutTenantResourceRequest" /> class.
        /// </summary>
        ...
        /// <param name="company">Tenant&#39;s company name..</param>
        ...
        /// <param name="domain">URL of the tenant&#39;s domain. The domain name permits only the use of alphanumeric characters separated by dots &#x60;.&#x60; and hyphens &#x60;-&#x60;..</param>
        /// <param name="ownedApplications">ownedApplications.</param>
        public PutTenantResourceRequest(string adminEmail = default(string), string adminPass = default(string), TenantApplications applications = default(TenantApplications), string company = default(string), string contactName = default(string), string contactPhone = default(string), CustomProperties customProperties = default(CustomProperties), string domain = default(string), TenantOwnedApplications ownedApplications = default(TenantOwnedApplications))
        {
        ...
        public Object AdminName { get; private set; }

        /// <summary>
        /// Returns false as AdminName should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeAdminName()
        {
            return false;
        }
        /// <summary>
        ...
        /// <summary>
        /// Returns false as AllowCreateTenants should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeAllowCreateTenants()
        {
            return false;
        }
        /// <summary>
        ...
        {
            return this.Equals(input as PutTenantResourceRequest);
        }

        /// <summary>
        /// Returns true if PutTenantResourceRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PutTenantResourceRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PutTenantResourceRequest input)
        {
            if (input == null)
            {
                return false;
