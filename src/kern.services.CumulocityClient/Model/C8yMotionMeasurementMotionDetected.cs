...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "c8y_MotionMeasurement_motionDetected")]
    public partial class C8yMotionMeasurementMotionDetected : IEquatable<C8yMotionMeasurementMotionDetected>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="C8yMotionMeasurementMotionDetected" /> class.
        /// </summary>
        /// <param name="value">value.</param>
        /// <param name="type">type.</param>
        public C8yMotionMeasurementMotionDetected(decimal value = default(decimal), string type = default(string))
        {
            this.Value = value;
            this.Type = type;
        }
        ...
        {
            return this.Equals(input as C8yMotionMeasurementMotionDetected);
        }

        /// <summary>
        /// Returns true if C8yMotionMeasurementMotionDetected instances are equal
        /// </summary>
        /// <param name="input">Instance of C8yMotionMeasurementMotionDetected to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(C8yMotionMeasurementMotionDetected input)
        {
            if (input == null)
            {
                return false;
