...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "tenant_ownedApplications")]
    public partial class TenantOwnedApplications : IEquatable<TenantOwnedApplications>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TenantOwnedApplications" /> class.
        /// </summary>
        /// <param name="references">An array containing all owned applications (only applications with availability MARKET)..</param>
        public TenantOwnedApplications(List<Application> references = default(List<Application>))
        {
        ...
        /// </summary>
        /// <value>An array containing all owned applications (only applications with availability MARKET).</value>
        ...
        {
            return this.Equals(input as TenantOwnedApplications);
        }

        /// <summary>
        /// Returns true if TenantOwnedApplications instances are equal
        /// </summary>
        /// <param name="input">Instance of TenantOwnedApplications to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TenantOwnedApplications input)
        {
            if (input == null)
            {
                return false;
