...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SystemOptionCollection")]
    public partial class SystemOptionCollection : IEquatable<SystemOptionCollection>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SystemOptionCollection" /> class.
        /// </summary>
        /// <param name="options">An array containing the predefined system options..</param>
        public SystemOptionCollection(List<SystemOption> options = default(List<SystemOption>))
        {
        ...
        /// </summary>
        /// <value>An array containing the predefined system options.</value>
        ...
        {
            return this.Equals(input as SystemOptionCollection);
        }

        /// <summary>
        /// Returns true if SystemOptionCollection instances are equal
        /// </summary>
        /// <param name="input">Instance of SystemOptionCollection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SystemOptionCollection input)
        {
            if (input == null)
            {
                return false;
