...
{
    /// <summary>
    /// PutTenantResourceRequestAllOf
    /// </summary>
    [DataContract(Name = "putTenantResource_request_allOf")]
    public partial class PutTenantResourceRequestAllOf : IEquatable<PutTenantResourceRequestAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PutTenantResourceRequestAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public PutTenantResourceRequestAllOf()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PutTenantResourceRequestAllOf {\n");
        ...
        {
            return this.Equals(input as PutTenantResourceRequestAllOf);
        }

        /// <summary>
        /// Returns true if PutTenantResourceRequestAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of PutTenantResourceRequestAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PutTenantResourceRequestAllOf input)
        {
            if (input == null)
            {
                return false;
