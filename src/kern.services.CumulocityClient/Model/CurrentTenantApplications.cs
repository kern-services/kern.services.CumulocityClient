...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CurrentTenant_applications")]
    public partial class CurrentTenantApplications : IEquatable<CurrentTenantApplications>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CurrentTenantApplications" /> class.
        /// </summary>
        /// <param name="references">An array containing all subscribed applications..</param>
        public CurrentTenantApplications(List<Application> references = default(List<Application>))
        {
        ...
        {
            return this.Equals(input as CurrentTenantApplications);
        }

        /// <summary>
        /// Returns true if CurrentTenantApplications instances are equal
        /// </summary>
        /// <param name="input">Instance of CurrentTenantApplications to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CurrentTenantApplications input)
        {
            if (input == null)
            {
                return false;
