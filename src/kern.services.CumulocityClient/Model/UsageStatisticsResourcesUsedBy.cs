...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UsageStatisticsResourcesUsedBy")]
    public partial class UsageStatisticsResourcesUsedBy : IEquatable<UsageStatisticsResourcesUsedBy>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UsageStatisticsResourcesUsedBy" /> class.
        /// </summary>
        /// <param name="cause">Reason for calculating statistics of the specified microservice..</param>
        /// <param name="cpu">Number of CPU usage for a single microservice..</param>
        /// <param name="memory">Number of memory usage for a single microservice..</param>
        /// <param name="name">Name of the microservice..</param>
        public UsageStatisticsResourcesUsedBy(string cause = default(string), int cpu = default(int), int memory = default(int), string name = default(string))
        {
            this.Cause = cause;
            this.Cpu = cpu;
            this.Memory = memory;
        ...
        /// </summary>
        /// <value>Reason for calculating statistics of the specified microservice.</value>
        ...
        /// </summary>
        /// <value>Number of CPU usage for a single microservice.</value>
        ...
        /// </summary>
        /// <value>Number of memory usage for a single microservice.</value>
        ...
        {
            return this.Equals(input as UsageStatisticsResourcesUsedBy);
        }

        /// <summary>
        /// Returns true if UsageStatisticsResourcesUsedBy instances are equal
        /// </summary>
        /// <param name="input">Instance of UsageStatisticsResourcesUsedBy to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UsageStatisticsResourcesUsedBy input)
        {
            if (input == null)
            {
                return false;
        ...
        {
            // Cause (string) minLength
            if (this.Cause != null && this.Cause.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Cause, length must be greater than 1.", new [] { "Cause" });
            }

            // Cpu (int) minimum
            if (this.Cpu < (int)0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Cpu, must be a value greater than or equal to 0.", new [] { "Cpu" });
            }

            // Memory (int) minimum
            if (this.Memory < (int)0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Memory, must be a value greater than or equal to 0.", new [] { "Memory" });
            }
