...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SubscribedApplicationReference")]
    public partial class SubscribedApplicationReference : IEquatable<SubscribedApplicationReference>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscribedApplicationReference" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SubscribedApplicationReference() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscribedApplicationReference" /> class.
        /// </summary>
        /// <param name="application">application (required).</param>
        public SubscribedApplicationReference(SubscribedApplicationReferenceApplication application = default(SubscribedApplicationReferenceApplication))
        {
            // to ensure "application" is required (not null)
            if (application == null)
            {
                throw new ArgumentNullException("application is a required property for SubscribedApplicationReference and cannot be null");
            }
        ...
        public SubscribedApplicationReferenceApplication Application { get; set; }
        ...
        {
            return this.Equals(input as SubscribedApplicationReference);
        }

        /// <summary>
        /// Returns true if SubscribedApplicationReference instances are equal
        /// </summary>
        /// <param name="input">Instance of SubscribedApplicationReference to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubscribedApplicationReference input)
        {
            if (input == null)
            {
                return false;
