...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NotificationTokenClaims")]
    public partial class NotificationTokenClaims : IEquatable<NotificationTokenClaims>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NotificationTokenClaims" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NotificationTokenClaims() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NotificationTokenClaims" /> class.
        /// </summary>
        /// <param name="expiresInMinutes">The token expiration duration. (default to 1440).</param>
        /// <param name="subscriber">The subscriber name which the client wishes to be identified with. (required).</param>
        /// <param name="subscription">The subscription name. This value must match the same that was used when the subscription was created. (required).</param>
        public NotificationTokenClaims(int expiresInMinutes = 1440, string subscriber = default(string), string subscription = default(string))
        {
            // to ensure "subscriber" is required (not null)
            if (subscriber == null)
            {
                throw new ArgumentNullException("subscriber is a required property for NotificationTokenClaims and cannot be null");
            }
            this.Subscriber = subscriber;
            // to ensure "subscription" is required (not null)
            if (subscription == null)
            {
                throw new ArgumentNullException("subscription is a required property for NotificationTokenClaims and cannot be null");
            }
        ...
        /// </summary>
        /// <value>The token expiration duration.</value>
        [DataMember(Name = "expiresInMinutes", EmitDefaultValue = false)]
        public int ExpiresInMinutes { get; set; }

        /// <summary>
        /// The subscriber name which the client wishes to be identified with.
        /// </summary>
        /// <value>The subscriber name which the client wishes to be identified with.</value>
        [DataMember(Name = "subscriber", IsRequired = true, EmitDefaultValue = true)]
        public string Subscriber { get; set; }

        /// <summary>
        /// The subscription name. This value must match the same that was used when the subscription was created.
        /// </summary>
        /// <value>The subscription name. This value must match the same that was used when the subscription was created.</value>
        ...
        {
            return this.Equals(input as NotificationTokenClaims);
        }

        /// <summary>
        /// Returns true if NotificationTokenClaims instances are equal
        /// </summary>
        /// <param name="input">Instance of NotificationTokenClaims to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NotificationTokenClaims input)
        {
            if (input == null)
            {
                return false;
