...
namespace kern.services.CumulocityClient.Model
{
    ...
    public partial class NotificationTokenClaims :  IEquatable<NotificationTokenClaims>, IValidatableObject
    {
        ...
        public NotificationTokenClaims(int expiresInMinutes = 1440, string subscriber = default(string), string subscription = default(string))
        {
            ...
            if (subscriber == null)
            {
                throw new InvalidDataException("subscriber is a required property for NotificationTokenClaims and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("subscription is a required property for NotificationTokenClaims and cannot be null");
            }
            else
            {
            ...
            // use default value if no "expiresInMinutes" provided
