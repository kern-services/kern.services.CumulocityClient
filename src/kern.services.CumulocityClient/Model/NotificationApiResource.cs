...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NotificationApiResource")]
    public partial class NotificationApiResource : IEquatable<NotificationApiResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NotificationApiResource" /> class.
        /// </summary>
        /// <param name="notificationSubscriptions">notificationSubscriptions.</param>
        /// <param name="notificationSubscriptionsBySource">Read-only collection of all notification subscriptions for a specific source object. The placeholder {source} must be a unique ID of an object in the inventory..</param>
        /// <param name="notificationSubscriptionsBySourceAndContext">Read-only collection of all notification subscriptions of a particular context and a specific source object..</param>
        /// <param name="notificationSubscriptionsByContext">Read-only collection of all notification subscriptions of a particular context..</param>
        public NotificationApiResource(NotificationApiResourceNotificationSubscriptions notificationSubscriptions = default(NotificationApiResourceNotificationSubscriptions), string notificationSubscriptionsBySource = default(string), string notificationSubscriptionsBySourceAndContext = default(string), string notificationSubscriptionsByContext = default(string))
        {
        ...
        /// <summary>
        /// Gets or Sets NotificationSubscriptions
        /// </summary>
        [DataMember(Name = "notificationSubscriptions", EmitDefaultValue = false)]
        public NotificationApiResourceNotificationSubscriptions NotificationSubscriptions { get; set; }
        ...
        /// </summary>
        /// <value>Read-only collection of all notification subscriptions for a specific source object. The placeholder {source} must be a unique ID of an object in the inventory.</value>
        [DataMember(Name = "notificationSubscriptionsBySource", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>Read-only collection of all notification subscriptions of a particular context and a specific source object.</value>
        [DataMember(Name = "notificationSubscriptionsBySourceAndContext", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>Read-only collection of all notification subscriptions of a particular context.</value>
        [DataMember(Name = "notificationSubscriptionsByContext", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  NotificationSubscriptions: ").Append(NotificationSubscriptions).Append("\n");
            sb.Append("  NotificationSubscriptionsBySource: ").Append(NotificationSubscriptionsBySource).Append("\n");
            sb.Append("  NotificationSubscriptionsBySourceAndContext: ").Append(NotificationSubscriptionsBySourceAndContext).Append("\n");
            sb.Append("  NotificationSubscriptionsByContext: ").Append(NotificationSubscriptionsByContext).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as NotificationApiResource);
        }

        /// <summary>
        /// Returns true if NotificationApiResource instances are equal
        /// </summary>
        /// <param name="input">Instance of NotificationApiResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NotificationApiResource input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.NotificationSubscriptions == input.NotificationSubscriptions ||
                    (this.NotificationSubscriptions != null &&
                    this.NotificationSubscriptions.Equals(input.NotificationSubscriptions))
                ) && 
                (
                    this.NotificationSubscriptionsBySource == input.NotificationSubscriptionsBySource ||
                    (this.NotificationSubscriptionsBySource != null &&
                    this.NotificationSubscriptionsBySource.Equals(input.NotificationSubscriptionsBySource))
                ) && 
                (
                    this.NotificationSubscriptionsBySourceAndContext == input.NotificationSubscriptionsBySourceAndContext ||
                    (this.NotificationSubscriptionsBySourceAndContext != null &&
                    this.NotificationSubscriptionsBySourceAndContext.Equals(input.NotificationSubscriptionsBySourceAndContext))
                ) && 
                (
                    this.NotificationSubscriptionsByContext == input.NotificationSubscriptionsByContext ||
                    (this.NotificationSubscriptionsByContext != null &&
                    this.NotificationSubscriptionsByContext.Equals(input.NotificationSubscriptionsByContext))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.NotificationSubscriptions.GetHashCode();
                }
                if (this.NotificationSubscriptionsBySource != null)
                {
                    hashCode = (hashCode * 59) + this.NotificationSubscriptionsBySource.GetHashCode();
                }
                if (this.NotificationSubscriptionsBySourceAndContext != null)
                {
                    hashCode = (hashCode * 59) + this.NotificationSubscriptionsBySourceAndContext.GetHashCode();
                }
                if (this.NotificationSubscriptionsByContext != null)
                {
                    hashCode = (hashCode * 59) + this.NotificationSubscriptionsByContext.GetHashCode();
                }
                return hashCode;
            }
        }
