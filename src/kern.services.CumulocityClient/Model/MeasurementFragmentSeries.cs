...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "measurementFragmentSeries")]
    public partial class MeasurementFragmentSeries : IEquatable<MeasurementFragmentSeries>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MeasurementFragmentSeries" /> class.
        /// </summary>
        ...
        public MeasurementFragmentSeries(string unit = default(string), string name = default(string), string type = default(string))
        {
            this.Unit = unit;
            this.Name = name;
            this.Type = type;
        ...
        /// </summary>
        /// <value>The type of measurement.</value>
        ...
        {
            return this.Equals(input as MeasurementFragmentSeries);
        }

        /// <summary>
        /// Returns true if MeasurementFragmentSeries instances are equal
        /// </summary>
        /// <param name="input">Instance of MeasurementFragmentSeries to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MeasurementFragmentSeries input)
        {
            if (input == null)
            {
                return false;
