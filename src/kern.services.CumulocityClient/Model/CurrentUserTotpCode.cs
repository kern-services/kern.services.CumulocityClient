...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// CurrentUserTotpCode
    /// </summary>
    [DataContract(Name = "currentUserTotpCode")]
    public partial class CurrentUserTotpCode : IEquatable<CurrentUserTotpCode>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CurrentUserTotpCode" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CurrentUserTotpCode() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CurrentUserTotpCode" /> class.
        /// </summary>
        /// <param name="code">Two-factor authentication code entered by the user to log in to the platform. (required).</param>
        public CurrentUserTotpCode(string code = default(string))
        {
            // to ensure "code" is required (not null)
            if (code == null)
            {
                throw new ArgumentNullException("code is a required property for CurrentUserTotpCode and cannot be null");
            }
            this.Code = code;
        }
        ...
        /// </summary>
        /// <value>Two-factor authentication code entered by the user to log in to the platform.</value>
        ...
        {
            return this.Equals(input as CurrentUserTotpCode);
        }

        /// <summary>
        /// Returns true if CurrentUserTotpCode instances are equal
        /// </summary>
        /// <param name="input">Instance of CurrentUserTotpCode to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CurrentUserTotpCode input)
        {
            if (input == null)
            {
                return false;
