...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NotificationSubscriptionResult")]
    public partial class NotificationSubscriptionResult : IEquatable<NotificationSubscriptionResult>, IValidatableObject
    {
        /// <summary>
        /// The status of the notification subscription deletion.
        /// </summary>
        /// <value>The status of the notification subscription deletion.</value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NotificationSubscriptionResult" /> class.
        /// </summary>
        /// <param name="result">The status of the notification subscription deletion..</param>
        public NotificationSubscriptionResult(ResultEnum? result = default(ResultEnum?))
        {
            this.Result = result;
        }
        ...
        {
            return this.Equals(input as NotificationSubscriptionResult);
        }

        /// <summary>
        /// Returns true if NotificationSubscriptionResult instances are equal
        /// </summary>
        /// <param name="input">Instance of NotificationSubscriptionResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NotificationSubscriptionResult input)
        {
            if (input == null)
            {
                return false;
