...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// SupportedSeries
    /// </summary>
    [DataContract(Name = "SupportedSeries")]
    public partial class SupportedSeries : IEquatable<SupportedSeries>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SupportedSeries" /> class.
        /// </summary>
        /// <param name="c8ySupportedSeries">An array containing all supported measurement series of the specified device..</param>
        public SupportedSeries(List<string> c8ySupportedSeries = default(List<string>))
        {
        ...
        /// </summary>
        /// <value>An array containing all supported measurement series of the specified device.</value>
        [DataMember(Name = "c8y_SupportedSeries", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  C8ySupportedSeries: ").Append(C8ySupportedSeries).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as SupportedSeries);
        }

        /// <summary>
        /// Returns true if SupportedSeries instances are equal
        /// </summary>
        /// <param name="input">Instance of SupportedSeries to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SupportedSeries input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.C8ySupportedSeries == input.C8ySupportedSeries ||
                    this.C8ySupportedSeries != null &&
                    input.C8ySupportedSeries != null &&
                    this.C8ySupportedSeries.SequenceEqual(input.C8ySupportedSeries)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.C8ySupportedSeries.GetHashCode();
                }
                return hashCode;
            }
        }
