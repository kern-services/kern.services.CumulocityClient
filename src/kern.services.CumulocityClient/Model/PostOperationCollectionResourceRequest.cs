...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "postOperationCollectionResource_request")]
    public partial class PostOperationCollectionResourceRequest : IEquatable<PostOperationCollectionResourceRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOperationCollectionResourceRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostOperationCollectionResourceRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostOperationCollectionResourceRequest" /> class.
        /// </summary>
        /// <param name="deviceId">Identifier of the target device where the operation should be performed. (required).</param>
        /// <param name="deviceExternalIDs">deviceExternalIDs.</param>
        public PostOperationCollectionResourceRequest(string deviceId = default(string), ExternalIds deviceExternalIDs = default(ExternalIds))
        {
            // to ensure "deviceId" is required (not null)
            if (deviceId == null)
            {
                throw new ArgumentNullException("deviceId is a required property for PostOperationCollectionResourceRequest and cannot be null");
            }
        ...
        /// </summary>
        /// <value>Reference to a bulk operation ID if this operation was scheduled from a bulk operation.</value>
        [DataMember(Name = "bulkOperationId", EmitDefaultValue = false)]
        public string BulkOperationId { get; private set; }

        /// <summary>
        /// Returns false as BulkOperationId should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeBulkOperationId()
        {
            return false;
        }
        /// <summary>
        ...
        /// </summary>
        /// <value>Date and time when the operation was created in the database.</value>
        ...
        /// </summary>
        /// <value>Identifier of the target device where the operation should be performed.</value>
        [DataMember(Name = "deviceId", IsRequired = true, EmitDefaultValue = true)]
        public string DeviceId { get; set; }

        /// <summary>
        /// Gets or Sets DeviceExternalIDs
        /// </summary>
        [DataMember(Name = "deviceExternalIDs", EmitDefaultValue = false)]
        public ExternalIds DeviceExternalIDs { get; set; }

        /// <summary>
        /// Reason for the failure.
        /// </summary>
        /// <value>Reason for the failure.</value>
        [DataMember(Name = "failureReason", EmitDefaultValue = false)]
        public string FailureReason { get; private set; }

        /// <summary>
        /// Returns false as FailureReason should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        ...
        /// </summary>
        /// <value>Unique identifier of this operation.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  BulkOperationId: ").Append(BulkOperationId).Append("\n");
            sb.Append("  CreationTime: ").Append(CreationTime).Append("\n");
            sb.Append("  DeviceId: ").Append(DeviceId).Append("\n");
            sb.Append("  DeviceExternalIDs: ").Append(DeviceExternalIDs).Append("\n");
        ...
        {
            return this.Equals(input as PostOperationCollectionResourceRequest);
        }

        /// <summary>
        /// Returns true if PostOperationCollectionResourceRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PostOperationCollectionResourceRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostOperationCollectionResourceRequest input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.BulkOperationId == input.BulkOperationId ||
                    (this.BulkOperationId != null &&
                    this.BulkOperationId.Equals(input.BulkOperationId))
                ) && 
                (
                ...
                (
                    this.DeviceExternalIDs == input.DeviceExternalIDs ||
                    (this.DeviceExternalIDs != null &&
                    this.DeviceExternalIDs.Equals(input.DeviceExternalIDs))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.BulkOperationId != null)
                {
                    hashCode = (hashCode * 59) + this.BulkOperationId.GetHashCode();
                }
                ...
                {
                    hashCode = (hashCode * 59) + this.DeviceExternalIDs.GetHashCode();
                }
