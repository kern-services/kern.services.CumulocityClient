...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "realtimeNotification_ext")]
    public partial class RealtimeNotificationExt : IEquatable<RealtimeNotificationExt>, IValidatableObject
    {
        /// <summary>
        /// The system of units to use.
        /// </summary>
        /// <value>The system of units to use.</value>
        ...
        /// </summary>
        /// <value>The system of units to use.</value>
        [DataMember(Name = "systemOfUnits", EmitDefaultValue = false)]
        public SystemOfUnitsEnum? SystemOfUnits { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="RealtimeNotificationExt" /> class.
        /// </summary>
        /// <param name="comCumulocityAuthn">comCumulocityAuthn.</param>
        /// <param name="systemOfUnits">The system of units to use..</param>
        public RealtimeNotificationExt(RealtimeNotificationExtComCumulocityAuthn comCumulocityAuthn = default(RealtimeNotificationExtComCumulocityAuthn), SystemOfUnitsEnum? systemOfUnits = default(SystemOfUnitsEnum?))
        {
        ...
        /// <summary>
        /// Gets or Sets ComCumulocityAuthn
        /// </summary>
        [DataMember(Name = "com.cumulocity.authn", EmitDefaultValue = false)]
        public RealtimeNotificationExtComCumulocityAuthn ComCumulocityAuthn { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ComCumulocityAuthn: ").Append(ComCumulocityAuthn).Append("\n");
            sb.Append("  SystemOfUnits: ").Append(SystemOfUnits).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as RealtimeNotificationExt);
        }

        /// <summary>
        /// Returns true if RealtimeNotificationExt instances are equal
        /// </summary>
        /// <param name="input">Instance of RealtimeNotificationExt to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RealtimeNotificationExt input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.ComCumulocityAuthn == input.ComCumulocityAuthn ||
                    (this.ComCumulocityAuthn != null &&
                    this.ComCumulocityAuthn.Equals(input.ComCumulocityAuthn))
                ) && 
                (
                    this.SystemOfUnits == input.SystemOfUnits ||
                    this.SystemOfUnits.Equals(input.SystemOfUnits)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.ComCumulocityAuthn != null)
                {
                    hashCode = (hashCode * 59) + this.ComCumulocityAuthn.GetHashCode();
                }
                hashCode = (hashCode * 59) + this.SystemOfUnits.GetHashCode();
                return hashCode;
            }
        }
