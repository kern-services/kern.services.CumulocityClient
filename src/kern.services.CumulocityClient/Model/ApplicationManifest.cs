...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// ApplicationManifest
    /// </summary>
    [JsonConverter(typeof(ApplicationManifestJsonConverter))]
    [DataContract(Name = "application_manifest")]
    public partial class ApplicationManifest : AbstractOpenAPISchema, IEquatable<ApplicationManifest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationManifest" /> class
        /// with the <see cref="MicroserviceApplicationManifest" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of MicroserviceApplicationManifest.</param>
        public ApplicationManifest(MicroserviceApplicationManifest actualInstance)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationManifest" /> class
        /// with the <see cref="WebApplicationManifest" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of WebApplicationManifest.</param>
        public ApplicationManifest(WebApplicationManifest actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public override Object ActualInstance
        {
            ...
            set
            {
                if (value.GetType() == typeof(MicroserviceApplicationManifest))
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(WebApplicationManifest))
                {
                    this._actualInstance = value;
                }
                else
                {
                    throw new ArgumentException("Invalid instance found. Must be the following types: MicroserviceApplicationManifest, WebApplicationManifest");
                }
            }
        }

        /// <summary>
        /// Get the actual instance of `MicroserviceApplicationManifest`. If the actual instance is not `MicroserviceApplicationManifest`,
        /// the InvalidClassException will be thrown
        /// </summary>
        /// <returns>An instance of MicroserviceApplicationManifest</returns>
        public MicroserviceApplicationManifest GetMicroserviceApplicationManifest()
        {
            return (MicroserviceApplicationManifest)this.ActualInstance;
        }

        /// <summary>
        /// Get the actual instance of `WebApplicationManifest`. If the actual instance is not `WebApplicationManifest`,
        /// the InvalidClassException will be thrown
        /// </summary>
        /// <returns>An instance of WebApplicationManifest</returns>
        public WebApplicationManifest GetWebApplicationManifest()
        {
            return (WebApplicationManifest)this.ActualInstance;
        }
        ...
        {
            return JsonConvert.SerializeObject(this.ActualInstance, ApplicationManifest.SerializerSettings);
        }

        /// <summary>
        /// Converts the JSON string into an instance of ApplicationManifest
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of ApplicationManifest</returns>
        public static ApplicationManifest FromJson(string jsonString)
        {
            ApplicationManifest newApplicationManifest = null;

            if (string.IsNullOrEmpty(jsonString))
            {
                return newApplicationManifest;
            }
            int match = 0;
            ...
            try
            {
                ...
                if (typeof(MicroserviceApplicationManifest).GetProperty("AdditionalProperties") == null)
                {
                    newApplicationManifest = new ApplicationManifest(JsonConvert.DeserializeObject<MicroserviceApplicationManifest>(jsonString, ApplicationManifest.SerializerSettings));
                }
                else
                {
                    newApplicationManifest = new ApplicationManifest(JsonConvert.DeserializeObject<MicroserviceApplicationManifest>(jsonString, ApplicationManifest.AdditionalPropertiesSerializerSettings));
                }
                matchedTypes.Add("MicroserviceApplicationManifest");
                match++;
            }
            catch (Exception exception)
            {
                // deserialization failed, try the next one
                System.Diagnostics.Debug.WriteLine(string.Format("Failed to deserialize `{0}` into MicroserviceApplicationManifest: {1}", jsonString, exception.ToString()));
            }

            try
            {
                // if it does not contains "AdditionalProperties", use SerializerSettings to deserialize
                if (typeof(WebApplicationManifest).GetProperty("AdditionalProperties") == null)
                {
                    newApplicationManifest = new ApplicationManifest(JsonConvert.DeserializeObject<WebApplicationManifest>(jsonString, ApplicationManifest.SerializerSettings));
                }
                else
                {
                    newApplicationManifest = new ApplicationManifest(JsonConvert.DeserializeObject<WebApplicationManifest>(jsonString, ApplicationManifest.AdditionalPropertiesSerializerSettings));
                }
                matchedTypes.Add("WebApplicationManifest");
                match++;
            }
            catch (Exception exception)
            {
                // deserialization failed, try the next one
                System.Diagnostics.Debug.WriteLine(string.Format("Failed to deserialize `{0}` into WebApplicationManifest: {1}", jsonString, exception.ToString()));
            }
    ...
    /// <summary>
    /// Custom JSON converter for ApplicationManifest
    /// </summary>
    public class ApplicationManifestJsonConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            writer.WriteRawValue((string)(typeof(ApplicationManifest).GetMethod("ToJson").Invoke(value, null)));
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                return ApplicationManifest.FromJson(JObject.Load(reader).ToString(Formatting.None));
            }
            return null;
        }
