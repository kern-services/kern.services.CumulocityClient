...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApplicationManifest :  IEquatable<ApplicationManifest>, IValidatableObject
    {
        /// <summary>
        /// The billing mode of the application.  In case of RESOURCES, the number of resources used is exposed for billing calculation per usage. In case of SUBSCRIPTION, all resources usage is counted for the microservice owner and the subtenant is charged for subscription. 
        /// </summary>
        /// <value>The billing mode of the application.  In case of RESOURCES, the number of resources used is exposed for billing calculation per usage. In case of SUBSCRIPTION, all resources usage is counted for the microservice owner and the subtenant is charged for subscription. </value>
        ...
        /// </summary>
        /// <value>The billing mode of the application.  In case of RESOURCES, the number of resources used is exposed for billing calculation per usage. In case of SUBSCRIPTION, all resources usage is counted for the microservice owner and the subtenant is charged for subscription. </value>
        [DataMember(Name="billingMode", EmitDefaultValue=false)]
        ...
        /// </summary>
        /// <value>Deployment isolation. In case of PER_TENANT, there is a separate instance for each tenant. Otherwise, there is one single instance for all subscribed tenants. This will affect billing. </value>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum IsolationEnum
        {
            /// <summary>
            /// Enum MULTITENANT for value: MULTI_TENANT
            /// </summary>
            [EnumMember(Value = "MULTI_TENANT")]
            MULTITENANT = 1,

            /// <summary>
            /// Enum PERTENANT for value: PER_TENANT
            /// </summary>
        ...
        /// </summary>
        /// <value>Allows to configure a microservice auto scaling policy. If the microservice uses a lot of CPU resources, a second instance will be created automatically when this is set to &#x60;AUTO&#x60;. The default is &#x60;NONE&#x60;, meaning auto scaling will not happen. </value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationManifest" /> class.
        /// </summary>
        /// <param name="apiVersion">Document type format discriminator, for future changes in format..</param>
        /// <param name="billingMode">The billing mode of the application.  In case of RESOURCES, the number of resources used is exposed for billing calculation per usage. In case of SUBSCRIPTION, all resources usage is counted for the microservice owner and the subtenant is charged for subscription.  (default to BillingModeEnum.RESOURCES).</param>
        /// <param name="contextPath">The context path in the URL makes the application accessible..</param>
        /// <param name="extensions">A list of URL extensions for this microservice application..</param>
        /// <param name="isolation">Deployment isolation. In case of PER_TENANT, there is a separate instance for each tenant. Otherwise, there is one single instance for all subscribed tenants. This will affect billing. .</param>
        /// <param name="livenessProbe">livenessProbe.</param>
        /// <param name="provider">provider.</param>
        /// <param name="readinessProbe">readinessProbe.</param>
        /// <param name="requestResources">requestResources.</param>
        ...
        /// <param name="scale">Allows to configure a microservice auto scaling policy. If the microservice uses a lot of CPU resources, a second instance will be created automatically when this is set to &#x60;AUTO&#x60;. The default is &#x60;NONE&#x60;, meaning auto scaling will not happen.  (default to ScaleEnum.NONE).</param>
        /// <param name="settings">A list of settings objects for this microservice application..</param>
        /// <param name="settingsCategory">Allows to specify a custom category for microservice settings. By default, &#x60;contextPath&#x60; is used. .</param>
        /// <param name="version">Application version. Must be a correct [SemVer](https://semver.org/) value but the \&quot;+\&quot; sign is disallowed. .</param>
        /// <param name="webpaas">A legacy flag that identified a certain type of web application that would control the behavior of plugin tab in the application details view. It is no longer used. .</param>
        /// <param name="contentSecurityPolicy">The content security policy of the application..</param>
        /// <param name="noAppSwitcher">A flag that decides if the application is shown in the app switcher on the UI..</param>
        /// <param name="tabsHorizontal">A flag that decides if the application tabs are displayed horizontally or not..</param>
        public ApplicationManifest(string apiVersion = default(string), BillingModeEnum? billingMode = BillingModeEnum.RESOURCES, string contextPath = default(string), List<MicroserviceApplicationManifestExtensionsInner> extensions = default(List<MicroserviceApplicationManifestExtensionsInner>), IsolationEnum? isolation = default(IsolationEnum?), MicroserviceApplicationManifestLivenessProbe livenessProbe = default(MicroserviceApplicationManifestLivenessProbe), MicroserviceApplicationManifestProvider provider = default(MicroserviceApplicationManifestProvider), MicroserviceApplicationManifestReadinessProbe readinessProbe = default(MicroserviceApplicationManifestReadinessProbe), MicroserviceApplicationManifestRequestResources requestResources = default(MicroserviceApplicationManifestRequestResources), MicroserviceApplicationManifestResources resources = default(MicroserviceApplicationManifestResources), List<string> roles = default(List<string>), List<string> requiredRoles = default(List<string>), ScaleEnum? scale = ScaleEnum.NONE, List<ApplicationSettingsInner> settings = default(List<ApplicationSettingsInner>), string settingsCategory = default(string), string version = default(string), bool webpaas = default(bool), string contentSecurityPolicy = default(string), bool noAppSwitcher = default(bool), bool tabsHorizontal = default(bool))
        {
            this.ApiVersion = apiVersion;
            // use default value if no "billingMode" provided
            if (billingMode == null)
            {
                this.BillingMode = BillingModeEnum.RESOURCES;
            }
            else
            {
        ...
        /// </summary>
        /// <value>Document type format discriminator, for future changes in format.</value>
        ...
        /// </summary>
        /// <value>The context path in the URL makes the application accessible.</value>
        ...
        /// </summary>
        /// <value>A list of URL extensions for this microservice application.</value>
        [DataMember(Name="extensions", EmitDefaultValue=false)]
        public List<MicroserviceApplicationManifestExtensionsInner> Extensions { get; set; }
        ...
        public MicroserviceApplicationManifestLivenessProbe LivenessProbe { get; set; }

        /// <summary>
        /// Gets or Sets Provider
        /// </summary>
        [DataMember(Name="provider", EmitDefaultValue=false)]
        public MicroserviceApplicationManifestProvider Provider { get; set; }

        /// <summary>
        /// Gets or Sets ReadinessProbe
        /// </summary>
        [DataMember(Name="readinessProbe", EmitDefaultValue=false)]
        public MicroserviceApplicationManifestReadinessProbe ReadinessProbe { get; set; }

        /// <summary>
        /// Gets or Sets RequestResources
        /// </summary>
        [DataMember(Name="requestResources", EmitDefaultValue=false)]
        public MicroserviceApplicationManifestRequestResources RequestResources { get; set; }

        /// <summary>
        /// Gets or Sets Resources
        /// </summary>
        [DataMember(Name="resources", EmitDefaultValue=false)]
        public MicroserviceApplicationManifestResources Resources { get; set; }
        ...
        /// </summary>
        /// <value>A list of settings objects for this microservice application.</value>
        [DataMember(Name="settings", EmitDefaultValue=false)]
        public List<ApplicationSettingsInner> Settings { get; set; }

        /// <summary>
        /// Allows to specify a custom category for microservice settings. By default, &#x60;contextPath&#x60; is used. 
        /// </summary>
        /// <value>Allows to specify a custom category for microservice settings. By default, &#x60;contextPath&#x60; is used. </value>
        [DataMember(Name="settingsCategory", EmitDefaultValue=false)]
        ...
        /// </summary>
        /// <value>Application version. Must be a correct [SemVer](https://semver.org/) value but the \&quot;+\&quot; sign is disallowed. </value>
        ...
        /// </summary>
        /// <value>A legacy flag that identified a certain type of web application that would control the behavior of plugin tab in the application details view. It is no longer used. </value>
        [DataMember(Name="_webpaas", EmitDefaultValue=false)]
        [Obsolete]
        public bool Webpaas { get; set; }

        /// <summary>
        /// The content security policy of the application.
        /// </summary>
        /// <value>The content security policy of the application.</value>
        ...
        /// </summary>
        /// <value>A flag that decides if the application is shown in the app switcher on the UI.</value>
        [DataMember(Name="noAppSwitcher", EmitDefaultValue=false)]
        public bool NoAppSwitcher { get; set; }

        /// <summary>
        /// A flag that decides if the application tabs are displayed horizontally or not.
        /// </summary>
        /// <value>A flag that decides if the application tabs are displayed horizontally or not.</value>
        [DataMember(Name="tabsHorizontal", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  RequestResources: ").Append(RequestResources).Append("\n");
            sb.Append("  Resources: ").Append(Resources).Append("\n");
            sb.Append("  Roles: ").Append(Roles).Append("\n");
            sb.Append("  RequiredRoles: ").Append(RequiredRoles).Append("\n");
            sb.Append("  Scale: ").Append(Scale).Append("\n");
            sb.Append("  Settings: ").Append(Settings).Append("\n");
            sb.Append("  SettingsCategory: ").Append(SettingsCategory).Append("\n");
            sb.Append("  _Version: ").Append(_Version).Append("\n");
            sb.Append("  Webpaas: ").Append(Webpaas).Append("\n");
            sb.Append("  ContentSecurityPolicy: ").Append(ContentSecurityPolicy).Append("\n");
            sb.Append("  NoAppSwitcher: ").Append(NoAppSwitcher).Append("\n");
            sb.Append("  TabsHorizontal: ").Append(TabsHorizontal).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as ApplicationManifest);
        }

        /// <summary>
        /// Returns true if ApplicationManifest instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationManifest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationManifest input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.RequestResources == input.RequestResources ||
                    (this.RequestResources != null &&
                    this.RequestResources.Equals(input.RequestResources))
                ) && 
                (
                ...
                (
                    this.SettingsCategory == input.SettingsCategory ||
                    (this.SettingsCategory != null &&
                    this.SettingsCategory.Equals(input.SettingsCategory))
                ) && 
                (
                ...
                (
                    this.Webpaas == input.Webpaas ||
                    (this.Webpaas != null &&
                    this.Webpaas.Equals(input.Webpaas))
                ) && 
                (
                ...
                (
                    this.NoAppSwitcher == input.NoAppSwitcher ||
                    (this.NoAppSwitcher != null &&
                    this.NoAppSwitcher.Equals(input.NoAppSwitcher))
                ) && 
                (
                    this.TabsHorizontal == input.TabsHorizontal ||
                    (this.TabsHorizontal != null &&
                    this.TabsHorizontal.Equals(input.TabsHorizontal))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.RequestResources != null)
                    hashCode = hashCode * 59 + this.RequestResources.GetHashCode();
                ...
                if (this.SettingsCategory != null)
                    hashCode = hashCode * 59 + this.SettingsCategory.GetHashCode();
                if (this._Version != null)
                    hashCode = hashCode * 59 + this._Version.GetHashCode();
                if (this.Webpaas != null)
                    hashCode = hashCode * 59 + this.Webpaas.GetHashCode();
                if (this.ContentSecurityPolicy != null)
                    hashCode = hashCode * 59 + this.ContentSecurityPolicy.GetHashCode();
                if (this.NoAppSwitcher != null)
                    hashCode = hashCode * 59 + this.NoAppSwitcher.GetHashCode();
                if (this.TabsHorizontal != null)
                    hashCode = hashCode * 59 + this.TabsHorizontal.GetHashCode();
                return hashCode;
            }
        }
