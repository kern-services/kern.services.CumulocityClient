...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "user_roles")]
    public partial class UserRoles : IValidatableObject
    {
        /// <summary>
        ...
        public UserRoles(List<RoleReference> references = default(List<RoleReference>), PageStatistics statistics = default(PageStatistics))
        {
