...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "c8y_Hardware")]
    public partial class C8yHardware : IEquatable<C8yHardware>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="C8yHardware" /> class.
        /// </summary>
        /// <param name="model">A text identifier of the device&#39;s hardware model..</param>
        /// <param name="revision">A text identifier of the hardware revision..</param>
        /// <param name="serialNumber">The hardware serial number of the device..</param>
        public C8yHardware(string model = default(string), string revision = default(string), string serialNumber = default(string))
        {
            this.Model = model;
        ...
        /// </summary>
        /// <value>A text identifier of the device&#39;s hardware model.</value>
        ...
        /// </summary>
        /// <value>A text identifier of the hardware revision.</value>
        ...
        /// </summary>
        /// <value>The hardware serial number of the device.</value>
        ...
        {
            return this.Equals(input as C8yHardware);
        }

        /// <summary>
        /// Returns true if C8yHardware instances are equal
        /// </summary>
        /// <param name="input">Instance of C8yHardware to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(C8yHardware input)
        {
            if (input == null)
            {
                return false;
