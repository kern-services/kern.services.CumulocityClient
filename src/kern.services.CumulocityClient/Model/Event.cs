...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// Event
    /// </summary>
    [DataContract(Name = "_event")]
    public partial class Event : Dictionary<String, Object>, IEquatable<Event>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="time">The date and time when the event is updated..</param>
        /// <param name="type">Identifies the type of this event..</param>
        public Event(EventSource source = default(EventSource), string text = default(string), DateTime time = default(DateTime), string type = default(string)) : base()
        {
            this.Source = source;
            this.Text = text;
            this.Time = time;
