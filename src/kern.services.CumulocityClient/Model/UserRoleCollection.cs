...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// UserRoleCollection
    /// </summary>
    [DataContract(Name = "UserRoleCollection")]
    public partial class UserRoleCollection : IEquatable<UserRoleCollection>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserRoleCollection" /> class.
        /// </summary>
        /// <param name="roles">An array of user roles..</param>
        /// <param name="statistics">statistics.</param>
        public UserRoleCollection(List<Role> roles = default(List<Role>), PageStatistics statistics = default(PageStatistics))
        {
            this.Roles = roles;
        ...
        {
            return this.Equals(input as UserRoleCollection);
        }

        /// <summary>
        /// Returns true if UserRoleCollection instances are equal
        /// </summary>
        /// <param name="input">Instance of UserRoleCollection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserRoleCollection input)
        {
            if (input == null)
            {
                return false;
