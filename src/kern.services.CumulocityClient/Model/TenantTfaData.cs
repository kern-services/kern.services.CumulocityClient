...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// TenantTfaData
    /// </summary>
    [DataContract(Name = "tenantTfaData")]
    public partial class TenantTfaData : IEquatable<TenantTfaData>, IValidatableObject
    {
        /// <summary>
        /// Two-factor authentication strategy.
        /// </summary>
        /// <value>Two-factor authentication strategy.</value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TenantTfaData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public TenantTfaData()
        {
        }
        ...
        /// </summary>
        /// <value>Indicates whether two-factor authentication is enabled on system level or not.</value>
        [DataMember(Name = "enabledOnSystemLevel", EmitDefaultValue = true)]
        public bool EnabledOnSystemLevel { get; private set; }

        /// <summary>
        /// Returns false as EnabledOnSystemLevel should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeEnabledOnSystemLevel()
        {
            return false;
        }
        /// <summary>
        ...
        /// </summary>
        /// <value>Indicates whether two-factor authentication is enabled on tenant level or not.</value>
        [DataMember(Name = "enabledOnTenantLevel", EmitDefaultValue = true)]
        public bool EnabledOnTenantLevel { get; private set; }

        /// <summary>
        /// Returns false as EnabledOnTenantLevel should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeEnabledOnTenantLevel()
        {
            return false;
        }
        /// <summary>
        ...
        /// </summary>
        /// <value>Indicates whether two-factor authentication is enforced on system level or not.</value>
        [DataMember(Name = "enforcedOnSystemLevel", EmitDefaultValue = true)]
        public bool EnforcedOnSystemLevel { get; private set; }

        /// <summary>
        /// Returns false as EnforcedOnSystemLevel should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeEnforcedOnSystemLevel()
        {
            return false;
        }
        /// <summary>
        ...
        /// </summary>
        /// <value>Two-factor authentication is enforced for the specified group.</value>
        [DataMember(Name = "enforcedUsersGroup", EmitDefaultValue = false)]
        public string EnforcedUsersGroup { get; private set; }

        /// <summary>
        /// Returns false as EnforcedUsersGroup should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeEnforcedUsersGroup()
        {
            return false;
        }
        /// <summary>
        ...
        /// </summary>
        /// <value>Indicates whether two-factor authentication is enforced on tenant level or not.</value>
        [DataMember(Name = "totpEnforcedOnTenantLevel", EmitDefaultValue = true)]
        public bool TotpEnforcedOnTenantLevel { get; private set; }

        /// <summary>
        /// Returns false as TotpEnforcedOnTenantLevel should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeTotpEnforcedOnTenantLevel()
        {
            return false;
        }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  EnabledOnSystemLevel: ").Append(EnabledOnSystemLevel).Append("\n");
            sb.Append("  EnabledOnTenantLevel: ").Append(EnabledOnTenantLevel).Append("\n");
            sb.Append("  EnforcedOnSystemLevel: ").Append(EnforcedOnSystemLevel).Append("\n");
            sb.Append("  EnforcedUsersGroup: ").Append(EnforcedUsersGroup).Append("\n");
            sb.Append("  Strategy: ").Append(Strategy).Append("\n");
            sb.Append("  TotpEnforcedOnTenantLevel: ").Append(TotpEnforcedOnTenantLevel).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as TenantTfaData);
        }

        /// <summary>
        /// Returns true if TenantTfaData instances are equal
        /// </summary>
        /// <param name="input">Instance of TenantTfaData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TenantTfaData input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.EnabledOnSystemLevel == input.EnabledOnSystemLevel ||
                    this.EnabledOnSystemLevel.Equals(input.EnabledOnSystemLevel)
                ) && 
                (
                    this.EnabledOnTenantLevel == input.EnabledOnTenantLevel ||
                    this.EnabledOnTenantLevel.Equals(input.EnabledOnTenantLevel)
                ) && 
                (
                    this.EnforcedOnSystemLevel == input.EnforcedOnSystemLevel ||
                    this.EnforcedOnSystemLevel.Equals(input.EnforcedOnSystemLevel)
                ) && 
                (
                    this.EnforcedUsersGroup == input.EnforcedUsersGroup ||
                    (this.EnforcedUsersGroup != null &&
                    this.EnforcedUsersGroup.Equals(input.EnforcedUsersGroup))
                ) && 
                (
                ...
                (
                    this.TotpEnforcedOnTenantLevel == input.TotpEnforcedOnTenantLevel ||
                    this.TotpEnforcedOnTenantLevel.Equals(input.TotpEnforcedOnTenantLevel)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                hashCode = (hashCode * 59) + this.EnabledOnSystemLevel.GetHashCode();
                hashCode = (hashCode * 59) + this.EnabledOnTenantLevel.GetHashCode();
                hashCode = (hashCode * 59) + this.EnforcedOnSystemLevel.GetHashCode();
                if (this.EnforcedUsersGroup != null)
                {
                    hashCode = (hashCode * 59) + this.EnforcedUsersGroup.GetHashCode();
                }
                hashCode = (hashCode * 59) + this.Strategy.GetHashCode();
                hashCode = (hashCode * 59) + this.TotpEnforcedOnTenantLevel.GetHashCode();
                return hashCode;
            }
        }
