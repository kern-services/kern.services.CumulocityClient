...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "c8y_Position")]
    public partial class C8yPosition : IEquatable<C8yPosition>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="C8yPosition" /> class.
        /// </summary>
        /// <param name="alt">In meters..</param>
        /// <param name="lng">lng.</param>
        /// <param name="lat">lat.</param>
        /// <param name="trackingProtocol">Describes in which protocol the tracking context of a positioning report was sent..</param>
        /// <param name="reportReason">Describes why the tracking context of a positioning report was sent..</param>
        public C8yPosition(decimal alt = default(decimal), decimal lng = default(decimal), decimal lat = default(decimal), string trackingProtocol = default(string), string reportReason = default(string))
        {
            this.Alt = alt;
            this.Lng = lng;
            this.Lat = lat;
        ...
        /// </summary>
        /// <value>Describes in which protocol the tracking context of a positioning report was sent.</value>
        [DataMember(Name = "trackingProtocol", EmitDefaultValue = false)]
        public string TrackingProtocol { get; set; }

        /// <summary>
        /// Describes why the tracking context of a positioning report was sent.
        /// </summary>
        /// <value>Describes why the tracking context of a positioning report was sent.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  TrackingProtocol: ").Append(TrackingProtocol).Append("\n");
        ...
        {
            return this.Equals(input as C8yPosition);
        }

        /// <summary>
        /// Returns true if C8yPosition instances are equal
        /// </summary>
        /// <param name="input">Instance of C8yPosition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(C8yPosition input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.TrackingProtocol == input.TrackingProtocol ||
                    (this.TrackingProtocol != null &&
                    this.TrackingProtocol.Equals(input.TrackingProtocol))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.TrackingProtocol != null)
                {
                    hashCode = (hashCode * 59) + this.TrackingProtocol.GetHashCode();
                }
