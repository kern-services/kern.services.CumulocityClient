...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "authConfig_signatureVerificationConfig_jwks")]
    public partial class AuthConfigSignatureVerificationConfigJwks : IEquatable<AuthConfigSignatureVerificationConfigJwks>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthConfigSignatureVerificationConfigJwks" /> class.
        /// </summary>
        /// <param name="jwksUrl">The URI to the public key resource..</param>
        public AuthConfigSignatureVerificationConfigJwks(string jwksUrl = default(string))
        {
        ...
        /// </summary>
        /// <value>The URI to the public key resource.</value>
        ...
        {
            return this.Equals(input as AuthConfigSignatureVerificationConfigJwks);
        }

        /// <summary>
        /// Returns true if AuthConfigSignatureVerificationConfigJwks instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthConfigSignatureVerificationConfigJwks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthConfigSignatureVerificationConfigJwks input)
        {
            if (input == null)
            {
                return false;
