...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// CategoryKeyOption
    /// </summary>
    [DataContract(Name = "CategoryKeyOption")]
    public partial class CategoryKeyOption : IEquatable<CategoryKeyOption>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CategoryKeyOption" /> class.
        /// </summary>
        /// <param name="value">The value of this option..</param>
        public CategoryKeyOption(string value = default(string))
        {
            this.Value = value;
        }
        ...
        {
            return this.Equals(input as CategoryKeyOption);
        }

        /// <summary>
        /// Returns true if CategoryKeyOption instances are equal
        /// </summary>
        /// <param name="input">Instance of CategoryKeyOption to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CategoryKeyOption input)
        {
            if (input == null)
            {
                return false;
