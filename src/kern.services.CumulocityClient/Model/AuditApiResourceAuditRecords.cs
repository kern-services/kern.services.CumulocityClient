...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "auditApiResource_auditRecords")]
    public partial class AuditApiResourceAuditRecords : IEquatable<AuditApiResourceAuditRecords>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditApiResourceAuditRecords" /> class.
        /// </summary>
        /// <param name="auditRecords">auditRecords.</param>
        public AuditApiResourceAuditRecords(List<AuditRecord> auditRecords = default(List<AuditRecord>))
        {
        ...
        /// </summary>
        [DataMember(Name = "auditRecords", EmitDefaultValue = true)]
        ...
        {
            return this.Equals(input as AuditApiResourceAuditRecords);
        }

        /// <summary>
        /// Returns true if AuditApiResourceAuditRecords instances are equal
        /// </summary>
        /// <param name="input">Instance of AuditApiResourceAuditRecords to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuditApiResourceAuditRecords input)
        {
            if (input == null)
            {
                return false;
