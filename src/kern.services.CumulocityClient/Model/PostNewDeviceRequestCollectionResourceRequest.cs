...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "postNewDeviceRequestCollectionResource_request")]
    public partial class PostNewDeviceRequestCollectionResourceRequest : IEquatable<PostNewDeviceRequestCollectionResourceRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostNewDeviceRequestCollectionResourceRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostNewDeviceRequestCollectionResourceRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostNewDeviceRequestCollectionResourceRequest" /> class.
        /// </summary>
        /// <param name="id">External ID of the device. (required).</param>
        public PostNewDeviceRequestCollectionResourceRequest(string id = default(string))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for PostNewDeviceRequestCollectionResourceRequest and cannot be null");
            }
            this.Id = id;
        }
        ...
        {
            return this.Equals(input as PostNewDeviceRequestCollectionResourceRequest);
        }

        /// <summary>
        /// Returns true if PostNewDeviceRequestCollectionResourceRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PostNewDeviceRequestCollectionResourceRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostNewDeviceRequestCollectionResourceRequest input)
        {
            if (input == null)
            {
                return false;
