...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DeviceStatistics")]
    public partial class DeviceStatistics : IEquatable<DeviceStatistics>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceStatistics" /> class.
        /// </summary>
        /// <param name="count">Sum of measurements, events and alarms created and updated for the specified device..</param>
        /// <param name="deviceId">Unique identifier of the device..</param>
        /// <param name="deviceParents">List of unique identifiers of parents for the corresponding device. Available only with monthly data..</param>
        /// <param name="deviceType">Value of the &#x60;type&#x60; field from the corresponding device. Available only with monthly data..</param>
        public DeviceStatistics(int count = default(int), string deviceId = default(string), List<string> deviceParents = default(List<string>), string deviceType = default(string))
        {
            this.Count = count;
        ...
        /// </summary>
        /// <value>Sum of measurements, events and alarms created and updated for the specified device.</value>
        ...
        /// </summary>
        /// <value>Unique identifier of the device.</value>
        ...
        /// </summary>
        /// <value>List of unique identifiers of parents for the corresponding device. Available only with monthly data.</value>
        [DataMember(Name = "deviceParents", EmitDefaultValue = true)]
        ...
        /// </summary>
        /// <value>Value of the &#x60;type&#x60; field from the corresponding device. Available only with monthly data.</value>
        ...
        {
            return this.Equals(input as DeviceStatistics);
        }

        /// <summary>
        /// Returns true if DeviceStatistics instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceStatistics to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceStatistics input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    ...
                    input.DeviceParents != null &&
                    this.DeviceParents.SequenceEqual(input.DeviceParents)
                ) && 
                (
        ...
        public IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for DeviceId, length must be greater than 1.", new [] { "DeviceId" });
            }
