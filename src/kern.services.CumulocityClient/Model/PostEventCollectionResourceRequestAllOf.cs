...
{
    /// <summary>
    /// PostEventCollectionResourceRequestAllOf
    /// </summary>
    [DataContract(Name = "postEventCollectionResource_request_allOf")]
    public partial class PostEventCollectionResourceRequestAllOf : IEquatable<PostEventCollectionResourceRequestAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostEventCollectionResourceRequestAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostEventCollectionResourceRequestAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostEventCollectionResourceRequestAllOf" /> class.
        /// </summary>
        /// <param name="source">source (required).</param>
        public PostEventCollectionResourceRequestAllOf(Object source = default(Object))
        {
            // to ensure "source" is required (not null)
            if (source == null)
            {
                throw new ArgumentNullException("source is a required property for PostEventCollectionResourceRequestAllOf and cannot be null");
            }
            this.Source = source;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostEventCollectionResourceRequestAllOf {\n");
        ...
        {
            return this.Equals(input as PostEventCollectionResourceRequestAllOf);
        }

        /// <summary>
        /// Returns true if PostEventCollectionResourceRequestAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of PostEventCollectionResourceRequestAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostEventCollectionResourceRequestAllOf input)
        {
            if (input == null)
            {
                return false;
