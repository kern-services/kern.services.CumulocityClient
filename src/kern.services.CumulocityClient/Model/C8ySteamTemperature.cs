...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class C8ySteamTemperature :  IEquatable<C8ySteamTemperature>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="C8ySteamTemperature" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected C8ySteamTemperature() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="C8ySteamTemperature" /> class.
        /// </summary>
        /// <param name="unit">The unit of the measurement..</param>
        /// <param name="value">The value of the individual measurement. (required).</param>
        public C8ySteamTemperature(string unit = default(string), decimal value = default(decimal))
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new InvalidDataException("value is a required property for C8ySteamTemperature and cannot be null");
            }
            else
            {
                this.Value = value;
        ...
        /// </summary>
        /// <value>The unit of the measurement.</value>
        ...
        /// </summary>
        /// <value>The value of the individual measurement.</value>
        ...
        {
            return this.Equals(input as C8ySteamTemperature);
        }

        /// <summary>
        /// Returns true if C8ySteamTemperature instances are equal
        /// </summary>
        /// <param name="input">Instance of C8ySteamTemperature to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(C8ySteamTemperature input)
        {
            if (input == null)
                return false;
