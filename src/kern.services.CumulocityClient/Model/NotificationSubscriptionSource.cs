...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NotificationSubscription_source")]
    public partial class NotificationSubscriptionSource : IEquatable<NotificationSubscriptionSource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NotificationSubscriptionSource" /> class.
        /// </summary>
        ...
        public NotificationSubscriptionSource(string id = default(string), string name = default(string))
        {
            this.Id = id;
            this.Name = name;
        }
        ...
        {
            return this.Equals(input as NotificationSubscriptionSource);
        }

        /// <summary>
        /// Returns true if NotificationSubscriptionSource instances are equal
        /// </summary>
        /// <param name="input">Instance of NotificationSubscriptionSource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NotificationSubscriptionSource input)
        {
            if (input == null)
            {
                return false;
