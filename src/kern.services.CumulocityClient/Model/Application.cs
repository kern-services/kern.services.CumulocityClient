...
namespace kern.services.CumulocityClient.Model
{
    ...
    public partial class Application :  IEquatable<Application>, IValidatableObject
    {
        ...
        public Application(AvailabilityEnum? availability = AvailabilityEnum.PRIVATE, string contextPath = default(string), string description = default(string), string key = default(string), string name = default(string), ApplicationOwner owner = default(ApplicationOwner), TypeEnum? type = default(TypeEnum?), ApplicationManifest manifest = default(ApplicationManifest), List<string> roles = default(List<string>), List<string> requiredRoles = default(List<string>), bool breadcrumbs = default(bool), string contentSecurityPolicy = default(string), string dynamicOptionsUrl = default(string), string globalTitle = default(string), bool legacy = default(bool), bool rightDrawer = default(bool), bool upgrade = default(bool))
        {
