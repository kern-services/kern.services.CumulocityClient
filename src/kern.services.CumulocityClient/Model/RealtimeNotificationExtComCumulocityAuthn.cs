...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "realtimeNotification_ext_com_cumulocity_authn")]
    public partial class RealtimeNotificationExtComCumulocityAuthn : IEquatable<RealtimeNotificationExtComCumulocityAuthn>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RealtimeNotificationExtComCumulocityAuthn" /> class.
        /// </summary>
        /// <param name="token">Base64 encoded credentials..</param>
        /// <param name="tfa">Optional two factor authentication token..</param>
        /// <param name="xsrfToken">Required for OAuth authentication..</param>
        public RealtimeNotificationExtComCumulocityAuthn(string token = default(string), string tfa = default(string), string xsrfToken = default(string))
        {
            this.Token = token;
            this.Tfa = tfa;
        ...
        /// </summary>
        /// <value>Base64 encoded credentials.</value>
        ...
        /// </summary>
        /// <value>Optional two factor authentication token.</value>
        ...
        /// </summary>
        /// <value>Required for OAuth authentication.</value>
        ...
        {
            return this.Equals(input as RealtimeNotificationExtComCumulocityAuthn);
        }

        /// <summary>
        /// Returns true if RealtimeNotificationExtComCumulocityAuthn instances are equal
        /// </summary>
        /// <param name="input">Instance of RealtimeNotificationExtComCumulocityAuthn to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RealtimeNotificationExtComCumulocityAuthn input)
        {
            if (input == null)
            {
                return false;
