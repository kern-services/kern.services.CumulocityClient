...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// AlarmCollection
    /// </summary>
    [DataContract(Name = "AlarmCollection")]
    public partial class AlarmCollection : IEquatable<AlarmCollection>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AlarmCollection" /> class.
        /// </summary>
        /// <param name="alarms">An array containing the results (alarms) of the request..</param>
        /// <param name="statistics">statistics.</param>
        public AlarmCollection(List<Alarm> alarms = default(List<Alarm>), PageStatistics statistics = default(PageStatistics))
        {
            this.Alarms = alarms;
        ...
        /// </summary>
        /// <value>An array containing the results (alarms) of the request.</value>
        ...
        {
            return this.Equals(input as AlarmCollection);
        }

        /// <summary>
        /// Returns true if AlarmCollection instances are equal
        /// </summary>
        /// <param name="input">Instance of AlarmCollection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AlarmCollection input)
        {
            if (input == null)
            {
                return false;
