...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "c8y_CommunicationMode")]
    public partial class C8yCommunicationMode : IEquatable<C8yCommunicationMode>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="C8yCommunicationMode" /> class.
        /// </summary>
        /// <param name="mode">mode.</param>
        public C8yCommunicationMode(string mode = default(string))
        {
            this.Mode = mode;
        }
        ...
        {
            return this.Equals(input as C8yCommunicationMode);
        }

        /// <summary>
        /// Returns true if C8yCommunicationMode instances are equal
        /// </summary>
        /// <param name="input">Instance of C8yCommunicationMode to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(C8yCommunicationMode input)
        {
            if (input == null)
            {
                return false;
