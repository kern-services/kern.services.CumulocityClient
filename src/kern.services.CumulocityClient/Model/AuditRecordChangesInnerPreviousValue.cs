...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [JsonConverter(typeof(AuditRecordChangesInnerPreviousValueJsonConverter))]
    [DataContract(Name = "auditRecord_changes_inner_previousValue")]
    public partial class AuditRecordChangesInnerPreviousValue : AbstractOpenAPISchema, IEquatable<AuditRecordChangesInnerPreviousValue>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditRecordChangesInnerPreviousValue" /> class.
        /// </summary>
        public AuditRecordChangesInnerPreviousValue()
        {
        ...
        public AuditRecordChangesInnerPreviousValue(string actualInstance)
        {
            this.IsNullable = true;
            this.SchemaType= "oneOf";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditRecordChangesInnerPreviousValue" /> class
        /// with the <see cref="AuditRecordChangesInnerNewValueOneOf" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of AuditRecordChangesInnerNewValueOneOf.</param>
        public AuditRecordChangesInnerPreviousValue(AuditRecordChangesInnerNewValueOneOf actualInstance)
        {
            this.IsNullable = true;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance;
        ...
        public override Object ActualInstance
        {
            ...
            set
            {
                if (value.GetType() == typeof(AuditRecordChangesInnerNewValueOneOf))
                {
                ...
                {
                    throw new ArgumentException("Invalid instance found. Must be the following types: AuditRecordChangesInnerNewValueOneOf, string");
                }
            }
        }
        ...
        /// <summary>
        /// Get the actual instance of `AuditRecordChangesInnerNewValueOneOf`. If the actual instance is not `AuditRecordChangesInnerNewValueOneOf`,
        /// the InvalidClassException will be thrown
        /// </summary>
        /// <returns>An instance of AuditRecordChangesInnerNewValueOneOf</returns>
        public AuditRecordChangesInnerNewValueOneOf GetAuditRecordChangesInnerNewValueOneOf()
        {
            return (AuditRecordChangesInnerNewValueOneOf)this.ActualInstance;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AuditRecordChangesInnerPreviousValue {\n");
        ...
        {
            return JsonConvert.SerializeObject(this.ActualInstance, AuditRecordChangesInnerPreviousValue.SerializerSettings);
        }

        /// <summary>
        /// Converts the JSON string into an instance of AuditRecordChangesInnerPreviousValue
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of AuditRecordChangesInnerPreviousValue</returns>
        public static AuditRecordChangesInnerPreviousValue FromJson(string jsonString)
        {
            AuditRecordChangesInnerPreviousValue newAuditRecordChangesInnerPreviousValue = null;

            if (string.IsNullOrEmpty(jsonString))
            {
                return newAuditRecordChangesInnerPreviousValue;
            }
            int match = 0;
            ...
            try
            {
                ...
                if (typeof(AuditRecordChangesInnerNewValueOneOf).GetProperty("AdditionalProperties") == null)
                {
                    newAuditRecordChangesInnerPreviousValue = new AuditRecordChangesInnerPreviousValue(JsonConvert.DeserializeObject<AuditRecordChangesInnerNewValueOneOf>(jsonString, AuditRecordChangesInnerPreviousValue.SerializerSettings));
                }
                else
                {
                    newAuditRecordChangesInnerPreviousValue = new AuditRecordChangesInnerPreviousValue(JsonConvert.DeserializeObject<AuditRecordChangesInnerNewValueOneOf>(jsonString, AuditRecordChangesInnerPreviousValue.AdditionalPropertiesSerializerSettings));
                }
                matchedTypes.Add("AuditRecordChangesInnerNewValueOneOf");
                match++;
            }
            catch (Exception exception)
            {
                // deserialization failed, try the next one
                System.Diagnostics.Debug.WriteLine(string.Format("Failed to deserialize `{0}` into AuditRecordChangesInnerNewValueOneOf: {1}", jsonString, exception.ToString()));
            }
            ...
            try
            {
                ...
                {
                    newAuditRecordChangesInnerPreviousValue = new AuditRecordChangesInnerPreviousValue(JsonConvert.DeserializeObject<string>(jsonString, AuditRecordChangesInnerPreviousValue.SerializerSettings));
                }
                else
                {
                    newAuditRecordChangesInnerPreviousValue = new AuditRecordChangesInnerPreviousValue(JsonConvert.DeserializeObject<string>(jsonString, AuditRecordChangesInnerPreviousValue.AdditionalPropertiesSerializerSettings));
                }
        ...
        {
            return this.Equals(input as AuditRecordChangesInnerPreviousValue);
        }

        /// <summary>
        /// Returns true if AuditRecordChangesInnerPreviousValue instances are equal
        /// </summary>
        /// <param name="input">Instance of AuditRecordChangesInnerPreviousValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuditRecordChangesInnerPreviousValue input)
        {
            if (input == null)
                return false;
    ...
    /// <summary>
    /// Custom JSON converter for AuditRecordChangesInnerPreviousValue
    /// </summary>
    public class AuditRecordChangesInnerPreviousValueJsonConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            writer.WriteRawValue((string)(typeof(AuditRecordChangesInnerPreviousValue).GetMethod("ToJson").Invoke(value, null)));
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                return AuditRecordChangesInnerPreviousValue.FromJson(JObject.Load(reader).ToString(Formatting.None));
            }
            return null;
        }
