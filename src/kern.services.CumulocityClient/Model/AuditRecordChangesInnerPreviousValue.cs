...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AuditRecordChangesInnerPreviousValue :  IEquatable<AuditRecordChangesInnerPreviousValue>, IValidatableObject
    {
        /// <summary>
        ...
        public AuditRecordChangesInnerPreviousValue(string cpu = default(string), string memory = default(string))
        {
            this.Cpu = cpu;
            this.Memory = memory;
        }
