...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "c8y_MeasurementValue")]
    public partial class C8yMeasurementValue : IEquatable<C8yMeasurementValue>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="C8yMeasurementValue" /> class.
        /// </summary>
        /// <param name="value">value.</param>
        /// <param name="unit">unit.</param>
        public C8yMeasurementValue(decimal value = default(decimal), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        {
            return this.Equals(input as C8yMeasurementValue);
        }

        /// <summary>
        /// Returns true if C8yMeasurementValue instances are equal
        /// </summary>
        /// <param name="input">Instance of C8yMeasurementValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(C8yMeasurementValue input)
        {
            if (input == null)
            {
                return false;
