...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "c8y_LightMeasurement_e")]
    public partial class C8yLightMeasurementE : IEquatable<C8yLightMeasurementE>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="C8yLightMeasurementE" /> class.
        /// </summary>
        /// <param name="value">value.</param>
        /// <param name="unit">unit.</param>
        public C8yLightMeasurementE(decimal value = default(decimal), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        {
            return this.Equals(input as C8yLightMeasurementE);
        }

        /// <summary>
        /// Returns true if C8yLightMeasurementE instances are equal
        /// </summary>
        /// <param name="input">Instance of C8yLightMeasurementE to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(C8yLightMeasurementE input)
        {
            if (input == null)
            {
                return false;
