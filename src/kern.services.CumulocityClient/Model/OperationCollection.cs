...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// OperationCollection
    /// </summary>
    [DataContract(Name = "OperationCollection")]
    public partial class OperationCollection : IEquatable<OperationCollection>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OperationCollection" /> class.
        /// </summary>
        /// <param name="operations">An array of operations..</param>
        /// <param name="statistics">statistics.</param>
        public OperationCollection(List<Operation> operations = default(List<Operation>), PageStatistics statistics = default(PageStatistics))
        {
        ...
        /// </summary>
        /// <value>An array of operations.</value>
        ...
        {
            return this.Equals(input as OperationCollection);
        }

        /// <summary>
        /// Returns true if OperationCollection instances are equal
        /// </summary>
        /// <param name="input">Instance of OperationCollection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OperationCollection input)
        {
            if (input == null)
            {
                return false;
