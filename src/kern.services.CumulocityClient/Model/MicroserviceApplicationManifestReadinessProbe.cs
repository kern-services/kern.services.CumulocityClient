...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "microservice_application_manifest_readinessProbe")]
    public partial class MicroserviceApplicationManifestReadinessProbe : IEquatable<MicroserviceApplicationManifestReadinessProbe>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MicroserviceApplicationManifestReadinessProbe" /> class.
        /// </summary>
        /// <param name="failureThreshold">The probe failure threshold..</param>
        /// <param name="periodSeconds">The probe period in seconds..</param>
        /// <param name="timeoutSeconds">The probe timeout in seconds..</param>
        /// <param name="successThreshold">The probe success threshold..</param>
        /// <param name="initialDelaySeconds">The probe&#39;s initial delay in seconds..</param>
        /// <param name="httpGet">httpGet.</param>
        public MicroserviceApplicationManifestReadinessProbe(int failureThreshold = default(int), int periodSeconds = default(int), int timeoutSeconds = default(int), int successThreshold = default(int), int initialDelaySeconds = default(int), ApplicationManifestProbeHttpGet httpGet = default(ApplicationManifestProbeHttpGet))
        {
        ...
        /// </summary>
        /// <value>The probe failure threshold.</value>
        ...
        /// </summary>
        /// <value>The probe period in seconds.</value>
        ...
        /// </summary>
        /// <value>The probe timeout in seconds.</value>
        ...
        /// </summary>
        /// <value>The probe success threshold.</value>
        ...
        /// </summary>
        /// <value>The probe&#39;s initial delay in seconds.</value>
        ...
        public ApplicationManifestProbeHttpGet HttpGet { get; set; }
        ...
        {
            return this.Equals(input as MicroserviceApplicationManifestReadinessProbe);
        }

        /// <summary>
        /// Returns true if MicroserviceApplicationManifestReadinessProbe instances are equal
        /// </summary>
        /// <param name="input">Instance of MicroserviceApplicationManifestReadinessProbe to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MicroserviceApplicationManifestReadinessProbe input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.SuccessThreshold == input.SuccessThreshold ||
                    this.SuccessThreshold.Equals(input.SuccessThreshold)
                ) && 
                (
                ...
                (
                    this.HttpGet == input.HttpGet ||
                    (this.HttpGet != null &&
                    this.HttpGet.Equals(input.HttpGet))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.SuccessThreshold.GetHashCode();
                hashCode = (hashCode * 59) + this.InitialDelaySeconds.GetHashCode();
                if (this.HttpGet != null)
                {
                    hashCode = (hashCode * 59) + this.HttpGet.GetHashCode();
                }
                return hashCode;
            }
        }
