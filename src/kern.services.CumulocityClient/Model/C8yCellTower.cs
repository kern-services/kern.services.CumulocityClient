...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "c8y_CellTower")]
    public partial class C8yCellTower : IEquatable<C8yCellTower>, IValidatableObject
    {
        ...
        [DataMember(Name = "mobileCountryCode", IsRequired = true, EmitDefaultValue = true)]
        ...
        [DataMember(Name = "mobileNetworkCode", IsRequired = true, EmitDefaultValue = true)]
        ...
        [DataMember(Name = "locationAreaCode", IsRequired = true, EmitDefaultValue = true)]
        ...
        [DataMember(Name = "cellId", IsRequired = true, EmitDefaultValue = true)]
