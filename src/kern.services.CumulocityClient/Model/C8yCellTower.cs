...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class C8yCellTower :  IEquatable<C8yCellTower>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="C8yCellTower" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected C8yCellTower() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="C8yCellTower" /> class.
        /// </summary>
        /// <param name="radioType">The radio type of this cell tower. Can also be put directly in root JSON element if all cellTowers have same radioType..</param>
        /// <param name="mobileCountryCode">The Mobile Country Code (MCC). (required).</param>
        /// <param name="mobileNetworkCode">The Mobile Network Code (MNC) for GSM, WCDMA and LTE. The SystemID (sid) for CDMA. (required).</param>
        /// <param name="locationAreaCode">The Location Area Code (LAC) for GSM, WCDMA and LTE. The Network ID for CDMA. (required).</param>
        /// <param name="cellId">The Cell ID (CID) for GSM, WCDMA and LTE. The base station ID for CDMA. (required).</param>
        /// <param name="timingAdvance">The timing advance value for this cell tower when available..</param>
        /// <param name="signalStrength">The signal strength for this cell tower in dBm..</param>
        /// <param name="primaryScramblingCode">The primary scrambling code for WCDMA and physical CellId for LTE..</param>
        /// <param name="serving">Specify with 0/1 if the cell is serving or not. If not specified, the first cell is assumed to be serving..</param>
        public C8yCellTower(string radioType = default(string), decimal mobileCountryCode = default(decimal), decimal mobileNetworkCode = default(decimal), decimal locationAreaCode = default(decimal), decimal cellId = default(decimal), decimal timingAdvance = default(decimal), decimal signalStrength = default(decimal), decimal primaryScramblingCode = default(decimal), decimal serving = default(decimal))
        {
            // to ensure "mobileCountryCode" is required (not null)
            if (mobileCountryCode == null)
            {
                throw new InvalidDataException("mobileCountryCode is a required property for C8yCellTower and cannot be null");
            }
            else
            {
            ...
            // to ensure "mobileNetworkCode" is required (not null)
            if (mobileNetworkCode == null)
            {
                throw new InvalidDataException("mobileNetworkCode is a required property for C8yCellTower and cannot be null");
            }
            else
            {
            ...
            // to ensure "locationAreaCode" is required (not null)
            if (locationAreaCode == null)
            {
                throw new InvalidDataException("locationAreaCode is a required property for C8yCellTower and cannot be null");
            }
            else
            {
            ...
            // to ensure "cellId" is required (not null)
            if (cellId == null)
            {
                throw new InvalidDataException("cellId is a required property for C8yCellTower and cannot be null");
            }
            else
            {
                this.CellId = cellId;
        ...
        /// </summary>
        /// <value>The radio type of this cell tower. Can also be put directly in root JSON element if all cellTowers have same radioType.</value>
        [DataMember(Name="radioType", EmitDefaultValue=false)]
        public string RadioType { get; set; }

        /// <summary>
        /// The Mobile Country Code (MCC).
        /// </summary>
        /// <value>The Mobile Country Code (MCC).</value>
        ...
        /// </summary>
        /// <value>The Mobile Network Code (MNC) for GSM, WCDMA and LTE. The SystemID (sid) for CDMA.</value>
        ...
        /// </summary>
        /// <value>The Location Area Code (LAC) for GSM, WCDMA and LTE. The Network ID for CDMA.</value>
        [DataMember(Name="locationAreaCode", EmitDefaultValue=true)]
        public decimal LocationAreaCode { get; set; }

        /// <summary>
        /// The Cell ID (CID) for GSM, WCDMA and LTE. The base station ID for CDMA.
        /// </summary>
        /// <value>The Cell ID (CID) for GSM, WCDMA and LTE. The base station ID for CDMA.</value>
        [DataMember(Name="cellId", EmitDefaultValue=true)]
        public decimal CellId { get; set; }

        /// <summary>
        /// The timing advance value for this cell tower when available.
        /// </summary>
        /// <value>The timing advance value for this cell tower when available.</value>
        [DataMember(Name="timingAdvance", EmitDefaultValue=false)]
        public decimal TimingAdvance { get; set; }

        /// <summary>
        /// The signal strength for this cell tower in dBm.
        /// </summary>
        /// <value>The signal strength for this cell tower in dBm.</value>
        [DataMember(Name="signalStrength", EmitDefaultValue=false)]
        public decimal SignalStrength { get; set; }

        /// <summary>
        /// The primary scrambling code for WCDMA and physical CellId for LTE.
        /// </summary>
        /// <value>The primary scrambling code for WCDMA and physical CellId for LTE.</value>
        [DataMember(Name="primaryScramblingCode", EmitDefaultValue=false)]
        ...
        /// </summary>
        /// <value>Specify with 0/1 if the cell is serving or not. If not specified, the first cell is assumed to be serving.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  RadioType: ").Append(RadioType).Append("\n");
            ...
            sb.Append("  TimingAdvance: ").Append(TimingAdvance).Append("\n");
            sb.Append("  SignalStrength: ").Append(SignalStrength).Append("\n");
            sb.Append("  PrimaryScramblingCode: ").Append(PrimaryScramblingCode).Append("\n");
        ...
        {
            return this.Equals(input as C8yCellTower);
        }

        /// <summary>
        /// Returns true if C8yCellTower instances are equal
        /// </summary>
        /// <param name="input">Instance of C8yCellTower to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(C8yCellTower input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.RadioType == input.RadioType ||
                    (this.RadioType != null &&
                    this.RadioType.Equals(input.RadioType))
                ) && 
                (
                ...
                (
                    this.TimingAdvance == input.TimingAdvance ||
                    (this.TimingAdvance != null &&
                    this.TimingAdvance.Equals(input.TimingAdvance))
                ) && 
                (
                ...
                (
                    this.PrimaryScramblingCode == input.PrimaryScramblingCode ||
                    (this.PrimaryScramblingCode != null &&
                    this.PrimaryScramblingCode.Equals(input.PrimaryScramblingCode))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.RadioType != null)
                    hashCode = hashCode * 59 + this.RadioType.GetHashCode();
