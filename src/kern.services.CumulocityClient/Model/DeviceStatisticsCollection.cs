...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DeviceStatisticsCollection")]
    public partial class DeviceStatisticsCollection : IEquatable<DeviceStatisticsCollection>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceStatisticsCollection" /> class.
        /// </summary>
        /// <param name="statistics">An array containing the tenant device statistics..</param>
        public DeviceStatisticsCollection(List<DeviceStatistics> statistics = default(List<DeviceStatistics>))
        {
        ...
        /// </summary>
        /// <value>An array containing the tenant device statistics.</value>
        ...
        {
            return this.Equals(input as DeviceStatisticsCollection);
        }

        /// <summary>
        /// Returns true if DeviceStatisticsCollection instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceStatisticsCollection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceStatisticsCollection input)
        {
            if (input == null)
            {
                return false;
