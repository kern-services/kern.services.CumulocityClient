...
namespace kern.services.CumulocityClient.Model
{
    ...
    public partial class GetApplicationsByTenantCollectionResource200Response : IEquatable<GetApplicationsByTenantCollectionResource200Response>, IValidatableObject
    {
        /// <summary>
        ...
        public GetApplicationsByTenantCollectionResource200Response(List<Application> applications = default(List<Application>), string next = default(string), string prev = default(string), string self = default(string), PageStatistics statistics = default(PageStatistics))
        {
        ...
        {
            return this.Equals(input as GetApplicationsByTenantCollectionResource200Response);
        }

        /// <summary>
        /// Returns true if GetApplicationsByTenantCollectionResource200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of GetApplicationsByTenantCollectionResource200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetApplicationsByTenantCollectionResource200Response input)
        {
            if (input == null)
            {
                return false;
