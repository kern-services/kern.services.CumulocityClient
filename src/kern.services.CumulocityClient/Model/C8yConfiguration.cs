...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "c8y_Configuration")]
    public partial class C8yConfiguration : IEquatable<C8yConfiguration>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="C8yConfiguration" /> class.
        /// </summary>
        /// <param name="config">A text in a device-specific format, representing the configuration of the device..</param>
        public C8yConfiguration(string config = default(string))
        {
            this.Config = config;
        }
        ...
        /// </summary>
        /// <value>A text in a device-specific format, representing the configuration of the device.</value>
        ...
        {
            return this.Equals(input as C8yConfiguration);
        }

        /// <summary>
        /// Returns true if C8yConfiguration instances are equal
        /// </summary>
        /// <param name="input">Instance of C8yConfiguration to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(C8yConfiguration input)
        {
            if (input == null)
            {
                return false;
