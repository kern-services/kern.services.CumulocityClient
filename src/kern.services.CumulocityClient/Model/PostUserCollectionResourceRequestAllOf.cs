...
{
    /// <summary>
    /// PostUserCollectionResourceRequestAllOf
    /// </summary>
    [DataContract(Name = "postUserCollectionResource_request_allOf")]
    public partial class PostUserCollectionResourceRequestAllOf : IEquatable<PostUserCollectionResourceRequestAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostUserCollectionResourceRequestAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public PostUserCollectionResourceRequestAllOf()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostUserCollectionResourceRequestAllOf {\n");
        ...
        {
            return this.Equals(input as PostUserCollectionResourceRequestAllOf);
        }

        /// <summary>
        /// Returns true if PostUserCollectionResourceRequestAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of PostUserCollectionResourceRequestAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostUserCollectionResourceRequestAllOf input)
        {
            if (input == null)
            {
                return false;
