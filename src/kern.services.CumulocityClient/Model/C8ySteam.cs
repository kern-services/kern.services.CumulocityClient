...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "c8y_Steam")]
    public partial class C8ySteam : IEquatable<C8ySteam>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="C8ySteam" /> class.
        /// </summary>
        /// <param name="temperature">temperature.</param>
        public C8ySteam(C8ySteamTemperature temperature = default(C8ySteamTemperature))
        {
        ...
        public C8ySteamTemperature Temperature { get; set; }
        ...
        {
            return this.Equals(input as C8ySteam);
        }

        /// <summary>
        /// Returns true if C8ySteam instances are equal
        /// </summary>
        /// <param name="input">Instance of C8ySteam to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(C8ySteam input)
        {
            if (input == null)
            {
                return false;
