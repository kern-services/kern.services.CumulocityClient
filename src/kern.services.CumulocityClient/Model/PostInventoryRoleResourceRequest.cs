...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "postInventoryRoleResource_request")]
    public partial class PostInventoryRoleResourceRequest : IEquatable<PostInventoryRoleResourceRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostInventoryRoleResourceRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostInventoryRoleResourceRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostInventoryRoleResourceRequest" /> class.
        /// </summary>
        /// <param name="description">A description for this inventory role. (required).</param>
        /// <param name="name">The name of this inventory role. (required).</param>
        /// <param name="permissions">A set of permissions for this inventory role. (required).</param>
        public PostInventoryRoleResourceRequest(string description = default(string), string name = default(string), List<InventoryRolePermission> permissions = default(List<InventoryRolePermission>))
        {
            // to ensure "description" is required (not null)
            if (description == null)
            {
                throw new ArgumentNullException("description is a required property for PostInventoryRoleResourceRequest and cannot be null");
            }
            this.Description = description;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for PostInventoryRoleResourceRequest and cannot be null");
            }
            this.Name = name;
            // to ensure "permissions" is required (not null)
            if (permissions == null)
            {
                throw new ArgumentNullException("permissions is a required property for PostInventoryRoleResourceRequest and cannot be null");
            }
        ...
        /// </summary>
        /// <value>A description for this inventory role.</value>
        ...
        /// </summary>
        /// <value>A unique identifier for this inventory role.</value>
        ...
        /// </summary>
        /// <value>The name of this inventory role.</value>
        ...
        /// </summary>
        /// <value>A set of permissions for this inventory role.</value>
        ...
        {
            return this.Equals(input as PostInventoryRoleResourceRequest);
        }

        /// <summary>
        /// Returns true if PostInventoryRoleResourceRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PostInventoryRoleResourceRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostInventoryRoleResourceRequest input)
        {
            if (input == null)
            {
                return false;
