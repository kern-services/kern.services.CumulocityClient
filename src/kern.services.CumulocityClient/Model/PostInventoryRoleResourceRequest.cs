...
namespace kern.services.CumulocityClient.Model
{
    ...
    public partial class PostInventoryRoleResourceRequest : IValidatableObject
    {
        /// <summary>
        ...
        /// <example>Can restart devices.</example>
        ...
        /// <example>Operations: Restart Device</example>
        ...
        /// <example>https://&lt;TENANT_DOMAIN&gt;/user/inventoryroles/4</example>
