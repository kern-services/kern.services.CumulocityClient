...
namespace kern.services.CumulocityClient.Model
{
    ...
    public partial class PostInventoryRoleResourceRequest :  IEquatable<PostInventoryRoleResourceRequest>, IValidatableObject
    {
        ...
        public PostInventoryRoleResourceRequest(string description = default(string), string name = default(string), List<InventoryRolePermission> permissions = default(List<InventoryRolePermission>))
        {
            ...
            if (description == null)
            {
                throw new InvalidDataException("description is a required property for PostInventoryRoleResourceRequest and cannot be null");
            }
            else
            {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for PostInventoryRoleResourceRequest and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (permissions == null)
            {
                throw new InvalidDataException("permissions is a required property for PostInventoryRoleResourceRequest and cannot be null");
            }
            else
            {
