...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "application_owner_tenant")]
    public partial class ApplicationOwnerTenant : IEquatable<ApplicationOwnerTenant>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationOwnerTenant" /> class.
        /// </summary>
        /// <param name="id">The tenant ID..</param>
        public ApplicationOwnerTenant(string id = default(string))
        {
            this.Id = id;
        }
        ...
        {
            return this.Equals(input as ApplicationOwnerTenant);
        }

        /// <summary>
        /// Returns true if ApplicationOwnerTenant instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationOwnerTenant to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationOwnerTenant input)
        {
            if (input == null)
            {
                return false;
