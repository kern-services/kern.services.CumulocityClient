...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "authConfig_authorizationRequest")]
    public partial class AuthConfigAuthorizationRequest : IEquatable<AuthConfigAuthorizationRequest>, IValidatableObject
    {
        /// <summary>
        /// HTTP request method.
        /// </summary>
        ...
        /// Requested operation.
        /// </summary>
        /// <value>Requested operation.</value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthConfigAuthorizationRequest" /> class.
        /// </summary>
        ...
        /// <param name="url">Target of the request described as a URL..</param>
        public AuthConfigAuthorizationRequest(string body = default(string), Dictionary<string, string> headers = default(Dictionary<string, string>), MethodEnum? method = default(MethodEnum?), OperationEnum? operation = default(OperationEnum?), Dictionary<string, string> requestParams = default(Dictionary<string, string>), string url = default(string))
        {
            this.Body = body;
        ...
        /// Body of the request.
        /// </summary>
        /// <value>Body of the request.</value>
        ...
        /// </summary>
        /// <value>Headers of the request.</value>
        ...
        /// </summary>
        /// <value>Parameters of the request.</value>
        [DataMember(Name = "requestParams", EmitDefaultValue = false)]
        public Dictionary<string, string> RequestParams { get; set; }

        /// <summary>
        /// Target of the request described as a URL.
        /// </summary>
        /// <value>Target of the request described as a URL.</value>
        ...
        {
            return this.Equals(input as AuthConfigAuthorizationRequest);
        }

        /// <summary>
        /// Returns true if AuthConfigAuthorizationRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthConfigAuthorizationRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthConfigAuthorizationRequest input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    ...
                    input.RequestParams != null &&
                    this.RequestParams.SequenceEqual(input.RequestParams)
                ) && 
                (
                    this.Url == input.Url ||
                    (this.Url != null &&
