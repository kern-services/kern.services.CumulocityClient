...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AuthConfig :  IEquatable<AuthConfig>, IValidatableObject
    {
        /// <summary>
        ...
        public AuthConfig(AuthConfigAccessTokenToUserDataMapping accessTokenToUserDataMapping = default(AuthConfigAccessTokenToUserDataMapping), string audience = default(string), AuthConfigAuthorizationRequest authorizationRequest = default(AuthConfigAuthorizationRequest), BasicAuthenticationRestrictions authenticationRestrictions = default(BasicAuthenticationRestrictions), string buttonName = default(string), string clientId = default(string), GrantTypeEnum? grantType = default(GrantTypeEnum?), string id = default(string), string issuer = default(string), AuthConfigLogoutRequest logoutRequest = default(AuthConfigLogoutRequest), bool onlyManagementTenantAccess = default(bool), AuthConfigOnNewUser onNewUser = default(AuthConfigOnNewUser), string providerName = default(string), string redirectToPlatform = default(string), AuthConfigRefreshRequest refreshRequest = default(AuthConfigRefreshRequest), OAuthSessionConfiguration sessionConfiguration = default(OAuthSessionConfiguration), AuthConfigSignatureVerificationConfig signatureVerificationConfig = default(AuthConfigSignatureVerificationConfig), string template = default(string), AuthConfigTokenRequest tokenRequest = default(AuthConfigTokenRequest), TypeEnum type = default(TypeEnum), AuthConfigUserIdConfig userIdConfig = default(AuthConfigUserIdConfig), UserManagementSourceEnum? userManagementSource = default(UserManagementSourceEnum?), bool visibleOnLoginPage = default(bool))
        {
            ...
            {
                throw new InvalidDataException("providerName is a required property for AuthConfig and cannot be null");
            }
            else
            {
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for AuthConfig and cannot be null");
            }
            else
            {
                this.Type = type;
        ...
        [DataMember(Name="onlyManagementTenantAccess", EmitDefaultValue=false)]
        ...
        public bool Equals(AuthConfig input)
        {
            ...
            return 
                (
                    this.AccessTokenToUserDataMapping == input.AccessTokenToUserDataMapping ||
                    (this.AccessTokenToUserDataMapping != null &&
                    this.AccessTokenToUserDataMapping.Equals(input.AccessTokenToUserDataMapping))
                ) && 
                (
                ...
                (
                    this.AuthorizationRequest == input.AuthorizationRequest ||
                    (this.AuthorizationRequest != null &&
                    this.AuthorizationRequest.Equals(input.AuthorizationRequest))
                ) && 
                (
                ...
                (
                    ...
                    this.ButtonName.Equals(input.ButtonName))
                ) && 
                (
                ...
                (
                    this.LogoutRequest == input.LogoutRequest ||
                    (this.LogoutRequest != null &&
                    this.LogoutRequest.Equals(input.LogoutRequest))
                ) && 
                (
                    this.OnlyManagementTenantAccess == input.OnlyManagementTenantAccess ||
                    (this.OnlyManagementTenantAccess != null &&
                    this.OnlyManagementTenantAccess.Equals(input.OnlyManagementTenantAccess))
                ) && 
                (
                    this.OnNewUser == input.OnNewUser ||
                    (this.OnNewUser != null &&
                    this.OnNewUser.Equals(input.OnNewUser))
                ) && 
                (
                ...
                (
                    this.RedirectToPlatform == input.RedirectToPlatform ||
                    (this.RedirectToPlatform != null &&
                    this.RedirectToPlatform.Equals(input.RedirectToPlatform))
                ) && 
                (
                    this.RefreshRequest == input.RefreshRequest ||
                    (this.RefreshRequest != null &&
                    this.RefreshRequest.Equals(input.RefreshRequest))
                ) && 
                (
                ...
                (
                    this.SignatureVerificationConfig == input.SignatureVerificationConfig ||
                    (this.SignatureVerificationConfig != null &&
                    this.SignatureVerificationConfig.Equals(input.SignatureVerificationConfig))
                ) && 
                (
                ...
                (
                    this.TokenRequest == input.TokenRequest ||
                    (this.TokenRequest != null &&
                    this.TokenRequest.Equals(input.TokenRequest))
                ) && 
                (
                ...
                (
                    this.UserIdConfig == input.UserIdConfig ||
                    (this.UserIdConfig != null &&
                    this.UserIdConfig.Equals(input.UserIdConfig))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.AccessTokenToUserDataMapping != null)
                    hashCode = hashCode * 59 + this.AccessTokenToUserDataMapping.GetHashCode();
                if (this.Audience != null)
                    hashCode = hashCode * 59 + this.Audience.GetHashCode();
                if (this.AuthorizationRequest != null)
                    hashCode = hashCode * 59 + this.AuthorizationRequest.GetHashCode();
                ...
                if (this.ButtonName != null)
                    hashCode = hashCode * 59 + this.ButtonName.GetHashCode();
                ...
                if (this.LogoutRequest != null)
                    hashCode = hashCode * 59 + this.LogoutRequest.GetHashCode();
                if (this.OnlyManagementTenantAccess != null)
                    hashCode = hashCode * 59 + this.OnlyManagementTenantAccess.GetHashCode();
                if (this.OnNewUser != null)
                    hashCode = hashCode * 59 + this.OnNewUser.GetHashCode();
                if (this.ProviderName != null)
                    hashCode = hashCode * 59 + this.ProviderName.GetHashCode();
                if (this.RedirectToPlatform != null)
                    hashCode = hashCode * 59 + this.RedirectToPlatform.GetHashCode();
                if (this.RefreshRequest != null)
                    hashCode = hashCode * 59 + this.RefreshRequest.GetHashCode();
                if (this.Self != null)
                    hashCode = hashCode * 59 + this.Self.GetHashCode();
                if (this.SessionConfiguration != null)
                    hashCode = hashCode * 59 + this.SessionConfiguration.GetHashCode();
                if (this.SignatureVerificationConfig != null)
                    hashCode = hashCode * 59 + this.SignatureVerificationConfig.GetHashCode();
                if (this.Template != null)
                    hashCode = hashCode * 59 + this.Template.GetHashCode();
                if (this.TokenRequest != null)
                    hashCode = hashCode * 59 + this.TokenRequest.GetHashCode();
                if (this.Type != null)
                    hashCode = hashCode * 59 + this.Type.GetHashCode();
                if (this.UserIdConfig != null)
                    hashCode = hashCode * 59 + this.UserIdConfig.GetHashCode();
