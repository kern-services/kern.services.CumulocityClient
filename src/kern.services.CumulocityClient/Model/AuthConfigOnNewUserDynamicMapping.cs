...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "authConfig_onNewUser_dynamicMapping")]
    public partial class AuthConfigOnNewUserDynamicMapping : IEquatable<AuthConfigOnNewUserDynamicMapping>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthConfigOnNewUserDynamicMapping" /> class.
        /// </summary>
        /// <param name="configuration">configuration.</param>
        /// <param name="mappings">Represents rules used to assign groups and applications..</param>
        public AuthConfigOnNewUserDynamicMapping(AuthConfigOnNewUserDynamicMappingConfiguration configuration = default(AuthConfigOnNewUserDynamicMappingConfiguration), List<AuthConfigOnNewUserDynamicMappingMappingsInner> mappings = default(List<AuthConfigOnNewUserDynamicMappingMappingsInner>))
        {
        ...
        public AuthConfigOnNewUserDynamicMappingConfiguration _Configuration { get; set; }

        /// <summary>
        /// Represents rules used to assign groups and applications.
        /// </summary>
        /// <value>Represents rules used to assign groups and applications.</value>
        [DataMember(Name = "mappings", EmitDefaultValue = false)]
        public List<AuthConfigOnNewUserDynamicMappingMappingsInner> Mappings { get; set; }
        ...
        {
            return this.Equals(input as AuthConfigOnNewUserDynamicMapping);
        }

        /// <summary>
        /// Returns true if AuthConfigOnNewUserDynamicMapping instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthConfigOnNewUserDynamicMapping to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthConfigOnNewUserDynamicMapping input)
        {
            if (input == null)
            {
                return false;
