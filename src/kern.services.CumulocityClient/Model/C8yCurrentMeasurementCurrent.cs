...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "c8y_CurrentMeasurement_current")]
    public partial class C8yCurrentMeasurementCurrent : IEquatable<C8yCurrentMeasurementCurrent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="C8yCurrentMeasurementCurrent" /> class.
        /// </summary>
        /// <param name="value">value.</param>
        /// <param name="unit">unit.</param>
        public C8yCurrentMeasurementCurrent(decimal value = default(decimal), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        {
            return this.Equals(input as C8yCurrentMeasurementCurrent);
        }

        /// <summary>
        /// Returns true if C8yCurrentMeasurementCurrent instances are equal
        /// </summary>
        /// <param name="input">Instance of C8yCurrentMeasurementCurrent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(C8yCurrentMeasurementCurrent input)
        {
            if (input == null)
            {
                return false;
