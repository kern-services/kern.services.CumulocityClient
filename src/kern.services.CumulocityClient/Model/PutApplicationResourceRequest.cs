...
namespace kern.services.CumulocityClient.Model
{
    ...
    public partial class PutApplicationResourceRequest : IValidatableObject
    {
        /// <summary>
        ...
        /// <example>/apps/public/public-options/options.json</example>
