...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PutApplicationResourceRequest :  IEquatable<PutApplicationResourceRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PutApplicationResourceRequest" /> class.
        /// </summary>
        ...
        /// <param name="key">Applications, regardless of their form, are identified by an application key..</param>
        ...
        public PutApplicationResourceRequest(AvailabilityEnum? availability = AvailabilityEnum.PRIVATE, string contextPath = default(string), string description = default(string), string key = default(string), string name = default(string), ApplicationOwner owner = default(ApplicationOwner), ApplicationManifest manifest = default(ApplicationManifest), List<string> roles = default(List<string>), List<string> requiredRoles = default(List<string>), bool breadcrumbs = default(bool), string contentSecurityPolicy = default(string), string dynamicOptionsUrl = default(string), string globalTitle = default(string), bool legacy = default(bool), bool rightDrawer = default(bool), bool upgrade = default(bool))
        {
            // use default value if no "availability" provided
            if (availability == null)
            {
                this.Availability = AvailabilityEnum.PRIVATE;
            }
            else
            {
        ...
        [DataMember(Name="rightDrawer", EmitDefaultValue=false)]
        ...
        {
            return this.Equals(input as PutApplicationResourceRequest);
        }

        /// <summary>
        /// Returns true if PutApplicationResourceRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PutApplicationResourceRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PutApplicationResourceRequest input)
        {
            if (input == null)
                return false;
