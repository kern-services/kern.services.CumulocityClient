...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "tenantApiResource_tenants")]
    public partial class TenantApiResourceTenants : IEquatable<TenantApiResourceTenants>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TenantApiResourceTenants" /> class.
        /// </summary>
        /// <param name="tenants">tenants.</param>
        public TenantApiResourceTenants(List<Tenant> tenants = default(List<Tenant>))
        {
        ...
        {
            return this.Equals(input as TenantApiResourceTenants);
        }

        /// <summary>
        /// Returns true if TenantApiResourceTenants instances are equal
        /// </summary>
        /// <param name="input">Instance of TenantApiResourceTenants to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TenantApiResourceTenants input)
        {
            if (input == null)
            {
                return false;
