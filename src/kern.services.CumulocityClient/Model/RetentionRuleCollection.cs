...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RetentionRuleCollection")]
    public partial class RetentionRuleCollection : IEquatable<RetentionRuleCollection>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RetentionRuleCollection" /> class.
        /// </summary>
        /// <param name="retentionRules">An array containing the results (retention rules) of the request..</param>
        /// <param name="statistics">statistics.</param>
        public RetentionRuleCollection(List<RetentionRule> retentionRules = default(List<RetentionRule>), PageStatistics statistics = default(PageStatistics))
        {
        ...
        /// </summary>
        /// <value>An array containing the results (retention rules) of the request.</value>
        ...
        {
            return this.Equals(input as RetentionRuleCollection);
        }

        /// <summary>
        /// Returns true if RetentionRuleCollection instances are equal
        /// </summary>
        /// <param name="input">Instance of RetentionRuleCollection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RetentionRuleCollection input)
        {
            if (input == null)
            {
                return false;
