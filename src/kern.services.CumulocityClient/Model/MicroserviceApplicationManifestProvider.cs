...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "microservice_application_manifest_provider")]
    public partial class MicroserviceApplicationManifestProvider : IEquatable<MicroserviceApplicationManifestProvider>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MicroserviceApplicationManifestProvider" /> class.
        /// </summary>
        /// <param name="name">The name of the application provider..</param>
        public MicroserviceApplicationManifestProvider(string name = default(string))
        {
            this.Name = name;
        }
        ...
        /// </summary>
        /// <value>The name of the application provider.</value>
        ...
        {
            return this.Equals(input as MicroserviceApplicationManifestProvider);
        }

        /// <summary>
        /// Returns true if MicroserviceApplicationManifestProvider instances are equal
        /// </summary>
        /// <param name="input">Instance of MicroserviceApplicationManifestProvider to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MicroserviceApplicationManifestProvider input)
        {
            if (input == null)
            {
                return false;
