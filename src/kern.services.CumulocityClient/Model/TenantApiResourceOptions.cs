...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "tenantApiResource_options")]
    public partial class TenantApiResourceOptions : IEquatable<TenantApiResourceOptions>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TenantApiResourceOptions" /> class.
        /// </summary>
        /// <param name="options">options.</param>
        public TenantApiResourceOptions(List<Option> options = default(List<Option>))
        {
        ...
        {
            return this.Equals(input as TenantApiResourceOptions);
        }

        /// <summary>
        /// Returns true if TenantApiResourceOptions instances are equal
        /// </summary>
        /// <param name="input">Instance of TenantApiResourceOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TenantApiResourceOptions input)
        {
            if (input == null)
            {
                return false;
