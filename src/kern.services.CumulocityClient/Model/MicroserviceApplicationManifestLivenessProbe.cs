...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "microservice_application_manifest_livenessProbe")]
    public partial class MicroserviceApplicationManifestLivenessProbe : IEquatable<MicroserviceApplicationManifestLivenessProbe>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MicroserviceApplicationManifestLivenessProbe" /> class.
        /// </summary>
        ...
        public MicroserviceApplicationManifestLivenessProbe(int failureThreshold = default(int), int periodSeconds = default(int), int timeoutSeconds = default(int), int successThreshold = default(int), int initialDelaySeconds = default(int), ApplicationManifestProbeHttpGet httpGet = default(ApplicationManifestProbeHttpGet))
        {
        ...
        {
            return this.Equals(input as MicroserviceApplicationManifestLivenessProbe);
        }

        /// <summary>
        /// Returns true if MicroserviceApplicationManifestLivenessProbe instances are equal
        /// </summary>
        /// <param name="input">Instance of MicroserviceApplicationManifestLivenessProbe to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MicroserviceApplicationManifestLivenessProbe input)
        {
            if (input == null)
            {
                return false;
