...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "tenant_applications")]
    public partial class TenantApplications : IEquatable<TenantApplications>, IValidatableObject
    {
        /// <summary>
        ...
        public TenantApplications(List<Application> references = default(List<Application>))
        {
        ...
        {
            return this.Equals(input as TenantApplications);
        }

        /// <summary>
        /// Returns true if TenantApplications instances are equal
        /// </summary>
        /// <param name="input">Instance of TenantApplications to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TenantApplications input)
        {
            if (input == null)
            {
                return false;
