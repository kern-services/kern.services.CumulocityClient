...
namespace kern.services.CumulocityClient.Model
{
    ...
    public partial class GetApplicationsByOwnerCollectionResource200Response : IEquatable<GetApplicationsByOwnerCollectionResource200Response>, IValidatableObject
    {
        /// <summary>
        ...
        public GetApplicationsByOwnerCollectionResource200Response(List<Application> applications = default(List<Application>), string next = default(string), string prev = default(string), string self = default(string), PageStatistics statistics = default(PageStatistics))
        {
        ...
        {
            return this.Equals(input as GetApplicationsByOwnerCollectionResource200Response);
        }

        /// <summary>
        /// Returns true if GetApplicationsByOwnerCollectionResource200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of GetApplicationsByOwnerCollectionResource200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetApplicationsByOwnerCollectionResource200Response input)
        {
            if (input == null)
            {
                return false;
