...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "postAlarmCollectionResource_request_allOf_source")]
    public partial class PostAlarmCollectionResourceRequestAllOfSource : IEquatable<PostAlarmCollectionResourceRequestAllOfSource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostAlarmCollectionResourceRequestAllOfSource" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public PostAlarmCollectionResourceRequestAllOfSource()
        {
        }
        ...
        {
            return this.Equals(input as PostAlarmCollectionResourceRequestAllOfSource);
        }

        /// <summary>
        /// Returns true if PostAlarmCollectionResourceRequestAllOfSource instances are equal
        /// </summary>
        /// <param name="input">Instance of PostAlarmCollectionResourceRequestAllOfSource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostAlarmCollectionResourceRequestAllOfSource input)
        {
            if (input == null)
            {
                return false;
