...
{
    /// <summary>
    /// PutApplicationResourceRequestAllOf
    /// </summary>
    [DataContract(Name = "putApplicationResource_request_allOf")]
    public partial class PutApplicationResourceRequestAllOf : IEquatable<PutApplicationResourceRequestAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PutApplicationResourceRequestAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public PutApplicationResourceRequestAllOf()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PutApplicationResourceRequestAllOf {\n");
        ...
        {
            return this.Equals(input as PutApplicationResourceRequestAllOf);
        }

        /// <summary>
        /// Returns true if PutApplicationResourceRequestAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of PutApplicationResourceRequestAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PutApplicationResourceRequestAllOf input)
        {
            if (input == null)
            {
                return false;
