...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "managedObjectReferenceTuple_managedObject")]
    public partial class ManagedObjectReferenceTupleManagedObject : IEquatable<ManagedObjectReferenceTupleManagedObject>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ManagedObjectReferenceTupleManagedObject" /> class.
        /// </summary>
        ...
        public ManagedObjectReferenceTupleManagedObject(string id = default(string), string name = default(string))
        {
            this.Id = id;
            this.Name = name;
        }
        ...
        {
            return this.Equals(input as ManagedObjectReferenceTupleManagedObject);
        }

        /// <summary>
        /// Returns true if ManagedObjectReferenceTupleManagedObject instances are equal
        /// </summary>
        /// <param name="input">Instance of ManagedObjectReferenceTupleManagedObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ManagedObjectReferenceTupleManagedObject input)
        {
            if (input == null)
            {
                return false;
