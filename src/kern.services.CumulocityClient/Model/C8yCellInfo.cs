...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "c8y_CellInfo")]
    public partial class C8yCellInfo : IEquatable<C8yCellInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="C8yCellInfo" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected C8yCellInfo() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="C8yCellInfo" /> class.
        /// </summary>
        /// <param name="radioType">The radio type of this cell tower..</param>
        /// <param name="cellTowers">Detailed information about the neighboring cell towers. (required).</param>
        public C8yCellInfo(string radioType = default(string), List<C8yCellTower> cellTowers = default(List<C8yCellTower>))
        {
            // to ensure "cellTowers" is required (not null)
            if (cellTowers == null)
            {
                throw new ArgumentNullException("cellTowers is a required property for C8yCellInfo and cannot be null");
            }
        ...
        /// </summary>
        /// <value>The radio type of this cell tower.</value>
        ...
        /// </summary>
        /// <value>Detailed information about the neighboring cell towers.</value>
        [DataMember(Name = "cellTowers", IsRequired = true, EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CellTowers: ").Append(CellTowers).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as C8yCellInfo);
        }

        /// <summary>
        /// Returns true if C8yCellInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of C8yCellInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(C8yCellInfo input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.CellTowers == input.CellTowers ||
                    this.CellTowers != null &&
                    input.CellTowers != null &&
                    this.CellTowers.SequenceEqual(input.CellTowers)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.CellTowers.GetHashCode();
                }
                return hashCode;
            }
        }
