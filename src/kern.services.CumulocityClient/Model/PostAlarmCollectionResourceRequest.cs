...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "postAlarmCollectionResource_request")]
    public partial class PostAlarmCollectionResourceRequest : IEquatable<PostAlarmCollectionResourceRequest>, IValidatableObject
    {
        ...
        public PostAlarmCollectionResourceRequest(SeverityEnum severity = default(SeverityEnum), PostAlarmCollectionResourceRequestAllOfSource source = default(PostAlarmCollectionResourceRequestAllOfSource), StatusEnum? status = default(StatusEnum?), string text = default(string), DateTime time = default(DateTime), string type = default(string))
        {
            ...
            if (source == null)
            {
                throw new ArgumentNullException("source is a required property for PostAlarmCollectionResourceRequest and cannot be null");
            }
            this.Source = source;
            // to ensure "text" is required (not null)
            if (text == null)
            {
                throw new ArgumentNullException("text is a required property for PostAlarmCollectionResourceRequest and cannot be null");
            }
            this.Text = text;
            this.Time = time;
            ...
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for PostAlarmCollectionResourceRequest and cannot be null");
            }
            this.Type = type;
            this.Status = status;
        }
        ...
        /// <summary>
        /// Returns false as FirstOccurrenceTime should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeFirstOccurrenceTime()
        {
            return false;
        }
        /// <summary>
