...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PostAlarmCollectionResourceRequest :  IEquatable<PostAlarmCollectionResourceRequest>, IValidatableObject
    {
        /// <summary>
        /// The severity of the alarm.
        /// </summary>
        /// <value>The severity of the alarm.</value>
        ...
        /// </summary>
        /// <value>The status of the alarm. If not specified, a new alarm will be created as ACTIVE.</value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostAlarmCollectionResourceRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostAlarmCollectionResourceRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostAlarmCollectionResourceRequest" /> class.
        /// </summary>
        /// <param name="severity">The severity of the alarm. (required).</param>
        /// <param name="source">source (required).</param>
        /// <param name="status">The status of the alarm. If not specified, a new alarm will be created as ACTIVE..</param>
        /// <param name="text">Description of the alarm. (required).</param>
        /// <param name="time">The date and time when the alarm is triggered. (required).</param>
        /// <param name="type">Identifies the type of this alarm. (required).</param>
        public PostAlarmCollectionResourceRequest(SeverityEnum severity = default(SeverityEnum), PostAlarmCollectionResourceRequestAllOfSource source = default(PostAlarmCollectionResourceRequestAllOfSource), StatusEnum? status = default(StatusEnum?), string text = default(string), DateTime time = default(DateTime), string type = default(string))
        {
            // to ensure "severity" is required (not null)
            if (severity == null)
            {
                throw new InvalidDataException("severity is a required property for PostAlarmCollectionResourceRequest and cannot be null");
            }
            else
            {
            ...
            if (source == null)
            {
                throw new InvalidDataException("source is a required property for PostAlarmCollectionResourceRequest and cannot be null");
            }
            else
            {
                this.Source = source;
            ...
            if (text == null)
            {
                throw new InvalidDataException("text is a required property for PostAlarmCollectionResourceRequest and cannot be null");
            }
            else
            {
                this.Text = text;
            ...
            if (time == null)
            {
                throw new InvalidDataException("time is a required property for PostAlarmCollectionResourceRequest and cannot be null");
            }
            else
            {
                this.Time = time;
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for PostAlarmCollectionResourceRequest and cannot be null");
            }
            else
            {
                this.Type = type;
        ...
        /// </summary>
        /// <value>Number of times that this alarm has been triggered.</value>
        ...
        /// </summary>
        /// <value>The date and time when the alarm was created.</value>
        ...
        /// </summary>
        /// <value>The time at which the alarm occurred for the first time. Only present when &#x60;count&#x60; is greater than 1.</value>
        [DataMember(Name="firstOccurrenceTime", EmitDefaultValue=false)]
        public DateTime FirstOccurrenceTime { get; private set; }

        /// <summary>
        /// Unique identifier of the alarm.
        /// </summary>
        /// <value>Unique identifier of the alarm.</value>
        ...
        /// </summary>
        /// <value>The date and time when the alarm was last updated.</value>
        ...
        public PostAlarmCollectionResourceRequestAllOfSource Source { get; set; }
        ...
        /// </summary>
        /// <value>The date and time when the alarm is triggered.</value>
        ...
        /// </summary>
        /// <value>Identifies the type of this alarm.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  FirstOccurrenceTime: ").Append(FirstOccurrenceTime).Append("\n");
        ...
        {
            return this.Equals(input as PostAlarmCollectionResourceRequest);
        }

        /// <summary>
        /// Returns true if PostAlarmCollectionResourceRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PostAlarmCollectionResourceRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostAlarmCollectionResourceRequest input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.FirstOccurrenceTime == input.FirstOccurrenceTime ||
                    (this.FirstOccurrenceTime != null &&
                    this.FirstOccurrenceTime.Equals(input.FirstOccurrenceTime))
                ) && 
                (
                    this.Id == input.Id ||
                    (this.Id != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.FirstOccurrenceTime != null)
                    hashCode = hashCode * 59 + this.FirstOccurrenceTime.GetHashCode();
                if (this.Id != null)
