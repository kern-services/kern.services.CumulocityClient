...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ApplicationReference")]
    public partial class ApplicationReference : IEquatable<ApplicationReference>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationReference" /> class.
        /// </summary>
        /// <param name="application">application.</param>
        public ApplicationReference(Application application = default(Application))
        {
        ...
        {
            return this.Equals(input as ApplicationReference);
        }

        /// <summary>
        /// Returns true if ApplicationReference instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationReference to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationReference input)
        {
            if (input == null)
            {
                return false;
