...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "c8y_Network_c8y_LAN")]
    public partial class C8yNetworkC8yLAN : IEquatable<C8yNetworkC8yLAN>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="C8yNetworkC8yLAN" /> class.
        /// </summary>
        /// <param name="netmask">Subnet mask configured for the network interface..</param>
        /// <param name="ip">IP address configured for the network interface..</param>
        /// <param name="name">Identifier for the network interface..</param>
        /// <param name="enabled">Indicator showing if the interface is enabled..</param>
        /// <param name="mac">MAC address of the network interface..</param>
        public C8yNetworkC8yLAN(string netmask = default(string), string ip = default(string), string name = default(string), int enabled = default(int), string mac = default(string))
        {
        ...
        /// </summary>
        /// <value>Subnet mask configured for the network interface.</value>
        ...
        /// </summary>
        /// <value>IP address configured for the network interface.</value>
        ...
        /// </summary>
        /// <value>Identifier for the network interface.</value>
        ...
        /// </summary>
        /// <value>Indicator showing if the interface is enabled.</value>
        ...
        /// </summary>
        /// <value>MAC address of the network interface.</value>
        ...
        {
            return this.Equals(input as C8yNetworkC8yLAN);
        }

        /// <summary>
        /// Returns true if C8yNetworkC8yLAN instances are equal
        /// </summary>
        /// <param name="input">Instance of C8yNetworkC8yLAN to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(C8yNetworkC8yLAN input)
        {
            if (input == null)
            {
                return false;
