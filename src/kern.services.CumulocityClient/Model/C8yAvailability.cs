...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "c8y_Availability")]
    public partial class C8yAvailability : IEquatable<C8yAvailability>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="C8yAvailability" /> class.
        /// </summary>
        /// <param name="status">status.</param>
        /// <param name="lastMessage">The time when the device sent the last message to Cumulocity IoT..</param>
        public C8yAvailability(C8yAvailabilityStatus? status = default(C8yAvailabilityStatus?), DateTime lastMessage = default(DateTime))
        {
            this.Status = status;
        ...
        /// </summary>
        /// <value>The time when the device sent the last message to Cumulocity IoT.</value>
        ...
        {
            return this.Equals(input as C8yAvailability);
        }

        /// <summary>
        /// Returns true if C8yAvailability instances are equal
        /// </summary>
        /// <param name="input">Instance of C8yAvailability to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(C8yAvailability input)
        {
            if (input == null)
            {
                return false;
