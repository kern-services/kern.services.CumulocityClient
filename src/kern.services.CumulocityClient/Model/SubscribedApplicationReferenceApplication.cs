...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SubscribedApplicationReference_application")]
    public partial class SubscribedApplicationReferenceApplication : IEquatable<SubscribedApplicationReferenceApplication>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscribedApplicationReferenceApplication" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SubscribedApplicationReferenceApplication() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscribedApplicationReferenceApplication" /> class.
        /// </summary>
        /// <param name="self">A URL linking to this resource. (required).</param>
        public SubscribedApplicationReferenceApplication(string self = default(string))
        {
            // to ensure "self" is required (not null)
            if (self == null)
            {
                throw new ArgumentNullException("self is a required property for SubscribedApplicationReferenceApplication and cannot be null");
            }
            this.Self = self;
        }
        ...
        {
            return this.Equals(input as SubscribedApplicationReferenceApplication);
        }

        /// <summary>
        /// Returns true if SubscribedApplicationReferenceApplication instances are equal
        /// </summary>
        /// <param name="input">Instance of SubscribedApplicationReferenceApplication to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubscribedApplicationReferenceApplication input)
        {
            if (input == null)
            {
                return false;
