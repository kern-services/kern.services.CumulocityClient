...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ApplicationVersionTag")]
    public partial class ApplicationVersionTag : IEquatable<ApplicationVersionTag>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationVersionTag" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ApplicationVersionTag() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationVersionTag" /> class.
        /// </summary>
        /// <param name="tag">Tag assigned to the version. Version tags must be unique across all versions and version fields of application versions. (required).</param>
        public ApplicationVersionTag(List<string> tag = default(List<string>))
        {
            // to ensure "tag" is required (not null)
            if (tag == null)
            {
                throw new ArgumentNullException("tag is a required property for ApplicationVersionTag and cannot be null");
            }
            this.Tag = tag;
        }
        ...
        /// </summary>
        /// <value>Tag assigned to the version. Version tags must be unique across all versions and version fields of application versions.</value>
        ...
        {
            return this.Equals(input as ApplicationVersionTag);
        }

        /// <summary>
        /// Returns true if ApplicationVersionTag instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationVersionTag to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationVersionTag input)
        {
            if (input == null)
            {
                return false;
