...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "c8y_Agent")]
    public partial class C8yAgent : IEquatable<C8yAgent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="C8yAgent" /> class.
        /// </summary>
        ...
        /// Initializes a new instance of the <see cref="C8yAgent" /> class.
        /// </summary>
        /// <param name="name">The name of the agent. (required).</param>
        /// <param name="version">The version of the agent. (required).</param>
        /// <param name="url">The URL of the agent, for example, its code repository..</param>
        public C8yAgent(string name = default(string), string version = default(string), string url = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for C8yAgent and cannot be null");
            }
            this.Name = name;
            // to ensure "version" is required (not null)
            if (version == null)
            {
                throw new ArgumentNullException("version is a required property for C8yAgent and cannot be null");
            }
        ...
        /// </summary>
        /// <value>The URL of the agent, for example, its code repository.</value>
        ...
        {
            return this.Equals(input as C8yAgent);
        }

        /// <summary>
        /// Returns true if C8yAgent instances are equal
        /// </summary>
        /// <param name="input">Instance of C8yAgent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(C8yAgent input)
        {
            if (input == null)
            {
                return false;
