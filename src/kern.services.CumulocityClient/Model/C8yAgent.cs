...
namespace kern.services.CumulocityClient.Model
{
    ...
    public partial class C8yAgent :  IEquatable<C8yAgent>, IValidatableObject
    {
        ...
        public C8yAgent(string name = default(string), string version = default(string), string url = default(string))
        {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for C8yAgent and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (version == null)
            {
                throw new InvalidDataException("version is a required property for C8yAgent and cannot be null");
            }
            else
            {
