...
namespace kern.services.CumulocityClient.Model
{
    ...
    public partial class C8yAgent : IValidatableObject
    {
        /// <summary>
        ...
        public C8yAgent(string name = default(string), string varVersion = default(string), string url = default(string))
        {
            ...
            if (varVersion == null)
            {
                throw new ArgumentNullException("varVersion is a required property for C8yAgent and cannot be null");
            }
