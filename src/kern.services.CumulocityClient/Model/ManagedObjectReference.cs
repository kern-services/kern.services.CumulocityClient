...
namespace kern.services.CumulocityClient.Model
{
    ...
    public partial class ManagedObjectReference : IEquatable<ManagedObjectReference>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ManagedObjectReference" /> class.
        /// </summary>
        /// <param name="managedObject">managedObject.</param>
        public ManagedObjectReference(ManagedObject managedObject = default(ManagedObject))
        {
        ...
        {
            return this.Equals(input as ManagedObjectReference);
        }

        /// <summary>
        /// Returns true if ManagedObjectReference instances are equal
        /// </summary>
        /// <param name="input">Instance of ManagedObjectReference to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ManagedObjectReference input)
        {
            if (input == null)
            {
                return false;
