...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OAuthSessionConfiguration :  IEquatable<OAuthSessionConfiguration>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OAuthSessionConfiguration" /> class.
        /// </summary>
        /// <param name="absoluteTimeoutMillis">Maximum session duration (in milliseconds) during which a user does not have to login again..</param>
        /// <param name="maximumNumberOfParallelSessions">Maximum number of parallel sessions for one user..</param>
        /// <param name="renewalTimeoutMillis">Amount of time before a token expires (in milliseconds) during which the token may be renewed..</param>
        /// <param name="userAgentValidationRequired">Switch to turn additional user agent verification on or off during the session..</param>
        public OAuthSessionConfiguration(int absoluteTimeoutMillis = default(int), int maximumNumberOfParallelSessions = default(int), int renewalTimeoutMillis = default(int), bool userAgentValidationRequired = default(bool))
        {
        ...
        /// </summary>
        /// <value>Maximum session duration (in milliseconds) during which a user does not have to login again.</value>
        [DataMember(Name="absoluteTimeoutMillis", EmitDefaultValue=false)]
        public int AbsoluteTimeoutMillis { get; set; }

        /// <summary>
        /// Maximum number of parallel sessions for one user.
        /// </summary>
        /// <value>Maximum number of parallel sessions for one user.</value>
        [DataMember(Name="maximumNumberOfParallelSessions", EmitDefaultValue=false)]
        ...
        /// </summary>
        /// <value>Amount of time before a token expires (in milliseconds) during which the token may be renewed.</value>
        [DataMember(Name="renewalTimeoutMillis", EmitDefaultValue=false)]
        public int RenewalTimeoutMillis { get; set; }

        /// <summary>
        /// Switch to turn additional user agent verification on or off during the session.
        /// </summary>
        /// <value>Switch to turn additional user agent verification on or off during the session.</value>
        [DataMember(Name="userAgentValidationRequired", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AbsoluteTimeoutMillis: ").Append(AbsoluteTimeoutMillis).Append("\n");
            sb.Append("  MaximumNumberOfParallelSessions: ").Append(MaximumNumberOfParallelSessions).Append("\n");
            sb.Append("  RenewalTimeoutMillis: ").Append(RenewalTimeoutMillis).Append("\n");
            sb.Append("  UserAgentValidationRequired: ").Append(UserAgentValidationRequired).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as OAuthSessionConfiguration);
        }

        /// <summary>
        /// Returns true if OAuthSessionConfiguration instances are equal
        /// </summary>
        /// <param name="input">Instance of OAuthSessionConfiguration to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OAuthSessionConfiguration input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.AbsoluteTimeoutMillis == input.AbsoluteTimeoutMillis ||
                    (this.AbsoluteTimeoutMillis != null &&
                    this.AbsoluteTimeoutMillis.Equals(input.AbsoluteTimeoutMillis))
                ) && 
                (
                    this.MaximumNumberOfParallelSessions == input.MaximumNumberOfParallelSessions ||
                    (this.MaximumNumberOfParallelSessions != null &&
                    this.MaximumNumberOfParallelSessions.Equals(input.MaximumNumberOfParallelSessions))
                ) && 
                (
                    this.RenewalTimeoutMillis == input.RenewalTimeoutMillis ||
                    (this.RenewalTimeoutMillis != null &&
                    this.RenewalTimeoutMillis.Equals(input.RenewalTimeoutMillis))
                ) && 
                (
                    this.UserAgentValidationRequired == input.UserAgentValidationRequired ||
                    (this.UserAgentValidationRequired != null &&
                    this.UserAgentValidationRequired.Equals(input.UserAgentValidationRequired))
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.AbsoluteTimeoutMillis != null)
                    hashCode = hashCode * 59 + this.AbsoluteTimeoutMillis.GetHashCode();
                if (this.MaximumNumberOfParallelSessions != null)
                    hashCode = hashCode * 59 + this.MaximumNumberOfParallelSessions.GetHashCode();
                if (this.RenewalTimeoutMillis != null)
                    hashCode = hashCode * 59 + this.RenewalTimeoutMillis.GetHashCode();
                if (this.UserAgentValidationRequired != null)
                    hashCode = hashCode * 59 + this.UserAgentValidationRequired.GetHashCode();
                return hashCode;
            }
        }
