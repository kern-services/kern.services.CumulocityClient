...
namespace kern.services.CumulocityClient.Model
{
    ...
    public partial class AuditRecord : IValidatableObject
    {
        /// <summary>
        ...
        public AuditRecord(string activity = default(string), AuditRecordC8yMetadata c8yMetadata = default(AuditRecordC8yMetadata), AuditRecordSource source = default(AuditRecordSource), string text = default(string), DateTime time = default(DateTime), TypeEnum type = default(TypeEnum), string user = default(string))
        {
