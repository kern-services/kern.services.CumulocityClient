...
namespace kern.services.CumulocityClient.Model
{
    ...
    public partial class AuditRecord : Dictionary<String, Object>,  IEquatable<AuditRecord>, IValidatableObject
    {
        ...
        public AuditRecord(string activity = default(string), AuditRecordC8yMetadata c8yMetadata = default(AuditRecordC8yMetadata), AuditRecordSource source = default(AuditRecordSource), string text = default(string), DateTime time = default(DateTime), TypeEnum type = default(TypeEnum), string user = default(string)) : base()
        {
            ...
            if (activity == null)
            {
                throw new InvalidDataException("activity is a required property for AuditRecord and cannot be null");
            }
            else
            {
            ...
            if (source == null)
            {
                throw new InvalidDataException("source is a required property for AuditRecord and cannot be null");
            }
            else
            {
                this.Source = source;
            ...
            if (text == null)
            {
                throw new InvalidDataException("text is a required property for AuditRecord and cannot be null");
            }
            else
            {
                this.Text = text;
            ...
            if (time == null)
            {
                throw new InvalidDataException("time is a required property for AuditRecord and cannot be null");
            }
            else
            {
                this.Time = time;
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for AuditRecord and cannot be null");
            }
            else
            {
                this.Type = type;
