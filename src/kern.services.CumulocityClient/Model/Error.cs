...
namespace kern.services.CumulocityClient.Model
{
    ...
    public partial class Error : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="varError">The type of error returned..</param>
        /// <param name="message">A human-readable message providing more details about the error..</param>
        /// <param name="info">A URI reference [[RFC3986](https://tools.ietf.org/html/rfc3986)] that identifies the error code reported..</param>
        public Error(string varError = default(string), string message = default(string), string info = default(string))
        {
        ...
        /// </summary>
        /// <value>A URI reference [[RFC3986](https://tools.ietf.org/html/rfc3986)] that identifies the error code reported.</value>
