...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "authConfig_onNewUser")]
    public partial class AuthConfigOnNewUser : IEquatable<AuthConfigOnNewUser>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthConfigOnNewUser" /> class.
        /// </summary>
        /// <param name="dynamicMapping">dynamicMapping.</param>
        public AuthConfigOnNewUser(AuthConfigOnNewUserDynamicMapping dynamicMapping = default(AuthConfigOnNewUserDynamicMapping))
        {
            this.DynamicMapping = dynamicMapping;
        }

        /// <summary>
        /// Gets or Sets DynamicMapping
        /// </summary>
        [DataMember(Name = "dynamicMapping", EmitDefaultValue = false)]
        public AuthConfigOnNewUserDynamicMapping DynamicMapping { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  DynamicMapping: ").Append(DynamicMapping).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as AuthConfigOnNewUser);
        }

        /// <summary>
        /// Returns true if AuthConfigOnNewUser instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthConfigOnNewUser to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthConfigOnNewUser input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.DynamicMapping == input.DynamicMapping ||
                    (this.DynamicMapping != null &&
                    this.DynamicMapping.Equals(input.DynamicMapping))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.DynamicMapping.GetHashCode();
                }
                return hashCode;
            }
        }
