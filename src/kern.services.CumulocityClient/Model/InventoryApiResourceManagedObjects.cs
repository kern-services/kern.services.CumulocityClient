...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inventoryApiResource_managedObjects")]
    public partial class InventoryApiResourceManagedObjects : IEquatable<InventoryApiResourceManagedObjects>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InventoryApiResourceManagedObjects" /> class.
        /// </summary>
        /// <param name="references">An array containing the referenced managed objects..</param>
        public InventoryApiResourceManagedObjects(List<ManagedObject> references = default(List<ManagedObject>))
        {
        ...
        /// </summary>
        /// <value>An array containing the referenced managed objects.</value>
        ...
        {
            return this.Equals(input as InventoryApiResourceManagedObjects);
        }

        /// <summary>
        /// Returns true if InventoryApiResourceManagedObjects instances are equal
        /// </summary>
        /// <param name="input">Instance of InventoryApiResourceManagedObjects to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InventoryApiResourceManagedObjects input)
        {
            if (input == null)
            {
                return false;
