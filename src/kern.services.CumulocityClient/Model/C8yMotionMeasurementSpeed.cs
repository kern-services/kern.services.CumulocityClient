...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "c8y_MotionMeasurement_speed")]
    public partial class C8yMotionMeasurementSpeed : IEquatable<C8yMotionMeasurementSpeed>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="C8yMotionMeasurementSpeed" /> class.
        /// </summary>
        /// <param name="value">value.</param>
        /// <param name="unit">unit.</param>
        public C8yMotionMeasurementSpeed(decimal value = default(decimal), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        {
            return this.Equals(input as C8yMotionMeasurementSpeed);
        }

        /// <summary>
        /// Returns true if C8yMotionMeasurementSpeed instances are equal
        /// </summary>
        /// <param name="input">Instance of C8yMotionMeasurementSpeed to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(C8yMotionMeasurementSpeed input)
        {
            if (input == null)
            {
                return false;
