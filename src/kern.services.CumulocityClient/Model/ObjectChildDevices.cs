...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "objectChildDevices")]
    public partial class ObjectChildDevices : IEquatable<ObjectChildDevices>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ObjectChildDevices" /> class.
        /// </summary>
        /// <param name="count">The total number of child devices. Only present if the value is greater than 0..</param>
        /// <param name="references">An array with the references to child devices..</param>
        /// <param name="self">Link to this resource&#39;s child devices..</param>
        public ObjectChildDevices(int count = default(int), List<ManagedObjectReferenceTuple> references = default(List<ManagedObjectReferenceTuple>), string self = default(string))
        {
            this.Count = count;
        ...
        /// </summary>
        /// <value>The total number of child devices. Only present if the value is greater than 0.</value>
        ...
        /// </summary>
        /// <value>Link to this resource&#39;s child devices.</value>
        ...
        {
            return this.Equals(input as ObjectChildDevices);
        }

        /// <summary>
        /// Returns true if ObjectChildDevices instances are equal
        /// </summary>
        /// <param name="input">Instance of ObjectChildDevices to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ObjectChildDevices input)
        {
            if (input == null)
            {
                return false;
