...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "event_source")]
    public partial class EventSource : IEquatable<EventSource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EventSource" /> class.
        /// </summary>
        /// <param name="id">Unique identifier of the object..</param>
        public EventSource(string id = default(string))
        {
            this.Id = id;
        }
        ...
        {
            return this.Equals(input as EventSource);
        }

        /// <summary>
        /// Returns true if EventSource instances are equal
        /// </summary>
        /// <param name="input">Instance of EventSource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EventSource input)
        {
            if (input == null)
            {
                return false;
