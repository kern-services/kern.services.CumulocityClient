...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// SubscribedUser
    /// </summary>
    [DataContract(Name = "SubscribedUser")]
    public partial class SubscribedUser : IEquatable<SubscribedUser>, IValidatableObject
    {
        ...
        public SubscribedUser(SubscribedUserUser user = default(SubscribedUserUser))
        {
            this.User = user;
        }
        ...
        public SubscribedUserUser User { get; set; }
        ...
        {
            return this.Equals(input as SubscribedUser);
        }

        /// <summary>
        /// Returns true if SubscribedUser instances are equal
        /// </summary>
        /// <param name="input">Instance of SubscribedUser to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubscribedUser input)
        {
            if (input == null)
            {
                return false;
