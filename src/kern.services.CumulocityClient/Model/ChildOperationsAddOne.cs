...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "childOperationsAddOne")]
    public partial class ChildOperationsAddOne : IEquatable<ChildOperationsAddOne>, IValidatableObject
    {
        ...
        public ChildOperationsAddOne(ChildOperationsAddOneManagedObject managedObject = default(ChildOperationsAddOneManagedObject))
        {
            ...
            {
                throw new ArgumentNullException("managedObject is a required property for ChildOperationsAddOne and cannot be null");
            }
