...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ChildOperationsAddOne :  IEquatable<ChildOperationsAddOne>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ChildOperationsAddOne" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ChildOperationsAddOne() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ChildOperationsAddOne" /> class.
        /// </summary>
        /// <param name="managedObject">managedObject (required).</param>
        public ChildOperationsAddOne(ChildOperationsAddOneManagedObject managedObject = default(ChildOperationsAddOneManagedObject))
        {
            // to ensure "managedObject" is required (not null)
            if (managedObject == null)
            {
                throw new InvalidDataException("managedObject is a required property for ChildOperationsAddOne and cannot be null");
            }
            else
            {
        ...
        public ChildOperationsAddOneManagedObject ManagedObject { get; set; }
        ...
        {
            return this.Equals(input as ChildOperationsAddOne);
        }

        /// <summary>
        /// Returns true if ChildOperationsAddOne instances are equal
        /// </summary>
        /// <param name="input">Instance of ChildOperationsAddOne to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChildOperationsAddOne input)
        {
            if (input == null)
                return false;
