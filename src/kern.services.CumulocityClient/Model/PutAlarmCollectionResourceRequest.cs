...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "putAlarmCollectionResource_request")]
    public partial class PutAlarmCollectionResourceRequest : IEquatable<PutAlarmCollectionResourceRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PutAlarmCollectionResourceRequest" /> class.
        /// </summary>
        /// <param name="status">The status of the alarm. If not specified, a new alarm will be created as ACTIVE..</param>
        public PutAlarmCollectionResourceRequest(StatusEnum? status = default(StatusEnum?))
        {
            this.Status = status;
        }
        ...
        public Object Severity { get; private set; }
        ...
        {
            return this.Equals(input as PutAlarmCollectionResourceRequest);
        }

        /// <summary>
        /// Returns true if PutAlarmCollectionResourceRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PutAlarmCollectionResourceRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PutAlarmCollectionResourceRequest input)
        {
            if (input == null)
            {
                return false;
