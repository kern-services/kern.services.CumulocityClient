...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "c8y_Network_c8y_DHCP")]
    public partial class C8yNetworkC8yDHCP : IEquatable<C8yNetworkC8yDHCP>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="C8yNetworkC8yDHCP" /> class.
        /// </summary>
        /// <param name="dns1">First configured DNS server..</param>
        /// <param name="dns2">Second configured DNS server..</param>
        /// <param name="domainName">Domain name configured for the device..</param>
        /// <param name="addressRange">addressRange.</param>
        /// <param name="enabled">Indicator showing if the DHCP server is enabled..</param>
        public C8yNetworkC8yDHCP(string dns1 = default(string), string dns2 = default(string), string domainName = default(string), C8yNetworkC8yDHCPAddressRange addressRange = default(C8yNetworkC8yDHCPAddressRange), int enabled = default(int))
        {
            this.Dns1 = dns1;
            this.Dns2 = dns2;
        ...
        /// </summary>
        /// <value>First configured DNS server.</value>
        ...
        /// </summary>
        /// <value>Second configured DNS server.</value>
        ...
        /// </summary>
        /// <value>Domain name configured for the device.</value>
        [DataMember(Name = "domainName", EmitDefaultValue = false)]
        public string DomainName { get; set; }

        /// <summary>
        /// Gets or Sets AddressRange
        /// </summary>
        [DataMember(Name = "addressRange", EmitDefaultValue = false)]
        public C8yNetworkC8yDHCPAddressRange AddressRange { get; set; }

        /// <summary>
        /// Indicator showing if the DHCP server is enabled.
        /// </summary>
        /// <value>Indicator showing if the DHCP server is enabled.</value>
        ...
        {
            return this.Equals(input as C8yNetworkC8yDHCP);
        }

        /// <summary>
        /// Returns true if C8yNetworkC8yDHCP instances are equal
        /// </summary>
        /// <param name="input">Instance of C8yNetworkC8yDHCP to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(C8yNetworkC8yDHCP input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.Dns1 == input.Dns1 ||
                    (this.Dns1 != null &&
                    this.Dns1.Equals(input.Dns1))
                ) && 
                (
                    this.Dns2 == input.Dns2 ||
                    (this.Dns2 != null &&
                    this.Dns2.Equals(input.Dns2))
                ) && 
                (
                ...
                (
                    this.AddressRange == input.AddressRange ||
                    (this.AddressRange != null &&
                    this.AddressRange.Equals(input.AddressRange))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Dns1 != null)
                {
                    hashCode = (hashCode * 59) + this.Dns1.GetHashCode();
                }
                if (this.Dns2 != null)
                {
                    hashCode = (hashCode * 59) + this.Dns2.GetHashCode();
                }
                ...
                {
                    hashCode = (hashCode * 59) + this.AddressRange.GetHashCode();
                }
