...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "authConfig_onNewUser_dynamicMapping_mappings_inner")]
    public partial class AuthConfigOnNewUserDynamicMappingMappingsInner : IEquatable<AuthConfigOnNewUserDynamicMappingMappingsInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthConfigOnNewUserDynamicMappingMappingsInner" /> class.
        /// </summary>
        /// <param name="when">when.</param>
        /// <param name="thenApplications">List of the applications&#39; identifiers..</param>
        /// <param name="thenGroups">List of the groups&#39; identifiers..</param>
        public AuthConfigOnNewUserDynamicMappingMappingsInner(JSONPredicateRepresentation when = default(JSONPredicateRepresentation), List<int> thenApplications = default(List<int>), List<int> thenGroups = default(List<int>))
        {
            this.When = when;
        ...
        /// </summary>
        /// <value>List of the applications&#39; identifiers.</value>
        [DataMember(Name = "thenApplications", EmitDefaultValue = false)]
        public List<int> ThenApplications { get; set; }

        /// <summary>
        /// List of the groups&#39; identifiers.
        /// </summary>
        /// <value>List of the groups&#39; identifiers.</value>
        [DataMember(Name = "thenGroups", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ThenApplications: ").Append(ThenApplications).Append("\n");
            sb.Append("  ThenGroups: ").Append(ThenGroups).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as AuthConfigOnNewUserDynamicMappingMappingsInner);
        }

        /// <summary>
        /// Returns true if AuthConfigOnNewUserDynamicMappingMappingsInner instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthConfigOnNewUserDynamicMappingMappingsInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthConfigOnNewUserDynamicMappingMappingsInner input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.ThenApplications == input.ThenApplications ||
                    this.ThenApplications != null &&
                    input.ThenApplications != null &&
                    this.ThenApplications.SequenceEqual(input.ThenApplications)
                ) && 
                (
                    this.ThenGroups == input.ThenGroups ||
                    this.ThenGroups != null &&
                    input.ThenGroups != null &&
                    this.ThenGroups.SequenceEqual(input.ThenGroups)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.ThenApplications.GetHashCode();
                }
                if (this.ThenGroups != null)
                {
                    hashCode = (hashCode * 59) + this.ThenGroups.GetHashCode();
                }
                return hashCode;
            }
        }
