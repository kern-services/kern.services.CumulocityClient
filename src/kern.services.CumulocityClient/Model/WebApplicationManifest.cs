...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "web_application_manifest")]
    public partial class WebApplicationManifest : IEquatable<WebApplicationManifest>, IValidatableObject
    {
        ...
        [DataMember(Name = "_webpaas", EmitDefaultValue = true)]
        [Obsolete]
        ...
        [DataMember(Name = "noAppSwitcher", EmitDefaultValue = true)]
        ...
        [DataMember(Name = "tabsHorizontal", EmitDefaultValue = true)]
