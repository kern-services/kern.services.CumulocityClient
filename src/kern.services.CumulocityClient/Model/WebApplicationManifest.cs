...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WebApplicationManifest :  IEquatable<WebApplicationManifest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WebApplicationManifest" /> class.
        /// </summary>
        ...
        public WebApplicationManifest(bool webpaas = default(bool), string contentSecurityPolicy = default(string), bool noAppSwitcher = default(bool), bool tabsHorizontal = default(bool))
        {
        ...
        {
            return this.Equals(input as WebApplicationManifest);
        }

        /// <summary>
        /// Returns true if WebApplicationManifest instances are equal
        /// </summary>
        /// <param name="input">Instance of WebApplicationManifest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WebApplicationManifest input)
        {
            if (input == null)
                return false;
