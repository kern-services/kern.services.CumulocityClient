...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GroupReferenceCollection")]
    public partial class GroupReferenceCollection : IEquatable<GroupReferenceCollection>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupReferenceCollection" /> class.
        /// </summary>
        /// <param name="self">self.</param>
        /// <param name="references">An array of group references..</param>
        /// <param name="prev">prev.</param>
        /// <param name="next">next.</param>
        /// <param name="statistics">statistics.</param>
        public GroupReferenceCollection(string self = default(string), List<GroupReference> references = default(List<GroupReference>), string prev = default(string), string next = default(string), PageStatistics statistics = default(PageStatistics))
        {
            this.Self = self;
        ...
        /// </summary>
        /// <value>An array of group references.</value>
        ...
        {
            return this.Equals(input as GroupReferenceCollection);
        }

        /// <summary>
        /// Returns true if GroupReferenceCollection instances are equal
        /// </summary>
        /// <param name="input">Instance of GroupReferenceCollection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GroupReferenceCollection input)
        {
            if (input == null)
            {
                return false;
