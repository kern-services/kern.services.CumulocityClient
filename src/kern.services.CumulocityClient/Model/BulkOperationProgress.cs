...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "bulkOperation_progress")]
    public partial class BulkOperationProgress : IEquatable<BulkOperationProgress>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BulkOperationProgress" /> class.
        /// </summary>
        /// <param name="pending">Number of pending operations..</param>
        /// <param name="failed">Number of failed operations..</param>
        /// <param name="executing">Number of operations being executed..</param>
        /// <param name="successful">Number of operations successfully processed..</param>
        /// <param name="all">Total number of processed operations..</param>
        public BulkOperationProgress(int pending = default(int), int failed = default(int), int executing = default(int), int successful = default(int), int all = default(int))
        {
        ...
        /// </summary>
        /// <value>Number of pending operations.</value>
        ...
        /// </summary>
        /// <value>Number of failed operations.</value>
        ...
        /// </summary>
        /// <value>Number of operations being executed.</value>
        ...
        /// </summary>
        /// <value>Number of operations successfully processed.</value>
        ...
        /// </summary>
        /// <value>Total number of processed operations.</value>
        ...
        {
            return this.Equals(input as BulkOperationProgress);
        }

        /// <summary>
        /// Returns true if BulkOperationProgress instances are equal
        /// </summary>
        /// <param name="input">Instance of BulkOperationProgress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BulkOperationProgress input)
        {
            if (input == null)
            {
                return false;
