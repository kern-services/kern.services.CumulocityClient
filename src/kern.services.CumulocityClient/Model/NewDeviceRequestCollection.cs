...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NewDeviceRequestCollection")]
    public partial class NewDeviceRequestCollection : IEquatable<NewDeviceRequestCollection>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewDeviceRequestCollection" /> class.
        /// </summary>
        /// <param name="newDeviceRequests">An array of new device requests..</param>
        /// <param name="statistics">statistics.</param>
        public NewDeviceRequestCollection(List<NewDeviceRequest> newDeviceRequests = default(List<NewDeviceRequest>), PageStatistics statistics = default(PageStatistics))
        {
        ...
        /// </summary>
        /// <value>An array of new device requests.</value>
        [DataMember(Name = "newDeviceRequests", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  NewDeviceRequests: ").Append(NewDeviceRequests).Append("\n");
        ...
        {
            return this.Equals(input as NewDeviceRequestCollection);
        }

        /// <summary>
        /// Returns true if NewDeviceRequestCollection instances are equal
        /// </summary>
        /// <param name="input">Instance of NewDeviceRequestCollection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewDeviceRequestCollection input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.NewDeviceRequests == input.NewDeviceRequests ||
                    this.NewDeviceRequests != null &&
                    input.NewDeviceRequests != null &&
                    this.NewDeviceRequests.SequenceEqual(input.NewDeviceRequests)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.NewDeviceRequests.GetHashCode();
                }
                if (this.Next != null)
                {
