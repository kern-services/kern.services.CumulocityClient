...
{
    /// <summary>
    /// GetManagedObjectChildDeviceResource200ResponseAllOf
    /// </summary>
    [DataContract(Name = "getManagedObjectChildDeviceResource_200_response_allOf")]
    public partial class GetManagedObjectChildDeviceResource200ResponseAllOf : IEquatable<GetManagedObjectChildDeviceResource200ResponseAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetManagedObjectChildDeviceResource200ResponseAllOf" /> class.
        /// </summary>
        /// <param name="self">self.</param>
        public GetManagedObjectChildDeviceResource200ResponseAllOf(Object self = default(Object))
        {
            this.Self = self;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetManagedObjectChildDeviceResource200ResponseAllOf {\n");
        ...
        {
            return this.Equals(input as GetManagedObjectChildDeviceResource200ResponseAllOf);
        }

        /// <summary>
        /// Returns true if GetManagedObjectChildDeviceResource200ResponseAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of GetManagedObjectChildDeviceResource200ResponseAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetManagedObjectChildDeviceResource200ResponseAllOf input)
        {
            if (input == null)
            {
                return false;
