...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "authConfig_refreshRequest")]
    public partial class AuthConfigRefreshRequest : IEquatable<AuthConfigRefreshRequest>, IValidatableObject
    {
        /// <summary>
        /// HTTP request method.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthConfigRefreshRequest" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as AuthConfigRefreshRequest);
        }

        /// <summary>
        /// Returns true if AuthConfigRefreshRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthConfigRefreshRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthConfigRefreshRequest input)
        {
            if (input == null)
            {
                return false;
