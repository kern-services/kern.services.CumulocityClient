...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ManagedObjectCollection")]
    public partial class ManagedObjectCollection : IEquatable<ManagedObjectCollection>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ManagedObjectCollection" /> class.
        /// </summary>
        /// <param name="managedObjects">An array containing the results (managed objects) of the request..</param>
        /// <param name="statistics">statistics.</param>
        public ManagedObjectCollection(List<ManagedObject> managedObjects = default(List<ManagedObject>), PageStatistics statistics = default(PageStatistics))
        {
        ...
        /// </summary>
        /// <value>An array containing the results (managed objects) of the request.</value>
        ...
        {
            return this.Equals(input as ManagedObjectCollection);
        }

        /// <summary>
        /// Returns true if ManagedObjectCollection instances are equal
        /// </summary>
        /// <param name="input">Instance of ManagedObjectCollection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ManagedObjectCollection input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    ...
                    input.ManagedObjects != null &&
                    this.ManagedObjects.SequenceEqual(input.ManagedObjects)
                ) && 
                (
