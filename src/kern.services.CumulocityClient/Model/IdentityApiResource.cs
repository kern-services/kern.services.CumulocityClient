...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// IdentityApiResource
    /// </summary>
    [DataContract(Name = "identityApiResource")]
    public partial class IdentityApiResource : IEquatable<IdentityApiResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IdentityApiResource" /> class.
        /// </summary>
        /// <param name="externalId">Single external ID, represented by the type and the value of the external ID..</param>
        /// <param name="externalIdsOfGlobalId">Represents a collection of external IDs for a specified global ID..</param>
        public IdentityApiResource(string externalId = default(string), string externalIdsOfGlobalId = default(string))
        {
        ...
        /// </summary>
        /// <value>Single external ID, represented by the type and the value of the external ID.</value>
        ...
        /// </summary>
        /// <value>Represents a collection of external IDs for a specified global ID.</value>
        [DataMember(Name = "externalIdsOfGlobalId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ExternalIdsOfGlobalId: ").Append(ExternalIdsOfGlobalId).Append("\n");
        ...
        {
            return this.Equals(input as IdentityApiResource);
        }

        /// <summary>
        /// Returns true if IdentityApiResource instances are equal
        /// </summary>
        /// <param name="input">Instance of IdentityApiResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IdentityApiResource input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.ExternalIdsOfGlobalId == input.ExternalIdsOfGlobalId ||
                    (this.ExternalIdsOfGlobalId != null &&
                    this.ExternalIdsOfGlobalId.Equals(input.ExternalIdsOfGlobalId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ExternalIdsOfGlobalId != null)
                {
                    hashCode = (hashCode * 59) + this.ExternalIdsOfGlobalId.GetHashCode();
                }
                if (this.Self != null)
                {
