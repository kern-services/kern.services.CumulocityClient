...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getManagedObjectChildAssetsResource_200_response")]
    public partial class GetManagedObjectChildAssetsResource200Response : IEquatable<GetManagedObjectChildAssetsResource200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetManagedObjectChildAssetsResource200Response" /> class.
        /// </summary>
        ...
        public GetManagedObjectChildAssetsResource200Response(Object prev = default(Object), Object self = default(Object), Object next = default(Object), List<ManagedObjectReferenceCollectionReferencesInner> references = default(List<ManagedObjectReferenceCollectionReferencesInner>), PageStatistics statistics = default(PageStatistics))
        {
            this.Prev = prev;
            this.Self = self;
            this.Next = next;
        ...
        {
            return this.Equals(input as GetManagedObjectChildAssetsResource200Response);
        }

        /// <summary>
        /// Returns true if GetManagedObjectChildAssetsResource200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of GetManagedObjectChildAssetsResource200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetManagedObjectChildAssetsResource200Response input)
        {
            if (input == null)
            {
                return false;
