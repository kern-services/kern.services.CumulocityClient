...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "c8y_MoistureMeasurement")]
    public partial class C8yMoistureMeasurement : IEquatable<C8yMoistureMeasurement>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="C8yMoistureMeasurement" /> class.
        /// </summary>
        /// <param name="moisture">moisture.</param>
        public C8yMoistureMeasurement(C8yMoistureMeasurementMoisture moisture = default(C8yMoistureMeasurementMoisture))
        {
        ...
        public C8yMoistureMeasurementMoisture Moisture { get; set; }
        ...
        {
            return this.Equals(input as C8yMoistureMeasurement);
        }

        /// <summary>
        /// Returns true if C8yMoistureMeasurement instances are equal
        /// </summary>
        /// <param name="input">Instance of C8yMoistureMeasurement to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(C8yMoistureMeasurement input)
        {
            if (input == null)
            {
                return false;
