...
{
    /// <summary>
    /// PutUserResourceRequestAllOf
    /// </summary>
    [DataContract(Name = "putUserResource_request_allOf")]
    public partial class PutUserResourceRequestAllOf : IEquatable<PutUserResourceRequestAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PutUserResourceRequestAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public PutUserResourceRequestAllOf()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PutUserResourceRequestAllOf {\n");
        ...
        {
            return this.Equals(input as PutUserResourceRequestAllOf);
        }

        /// <summary>
        /// Returns true if PutUserResourceRequestAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of PutUserResourceRequestAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PutUserResourceRequestAllOf input)
        {
            if (input == null)
            {
                return false;
