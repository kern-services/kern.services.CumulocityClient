...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpdatedDevicePermissions_users_inner")]
    public partial class UpdatedDevicePermissionsUsersInner : IEquatable<UpdatedDevicePermissionsUsersInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdatedDevicePermissionsUsersInner" /> class.
        /// </summary>
        /// <param name="userName">userName.</param>
        /// <param name="devicePermissions">An object with a list of the user&#39;s device permissions..</param>
        public UpdatedDevicePermissionsUsersInner(string userName = default(string), Dictionary<string, List<string>> devicePermissions = default(Dictionary<string, List<string>>))
        {
        ...
        {
            return this.Equals(input as UpdatedDevicePermissionsUsersInner);
        }

        /// <summary>
        /// Returns true if UpdatedDevicePermissionsUsersInner instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdatedDevicePermissionsUsersInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdatedDevicePermissionsUsersInner input)
        {
            if (input == null)
            {
                return false;
