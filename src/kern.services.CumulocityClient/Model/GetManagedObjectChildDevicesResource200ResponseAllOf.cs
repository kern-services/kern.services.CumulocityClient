...
{
    /// <summary>
    /// GetManagedObjectChildDevicesResource200ResponseAllOf
    /// </summary>
    [DataContract(Name = "getManagedObjectChildDevicesResource_200_response_allOf")]
    public partial class GetManagedObjectChildDevicesResource200ResponseAllOf : IEquatable<GetManagedObjectChildDevicesResource200ResponseAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetManagedObjectChildDevicesResource200ResponseAllOf" /> class.
        /// </summary>
        /// <param name="prev">prev.</param>
        /// <param name="self">self.</param>
        /// <param name="next">next.</param>
        public GetManagedObjectChildDevicesResource200ResponseAllOf(Object prev = default(Object), Object self = default(Object), Object next = default(Object))
        {
            this.Prev = prev;
            this.Self = self;
            this.Next = next;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetManagedObjectChildDevicesResource200ResponseAllOf {\n");
        ...
        {
            return this.Equals(input as GetManagedObjectChildDevicesResource200ResponseAllOf);
        }

        /// <summary>
        /// Returns true if GetManagedObjectChildDevicesResource200ResponseAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of GetManagedObjectChildDevicesResource200ResponseAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetManagedObjectChildDevicesResource200ResponseAllOf input)
        {
            if (input == null)
            {
                return false;
