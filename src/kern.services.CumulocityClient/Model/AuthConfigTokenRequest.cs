...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "authConfig_tokenRequest")]
    public partial class AuthConfigTokenRequest : IEquatable<AuthConfigTokenRequest>, IValidatableObject
    {
        /// <summary>
        /// HTTP request method.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthConfigTokenRequest" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as AuthConfigTokenRequest);
        }

        /// <summary>
        /// Returns true if AuthConfigTokenRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthConfigTokenRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthConfigTokenRequest input)
        {
            if (input == null)
            {
                return false;
