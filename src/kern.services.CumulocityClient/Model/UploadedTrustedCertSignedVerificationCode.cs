...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UploadedTrustedCertSignedVerificationCode")]
    public partial class UploadedTrustedCertSignedVerificationCode : IEquatable<UploadedTrustedCertSignedVerificationCode>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UploadedTrustedCertSignedVerificationCode" /> class.
        /// </summary>
        /// <param name="proofOfPossessionSignedVerificationCode">A signed verification code that proves the right to use the certificate..</param>
        public UploadedTrustedCertSignedVerificationCode(string proofOfPossessionSignedVerificationCode = default(string))
        {
        ...
        /// </summary>
        /// <value>A signed verification code that proves the right to use the certificate.</value>
        [DataMember(Name = "proofOfPossessionSignedVerificationCode", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ProofOfPossessionSignedVerificationCode: ").Append(ProofOfPossessionSignedVerificationCode).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as UploadedTrustedCertSignedVerificationCode);
        }

        /// <summary>
        /// Returns true if UploadedTrustedCertSignedVerificationCode instances are equal
        /// </summary>
        /// <param name="input">Instance of UploadedTrustedCertSignedVerificationCode to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UploadedTrustedCertSignedVerificationCode input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.ProofOfPossessionSignedVerificationCode == input.ProofOfPossessionSignedVerificationCode ||
                    (this.ProofOfPossessionSignedVerificationCode != null &&
                    this.ProofOfPossessionSignedVerificationCode.Equals(input.ProofOfPossessionSignedVerificationCode))
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.ProofOfPossessionSignedVerificationCode != null)
                {
                    hashCode = (hashCode * 59) + this.ProofOfPossessionSignedVerificationCode.GetHashCode();
                }
                return hashCode;
            }
        }
