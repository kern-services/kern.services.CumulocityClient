...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "application_manifest_probe")]
    public partial class ApplicationManifestProbe : IEquatable<ApplicationManifestProbe>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationManifestProbe" /> class.
        /// </summary>
        ...
        public ApplicationManifestProbe(int failureThreshold = default(int), int periodSeconds = default(int), int timeoutSeconds = default(int), int successThreshold = default(int), int initialDelaySeconds = default(int), ApplicationManifestProbeHttpGet httpGet = default(ApplicationManifestProbeHttpGet))
        {
        ...
        {
            return this.Equals(input as ApplicationManifestProbe);
        }

        /// <summary>
        /// Returns true if ApplicationManifestProbe instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationManifestProbe to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationManifestProbe input)
        {
            if (input == null)
            {
                return false;
