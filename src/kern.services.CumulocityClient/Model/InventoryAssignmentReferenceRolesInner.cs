...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inventoryAssignmentReference_roles_inner")]
    public partial class InventoryAssignmentReferenceRolesInner : IEquatable<InventoryAssignmentReferenceRolesInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InventoryAssignmentReferenceRolesInner" /> class.
        /// </summary>
        /// <param name="id">A unique identifier for this inventory role..</param>
        public InventoryAssignmentReferenceRolesInner(int id = default(int))
        {
            this.Id = id;
        }
        ...
        {
            return this.Equals(input as InventoryAssignmentReferenceRolesInner);
        }

        /// <summary>
        /// Returns true if InventoryAssignmentReferenceRolesInner instances are equal
        /// </summary>
        /// <param name="input">Instance of InventoryAssignmentReferenceRolesInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InventoryAssignmentReferenceRolesInner input)
        {
            if (input == null)
            {
                return false;
