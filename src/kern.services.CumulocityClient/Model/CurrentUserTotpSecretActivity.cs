...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CurrentUserTotpSecretActivity :  IEquatable<CurrentUserTotpSecretActivity>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CurrentUserTotpSecretActivity" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CurrentUserTotpSecretActivity() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CurrentUserTotpSecretActivity" /> class.
        /// </summary>
        /// <param name="isActive">Indicates whether the two-factor authentication secret is active. (required).</param>
        public CurrentUserTotpSecretActivity(bool isActive = default(bool))
        {
            // to ensure "isActive" is required (not null)
            if (isActive == null)
            {
                throw new InvalidDataException("isActive is a required property for CurrentUserTotpSecretActivity and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Indicates whether the two-factor authentication secret is active.</value>
        ...
        {
            return this.Equals(input as CurrentUserTotpSecretActivity);
        }

        /// <summary>
        /// Returns true if CurrentUserTotpSecretActivity instances are equal
        /// </summary>
        /// <param name="input">Instance of CurrentUserTotpSecretActivity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CurrentUserTotpSecretActivity input)
        {
            if (input == null)
                return false;
