...
namespace kern.services.CumulocityClient.Model
{
    ...
    public partial class PasswordChange :  IEquatable<PasswordChange>, IValidatableObject
    {
        ...
        public PasswordChange(string currentUserPassword = default(string), string newPassword = default(string))
        {
            ...
            {
                throw new InvalidDataException("currentUserPassword is a required property for PasswordChange and cannot be null");
            }
            else
            {
            ...
            if (newPassword == null)
            {
                throw new InvalidDataException("newPassword is a required property for PasswordChange and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="currentUserPassword", EmitDefaultValue=true)]
