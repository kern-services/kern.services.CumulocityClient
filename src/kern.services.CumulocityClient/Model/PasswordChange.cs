...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// PasswordChange
    /// </summary>
    [DataContract(Name = "passwordChange")]
    public partial class PasswordChange : IEquatable<PasswordChange>, IValidatableObject
    {
        /// <summary>
        ...
        /// Initializes a new instance of the <see cref="PasswordChange" /> class.
        /// </summary>
        /// <param name="currentUserPassword">The current password of the user performing the request. (required).</param>
        /// <param name="newPassword">The new password to be set for the user performing the request. (required).</param>
        public PasswordChange(string currentUserPassword = default(string), string newPassword = default(string))
        {
            // to ensure "currentUserPassword" is required (not null)
            if (currentUserPassword == null)
            {
                throw new ArgumentNullException("currentUserPassword is a required property for PasswordChange and cannot be null");
            }
            this.CurrentUserPassword = currentUserPassword;
            // to ensure "newPassword" is required (not null)
            if (newPassword == null)
            {
                throw new ArgumentNullException("newPassword is a required property for PasswordChange and cannot be null");
            }
        ...
        /// </summary>
        /// <value>The current password of the user performing the request.</value>
        [DataMember(Name = "currentUserPassword", IsRequired = true, EmitDefaultValue = true)]
        public string CurrentUserPassword { get; set; }

        /// <summary>
        /// The new password to be set for the user performing the request.
        /// </summary>
        /// <value>The new password to be set for the user performing the request.</value>
        ...
        {
            return this.Equals(input as PasswordChange);
        }

        /// <summary>
        /// Returns true if PasswordChange instances are equal
        /// </summary>
        /// <param name="input">Instance of PasswordChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PasswordChange input)
        {
            if (input == null)
            {
                return false;
