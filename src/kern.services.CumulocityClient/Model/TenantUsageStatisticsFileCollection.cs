...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TenantUsageStatisticsFileCollection")]
    public partial class TenantUsageStatisticsFileCollection : IEquatable<TenantUsageStatisticsFileCollection>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TenantUsageStatisticsFileCollection" /> class.
        /// </summary>
        /// <param name="statistics">statistics.</param>
        /// <param name="statisticsFiles">An array containing the usage statistics files metadata..</param>
        public TenantUsageStatisticsFileCollection(PageStatistics statistics = default(PageStatistics), List<StatisticsFile> statisticsFiles = default(List<StatisticsFile>))
        {
        ...
        /// </summary>
        /// <value>A URI reference [[RFC3986](https://tools.ietf.org/html/rfc3986)] to a potential next page of managed objects.</value>
        ...
        /// </summary>
        /// <value>A URI reference [[RFC3986](https://tools.ietf.org/html/rfc3986)] to a potential previous page of managed objects.</value>
        ...
        /// </summary>
        /// <value>An array containing the usage statistics files metadata.</value>
        [DataMember(Name = "statisticsFiles", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  StatisticsFiles: ").Append(StatisticsFiles).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as TenantUsageStatisticsFileCollection);
        }

        /// <summary>
        /// Returns true if TenantUsageStatisticsFileCollection instances are equal
        /// </summary>
        /// <param name="input">Instance of TenantUsageStatisticsFileCollection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TenantUsageStatisticsFileCollection input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.StatisticsFiles == input.StatisticsFiles ||
                    this.StatisticsFiles != null &&
                    input.StatisticsFiles != null &&
                    this.StatisticsFiles.SequenceEqual(input.StatisticsFiles)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.StatisticsFiles.GetHashCode();
                }
                return hashCode;
            }
        }
