...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "objectChildAssets")]
    public partial class ObjectChildAssets : IEquatable<ObjectChildAssets>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ObjectChildAssets" /> class.
        /// </summary>
        /// <param name="count">The total number of child assets. Only present if the value is greater than 0..</param>
        /// <param name="references">An array with the references to child assets..</param>
        /// <param name="self">Link to this resource&#39;s child assets..</param>
        public ObjectChildAssets(int count = default(int), List<ManagedObjectReferenceTuple> references = default(List<ManagedObjectReferenceTuple>), string self = default(string))
        {
            this.Count = count;
        ...
        /// </summary>
        /// <value>The total number of child assets. Only present if the value is greater than 0.</value>
        ...
        /// </summary>
        /// <value>An array with the references to child assets.</value>
        ...
        /// </summary>
        /// <value>Link to this resource&#39;s child assets.</value>
        ...
        {
            return this.Equals(input as ObjectChildAssets);
        }

        /// <summary>
        /// Returns true if ObjectChildAssets instances are equal
        /// </summary>
        /// <param name="input">Instance of ObjectChildAssets to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ObjectChildAssets input)
        {
            if (input == null)
            {
                return false;
