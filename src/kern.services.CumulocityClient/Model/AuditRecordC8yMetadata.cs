...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "auditRecord_c8y_Metadata")]
    public partial class AuditRecordC8yMetadata : IEquatable<AuditRecordC8yMetadata>, IValidatableObject
    {
        /// <summary>
        /// The action that was carried out.
        /// </summary>
        /// <value>The action that was carried out.</value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditRecordC8yMetadata" /> class.
        /// </summary>
        /// <param name="action">The action that was carried out..</param>
        public AuditRecordC8yMetadata(ActionEnum? action = default(ActionEnum?))
        {
            this.Action = action;
        }
        ...
        {
            return this.Equals(input as AuditRecordC8yMetadata);
        }

        /// <summary>
        /// Returns true if AuditRecordC8yMetadata instances are equal
        /// </summary>
        /// <param name="input">Instance of AuditRecordC8yMetadata to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuditRecordC8yMetadata input)
        {
            if (input == null)
            {
                return false;
