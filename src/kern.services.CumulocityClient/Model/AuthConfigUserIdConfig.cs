...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AuthConfigUserIdConfig :  IEquatable<AuthConfigUserIdConfig>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthConfigUserIdConfig" /> class.
        /// </summary>
        /// <param name="constantValue">Used only when &#x60;useConstantValue&#x60; is set to &#x60;true&#x60;..</param>
        /// <param name="jwtField">The name of the field containing the JWT..</param>
        /// <param name="useConstantValue">Not recommended. If set to &#x60;true&#x60;, all SSO users will share one account in the Cumulocity IoT platform..</param>
        public AuthConfigUserIdConfig(string constantValue = default(string), string jwtField = default(string), bool useConstantValue = default(bool))
        {
        ...
        /// </summary>
        /// <value>Used only when &#x60;useConstantValue&#x60; is set to &#x60;true&#x60;.</value>
        [DataMember(Name="constantValue", EmitDefaultValue=false)]
        public string ConstantValue { get; set; }

        /// <summary>
        /// The name of the field containing the JWT.
        /// </summary>
        /// <value>The name of the field containing the JWT.</value>
        [DataMember(Name="jwtField", EmitDefaultValue=false)]
        ...
        /// </summary>
        /// <value>Not recommended. If set to &#x60;true&#x60;, all SSO users will share one account in the Cumulocity IoT platform.</value>
        [DataMember(Name="useConstantValue", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ConstantValue: ").Append(ConstantValue).Append("\n");
            sb.Append("  JwtField: ").Append(JwtField).Append("\n");
            sb.Append("  UseConstantValue: ").Append(UseConstantValue).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as AuthConfigUserIdConfig);
        }

        /// <summary>
        /// Returns true if AuthConfigUserIdConfig instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthConfigUserIdConfig to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthConfigUserIdConfig input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    ...
                    this.ConstantValue.Equals(input.ConstantValue))
                ) && 
                (
                    this.JwtField == input.JwtField ||
                    (this.JwtField != null &&
                    this.JwtField.Equals(input.JwtField))
                ) && 
                (
                    this.UseConstantValue == input.UseConstantValue ||
                    (this.UseConstantValue != null &&
                    this.UseConstantValue.Equals(input.UseConstantValue))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ConstantValue != null)
                    hashCode = hashCode * 59 + this.ConstantValue.GetHashCode();
                if (this.JwtField != null)
                    hashCode = hashCode * 59 + this.JwtField.GetHashCode();
                if (this.UseConstantValue != null)
                    hashCode = hashCode * 59 + this.UseConstantValue.GetHashCode();
                return hashCode;
            }
        }
