...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getManagedObjectChildDevicesResource_200_response")]
    public partial class GetManagedObjectChildDevicesResource200Response : IEquatable<GetManagedObjectChildDevicesResource200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetManagedObjectChildDevicesResource200Response" /> class.
        /// </summary>
        /// <param name="prev">prev.</param>
        /// <param name="self">self.</param>
        /// <param name="next">next.</param>
        /// <param name="references">An array containing the details of all children (if any)..</param>
        /// <param name="statistics">statistics.</param>
        public GetManagedObjectChildDevicesResource200Response(Object prev = default(Object), Object self = default(Object), Object next = default(Object), List<ManagedObjectReferenceCollectionReferencesInner> references = default(List<ManagedObjectReferenceCollectionReferencesInner>), PageStatistics statistics = default(PageStatistics))
        {
            this.Prev = prev;
            this.Self = self;
            this.Next = next;
        ...
        /// </summary>
        /// <value>An array containing the details of all children (if any).</value>
        [DataMember(Name = "references", EmitDefaultValue = false)]
        public List<ManagedObjectReferenceCollectionReferencesInner> References { get; set; }
        ...
        {
            return this.Equals(input as GetManagedObjectChildDevicesResource200Response);
        }

        /// <summary>
        /// Returns true if GetManagedObjectChildDevicesResource200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of GetManagedObjectChildDevicesResource200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetManagedObjectChildDevicesResource200Response input)
        {
            if (input == null)
            {
                return false;
