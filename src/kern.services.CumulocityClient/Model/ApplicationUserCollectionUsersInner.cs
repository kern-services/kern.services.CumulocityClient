...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ApplicationUserCollection_users_inner")]
    public partial class ApplicationUserCollectionUsersInner : IEquatable<ApplicationUserCollectionUsersInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationUserCollectionUsersInner" /> class.
        /// </summary>
        /// <param name="name">The username..</param>
        /// <param name="password">The user password..</param>
        /// <param name="tenant">The user tenant..</param>
        public ApplicationUserCollectionUsersInner(string name = default(string), string password = default(string), string tenant = default(string))
        {
            this.Name = name;
        ...
        {
            return this.Equals(input as ApplicationUserCollectionUsersInner);
        }

        /// <summary>
        /// Returns true if ApplicationUserCollectionUsersInner instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationUserCollectionUsersInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationUserCollectionUsersInner input)
        {
            if (input == null)
            {
                return false;
