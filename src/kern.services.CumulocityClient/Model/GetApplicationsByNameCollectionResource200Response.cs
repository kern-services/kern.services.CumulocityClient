...
namespace kern.services.CumulocityClient.Model
{
    ...
    public partial class GetApplicationsByNameCollectionResource200Response : IEquatable<GetApplicationsByNameCollectionResource200Response>, IValidatableObject
    {
        /// <summary>
        ...
        public GetApplicationsByNameCollectionResource200Response(List<Application> applications = default(List<Application>), string next = default(string), string prev = default(string), string self = default(string), PageStatistics statistics = default(PageStatistics))
        {
        ...
        {
            return this.Equals(input as GetApplicationsByNameCollectionResource200Response);
        }

        /// <summary>
        /// Returns true if GetApplicationsByNameCollectionResource200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of GetApplicationsByNameCollectionResource200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetApplicationsByNameCollectionResource200Response input)
        {
            if (input == null)
            {
                return false;
