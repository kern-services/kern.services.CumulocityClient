...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "c8y_AccelerationMeasurement")]
    public partial class C8yAccelerationMeasurement : IEquatable<C8yAccelerationMeasurement>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="C8yAccelerationMeasurement" /> class.
        /// </summary>
        /// <param name="acceleration">acceleration.</param>
        public C8yAccelerationMeasurement(C8yAccelerationMeasurementAcceleration acceleration = default(C8yAccelerationMeasurementAcceleration))
        {
        ...
        public C8yAccelerationMeasurementAcceleration Acceleration { get; set; }
        ...
        {
            return this.Equals(input as C8yAccelerationMeasurement);
        }

        /// <summary>
        /// Returns true if C8yAccelerationMeasurement instances are equal
        /// </summary>
        /// <param name="input">Instance of C8yAccelerationMeasurement to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(C8yAccelerationMeasurement input)
        {
            if (input == null)
            {
                return false;
