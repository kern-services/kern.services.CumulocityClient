...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// PlatformApiResource
    /// </summary>
    [DataContract(Name = "PlatformApiResource")]
    public partial class PlatformApiResource : IEquatable<PlatformApiResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PlatformApiResource" /> class.
        /// </summary>
        /// <param name="self">self.</param>
        /// <param name="alarm">alarm.</param>
        /// <param name="audit">audit.</param>
        /// <param name="deviceControl">deviceControl.</param>
        ...
        public PlatformApiResource(string self = default(string), AlarmsApiResource alarm = default(AlarmsApiResource), AuditApiResource audit = default(AuditApiResource), DeviceControlApiResource deviceControl = default(DeviceControlApiResource), EventsApiResource _event = default(EventsApiResource), IdentityApiResource identity = default(IdentityApiResource), InventoryApiResource inventory = default(InventoryApiResource), MeasurementApiResource measurement = default(MeasurementApiResource), TenantApiResource tenant = default(TenantApiResource), UserApiResource user = default(UserApiResource))
        {
            this.Self = self;
            this.Alarm = alarm;
            this.Audit = audit;
        ...
        /// <summary>
        /// Gets or Sets DeviceControl
        /// </summary>
        [DataMember(Name = "deviceControl", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  DeviceControl: ").Append(DeviceControl).Append("\n");
        ...
        {
            return this.Equals(input as PlatformApiResource);
        }

        /// <summary>
        /// Returns true if PlatformApiResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PlatformApiResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PlatformApiResource input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.DeviceControl == input.DeviceControl ||
                    (this.DeviceControl != null &&
                    this.DeviceControl.Equals(input.DeviceControl))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.DeviceControl.GetHashCode();
                }
                if (this.Event != null)
                {
