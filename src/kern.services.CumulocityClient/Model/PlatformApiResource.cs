...
namespace kern.services.CumulocityClient.Model
{
    ...
    public partial class PlatformApiResource : IValidatableObject
    {
        /// <summary>
        ...
        public EventsApiResource VarEvent { get; set; }
