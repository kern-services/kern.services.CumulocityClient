...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// OperationReference
    /// </summary>
    [DataContract(Name = "operationReference")]
    public partial class OperationReference : IEquatable<OperationReference>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OperationReference" /> class.
        /// </summary>
        /// <param name="operation">operation.</param>
        public OperationReference(OperationReferenceOperation operation = default(OperationReferenceOperation))
        {
        ...
        public OperationReferenceOperation Operation { get; set; }
        ...
        {
            return this.Equals(input as OperationReference);
        }

        /// <summary>
        /// Returns true if OperationReference instances are equal
        /// </summary>
        /// <param name="input">Instance of OperationReference to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OperationReference input)
        {
            if (input == null)
            {
                return false;
