...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// ManagedObjectUser
    /// </summary>
    [DataContract(Name = "ManagedObjectUser")]
    public partial class ManagedObjectUser : IEquatable<ManagedObjectUser>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ManagedObjectUser" /> class.
        /// </summary>
        /// <param name="enabled">Specifies if the device&#39;s owner is enabled or not..</param>
        public ManagedObjectUser(bool enabled = default(bool))
        {
        ...
        /// </summary>
        /// <value>Specifies if the device&#39;s owner is enabled or not.</value>
        ...
        /// </summary>
        /// <value>The username of the device&#39;s owner.</value>
        ...
        {
            return this.Equals(input as ManagedObjectUser);
        }

        /// <summary>
        /// Returns true if ManagedObjectUser instances are equal
        /// </summary>
        /// <param name="input">Instance of ManagedObjectUser to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ManagedObjectUser input)
        {
            if (input == null)
            {
                return false;
