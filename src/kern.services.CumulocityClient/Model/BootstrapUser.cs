...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// BootstrapUser
    /// </summary>
    [DataContract(Name = "BootstrapUser")]
    public partial class BootstrapUser : IEquatable<BootstrapUser>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BootstrapUser" /> class.
        /// </summary>
        /// <param name="name">The bootstrap user tenant username..</param>
        /// <param name="password">The bootstrap user tenant password..</param>
        /// <param name="tenant">The bootstrap user tenant ID..</param>
        public BootstrapUser(string name = default(string), string password = default(string), string tenant = default(string))
        {
            this.Name = name;
        ...
        /// </summary>
        /// <value>The bootstrap user tenant username.</value>
        ...
        /// </summary>
        /// <value>The bootstrap user tenant password.</value>
        ...
        /// </summary>
        /// <value>The bootstrap user tenant ID.</value>
        ...
        {
            return this.Equals(input as BootstrapUser);
        }

        /// <summary>
        /// Returns true if BootstrapUser instances are equal
        /// </summary>
        /// <param name="input">Instance of BootstrapUser to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BootstrapUser input)
        {
            if (input == null)
            {
                return false;
