...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ApplicationApiResource")]
    public partial class ApplicationApiResource : IEquatable<ApplicationApiResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationApiResource" /> class.
        /// </summary>
        /// <param name="applications">Collection of all applications...</param>
        /// <param name="applicationById">A reference to a resource of type Application..</param>
        /// <param name="applicationsByName">Read-only collection of all applications with a particular name..</param>
        /// <param name="applicationsByTenant">Read-only collection of all applications subscribed by a particular tenant..</param>
        /// <param name="applicationsByOwner">Read-only collection of all applications owned by a particular tenant..</param>
        /// <param name="applicationsByUser">Read-only collection of all applications owned by a particular user..</param>
        public ApplicationApiResource(string applications = default(string), string applicationById = default(string), string applicationsByName = default(string), string applicationsByTenant = default(string), string applicationsByOwner = default(string), string applicationsByUser = default(string))
        {
        ...
        /// </summary>
        /// <value>Collection of all applications..</value>
        ...
        /// </summary>
        /// <value>A reference to a resource of type Application.</value>
        [DataMember(Name = "applicationById", EmitDefaultValue = false)]
        public string ApplicationById { get; set; }

        /// <summary>
        /// Read-only collection of all applications with a particular name.
        /// </summary>
        /// <value>Read-only collection of all applications with a particular name.</value>
        [DataMember(Name = "applicationsByName", EmitDefaultValue = false)]
        public string ApplicationsByName { get; set; }

        /// <summary>
        /// Read-only collection of all applications subscribed by a particular tenant.
        /// </summary>
        /// <value>Read-only collection of all applications subscribed by a particular tenant.</value>
        [DataMember(Name = "applicationsByTenant", EmitDefaultValue = false)]
        public string ApplicationsByTenant { get; set; }

        /// <summary>
        /// Read-only collection of all applications owned by a particular tenant.
        /// </summary>
        /// <value>Read-only collection of all applications owned by a particular tenant.</value>
        [DataMember(Name = "applicationsByOwner", EmitDefaultValue = false)]
        public string ApplicationsByOwner { get; set; }

        /// <summary>
        /// Read-only collection of all applications owned by a particular user.
        /// </summary>
        /// <value>Read-only collection of all applications owned by a particular user.</value>
        [DataMember(Name = "applicationsByUser", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ApplicationById: ").Append(ApplicationById).Append("\n");
            sb.Append("  ApplicationsByName: ").Append(ApplicationsByName).Append("\n");
            sb.Append("  ApplicationsByTenant: ").Append(ApplicationsByTenant).Append("\n");
            sb.Append("  ApplicationsByOwner: ").Append(ApplicationsByOwner).Append("\n");
            sb.Append("  ApplicationsByUser: ").Append(ApplicationsByUser).Append("\n");
        ...
        {
            return this.Equals(input as ApplicationApiResource);
        }

        /// <summary>
        /// Returns true if ApplicationApiResource instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationApiResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationApiResource input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.ApplicationById == input.ApplicationById ||
                    (this.ApplicationById != null &&
                    this.ApplicationById.Equals(input.ApplicationById))
                ) && 
                (
                    this.ApplicationsByName == input.ApplicationsByName ||
                    (this.ApplicationsByName != null &&
                    this.ApplicationsByName.Equals(input.ApplicationsByName))
                ) && 
                (
                    this.ApplicationsByTenant == input.ApplicationsByTenant ||
                    (this.ApplicationsByTenant != null &&
                    this.ApplicationsByTenant.Equals(input.ApplicationsByTenant))
                ) && 
                (
                    this.ApplicationsByOwner == input.ApplicationsByOwner ||
                    (this.ApplicationsByOwner != null &&
                    this.ApplicationsByOwner.Equals(input.ApplicationsByOwner))
                ) && 
                (
                    this.ApplicationsByUser == input.ApplicationsByUser ||
                    (this.ApplicationsByUser != null &&
                    this.ApplicationsByUser.Equals(input.ApplicationsByUser))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.ApplicationById.GetHashCode();
                }
                if (this.ApplicationsByName != null)
                {
                    hashCode = (hashCode * 59) + this.ApplicationsByName.GetHashCode();
                }
                if (this.ApplicationsByTenant != null)
                {
                    hashCode = (hashCode * 59) + this.ApplicationsByTenant.GetHashCode();
                }
                if (this.ApplicationsByOwner != null)
                {
                    hashCode = (hashCode * 59) + this.ApplicationsByOwner.GetHashCode();
                }
                if (this.ApplicationsByUser != null)
                {
                    hashCode = (hashCode * 59) + this.ApplicationsByUser.GetHashCode();
                }
                if (this.Self != null)
                {
