...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PutNewDeviceRequestResourceRequest :  IEquatable<PutNewDeviceRequestResourceRequest>, IValidatableObject
    {
        /// <summary>
        /// Status of this new device request.
        /// </summary>
        /// <value>Status of this new device request.</value>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum StatusEnum
        {
            /// <summary>
            /// Enum WAITINGFORCONNECTION for value: WAITING_FOR_CONNECTION
            /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PutNewDeviceRequestResourceRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PutNewDeviceRequestResourceRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PutNewDeviceRequestResourceRequest" /> class.
        /// </summary>
        /// <param name="status">Status of this new device request. (required).</param>
        public PutNewDeviceRequestResourceRequest(StatusEnum status = default(StatusEnum))
        {
            // to ensure "status" is required (not null)
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for PutNewDeviceRequestResourceRequest and cannot be null");
            }
            else
            {
                this.Status = status;
        ...
        {
            return this.Equals(input as PutNewDeviceRequestResourceRequest);
        }

        /// <summary>
        /// Returns true if PutNewDeviceRequestResourceRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PutNewDeviceRequestResourceRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PutNewDeviceRequestResourceRequest input)
        {
            if (input == null)
                return false;
