...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UsageStatisticsResources")]
    public partial class UsageStatisticsResources : IEquatable<UsageStatisticsResources>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UsageStatisticsResources" /> class.
        /// </summary>
        /// <param name="cpu">Total number of CPU usage for tenant microservices, specified in CPU milliseconds (1000m &#x3D; 1 CPU)..</param>
        /// <param name="memory">Total number of memory usage for tenant microservices, specified in MB..</param>
        /// <param name="usedBy">Collection of resources usage for each microservice..</param>
        public UsageStatisticsResources(int cpu = default(int), int memory = default(int), List<UsageStatisticsResourcesUsedBy> usedBy = default(List<UsageStatisticsResourcesUsedBy>))
        {
            this.Cpu = cpu;
            this.Memory = memory;
            this.UsedBy = usedBy;
        ...
        /// </summary>
        /// <value>Total number of CPU usage for tenant microservices, specified in CPU milliseconds (1000m &#x3D; 1 CPU).</value>
        ...
        /// </summary>
        /// <value>Total number of memory usage for tenant microservices, specified in MB.</value>
        ...
        /// </summary>
        /// <value>Collection of resources usage for each microservice.</value>
        ...
        {
            return this.Equals(input as UsageStatisticsResources);
        }

        /// <summary>
        /// Returns true if UsageStatisticsResources instances are equal
        /// </summary>
        /// <param name="input">Instance of UsageStatisticsResources to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UsageStatisticsResources input)
        {
            if (input == null)
            {
                return false;
