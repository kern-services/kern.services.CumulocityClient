...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "putOperationResource_request")]
    public partial class PutOperationResourceRequest : IEquatable<PutOperationResourceRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PutOperationResourceRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PutOperationResourceRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PutOperationResourceRequest" /> class.
        /// </summary>
        /// <param name="deviceExternalIDs">deviceExternalIDs.</param>
        /// <param name="status">The status of the operation. (required).</param>
        public PutOperationResourceRequest(ExternalIds deviceExternalIDs = default(ExternalIds), StatusEnum status = default(StatusEnum))
        {
            this.Status = status;
        ...
        {
            return this.Equals(input as PutOperationResourceRequest);
        }

        /// <summary>
        /// Returns true if PutOperationResourceRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PutOperationResourceRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PutOperationResourceRequest input)
        {
            if (input == null)
            {
                return false;
