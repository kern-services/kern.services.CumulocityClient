...
{
    /// <summary>
    /// GetApplicationsByNameCollectionResource200ResponseAllOf
    /// </summary>
    [DataContract(Name = "getApplicationsByNameCollectionResource_200_response_allOf")]
    public partial class GetApplicationsByNameCollectionResource200ResponseAllOf : IEquatable<GetApplicationsByNameCollectionResource200ResponseAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetApplicationsByNameCollectionResource200ResponseAllOf" /> class.
        /// </summary>
        /// <param name="self">self.</param>
        /// <param name="prev">prev.</param>
        /// <param name="next">next.</param>
        public GetApplicationsByNameCollectionResource200ResponseAllOf(string self = default(string), string prev = default(string), string next = default(string))
        {
            this.Self = self;
            this.Prev = prev;
            this.Next = next;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetApplicationsByNameCollectionResource200ResponseAllOf {\n");
        ...
        {
            return this.Equals(input as GetApplicationsByNameCollectionResource200ResponseAllOf);
        }

        /// <summary>
        /// Returns true if GetApplicationsByNameCollectionResource200ResponseAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of GetApplicationsByNameCollectionResource200ResponseAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetApplicationsByNameCollectionResource200ResponseAllOf input)
        {
            if (input == null)
            {
                return false;
