...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OptionCollection")]
    public partial class OptionCollection : IEquatable<OptionCollection>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OptionCollection" /> class.
        /// </summary>
        /// <param name="statistics">statistics.</param>
        /// <param name="options">An array containing the available options..</param>
        public OptionCollection(PageStatistics statistics = default(PageStatistics), List<Option> options = default(List<Option>))
        {
        ...
        /// </summary>
        /// <value>An array containing the available options.</value>
        ...
        {
            return this.Equals(input as OptionCollection);
        }

        /// <summary>
        /// Returns true if OptionCollection instances are equal
        /// </summary>
        /// <param name="input">Instance of OptionCollection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OptionCollection input)
        {
            if (input == null)
            {
                return false;
