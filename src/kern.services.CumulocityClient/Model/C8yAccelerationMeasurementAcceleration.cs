...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "c8y_AccelerationMeasurement_acceleration")]
    public partial class C8yAccelerationMeasurementAcceleration : IEquatable<C8yAccelerationMeasurementAcceleration>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="C8yAccelerationMeasurementAcceleration" /> class.
        /// </summary>
        /// <param name="value">value.</param>
        /// <param name="unit">unit.</param>
        public C8yAccelerationMeasurementAcceleration(decimal value = default(decimal), string unit = default(string))
        {
            this.Value = value;
            this.Unit = unit;
        }
        ...
        {
            return this.Equals(input as C8yAccelerationMeasurementAcceleration);
        }

        /// <summary>
        /// Returns true if C8yAccelerationMeasurementAcceleration instances are equal
        /// </summary>
        /// <param name="input">Instance of C8yAccelerationMeasurementAcceleration to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(C8yAccelerationMeasurementAcceleration input)
        {
            if (input == null)
            {
                return false;
