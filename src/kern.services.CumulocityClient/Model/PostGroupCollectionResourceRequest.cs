...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "postGroupCollectionResource_request")]
    public partial class PostGroupCollectionResourceRequest : IEquatable<PostGroupCollectionResourceRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostGroupCollectionResourceRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostGroupCollectionResourceRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostGroupCollectionResourceRequest" /> class.
        /// </summary>
        ...
        public PostGroupCollectionResourceRequest(CustomProperties customProperties = default(CustomProperties), string description = default(string), string name = default(string), GroupRoles roles = default(GroupRoles), GroupUsers users = default(GroupUsers))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for PostGroupCollectionResourceRequest and cannot be null");
            }
            this.Name = name;
        ...
        /// </summary>
        /// <value>A unique identifier for this group.</value>
        ...
        {
            return this.Equals(input as PostGroupCollectionResourceRequest);
        }

        /// <summary>
        /// Returns true if PostGroupCollectionResourceRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PostGroupCollectionResourceRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostGroupCollectionResourceRequest input)
        {
            if (input == null)
            {
                return false;
