...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// NotificationToken
    /// </summary>
    [DataContract(Name = "NotificationToken")]
    public partial class NotificationToken : IEquatable<NotificationToken>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NotificationToken" /> class.
        /// </summary>
        /// <param name="token">JWT (JSON Web Token) access token..</param>
        public NotificationToken(string token = default(string))
        {
            this.Token = token;
        }
        ...
        /// </summary>
        /// <value>JWT (JSON Web Token) access token.</value>
        ...
        {
            return this.Equals(input as NotificationToken);
        }

        /// <summary>
        /// Returns true if NotificationToken instances are equal
        /// </summary>
        /// <param name="input">Instance of NotificationToken to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NotificationToken input)
        {
            if (input == null)
            {
                return false;
