...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "authConfig_logoutRequest")]
    public partial class AuthConfigLogoutRequest : IEquatable<AuthConfigLogoutRequest>, IValidatableObject
    {
        /// <summary>
        /// HTTP request method.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthConfigLogoutRequest" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as AuthConfigLogoutRequest);
        }

        /// <summary>
        /// Returns true if AuthConfigLogoutRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthConfigLogoutRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthConfigLogoutRequest input)
        {
            if (input == null)
            {
                return false;
