...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// Alarm
    /// </summary>
    [DataContract(Name = "alarm")]
    public partial class Alarm : Dictionary<String, Object>, IEquatable<Alarm>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="text">Description of the alarm..</param>
        /// <param name="time">The date and time when the alarm is triggered..</param>
        /// <param name="type">Identifies the type of this alarm..</param>
        public Alarm(SeverityEnum? severity = default(SeverityEnum?), AlarmSource source = default(AlarmSource), StatusEnum? status = default(StatusEnum?), string text = default(string), DateTime time = default(DateTime), string type = default(string)) : base()
        {
        ...
        {
            return this.Equals(input as Alarm);
        }

        /// <summary>
        /// Returns true if Alarm instances are equal
        /// </summary>
        /// <param name="input">Instance of Alarm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Alarm input)
        {
            if (input == null)
            {
                return false;
