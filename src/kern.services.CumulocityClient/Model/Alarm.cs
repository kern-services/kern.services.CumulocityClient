...
namespace kern.services.CumulocityClient.Model
{
    ...
    public partial class Alarm : IValidatableObject
    {
        /// <summary>
        ...
        public Alarm(SeverityEnum? severity = default(SeverityEnum?), AlarmSource source = default(AlarmSource), StatusEnum? status = default(StatusEnum?), string text = default(string), DateTime time = default(DateTime), string type = default(string))
        {
