...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TrustedCertificateCollection")]
    public partial class TrustedCertificateCollection : IEquatable<TrustedCertificateCollection>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrustedCertificateCollection" /> class.
        /// </summary>
        /// <param name="certificates">An array containing trusted certificates..</param>
        /// <param name="statistics">statistics.</param>
        public TrustedCertificateCollection(List<TrustedCertificate> certificates = default(List<TrustedCertificate>), PageStatistics statistics = default(PageStatistics))
        {
        ...
        /// </summary>
        /// <value>An array containing trusted certificates.</value>
        ...
        {
            return this.Equals(input as TrustedCertificateCollection);
        }

        /// <summary>
        /// Returns true if TrustedCertificateCollection instances are equal
        /// </summary>
        /// <param name="input">Instance of TrustedCertificateCollection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrustedCertificateCollection input)
        {
            if (input == null)
            {
                return false;
