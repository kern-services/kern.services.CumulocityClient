...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getManagedObjectChildAssetResource_200_response")]
    public partial class GetManagedObjectChildAssetResource200Response : IEquatable<GetManagedObjectChildAssetResource200Response>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetManagedObjectChildAssetResource200Response" /> class.
        /// </summary>
        /// <param name="managedObject">managedObject.</param>
        /// <param name="self">self.</param>
        public GetManagedObjectChildAssetResource200Response(ManagedObject managedObject = default(ManagedObject), Object self = default(Object))
        {
        ...
        {
            return this.Equals(input as GetManagedObjectChildAssetResource200Response);
        }

        /// <summary>
        /// Returns true if GetManagedObjectChildAssetResource200Response instances are equal
        /// </summary>
        /// <param name="input">Instance of GetManagedObjectChildAssetResource200Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetManagedObjectChildAssetResource200Response input)
        {
            if (input == null)
            {
                return false;
