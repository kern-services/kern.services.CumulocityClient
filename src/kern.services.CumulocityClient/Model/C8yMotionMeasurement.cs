...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "c8y_MotionMeasurement")]
    public partial class C8yMotionMeasurement : IEquatable<C8yMotionMeasurement>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="C8yMotionMeasurement" /> class.
        /// </summary>
        /// <param name="motionDetected">motionDetected.</param>
        /// <param name="speed">speed.</param>
        public C8yMotionMeasurement(C8yMotionMeasurementMotionDetected motionDetected = default(C8yMotionMeasurementMotionDetected), C8yMotionMeasurementSpeed speed = default(C8yMotionMeasurementSpeed))
        {
        ...
        /// <summary>
        /// Gets or Sets MotionDetected
        /// </summary>
        [DataMember(Name = "motionDetected", EmitDefaultValue = false)]
        public C8yMotionMeasurementMotionDetected MotionDetected { get; set; }

        /// <summary>
        /// Gets or Sets Speed
        /// </summary>
        [DataMember(Name = "speed", EmitDefaultValue = false)]
        public C8yMotionMeasurementSpeed Speed { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  MotionDetected: ").Append(MotionDetected).Append("\n");
        ...
        {
            return this.Equals(input as C8yMotionMeasurement);
        }

        /// <summary>
        /// Returns true if C8yMotionMeasurement instances are equal
        /// </summary>
        /// <param name="input">Instance of C8yMotionMeasurement to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(C8yMotionMeasurement input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.MotionDetected == input.MotionDetected ||
                    (this.MotionDetected != null &&
                    this.MotionDetected.Equals(input.MotionDetected))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.MotionDetected != null)
                {
                    hashCode = (hashCode * 59) + this.MotionDetected.GetHashCode();
                }
                if (this.Speed != null)
                {
