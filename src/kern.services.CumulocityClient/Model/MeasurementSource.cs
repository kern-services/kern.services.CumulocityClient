...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "measurement_source")]
    public partial class MeasurementSource : IEquatable<MeasurementSource>, IValidatableObject
    {
        /// <summary>
        ...
        public MeasurementSource(string id = default(string))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for MeasurementSource and cannot be null");
            }
            this.Id = id;
        }
        ...
        {
            return this.Equals(input as MeasurementSource);
        }

        /// <summary>
        /// Returns true if MeasurementSource instances are equal
        /// </summary>
        /// <param name="input">Instance of MeasurementSource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MeasurementSource input)
        {
            if (input == null)
            {
                return false;
