...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "authConfig_signatureVerificationConfig_manual")]
    public partial class AuthConfigSignatureVerificationConfigManual : IEquatable<AuthConfigSignatureVerificationConfigManual>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthConfigSignatureVerificationConfigManual" /> class.
        /// </summary>
        /// <param name="certIdField">The name of the field in the JWT access token containing the certificate identifier..</param>
        /// <param name="certIdFromField">Indicates whether the certificate identifier should be read from the JWT access token..</param>
        /// <param name="certificates">certificates.</param>
        public AuthConfigSignatureVerificationConfigManual(string certIdField = default(string), bool certIdFromField = default(bool), AuthConfigSignatureVerificationConfigManualCertificates certificates = default(AuthConfigSignatureVerificationConfigManualCertificates))
        {
        ...
        /// </summary>
        /// <value>The name of the field in the JWT access token containing the certificate identifier.</value>
        [DataMember(Name = "certIdField", EmitDefaultValue = false)]
        public string CertIdField { get; set; }

        /// <summary>
        /// Indicates whether the certificate identifier should be read from the JWT access token.
        /// </summary>
        /// <value>Indicates whether the certificate identifier should be read from the JWT access token.</value>
        [DataMember(Name = "certIdFromField", EmitDefaultValue = true)]
        ...
        public AuthConfigSignatureVerificationConfigManualCertificates Certificates { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CertIdField: ").Append(CertIdField).Append("\n");
            sb.Append("  CertIdFromField: ").Append(CertIdFromField).Append("\n");
        ...
        {
            return this.Equals(input as AuthConfigSignatureVerificationConfigManual);
        }

        /// <summary>
        /// Returns true if AuthConfigSignatureVerificationConfigManual instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthConfigSignatureVerificationConfigManual to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthConfigSignatureVerificationConfigManual input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.CertIdField == input.CertIdField ||
                    (this.CertIdField != null &&
                    this.CertIdField.Equals(input.CertIdField))
                ) && 
                (
                    this.CertIdFromField == input.CertIdFromField ||
                    this.CertIdFromField.Equals(input.CertIdFromField)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.CertIdField != null)
                {
                    hashCode = (hashCode * 59) + this.CertIdField.GetHashCode();
                }
                hashCode = (hashCode * 59) + this.CertIdFromField.GetHashCode();
