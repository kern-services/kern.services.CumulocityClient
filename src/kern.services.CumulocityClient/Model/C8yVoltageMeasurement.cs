...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "c8y_VoltageMeasurement")]
    public partial class C8yVoltageMeasurement : IEquatable<C8yVoltageMeasurement>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="C8yVoltageMeasurement" /> class.
        /// </summary>
        /// <param name="voltage">voltage.</param>
        public C8yVoltageMeasurement(C8yVoltageMeasurementVoltage voltage = default(C8yVoltageMeasurementVoltage))
        {
        ...
        public C8yVoltageMeasurementVoltage Voltage { get; set; }
        ...
        {
            return this.Equals(input as C8yVoltageMeasurement);
        }

        /// <summary>
        /// Returns true if C8yVoltageMeasurement instances are equal
        /// </summary>
        /// <param name="input">Instance of C8yVoltageMeasurement to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(C8yVoltageMeasurement input)
        {
            if (input == null)
            {
                return false;
