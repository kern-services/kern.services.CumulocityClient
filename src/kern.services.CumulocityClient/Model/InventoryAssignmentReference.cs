...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "inventoryAssignmentReference")]
    public partial class InventoryAssignmentReference : IEquatable<InventoryAssignmentReference>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InventoryAssignmentReference" /> class.
        /// </summary>
        /// <param name="roles">An array of roles that are assigned to the managed object for the user..</param>
        public InventoryAssignmentReference(List<InventoryAssignmentReferenceRolesInner> roles = default(List<InventoryAssignmentReferenceRolesInner>))
        {
            this.Roles = roles;
        }
        ...
        public List<InventoryAssignmentReferenceRolesInner> Roles { get; set; }
        ...
        {
            return this.Equals(input as InventoryAssignmentReference);
        }

        /// <summary>
        /// Returns true if InventoryAssignmentReference instances are equal
        /// </summary>
        /// <param name="input">Instance of InventoryAssignmentReference to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InventoryAssignmentReference input)
        {
            if (input == null)
            {
                return false;
