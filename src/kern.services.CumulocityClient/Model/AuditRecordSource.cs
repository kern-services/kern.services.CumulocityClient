...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "auditRecord_source")]
    public partial class AuditRecordSource : IEquatable<AuditRecordSource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditRecordSource" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AuditRecordSource() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditRecordSource" /> class.
        /// </summary>
        /// <param name="id">Unique identifier of the object. (required).</param>
        public AuditRecordSource(string id = default(string))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for AuditRecordSource and cannot be null");
            }
            this.Id = id;
        }
        ...
        {
            return this.Equals(input as AuditRecordSource);
        }

        /// <summary>
        /// Returns true if AuditRecordSource instances are equal
        /// </summary>
        /// <param name="input">Instance of AuditRecordSource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuditRecordSource input)
        {
            if (input == null)
            {
                return false;
