...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CurrentTenant :  IEquatable<CurrentTenant>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CurrentTenant" /> class.
        /// </summary>
        /// <param name="allowCreateTenants">Indicates if this tenant can create subtenants. (default to false).</param>
        /// <param name="applications">applications.</param>
        /// <param name="customProperties">customProperties.</param>
        /// <param name="domainName">URL of the tenant&#39;s domain. The domain name permits only the use of alphanumeric characters separated by dots &#x60;.&#x60;, hyphens &#x60;-&#x60; and underscores &#x60;_&#x60;..</param>
        /// <param name="parent">ID of the parent tenant..</param>
        public CurrentTenant(bool allowCreateTenants = false, CurrentTenantApplications applications = default(CurrentTenantApplications), CustomProperties customProperties = default(CustomProperties), string domainName = default(string), string parent = default(string))
        {
            // use default value if no "allowCreateTenants" provided
            if (allowCreateTenants == null)
            {
                this.AllowCreateTenants = false;
            }
            else
            {
        ...
        public CurrentTenantApplications Applications { get; set; }
        ...
        {
            return this.Equals(input as CurrentTenant);
        }

        /// <summary>
        /// Returns true if CurrentTenant instances are equal
        /// </summary>
        /// <param name="input">Instance of CurrentTenant to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CurrentTenant input)
        {
            if (input == null)
                return false;
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if(this.DomainName != null && this.DomainName.Length > 256)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for DomainName, length must be less than 256.", new [] { "DomainName" });
            }

            // DomainName (string) minLength
            if(this.DomainName != null && this.DomainName.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for DomainName, length must be greater than 1.", new [] { "DomainName" });
            }
