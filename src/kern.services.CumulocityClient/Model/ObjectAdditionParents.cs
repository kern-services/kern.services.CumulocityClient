...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "objectAdditionParents")]
    public partial class ObjectAdditionParents : IEquatable<ObjectAdditionParents>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ObjectAdditionParents" /> class.
        /// </summary>
        /// <param name="references">An array with the references to addition parent objects..</param>
        /// <param name="self">Link to this resource&#39;s addition parent objects..</param>
        public ObjectAdditionParents(List<ManagedObjectReferenceTuple> references = default(List<ManagedObjectReferenceTuple>), string self = default(string))
        {
        ...
        /// </summary>
        /// <value>An array with the references to addition parent objects.</value>
        ...
        /// </summary>
        /// <value>Link to this resource&#39;s addition parent objects.</value>
        ...
        {
            return this.Equals(input as ObjectAdditionParents);
        }

        /// <summary>
        /// Returns true if ObjectAdditionParents instances are equal
        /// </summary>
        /// <param name="input">Instance of ObjectAdditionParents to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ObjectAdditionParents input)
        {
            if (input == null)
            {
                return false;
