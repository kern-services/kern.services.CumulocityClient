...
{
    /// <summary>
    /// PutNewDeviceRequestResourceRequestAllOf
    /// </summary>
    [DataContract(Name = "putNewDeviceRequestResource_request_allOf")]
    public partial class PutNewDeviceRequestResourceRequestAllOf : IEquatable<PutNewDeviceRequestResourceRequestAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PutNewDeviceRequestResourceRequestAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public PutNewDeviceRequestResourceRequestAllOf()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PutNewDeviceRequestResourceRequestAllOf {\n");
        ...
        {
            return this.Equals(input as PutNewDeviceRequestResourceRequestAllOf);
        }

        /// <summary>
        /// Returns true if PutNewDeviceRequestResourceRequestAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of PutNewDeviceRequestResourceRequestAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PutNewDeviceRequestResourceRequestAllOf input)
        {
            if (input == null)
            {
                return false;
