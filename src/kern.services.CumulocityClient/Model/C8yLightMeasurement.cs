...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "c8y_LightMeasurement")]
    public partial class C8yLightMeasurement : IEquatable<C8yLightMeasurement>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="C8yLightMeasurement" /> class.
        /// </summary>
        /// <param name="e">e.</param>
        public C8yLightMeasurement(C8yLightMeasurementE e = default(C8yLightMeasurementE))
        {
            this.E = e;
        }
        ...
        public C8yLightMeasurementE E { get; set; }
        ...
        {
            return this.Equals(input as C8yLightMeasurement);
        }

        /// <summary>
        /// Returns true if C8yLightMeasurement instances are equal
        /// </summary>
        /// <param name="input">Instance of C8yLightMeasurement to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(C8yLightMeasurement input)
        {
            if (input == null)
            {
                return false;
