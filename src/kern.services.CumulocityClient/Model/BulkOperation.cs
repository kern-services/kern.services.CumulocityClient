...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// BulkOperation
    /// </summary>
    [DataContract(Name = "bulkOperation")]
    public partial class BulkOperation : IEquatable<BulkOperation>, IValidatableObject
    {
        /// <summary>
        /// The status of this bulk operation, in context of the execution of all its single operations.
        /// </summary>
        /// <value>The status of this bulk operation, in context of the execution of all its single operations.</value>
        ...
        /// </summary>
        /// <value>The general status of this bulk operation. The general status is visible for end users and they can filter and evaluate bulk operations by this status.</value>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum GeneralStatusEnum
        {
            ...
            /// <summary>
            /// Enum EXECUTINGWITHERRORS for value: EXECUTING_WITH_ERRORS
            /// </summary>
            [EnumMember(Value = "EXECUTING_WITH_ERRORS")]
            EXECUTINGWITHERRORS = 3,
        ...
        /// </summary>
        /// <value>The general status of this bulk operation. The general status is visible for end users and they can filter and evaluate bulk operations by this status.</value>
        [DataMember(Name = "generalStatus", EmitDefaultValue = false)]
        public GeneralStatusEnum? GeneralStatus { get; set; }

        /// <summary>
        /// Returns false as GeneralStatus should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeGeneralStatus()
        {
            return false;
        }
        /// <summary>
        ...
        /// </summary>
        /// <param name="groupId">Identifies the target group on which this operation should be performed. &gt;**&amp;#9432; Info:** &#x60;groupId&#x60; and &#x60;failedParentId&#x60; are mutually exclusive. Use only one of them in your request. .</param>
        /// <param name="failedParentId">Identifies the failed bulk operation from which the failed operations should be rescheduled. &gt;**&amp;#9432; Info:** &#x60;groupId&#x60; and &#x60;failedParentId&#x60; are mutually exclusive. Use only one of them in your request. .</param>
        /// <param name="startDate">Date and time when the operations of this bulk operation should be created..</param>
        /// <param name="creationRamp">Delay between every operation creation in seconds..</param>
        /// <param name="operationPrototype">Operation to be executed for every device in a group..</param>
        /// <param name="progress">progress.</param>
        public BulkOperation(string groupId = default(string), string failedParentId = default(string), DateTime startDate = default(DateTime), float creationRamp = default(float), Object operationPrototype = default(Object), BulkOperationProgress progress = default(BulkOperationProgress))
        {
        ...
        /// </summary>
        /// <value>Unique identifier of this bulk operation.</value>
        ...
        /// <summary>
        /// Identifies the target group on which this operation should be performed. &gt;**&amp;#9432; Info:** &#x60;groupId&#x60; and &#x60;failedParentId&#x60; are mutually exclusive. Use only one of them in your request. 
        /// </summary>
        /// <value>Identifies the target group on which this operation should be performed. &gt;**&amp;#9432; Info:** &#x60;groupId&#x60; and &#x60;failedParentId&#x60; are mutually exclusive. Use only one of them in your request. </value>
        [DataMember(Name = "groupId", EmitDefaultValue = false)]
        public string GroupId { get; set; }

        /// <summary>
        /// Identifies the failed bulk operation from which the failed operations should be rescheduled. &gt;**&amp;#9432; Info:** &#x60;groupId&#x60; and &#x60;failedParentId&#x60; are mutually exclusive. Use only one of them in your request. 
        /// </summary>
        /// <value>Identifies the failed bulk operation from which the failed operations should be rescheduled. &gt;**&amp;#9432; Info:** &#x60;groupId&#x60; and &#x60;failedParentId&#x60; are mutually exclusive. Use only one of them in your request. </value>
        [DataMember(Name = "failedParentId", EmitDefaultValue = false)]
        public string FailedParentId { get; set; }

        /// <summary>
        /// Date and time when the operations of this bulk operation should be created.
        /// </summary>
        /// <value>Date and time when the operations of this bulk operation should be created.</value>
        ...
        /// </summary>
        /// <value>Delay between every operation creation in seconds.</value>
        [DataMember(Name = "creationRamp", EmitDefaultValue = false)]
        public float CreationRamp { get; set; }

        /// <summary>
        /// Operation to be executed for every device in a group.
        /// </summary>
        /// <value>Operation to be executed for every device in a group.</value>
        [DataMember(Name = "operationPrototype", EmitDefaultValue = false)]
        public Object OperationPrototype { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  FailedParentId: ").Append(FailedParentId).Append("\n");
            sb.Append("  StartDate: ").Append(StartDate).Append("\n");
            sb.Append("  CreationRamp: ").Append(CreationRamp).Append("\n");
            sb.Append("  OperationPrototype: ").Append(OperationPrototype).Append("\n");
            sb.Append("  Status: ").Append(Status).Append("\n");
            sb.Append("  GeneralStatus: ").Append(GeneralStatus).Append("\n");
        ...
        {
            return this.Equals(input as BulkOperation);
        }

        /// <summary>
        /// Returns true if BulkOperation instances are equal
        /// </summary>
        /// <param name="input">Instance of BulkOperation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BulkOperation input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.FailedParentId == input.FailedParentId ||
                    (this.FailedParentId != null &&
                    this.FailedParentId.Equals(input.FailedParentId))
                ) && 
                (
                ...
                (
                    this.CreationRamp == input.CreationRamp ||
                    this.CreationRamp.Equals(input.CreationRamp)
                ) && 
                (
                    this.OperationPrototype == input.OperationPrototype ||
                    (this.OperationPrototype != null &&
                    this.OperationPrototype.Equals(input.OperationPrototype))
                ) && 
                (
                ...
                (
                    this.GeneralStatus == input.GeneralStatus ||
                    this.GeneralStatus.Equals(input.GeneralStatus)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.FailedParentId != null)
                {
                    hashCode = (hashCode * 59) + this.FailedParentId.GetHashCode();
                }
                if (this.StartDate != null)
                {
                    hashCode = (hashCode * 59) + this.StartDate.GetHashCode();
                }
                hashCode = (hashCode * 59) + this.CreationRamp.GetHashCode();
                if (this.OperationPrototype != null)
                {
                    hashCode = (hashCode * 59) + this.OperationPrototype.GetHashCode();
                }
                hashCode = (hashCode * 59) + this.Status.GetHashCode();
                hashCode = (hashCode * 59) + this.GeneralStatus.GetHashCode();
