...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// SubscribedRole
    /// </summary>
    [DataContract(Name = "SubscribedRole")]
    public partial class SubscribedRole : IEquatable<SubscribedRole>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscribedRole" /> class.
        /// </summary>
        /// <param name="role">role.</param>
        public SubscribedRole(SubscribedRoleRole role = default(SubscribedRoleRole))
        {
            this.Role = role;
        }
        ...
        public SubscribedRoleRole Role { get; set; }
        ...
        {
            return this.Equals(input as SubscribedRole);
        }

        /// <summary>
        /// Returns true if SubscribedRole instances are equal
        /// </summary>
        /// <param name="input">Instance of SubscribedRole to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubscribedRole input)
        {
            if (input == null)
            {
                return false;
