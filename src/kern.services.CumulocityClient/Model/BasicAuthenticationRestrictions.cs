...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BasicAuthenticationRestrictions")]
    public partial class BasicAuthenticationRestrictions : IEquatable<BasicAuthenticationRestrictions>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BasicAuthenticationRestrictions" /> class.
        /// </summary>
        /// <param name="forbiddenClients">List of types of clients which are not allowed to use basic authentication. Currently the only supported option is WEB_BROWSERS..</param>
        /// <param name="forbiddenUserAgents">List of user agents, passed in &#x60;User-Agent&#x60; HTTP header, which are blocked if basic authentication is used..</param>
        /// <param name="trustedUserAgents">List of user agents, passed in &#x60;User-Agent&#x60; HTTP header, which are allowed to use basic authentication..</param>
        public BasicAuthenticationRestrictions(List<string> forbiddenClients = default(List<string>), List<string> forbiddenUserAgents = default(List<string>), List<string> trustedUserAgents = default(List<string>))
        {
        ...
        /// </summary>
        /// <value>List of types of clients which are not allowed to use basic authentication. Currently the only supported option is WEB_BROWSERS.</value>
        [DataMember(Name = "forbiddenClients", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>List of user agents, passed in &#x60;User-Agent&#x60; HTTP header, which are blocked if basic authentication is used.</value>
        [DataMember(Name = "forbiddenUserAgents", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>List of user agents, passed in &#x60;User-Agent&#x60; HTTP header, which are allowed to use basic authentication.</value>
        [DataMember(Name = "trustedUserAgents", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ForbiddenClients: ").Append(ForbiddenClients).Append("\n");
            sb.Append("  ForbiddenUserAgents: ").Append(ForbiddenUserAgents).Append("\n");
            sb.Append("  TrustedUserAgents: ").Append(TrustedUserAgents).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as BasicAuthenticationRestrictions);
        }

        /// <summary>
        /// Returns true if BasicAuthenticationRestrictions instances are equal
        /// </summary>
        /// <param name="input">Instance of BasicAuthenticationRestrictions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BasicAuthenticationRestrictions input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.ForbiddenClients == input.ForbiddenClients ||
                    this.ForbiddenClients != null &&
                    input.ForbiddenClients != null &&
                    this.ForbiddenClients.SequenceEqual(input.ForbiddenClients)
                ) && 
                (
                    this.ForbiddenUserAgents == input.ForbiddenUserAgents ||
                    this.ForbiddenUserAgents != null &&
                    input.ForbiddenUserAgents != null &&
                    this.ForbiddenUserAgents.SequenceEqual(input.ForbiddenUserAgents)
                ) && 
                (
                    this.TrustedUserAgents == input.TrustedUserAgents ||
                    this.TrustedUserAgents != null &&
                    input.TrustedUserAgents != null &&
                    this.TrustedUserAgents.SequenceEqual(input.TrustedUserAgents)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.ForbiddenClients.GetHashCode();
                }
                if (this.ForbiddenUserAgents != null)
                {
                    hashCode = (hashCode * 59) + this.ForbiddenUserAgents.GetHashCode();
                }
                if (this.TrustedUserAgents != null)
                {
                    hashCode = (hashCode * 59) + this.TrustedUserAgents.GetHashCode();
                }
                return hashCode;
            }
        }
