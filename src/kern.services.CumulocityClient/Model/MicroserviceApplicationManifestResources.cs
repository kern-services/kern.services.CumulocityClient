...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "microservice_application_manifest_resources")]
    public partial class MicroserviceApplicationManifestResources : IEquatable<MicroserviceApplicationManifestResources>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MicroserviceApplicationManifestResources" /> class.
        /// </summary>
        ...
        public MicroserviceApplicationManifestResources(string cpu = default(string), string memory = default(string))
        {
            this.Cpu = cpu;
            this.Memory = memory;
        }
        ...
        {
            return this.Equals(input as MicroserviceApplicationManifestResources);
        }

        /// <summary>
        /// Returns true if MicroserviceApplicationManifestResources instances are equal
        /// </summary>
        /// <param name="input">Instance of MicroserviceApplicationManifestResources to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MicroserviceApplicationManifestResources input)
        {
            if (input == null)
            {
                return false;
