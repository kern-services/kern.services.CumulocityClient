...
namespace kern.services.CumulocityClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AuthConfigAccess :  IEquatable<AuthConfigAccess>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthConfigAccess" /> class.
        /// </summary>
        /// <param name="onlyManagementTenantAccess">Indicates whether the configuration is only accessible to the management tenant. (default to false).</param>
        public AuthConfigAccess(bool onlyManagementTenantAccess = false)
        {
            // use default value if no "onlyManagementTenantAccess" provided
            if (onlyManagementTenantAccess == null)
            {
                this.OnlyManagementTenantAccess = false;
            }
            else
            {
        ...
        {
            return this.Equals(input as AuthConfigAccess);
        }

        /// <summary>
        /// Returns true if AuthConfigAccess instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthConfigAccess to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthConfigAccess input)
        {
            if (input == null)
                return false;
