...
namespace kern.services.CumulocityClient.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "10.15.1";
        ...
        {
            UserAgent = "OpenAPI-Generator/10.15.1/csharp";
            BasePath = "https://<TENANT_DOMAIN>";
        ...
        public Configuration(
            ...
            string basePath = "https://<TENANT_DOMAIN>") : this()
        {
        ...
        public Configuration(
            ...
            int timeout = 100000,
            string userAgent = "OpenAPI-Generator/10.15.1/csharp"
        ...
        {
            String report = "C# SDK (kern.services.CumulocityClient) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: Release 10.15.0\n";
            report += "    SDK Package Version: 10.15.1\n";
