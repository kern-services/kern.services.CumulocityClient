...
namespace kern.services.CumulocityClient.Api
{
    ...
    /// </summary>
    public interface IDeviceStatisticsApiSync : IApiAccessor
    {
        ...
        /// <param name="deviceId">The ID of the device to search for. (optional)</param>
        ...
        /// <returns>DeviceStatisticsCollection</returns>
        DeviceStatisticsCollection GetTenantDeviceStatisticsDailyCollection(string tenantId, DateOnly date, int? currentPage = default(int?), string? deviceId = default(string?), int? pageSize = default(int?), bool? withTotalPages = default(bool?), int operationIndex = 0);
        ...
        /// <param name="withTotalPages">When set to &#x60;true&#x60;, the returned result will contain in the statistics object the total number of pages. Only applicable on [range queries](https://en.wikipedia.org/wiki/Range_query_(database)). (optional, default to false)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of DeviceStatisticsCollection</returns>
        ApiResponse<DeviceStatisticsCollection> GetTenantDeviceStatisticsDailyCollectionWithHttpInfo(string tenantId, DateOnly date, int? currentPage = default(int?), string? deviceId = default(string?), int? pageSize = default(int?), bool? withTotalPages = default(bool?), int operationIndex = 0);
        /// <summary>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>DeviceStatisticsCollection</returns>
        DeviceStatisticsCollection GetTenantDeviceStatisticsMonthlyCollection(string tenantId, DateOnly date, int? currentPage = default(int?), string? deviceId = default(string?), int? pageSize = default(int?), bool? withTotalPages = default(bool?), int operationIndex = 0);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of DeviceStatisticsCollection</returns>
        ApiResponse<DeviceStatisticsCollection> GetTenantDeviceStatisticsMonthlyCollectionWithHttpInfo(string tenantId, DateOnly date, int? currentPage = default(int?), string? deviceId = default(string?), int? pageSize = default(int?), bool? withTotalPages = default(bool?), int operationIndex = 0);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IDeviceStatisticsApiAsync : IApiAccessor
    {
        ...
        /// <returns>Task of DeviceStatisticsCollection</returns>
        System.Threading.Tasks.Task<DeviceStatisticsCollection> GetTenantDeviceStatisticsDailyCollectionAsync(string tenantId, DateOnly date, int? currentPage = default(int?), string? deviceId = default(string?), int? pageSize = default(int?), bool? withTotalPages = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DeviceStatisticsCollection)</returns>
        System.Threading.Tasks.Task<ApiResponse<DeviceStatisticsCollection>> GetTenantDeviceStatisticsDailyCollectionWithHttpInfoAsync(string tenantId, DateOnly date, int? currentPage = default(int?), string? deviceId = default(string?), int? pageSize = default(int?), bool? withTotalPages = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Retrieve monthly device statistics
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of DeviceStatisticsCollection</returns>
        System.Threading.Tasks.Task<DeviceStatisticsCollection> GetTenantDeviceStatisticsMonthlyCollectionAsync(string tenantId, DateOnly date, int? currentPage = default(int?), string? deviceId = default(string?), int? pageSize = default(int?), bool? withTotalPages = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DeviceStatisticsCollection)</returns>
        System.Threading.Tasks.Task<ApiResponse<DeviceStatisticsCollection>> GetTenantDeviceStatisticsMonthlyCollectionWithHttpInfoAsync(string tenantId, DateOnly date, int? currentPage = default(int?), string? deviceId = default(string?), int? pageSize = default(int?), bool? withTotalPages = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IDeviceStatisticsApi : IDeviceStatisticsApiSync, IDeviceStatisticsApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class DeviceStatisticsApi : IDeviceStatisticsApi
    {
        private kern.services.CumulocityClient.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceStatisticsApi"/> class.
        /// </summary>
        /// <returns></returns>
        public DeviceStatisticsApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public DeviceStatisticsApi(string basePath)
        {
        ...
        /// <returns></returns>
        public DeviceStatisticsApi(kern.services.CumulocityClient.Client.Configuration configuration)
        {
        ...
        public DeviceStatisticsApi(kern.services.CumulocityClient.Client.ISynchronousClient client, kern.services.CumulocityClient.Client.IAsynchronousClient asyncClient, kern.services.CumulocityClient.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Retrieve daily device statistics Retrieve daily device statistics from a specific tenant (by a given ID).  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_TENANT_STATISTICS_READ &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="tenantId">Unique identifier of a Cumulocity IoT tenant.</param>
        /// <param name="date">Date (format YYYY-MM-dd) of the queried day.</param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>DeviceStatisticsCollection</returns>
        public DeviceStatisticsCollection GetTenantDeviceStatisticsDailyCollection(string tenantId, DateOnly date, int? currentPage = default(int?), string? deviceId = default(string?), int? pageSize = default(int?), bool? withTotalPages = default(bool?), int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<DeviceStatisticsCollection> localVarResponse = GetTenantDeviceStatisticsDailyCollectionWithHttpInfo(tenantId, date, currentPage, deviceId, pageSize, withTotalPages);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of DeviceStatisticsCollection</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<DeviceStatisticsCollection> GetTenantDeviceStatisticsDailyCollectionWithHttpInfo(string tenantId, DateOnly date, int? currentPage = default(int?), string? deviceId = default(string?), int? pageSize = default(int?), bool? withTotalPages = default(bool?), int operationIndex = 0)
        {
            // verify the required parameter 'tenantId' is set
            if (tenantId == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'tenantId' when calling DeviceStatisticsApi->GetTenantDeviceStatisticsDailyCollection");
            }

            // verify the required parameter 'date' is set
            if (date == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'date' when calling DeviceStatisticsApi->GetTenantDeviceStatisticsDailyCollection");
            }
            ...
            localVarRequestOptions.PathParameters.Add("date", kern.services.CumulocityClient.Client.ClientUtils.ParameterToString(date)); // path parameter
            if (currentPage != null)
            {
            ...
            localVarRequestOptions.Operation = "DeviceStatisticsApi.GetTenantDeviceStatisticsDailyCollection";
            ...
            var localVarResponse = this.Client.Get<DeviceStatisticsCollection>("/tenant/statistics/device/{tenantId}/daily/{date}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetTenantDeviceStatisticsDailyCollection", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of DeviceStatisticsCollection</returns>
        public async System.Threading.Tasks.Task<DeviceStatisticsCollection> GetTenantDeviceStatisticsDailyCollectionAsync(string tenantId, DateOnly date, int? currentPage = default(int?), string? deviceId = default(string?), int? pageSize = default(int?), bool? withTotalPages = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<DeviceStatisticsCollection> localVarResponse = await GetTenantDeviceStatisticsDailyCollectionWithHttpInfoAsync(tenantId, date, currentPage, deviceId, pageSize, withTotalPages, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<DeviceStatisticsCollection>> GetTenantDeviceStatisticsDailyCollectionWithHttpInfoAsync(string tenantId, DateOnly date, int? currentPage = default(int?), string? deviceId = default(string?), int? pageSize = default(int?), bool? withTotalPages = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<DeviceStatisticsCollection>("/tenant/statistics/device/{tenantId}/daily/{date}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Retrieve monthly device statistics Retrieve monthly device statistics from a specific tenant (by a given ID).  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_TENANT_STATISTICS_READ &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="tenantId">Unique identifier of a Cumulocity IoT tenant.</param>
        /// <param name="date">Date (format YYYY-MM-dd) of the queried month (the day value is ignored).</param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>DeviceStatisticsCollection</returns>
        public DeviceStatisticsCollection GetTenantDeviceStatisticsMonthlyCollection(string tenantId, DateOnly date, int? currentPage = default(int?), string? deviceId = default(string?), int? pageSize = default(int?), bool? withTotalPages = default(bool?), int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<DeviceStatisticsCollection> localVarResponse = GetTenantDeviceStatisticsMonthlyCollectionWithHttpInfo(tenantId, date, currentPage, deviceId, pageSize, withTotalPages);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of DeviceStatisticsCollection</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<DeviceStatisticsCollection> GetTenantDeviceStatisticsMonthlyCollectionWithHttpInfo(string tenantId, DateOnly date, int? currentPage = default(int?), string? deviceId = default(string?), int? pageSize = default(int?), bool? withTotalPages = default(bool?), int operationIndex = 0)
        {
            // verify the required parameter 'tenantId' is set
            if (tenantId == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'tenantId' when calling DeviceStatisticsApi->GetTenantDeviceStatisticsMonthlyCollection");
            }

            // verify the required parameter 'date' is set
            if (date == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'date' when calling DeviceStatisticsApi->GetTenantDeviceStatisticsMonthlyCollection");
            }
            ...
            localVarRequestOptions.Operation = "DeviceStatisticsApi.GetTenantDeviceStatisticsMonthlyCollection";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<DeviceStatisticsCollection>("/tenant/statistics/device/{tenantId}/monthly/{date}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetTenantDeviceStatisticsMonthlyCollection", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of DeviceStatisticsCollection</returns>
        public async System.Threading.Tasks.Task<DeviceStatisticsCollection> GetTenantDeviceStatisticsMonthlyCollectionAsync(string tenantId, DateOnly date, int? currentPage = default(int?), string? deviceId = default(string?), int? pageSize = default(int?), bool? withTotalPages = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<DeviceStatisticsCollection> localVarResponse = await GetTenantDeviceStatisticsMonthlyCollectionWithHttpInfoAsync(tenantId, date, currentPage, deviceId, pageSize, withTotalPages, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<DeviceStatisticsCollection>> GetTenantDeviceStatisticsMonthlyCollectionWithHttpInfoAsync(string tenantId, DateOnly date, int? currentPage = default(int?), string? deviceId = default(string?), int? pageSize = default(int?), bool? withTotalPages = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<DeviceStatisticsCollection>("/tenant/statistics/device/{tenantId}/monthly/{date}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
