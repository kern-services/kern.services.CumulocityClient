...
namespace kern.services.CumulocityClient.Api
{
    ...
    public interface IRolesApiSync : IApiAccessor
    {
        ...
        /// <returns></returns>
        void DeleteGroupRoleReferenceResource(string tenantId, int groupId, string roleId, int operationIndex = 0);
        ...
        ApiResponse<Object> DeleteGroupRoleReferenceResourceWithHttpInfo(string tenantId, int groupId, string roleId, int operationIndex = 0);
        /// <summary>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns></returns>
        void DeleteUserRoleReferenceResource(string tenantId, string userId, string roleId, int operationIndex = 0);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        ApiResponse<Object> DeleteUserRoleReferenceResourceWithHttpInfo(string tenantId, string userId, string roleId, int operationIndex = 0);
        /// <summary>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>RoleReferenceCollection</returns>
        RoleReferenceCollection GetGroupsRoleReferenceCollectionResource(string tenantId, int groupId, int? currentPage = default(int?), int? pageSize = default(int?), int operationIndex = 0);
        ...
        /// <param name="pageSize">Indicates how many entries of the collection shall be returned. The upper limit for one page is 2,000 objects. (optional, default to 5)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of RoleReferenceCollection</returns>
        ApiResponse<RoleReferenceCollection> GetGroupsRoleReferenceCollectionResourceWithHttpInfo(string tenantId, int groupId, int? currentPage = default(int?), int? pageSize = default(int?), int operationIndex = 0);
        /// <summary>
        ...
        UserRoleCollection GetRoleCollectionResource(int? currentPage = default(int?), int? pageSize = default(int?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0);
        ...
        /// <param name="withTotalPages">When set to &#x60;true&#x60;, the returned result will contain in the statistics object the total number of pages. Only applicable on [range queries](https://en.wikipedia.org/wiki/Range_query_(database)). (optional, default to false)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of UserRoleCollection</returns>
        ApiResponse<UserRoleCollection> GetRoleCollectionResourceWithHttpInfo(int? currentPage = default(int?), int? pageSize = default(int?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0);
        /// <summary>
        ...
        Role GetRoleCollectionResourceByName(string name, int operationIndex = 0);
        ...
        ApiResponse<Role> GetRoleCollectionResourceByNameWithHttpInfo(string name, int operationIndex = 0);
        /// <summary>
        ...
        /// <param name="tenantId">Unique identifier of a Cumulocity IoT tenant.</param>
        /// <param name="groupId">Unique identifier of the user group.</param>
        /// <param name="subscribedRole"></param>
        /// <param name="accept">Advertises which content types, expressed as MIME types, the client is able to understand. (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>RoleReference</returns>
        RoleReference PostGroupsRoleReferenceCollectionResource(string tenantId, int groupId, SubscribedRole subscribedRole, string? accept = default(string?), int operationIndex = 0);
        ...
        /// <param name="accept">Advertises which content types, expressed as MIME types, the client is able to understand. (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of RoleReference</returns>
        ApiResponse<RoleReference> PostGroupsRoleReferenceCollectionResourceWithHttpInfo(string tenantId, int groupId, SubscribedRole subscribedRole, string? accept = default(string?), int operationIndex = 0);
        /// <summary>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>RoleReference</returns>
        RoleReference PostUsersRoleReferenceCollectionResource(string tenantId, string userId, SubscribedRole subscribedRole, string? accept = default(string?), int operationIndex = 0);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of RoleReference</returns>
        ApiResponse<RoleReference> PostUsersRoleReferenceCollectionResourceWithHttpInfo(string tenantId, string userId, SubscribedRole subscribedRole, string? accept = default(string?), int operationIndex = 0);
    ...
    public interface IRolesApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task DeleteGroupRoleReferenceResourceAsync(string tenantId, int groupId, string roleId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> DeleteGroupRoleReferenceResourceWithHttpInfoAsync(string tenantId, int groupId, string roleId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Unassign a specific role from a specific user in a specific tenant
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task DeleteUserRoleReferenceResourceAsync(string tenantId, string userId, string roleId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> DeleteUserRoleReferenceResourceWithHttpInfoAsync(string tenantId, string userId, string roleId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Retrieve all roles assigned to a specific user group in a specific tenant
        /// </summary>
        /// <remarks>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of RoleReferenceCollection</returns>
        System.Threading.Tasks.Task<RoleReferenceCollection> GetGroupsRoleReferenceCollectionResourceAsync(string tenantId, int groupId, int? currentPage = default(int?), int? pageSize = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (UserRoleCollection)</returns>
        System.Threading.Tasks.Task<ApiResponse<UserRoleCollection>> GetRoleCollectionResourceWithHttpInfoAsync(int? currentPage = default(int?), int? pageSize = default(int?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Retrieve a user role by name
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<Role> GetRoleCollectionResourceByNameAsync(string name, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Role>> GetRoleCollectionResourceByNameWithHttpInfoAsync(string name, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Assign a role to a specific user group in a specific tenant
        /// </summary>
        /// <remarks>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of RoleReference</returns>
        System.Threading.Tasks.Task<RoleReference> PostGroupsRoleReferenceCollectionResourceAsync(string tenantId, int groupId, SubscribedRole subscribedRole, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (RoleReference)</returns>
        System.Threading.Tasks.Task<ApiResponse<RoleReference>> PostGroupsRoleReferenceCollectionResourceWithHttpInfoAsync(string tenantId, int groupId, SubscribedRole subscribedRole, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Assign a role to specific user in a specific tenant
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of RoleReference</returns>
        System.Threading.Tasks.Task<RoleReference> PostUsersRoleReferenceCollectionResourceAsync(string tenantId, string userId, SubscribedRole subscribedRole, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (RoleReference)</returns>
        System.Threading.Tasks.Task<ApiResponse<RoleReference>> PostUsersRoleReferenceCollectionResourceWithHttpInfoAsync(string tenantId, string userId, SubscribedRole subscribedRole, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class RolesApi : IRolesApi
    {
        ...
        /// <returns></returns>
        public RolesApi(kern.services.CumulocityClient.Client.Configuration configuration)
        {
        ...
        public RolesApi(kern.services.CumulocityClient.Client.ISynchronousClient client, kern.services.CumulocityClient.Client.IAsynchronousClient asyncClient, kern.services.CumulocityClient.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Unassign a specific role for a specific user group in a specific tenant Unassign a specific role (given by a role ID) for a specific user group (by a given user group ID) in a specific tenant (by a given tenant ID).  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_USER_MANAGEMENT_ADMIN &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="tenantId">Unique identifier of a Cumulocity IoT tenant.</param>
        /// <param name="groupId">Unique identifier of the user group.</param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns></returns>
        public void DeleteGroupRoleReferenceResource(string tenantId, int groupId, string roleId, int operationIndex = 0)
        {
            DeleteGroupRoleReferenceResourceWithHttpInfo(tenantId, groupId, roleId);
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<Object> DeleteGroupRoleReferenceResourceWithHttpInfo(string tenantId, int groupId, string roleId, int operationIndex = 0)
        {
            // verify the required parameter 'tenantId' is set
            if (tenantId == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'tenantId' when calling RolesApi->DeleteGroupRoleReferenceResource");
            }

            // verify the required parameter 'roleId' is set
            if (roleId == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'roleId' when calling RolesApi->DeleteGroupRoleReferenceResource");
            }
            ...
            localVarRequestOptions.PathParameters.Add("roleId", kern.services.CumulocityClient.Client.ClientUtils.ParameterToString(roleId)); // path parameter

            localVarRequestOptions.Operation = "RolesApi.DeleteGroupRoleReferenceResource";
            ...
            var localVarResponse = this.Client.Delete<Object>("/user/{tenantId}/groups/{groupId}/roles/{roleId}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("DeleteGroupRoleReferenceResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task DeleteGroupRoleReferenceResourceAsync(string tenantId, int groupId, string roleId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await DeleteGroupRoleReferenceResourceWithHttpInfoAsync(tenantId, groupId, roleId, operationIndex, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<Object>> DeleteGroupRoleReferenceResourceWithHttpInfoAsync(string tenantId, int groupId, string roleId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'tenantId' is set
            if (tenantId == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.DeleteAsync<Object>("/user/{tenantId}/groups/{groupId}/roles/{roleId}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns></returns>
        public void DeleteUserRoleReferenceResource(string tenantId, string userId, string roleId, int operationIndex = 0)
        {
            DeleteUserRoleReferenceResourceWithHttpInfo(tenantId, userId, roleId);
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<Object> DeleteUserRoleReferenceResourceWithHttpInfo(string tenantId, string userId, string roleId, int operationIndex = 0)
        {
            // verify the required parameter 'tenantId' is set
            if (tenantId == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'tenantId' when calling RolesApi->DeleteUserRoleReferenceResource");
            }

            // verify the required parameter 'userId' is set
            if (userId == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'userId' when calling RolesApi->DeleteUserRoleReferenceResource");
            }

            // verify the required parameter 'roleId' is set
            if (roleId == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'roleId' when calling RolesApi->DeleteUserRoleReferenceResource");
            }
            ...
            localVarRequestOptions.Operation = "RolesApi.DeleteUserRoleReferenceResource";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Delete<Object>("/user/{tenantId}/users/{userId}/roles/{roleId}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("DeleteUserRoleReferenceResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task DeleteUserRoleReferenceResourceAsync(string tenantId, string userId, string roleId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await DeleteUserRoleReferenceResourceWithHttpInfoAsync(tenantId, userId, roleId, operationIndex, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<Object>> DeleteUserRoleReferenceResourceWithHttpInfoAsync(string tenantId, string userId, string roleId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'tenantId' is set
            if (tenantId == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.DeleteAsync<Object>("/user/{tenantId}/users/{userId}/roles/{roleId}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Retrieve all roles assigned to a specific user group in a specific tenant Retrieve all roles assigned to a specific user group (by a given user group ID) in a specific tenant (by a given tenant ID).  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_USER_MANAGEMENT_READ &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="tenantId">Unique identifier of a Cumulocity IoT tenant.</param>
        /// <param name="groupId">Unique identifier of the user group.</param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>RoleReferenceCollection</returns>
        public RoleReferenceCollection GetGroupsRoleReferenceCollectionResource(string tenantId, int groupId, int? currentPage = default(int?), int? pageSize = default(int?), int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<RoleReferenceCollection> localVarResponse = GetGroupsRoleReferenceCollectionResourceWithHttpInfo(tenantId, groupId, currentPage, pageSize);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of RoleReferenceCollection</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<RoleReferenceCollection> GetGroupsRoleReferenceCollectionResourceWithHttpInfo(string tenantId, int groupId, int? currentPage = default(int?), int? pageSize = default(int?), int operationIndex = 0)
        {
            // verify the required parameter 'tenantId' is set
            if (tenantId == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'tenantId' when calling RolesApi->GetGroupsRoleReferenceCollectionResource");
            }
            ...
            localVarRequestOptions.Operation = "RolesApi.GetGroupsRoleReferenceCollectionResource";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<RoleReferenceCollection>("/user/{tenantId}/groups/{groupId}/roles", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetGroupsRoleReferenceCollectionResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of RoleReferenceCollection</returns>
        public async System.Threading.Tasks.Task<RoleReferenceCollection> GetGroupsRoleReferenceCollectionResourceAsync(string tenantId, int groupId, int? currentPage = default(int?), int? pageSize = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<RoleReferenceCollection> localVarResponse = await GetGroupsRoleReferenceCollectionResourceWithHttpInfoAsync(tenantId, groupId, currentPage, pageSize, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (RoleReferenceCollection)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<RoleReferenceCollection>> GetGroupsRoleReferenceCollectionResourceWithHttpInfoAsync(string tenantId, int groupId, int? currentPage = default(int?), int? pageSize = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'tenantId' is set
            if (tenantId == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<RoleReferenceCollection>("/user/{tenantId}/groups/{groupId}/roles", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Retrieve all user roles Retrieve all user roles.  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_USER_MANAGEMENT_READ &lt;b&gt;OR&lt;/b&gt; ROLE_USER_MANAGEMENT_CREATE &lt;b&gt;AND&lt;/b&gt; has access to the user role &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="currentPage">The current page of the paginated results. (optional, default to 1)</param>
        /// <param name="pageSize">Indicates how many entries of the collection shall be returned. The upper limit for one page is 2,000 objects. (optional, default to 5)</param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>UserRoleCollection</returns>
        public UserRoleCollection GetRoleCollectionResource(int? currentPage = default(int?), int? pageSize = default(int?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<UserRoleCollection> localVarResponse = GetRoleCollectionResourceWithHttpInfo(currentPage, pageSize, withTotalElements, withTotalPages);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of UserRoleCollection</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<UserRoleCollection> GetRoleCollectionResourceWithHttpInfo(int? currentPage = default(int?), int? pageSize = default(int?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.RequestOptions localVarRequestOptions = new kern.services.CumulocityClient.Client.RequestOptions();
            ...
            localVarRequestOptions.Operation = "RolesApi.GetRoleCollectionResource";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<UserRoleCollection>("/user/roles", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetRoleCollectionResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of UserRoleCollection</returns>
        public async System.Threading.Tasks.Task<UserRoleCollection> GetRoleCollectionResourceAsync(int? currentPage = default(int?), int? pageSize = default(int?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<UserRoleCollection> localVarResponse = await GetRoleCollectionResourceWithHttpInfoAsync(currentPage, pageSize, withTotalElements, withTotalPages, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (UserRoleCollection)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<UserRoleCollection>> GetRoleCollectionResourceWithHttpInfoAsync(int? currentPage = default(int?), int? pageSize = default(int?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<UserRoleCollection>("/user/roles", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Retrieve a user role by name Retrieve a user role by name.  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_USER_MANAGEMENT_READ &lt;b&gt;OR&lt;/b&gt; ROLE_USER_MANAGEMENT_CREATE &lt;b&gt;AND&lt;/b&gt; current user has access to the role with this name &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="name">The name of the user role.</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>Role</returns>
        public Role GetRoleCollectionResourceByName(string name, int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<Role> localVarResponse = GetRoleCollectionResourceByNameWithHttpInfo(name);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Role</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<Role> GetRoleCollectionResourceByNameWithHttpInfo(string name, int operationIndex = 0)
        {
            // verify the required parameter 'name' is set
            if (name == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'name' when calling RolesApi->GetRoleCollectionResourceByName");
            }
            ...
            localVarRequestOptions.Operation = "RolesApi.GetRoleCollectionResourceByName";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<Role>("/user/roles/{name}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetRoleCollectionResourceByName", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Role</returns>
        public async System.Threading.Tasks.Task<Role> GetRoleCollectionResourceByNameAsync(string name, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<Role> localVarResponse = await GetRoleCollectionResourceByNameWithHttpInfoAsync(name, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Role)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<Role>> GetRoleCollectionResourceByNameWithHttpInfoAsync(string name, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'name' is set
            if (name == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<Role>("/user/roles/{name}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Assign a role to a specific user group in a specific tenant Assign a role to a specific user group (by a given user group ID) in a specific tenant (by a given tenant ID).  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_USER_MANAGEMENT_ADMIN &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="tenantId">Unique identifier of a Cumulocity IoT tenant.</param>
        /// <param name="groupId">Unique identifier of the user group.</param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>RoleReference</returns>
        public RoleReference PostGroupsRoleReferenceCollectionResource(string tenantId, int groupId, SubscribedRole subscribedRole, string? accept = default(string?), int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<RoleReference> localVarResponse = PostGroupsRoleReferenceCollectionResourceWithHttpInfo(tenantId, groupId, subscribedRole, accept);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of RoleReference</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<RoleReference> PostGroupsRoleReferenceCollectionResourceWithHttpInfo(string tenantId, int groupId, SubscribedRole subscribedRole, string? accept = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'tenantId' is set
            if (tenantId == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'tenantId' when calling RolesApi->PostGroupsRoleReferenceCollectionResource");
            }

            // verify the required parameter 'subscribedRole' is set
            if (subscribedRole == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'subscribedRole' when calling RolesApi->PostGroupsRoleReferenceCollectionResource");
            }
            ...
            localVarRequestOptions.Data = subscribedRole;

            localVarRequestOptions.Operation = "RolesApi.PostGroupsRoleReferenceCollectionResource";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<RoleReference>("/user/{tenantId}/groups/{groupId}/roles", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PostGroupsRoleReferenceCollectionResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of RoleReference</returns>
        public async System.Threading.Tasks.Task<RoleReference> PostGroupsRoleReferenceCollectionResourceAsync(string tenantId, int groupId, SubscribedRole subscribedRole, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<RoleReference> localVarResponse = await PostGroupsRoleReferenceCollectionResourceWithHttpInfoAsync(tenantId, groupId, subscribedRole, accept, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (RoleReference)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<RoleReference>> PostGroupsRoleReferenceCollectionResourceWithHttpInfoAsync(string tenantId, int groupId, SubscribedRole subscribedRole, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'tenantId' is set
            if (tenantId == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<RoleReference>("/user/{tenantId}/groups/{groupId}/roles", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>RoleReference</returns>
        public RoleReference PostUsersRoleReferenceCollectionResource(string tenantId, string userId, SubscribedRole subscribedRole, string? accept = default(string?), int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<RoleReference> localVarResponse = PostUsersRoleReferenceCollectionResourceWithHttpInfo(tenantId, userId, subscribedRole, accept);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of RoleReference</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<RoleReference> PostUsersRoleReferenceCollectionResourceWithHttpInfo(string tenantId, string userId, SubscribedRole subscribedRole, string? accept = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'tenantId' is set
            if (tenantId == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'tenantId' when calling RolesApi->PostUsersRoleReferenceCollectionResource");
            }

            // verify the required parameter 'userId' is set
            if (userId == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'userId' when calling RolesApi->PostUsersRoleReferenceCollectionResource");
            }

            // verify the required parameter 'subscribedRole' is set
            if (subscribedRole == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'subscribedRole' when calling RolesApi->PostUsersRoleReferenceCollectionResource");
            }
            ...
            localVarRequestOptions.Operation = "RolesApi.PostUsersRoleReferenceCollectionResource";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<RoleReference>("/user/{tenantId}/users/{userId}/roles", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PostUsersRoleReferenceCollectionResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of RoleReference</returns>
        public async System.Threading.Tasks.Task<RoleReference> PostUsersRoleReferenceCollectionResourceAsync(string tenantId, string userId, SubscribedRole subscribedRole, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<RoleReference> localVarResponse = await PostUsersRoleReferenceCollectionResourceWithHttpInfoAsync(tenantId, userId, subscribedRole, accept, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (RoleReference)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<RoleReference>> PostUsersRoleReferenceCollectionResourceWithHttpInfoAsync(string tenantId, string userId, SubscribedRole subscribedRole, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'tenantId' is set
            if (tenantId == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<RoleReference>("/user/{tenantId}/users/{userId}/roles", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
