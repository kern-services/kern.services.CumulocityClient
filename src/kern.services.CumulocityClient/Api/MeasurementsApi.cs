...
namespace kern.services.CumulocityClient.Api
{
    ...
    public interface IMeasurementsApiSync : IApiAccessor
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>Measurement</returns>
        Measurement PostMeasurementCollectionResource(Dictionary<string, Object> requestBody, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Measurement</returns>
        ApiResponse<Measurement> PostMeasurementCollectionResourceWithHttpInfo(Dictionary<string, Object> requestBody, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0);
    ...
    public interface IMeasurementsApiAsync : IApiAccessor
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Measurement)</returns>
        System.Threading.Tasks.Task<ApiResponse<Measurement>> PostMeasurementCollectionResourceWithHttpInfoAsync(Dictionary<string, Object> requestBody, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class MeasurementsApi : IMeasurementsApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>Measurement</returns>
        public Measurement PostMeasurementCollectionResource(Dictionary<string, Object> requestBody, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<Measurement> localVarResponse = PostMeasurementCollectionResourceWithHttpInfo(requestBody, accept, xCumulocityProcessingMode);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Measurement</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<Measurement> PostMeasurementCollectionResourceWithHttpInfo(Dictionary<string, Object> requestBody, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'requestBody' is set
            if (requestBody == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'requestBody' when calling MeasurementsApi->PostMeasurementCollectionResource");
            }
        ...
        {
            kern.services.CumulocityClient.Client.ApiResponse<Measurement> localVarResponse = await PostMeasurementCollectionResourceWithHttpInfoAsync(requestBody, accept, xCumulocityProcessingMode, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
