...
namespace kern.services.CumulocityClient.Api
{
    ...
    /// </summary>
    public interface IEventAPIApiSync : IApiAccessor
    {
        ...
        /// <returns>EventsApiResource</returns>
        EventsApiResource GetEventsApiResource(int operationIndex = 0);
        ...
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of EventsApiResource</returns>
        ApiResponse<EventsApiResource> GetEventsApiResourceWithHttpInfo(int operationIndex = 0);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IEventAPIApiAsync : IApiAccessor
    {
        ...
        /// <returns>Task of EventsApiResource</returns>
        System.Threading.Tasks.Task<EventsApiResource> GetEventsApiResourceAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (EventsApiResource)</returns>
        System.Threading.Tasks.Task<ApiResponse<EventsApiResource>> GetEventsApiResourceWithHttpInfoAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IEventAPIApi : IEventAPIApiSync, IEventAPIApiAsync
    {
    ...
    public partial class EventAPIApi : IEventAPIApi
    {
        ...
        /// </summary>
        /// <returns></returns>
        public EventAPIApi() : this((string)null)
        {
        }
        ...
        /// <returns></returns>
        public EventAPIApi(kern.services.CumulocityClient.Client.Configuration configuration)
        {
        ...
        public EventAPIApi(kern.services.CumulocityClient.Client.ISynchronousClient client, kern.services.CumulocityClient.Client.IAsynchronousClient asyncClient, kern.services.CumulocityClient.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Retrieve URIs to collections of events Retrieve URIs and URI templates to collections of events.  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_EVENT_READ &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>EventsApiResource</returns>
        public EventsApiResource GetEventsApiResource(int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<EventsApiResource> localVarResponse = GetEventsApiResourceWithHttpInfo();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of EventsApiResource</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<EventsApiResource> GetEventsApiResourceWithHttpInfo(int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "EventAPIApi.GetEventsApiResource";
            ...
            var localVarResponse = this.Client.Get<EventsApiResource>("/event", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetEventsApiResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of EventsApiResource</returns>
        public async System.Threading.Tasks.Task<EventsApiResource> GetEventsApiResourceAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<EventsApiResource> localVarResponse = await GetEventsApiResourceWithHttpInfoAsync(operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (EventsApiResource)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<EventsApiResource>> GetEventsApiResourceWithHttpInfoAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<EventsApiResource>("/event", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
