...
namespace kern.services.CumulocityClient.Api
{
    ...
    public interface IEventAPIApi : IApiAccessor
    {
        ...
        ApiResponse<EventsApiResource> GetEventsApiResourceWithHttpInfo ();
        ...
        System.Threading.Tasks.Task<EventsApiResource> GetEventsApiResourceAsync (CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<EventsApiResource>> GetEventsApiResourceWithHttpInfoAsync (CancellationToken cancellationToken = default(CancellationToken));
    ...
    public partial class EventAPIApi : IEventAPIApi
    {
        ...
        /// <returns></returns>
        public EventAPIApi(kern.services.CumulocityClient.Client.Configuration configuration = null)
        {
        ...
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>EventsApiResource</returns>
        public EventsApiResource GetEventsApiResource ()
        {
             ApiResponse<EventsApiResource> localVarResponse = GetEventsApiResourceWithHttpInfo();
        ...
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of EventsApiResource</returns>
        public ApiResponse<EventsApiResource> GetEventsApiResourceWithHttpInfo ()
        {
            ...
            {
                Exception exception = ExceptionFactory("GetEventsApiResource", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<EventsApiResource>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (EventsApiResource) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(EventsApiResource)));
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of EventsApiResource</returns>
        public async System.Threading.Tasks.Task<EventsApiResource> GetEventsApiResourceAsync (CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<EventsApiResource> localVarResponse = await GetEventsApiResourceWithHttpInfoAsync(cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (EventsApiResource)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<EventsApiResource>> GetEventsApiResourceWithHttpInfoAsync (CancellationToken cancellationToken = default(CancellationToken))
        {
