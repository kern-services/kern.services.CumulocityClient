...
namespace kern.services.CumulocityClient.Api
{
    ...
    public interface ITenantsApiSync : IApiAccessor
    {
        ...
        /// <returns></returns>
        void DeleteTenantResource(string tenantId, int operationIndex = 0);
        ...
        ApiResponse<Object> DeleteTenantResourceWithHttpInfo(string tenantId, int operationIndex = 0);
        /// <summary>
        ...
        /// </remarks>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="withParent">When set to &#x60;true&#x60;, the returned result will contain the parent of the current tenant. (optional, default to false)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>CurrentTenant</returns>
        CurrentTenant GetCurrentTenantResource(bool? withParent = default(bool?), int operationIndex = 0);
        ...
        /// <param name="withParent">When set to &#x60;true&#x60;, the returned result will contain the parent of the current tenant. (optional, default to false)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CurrentTenant</returns>
        ApiResponse<CurrentTenant> GetCurrentTenantResourceWithHttpInfo(bool? withParent = default(bool?), int operationIndex = 0);
        /// <summary>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>TenantCollection</returns>
        TenantCollection GetTenantCollectionResource(int? currentPage = default(int?), int? pageSize = default(int?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0);
        ...
        /// <param name="withTotalPages">When set to &#x60;true&#x60;, the returned result will contain in the statistics object the total number of pages. Only applicable on [range queries](https://en.wikipedia.org/wiki/Range_query_(database)). (optional, default to false)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of TenantCollection</returns>
        ApiResponse<TenantCollection> GetTenantCollectionResourceWithHttpInfo(int? currentPage = default(int?), int? pageSize = default(int?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0);
        /// <summary>
        ...
        Tenant GetTenantResource(string tenantId, int operationIndex = 0);
        ...
        ApiResponse<Tenant> GetTenantResourceWithHttpInfo(string tenantId, int operationIndex = 0);
        /// <summary>
        ...
        /// <param name="tenantId">Unique identifier of a Cumulocity IoT tenant.</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>TenantTfaData</returns>
        TenantTfaData GetTenantsTfaResourceTfa(string tenantId, int operationIndex = 0);
        ...
        /// <param name="tenantId">Unique identifier of a Cumulocity IoT tenant.</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of TenantTfaData</returns>
        ApiResponse<TenantTfaData> GetTenantsTfaResourceTfaWithHttpInfo(string tenantId, int operationIndex = 0);
        /// <summary>
        /// Create a tenant
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="postTenantCollectionResourceRequest"></param>
        /// <param name="accept">Advertises which content types, expressed as MIME types, the client is able to understand. (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>Tenant</returns>
        Tenant PostTenantCollectionResource(PostTenantCollectionResourceRequest postTenantCollectionResourceRequest, string? accept = default(string?), int operationIndex = 0);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Tenant</returns>
        ApiResponse<Tenant> PostTenantCollectionResourceWithHttpInfo(PostTenantCollectionResourceRequest postTenantCollectionResourceRequest, string? accept = default(string?), int operationIndex = 0);
        /// <summary>
        ...
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="tenantId">Unique identifier of a Cumulocity IoT tenant.</param>
        /// <param name="putTenantResourceRequest"></param>
        /// <param name="accept">Advertises which content types, expressed as MIME types, the client is able to understand. (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>Tenant</returns>
        Tenant PutTenantResource(string tenantId, PutTenantResourceRequest putTenantResourceRequest, string? accept = default(string?), int operationIndex = 0);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Tenant</returns>
        ApiResponse<Tenant> PutTenantResourceWithHttpInfo(string tenantId, PutTenantResourceRequest putTenantResourceRequest, string? accept = default(string?), int operationIndex = 0);
    ...
    public interface ITenantsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task DeleteTenantResourceAsync(string tenantId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> DeleteTenantResourceWithHttpInfoAsync(string tenantId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Retrieve the current tenant
        /// </summary>
        /// <remarks>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of CurrentTenant</returns>
        System.Threading.Tasks.Task<CurrentTenant> GetCurrentTenantResourceAsync(bool? withParent = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (CurrentTenant)</returns>
        System.Threading.Tasks.Task<ApiResponse<CurrentTenant>> GetCurrentTenantResourceWithHttpInfoAsync(bool? withParent = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Retrieve all subtenants
        /// </summary>
        /// <remarks>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (TenantCollection)</returns>
        System.Threading.Tasks.Task<ApiResponse<TenantCollection>> GetTenantCollectionResourceWithHttpInfoAsync(int? currentPage = default(int?), int? pageSize = default(int?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Retrieve a specific tenant
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<Tenant> GetTenantResourceAsync(string tenantId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Tenant>> GetTenantResourceWithHttpInfoAsync(string tenantId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Retrieve TFA settings of a specific tenant
        /// </summary>
        /// <remarks>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of TenantTfaData</returns>
        System.Threading.Tasks.Task<TenantTfaData> GetTenantsTfaResourceTfaAsync(string tenantId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (TenantTfaData)</returns>
        System.Threading.Tasks.Task<ApiResponse<TenantTfaData>> GetTenantsTfaResourceTfaWithHttpInfoAsync(string tenantId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Create a tenant
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Tenant</returns>
        System.Threading.Tasks.Task<Tenant> PostTenantCollectionResourceAsync(PostTenantCollectionResourceRequest postTenantCollectionResourceRequest, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Tenant)</returns>
        System.Threading.Tasks.Task<ApiResponse<Tenant>> PostTenantCollectionResourceWithHttpInfoAsync(PostTenantCollectionResourceRequest postTenantCollectionResourceRequest, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Update a specific tenant
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Tenant</returns>
        System.Threading.Tasks.Task<Tenant> PutTenantResourceAsync(string tenantId, PutTenantResourceRequest putTenantResourceRequest, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Tenant)</returns>
        System.Threading.Tasks.Task<ApiResponse<Tenant>> PutTenantResourceWithHttpInfoAsync(string tenantId, PutTenantResourceRequest putTenantResourceRequest, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class TenantsApi : ITenantsApi
    {
        ...
        /// <returns></returns>
        public TenantsApi(kern.services.CumulocityClient.Client.Configuration configuration)
        {
        ...
        public TenantsApi(kern.services.CumulocityClient.Client.ISynchronousClient client, kern.services.CumulocityClient.Client.IAsynchronousClient asyncClient, kern.services.CumulocityClient.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Remove a specific tenant Remove a specific tenant by a given ID.  &gt; **⚠️ Important:** Deleting a subtenant cannot be reverted. For security reasons, it is therefore only available in the management tenant. You cannot delete tenants from any tenant but the management tenant. &gt; &gt; Administrators in Enterprise Tenants are only allowed to suspend active subtenants, but not to delete them.  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_TENANT_MANAGEMENT_ADMIN &lt;b&gt;AND&lt;/b&gt; is the management tenant &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="tenantId">Unique identifier of a Cumulocity IoT tenant.</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns></returns>
        public void DeleteTenantResource(string tenantId, int operationIndex = 0)
        {
            DeleteTenantResourceWithHttpInfo(tenantId);
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<Object> DeleteTenantResourceWithHttpInfo(string tenantId, int operationIndex = 0)
        {
            // verify the required parameter 'tenantId' is set
            if (tenantId == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'tenantId' when calling TenantsApi->DeleteTenantResource");
            }
            ...
            localVarRequestOptions.Operation = "TenantsApi.DeleteTenantResource";
            ...
            var localVarResponse = this.Client.Delete<Object>("/tenant/tenants/{tenantId}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("DeleteTenantResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task DeleteTenantResourceAsync(string tenantId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await DeleteTenantResourceWithHttpInfoAsync(tenantId, operationIndex, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<Object>> DeleteTenantResourceWithHttpInfoAsync(string tenantId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'tenantId' is set
            if (tenantId == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.DeleteAsync<Object>("/tenant/tenants/{tenantId}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Retrieve the current tenant Retrieve information about the current tenant.  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_USER_MANAGEMENT_OWN_READ &lt;b&gt;OR&lt;/b&gt; ROLE_SYSTEM &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="withParent">When set to &#x60;true&#x60;, the returned result will contain the parent of the current tenant. (optional, default to false)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>CurrentTenant</returns>
        public CurrentTenant GetCurrentTenantResource(bool? withParent = default(bool?), int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<CurrentTenant> localVarResponse = GetCurrentTenantResourceWithHttpInfo(withParent);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CurrentTenant</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<CurrentTenant> GetCurrentTenantResourceWithHttpInfo(bool? withParent = default(bool?), int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.RequestOptions localVarRequestOptions = new kern.services.CumulocityClient.Client.RequestOptions();
            ...
            if (withParent != null)
            {
                localVarRequestOptions.QueryParameters.Add(kern.services.CumulocityClient.Client.ClientUtils.ParameterToMultiMap("", "withParent", withParent));
            }

            localVarRequestOptions.Operation = "TenantsApi.GetCurrentTenantResource";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<CurrentTenant>("/tenant/currentTenant", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetCurrentTenantResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of CurrentTenant</returns>
        public async System.Threading.Tasks.Task<CurrentTenant> GetCurrentTenantResourceAsync(bool? withParent = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<CurrentTenant> localVarResponse = await GetCurrentTenantResourceWithHttpInfoAsync(withParent, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (CurrentTenant)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<CurrentTenant>> GetCurrentTenantResourceWithHttpInfoAsync(bool? withParent = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<CurrentTenant>("/tenant/currentTenant", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Retrieve all subtenants Retrieve all subtenants of the current tenant.  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_TENANT_MANAGEMENT_READ &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="currentPage">The current page of the paginated results. (optional, default to 1)</param>
        /// <param name="pageSize">Indicates how many entries of the collection shall be returned. The upper limit for one page is 2,000 objects. (optional, default to 5)</param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>TenantCollection</returns>
        public TenantCollection GetTenantCollectionResource(int? currentPage = default(int?), int? pageSize = default(int?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<TenantCollection> localVarResponse = GetTenantCollectionResourceWithHttpInfo(currentPage, pageSize, withTotalElements, withTotalPages);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of TenantCollection</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<TenantCollection> GetTenantCollectionResourceWithHttpInfo(int? currentPage = default(int?), int? pageSize = default(int?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.RequestOptions localVarRequestOptions = new kern.services.CumulocityClient.Client.RequestOptions();
            ...
            localVarRequestOptions.Operation = "TenantsApi.GetTenantCollectionResource";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<TenantCollection>("/tenant/tenants", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetTenantCollectionResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of TenantCollection</returns>
        public async System.Threading.Tasks.Task<TenantCollection> GetTenantCollectionResourceAsync(int? currentPage = default(int?), int? pageSize = default(int?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<TenantCollection> localVarResponse = await GetTenantCollectionResourceWithHttpInfoAsync(currentPage, pageSize, withTotalElements, withTotalPages, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (TenantCollection)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<TenantCollection>> GetTenantCollectionResourceWithHttpInfoAsync(int? currentPage = default(int?), int? pageSize = default(int?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<TenantCollection>("/tenant/tenants", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Retrieve a specific tenant Retrieve a specific tenant by a given ID.  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_TENANT_MANAGEMENT_READ &lt;b&gt;AND&lt;/b&gt; the current tenant is its parent &lt;b&gt;OR&lt;/b&gt; is the management tenant &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="tenantId">Unique identifier of a Cumulocity IoT tenant.</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>Tenant</returns>
        public Tenant GetTenantResource(string tenantId, int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<Tenant> localVarResponse = GetTenantResourceWithHttpInfo(tenantId);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Tenant</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<Tenant> GetTenantResourceWithHttpInfo(string tenantId, int operationIndex = 0)
        {
            // verify the required parameter 'tenantId' is set
            if (tenantId == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'tenantId' when calling TenantsApi->GetTenantResource");
            }
            ...
            localVarRequestOptions.Operation = "TenantsApi.GetTenantResource";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<Tenant>("/tenant/tenants/{tenantId}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetTenantResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Tenant</returns>
        public async System.Threading.Tasks.Task<Tenant> GetTenantResourceAsync(string tenantId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<Tenant> localVarResponse = await GetTenantResourceWithHttpInfoAsync(tenantId, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Tenant)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<Tenant>> GetTenantResourceWithHttpInfoAsync(string tenantId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'tenantId' is set
            if (tenantId == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<Tenant>("/tenant/tenants/{tenantId}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Retrieve TFA settings of a specific tenant Retrieve the two-factor authentication settings of a specific tenant by a given tenant ID.  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ((ROLE_TENANT_MANAGEMENT_READ &lt;b&gt;OR&lt;/b&gt; ROLE_USER_MANAGEMENT_READ) &lt;b&gt;AND&lt;/b&gt; (the current tenant is its parent &lt;b&gt;OR&lt;/b&gt; is the management tenant &lt;b&gt;OR&lt;/b&gt; the current user belongs to the tenant)) &lt;b&gt;OR&lt;/b&gt; (the user belongs to the tenant &lt;b&gt;AND&lt;/b&gt; ROLE_USER_MANAGEMENT_OWN_READ) &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="tenantId">Unique identifier of a Cumulocity IoT tenant.</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>TenantTfaData</returns>
        public TenantTfaData GetTenantsTfaResourceTfa(string tenantId, int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<TenantTfaData> localVarResponse = GetTenantsTfaResourceTfaWithHttpInfo(tenantId);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of TenantTfaData</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<TenantTfaData> GetTenantsTfaResourceTfaWithHttpInfo(string tenantId, int operationIndex = 0)
        {
            // verify the required parameter 'tenantId' is set
            if (tenantId == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'tenantId' when calling TenantsApi->GetTenantsTfaResourceTfa");
            }
            ...
            localVarRequestOptions.Operation = "TenantsApi.GetTenantsTfaResourceTfa";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<TenantTfaData>("/tenant/tenants/{tenantId}/tfa", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetTenantsTfaResourceTfa", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of TenantTfaData</returns>
        public async System.Threading.Tasks.Task<TenantTfaData> GetTenantsTfaResourceTfaAsync(string tenantId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<TenantTfaData> localVarResponse = await GetTenantsTfaResourceTfaWithHttpInfoAsync(tenantId, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (TenantTfaData)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<TenantTfaData>> GetTenantsTfaResourceTfaWithHttpInfoAsync(string tenantId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'tenantId' is set
            if (tenantId == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<TenantTfaData>("/tenant/tenants/{tenantId}/tfa", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Create a tenant Create a subtenant for the current tenant.  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; (ROLE_TENANT_MANAGEMENT_ADMIN &lt;b&gt;OR&lt;/b&gt; ROLE_TENANT_MANAGEMENT_CREATE) &lt;b&gt;AND&lt;/b&gt; the current tenant is allowed to create subtenants &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="postTenantCollectionResourceRequest"></param>
        /// <param name="accept">Advertises which content types, expressed as MIME types, the client is able to understand. (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>Tenant</returns>
        public Tenant PostTenantCollectionResource(PostTenantCollectionResourceRequest postTenantCollectionResourceRequest, string? accept = default(string?), int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<Tenant> localVarResponse = PostTenantCollectionResourceWithHttpInfo(postTenantCollectionResourceRequest, accept);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Tenant</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<Tenant> PostTenantCollectionResourceWithHttpInfo(PostTenantCollectionResourceRequest postTenantCollectionResourceRequest, string? accept = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'postTenantCollectionResourceRequest' is set
            if (postTenantCollectionResourceRequest == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'postTenantCollectionResourceRequest' when calling TenantsApi->PostTenantCollectionResource");
            }
            ...
            localVarRequestOptions.Data = postTenantCollectionResourceRequest;

            localVarRequestOptions.Operation = "TenantsApi.PostTenantCollectionResource";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<Tenant>("/tenant/tenants", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PostTenantCollectionResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Tenant</returns>
        public async System.Threading.Tasks.Task<Tenant> PostTenantCollectionResourceAsync(PostTenantCollectionResourceRequest postTenantCollectionResourceRequest, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<Tenant> localVarResponse = await PostTenantCollectionResourceWithHttpInfoAsync(postTenantCollectionResourceRequest, accept, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Tenant)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<Tenant>> PostTenantCollectionResourceWithHttpInfoAsync(PostTenantCollectionResourceRequest postTenantCollectionResourceRequest, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'postTenantCollectionResourceRequest' is set
            if (postTenantCollectionResourceRequest == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<Tenant>("/tenant/tenants", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Update a specific tenant Update a specific tenant by a given ID.  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; (ROLE_TENANT_MANAGEMENT_ADMIN &lt;b&gt;OR&lt;/b&gt; ROLE_TENANT_MANAGEMENT_UPDATE) &lt;b&gt;AND&lt;/b&gt; (the current tenant is its parent &lt;b&gt;AND&lt;/b&gt; the current tenant is allowed to create subtenants) &lt;b&gt;OR&lt;/b&gt; is the management tenant &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="tenantId">Unique identifier of a Cumulocity IoT tenant.</param>
        /// <param name="putTenantResourceRequest"></param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>Tenant</returns>
        public Tenant PutTenantResource(string tenantId, PutTenantResourceRequest putTenantResourceRequest, string? accept = default(string?), int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<Tenant> localVarResponse = PutTenantResourceWithHttpInfo(tenantId, putTenantResourceRequest, accept);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Tenant</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<Tenant> PutTenantResourceWithHttpInfo(string tenantId, PutTenantResourceRequest putTenantResourceRequest, string? accept = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'tenantId' is set
            if (tenantId == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'tenantId' when calling TenantsApi->PutTenantResource");
            }

            // verify the required parameter 'putTenantResourceRequest' is set
            if (putTenantResourceRequest == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'putTenantResourceRequest' when calling TenantsApi->PutTenantResource");
            }
            ...
            localVarRequestOptions.Data = putTenantResourceRequest;

            localVarRequestOptions.Operation = "TenantsApi.PutTenantResource";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Put<Tenant>("/tenant/tenants/{tenantId}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PutTenantResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Tenant</returns>
        public async System.Threading.Tasks.Task<Tenant> PutTenantResourceAsync(string tenantId, PutTenantResourceRequest putTenantResourceRequest, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<Tenant> localVarResponse = await PutTenantResourceWithHttpInfoAsync(tenantId, putTenantResourceRequest, accept, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Tenant)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<Tenant>> PutTenantResourceWithHttpInfoAsync(string tenantId, PutTenantResourceRequest putTenantResourceRequest, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'tenantId' is set
            if (tenantId == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PutAsync<Tenant>("/tenant/tenants/{tenantId}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
