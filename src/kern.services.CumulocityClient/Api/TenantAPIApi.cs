...
namespace kern.services.CumulocityClient.Api
{
    ...
    /// </summary>
    public interface ITenantAPIApi : IApiAccessor
    {
        ...
        ApiResponse<TenantApiResource> GetTenantsApiResourceWithHttpInfo ();
        ...
        System.Threading.Tasks.Task<TenantApiResource> GetTenantsApiResourceAsync (CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<TenantApiResource>> GetTenantsApiResourceWithHttpInfoAsync (CancellationToken cancellationToken = default(CancellationToken));
    ...
    public partial class TenantAPIApi : ITenantAPIApi
    {
        ...
        /// <returns></returns>
        public TenantAPIApi(kern.services.CumulocityClient.Client.Configuration configuration = null)
        {
        ...
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>TenantApiResource</returns>
        public TenantApiResource GetTenantsApiResource ()
        {
             ApiResponse<TenantApiResource> localVarResponse = GetTenantsApiResourceWithHttpInfo();
        ...
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of TenantApiResource</returns>
        public ApiResponse<TenantApiResource> GetTenantsApiResourceWithHttpInfo ()
        {

            var localVarPath = "/tenant";
            ...
            {
                Exception exception = ExceptionFactory("GetTenantsApiResource", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<TenantApiResource>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (TenantApiResource) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(TenantApiResource)));
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of TenantApiResource</returns>
        public async System.Threading.Tasks.Task<TenantApiResource> GetTenantsApiResourceAsync (CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<TenantApiResource> localVarResponse = await GetTenantsApiResourceWithHttpInfoAsync(cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (TenantApiResource)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<TenantApiResource>> GetTenantsApiResourceWithHttpInfoAsync (CancellationToken cancellationToken = default(CancellationToken))
        {
