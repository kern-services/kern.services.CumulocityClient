...
namespace kern.services.CumulocityClient.Api
{
    ...
    /// </summary>
    public interface ITenantAPIApiSync : IApiAccessor
    {
        ...
        /// <returns>TenantApiResource</returns>
        TenantApiResource GetTenantsApiResource(int operationIndex = 0);
        ...
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of TenantApiResource</returns>
        ApiResponse<TenantApiResource> GetTenantsApiResourceWithHttpInfo(int operationIndex = 0);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ITenantAPIApiAsync : IApiAccessor
    {
        ...
        /// <returns>Task of TenantApiResource</returns>
        System.Threading.Tasks.Task<TenantApiResource> GetTenantsApiResourceAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (TenantApiResource)</returns>
        System.Threading.Tasks.Task<ApiResponse<TenantApiResource>> GetTenantsApiResourceWithHttpInfoAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ITenantAPIApi : ITenantAPIApiSync, ITenantAPIApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class TenantAPIApi : ITenantAPIApi
    {
        private kern.services.CumulocityClient.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="TenantAPIApi"/> class.
        /// </summary>
        /// <returns></returns>
        public TenantAPIApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public TenantAPIApi(string basePath)
        {
        ...
        /// <returns></returns>
        public TenantAPIApi(kern.services.CumulocityClient.Client.Configuration configuration)
        {
        ...
        public TenantAPIApi(kern.services.CumulocityClient.Client.ISynchronousClient client, kern.services.CumulocityClient.Client.IAsynchronousClient asyncClient, kern.services.CumulocityClient.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Retrieve URIs to collections of tenants Retrieve URIs and URI templates to collections of tenants and options.  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_TENANT_MANAGEMENT_READ &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>TenantApiResource</returns>
        public TenantApiResource GetTenantsApiResource(int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<TenantApiResource> localVarResponse = GetTenantsApiResourceWithHttpInfo();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of TenantApiResource</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<TenantApiResource> GetTenantsApiResourceWithHttpInfo(int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "TenantAPIApi.GetTenantsApiResource";
            ...
            var localVarResponse = this.Client.Get<TenantApiResource>("/tenant", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetTenantsApiResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of TenantApiResource</returns>
        public async System.Threading.Tasks.Task<TenantApiResource> GetTenantsApiResourceAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<TenantApiResource> localVarResponse = await GetTenantsApiResourceWithHttpInfoAsync(operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (TenantApiResource)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<TenantApiResource>> GetTenantsApiResourceWithHttpInfoAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<TenantApiResource>("/tenant", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
