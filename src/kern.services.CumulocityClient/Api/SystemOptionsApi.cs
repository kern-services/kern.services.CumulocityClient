...
namespace kern.services.CumulocityClient.Api
{
    ...
    /// </summary>
    public interface ISystemOptionsApi : IApiAccessor
    {
        ...
        ApiResponse<SystemOption> GetSystemOptionResourceWithHttpInfo (string category, string key);
        ...
        System.Threading.Tasks.Task<SystemOptionCollection> GetSystemOptionCollectionResourceAsync (CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<SystemOptionCollection>> GetSystemOptionCollectionResourceWithHttpInfoAsync (CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Retrieve a specific system option
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<SystemOption> GetSystemOptionResourceAsync (string category, string key, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<SystemOption>> GetSystemOptionResourceWithHttpInfoAsync (string category, string key, CancellationToken cancellationToken = default(CancellationToken));
    ...
    public partial class SystemOptionsApi : ISystemOptionsApi
    {
        ...
        /// <returns></returns>
        public SystemOptionsApi(kern.services.CumulocityClient.Client.Configuration configuration = null)
        {
        ...
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>SystemOptionCollection</returns>
        public SystemOptionCollection GetSystemOptionCollectionResource ()
        {
             ApiResponse<SystemOptionCollection> localVarResponse = GetSystemOptionCollectionResourceWithHttpInfo();
        ...
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of SystemOptionCollection</returns>
        public ApiResponse<SystemOptionCollection> GetSystemOptionCollectionResourceWithHttpInfo ()
        {

            var localVarPath = "/tenant/system/options";
            ...
            {
                Exception exception = ExceptionFactory("GetSystemOptionCollectionResource", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<SystemOptionCollection>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (SystemOptionCollection) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(SystemOptionCollection)));
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of SystemOptionCollection</returns>
        public async System.Threading.Tasks.Task<SystemOptionCollection> GetSystemOptionCollectionResourceAsync (CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<SystemOptionCollection> localVarResponse = await GetSystemOptionCollectionResourceWithHttpInfoAsync(cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (SystemOptionCollection)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<SystemOptionCollection>> GetSystemOptionCollectionResourceWithHttpInfoAsync (CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <param name="key">The key of a system option.</param>
        /// <returns>SystemOption</returns>
        public SystemOption GetSystemOptionResource (string category, string key)
        {
             ApiResponse<SystemOption> localVarResponse = GetSystemOptionResourceWithHttpInfo(category, key);
             return localVarResponse.Data;
        }
        ...
        /// <param name="key">The key of a system option.</param>
        /// <returns>ApiResponse of SystemOption</returns>
        public ApiResponse<SystemOption> GetSystemOptionResourceWithHttpInfo (string category, string key)
        {
            // verify the required parameter 'category' is set
            if (category == null)
                throw new ApiException(400, "Missing required parameter 'category' when calling SystemOptionsApi->GetSystemOptionResource");
            // verify the required parameter 'key' is set
            if (key == null)
                throw new ApiException(400, "Missing required parameter 'key' when calling SystemOptionsApi->GetSystemOptionResource");

            var localVarPath = "/tenant/system/options/{category}/{key}";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("GetSystemOptionResource", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<SystemOption>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (SystemOption) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(SystemOption)));
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of SystemOption</returns>
        public async System.Threading.Tasks.Task<SystemOption> GetSystemOptionResourceAsync (string category, string key, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<SystemOption> localVarResponse = await GetSystemOptionResourceWithHttpInfoAsync(category, key, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (SystemOption)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<SystemOption>> GetSystemOptionResourceWithHttpInfoAsync (string category, string key, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'category' is set
            if (category == null)
                throw new ApiException(400, "Missing required parameter 'category' when calling SystemOptionsApi->GetSystemOptionResource");
