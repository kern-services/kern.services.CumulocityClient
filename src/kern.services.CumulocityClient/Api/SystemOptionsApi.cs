...
namespace kern.services.CumulocityClient.Api
{
    ...
    /// </summary>
    public interface ISystemOptionsApiSync : IApiAccessor
    {
        ...
        /// <returns>SystemOptionCollection</returns>
        SystemOptionCollection GetSystemOptionCollectionResource(int operationIndex = 0);
        ...
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SystemOptionCollection</returns>
        ApiResponse<SystemOptionCollection> GetSystemOptionCollectionResourceWithHttpInfo(int operationIndex = 0);
        /// <summary>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>SystemOption</returns>
        SystemOption GetSystemOptionResource(string category, string key, int operationIndex = 0);
        ...
        /// <param name="key">The key of a system option.</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SystemOption</returns>
        ApiResponse<SystemOption> GetSystemOptionResourceWithHttpInfo(string category, string key, int operationIndex = 0);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ISystemOptionsApiAsync : IApiAccessor
    {
        ...
        /// <returns>Task of SystemOptionCollection</returns>
        System.Threading.Tasks.Task<SystemOptionCollection> GetSystemOptionCollectionResourceAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SystemOptionCollection)</returns>
        System.Threading.Tasks.Task<ApiResponse<SystemOptionCollection>> GetSystemOptionCollectionResourceWithHttpInfoAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Retrieve a specific system option
        /// </summary>
        /// <remarks>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of SystemOption</returns>
        System.Threading.Tasks.Task<SystemOption> GetSystemOptionResourceAsync(string category, string key, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SystemOption)</returns>
        System.Threading.Tasks.Task<ApiResponse<SystemOption>> GetSystemOptionResourceWithHttpInfoAsync(string category, string key, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ISystemOptionsApi : ISystemOptionsApiSync, ISystemOptionsApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class SystemOptionsApi : ISystemOptionsApi
    {
        private kern.services.CumulocityClient.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="SystemOptionsApi"/> class.
        /// </summary>
        /// <returns></returns>
        public SystemOptionsApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public SystemOptionsApi(string basePath)
        {
        ...
        /// <returns></returns>
        public SystemOptionsApi(kern.services.CumulocityClient.Client.Configuration configuration)
        {
        ...
        public SystemOptionsApi(kern.services.CumulocityClient.Client.ISynchronousClient client, kern.services.CumulocityClient.Client.IAsynchronousClient asyncClient, kern.services.CumulocityClient.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Retrieve all system options Retrieve all the system options available on the tenant.  &gt; **⚠️ Important:** Note that it is possible to call this endpoint without the ROLE_OPTION_MANAGEMENT_ADMIN role, but options that are considered secured (see the list of options above) will be obfuscated with a constant value &#x60;\&quot;&lt;&lt;Encrypted&gt;&gt;\&quot;&#x60;. 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>SystemOptionCollection</returns>
        public SystemOptionCollection GetSystemOptionCollectionResource(int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<SystemOptionCollection> localVarResponse = GetSystemOptionCollectionResourceWithHttpInfo();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SystemOptionCollection</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<SystemOptionCollection> GetSystemOptionCollectionResourceWithHttpInfo(int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "SystemOptionsApi.GetSystemOptionCollectionResource";
            ...
            var localVarResponse = this.Client.Get<SystemOptionCollection>("/tenant/system/options", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetSystemOptionCollectionResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of SystemOptionCollection</returns>
        public async System.Threading.Tasks.Task<SystemOptionCollection> GetSystemOptionCollectionResourceAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<SystemOptionCollection> localVarResponse = await GetSystemOptionCollectionResourceWithHttpInfoAsync(operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SystemOptionCollection)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<SystemOptionCollection>> GetSystemOptionCollectionResourceWithHttpInfoAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<SystemOptionCollection>("/tenant/system/options", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Retrieve a specific system option Retrieve a specific system option (by a given category and key) on your tenant.  &gt; **⚠️ Important:** Note that it is possible to call this endpoint without the ROLE_OPTION_MANAGEMENT_ADMIN role, but only the options that are considered not secured (see the list of options above) will be returned. Otherwise, if the option is considered secured and the user does not have the required role, an HTTP response 403 will be returned. &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_OPTION_MANAGEMENT_ADMIN &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="category">The category of the system options.</param>
        /// <param name="key">The key of a system option.</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>SystemOption</returns>
        public SystemOption GetSystemOptionResource(string category, string key, int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<SystemOption> localVarResponse = GetSystemOptionResourceWithHttpInfo(category, key);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SystemOption</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<SystemOption> GetSystemOptionResourceWithHttpInfo(string category, string key, int operationIndex = 0)
        {
            // verify the required parameter 'category' is set
            if (category == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'category' when calling SystemOptionsApi->GetSystemOptionResource");
            }

            // verify the required parameter 'key' is set
            if (key == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'key' when calling SystemOptionsApi->GetSystemOptionResource");
            }
            ...
            localVarRequestOptions.Operation = "SystemOptionsApi.GetSystemOptionResource";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<SystemOption>("/tenant/system/options/{category}/{key}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetSystemOptionResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of SystemOption</returns>
        public async System.Threading.Tasks.Task<SystemOption> GetSystemOptionResourceAsync(string category, string key, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<SystemOption> localVarResponse = await GetSystemOptionResourceWithHttpInfoAsync(category, key, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SystemOption)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<SystemOption>> GetSystemOptionResourceWithHttpInfoAsync(string category, string key, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'category' is set
            if (category == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<SystemOption>("/tenant/system/options/{category}/{key}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
