...
namespace kern.services.CumulocityClient.Api
{
    ...
    /// </summary>
    public interface INotification20APIApiSync : IApiAccessor
    {
        ...
        /// <returns>NotificationApiResource</returns>
        NotificationApiResource GetNotificationApiResource(int operationIndex = 0);
        ...
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of NotificationApiResource</returns>
        ApiResponse<NotificationApiResource> GetNotificationApiResourceWithHttpInfo(int operationIndex = 0);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface INotification20APIApiAsync : IApiAccessor
    {
        ...
        /// <returns>Task of NotificationApiResource</returns>
        System.Threading.Tasks.Task<NotificationApiResource> GetNotificationApiResourceAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (NotificationApiResource)</returns>
        System.Threading.Tasks.Task<ApiResponse<NotificationApiResource>> GetNotificationApiResourceWithHttpInfoAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface INotification20APIApi : INotification20APIApiSync, INotification20APIApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class Notification20APIApi : INotification20APIApi
    {
        private kern.services.CumulocityClient.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="Notification20APIApi"/> class.
        /// </summary>
        /// <returns></returns>
        public Notification20APIApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public Notification20APIApi(string basePath)
        {
        ...
        /// <returns></returns>
        public Notification20APIApi(kern.services.CumulocityClient.Client.Configuration configuration)
        {
        ...
        public Notification20APIApi(kern.services.CumulocityClient.Client.ISynchronousClient client, kern.services.CumulocityClient.Client.IAsynchronousClient asyncClient, kern.services.CumulocityClient.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Retrieve URIs to collections of notification subscriptions Retrieve URIs and URI templates to collections of notification subscriptions.  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_NOTIFICATION_2_ADMIN &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>NotificationApiResource</returns>
        public NotificationApiResource GetNotificationApiResource(int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<NotificationApiResource> localVarResponse = GetNotificationApiResourceWithHttpInfo();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of NotificationApiResource</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<NotificationApiResource> GetNotificationApiResourceWithHttpInfo(int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "Notification20APIApi.GetNotificationApiResource";
            ...
            var localVarResponse = this.Client.Get<NotificationApiResource>("/notification2", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetNotificationApiResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of NotificationApiResource</returns>
        public async System.Threading.Tasks.Task<NotificationApiResource> GetNotificationApiResourceAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<NotificationApiResource> localVarResponse = await GetNotificationApiResourceWithHttpInfoAsync(operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (NotificationApiResource)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<NotificationApiResource>> GetNotificationApiResourceWithHttpInfoAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<NotificationApiResource>("/notification2", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
