...
namespace kern.services.CumulocityClient.Api
{
    ...
    /// </summary>
    public interface INotification20APIApi : IApiAccessor
    {
        ...
        ApiResponse<NotificationApiResource> GetNotificationApiResourceWithHttpInfo ();
        ...
        System.Threading.Tasks.Task<NotificationApiResource> GetNotificationApiResourceAsync (CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<NotificationApiResource>> GetNotificationApiResourceWithHttpInfoAsync (CancellationToken cancellationToken = default(CancellationToken));
    ...
    public partial class Notification20APIApi : INotification20APIApi
    {
        ...
        /// <returns></returns>
        public Notification20APIApi(kern.services.CumulocityClient.Client.Configuration configuration = null)
        {
        ...
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>NotificationApiResource</returns>
        public NotificationApiResource GetNotificationApiResource ()
        {
             ApiResponse<NotificationApiResource> localVarResponse = GetNotificationApiResourceWithHttpInfo();
        ...
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of NotificationApiResource</returns>
        public ApiResponse<NotificationApiResource> GetNotificationApiResourceWithHttpInfo ()
        {

            var localVarPath = "/notification2";
            ...
            {
                Exception exception = ExceptionFactory("GetNotificationApiResource", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<NotificationApiResource>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (NotificationApiResource) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(NotificationApiResource)));
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of NotificationApiResource</returns>
        public async System.Threading.Tasks.Task<NotificationApiResource> GetNotificationApiResourceAsync (CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<NotificationApiResource> localVarResponse = await GetNotificationApiResourceWithHttpInfoAsync(cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (NotificationApiResource)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<NotificationApiResource>> GetNotificationApiResourceWithHttpInfoAsync (CancellationToken cancellationToken = default(CancellationToken))
        {
