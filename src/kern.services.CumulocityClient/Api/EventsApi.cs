...
namespace kern.services.CumulocityClient.Api
{
    ...
    public interface IEventsApi : IApiAccessor
    {
        ...
        /// <returns></returns>
        void DeleteEventCollectionResource (string xCumulocityProcessingMode = default(string), DateTime? createdFrom = default(DateTime?), DateTime? createdTo = default(DateTime?), DateTime? dateFrom = default(DateTime?), DateTime? dateTo = default(DateTime?), string fragmentType = default(string), string source = default(string), string type = default(string));
        ...
        /// <param name="xCumulocityProcessingMode">Used to explicitly control the processing mode of the request. See [Processing mode](#processing-mode) for more details. (optional, default to PERSISTENT)</param>
        /// <returns></returns>
        void DeleteEventResource (string id, string xCumulocityProcessingMode = default(string));
        ...
        /// <param name="xCumulocityProcessingMode">Used to explicitly control the processing mode of the request. See [Processing mode](#processing-mode) for more details. (optional, default to PERSISTENT)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        ApiResponse<Object> DeleteEventResourceWithHttpInfo (string id, string xCumulocityProcessingMode = default(string));
        /// <summary>
        /// Retrieve all events
        /// </summary>
        /// <remarks>
        ...
        ApiResponse<Event> GetEventResourceWithHttpInfo (string id);
        /// <summary>
        /// Create an event
        /// </summary>
        /// <remarks>
        ...
        /// <param name="xCumulocityProcessingMode">Used to explicitly control the processing mode of the request. See [Processing mode](#processing-mode) for more details. (optional, default to PERSISTENT)</param>
        /// <returns>Event</returns>
        Event PostEventCollectionResource (PostEventCollectionResourceRequest postEventCollectionResourceRequest, string accept = default(string), string xCumulocityProcessingMode = default(string));
        ...
        /// <param name="xCumulocityProcessingMode">Used to explicitly control the processing mode of the request. See [Processing mode](#processing-mode) for more details. (optional, default to PERSISTENT)</param>
        /// <returns>ApiResponse of Event</returns>
        ApiResponse<Event> PostEventCollectionResourceWithHttpInfo (PostEventCollectionResourceRequest postEventCollectionResourceRequest, string accept = default(string), string xCumulocityProcessingMode = default(string));
        /// <summary>
        ...
        /// <param name="xCumulocityProcessingMode">Used to explicitly control the processing mode of the request. See [Processing mode](#processing-mode) for more details. (optional, default to PERSISTENT)</param>
        /// <returns>Event</returns>
        Event PutEventResource (string id, PutEventResourceRequest putEventResourceRequest, string accept = default(string), string xCumulocityProcessingMode = default(string));
        ...
        /// <param name="xCumulocityProcessingMode">Used to explicitly control the processing mode of the request. See [Processing mode](#processing-mode) for more details. (optional, default to PERSISTENT)</param>
        /// <returns>ApiResponse of Event</returns>
        ApiResponse<Event> PutEventResourceWithHttpInfo (string id, PutEventResourceRequest putEventResourceRequest, string accept = default(string), string xCumulocityProcessingMode = default(string));
        ...
        System.Threading.Tasks.Task DeleteEventCollectionResourceAsync (string xCumulocityProcessingMode = default(string), DateTime? createdFrom = default(DateTime?), DateTime? createdTo = default(DateTime?), DateTime? dateFrom = default(DateTime?), DateTime? dateTo = default(DateTime?), string fragmentType = default(string), string source = default(string), string type = default(string), CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task DeleteEventResourceAsync (string id, string xCumulocityProcessingMode = default(string), CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> DeleteEventResourceWithHttpInfoAsync (string id, string xCumulocityProcessingMode = default(string), CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Retrieve all events
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<EventCollection> GetEventCollectionResourceAsync (DateTime? createdFrom = default(DateTime?), DateTime? createdTo = default(DateTime?), int? currentPage = default(int?), DateTime? dateFrom = default(DateTime?), DateTime? dateTo = default(DateTime?), string fragmentType = default(string), string fragmentValue = default(string), DateTime? lastUpdatedFrom = default(DateTime?), DateTime? lastUpdatedTo = default(DateTime?), int? pageSize = default(int?), bool? revert = default(bool?), string source = default(string), string type = default(string), bool? withSourceAssets = default(bool?), bool? withSourceDevices = default(bool?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<Event> GetEventResourceAsync (string id, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Event>> GetEventResourceWithHttpInfoAsync (string id, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Create an event
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of Event</returns>
        System.Threading.Tasks.Task<Event> PostEventCollectionResourceAsync (PostEventCollectionResourceRequest postEventCollectionResourceRequest, string accept = default(string), string xCumulocityProcessingMode = default(string), CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (Event)</returns>
        System.Threading.Tasks.Task<ApiResponse<Event>> PostEventCollectionResourceWithHttpInfoAsync (PostEventCollectionResourceRequest postEventCollectionResourceRequest, string accept = default(string), string xCumulocityProcessingMode = default(string), CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Update a specific event
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of Event</returns>
        System.Threading.Tasks.Task<Event> PutEventResourceAsync (string id, PutEventResourceRequest putEventResourceRequest, string accept = default(string), string xCumulocityProcessingMode = default(string), CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (Event)</returns>
        System.Threading.Tasks.Task<ApiResponse<Event>> PutEventResourceWithHttpInfoAsync (string id, PutEventResourceRequest putEventResourceRequest, string accept = default(string), string xCumulocityProcessingMode = default(string), CancellationToken cancellationToken = default(CancellationToken));
    ...
    public partial class EventsApi : IEventsApi
    {
        ...
        /// <returns></returns>
        public EventsApi(kern.services.CumulocityClient.Client.Configuration configuration = null)
        {
        ...
        /// <param name="type">The type of event to search for. (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> DeleteEventCollectionResourceWithHttpInfo (string xCumulocityProcessingMode = default(string), DateTime? createdFrom = default(DateTime?), DateTime? createdTo = default(DateTime?), DateTime? dateFrom = default(DateTime?), DateTime? dateTo = default(DateTime?), string fragmentType = default(string), string source = default(string), string type = default(string))
        {

            var localVarPath = "/event/events";
            ...
            {
                Exception exception = ExceptionFactory("DeleteEventCollectionResource", localVarResponse);
        ...
        {
             await DeleteEventCollectionResourceWithHttpInfoAsync(xCumulocityProcessingMode, createdFrom, createdTo, dateFrom, dateTo, fragmentType, source, type, cancellationToken);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> DeleteEventCollectionResourceWithHttpInfoAsync (string xCumulocityProcessingMode = default(string), DateTime? createdFrom = default(DateTime?), DateTime? createdTo = default(DateTime?), DateTime? dateFrom = default(DateTime?), DateTime? dateTo = default(DateTime?), string fragmentType = default(string), string source = default(string), string type = default(string), CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <param name="xCumulocityProcessingMode">Used to explicitly control the processing mode of the request. See [Processing mode](#processing-mode) for more details. (optional, default to PERSISTENT)</param>
        /// <returns></returns>
        public void DeleteEventResource (string id, string xCumulocityProcessingMode = default(string))
        {
        ...
        /// <param name="xCumulocityProcessingMode">Used to explicitly control the processing mode of the request. See [Processing mode](#processing-mode) for more details. (optional, default to PERSISTENT)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> DeleteEventResourceWithHttpInfo (string id, string xCumulocityProcessingMode = default(string))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling EventsApi->DeleteEventResource");

            var localVarPath = "/event/events/{id}";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("DeleteEventResource", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task DeleteEventResourceAsync (string id, string xCumulocityProcessingMode = default(string), CancellationToken cancellationToken = default(CancellationToken))
        {
             await DeleteEventResourceWithHttpInfoAsync(id, xCumulocityProcessingMode, cancellationToken);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> DeleteEventResourceWithHttpInfoAsync (string id, string xCumulocityProcessingMode = default(string), CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling EventsApi->DeleteEventResource");
        ...
        {
             ApiResponse<EventCollection> localVarResponse = GetEventCollectionResourceWithHttpInfo(createdFrom, createdTo, currentPage, dateFrom, dateTo, fragmentType, fragmentValue, lastUpdatedFrom, lastUpdatedTo, pageSize, revert, source, type, withSourceAssets, withSourceDevices, withTotalElements, withTotalPages);
        ...
        /// <param name="withTotalPages">When set to &#x60;true&#x60;, the returned result will contain in the statistics object the total number of pages. Only applicable on [range queries](https://en.wikipedia.org/wiki/Range_query_(database)). (optional, default to false)</param>
        /// <returns>ApiResponse of EventCollection</returns>
        public ApiResponse<EventCollection> GetEventCollectionResourceWithHttpInfo (DateTime? createdFrom = default(DateTime?), DateTime? createdTo = default(DateTime?), int? currentPage = default(int?), DateTime? dateFrom = default(DateTime?), DateTime? dateTo = default(DateTime?), string fragmentType = default(string), string fragmentValue = default(string), DateTime? lastUpdatedFrom = default(DateTime?), DateTime? lastUpdatedTo = default(DateTime?), int? pageSize = default(int?), bool? revert = default(bool?), string source = default(string), string type = default(string), bool? withSourceAssets = default(bool?), bool? withSourceDevices = default(bool?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?))
        {
            ...
            if (dateTo != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("", "dateTo", dateTo)); // query parameter
            if (fragmentType != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("", "fragmentType", fragmentType)); // query parameter
            if (fragmentValue != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("", "fragmentValue", fragmentValue)); // query parameter
            if (lastUpdatedFrom != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("", "lastUpdatedFrom", lastUpdatedFrom)); // query parameter
            if (lastUpdatedTo != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("", "lastUpdatedTo", lastUpdatedTo)); // query parameter
            ...
            if (source != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("", "source", source)); // query parameter
            if (type != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("", "type", type)); // query parameter
            if (withSourceAssets != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("", "withSourceAssets", withSourceAssets)); // query parameter
            if (withSourceDevices != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("", "withSourceDevices", withSourceDevices)); // query parameter
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("GetEventCollectionResource", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<EventCollection>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (EventCollection) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(EventCollection)));
        }
        ...
        {
             ApiResponse<EventCollection> localVarResponse = await GetEventCollectionResourceWithHttpInfoAsync(createdFrom, createdTo, currentPage, dateFrom, dateTo, fragmentType, fragmentValue, lastUpdatedFrom, lastUpdatedTo, pageSize, revert, source, type, withSourceAssets, withSourceDevices, withTotalElements, withTotalPages, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (EventCollection)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<EventCollection>> GetEventCollectionResourceWithHttpInfoAsync (DateTime? createdFrom = default(DateTime?), DateTime? createdTo = default(DateTime?), int? currentPage = default(int?), DateTime? dateFrom = default(DateTime?), DateTime? dateTo = default(DateTime?), string fragmentType = default(string), string fragmentValue = default(string), DateTime? lastUpdatedFrom = default(DateTime?), DateTime? lastUpdatedTo = default(DateTime?), int? pageSize = default(int?), bool? revert = default(bool?), string source = default(string), string type = default(string), bool? withSourceAssets = default(bool?), bool? withSourceDevices = default(bool?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <param name="id">Unique identifier of the event.</param>
        /// <returns>Event</returns>
        public Event GetEventResource (string id)
        {
             ApiResponse<Event> localVarResponse = GetEventResourceWithHttpInfo(id);
             return localVarResponse.Data;
        }
        ...
        /// <param name="id">Unique identifier of the event.</param>
        /// <returns>ApiResponse of Event</returns>
        public ApiResponse<Event> GetEventResourceWithHttpInfo (string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling EventsApi->GetEventResource");
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("GetEventResource", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of Event</returns>
        public async System.Threading.Tasks.Task<Event> GetEventResourceAsync (string id, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<Event> localVarResponse = await GetEventResourceWithHttpInfoAsync(id, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (Event)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Event>> GetEventResourceWithHttpInfoAsync (string id, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling EventsApi->GetEventResource");
        ...
        /// <param name="xCumulocityProcessingMode">Used to explicitly control the processing mode of the request. See [Processing mode](#processing-mode) for more details. (optional, default to PERSISTENT)</param>
        /// <returns>Event</returns>
        public Event PostEventCollectionResource (PostEventCollectionResourceRequest postEventCollectionResourceRequest, string accept = default(string), string xCumulocityProcessingMode = default(string))
        {
             ApiResponse<Event> localVarResponse = PostEventCollectionResourceWithHttpInfo(postEventCollectionResourceRequest, accept, xCumulocityProcessingMode);
             return localVarResponse.Data;
        }
        ...
        /// <param name="xCumulocityProcessingMode">Used to explicitly control the processing mode of the request. See [Processing mode](#processing-mode) for more details. (optional, default to PERSISTENT)</param>
        /// <returns>ApiResponse of Event</returns>
        public ApiResponse<Event> PostEventCollectionResourceWithHttpInfo (PostEventCollectionResourceRequest postEventCollectionResourceRequest, string accept = default(string), string xCumulocityProcessingMode = default(string))
        {
            // verify the required parameter 'postEventCollectionResourceRequest' is set
            if (postEventCollectionResourceRequest == null)
                throw new ApiException(400, "Missing required parameter 'postEventCollectionResourceRequest' when calling EventsApi->PostEventCollectionResource");
            ...
            if (xCumulocityProcessingMode != null) localVarHeaderParams.Add("X-Cumulocity-Processing-Mode", this.Configuration.ApiClient.ParameterToString(xCumulocityProcessingMode)); // header parameter
            if (postEventCollectionResourceRequest != null && postEventCollectionResourceRequest.GetType() != typeof(byte[]))
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(postEventCollectionResourceRequest); // http body (model) parameter
            }
            else
            {
                localVarPostBody = postEventCollectionResourceRequest; // byte array
            }
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("PostEventCollectionResource", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of Event</returns>
        public async System.Threading.Tasks.Task<Event> PostEventCollectionResourceAsync (PostEventCollectionResourceRequest postEventCollectionResourceRequest, string accept = default(string), string xCumulocityProcessingMode = default(string), CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<Event> localVarResponse = await PostEventCollectionResourceWithHttpInfoAsync(postEventCollectionResourceRequest, accept, xCumulocityProcessingMode, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (Event)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Event>> PostEventCollectionResourceWithHttpInfoAsync (PostEventCollectionResourceRequest postEventCollectionResourceRequest, string accept = default(string), string xCumulocityProcessingMode = default(string), CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'postEventCollectionResourceRequest' is set
            if (postEventCollectionResourceRequest == null)
                throw new ApiException(400, "Missing required parameter 'postEventCollectionResourceRequest' when calling EventsApi->PostEventCollectionResource");
        ...
        /// <param name="xCumulocityProcessingMode">Used to explicitly control the processing mode of the request. See [Processing mode](#processing-mode) for more details. (optional, default to PERSISTENT)</param>
        /// <returns>Event</returns>
        public Event PutEventResource (string id, PutEventResourceRequest putEventResourceRequest, string accept = default(string), string xCumulocityProcessingMode = default(string))
        {
             ApiResponse<Event> localVarResponse = PutEventResourceWithHttpInfo(id, putEventResourceRequest, accept, xCumulocityProcessingMode);
             return localVarResponse.Data;
        }
        ...
        /// <param name="xCumulocityProcessingMode">Used to explicitly control the processing mode of the request. See [Processing mode](#processing-mode) for more details. (optional, default to PERSISTENT)</param>
        /// <returns>ApiResponse of Event</returns>
        public ApiResponse<Event> PutEventResourceWithHttpInfo (string id, PutEventResourceRequest putEventResourceRequest, string accept = default(string), string xCumulocityProcessingMode = default(string))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling EventsApi->PutEventResource");
            // verify the required parameter 'putEventResourceRequest' is set
            if (putEventResourceRequest == null)
                throw new ApiException(400, "Missing required parameter 'putEventResourceRequest' when calling EventsApi->PutEventResource");
            ...
            if (accept != null) localVarHeaderParams.Add("Accept", this.Configuration.ApiClient.ParameterToString(accept)); // header parameter
            if (xCumulocityProcessingMode != null) localVarHeaderParams.Add("X-Cumulocity-Processing-Mode", this.Configuration.ApiClient.ParameterToString(xCumulocityProcessingMode)); // header parameter
            if (putEventResourceRequest != null && putEventResourceRequest.GetType() != typeof(byte[]))
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(putEventResourceRequest); // http body (model) parameter
            }
            else
            {
                localVarPostBody = putEventResourceRequest; // byte array
            }
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("PutEventResource", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of Event</returns>
        public async System.Threading.Tasks.Task<Event> PutEventResourceAsync (string id, PutEventResourceRequest putEventResourceRequest, string accept = default(string), string xCumulocityProcessingMode = default(string), CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<Event> localVarResponse = await PutEventResourceWithHttpInfoAsync(id, putEventResourceRequest, accept, xCumulocityProcessingMode, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (Event)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Event>> PutEventResourceWithHttpInfoAsync (string id, PutEventResourceRequest putEventResourceRequest, string accept = default(string), string xCumulocityProcessingMode = default(string), CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling EventsApi->PutEventResource");
