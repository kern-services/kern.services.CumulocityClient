...
namespace kern.services.CumulocityClient.Api
{
    ...
    public interface IEventsApiSync : IApiAccessor
    {
        ...
        /// <param name="createdFrom">Start date or date and time of the event&#39;s creation (set by the platform during creation). (optional)</param>
        /// <param name="createdTo">End date or date and time of the event&#39;s creation (set by the platform during creation). (optional)</param>
        /// <param name="dateFrom">Start date or date and time of the event occurrence (provided by the device). (optional)</param>
        /// <param name="dateTo">End date or date and time of the event occurrence (provided by the device). (optional)</param>
        ...
        /// <param name="source">The managed object ID to which the event is associated. (optional)</param>
        /// <param name="type">The type of event to search for. (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns></returns>
        void DeleteEventCollectionResource(string? xCumulocityProcessingMode = default(string?), DateTime? createdFrom = default(DateTime?), DateTime? createdTo = default(DateTime?), DateTime? dateFrom = default(DateTime?), DateTime? dateTo = default(DateTime?), string? fragmentType = default(string?), string? source = default(string?), string? type = default(string?), int operationIndex = 0);
        ...
        ApiResponse<Object> DeleteEventCollectionResourceWithHttpInfo(string? xCumulocityProcessingMode = default(string?), DateTime? createdFrom = default(DateTime?), DateTime? createdTo = default(DateTime?), DateTime? dateFrom = default(DateTime?), DateTime? dateTo = default(DateTime?), string? fragmentType = default(string?), string? source = default(string?), string? type = default(string?), int operationIndex = 0);
        /// <summary>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns></returns>
        void DeleteEventResource(string id, string? xCumulocityProcessingMode = default(string?), int operationIndex = 0);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        ApiResponse<Object> DeleteEventResourceWithHttpInfo(string id, string? xCumulocityProcessingMode = default(string?), int operationIndex = 0);
        /// <summary>
        /// Retrieve all events
        /// </summary>
        /// <remarks>
        ...
        /// <param name="dateTo">End date or date and time of the event occurrence (provided by the device). (optional)</param>
        /// <param name="fragmentType">A characteristic which identifies a managed object or event, for example, geolocation, electricity sensor, relay state. (optional)</param>
        /// <param name="fragmentValue">Allows filtering events by the fragment&#39;s value, but only when provided together with &#x60;fragmentType&#x60;.  &gt; **⚠️ Important:** Only fragments with a string value are supported.  (optional)</param>
        ...
        /// <param name="revert">If you are using a range query (that is, at least one of the &#x60;dateFrom&#x60; or &#x60;dateTo&#x60; parameters is included in the request), then setting &#x60;revert&#x3D;true&#x60; will sort the results by the oldest events first. By default, the results are sorted by the newest events first.  (optional, default to false)</param>
        /// <param name="source">The managed object ID to which the event is associated. (optional)</param>
        /// <param name="type">The type of event to search for. (optional)</param>
        /// <param name="withSourceAssets">When set to &#x60;true&#x60; also events for related source assets will be included in the request. When this parameter is provided a &#x60;source&#x60; must be specified. (optional, default to false)</param>
        /// <param name="withSourceDevices">When set to &#x60;true&#x60; also events for related source devices will be included in the request. When this parameter is provided a &#x60;source&#x60; must be specified. (optional, default to false)</param>
        ...
        EventCollection GetEventCollectionResource(DateTime? createdFrom = default(DateTime?), DateTime? createdTo = default(DateTime?), int? currentPage = default(int?), DateTime? dateFrom = default(DateTime?), DateTime? dateTo = default(DateTime?), string? fragmentType = default(string?), string? fragmentValue = default(string?), DateTime? lastUpdatedFrom = default(DateTime?), DateTime? lastUpdatedTo = default(DateTime?), int? pageSize = default(int?), bool? revert = default(bool?), string? source = default(string?), string? type = default(string?), bool? withSourceAssets = default(bool?), bool? withSourceDevices = default(bool?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0);
        ...
        Event GetEventResource(string id, int operationIndex = 0);
        ...
        ApiResponse<Event> GetEventResourceWithHttpInfo(string id, int operationIndex = 0);
        /// <summary>
        /// Create an event
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="postEventCollectionResourceRequest"></param>
        /// <param name="accept">Advertises which content types, expressed as MIME types, the client is able to understand. (optional)</param>
        /// <param name="xCumulocityProcessingMode">Used to explicitly control the processing mode of the request. See [Processing mode](#processing-mode) for more details. (optional, default to PERSISTENT)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>Event</returns>
        Event PostEventCollectionResource(PostEventCollectionResourceRequest postEventCollectionResourceRequest, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Event</returns>
        ApiResponse<Event> PostEventCollectionResourceWithHttpInfo(PostEventCollectionResourceRequest postEventCollectionResourceRequest, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0);
        /// <summary>
        ...
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">Unique identifier of the event.</param>
        /// <param name="putEventResourceRequest"></param>
        /// <param name="accept">Advertises which content types, expressed as MIME types, the client is able to understand. (optional)</param>
        /// <param name="xCumulocityProcessingMode">Used to explicitly control the processing mode of the request. See [Processing mode](#processing-mode) for more details. (optional, default to PERSISTENT)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>Event</returns>
        Event PutEventResource(string id, PutEventResourceRequest putEventResourceRequest, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Event</returns>
        ApiResponse<Event> PutEventResourceWithHttpInfo(string id, PutEventResourceRequest putEventResourceRequest, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0);
    ...
    public interface IEventsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task DeleteEventCollectionResourceAsync(string? xCumulocityProcessingMode = default(string?), DateTime? createdFrom = default(DateTime?), DateTime? createdTo = default(DateTime?), DateTime? dateFrom = default(DateTime?), DateTime? dateTo = default(DateTime?), string? fragmentType = default(string?), string? source = default(string?), string? type = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> DeleteEventCollectionResourceWithHttpInfoAsync(string? xCumulocityProcessingMode = default(string?), DateTime? createdFrom = default(DateTime?), DateTime? createdTo = default(DateTime?), DateTime? dateFrom = default(DateTime?), DateTime? dateTo = default(DateTime?), string? fragmentType = default(string?), string? source = default(string?), string? type = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Remove a specific event
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task DeleteEventResourceAsync(string id, string? xCumulocityProcessingMode = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> DeleteEventResourceWithHttpInfoAsync(string id, string? xCumulocityProcessingMode = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Retrieve all events
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<EventCollection> GetEventCollectionResourceAsync(DateTime? createdFrom = default(DateTime?), DateTime? createdTo = default(DateTime?), int? currentPage = default(int?), DateTime? dateFrom = default(DateTime?), DateTime? dateTo = default(DateTime?), string? fragmentType = default(string?), string? fragmentValue = default(string?), DateTime? lastUpdatedFrom = default(DateTime?), DateTime? lastUpdatedTo = default(DateTime?), int? pageSize = default(int?), bool? revert = default(bool?), string? source = default(string?), string? type = default(string?), bool? withSourceAssets = default(bool?), bool? withSourceDevices = default(bool?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<EventCollection>> GetEventCollectionResourceWithHttpInfoAsync(DateTime? createdFrom = default(DateTime?), DateTime? createdTo = default(DateTime?), int? currentPage = default(int?), DateTime? dateFrom = default(DateTime?), DateTime? dateTo = default(DateTime?), string? fragmentType = default(string?), string? fragmentValue = default(string?), DateTime? lastUpdatedFrom = default(DateTime?), DateTime? lastUpdatedTo = default(DateTime?), int? pageSize = default(int?), bool? revert = default(bool?), string? source = default(string?), string? type = default(string?), bool? withSourceAssets = default(bool?), bool? withSourceDevices = default(bool?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Retrieve a specific event
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<Event> GetEventResourceAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Event>> GetEventResourceWithHttpInfoAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Create an event
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Event</returns>
        System.Threading.Tasks.Task<Event> PostEventCollectionResourceAsync(PostEventCollectionResourceRequest postEventCollectionResourceRequest, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Event)</returns>
        System.Threading.Tasks.Task<ApiResponse<Event>> PostEventCollectionResourceWithHttpInfoAsync(PostEventCollectionResourceRequest postEventCollectionResourceRequest, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Update a specific event
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Event)</returns>
        System.Threading.Tasks.Task<ApiResponse<Event>> PutEventResourceWithHttpInfoAsync(string id, PutEventResourceRequest putEventResourceRequest, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class EventsApi : IEventsApi
    {
        ...
        /// <returns></returns>
        public EventsApi(kern.services.CumulocityClient.Client.Configuration configuration)
        {
        ...
        public EventsApi(kern.services.CumulocityClient.Client.ISynchronousClient client, kern.services.CumulocityClient.Client.IAsynchronousClient asyncClient, kern.services.CumulocityClient.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Remove event collections Remove event collections specified by query parameters.  DELETE requests are not synchronous. The response could be returned before the delete request has been completed. This may happen especially when the deleted event has a lot of associated data. After sending the request, the platform starts deleting the associated data in an asynchronous way. Finally, the requested event is deleted after all associated data has been deleted.  &gt; **⚠️ Important:** Note that it is possible to call this endpoint without providing any parameter - it will result in deleting all events and it is not recommended.  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_EVENT_ADMIN &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="xCumulocityProcessingMode">Used to explicitly control the processing mode of the request. See [Processing mode](#processing-mode) for more details. (optional, default to PERSISTENT)</param>
        /// <param name="createdFrom">Start date or date and time of the event&#39;s creation (set by the platform during creation). (optional)</param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns></returns>
        public void DeleteEventCollectionResource(string? xCumulocityProcessingMode = default(string?), DateTime? createdFrom = default(DateTime?), DateTime? createdTo = default(DateTime?), DateTime? dateFrom = default(DateTime?), DateTime? dateTo = default(DateTime?), string? fragmentType = default(string?), string? source = default(string?), string? type = default(string?), int operationIndex = 0)
        {
            DeleteEventCollectionResourceWithHttpInfo(xCumulocityProcessingMode, createdFrom, createdTo, dateFrom, dateTo, fragmentType, source, type);
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<Object> DeleteEventCollectionResourceWithHttpInfo(string? xCumulocityProcessingMode = default(string?), DateTime? createdFrom = default(DateTime?), DateTime? createdTo = default(DateTime?), DateTime? dateFrom = default(DateTime?), DateTime? dateTo = default(DateTime?), string? fragmentType = default(string?), string? source = default(string?), string? type = default(string?), int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "EventsApi.DeleteEventCollectionResource";
            ...
            var localVarResponse = this.Client.Delete<Object>("/event/events", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("DeleteEventCollectionResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task DeleteEventCollectionResourceAsync(string? xCumulocityProcessingMode = default(string?), DateTime? createdFrom = default(DateTime?), DateTime? createdTo = default(DateTime?), DateTime? dateFrom = default(DateTime?), DateTime? dateTo = default(DateTime?), string? fragmentType = default(string?), string? source = default(string?), string? type = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await DeleteEventCollectionResourceWithHttpInfoAsync(xCumulocityProcessingMode, createdFrom, createdTo, dateFrom, dateTo, fragmentType, source, type, operationIndex, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<Object>> DeleteEventCollectionResourceWithHttpInfoAsync(string? xCumulocityProcessingMode = default(string?), DateTime? createdFrom = default(DateTime?), DateTime? createdTo = default(DateTime?), DateTime? dateFrom = default(DateTime?), DateTime? dateTo = default(DateTime?), string? fragmentType = default(string?), string? source = default(string?), string? type = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.DeleteAsync<Object>("/event/events", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Remove a specific event Remove a specific event by a given ID.  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_EVENT_ADMIN &lt;b&gt;OR&lt;/b&gt; owner of the source &lt;b&gt;OR&lt;/b&gt; EVENT_ADMIN permission on the source &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">Unique identifier of the event.</param>
        /// <param name="xCumulocityProcessingMode">Used to explicitly control the processing mode of the request. See [Processing mode](#processing-mode) for more details. (optional, default to PERSISTENT)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns></returns>
        public void DeleteEventResource(string id, string? xCumulocityProcessingMode = default(string?), int operationIndex = 0)
        {
            DeleteEventResourceWithHttpInfo(id, xCumulocityProcessingMode);
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<Object> DeleteEventResourceWithHttpInfo(string id, string? xCumulocityProcessingMode = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'id' when calling EventsApi->DeleteEventResource");
            }
            ...
            localVarRequestOptions.Operation = "EventsApi.DeleteEventResource";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Delete<Object>("/event/events/{id}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("DeleteEventResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task DeleteEventResourceAsync(string id, string? xCumulocityProcessingMode = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await DeleteEventResourceWithHttpInfoAsync(id, xCumulocityProcessingMode, operationIndex, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<Object>> DeleteEventResourceWithHttpInfoAsync(string id, string? xCumulocityProcessingMode = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.DeleteAsync<Object>("/event/events/{id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>EventCollection</returns>
        public EventCollection GetEventCollectionResource(DateTime? createdFrom = default(DateTime?), DateTime? createdTo = default(DateTime?), int? currentPage = default(int?), DateTime? dateFrom = default(DateTime?), DateTime? dateTo = default(DateTime?), string? fragmentType = default(string?), string? fragmentValue = default(string?), DateTime? lastUpdatedFrom = default(DateTime?), DateTime? lastUpdatedTo = default(DateTime?), int? pageSize = default(int?), bool? revert = default(bool?), string? source = default(string?), string? type = default(string?), bool? withSourceAssets = default(bool?), bool? withSourceDevices = default(bool?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<EventCollection> localVarResponse = GetEventCollectionResourceWithHttpInfo(createdFrom, createdTo, currentPage, dateFrom, dateTo, fragmentType, fragmentValue, lastUpdatedFrom, lastUpdatedTo, pageSize, revert, source, type, withSourceAssets, withSourceDevices, withTotalElements, withTotalPages);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of EventCollection</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<EventCollection> GetEventCollectionResourceWithHttpInfo(DateTime? createdFrom = default(DateTime?), DateTime? createdTo = default(DateTime?), int? currentPage = default(int?), DateTime? dateFrom = default(DateTime?), DateTime? dateTo = default(DateTime?), string? fragmentType = default(string?), string? fragmentValue = default(string?), DateTime? lastUpdatedFrom = default(DateTime?), DateTime? lastUpdatedTo = default(DateTime?), int? pageSize = default(int?), bool? revert = default(bool?), string? source = default(string?), string? type = default(string?), bool? withSourceAssets = default(bool?), bool? withSourceDevices = default(bool?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.RequestOptions localVarRequestOptions = new kern.services.CumulocityClient.Client.RequestOptions();
            ...
            {
                localVarRequestOptions.QueryParameters.Add(kern.services.CumulocityClient.Client.ClientUtils.ParameterToMultiMap("", "fragmentValue", fragmentValue));
            }
            ...
            localVarRequestOptions.Operation = "EventsApi.GetEventCollectionResource";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<EventCollection>("/event/events", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetEventCollectionResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of EventCollection</returns>
        public async System.Threading.Tasks.Task<EventCollection> GetEventCollectionResourceAsync(DateTime? createdFrom = default(DateTime?), DateTime? createdTo = default(DateTime?), int? currentPage = default(int?), DateTime? dateFrom = default(DateTime?), DateTime? dateTo = default(DateTime?), string? fragmentType = default(string?), string? fragmentValue = default(string?), DateTime? lastUpdatedFrom = default(DateTime?), DateTime? lastUpdatedTo = default(DateTime?), int? pageSize = default(int?), bool? revert = default(bool?), string? source = default(string?), string? type = default(string?), bool? withSourceAssets = default(bool?), bool? withSourceDevices = default(bool?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<EventCollection> localVarResponse = await GetEventCollectionResourceWithHttpInfoAsync(createdFrom, createdTo, currentPage, dateFrom, dateTo, fragmentType, fragmentValue, lastUpdatedFrom, lastUpdatedTo, pageSize, revert, source, type, withSourceAssets, withSourceDevices, withTotalElements, withTotalPages, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (EventCollection)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<EventCollection>> GetEventCollectionResourceWithHttpInfoAsync(DateTime? createdFrom = default(DateTime?), DateTime? createdTo = default(DateTime?), int? currentPage = default(int?), DateTime? dateFrom = default(DateTime?), DateTime? dateTo = default(DateTime?), string? fragmentType = default(string?), string? fragmentValue = default(string?), DateTime? lastUpdatedFrom = default(DateTime?), DateTime? lastUpdatedTo = default(DateTime?), int? pageSize = default(int?), bool? revert = default(bool?), string? source = default(string?), string? type = default(string?), bool? withSourceAssets = default(bool?), bool? withSourceDevices = default(bool?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<EventCollection>("/event/events", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Retrieve a specific event Retrieve a specific event by a given ID.  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_EVENT_READ &lt;b&gt;OR&lt;/b&gt; owner of the source &lt;b&gt;OR&lt;/b&gt; EVENT_READ permission on the source &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">Unique identifier of the event.</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>Event</returns>
        public Event GetEventResource(string id, int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<Event> localVarResponse = GetEventResourceWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Event</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<Event> GetEventResourceWithHttpInfo(string id, int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'id' when calling EventsApi->GetEventResource");
            }
            ...
            localVarRequestOptions.Operation = "EventsApi.GetEventResource";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<Event>("/event/events/{id}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetEventResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Event</returns>
        public async System.Threading.Tasks.Task<Event> GetEventResourceAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<Event> localVarResponse = await GetEventResourceWithHttpInfoAsync(id, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Event)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<Event>> GetEventResourceWithHttpInfoAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<Event>("/event/events/{id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Create an event An event must be associated with a source (managed object) identified by an ID.&lt;br&gt; In general, each event consists of:  *  A type to identify the nature of the event. *  A time stamp to indicate when the event was last updated. *  A description of the event. *  The managed object which originated the event.  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_EVENT_ADMIN &lt;b&gt;OR&lt;/b&gt; owner of the source &lt;b&gt;OR&lt;/b&gt; EVENT_ADMIN permission on the source &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="postEventCollectionResourceRequest"></param>
        /// <param name="accept">Advertises which content types, expressed as MIME types, the client is able to understand. (optional)</param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>Event</returns>
        public Event PostEventCollectionResource(PostEventCollectionResourceRequest postEventCollectionResourceRequest, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<Event> localVarResponse = PostEventCollectionResourceWithHttpInfo(postEventCollectionResourceRequest, accept, xCumulocityProcessingMode);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Event</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<Event> PostEventCollectionResourceWithHttpInfo(PostEventCollectionResourceRequest postEventCollectionResourceRequest, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'postEventCollectionResourceRequest' is set
            if (postEventCollectionResourceRequest == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'postEventCollectionResourceRequest' when calling EventsApi->PostEventCollectionResource");
            }
            ...
            localVarRequestOptions.Data = postEventCollectionResourceRequest;

            localVarRequestOptions.Operation = "EventsApi.PostEventCollectionResource";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<Event>("/event/events", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PostEventCollectionResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Event</returns>
        public async System.Threading.Tasks.Task<Event> PostEventCollectionResourceAsync(PostEventCollectionResourceRequest postEventCollectionResourceRequest, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<Event> localVarResponse = await PostEventCollectionResourceWithHttpInfoAsync(postEventCollectionResourceRequest, accept, xCumulocityProcessingMode, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Event)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<Event>> PostEventCollectionResourceWithHttpInfoAsync(PostEventCollectionResourceRequest postEventCollectionResourceRequest, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'postEventCollectionResourceRequest' is set
            if (postEventCollectionResourceRequest == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<Event>("/event/events", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Update a specific event Update a specific event by a given ID. Only its text description and custom fragments can be updated.  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_EVENT_ADMIN &lt;b&gt;OR&lt;/b&gt; owner of the source &lt;b&gt;OR&lt;/b&gt; EVENT_ADMIN permission on the source &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">Unique identifier of the event.</param>
        /// <param name="putEventResourceRequest"></param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>Event</returns>
        public Event PutEventResource(string id, PutEventResourceRequest putEventResourceRequest, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<Event> localVarResponse = PutEventResourceWithHttpInfo(id, putEventResourceRequest, accept, xCumulocityProcessingMode);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Event</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<Event> PutEventResourceWithHttpInfo(string id, PutEventResourceRequest putEventResourceRequest, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'id' when calling EventsApi->PutEventResource");
            }

            // verify the required parameter 'putEventResourceRequest' is set
            if (putEventResourceRequest == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'putEventResourceRequest' when calling EventsApi->PutEventResource");
            }
            ...
            localVarRequestOptions.Data = putEventResourceRequest;

            localVarRequestOptions.Operation = "EventsApi.PutEventResource";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Put<Event>("/event/events/{id}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PutEventResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Event</returns>
        public async System.Threading.Tasks.Task<Event> PutEventResourceAsync(string id, PutEventResourceRequest putEventResourceRequest, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<Event> localVarResponse = await PutEventResourceWithHttpInfoAsync(id, putEventResourceRequest, accept, xCumulocityProcessingMode, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Event)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<Event>> PutEventResourceWithHttpInfoAsync(string id, PutEventResourceRequest putEventResourceRequest, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PutAsync<Event>("/event/events/{id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
