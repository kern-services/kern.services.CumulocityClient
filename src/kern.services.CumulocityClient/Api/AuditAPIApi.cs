...
namespace kern.services.CumulocityClient.Api
{
    ...
    /// </summary>
    public interface IAuditAPIApiSync : IApiAccessor
    {
        ...
        /// <returns>AuditApiResource</returns>
        AuditApiResource GetAuditApiResource(int operationIndex = 0);
        ...
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of AuditApiResource</returns>
        ApiResponse<AuditApiResource> GetAuditApiResourceWithHttpInfo(int operationIndex = 0);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAuditAPIApiAsync : IApiAccessor
    {
        ...
        /// <returns>Task of AuditApiResource</returns>
        System.Threading.Tasks.Task<AuditApiResource> GetAuditApiResourceAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (AuditApiResource)</returns>
        System.Threading.Tasks.Task<ApiResponse<AuditApiResource>> GetAuditApiResourceWithHttpInfoAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAuditAPIApi : IAuditAPIApiSync, IAuditAPIApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class AuditAPIApi : IAuditAPIApi
    {
        private kern.services.CumulocityClient.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="AuditAPIApi"/> class.
        /// </summary>
        /// <returns></returns>
        public AuditAPIApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public AuditAPIApi(string basePath)
        {
        ...
        /// <returns></returns>
        public AuditAPIApi(kern.services.CumulocityClient.Client.Configuration configuration)
        {
        ...
        public AuditAPIApi(kern.services.CumulocityClient.Client.ISynchronousClient client, kern.services.CumulocityClient.Client.IAsynchronousClient asyncClient, kern.services.CumulocityClient.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Retrieve URIs to collections of audits Retrieve URIs and URI templates to collections of audit records.  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_AUDIT_READ &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>AuditApiResource</returns>
        public AuditApiResource GetAuditApiResource(int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<AuditApiResource> localVarResponse = GetAuditApiResourceWithHttpInfo();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of AuditApiResource</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<AuditApiResource> GetAuditApiResourceWithHttpInfo(int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "AuditAPIApi.GetAuditApiResource";
            ...
            var localVarResponse = this.Client.Get<AuditApiResource>("/audit", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetAuditApiResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of AuditApiResource</returns>
        public async System.Threading.Tasks.Task<AuditApiResource> GetAuditApiResourceAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<AuditApiResource> localVarResponse = await GetAuditApiResourceWithHttpInfoAsync(operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (AuditApiResource)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<AuditApiResource>> GetAuditApiResourceWithHttpInfoAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<AuditApiResource>("/audit", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
