...
namespace kern.services.CumulocityClient.Api
{
    ...
    /// </summary>
    public interface IAuditAPIApi : IApiAccessor
    {
        ...
        ApiResponse<AuditApiResource> GetAuditApiResourceWithHttpInfo ();
        ...
        System.Threading.Tasks.Task<AuditApiResource> GetAuditApiResourceAsync (CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<AuditApiResource>> GetAuditApiResourceWithHttpInfoAsync (CancellationToken cancellationToken = default(CancellationToken));
    ...
    public partial class AuditAPIApi : IAuditAPIApi
    {
        ...
        /// <returns></returns>
        public AuditAPIApi(kern.services.CumulocityClient.Client.Configuration configuration = null)
        {
        ...
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>AuditApiResource</returns>
        public AuditApiResource GetAuditApiResource ()
        {
             ApiResponse<AuditApiResource> localVarResponse = GetAuditApiResourceWithHttpInfo();
        ...
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of AuditApiResource</returns>
        public ApiResponse<AuditApiResource> GetAuditApiResourceWithHttpInfo ()
        {
            ...
            {
                Exception exception = ExceptionFactory("GetAuditApiResource", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<AuditApiResource>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (AuditApiResource) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(AuditApiResource)));
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of AuditApiResource</returns>
        public async System.Threading.Tasks.Task<AuditApiResource> GetAuditApiResourceAsync (CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<AuditApiResource> localVarResponse = await GetAuditApiResourceWithHttpInfoAsync(cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (AuditApiResource)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<AuditApiResource>> GetAuditApiResourceWithHttpInfoAsync (CancellationToken cancellationToken = default(CancellationToken))
        {
