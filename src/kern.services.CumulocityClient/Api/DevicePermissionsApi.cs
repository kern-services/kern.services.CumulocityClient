...
namespace kern.services.CumulocityClient.Api
{
    ...
    /// </summary>
    public interface IDevicePermissionsApi : IApiAccessor
    {
        ...
        ApiResponse<DevicePermissionOwners> GetDevicePermissionsResourceWithHttpInfo (string id);
        /// <summary>
        ...
        /// <returns></returns>
        void PutDevicePermissionsResource (string id, UpdatedDevicePermissions updatedDevicePermissions, string accept = default(string));
        ...
        ApiResponse<Object> PutDevicePermissionsResourceWithHttpInfo (string id, UpdatedDevicePermissions updatedDevicePermissions, string accept = default(string));
        ...
        System.Threading.Tasks.Task<DevicePermissionOwners> GetDevicePermissionsResourceAsync (string id, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<DevicePermissionOwners>> GetDevicePermissionsResourceWithHttpInfoAsync (string id, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Updates the device permissions assignments
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task PutDevicePermissionsResourceAsync (string id, UpdatedDevicePermissions updatedDevicePermissions, string accept = default(string), CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> PutDevicePermissionsResourceWithHttpInfoAsync (string id, UpdatedDevicePermissions updatedDevicePermissions, string accept = default(string), CancellationToken cancellationToken = default(CancellationToken));
    ...
    public partial class DevicePermissionsApi : IDevicePermissionsApi
    {
        ...
        /// <returns></returns>
        public DevicePermissionsApi(kern.services.CumulocityClient.Client.Configuration configuration = null)
        {
        ...
        /// <param name="id">Unique identifier of the managed object.</param>
        /// <returns>DevicePermissionOwners</returns>
        public DevicePermissionOwners GetDevicePermissionsResource (string id)
        {
             ApiResponse<DevicePermissionOwners> localVarResponse = GetDevicePermissionsResourceWithHttpInfo(id);
        ...
        /// <param name="id">Unique identifier of the managed object.</param>
        /// <returns>ApiResponse of DevicePermissionOwners</returns>
        public ApiResponse<DevicePermissionOwners> GetDevicePermissionsResourceWithHttpInfo (string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling DevicePermissionsApi->GetDevicePermissionsResource");

            var localVarPath = "/user/devicePermissions/{id}";
            ...
            {
                Exception exception = ExceptionFactory("GetDevicePermissionsResource", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<DevicePermissionOwners>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (DevicePermissionOwners) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(DevicePermissionOwners)));
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of DevicePermissionOwners</returns>
        public async System.Threading.Tasks.Task<DevicePermissionOwners> GetDevicePermissionsResourceAsync (string id, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<DevicePermissionOwners> localVarResponse = await GetDevicePermissionsResourceWithHttpInfoAsync(id, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (DevicePermissionOwners)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<DevicePermissionOwners>> GetDevicePermissionsResourceWithHttpInfoAsync (string id, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling DevicePermissionsApi->GetDevicePermissionsResource");
        ...
        /// <param name="accept">Advertises which content types, expressed as MIME types, the client is able to understand. (optional)</param>
        /// <returns></returns>
        public void PutDevicePermissionsResource (string id, UpdatedDevicePermissions updatedDevicePermissions, string accept = default(string))
        {
        ...
        /// <param name="accept">Advertises which content types, expressed as MIME types, the client is able to understand. (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> PutDevicePermissionsResourceWithHttpInfo (string id, UpdatedDevicePermissions updatedDevicePermissions, string accept = default(string))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling DevicePermissionsApi->PutDevicePermissionsResource");
            // verify the required parameter 'updatedDevicePermissions' is set
            if (updatedDevicePermissions == null)
                throw new ApiException(400, "Missing required parameter 'updatedDevicePermissions' when calling DevicePermissionsApi->PutDevicePermissionsResource");
            ...
            if (updatedDevicePermissions != null && updatedDevicePermissions.GetType() != typeof(byte[]))
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(updatedDevicePermissions); // http body (model) parameter
            }
            else
            {
                localVarPostBody = updatedDevicePermissions; // byte array
            }
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("PutDevicePermissionsResource", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task PutDevicePermissionsResourceAsync (string id, UpdatedDevicePermissions updatedDevicePermissions, string accept = default(string), CancellationToken cancellationToken = default(CancellationToken))
        {
             await PutDevicePermissionsResourceWithHttpInfoAsync(id, updatedDevicePermissions, accept, cancellationToken);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> PutDevicePermissionsResourceWithHttpInfoAsync (string id, UpdatedDevicePermissions updatedDevicePermissions, string accept = default(string), CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling DevicePermissionsApi->PutDevicePermissionsResource");
