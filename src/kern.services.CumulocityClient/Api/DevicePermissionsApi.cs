...
namespace kern.services.CumulocityClient.Api
{
    ...
    /// </summary>
    public interface IDevicePermissionsApiSync : IApiAccessor
    {
        ...
        /// <returns>DevicePermissionOwners</returns>
        DevicePermissionOwners GetDevicePermissionsResource(string id, int operationIndex = 0);
        ...
        /// <param name="id">Unique identifier of the managed object.</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of DevicePermissionOwners</returns>
        ApiResponse<DevicePermissionOwners> GetDevicePermissionsResourceWithHttpInfo(string id, int operationIndex = 0);
        /// <summary>
        ...
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">Unique identifier of the managed object.</param>
        /// <param name="updatedDevicePermissions"></param>
        /// <param name="accept">Advertises which content types, expressed as MIME types, the client is able to understand. (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns></returns>
        void PutDevicePermissionsResource(string id, UpdatedDevicePermissions updatedDevicePermissions, string? accept = default(string?), int operationIndex = 0);
        ...
        ApiResponse<Object> PutDevicePermissionsResourceWithHttpInfo(string id, UpdatedDevicePermissions updatedDevicePermissions, string? accept = default(string?), int operationIndex = 0);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IDevicePermissionsApiAsync : IApiAccessor
    {
        ...
        /// <returns>Task of DevicePermissionOwners</returns>
        System.Threading.Tasks.Task<DevicePermissionOwners> GetDevicePermissionsResourceAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DevicePermissionOwners)</returns>
        System.Threading.Tasks.Task<ApiResponse<DevicePermissionOwners>> GetDevicePermissionsResourceWithHttpInfoAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Updates the device permissions assignments
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task PutDevicePermissionsResourceAsync(string id, UpdatedDevicePermissions updatedDevicePermissions, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> PutDevicePermissionsResourceWithHttpInfoAsync(string id, UpdatedDevicePermissions updatedDevicePermissions, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IDevicePermissionsApi : IDevicePermissionsApiSync, IDevicePermissionsApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class DevicePermissionsApi : IDevicePermissionsApi
    {
        private kern.services.CumulocityClient.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="DevicePermissionsApi"/> class.
        /// </summary>
        /// <returns></returns>
        public DevicePermissionsApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public DevicePermissionsApi(string basePath)
        {
        ...
        /// <returns></returns>
        public DevicePermissionsApi(kern.services.CumulocityClient.Client.Configuration configuration)
        {
        ...
        public DevicePermissionsApi(kern.services.CumulocityClient.Client.ISynchronousClient client, kern.services.CumulocityClient.Client.IAsynchronousClient asyncClient, kern.services.CumulocityClient.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Returns all device permissions assignments Returns all device permissions assignments if the current user has READ permission.  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_USER_MANAGEMENT_READ &lt;b&gt;OR&lt;/b&gt; ROLE_USER_MANAGEMENT_CREATE &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">Unique identifier of the managed object.</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>DevicePermissionOwners</returns>
        public DevicePermissionOwners GetDevicePermissionsResource(string id, int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<DevicePermissionOwners> localVarResponse = GetDevicePermissionsResourceWithHttpInfo(id);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of DevicePermissionOwners</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<DevicePermissionOwners> GetDevicePermissionsResourceWithHttpInfo(string id, int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'id' when calling DevicePermissionsApi->GetDevicePermissionsResource");
            }
            ...
            localVarRequestOptions.Operation = "DevicePermissionsApi.GetDevicePermissionsResource";
            ...
            var localVarResponse = this.Client.Get<DevicePermissionOwners>("/user/devicePermissions/{id}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetDevicePermissionsResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of DevicePermissionOwners</returns>
        public async System.Threading.Tasks.Task<DevicePermissionOwners> GetDevicePermissionsResourceAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<DevicePermissionOwners> localVarResponse = await GetDevicePermissionsResourceWithHttpInfoAsync(id, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DevicePermissionOwners)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<DevicePermissionOwners>> GetDevicePermissionsResourceWithHttpInfoAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<DevicePermissionOwners>("/user/devicePermissions/{id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Updates the device permissions assignments Updates the device permissions assignments if the current user has ADMIN permission or CREATE permission and also has all device permissions.  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_USER_MANAGEMENT_ADMIN &lt;b&gt;OR&lt;/b&gt; ROLE_USER_MANAGEMENT_CREATE &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">Unique identifier of the managed object.</param>
        /// <param name="updatedDevicePermissions"></param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns></returns>
        public void PutDevicePermissionsResource(string id, UpdatedDevicePermissions updatedDevicePermissions, string? accept = default(string?), int operationIndex = 0)
        {
            PutDevicePermissionsResourceWithHttpInfo(id, updatedDevicePermissions, accept);
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<Object> PutDevicePermissionsResourceWithHttpInfo(string id, UpdatedDevicePermissions updatedDevicePermissions, string? accept = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'id' when calling DevicePermissionsApi->PutDevicePermissionsResource");
            }

            // verify the required parameter 'updatedDevicePermissions' is set
            if (updatedDevicePermissions == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'updatedDevicePermissions' when calling DevicePermissionsApi->PutDevicePermissionsResource");
            }
            ...
            localVarRequestOptions.Data = updatedDevicePermissions;

            localVarRequestOptions.Operation = "DevicePermissionsApi.PutDevicePermissionsResource";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Put<Object>("/user/devicePermissions/{id}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PutDevicePermissionsResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task PutDevicePermissionsResourceAsync(string id, UpdatedDevicePermissions updatedDevicePermissions, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await PutDevicePermissionsResourceWithHttpInfoAsync(id, updatedDevicePermissions, accept, operationIndex, cancellationToken).ConfigureAwait(false);
        }
        ...
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<Object>> PutDevicePermissionsResourceWithHttpInfoAsync(string id, UpdatedDevicePermissions updatedDevicePermissions, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PutAsync<Object>("/user/devicePermissions/{id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
