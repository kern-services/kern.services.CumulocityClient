...
namespace kern.services.CumulocityClient.Api
{
    ...
    public interface IAuditsApi : IApiAccessor
    {
        ...
        AuditRecordCollection GetAuditRecordCollectionResource (string application = default(string), int? currentPage = default(int?), DateTime? dateFrom = default(DateTime?), DateTime? dateTo = default(DateTime?), int? pageSize = default(int?), string source = default(string), string type = default(string), string user = default(string), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?));
        ...
        ApiResponse<AuditRecord> GetAuditRecordResourceWithHttpInfo (string id);
        /// <summary>
        ...
        /// <returns>AuditRecord</returns>
        AuditRecord PostAuditRecordCollectionResource (Dictionary<string, Object> requestBody, string accept = default(string));
        ...
        /// <param name="accept">Advertises which content types, expressed as MIME types, the client is able to understand. (optional)</param>
        /// <returns>ApiResponse of AuditRecord</returns>
        ApiResponse<AuditRecord> PostAuditRecordCollectionResourceWithHttpInfo (Dictionary<string, Object> requestBody, string accept = default(string));
        ...
        System.Threading.Tasks.Task<AuditRecordCollection> GetAuditRecordCollectionResourceAsync (string application = default(string), int? currentPage = default(int?), DateTime? dateFrom = default(DateTime?), DateTime? dateTo = default(DateTime?), int? pageSize = default(int?), string source = default(string), string type = default(string), string user = default(string), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<AuditRecord> GetAuditRecordResourceAsync (string id, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<AuditRecord>> GetAuditRecordResourceWithHttpInfoAsync (string id, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Create an audit record
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of AuditRecord</returns>
        System.Threading.Tasks.Task<AuditRecord> PostAuditRecordCollectionResourceAsync (Dictionary<string, Object> requestBody, string accept = default(string), CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (AuditRecord)</returns>
        System.Threading.Tasks.Task<ApiResponse<AuditRecord>> PostAuditRecordCollectionResourceWithHttpInfoAsync (Dictionary<string, Object> requestBody, string accept = default(string), CancellationToken cancellationToken = default(CancellationToken));
    ...
    public partial class AuditsApi : IAuditsApi
    {
        ...
        /// <returns></returns>
        public AuditsApi(kern.services.CumulocityClient.Client.Configuration configuration = null)
        {
        ...
        {
             ApiResponse<AuditRecordCollection> localVarResponse = GetAuditRecordCollectionResourceWithHttpInfo(application, currentPage, dateFrom, dateTo, pageSize, source, type, user, withTotalElements, withTotalPages);
        ...
        /// <param name="withTotalPages">When set to &#x60;true&#x60;, the returned result will contain in the statistics object the total number of pages. Only applicable on [range queries](https://en.wikipedia.org/wiki/Range_query_(database)). (optional, default to false)</param>
        /// <returns>ApiResponse of AuditRecordCollection</returns>
        public ApiResponse<AuditRecordCollection> GetAuditRecordCollectionResourceWithHttpInfo (string application = default(string), int? currentPage = default(int?), DateTime? dateFrom = default(DateTime?), DateTime? dateTo = default(DateTime?), int? pageSize = default(int?), string source = default(string), string type = default(string), string user = default(string), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?))
        {

            var localVarPath = "/audit/auditRecords";
            ...
            {
                Exception exception = ExceptionFactory("GetAuditRecordCollectionResource", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<AuditRecordCollection>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (AuditRecordCollection) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(AuditRecordCollection)));
        }
        ...
        {
             ApiResponse<AuditRecordCollection> localVarResponse = await GetAuditRecordCollectionResourceWithHttpInfoAsync(application, currentPage, dateFrom, dateTo, pageSize, source, type, user, withTotalElements, withTotalPages, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (AuditRecordCollection)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<AuditRecordCollection>> GetAuditRecordCollectionResourceWithHttpInfoAsync (string application = default(string), int? currentPage = default(int?), DateTime? dateFrom = default(DateTime?), DateTime? dateTo = default(DateTime?), int? pageSize = default(int?), string source = default(string), string type = default(string), string user = default(string), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <param name="id">Unique identifier of the audit record.</param>
        /// <returns>AuditRecord</returns>
        public AuditRecord GetAuditRecordResource (string id)
        {
             ApiResponse<AuditRecord> localVarResponse = GetAuditRecordResourceWithHttpInfo(id);
             return localVarResponse.Data;
        }
        ...
        /// <param name="id">Unique identifier of the audit record.</param>
        /// <returns>ApiResponse of AuditRecord</returns>
        public ApiResponse<AuditRecord> GetAuditRecordResourceWithHttpInfo (string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling AuditsApi->GetAuditRecordResource");

            var localVarPath = "/audit/auditRecords/{id}";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("GetAuditRecordResource", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<AuditRecord>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (AuditRecord) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(AuditRecord)));
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of AuditRecord</returns>
        public async System.Threading.Tasks.Task<AuditRecord> GetAuditRecordResourceAsync (string id, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<AuditRecord> localVarResponse = await GetAuditRecordResourceWithHttpInfoAsync(id, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (AuditRecord)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<AuditRecord>> GetAuditRecordResourceWithHttpInfoAsync (string id, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling AuditsApi->GetAuditRecordResource");
        ...
        /// <param name="accept">Advertises which content types, expressed as MIME types, the client is able to understand. (optional)</param>
        /// <returns>AuditRecord</returns>
        public AuditRecord PostAuditRecordCollectionResource (Dictionary<string, Object> requestBody, string accept = default(string))
        {
             ApiResponse<AuditRecord> localVarResponse = PostAuditRecordCollectionResourceWithHttpInfo(requestBody, accept);
             return localVarResponse.Data;
        }
        ...
        /// <param name="accept">Advertises which content types, expressed as MIME types, the client is able to understand. (optional)</param>
        /// <returns>ApiResponse of AuditRecord</returns>
        public ApiResponse<AuditRecord> PostAuditRecordCollectionResourceWithHttpInfo (Dictionary<string, Object> requestBody, string accept = default(string))
        {
            // verify the required parameter 'requestBody' is set
            if (requestBody == null)
                throw new ApiException(400, "Missing required parameter 'requestBody' when calling AuditsApi->PostAuditRecordCollectionResource");
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("PostAuditRecordCollectionResource", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of AuditRecord</returns>
        public async System.Threading.Tasks.Task<AuditRecord> PostAuditRecordCollectionResourceAsync (Dictionary<string, Object> requestBody, string accept = default(string), CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<AuditRecord> localVarResponse = await PostAuditRecordCollectionResourceWithHttpInfoAsync(requestBody, accept, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (AuditRecord)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<AuditRecord>> PostAuditRecordCollectionResourceWithHttpInfoAsync (Dictionary<string, Object> requestBody, string accept = default(string), CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'requestBody' is set
            if (requestBody == null)
                throw new ApiException(400, "Missing required parameter 'requestBody' when calling AuditsApi->PostAuditRecordCollectionResource");
