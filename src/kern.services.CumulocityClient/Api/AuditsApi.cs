...
namespace kern.services.CumulocityClient.Api
{
    ...
    public interface IAuditsApiSync : IApiAccessor
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>AuditRecord</returns>
        AuditRecord PostAuditRecordCollectionResource(AuditRecord auditRecord, string? accept = default(string?), int operationIndex = 0);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of AuditRecord</returns>
        ApiResponse<AuditRecord> PostAuditRecordCollectionResourceWithHttpInfo(AuditRecord auditRecord, string? accept = default(string?), int operationIndex = 0);
    ...
    public interface IAuditsApiAsync : IApiAccessor
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of AuditRecord</returns>
        System.Threading.Tasks.Task<AuditRecord> PostAuditRecordCollectionResourceAsync(AuditRecord auditRecord, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (AuditRecord)</returns>
        System.Threading.Tasks.Task<ApiResponse<AuditRecord>> PostAuditRecordCollectionResourceWithHttpInfoAsync(AuditRecord auditRecord, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class AuditsApi : IAuditsApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>AuditRecord</returns>
        public AuditRecord PostAuditRecordCollectionResource(AuditRecord auditRecord, string? accept = default(string?), int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<AuditRecord> localVarResponse = PostAuditRecordCollectionResourceWithHttpInfo(auditRecord, accept);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of AuditRecord</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<AuditRecord> PostAuditRecordCollectionResourceWithHttpInfo(AuditRecord auditRecord, string? accept = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'auditRecord' is set
            if (auditRecord == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'auditRecord' when calling AuditsApi->PostAuditRecordCollectionResource");
            }
            ...
            localVarRequestOptions.Data = auditRecord;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of AuditRecord</returns>
        public async System.Threading.Tasks.Task<AuditRecord> PostAuditRecordCollectionResourceAsync(AuditRecord auditRecord, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<AuditRecord> localVarResponse = await PostAuditRecordCollectionResourceWithHttpInfoAsync(auditRecord, accept, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (AuditRecord)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<AuditRecord>> PostAuditRecordCollectionResourceWithHttpInfoAsync(AuditRecord auditRecord, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'auditRecord' is set
            if (auditRecord == null)
            {
