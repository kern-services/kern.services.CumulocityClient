...
namespace kern.services.CumulocityClient.Api
{
    ...
    public interface IAuditsApiSync : IApiAccessor
    {
        ...
        /// <param name="application">Name of the application from which the audit was carried out. (optional)</param>
        /// <param name="currentPage">The current page of the paginated results. (optional, default to 1)</param>
        /// <param name="dateFrom">Start date or date and time of the audit record. (optional)</param>
        /// <param name="dateTo">End date or date and time of the audit record. (optional)</param>
        ...
        /// <param name="source">The platform component ID to which the audit is associated. (optional)</param>
        /// <param name="type">The type of audit record to search for. (optional)</param>
        /// <param name="user">The username to search for. (optional)</param>
        ...
        /// <returns>AuditRecordCollection</returns>
        AuditRecordCollection GetAuditRecordCollectionResource(string? application = default(string?), int? currentPage = default(int?), DateTime? dateFrom = default(DateTime?), DateTime? dateTo = default(DateTime?), int? pageSize = default(int?), string? source = default(string?), string? type = default(string?), string? user = default(string?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0);
        ...
        /// <param name="withTotalPages">When set to &#x60;true&#x60;, the returned result will contain in the statistics object the total number of pages. Only applicable on [range queries](https://en.wikipedia.org/wiki/Range_query_(database)). (optional, default to false)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of AuditRecordCollection</returns>
        ApiResponse<AuditRecordCollection> GetAuditRecordCollectionResourceWithHttpInfo(string? application = default(string?), int? currentPage = default(int?), DateTime? dateFrom = default(DateTime?), DateTime? dateTo = default(DateTime?), int? pageSize = default(int?), string? source = default(string?), string? type = default(string?), string? user = default(string?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0);
        /// <summary>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>AuditRecord</returns>
        AuditRecord GetAuditRecordResource(string id, int operationIndex = 0);
        ...
        /// <param name="id">Unique identifier of the audit record.</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of AuditRecord</returns>
        ApiResponse<AuditRecord> GetAuditRecordResourceWithHttpInfo(string id, int operationIndex = 0);
        /// <summary>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>AuditRecord</returns>
        AuditRecord PostAuditRecordCollectionResource(Dictionary<string, Object> requestBody, string? accept = default(string?), int operationIndex = 0);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of AuditRecord</returns>
        ApiResponse<AuditRecord> PostAuditRecordCollectionResourceWithHttpInfo(Dictionary<string, Object> requestBody, string? accept = default(string?), int operationIndex = 0);
    ...
    public interface IAuditsApiAsync : IApiAccessor
    {
        ...
        /// <returns>Task of AuditRecordCollection</returns>
        System.Threading.Tasks.Task<AuditRecordCollection> GetAuditRecordCollectionResourceAsync(string? application = default(string?), int? currentPage = default(int?), DateTime? dateFrom = default(DateTime?), DateTime? dateTo = default(DateTime?), int? pageSize = default(int?), string? source = default(string?), string? type = default(string?), string? user = default(string?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (AuditRecordCollection)</returns>
        System.Threading.Tasks.Task<ApiResponse<AuditRecordCollection>> GetAuditRecordCollectionResourceWithHttpInfoAsync(string? application = default(string?), int? currentPage = default(int?), DateTime? dateFrom = default(DateTime?), DateTime? dateTo = default(DateTime?), int? pageSize = default(int?), string? source = default(string?), string? type = default(string?), string? user = default(string?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Retrieve a specific audit record
        /// </summary>
        /// <remarks>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of AuditRecord</returns>
        System.Threading.Tasks.Task<AuditRecord> GetAuditRecordResourceAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (AuditRecord)</returns>
        System.Threading.Tasks.Task<ApiResponse<AuditRecord>> GetAuditRecordResourceWithHttpInfoAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Create an audit record
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of AuditRecord</returns>
        System.Threading.Tasks.Task<AuditRecord> PostAuditRecordCollectionResourceAsync(Dictionary<string, Object> requestBody, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (AuditRecord)</returns>
        System.Threading.Tasks.Task<ApiResponse<AuditRecord>> PostAuditRecordCollectionResourceWithHttpInfoAsync(Dictionary<string, Object> requestBody, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class AuditsApi : IAuditsApi
    {
        ...
        /// <returns></returns>
        public AuditsApi(kern.services.CumulocityClient.Client.Configuration configuration)
        {
        ...
        public AuditsApi(kern.services.CumulocityClient.Client.ISynchronousClient client, kern.services.CumulocityClient.Client.IAsynchronousClient asyncClient, kern.services.CumulocityClient.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>AuditRecordCollection</returns>
        public AuditRecordCollection GetAuditRecordCollectionResource(string? application = default(string?), int? currentPage = default(int?), DateTime? dateFrom = default(DateTime?), DateTime? dateTo = default(DateTime?), int? pageSize = default(int?), string? source = default(string?), string? type = default(string?), string? user = default(string?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<AuditRecordCollection> localVarResponse = GetAuditRecordCollectionResourceWithHttpInfo(application, currentPage, dateFrom, dateTo, pageSize, source, type, user, withTotalElements, withTotalPages);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of AuditRecordCollection</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<AuditRecordCollection> GetAuditRecordCollectionResourceWithHttpInfo(string? application = default(string?), int? currentPage = default(int?), DateTime? dateFrom = default(DateTime?), DateTime? dateTo = default(DateTime?), int? pageSize = default(int?), string? source = default(string?), string? type = default(string?), string? user = default(string?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0)
        {
            ...
            if (application != null)
            {
                localVarRequestOptions.QueryParameters.Add(kern.services.CumulocityClient.Client.ClientUtils.ParameterToMultiMap("", "application", application));
            }
            if (currentPage != null)
            {
            ...
            localVarRequestOptions.Operation = "AuditsApi.GetAuditRecordCollectionResource";
            ...
            var localVarResponse = this.Client.Get<AuditRecordCollection>("/audit/auditRecords", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetAuditRecordCollectionResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of AuditRecordCollection</returns>
        public async System.Threading.Tasks.Task<AuditRecordCollection> GetAuditRecordCollectionResourceAsync(string? application = default(string?), int? currentPage = default(int?), DateTime? dateFrom = default(DateTime?), DateTime? dateTo = default(DateTime?), int? pageSize = default(int?), string? source = default(string?), string? type = default(string?), string? user = default(string?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<AuditRecordCollection> localVarResponse = await GetAuditRecordCollectionResourceWithHttpInfoAsync(application, currentPage, dateFrom, dateTo, pageSize, source, type, user, withTotalElements, withTotalPages, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (AuditRecordCollection)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<AuditRecordCollection>> GetAuditRecordCollectionResourceWithHttpInfoAsync(string? application = default(string?), int? currentPage = default(int?), DateTime? dateFrom = default(DateTime?), DateTime? dateTo = default(DateTime?), int? pageSize = default(int?), string? source = default(string?), string? type = default(string?), string? user = default(string?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<AuditRecordCollection>("/audit/auditRecords", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Retrieve a specific audit record Retrieve a specific audit record by a given ID.  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_AUDIT_READ &lt;b&gt;OR&lt;/b&gt; AUDIT_READ permission on the source &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">Unique identifier of the audit record.</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>AuditRecord</returns>
        public AuditRecord GetAuditRecordResource(string id, int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<AuditRecord> localVarResponse = GetAuditRecordResourceWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of AuditRecord</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<AuditRecord> GetAuditRecordResourceWithHttpInfo(string id, int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'id' when calling AuditsApi->GetAuditRecordResource");
            }
            ...
            localVarRequestOptions.Operation = "AuditsApi.GetAuditRecordResource";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<AuditRecord>("/audit/auditRecords/{id}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetAuditRecordResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of AuditRecord</returns>
        public async System.Threading.Tasks.Task<AuditRecord> GetAuditRecordResourceAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<AuditRecord> localVarResponse = await GetAuditRecordResourceWithHttpInfoAsync(id, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (AuditRecord)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<AuditRecord>> GetAuditRecordResourceWithHttpInfoAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<AuditRecord>("/audit/auditRecords/{id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Create an audit record Create an audit record.  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_AUDIT_ADMIN &lt;b&gt;OR&lt;/b&gt; ROLE_SYSTEM &lt;b&gt;OR&lt;/b&gt; AUDIT_ADMIN permission on the resource &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="requestBody"></param>
        /// <param name="accept">Advertises which content types, expressed as MIME types, the client is able to understand. (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>AuditRecord</returns>
        public AuditRecord PostAuditRecordCollectionResource(Dictionary<string, Object> requestBody, string? accept = default(string?), int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<AuditRecord> localVarResponse = PostAuditRecordCollectionResourceWithHttpInfo(requestBody, accept);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of AuditRecord</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<AuditRecord> PostAuditRecordCollectionResourceWithHttpInfo(Dictionary<string, Object> requestBody, string? accept = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'requestBody' is set
            if (requestBody == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'requestBody' when calling AuditsApi->PostAuditRecordCollectionResource");
            }
            ...
            localVarRequestOptions.Operation = "AuditsApi.PostAuditRecordCollectionResource";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<AuditRecord>("/audit/auditRecords", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PostAuditRecordCollectionResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of AuditRecord</returns>
        public async System.Threading.Tasks.Task<AuditRecord> PostAuditRecordCollectionResourceAsync(Dictionary<string, Object> requestBody, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<AuditRecord> localVarResponse = await PostAuditRecordCollectionResourceWithHttpInfoAsync(requestBody, accept, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (AuditRecord)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<AuditRecord>> PostAuditRecordCollectionResourceWithHttpInfoAsync(Dictionary<string, Object> requestBody, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'requestBody' is set
            if (requestBody == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<AuditRecord>("/audit/auditRecords", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
