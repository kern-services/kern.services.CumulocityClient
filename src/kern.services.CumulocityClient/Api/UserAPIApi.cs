...
namespace kern.services.CumulocityClient.Api
{
    ...
    /// </summary>
    public interface IUserAPIApiSync : IApiAccessor
    {
        ...
        /// <returns>UserApiResource</returns>
        UserApiResource GetUserApiResource(int operationIndex = 0);
        ...
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of UserApiResource</returns>
        ApiResponse<UserApiResource> GetUserApiResourceWithHttpInfo(int operationIndex = 0);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IUserAPIApiAsync : IApiAccessor
    {
        ...
        /// <returns>Task of UserApiResource</returns>
        System.Threading.Tasks.Task<UserApiResource> GetUserApiResourceAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (UserApiResource)</returns>
        System.Threading.Tasks.Task<ApiResponse<UserApiResource>> GetUserApiResourceWithHttpInfoAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IUserAPIApi : IUserAPIApiSync, IUserAPIApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class UserAPIApi : IUserAPIApi
    {
        ...
        /// </summary>
        /// <returns></returns>
        public UserAPIApi() : this((string)null)
        {
        }
        ...
        /// <returns></returns>
        public UserAPIApi(kern.services.CumulocityClient.Client.Configuration configuration)
        {
        ...
        public UserAPIApi(kern.services.CumulocityClient.Client.ISynchronousClient client, kern.services.CumulocityClient.Client.IAsynchronousClient asyncClient, kern.services.CumulocityClient.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Retrieve URIs to collections of users, groups and roles Retrieve URIs and URI templates to collections of users, groups, and roles, so that they can be queried.  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_USER_MANAGEMENT_READ &lt;b&gt;OR&lt;/b&gt; ROLE_USER_MANAGEMENT_CREATE &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>UserApiResource</returns>
        public UserApiResource GetUserApiResource(int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<UserApiResource> localVarResponse = GetUserApiResourceWithHttpInfo();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of UserApiResource</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<UserApiResource> GetUserApiResourceWithHttpInfo(int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "UserAPIApi.GetUserApiResource";
            ...
            var localVarResponse = this.Client.Get<UserApiResource>("/user", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetUserApiResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of UserApiResource</returns>
        public async System.Threading.Tasks.Task<UserApiResource> GetUserApiResourceAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<UserApiResource> localVarResponse = await GetUserApiResourceWithHttpInfoAsync(operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (UserApiResource)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<UserApiResource>> GetUserApiResourceWithHttpInfoAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<UserApiResource>("/user", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
