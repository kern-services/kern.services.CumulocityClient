...
namespace kern.services.CumulocityClient.Api
{
    ...
    /// </summary>
    public interface IUserAPIApi : IApiAccessor
    {
        ...
        ApiResponse<UserApiResource> GetUserApiResourceWithHttpInfo ();
        ...
        System.Threading.Tasks.Task<UserApiResource> GetUserApiResourceAsync (CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<UserApiResource>> GetUserApiResourceWithHttpInfoAsync (CancellationToken cancellationToken = default(CancellationToken));
    ...
    public partial class UserAPIApi : IUserAPIApi
    {
        ...
        /// <returns></returns>
        public UserAPIApi(kern.services.CumulocityClient.Client.Configuration configuration = null)
        {
        ...
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>UserApiResource</returns>
        public UserApiResource GetUserApiResource ()
        {
             ApiResponse<UserApiResource> localVarResponse = GetUserApiResourceWithHttpInfo();
        ...
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of UserApiResource</returns>
        public ApiResponse<UserApiResource> GetUserApiResourceWithHttpInfo ()
        {
            ...
            {
                Exception exception = ExceptionFactory("GetUserApiResource", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<UserApiResource>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (UserApiResource) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(UserApiResource)));
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of UserApiResource</returns>
        public async System.Threading.Tasks.Task<UserApiResource> GetUserApiResourceAsync (CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<UserApiResource> localVarResponse = await GetUserApiResourceWithHttpInfoAsync(cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (UserApiResource)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<UserApiResource>> GetUserApiResourceWithHttpInfoAsync (CancellationToken cancellationToken = default(CancellationToken))
        {
