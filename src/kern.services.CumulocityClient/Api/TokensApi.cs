...
namespace kern.services.CumulocityClient.Api
{
    ...
    public interface ITokensApiSync : IApiAccessor
    {
        ...
        /// <param name="notificationTokenClaims"></param>
        ...
        /// <returns>NotificationToken</returns>
        NotificationToken PostNotificationTokenResource(NotificationTokenClaims notificationTokenClaims, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0);
        ...
        /// <param name="xCumulocityProcessingMode">Used to explicitly control the processing mode of the request. See [Processing mode](#processing-mode) for more details. (optional, default to PERSISTENT)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of NotificationToken</returns>
        ApiResponse<NotificationToken> PostNotificationTokenResourceWithHttpInfo(NotificationTokenClaims notificationTokenClaims, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0);
        /// <summary>
        ...
        /// <param name="xCumulocityProcessingMode">Used to explicitly control the processing mode of the request. See [Processing mode](#processing-mode) for more details. (optional, default to PERSISTENT)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>NotificationSubscriptionResult</returns>
        NotificationSubscriptionResult PostNotificationTokenUnsubscribeResource(string token, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0);
        ...
        /// <param name="xCumulocityProcessingMode">Used to explicitly control the processing mode of the request. See [Processing mode](#processing-mode) for more details. (optional, default to PERSISTENT)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of NotificationSubscriptionResult</returns>
        ApiResponse<NotificationSubscriptionResult> PostNotificationTokenUnsubscribeResourceWithHttpInfo(string token, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0);
    ...
    public interface ITokensApiAsync : IApiAccessor
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (NotificationToken)</returns>
        System.Threading.Tasks.Task<ApiResponse<NotificationToken>> PostNotificationTokenResourceWithHttpInfoAsync(NotificationTokenClaims notificationTokenClaims, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Unsubscribe a subscriber
        /// </summary>
        /// <remarks>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of NotificationSubscriptionResult</returns>
        System.Threading.Tasks.Task<NotificationSubscriptionResult> PostNotificationTokenUnsubscribeResourceAsync(string token, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (NotificationSubscriptionResult)</returns>
        System.Threading.Tasks.Task<ApiResponse<NotificationSubscriptionResult>> PostNotificationTokenUnsubscribeResourceWithHttpInfoAsync(string token, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class TokensApi : ITokensApi
    {
        ...
        /// <returns></returns>
        public TokensApi(kern.services.CumulocityClient.Client.Configuration configuration)
        {
        ...
        public TokensApi(kern.services.CumulocityClient.Client.ISynchronousClient client, kern.services.CumulocityClient.Client.IAsynchronousClient asyncClient, kern.services.CumulocityClient.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Create a notification token Create a new JWT (JSON web token) access token which can be used to establish a successful WebSocket connection to read a sequence of notifications.  In general, each request to obtain an access token consists of:  *  The subscriber name which the client wishes to be identified with. *  The subscription name. This value must be associated with a subscription that&#39;s already been created and in essence, the obtained token will give the ability to read notifications for the subscription that is specified here. *  The token expiration duration.  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_NOTIFICATION_2_ADMIN &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="notificationTokenClaims"></param>
        /// <param name="accept">Advertises which content types, expressed as MIME types, the client is able to understand. (optional)</param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>NotificationToken</returns>
        public NotificationToken PostNotificationTokenResource(NotificationTokenClaims notificationTokenClaims, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<NotificationToken> localVarResponse = PostNotificationTokenResourceWithHttpInfo(notificationTokenClaims, accept, xCumulocityProcessingMode);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of NotificationToken</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<NotificationToken> PostNotificationTokenResourceWithHttpInfo(NotificationTokenClaims notificationTokenClaims, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'notificationTokenClaims' is set
            if (notificationTokenClaims == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'notificationTokenClaims' when calling TokensApi->PostNotificationTokenResource");
            }
            ...
            localVarRequestOptions.Data = notificationTokenClaims;

            localVarRequestOptions.Operation = "TokensApi.PostNotificationTokenResource";
            ...
            var localVarResponse = this.Client.Post<NotificationToken>("/notification2/token", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PostNotificationTokenResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of NotificationToken</returns>
        public async System.Threading.Tasks.Task<NotificationToken> PostNotificationTokenResourceAsync(NotificationTokenClaims notificationTokenClaims, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<NotificationToken> localVarResponse = await PostNotificationTokenResourceWithHttpInfoAsync(notificationTokenClaims, accept, xCumulocityProcessingMode, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (NotificationToken)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<NotificationToken>> PostNotificationTokenResourceWithHttpInfoAsync(NotificationTokenClaims notificationTokenClaims, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'notificationTokenClaims' is set
            if (notificationTokenClaims == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<NotificationToken>("/notification2/token", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>NotificationSubscriptionResult</returns>
        public NotificationSubscriptionResult PostNotificationTokenUnsubscribeResource(string token, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<NotificationSubscriptionResult> localVarResponse = PostNotificationTokenUnsubscribeResourceWithHttpInfo(token, accept, xCumulocityProcessingMode);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of NotificationSubscriptionResult</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<NotificationSubscriptionResult> PostNotificationTokenUnsubscribeResourceWithHttpInfo(string token, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'token' is set
            if (token == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'token' when calling TokensApi->PostNotificationTokenUnsubscribeResource");
            }
            ...
            localVarRequestOptions.QueryParameters.Add(kern.services.CumulocityClient.Client.ClientUtils.ParameterToMultiMap("", "token", token));
            if (accept != null)
            {
                localVarRequestOptions.HeaderParameters.Add("Accept", kern.services.CumulocityClient.Client.ClientUtils.ParameterToString(accept)); // header parameter
            }
            ...
            localVarRequestOptions.Operation = "TokensApi.PostNotificationTokenUnsubscribeResource";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<NotificationSubscriptionResult>("/notification2/unsubscribe", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PostNotificationTokenUnsubscribeResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of NotificationSubscriptionResult</returns>
        public async System.Threading.Tasks.Task<NotificationSubscriptionResult> PostNotificationTokenUnsubscribeResourceAsync(string token, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<NotificationSubscriptionResult> localVarResponse = await PostNotificationTokenUnsubscribeResourceWithHttpInfoAsync(token, accept, xCumulocityProcessingMode, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (NotificationSubscriptionResult)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<NotificationSubscriptionResult>> PostNotificationTokenUnsubscribeResourceWithHttpInfoAsync(string token, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'token' is set
            if (token == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<NotificationSubscriptionResult>("/notification2/unsubscribe", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
