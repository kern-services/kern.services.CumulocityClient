...
namespace kern.services.CumulocityClient.Api
{
    ...
    public interface ISubscriptionsApiSync : IApiAccessor
    {
        ...
        /// <param name="context">The context to which the subscription is associated. &gt; **&amp;#9432; Info:** If the value is &#x60;mo&#x60;, then &#x60;source&#x60; must also be provided in the query.  (optional, default to mo)</param>
        /// <param name="source">The managed object ID to which the subscription is associated. (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns></returns>
        void DeleteNotificationSubscriptionBySourceResource(string? xCumulocityProcessingMode = default(string?), string? context = default(string?), string? source = default(string?), int operationIndex = 0);
        ...
        ApiResponse<Object> DeleteNotificationSubscriptionBySourceResourceWithHttpInfo(string? xCumulocityProcessingMode = default(string?), string? context = default(string?), string? source = default(string?), int operationIndex = 0);
        /// <summary>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns></returns>
        void DeleteNotificationSubscriptionResource(string id, string? xCumulocityProcessingMode = default(string?), int operationIndex = 0);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        ApiResponse<Object> DeleteNotificationSubscriptionResourceWithHttpInfo(string id, string? xCumulocityProcessingMode = default(string?), int operationIndex = 0);
        /// <summary>
        ...
        /// </remarks>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="context">The context to which the subscription is associated. (optional)</param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>NotificationSubscriptionCollection</returns>
        NotificationSubscriptionCollection GetNotificationSubscriptionCollectionResource(string? context = default(string?), int? currentPage = default(int?), int? pageSize = default(int?), string? source = default(string?), bool? withTotalPages = default(bool?), int operationIndex = 0);
        ...
        /// <param name="withTotalPages">When set to &#x60;true&#x60;, the returned result will contain in the statistics object the total number of pages. Only applicable on [range queries](https://en.wikipedia.org/wiki/Range_query_(database)). (optional, default to false)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of NotificationSubscriptionCollection</returns>
        ApiResponse<NotificationSubscriptionCollection> GetNotificationSubscriptionCollectionResourceWithHttpInfo(string? context = default(string?), int? currentPage = default(int?), int? pageSize = default(int?), string? source = default(string?), bool? withTotalPages = default(bool?), int operationIndex = 0);
        /// <summary>
        ...
        NotificationSubscription GetNotificationSubscriptionResource(string id, int operationIndex = 0);
        ...
        ApiResponse<NotificationSubscription> GetNotificationSubscriptionResourceWithHttpInfo(string id, int operationIndex = 0);
        /// <summary>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>NotificationSubscription</returns>
        NotificationSubscription PostNotificationSubscriptionResource(NotificationSubscription notificationSubscription, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of NotificationSubscription</returns>
        ApiResponse<NotificationSubscription> PostNotificationSubscriptionResourceWithHttpInfo(NotificationSubscription notificationSubscription, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0);
    ...
    public interface ISubscriptionsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task DeleteNotificationSubscriptionBySourceResourceAsync(string? xCumulocityProcessingMode = default(string?), string? context = default(string?), string? source = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> DeleteNotificationSubscriptionBySourceResourceWithHttpInfoAsync(string? xCumulocityProcessingMode = default(string?), string? context = default(string?), string? source = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Remove a specific subscription
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task DeleteNotificationSubscriptionResourceAsync(string id, string? xCumulocityProcessingMode = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> DeleteNotificationSubscriptionResourceWithHttpInfoAsync(string id, string? xCumulocityProcessingMode = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Retrieve all subscriptions
        /// </summary>
        /// <remarks>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of NotificationSubscriptionCollection</returns>
        System.Threading.Tasks.Task<NotificationSubscriptionCollection> GetNotificationSubscriptionCollectionResourceAsync(string? context = default(string?), int? currentPage = default(int?), int? pageSize = default(int?), string? source = default(string?), bool? withTotalPages = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (NotificationSubscriptionCollection)</returns>
        System.Threading.Tasks.Task<ApiResponse<NotificationSubscriptionCollection>> GetNotificationSubscriptionCollectionResourceWithHttpInfoAsync(string? context = default(string?), int? currentPage = default(int?), int? pageSize = default(int?), string? source = default(string?), bool? withTotalPages = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Retrieve a specific subscription
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<NotificationSubscription> GetNotificationSubscriptionResourceAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<NotificationSubscription>> GetNotificationSubscriptionResourceWithHttpInfoAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Create a subscription
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of NotificationSubscription</returns>
        System.Threading.Tasks.Task<NotificationSubscription> PostNotificationSubscriptionResourceAsync(NotificationSubscription notificationSubscription, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (NotificationSubscription)</returns>
        System.Threading.Tasks.Task<ApiResponse<NotificationSubscription>> PostNotificationSubscriptionResourceWithHttpInfoAsync(NotificationSubscription notificationSubscription, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class SubscriptionsApi : ISubscriptionsApi
    {
        ...
        /// <returns></returns>
        public SubscriptionsApi(kern.services.CumulocityClient.Client.Configuration configuration)
        {
        ...
        public SubscriptionsApi(kern.services.CumulocityClient.Client.ISynchronousClient client, kern.services.CumulocityClient.Client.IAsynchronousClient asyncClient, kern.services.CumulocityClient.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Remove subscriptions by source Remove subscriptions by source and context.  &gt;**&amp;#9432; Info:** The request will result in an error if there are no query parameters. The &#x60;source&#x60; parameter is optional only if the &#x60;context&#x60; parameter equals &#x60;tenant&#x60;.  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_NOTIFICATION_2_ADMIN &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="xCumulocityProcessingMode">Used to explicitly control the processing mode of the request. See [Processing mode](#processing-mode) for more details. (optional, default to PERSISTENT)</param>
        /// <param name="context">The context to which the subscription is associated. &gt; **&amp;#9432; Info:** If the value is &#x60;mo&#x60;, then &#x60;source&#x60; must also be provided in the query.  (optional, default to mo)</param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns></returns>
        public void DeleteNotificationSubscriptionBySourceResource(string? xCumulocityProcessingMode = default(string?), string? context = default(string?), string? source = default(string?), int operationIndex = 0)
        {
            DeleteNotificationSubscriptionBySourceResourceWithHttpInfo(xCumulocityProcessingMode, context, source);
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<Object> DeleteNotificationSubscriptionBySourceResourceWithHttpInfo(string? xCumulocityProcessingMode = default(string?), string? context = default(string?), string? source = default(string?), int operationIndex = 0)
        {
            ...
            if (context != null)
            {
                localVarRequestOptions.QueryParameters.Add(kern.services.CumulocityClient.Client.ClientUtils.ParameterToMultiMap("", "context", context));
            }
            if (source != null)
            {
            ...
            localVarRequestOptions.Operation = "SubscriptionsApi.DeleteNotificationSubscriptionBySourceResource";
            ...
            var localVarResponse = this.Client.Delete<Object>("/notification2/subscriptions", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("DeleteNotificationSubscriptionBySourceResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task DeleteNotificationSubscriptionBySourceResourceAsync(string? xCumulocityProcessingMode = default(string?), string? context = default(string?), string? source = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await DeleteNotificationSubscriptionBySourceResourceWithHttpInfoAsync(xCumulocityProcessingMode, context, source, operationIndex, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<Object>> DeleteNotificationSubscriptionBySourceResourceWithHttpInfoAsync(string? xCumulocityProcessingMode = default(string?), string? context = default(string?), string? source = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.DeleteAsync<Object>("/notification2/subscriptions", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Remove a specific subscription Remove a specific subscription by a given ID.  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_NOTIFICATION_2_ADMIN &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">Unique identifier of the notification subscription.</param>
        /// <param name="xCumulocityProcessingMode">Used to explicitly control the processing mode of the request. See [Processing mode](#processing-mode) for more details. (optional, default to PERSISTENT)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns></returns>
        public void DeleteNotificationSubscriptionResource(string id, string? xCumulocityProcessingMode = default(string?), int operationIndex = 0)
        {
            DeleteNotificationSubscriptionResourceWithHttpInfo(id, xCumulocityProcessingMode);
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<Object> DeleteNotificationSubscriptionResourceWithHttpInfo(string id, string? xCumulocityProcessingMode = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'id' when calling SubscriptionsApi->DeleteNotificationSubscriptionResource");
            }
            ...
            localVarRequestOptions.Operation = "SubscriptionsApi.DeleteNotificationSubscriptionResource";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Delete<Object>("/notification2/subscriptions/{id}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("DeleteNotificationSubscriptionResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task DeleteNotificationSubscriptionResourceAsync(string id, string? xCumulocityProcessingMode = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await DeleteNotificationSubscriptionResourceWithHttpInfoAsync(id, xCumulocityProcessingMode, operationIndex, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<Object>> DeleteNotificationSubscriptionResourceWithHttpInfoAsync(string id, string? xCumulocityProcessingMode = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.DeleteAsync<Object>("/notification2/subscriptions/{id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Retrieve all subscriptions Retrieve all subscriptions on your tenant, or a specific subset based on queries.  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_NOTIFICATION_2_ADMIN &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="context">The context to which the subscription is associated. (optional)</param>
        /// <param name="currentPage">The current page of the paginated results. (optional, default to 1)</param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>NotificationSubscriptionCollection</returns>
        public NotificationSubscriptionCollection GetNotificationSubscriptionCollectionResource(string? context = default(string?), int? currentPage = default(int?), int? pageSize = default(int?), string? source = default(string?), bool? withTotalPages = default(bool?), int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<NotificationSubscriptionCollection> localVarResponse = GetNotificationSubscriptionCollectionResourceWithHttpInfo(context, currentPage, pageSize, source, withTotalPages);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of NotificationSubscriptionCollection</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<NotificationSubscriptionCollection> GetNotificationSubscriptionCollectionResourceWithHttpInfo(string? context = default(string?), int? currentPage = default(int?), int? pageSize = default(int?), string? source = default(string?), bool? withTotalPages = default(bool?), int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.RequestOptions localVarRequestOptions = new kern.services.CumulocityClient.Client.RequestOptions();
            ...
            localVarRequestOptions.Operation = "SubscriptionsApi.GetNotificationSubscriptionCollectionResource";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<NotificationSubscriptionCollection>("/notification2/subscriptions", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetNotificationSubscriptionCollectionResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of NotificationSubscriptionCollection</returns>
        public async System.Threading.Tasks.Task<NotificationSubscriptionCollection> GetNotificationSubscriptionCollectionResourceAsync(string? context = default(string?), int? currentPage = default(int?), int? pageSize = default(int?), string? source = default(string?), bool? withTotalPages = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<NotificationSubscriptionCollection> localVarResponse = await GetNotificationSubscriptionCollectionResourceWithHttpInfoAsync(context, currentPage, pageSize, source, withTotalPages, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (NotificationSubscriptionCollection)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<NotificationSubscriptionCollection>> GetNotificationSubscriptionCollectionResourceWithHttpInfoAsync(string? context = default(string?), int? currentPage = default(int?), int? pageSize = default(int?), string? source = default(string?), bool? withTotalPages = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<NotificationSubscriptionCollection>("/notification2/subscriptions", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Retrieve a specific subscription Retrieve a specific subscription by a given ID.  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_NOTIFICATION_2_ADMIN &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">Unique identifier of the notification subscription.</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>NotificationSubscription</returns>
        public NotificationSubscription GetNotificationSubscriptionResource(string id, int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<NotificationSubscription> localVarResponse = GetNotificationSubscriptionResourceWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of NotificationSubscription</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<NotificationSubscription> GetNotificationSubscriptionResourceWithHttpInfo(string id, int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'id' when calling SubscriptionsApi->GetNotificationSubscriptionResource");
            }
            ...
            localVarRequestOptions.Operation = "SubscriptionsApi.GetNotificationSubscriptionResource";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<NotificationSubscription>("/notification2/subscriptions/{id}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetNotificationSubscriptionResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of NotificationSubscription</returns>
        public async System.Threading.Tasks.Task<NotificationSubscription> GetNotificationSubscriptionResourceAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<NotificationSubscription> localVarResponse = await GetNotificationSubscriptionResourceWithHttpInfoAsync(id, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (NotificationSubscription)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<NotificationSubscription>> GetNotificationSubscriptionResourceWithHttpInfoAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<NotificationSubscription>("/notification2/subscriptions/{id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Create a subscription Create a new subscription, for example, a subscription that forwards measurements and events of a specific type for a given device.  In general, each subscription may consist of:  *  The managed object to which the subscription is associated. *  The context under which the subscription is to be processed. *  The name of the subscription. *  The applicable filter criteria. *  The option to only include specific custom fragments in the forwarded data.  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_NOTIFICATION_2_ADMIN &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="notificationSubscription"></param>
        /// <param name="accept">Advertises which content types, expressed as MIME types, the client is able to understand. (optional)</param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>NotificationSubscription</returns>
        public NotificationSubscription PostNotificationSubscriptionResource(NotificationSubscription notificationSubscription, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<NotificationSubscription> localVarResponse = PostNotificationSubscriptionResourceWithHttpInfo(notificationSubscription, accept, xCumulocityProcessingMode);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of NotificationSubscription</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<NotificationSubscription> PostNotificationSubscriptionResourceWithHttpInfo(NotificationSubscription notificationSubscription, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'notificationSubscription' is set
            if (notificationSubscription == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'notificationSubscription' when calling SubscriptionsApi->PostNotificationSubscriptionResource");
            }
            ...
            localVarRequestOptions.Data = notificationSubscription;

            localVarRequestOptions.Operation = "SubscriptionsApi.PostNotificationSubscriptionResource";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<NotificationSubscription>("/notification2/subscriptions", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PostNotificationSubscriptionResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of NotificationSubscription</returns>
        public async System.Threading.Tasks.Task<NotificationSubscription> PostNotificationSubscriptionResourceAsync(NotificationSubscription notificationSubscription, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<NotificationSubscription> localVarResponse = await PostNotificationSubscriptionResourceWithHttpInfoAsync(notificationSubscription, accept, xCumulocityProcessingMode, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (NotificationSubscription)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<NotificationSubscription>> PostNotificationSubscriptionResourceWithHttpInfoAsync(NotificationSubscription notificationSubscription, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'notificationSubscription' is set
            if (notificationSubscription == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<NotificationSubscription>("/notification2/subscriptions", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
