...
namespace kern.services.CumulocityClient.Api
{
    ...
    public interface IBinariesApiSync : IApiAccessor
    {
        ...
        byte[] PostBinariesCollectionResource(BinaryInfo varObject, System.IO.Stream file, int operationIndex = 0);
        ...
        ApiResponse<byte[]> PostBinariesCollectionResourceWithHttpInfo(BinaryInfo varObject, System.IO.Stream file, int operationIndex = 0);
        /// <summary>
        /// Replace a file
        /// </summary>
        /// <remarks>
    ...
    public interface IBinariesApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<byte[]> PostBinariesCollectionResourceAsync(BinaryInfo varObject, System.IO.Stream file, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<byte[]>> PostBinariesCollectionResourceWithHttpInfoAsync(BinaryInfo varObject, System.IO.Stream file, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Replace a file
        /// </summary>
        /// <remarks>
    ...
    public partial class BinariesApi : IBinariesApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>byte[]</returns>
        public byte[] PostBinariesCollectionResource(BinaryInfo varObject, System.IO.Stream file, int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<byte[]> localVarResponse = PostBinariesCollectionResourceWithHttpInfo(varObject, file);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of byte[]</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<byte[]> PostBinariesCollectionResourceWithHttpInfo(BinaryInfo varObject, System.IO.Stream file, int operationIndex = 0)
        {
            // verify the required parameter 'varObject' is set
            if (varObject == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'varObject' when calling BinariesApi->PostBinariesCollectionResource");
            }
            ...
            localVarRequestOptions.FormParameters.Add("object", kern.services.CumulocityClient.Client.ClientUtils.Serialize(varObject)); // form parameter
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of byte[]</returns>
        public async System.Threading.Tasks.Task<byte[]> PostBinariesCollectionResourceAsync(BinaryInfo varObject, System.IO.Stream file, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<byte[]> localVarResponse = await PostBinariesCollectionResourceWithHttpInfoAsync(varObject, file, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (byte[])</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<byte[]>> PostBinariesCollectionResourceWithHttpInfoAsync(BinaryInfo varObject, System.IO.Stream file, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'varObject' is set
            if (varObject == null)
            {
            ...
            localVarRequestOptions.FormParameters.Add("object", kern.services.CumulocityClient.Client.ClientUtils.ParameterToString(varObject)); // form parameter
            localVarRequestOptions.FileParameters.Add("file", file);
