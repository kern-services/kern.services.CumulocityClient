...
namespace kern.services.CumulocityClient.Api
{
    ...
    /// </summary>
    public interface IBinariesApiSync : IApiAccessor
    {
        ...
        /// <returns></returns>
        void DeleteBinariesResource(string id, int operationIndex = 0);
        ...
        ApiResponse<Object> DeleteBinariesResourceWithHttpInfo(string id, int operationIndex = 0);
        /// <summary>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>BinaryCollection</returns>
        BinaryCollection GetBinariesCollectionResource(string? childAdditionId = default(string?), string? childAssetId = default(string?), string? childDeviceId = default(string?), int? currentPage = default(int?), List<string>? ids = default(List<string>?), string? owner = default(string?), int? pageSize = default(int?), string? text = default(string?), string? type = default(string?), bool? withTotalPages = default(bool?), int operationIndex = 0);
        ...
        /// <param name="withTotalPages">When set to &#x60;true&#x60;, the returned result will contain in the statistics object the total number of pages. Only applicable on [range queries](https://en.wikipedia.org/wiki/Range_query_(database)). (optional, default to false)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of BinaryCollection</returns>
        ApiResponse<BinaryCollection> GetBinariesCollectionResourceWithHttpInfo(string? childAdditionId = default(string?), string? childAssetId = default(string?), string? childDeviceId = default(string?), int? currentPage = default(int?), List<string>? ids = default(List<string>?), string? owner = default(string?), int? pageSize = default(int?), string? text = default(string?), string? type = default(string?), bool? withTotalPages = default(bool?), int operationIndex = 0);
        /// <summary>
        ...
        System.IO.Stream GetBinariesResource(string id, int operationIndex = 0);
        ...
        ApiResponse<System.IO.Stream> GetBinariesResourceWithHttpInfo(string id, int operationIndex = 0);
        /// <summary>
        /// Upload a file
        /// </summary>
        /// <remarks>
        ...
        byte[] PostBinariesCollectionResource(Binary _object, System.IO.Stream file, int operationIndex = 0);
        ...
        ApiResponse<byte[]> PostBinariesCollectionResourceWithHttpInfo(Binary _object, System.IO.Stream file, int operationIndex = 0);
        /// <summary>
        /// Replace a file
        /// </summary>
        /// <remarks>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>byte[]</returns>
        byte[] PutBinariesResource(string id, System.IO.Stream body, int operationIndex = 0);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of byte[]</returns>
        ApiResponse<byte[]> PutBinariesResourceWithHttpInfo(string id, System.IO.Stream body, int operationIndex = 0);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IBinariesApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task DeleteBinariesResourceAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> DeleteBinariesResourceWithHttpInfoAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Retrieve the stored files
        /// </summary>
        /// <remarks>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of BinaryCollection</returns>
        System.Threading.Tasks.Task<BinaryCollection> GetBinariesCollectionResourceAsync(string? childAdditionId = default(string?), string? childAssetId = default(string?), string? childDeviceId = default(string?), int? currentPage = default(int?), List<string>? ids = default(List<string>?), string? owner = default(string?), int? pageSize = default(int?), string? text = default(string?), string? type = default(string?), bool? withTotalPages = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (BinaryCollection)</returns>
        System.Threading.Tasks.Task<ApiResponse<BinaryCollection>> GetBinariesCollectionResourceWithHttpInfoAsync(string? childAdditionId = default(string?), string? childAssetId = default(string?), string? childDeviceId = default(string?), int? currentPage = default(int?), List<string>? ids = default(List<string>?), string? owner = default(string?), int? pageSize = default(int?), string? text = default(string?), string? type = default(string?), bool? withTotalPages = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Retrieve a stored file
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<System.IO.Stream> GetBinariesResourceAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<System.IO.Stream>> GetBinariesResourceWithHttpInfoAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Upload a file
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<byte[]> PostBinariesCollectionResourceAsync(Binary _object, System.IO.Stream file, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<byte[]>> PostBinariesCollectionResourceWithHttpInfoAsync(Binary _object, System.IO.Stream file, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Replace a file
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of byte[]</returns>
        System.Threading.Tasks.Task<byte[]> PutBinariesResourceAsync(string id, System.IO.Stream body, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (byte[])</returns>
        System.Threading.Tasks.Task<ApiResponse<byte[]>> PutBinariesResourceWithHttpInfoAsync(string id, System.IO.Stream body, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IBinariesApi : IBinariesApiSync, IBinariesApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class BinariesApi : IBinariesApi
    {
        private kern.services.CumulocityClient.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="BinariesApi"/> class.
        /// </summary>
        /// <returns></returns>
        public BinariesApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public BinariesApi(string basePath)
        {
        ...
        /// <returns></returns>
        public BinariesApi(kern.services.CumulocityClient.Client.Configuration configuration)
        {
        ...
        public BinariesApi(kern.services.CumulocityClient.Client.ISynchronousClient client, kern.services.CumulocityClient.Client.IAsynchronousClient asyncClient, kern.services.CumulocityClient.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Remove a stored file Remove a managed object and its stored file by a given ID.  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_INVENTORY_ADMIN &lt;b&gt;OR&lt;/b&gt; owner of the resource &lt;b&gt;OR&lt;/b&gt; MANAGE_OBJECT_ADMIN permission on the resource &lt;/section&gt;
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">Unique identifier of the managed object.</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns></returns>
        public void DeleteBinariesResource(string id, int operationIndex = 0)
        {
            DeleteBinariesResourceWithHttpInfo(id);
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<Object> DeleteBinariesResourceWithHttpInfo(string id, int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'id' when calling BinariesApi->DeleteBinariesResource");
            }
            ...
            localVarRequestOptions.Operation = "BinariesApi.DeleteBinariesResource";
            ...
            var localVarResponse = this.Client.Delete<Object>("/inventory/binaries/{id}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("DeleteBinariesResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task DeleteBinariesResourceAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await DeleteBinariesResourceWithHttpInfoAsync(id, operationIndex, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<Object>> DeleteBinariesResourceWithHttpInfoAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.DeleteAsync<Object>("/inventory/binaries/{id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Retrieve the stored files Retrieve the stored files as a collections of managed objects.
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="childAdditionId">Search for a specific child addition and list all the groups to which it belongs. (optional)</param>
        /// <param name="childAssetId">Search for a specific child asset and list all the groups to which it belongs. (optional)</param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>BinaryCollection</returns>
        public BinaryCollection GetBinariesCollectionResource(string? childAdditionId = default(string?), string? childAssetId = default(string?), string? childDeviceId = default(string?), int? currentPage = default(int?), List<string>? ids = default(List<string>?), string? owner = default(string?), int? pageSize = default(int?), string? text = default(string?), string? type = default(string?), bool? withTotalPages = default(bool?), int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<BinaryCollection> localVarResponse = GetBinariesCollectionResourceWithHttpInfo(childAdditionId, childAssetId, childDeviceId, currentPage, ids, owner, pageSize, text, type, withTotalPages);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of BinaryCollection</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<BinaryCollection> GetBinariesCollectionResourceWithHttpInfo(string? childAdditionId = default(string?), string? childAssetId = default(string?), string? childDeviceId = default(string?), int? currentPage = default(int?), List<string>? ids = default(List<string>?), string? owner = default(string?), int? pageSize = default(int?), string? text = default(string?), string? type = default(string?), bool? withTotalPages = default(bool?), int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.RequestOptions localVarRequestOptions = new kern.services.CumulocityClient.Client.RequestOptions();
            ...
            localVarRequestOptions.Operation = "BinariesApi.GetBinariesCollectionResource";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<BinaryCollection>("/inventory/binaries", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetBinariesCollectionResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of BinaryCollection</returns>
        public async System.Threading.Tasks.Task<BinaryCollection> GetBinariesCollectionResourceAsync(string? childAdditionId = default(string?), string? childAssetId = default(string?), string? childDeviceId = default(string?), int? currentPage = default(int?), List<string>? ids = default(List<string>?), string? owner = default(string?), int? pageSize = default(int?), string? text = default(string?), string? type = default(string?), bool? withTotalPages = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<BinaryCollection> localVarResponse = await GetBinariesCollectionResourceWithHttpInfoAsync(childAdditionId, childAssetId, childDeviceId, currentPage, ids, owner, pageSize, text, type, withTotalPages, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (BinaryCollection)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<BinaryCollection>> GetBinariesCollectionResourceWithHttpInfoAsync(string? childAdditionId = default(string?), string? childAssetId = default(string?), string? childDeviceId = default(string?), int? currentPage = default(int?), List<string>? ids = default(List<string>?), string? owner = default(string?), int? pageSize = default(int?), string? text = default(string?), string? type = default(string?), bool? withTotalPages = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<BinaryCollection>("/inventory/binaries", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Retrieve a stored file Retrieve a stored file (managed object) by a given ID.  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_INVENTORY_READ &lt;b&gt;OR&lt;/b&gt; owner of the resource &lt;b&gt;OR&lt;/b&gt; MANAGE_OBJECT_READ permission on the resource &lt;/section&gt;
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">Unique identifier of the managed object.</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>System.IO.Stream</returns>
        public System.IO.Stream GetBinariesResource(string id, int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<System.IO.Stream> localVarResponse = GetBinariesResourceWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of System.IO.Stream</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<System.IO.Stream> GetBinariesResourceWithHttpInfo(string id, int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'id' when calling BinariesApi->GetBinariesResource");
            }
            ...
            localVarRequestOptions.Operation = "BinariesApi.GetBinariesResource";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<System.IO.Stream>("/inventory/binaries/{id}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetBinariesResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of System.IO.Stream</returns>
        public async System.Threading.Tasks.Task<System.IO.Stream> GetBinariesResourceAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<System.IO.Stream> localVarResponse = await GetBinariesResourceWithHttpInfoAsync(id, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (System.IO.Stream)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<System.IO.Stream>> GetBinariesResourceWithHttpInfoAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<System.IO.Stream>("/inventory/binaries/{id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Upload a file Uploading a file (binary) requires providing the following properties:  * &#x60;object&#x60; – In JSON format, it contains information about the file. * &#x60;file&#x60; – Contains the file to be uploaded.  After the file has been uploaded, the corresponding managed object will contain the fragment &#x60;c8y_IsBinary&#x60;.  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_INVENTORY_ADMIN &lt;b&gt;OR&lt;/b&gt; ROLE_INVENTORY_CREATE &lt;/section&gt;
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="_object"></param>
        /// <param name="file">Path of the file to be uploaded.</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>byte[]</returns>
        public byte[] PostBinariesCollectionResource(Binary _object, System.IO.Stream file, int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<byte[]> localVarResponse = PostBinariesCollectionResourceWithHttpInfo(_object, file);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of byte[]</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<byte[]> PostBinariesCollectionResourceWithHttpInfo(Binary _object, System.IO.Stream file, int operationIndex = 0)
        {
            // verify the required parameter '_object' is set
            if (_object == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter '_object' when calling BinariesApi->PostBinariesCollectionResource");
            }

            // verify the required parameter 'file' is set
            if (file == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'file' when calling BinariesApi->PostBinariesCollectionResource");
            }
            ...
            localVarRequestOptions.FormParameters.Add("object", kern.services.CumulocityClient.Client.ClientUtils.Serialize(_object)); // form parameter
            localVarRequestOptions.FileParameters.Add("file", file);

            localVarRequestOptions.Operation = "BinariesApi.PostBinariesCollectionResource";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<byte[]>("/inventory/binaries", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PostBinariesCollectionResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of byte[]</returns>
        public async System.Threading.Tasks.Task<byte[]> PostBinariesCollectionResourceAsync(Binary _object, System.IO.Stream file, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<byte[]> localVarResponse = await PostBinariesCollectionResourceWithHttpInfoAsync(_object, file, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (byte[])</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<byte[]>> PostBinariesCollectionResourceWithHttpInfoAsync(Binary _object, System.IO.Stream file, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter '_object' is set
            if (_object == null)
            {
            ...
            localVarRequestOptions.FormParameters.Add("object", kern.services.CumulocityClient.Client.ClientUtils.ParameterToString(_object)); // form parameter
            localVarRequestOptions.FileParameters.Add("file", file);
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<byte[]>("/inventory/binaries", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Replace a file Upload and replace the attached file (binary) of a specific managed object by a given ID.&lt;br&gt;  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_INVENTORY_ADMIN &lt;b&gt;OR&lt;/b&gt; owner of the resource &lt;b&gt;OR&lt;/b&gt; MANAGE_OBJECT_ADMIN permission on the resource &lt;/section&gt;
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">Unique identifier of the managed object.</param>
        /// <param name="body"></param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>byte[]</returns>
        public byte[] PutBinariesResource(string id, System.IO.Stream body, int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<byte[]> localVarResponse = PutBinariesResourceWithHttpInfo(id, body);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of byte[]</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<byte[]> PutBinariesResourceWithHttpInfo(string id, System.IO.Stream body, int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'id' when calling BinariesApi->PutBinariesResource");
            }

            // verify the required parameter 'body' is set
            if (body == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'body' when calling BinariesApi->PutBinariesResource");
            }
            ...
            localVarRequestOptions.Operation = "BinariesApi.PutBinariesResource";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Put<byte[]>("/inventory/binaries/{id}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PutBinariesResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of byte[]</returns>
        public async System.Threading.Tasks.Task<byte[]> PutBinariesResourceAsync(string id, System.IO.Stream body, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<byte[]> localVarResponse = await PutBinariesResourceWithHttpInfoAsync(id, body, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (byte[])</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<byte[]>> PutBinariesResourceWithHttpInfoAsync(string id, System.IO.Stream body, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PutAsync<byte[]>("/inventory/binaries/{id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
