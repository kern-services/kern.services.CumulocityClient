...
namespace kern.services.CumulocityClient.Api
{
    ...
    public interface IBinariesApiSync : IApiAccessor
    {
        ...
        byte[] PostBinariesCollectionResource(BinaryInfo _object, System.IO.Stream file, int operationIndex = 0);
        ...
        ApiResponse<byte[]> PostBinariesCollectionResourceWithHttpInfo(BinaryInfo _object, System.IO.Stream file, int operationIndex = 0);
        /// <summary>
        /// Replace a file
        /// </summary>
        /// <remarks>
    ...
    public interface IBinariesApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<byte[]> PostBinariesCollectionResourceAsync(BinaryInfo _object, System.IO.Stream file, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<byte[]>> PostBinariesCollectionResourceWithHttpInfoAsync(BinaryInfo _object, System.IO.Stream file, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Replace a file
        /// </summary>
        /// <remarks>
    ...
    public partial class BinariesApi : IBinariesApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>byte[]</returns>
        public byte[] PostBinariesCollectionResource(BinaryInfo _object, System.IO.Stream file, int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of byte[]</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<byte[]> PostBinariesCollectionResourceWithHttpInfo(BinaryInfo _object, System.IO.Stream file, int operationIndex = 0)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of byte[]</returns>
        public async System.Threading.Tasks.Task<byte[]> PostBinariesCollectionResourceAsync(BinaryInfo _object, System.IO.Stream file, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (byte[])</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<byte[]>> PostBinariesCollectionResourceWithHttpInfoAsync(BinaryInfo _object, System.IO.Stream file, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter '_object' is set
            if (_object == null)
            {
