...
namespace kern.services.CumulocityClient.Api
{
    ...
    /// </summary>
    public interface IMeasurementAPIApiSync : IApiAccessor
    {
        ...
        /// <returns>MeasurementApiResource</returns>
        MeasurementApiResource GetMeasurementApiResource(int operationIndex = 0);
        ...
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of MeasurementApiResource</returns>
        ApiResponse<MeasurementApiResource> GetMeasurementApiResourceWithHttpInfo(int operationIndex = 0);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IMeasurementAPIApiAsync : IApiAccessor
    {
        ...
        /// <returns>Task of MeasurementApiResource</returns>
        System.Threading.Tasks.Task<MeasurementApiResource> GetMeasurementApiResourceAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (MeasurementApiResource)</returns>
        System.Threading.Tasks.Task<ApiResponse<MeasurementApiResource>> GetMeasurementApiResourceWithHttpInfoAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IMeasurementAPIApi : IMeasurementAPIApiSync, IMeasurementAPIApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class MeasurementAPIApi : IMeasurementAPIApi
    {
        private kern.services.CumulocityClient.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="MeasurementAPIApi"/> class.
        /// </summary>
        /// <returns></returns>
        public MeasurementAPIApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public MeasurementAPIApi(string basePath)
        {
        ...
        /// <returns></returns>
        public MeasurementAPIApi(kern.services.CumulocityClient.Client.Configuration configuration)
        {
        ...
        public MeasurementAPIApi(kern.services.CumulocityClient.Client.ISynchronousClient client, kern.services.CumulocityClient.Client.IAsynchronousClient asyncClient, kern.services.CumulocityClient.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Retrieve URIs to collections of measurements Retrieve URIs and URI templates to collections of measurements.  &gt; **&amp;#9432; Info:** The response sample on the right side contains a subset of all URIs returned by the endpoint method. For all available query parameters see [Retrieve all measurements](#operation/getMeasurementCollectionResource). 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>MeasurementApiResource</returns>
        public MeasurementApiResource GetMeasurementApiResource(int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<MeasurementApiResource> localVarResponse = GetMeasurementApiResourceWithHttpInfo();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of MeasurementApiResource</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<MeasurementApiResource> GetMeasurementApiResourceWithHttpInfo(int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "MeasurementAPIApi.GetMeasurementApiResource";
            ...
            var localVarResponse = this.Client.Get<MeasurementApiResource>("/measurement", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetMeasurementApiResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of MeasurementApiResource</returns>
        public async System.Threading.Tasks.Task<MeasurementApiResource> GetMeasurementApiResourceAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<MeasurementApiResource> localVarResponse = await GetMeasurementApiResourceWithHttpInfoAsync(operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (MeasurementApiResource)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<MeasurementApiResource>> GetMeasurementApiResourceWithHttpInfoAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<MeasurementApiResource>("/measurement", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
