...
namespace kern.services.CumulocityClient.Api
{
    ...
    /// </summary>
    public interface IMeasurementAPIApi : IApiAccessor
    {
        ...
        ApiResponse<MeasurementApiResource> GetMeasurementApiResourceWithHttpInfo ();
        ...
        System.Threading.Tasks.Task<MeasurementApiResource> GetMeasurementApiResourceAsync (CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<MeasurementApiResource>> GetMeasurementApiResourceWithHttpInfoAsync (CancellationToken cancellationToken = default(CancellationToken));
    ...
    public partial class MeasurementAPIApi : IMeasurementAPIApi
    {
        ...
        /// <returns></returns>
        public MeasurementAPIApi(kern.services.CumulocityClient.Client.Configuration configuration = null)
        {
        ...
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>MeasurementApiResource</returns>
        public MeasurementApiResource GetMeasurementApiResource ()
        {
             ApiResponse<MeasurementApiResource> localVarResponse = GetMeasurementApiResourceWithHttpInfo();
        ...
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of MeasurementApiResource</returns>
        public ApiResponse<MeasurementApiResource> GetMeasurementApiResourceWithHttpInfo ()
        {

            var localVarPath = "/measurement";
            ...
            {
                Exception exception = ExceptionFactory("GetMeasurementApiResource", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<MeasurementApiResource>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (MeasurementApiResource) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(MeasurementApiResource)));
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of MeasurementApiResource</returns>
        public async System.Threading.Tasks.Task<MeasurementApiResource> GetMeasurementApiResourceAsync (CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<MeasurementApiResource> localVarResponse = await GetMeasurementApiResourceWithHttpInfoAsync(cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (MeasurementApiResource)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<MeasurementApiResource>> GetMeasurementApiResourceWithHttpInfoAsync (CancellationToken cancellationToken = default(CancellationToken))
        {
