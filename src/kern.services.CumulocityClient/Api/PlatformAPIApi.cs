...
namespace kern.services.CumulocityClient.Api
{
    ...
    /// </summary>
    public interface IPlatformAPIApi : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<PlatformApiResource> GetPlatformApiResourceAsync (CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<PlatformApiResource>> GetPlatformApiResourceWithHttpInfoAsync (CancellationToken cancellationToken = default(CancellationToken));
    ...
    public partial class PlatformAPIApi : IPlatformAPIApi
    {
        ...
        /// <returns></returns>
        public PlatformAPIApi(kern.services.CumulocityClient.Client.Configuration configuration = null)
        {
        ...
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>PlatformApiResource</returns>
        public PlatformApiResource GetPlatformApiResource ()
        {
             ApiResponse<PlatformApiResource> localVarResponse = GetPlatformApiResourceWithHttpInfo();
        ...
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of PlatformApiResource</returns>
        public ApiResponse<PlatformApiResource> GetPlatformApiResourceWithHttpInfo ()
        {

            var localVarPath = "/platform";
            ...
            {
                Exception exception = ExceptionFactory("GetPlatformApiResource", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<PlatformApiResource>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (PlatformApiResource) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(PlatformApiResource)));
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of PlatformApiResource</returns>
        public async System.Threading.Tasks.Task<PlatformApiResource> GetPlatformApiResourceAsync (CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<PlatformApiResource> localVarResponse = await GetPlatformApiResourceWithHttpInfoAsync(cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (PlatformApiResource)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<PlatformApiResource>> GetPlatformApiResourceWithHttpInfoAsync (CancellationToken cancellationToken = default(CancellationToken))
        {
