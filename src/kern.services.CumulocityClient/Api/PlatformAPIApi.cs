...
namespace kern.services.CumulocityClient.Api
{
    ...
    /// </summary>
    public interface IPlatformAPIApiSync : IApiAccessor
    {
        ...
        /// <returns>PlatformApiResource</returns>
        PlatformApiResource GetPlatformApiResource(int operationIndex = 0);
        ...
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PlatformApiResource</returns>
        ApiResponse<PlatformApiResource> GetPlatformApiResourceWithHttpInfo(int operationIndex = 0);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IPlatformAPIApiAsync : IApiAccessor
    {
        ...
        /// <returns>Task of PlatformApiResource</returns>
        System.Threading.Tasks.Task<PlatformApiResource> GetPlatformApiResourceAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (PlatformApiResource)</returns>
        System.Threading.Tasks.Task<ApiResponse<PlatformApiResource>> GetPlatformApiResourceWithHttpInfoAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IPlatformAPIApi : IPlatformAPIApiSync, IPlatformAPIApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class PlatformAPIApi : IPlatformAPIApi
    {
        private kern.services.CumulocityClient.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="PlatformAPIApi"/> class.
        /// </summary>
        /// <returns></returns>
        public PlatformAPIApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public PlatformAPIApi(string basePath)
        {
        ...
        /// <returns></returns>
        public PlatformAPIApi(kern.services.CumulocityClient.Client.Configuration configuration)
        {
        ...
        public PlatformAPIApi(kern.services.CumulocityClient.Client.ISynchronousClient client, kern.services.CumulocityClient.Client.IAsynchronousClient asyncClient, kern.services.CumulocityClient.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Retrieve URIs to collection platform objects Retrieve URIs and URI templates to collections of platform objects.
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>PlatformApiResource</returns>
        public PlatformApiResource GetPlatformApiResource(int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<PlatformApiResource> localVarResponse = GetPlatformApiResourceWithHttpInfo();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PlatformApiResource</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<PlatformApiResource> GetPlatformApiResourceWithHttpInfo(int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "PlatformAPIApi.GetPlatformApiResource";
            ...
            var localVarResponse = this.Client.Get<PlatformApiResource>("/platform", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetPlatformApiResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of PlatformApiResource</returns>
        public async System.Threading.Tasks.Task<PlatformApiResource> GetPlatformApiResourceAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<PlatformApiResource> localVarResponse = await GetPlatformApiResourceWithHttpInfoAsync(operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (PlatformApiResource)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<PlatformApiResource>> GetPlatformApiResourceWithHttpInfoAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<PlatformApiResource>("/platform", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
