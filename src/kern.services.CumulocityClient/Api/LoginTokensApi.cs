...
namespace kern.services.CumulocityClient.Api
{
    ...
    /// </summary>
    public interface ILoginTokensApiSync : IApiAccessor
    {
        ...
        /// <param name="code">Used in case of SSO login. A code received from the external authentication server is exchanged to an internal access token. (optional)</param>
        /// <param name="grantType">Dependent on the authentication type. PASSWORD is used for OAI-Secure. (optional)</param>
        /// <param name="password">Used in cases of basic or OAI-Secure authentication. (optional)</param>
        /// <param name="tfaCode">Current TFA code, sent by the user, if a TFA code is required to log in. (optional)</param>
        /// <param name="username">Used in cases of basic or OAI-Secure authentication. (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>AccessToken</returns>
        AccessToken PostLoginFormBody(string? accept = default(string?), string? code = default(string?), string? grantType = default(string?), string? password = default(string?), string? tfaCode = default(string?), string? username = default(string?), int operationIndex = 0);
        ...
        ApiResponse<AccessToken> PostLoginFormBodyWithHttpInfo(string? accept = default(string?), string? code = default(string?), string? grantType = default(string?), string? password = default(string?), string? tfaCode = default(string?), string? username = default(string?), int operationIndex = 0);
        /// <summary>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns></returns>
        void PostLoginFormCookie(string? accept = default(string?), string? code = default(string?), string? grantType = default(string?), string? password = default(string?), string? tfaCode = default(string?), string? username = default(string?), int operationIndex = 0);
        ...
        ApiResponse<Object> PostLoginFormCookieWithHttpInfo(string? accept = default(string?), string? code = default(string?), string? grantType = default(string?), string? password = default(string?), string? tfaCode = default(string?), string? username = default(string?), int operationIndex = 0);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ILoginTokensApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<AccessToken> PostLoginFormBodyAsync(string? accept = default(string?), string? code = default(string?), string? grantType = default(string?), string? password = default(string?), string? tfaCode = default(string?), string? username = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<AccessToken>> PostLoginFormBodyWithHttpInfoAsync(string? accept = default(string?), string? code = default(string?), string? grantType = default(string?), string? password = default(string?), string? tfaCode = default(string?), string? username = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Obtain access tokens in cookies
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task PostLoginFormCookieAsync(string? accept = default(string?), string? code = default(string?), string? grantType = default(string?), string? password = default(string?), string? tfaCode = default(string?), string? username = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> PostLoginFormCookieWithHttpInfoAsync(string? accept = default(string?), string? code = default(string?), string? grantType = default(string?), string? password = default(string?), string? tfaCode = default(string?), string? username = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ILoginTokensApi : ILoginTokensApiSync, ILoginTokensApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class LoginTokensApi : ILoginTokensApi
    {
        private kern.services.CumulocityClient.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="LoginTokensApi"/> class.
        /// </summary>
        /// <returns></returns>
        public LoginTokensApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public LoginTokensApi(string basePath)
        {
        ...
        /// <returns></returns>
        public LoginTokensApi(kern.services.CumulocityClient.Client.Configuration configuration)
        {
        ...
        public LoginTokensApi(kern.services.CumulocityClient.Client.ISynchronousClient client, kern.services.CumulocityClient.Client.IAsynchronousClient asyncClient, kern.services.CumulocityClient.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Obtain an access token Obtain an OAI-Secure access token.
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="accept">Advertises which content types, expressed as MIME types, the client is able to understand. (optional)</param>
        /// <param name="code">Used in case of SSO login. A code received from the external authentication server is exchanged to an internal access token. (optional)</param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>AccessToken</returns>
        public AccessToken PostLoginFormBody(string? accept = default(string?), string? code = default(string?), string? grantType = default(string?), string? password = default(string?), string? tfaCode = default(string?), string? username = default(string?), int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<AccessToken> localVarResponse = PostLoginFormBodyWithHttpInfo(accept, code, grantType, password, tfaCode, username);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of AccessToken</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<AccessToken> PostLoginFormBodyWithHttpInfo(string? accept = default(string?), string? code = default(string?), string? grantType = default(string?), string? password = default(string?), string? tfaCode = default(string?), string? username = default(string?), int operationIndex = 0)
        {
            ...
            if (code != null)
            {
                localVarRequestOptions.FormParameters.Add("code", kern.services.CumulocityClient.Client.ClientUtils.ParameterToString(code)); // form parameter
            }
            if (grantType != null)
            {
                localVarRequestOptions.FormParameters.Add("grant_type", kern.services.CumulocityClient.Client.ClientUtils.ParameterToString(grantType)); // form parameter
            }
            if (password != null)
            {
                localVarRequestOptions.FormParameters.Add("password", kern.services.CumulocityClient.Client.ClientUtils.ParameterToString(password)); // form parameter
            }
            if (tfaCode != null)
            {
                localVarRequestOptions.FormParameters.Add("tfa_code", kern.services.CumulocityClient.Client.ClientUtils.ParameterToString(tfaCode)); // form parameter
            }
            if (username != null)
            {
                localVarRequestOptions.FormParameters.Add("username", kern.services.CumulocityClient.Client.ClientUtils.ParameterToString(username)); // form parameter
            }

            localVarRequestOptions.Operation = "LoginTokensApi.PostLoginFormBody";
            ...
            var localVarResponse = this.Client.Post<AccessToken>("/tenant/oauth/token", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PostLoginFormBody", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of AccessToken</returns>
        public async System.Threading.Tasks.Task<AccessToken> PostLoginFormBodyAsync(string? accept = default(string?), string? code = default(string?), string? grantType = default(string?), string? password = default(string?), string? tfaCode = default(string?), string? username = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<AccessToken> localVarResponse = await PostLoginFormBodyWithHttpInfoAsync(accept, code, grantType, password, tfaCode, username, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (AccessToken)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<AccessToken>> PostLoginFormBodyWithHttpInfoAsync(string? accept = default(string?), string? code = default(string?), string? grantType = default(string?), string? password = default(string?), string? tfaCode = default(string?), string? username = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<AccessToken>("/tenant/oauth/token", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Obtain access tokens in cookies Obtain an OAI-Secure and XSRF tokens in cookies. 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="accept">Advertises which content types, expressed as MIME types, the client is able to understand. (optional)</param>
        /// <param name="code">Used in case of SSO login. A code received from the external authentication server is exchanged to an internal access token. (optional)</param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns></returns>
        public void PostLoginFormCookie(string? accept = default(string?), string? code = default(string?), string? grantType = default(string?), string? password = default(string?), string? tfaCode = default(string?), string? username = default(string?), int operationIndex = 0)
        {
            PostLoginFormCookieWithHttpInfo(accept, code, grantType, password, tfaCode, username);
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<Object> PostLoginFormCookieWithHttpInfo(string? accept = default(string?), string? code = default(string?), string? grantType = default(string?), string? password = default(string?), string? tfaCode = default(string?), string? username = default(string?), int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.RequestOptions localVarRequestOptions = new kern.services.CumulocityClient.Client.RequestOptions();
            ...
            localVarRequestOptions.Operation = "LoginTokensApi.PostLoginFormCookie";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<Object>("/tenant/oauth", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PostLoginFormCookie", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task PostLoginFormCookieAsync(string? accept = default(string?), string? code = default(string?), string? grantType = default(string?), string? password = default(string?), string? tfaCode = default(string?), string? username = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await PostLoginFormCookieWithHttpInfoAsync(accept, code, grantType, password, tfaCode, username, operationIndex, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<Object>> PostLoginFormCookieWithHttpInfoAsync(string? accept = default(string?), string? code = default(string?), string? grantType = default(string?), string? password = default(string?), string? tfaCode = default(string?), string? username = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<Object>("/tenant/oauth", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
