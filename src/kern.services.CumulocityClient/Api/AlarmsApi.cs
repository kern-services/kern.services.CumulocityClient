...
namespace kern.services.CumulocityClient.Api
{
    ...
    /// </summary>
    public interface IAlarmsApi : IApiAccessor
    {
        ...
        /// <returns></returns>
        void DeleteAlarmCollectionResource (string xCumulocityProcessingMode = default(string), DateTime? createdFrom = default(DateTime?), DateTime? createdTo = default(DateTime?), DateTime? dateFrom = default(DateTime?), DateTime? dateTo = default(DateTime?), bool? resolved = default(bool?), List<string> severity = default(List<string>), string source = default(string), List<string> status = default(List<string>), List<string> type = default(List<string>), bool? withSourceAssets = default(bool?), bool? withSourceDevices = default(bool?));
        ...
        /// <param name="withSourceDevices">When set to &#x60;true&#x60; also alarms for related source devices will be included in the request. When this parameter is provided a &#x60;source&#x60; must be specified. (optional, default to false)</param>
        /// <returns>int</returns>
        int GetAlarmCollectionCountResource (DateTime? dateFrom = default(DateTime?), DateTime? dateTo = default(DateTime?), bool? resolved = default(bool?), List<string> severity = default(List<string>), string source = default(string), List<string> status = default(List<string>), List<string> type = default(List<string>), bool? withSourceAssets = default(bool?), bool? withSourceDevices = default(bool?));
        ...
        ApiResponse<int> GetAlarmCollectionCountResourceWithHttpInfo (DateTime? dateFrom = default(DateTime?), DateTime? dateTo = default(DateTime?), bool? resolved = default(bool?), List<string> severity = default(List<string>), string source = default(string), List<string> status = default(List<string>), List<string> type = default(List<string>), bool? withSourceAssets = default(bool?), bool? withSourceDevices = default(bool?));
        /// <summary>
        /// Retrieve all alarms
        /// </summary>
        /// <remarks>
        ...
        AlarmCollection GetAlarmCollectionResource (DateTime? createdFrom = default(DateTime?), DateTime? createdTo = default(DateTime?), int? currentPage = default(int?), DateTime? dateFrom = default(DateTime?), DateTime? dateTo = default(DateTime?), DateTime? lastUpdatedFrom = default(DateTime?), DateTime? lastUpdatedTo = default(DateTime?), int? pageSize = default(int?), bool? resolved = default(bool?), List<string> severity = default(List<string>), string source = default(string), List<string> status = default(List<string>), List<string> type = default(List<string>), bool? withSourceAssets = default(bool?), bool? withSourceDevices = default(bool?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?));
        ...
        ApiResponse<Alarm> GetAlarmResourceWithHttpInfo (string id);
        /// <summary>
        /// Create an alarm
        /// </summary>
        /// <remarks>
        ...
        /// <param name="xCumulocityProcessingMode">Used to explicitly control the processing mode of the request. See [Processing mode](#processing-mode) for more details. (optional, default to PERSISTENT)</param>
        /// <returns>Alarm</returns>
        Alarm PostAlarmCollectionResource (PostAlarmCollectionResourceRequest postAlarmCollectionResourceRequest, string accept = default(string), string xCumulocityProcessingMode = default(string));
        ...
        /// <param name="xCumulocityProcessingMode">Used to explicitly control the processing mode of the request. See [Processing mode](#processing-mode) for more details. (optional, default to PERSISTENT)</param>
        /// <returns>ApiResponse of Alarm</returns>
        ApiResponse<Alarm> PostAlarmCollectionResourceWithHttpInfo (PostAlarmCollectionResourceRequest postAlarmCollectionResourceRequest, string accept = default(string), string xCumulocityProcessingMode = default(string));
        /// <summary>
        ...
        /// <param name="withSourceDevices">When set to &#x60;true&#x60; also alarms for related source devices will be included in the request. When this parameter is provided a &#x60;source&#x60; must be specified. (optional, default to false)</param>
        /// <returns></returns>
        void PutAlarmCollectionResource (PutAlarmCollectionResourceRequest putAlarmCollectionResourceRequest, string accept = default(string), string xCumulocityProcessingMode = default(string), DateTime? createdFrom = default(DateTime?), DateTime? createdTo = default(DateTime?), DateTime? dateFrom = default(DateTime?), DateTime? dateTo = default(DateTime?), bool? resolved = default(bool?), List<string> severity = default(List<string>), string source = default(string), List<string> status = default(List<string>), bool? withSourceAssets = default(bool?), bool? withSourceDevices = default(bool?));
        ...
        /// <param name="xCumulocityProcessingMode">Used to explicitly control the processing mode of the request. See [Processing mode](#processing-mode) for more details. (optional, default to PERSISTENT)</param>
        /// <returns>Alarm</returns>
        Alarm PutAlarmResource (string id, PutAlarmResourceRequest putAlarmResourceRequest, string accept = default(string), string xCumulocityProcessingMode = default(string));
        ...
        /// <param name="xCumulocityProcessingMode">Used to explicitly control the processing mode of the request. See [Processing mode](#processing-mode) for more details. (optional, default to PERSISTENT)</param>
        /// <returns>ApiResponse of Alarm</returns>
        ApiResponse<Alarm> PutAlarmResourceWithHttpInfo (string id, PutAlarmResourceRequest putAlarmResourceRequest, string accept = default(string), string xCumulocityProcessingMode = default(string));
        ...
        System.Threading.Tasks.Task DeleteAlarmCollectionResourceAsync (string xCumulocityProcessingMode = default(string), DateTime? createdFrom = default(DateTime?), DateTime? createdTo = default(DateTime?), DateTime? dateFrom = default(DateTime?), DateTime? dateTo = default(DateTime?), bool? resolved = default(bool?), List<string> severity = default(List<string>), string source = default(string), List<string> status = default(List<string>), List<string> type = default(List<string>), bool? withSourceAssets = default(bool?), bool? withSourceDevices = default(bool?), CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<int> GetAlarmCollectionCountResourceAsync (DateTime? dateFrom = default(DateTime?), DateTime? dateTo = default(DateTime?), bool? resolved = default(bool?), List<string> severity = default(List<string>), string source = default(string), List<string> status = default(List<string>), List<string> type = default(List<string>), bool? withSourceAssets = default(bool?), bool? withSourceDevices = default(bool?), CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<int>> GetAlarmCollectionCountResourceWithHttpInfoAsync (DateTime? dateFrom = default(DateTime?), DateTime? dateTo = default(DateTime?), bool? resolved = default(bool?), List<string> severity = default(List<string>), string source = default(string), List<string> status = default(List<string>), List<string> type = default(List<string>), bool? withSourceAssets = default(bool?), bool? withSourceDevices = default(bool?), CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Retrieve all alarms
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<AlarmCollection> GetAlarmCollectionResourceAsync (DateTime? createdFrom = default(DateTime?), DateTime? createdTo = default(DateTime?), int? currentPage = default(int?), DateTime? dateFrom = default(DateTime?), DateTime? dateTo = default(DateTime?), DateTime? lastUpdatedFrom = default(DateTime?), DateTime? lastUpdatedTo = default(DateTime?), int? pageSize = default(int?), bool? resolved = default(bool?), List<string> severity = default(List<string>), string source = default(string), List<string> status = default(List<string>), List<string> type = default(List<string>), bool? withSourceAssets = default(bool?), bool? withSourceDevices = default(bool?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<Alarm> GetAlarmResourceAsync (string id, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Alarm>> GetAlarmResourceWithHttpInfoAsync (string id, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Create an alarm
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of Alarm</returns>
        System.Threading.Tasks.Task<Alarm> PostAlarmCollectionResourceAsync (PostAlarmCollectionResourceRequest postAlarmCollectionResourceRequest, string accept = default(string), string xCumulocityProcessingMode = default(string), CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (Alarm)</returns>
        System.Threading.Tasks.Task<ApiResponse<Alarm>> PostAlarmCollectionResourceWithHttpInfoAsync (PostAlarmCollectionResourceRequest postAlarmCollectionResourceRequest, string accept = default(string), string xCumulocityProcessingMode = default(string), CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Update alarm collections
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task PutAlarmCollectionResourceAsync (PutAlarmCollectionResourceRequest putAlarmCollectionResourceRequest, string accept = default(string), string xCumulocityProcessingMode = default(string), DateTime? createdFrom = default(DateTime?), DateTime? createdTo = default(DateTime?), DateTime? dateFrom = default(DateTime?), DateTime? dateTo = default(DateTime?), bool? resolved = default(bool?), List<string> severity = default(List<string>), string source = default(string), List<string> status = default(List<string>), bool? withSourceAssets = default(bool?), bool? withSourceDevices = default(bool?), CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of Alarm</returns>
        System.Threading.Tasks.Task<Alarm> PutAlarmResourceAsync (string id, PutAlarmResourceRequest putAlarmResourceRequest, string accept = default(string), string xCumulocityProcessingMode = default(string), CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (Alarm)</returns>
        System.Threading.Tasks.Task<ApiResponse<Alarm>> PutAlarmResourceWithHttpInfoAsync (string id, PutAlarmResourceRequest putAlarmResourceRequest, string accept = default(string), string xCumulocityProcessingMode = default(string), CancellationToken cancellationToken = default(CancellationToken));
    ...
    public partial class AlarmsApi : IAlarmsApi
    {
        ...
        /// <returns></returns>
        public AlarmsApi(kern.services.CumulocityClient.Client.Configuration configuration = null)
        {
        ...
        /// <param name="withSourceDevices">When set to &#x60;true&#x60; also alarms for related source devices will be included in the request. When this parameter is provided a &#x60;source&#x60; must be specified. (optional, default to false)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> DeleteAlarmCollectionResourceWithHttpInfo (string xCumulocityProcessingMode = default(string), DateTime? createdFrom = default(DateTime?), DateTime? createdTo = default(DateTime?), DateTime? dateFrom = default(DateTime?), DateTime? dateTo = default(DateTime?), bool? resolved = default(bool?), List<string> severity = default(List<string>), string source = default(string), List<string> status = default(List<string>), List<string> type = default(List<string>), bool? withSourceAssets = default(bool?), bool? withSourceDevices = default(bool?))
        {

            var localVarPath = "/alarm/alarms";
            ...
            if (resolved != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("", "resolved", resolved)); // query parameter
            ...
            {
                Exception exception = ExceptionFactory("DeleteAlarmCollectionResource", localVarResponse);
        ...
        {
             await DeleteAlarmCollectionResourceWithHttpInfoAsync(xCumulocityProcessingMode, createdFrom, createdTo, dateFrom, dateTo, resolved, severity, source, status, type, withSourceAssets, withSourceDevices, cancellationToken);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> DeleteAlarmCollectionResourceWithHttpInfoAsync (string xCumulocityProcessingMode = default(string), DateTime? createdFrom = default(DateTime?), DateTime? createdTo = default(DateTime?), DateTime? dateFrom = default(DateTime?), DateTime? dateTo = default(DateTime?), bool? resolved = default(bool?), List<string> severity = default(List<string>), string source = default(string), List<string> status = default(List<string>), List<string> type = default(List<string>), bool? withSourceAssets = default(bool?), bool? withSourceDevices = default(bool?), CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <param name="withSourceDevices">When set to &#x60;true&#x60; also alarms for related source devices will be included in the request. When this parameter is provided a &#x60;source&#x60; must be specified. (optional, default to false)</param>
        /// <returns>int</returns>
        public int GetAlarmCollectionCountResource (DateTime? dateFrom = default(DateTime?), DateTime? dateTo = default(DateTime?), bool? resolved = default(bool?), List<string> severity = default(List<string>), string source = default(string), List<string> status = default(List<string>), List<string> type = default(List<string>), bool? withSourceAssets = default(bool?), bool? withSourceDevices = default(bool?))
        {
             ApiResponse<int> localVarResponse = GetAlarmCollectionCountResourceWithHttpInfo(dateFrom, dateTo, resolved, severity, source, status, type, withSourceAssets, withSourceDevices);
        ...
        /// <param name="withSourceDevices">When set to &#x60;true&#x60; also alarms for related source devices will be included in the request. When this parameter is provided a &#x60;source&#x60; must be specified. (optional, default to false)</param>
        /// <returns>ApiResponse of int</returns>
        public ApiResponse<int> GetAlarmCollectionCountResourceWithHttpInfo (DateTime? dateFrom = default(DateTime?), DateTime? dateTo = default(DateTime?), bool? resolved = default(bool?), List<string> severity = default(List<string>), string source = default(string), List<string> status = default(List<string>), List<string> type = default(List<string>), bool? withSourceAssets = default(bool?), bool? withSourceDevices = default(bool?))
        {

            var localVarPath = "/alarm/alarms/count";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("GetAlarmCollectionCountResource", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of int</returns>
        public async System.Threading.Tasks.Task<int> GetAlarmCollectionCountResourceAsync (DateTime? dateFrom = default(DateTime?), DateTime? dateTo = default(DateTime?), bool? resolved = default(bool?), List<string> severity = default(List<string>), string source = default(string), List<string> status = default(List<string>), List<string> type = default(List<string>), bool? withSourceAssets = default(bool?), bool? withSourceDevices = default(bool?), CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<int> localVarResponse = await GetAlarmCollectionCountResourceWithHttpInfoAsync(dateFrom, dateTo, resolved, severity, source, status, type, withSourceAssets, withSourceDevices, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (int)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<int>> GetAlarmCollectionCountResourceWithHttpInfoAsync (DateTime? dateFrom = default(DateTime?), DateTime? dateTo = default(DateTime?), bool? resolved = default(bool?), List<string> severity = default(List<string>), string source = default(string), List<string> status = default(List<string>), List<string> type = default(List<string>), bool? withSourceAssets = default(bool?), bool? withSourceDevices = default(bool?), CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        {
             ApiResponse<AlarmCollection> localVarResponse = GetAlarmCollectionResourceWithHttpInfo(createdFrom, createdTo, currentPage, dateFrom, dateTo, lastUpdatedFrom, lastUpdatedTo, pageSize, resolved, severity, source, status, type, withSourceAssets, withSourceDevices, withTotalElements, withTotalPages);
             return localVarResponse.Data;
        }
        ...
        /// <param name="withTotalPages">When set to &#x60;true&#x60;, the returned result will contain in the statistics object the total number of pages. Only applicable on [range queries](https://en.wikipedia.org/wiki/Range_query_(database)). (optional, default to false)</param>
        /// <returns>ApiResponse of AlarmCollection</returns>
        public ApiResponse<AlarmCollection> GetAlarmCollectionResourceWithHttpInfo (DateTime? createdFrom = default(DateTime?), DateTime? createdTo = default(DateTime?), int? currentPage = default(int?), DateTime? dateFrom = default(DateTime?), DateTime? dateTo = default(DateTime?), DateTime? lastUpdatedFrom = default(DateTime?), DateTime? lastUpdatedTo = default(DateTime?), int? pageSize = default(int?), bool? resolved = default(bool?), List<string> severity = default(List<string>), string source = default(string), List<string> status = default(List<string>), List<string> type = default(List<string>), bool? withSourceAssets = default(bool?), bool? withSourceDevices = default(bool?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?))
        {
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("GetAlarmCollectionResource", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<AlarmCollection>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (AlarmCollection) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(AlarmCollection)));
        }
        ...
        {
             ApiResponse<AlarmCollection> localVarResponse = await GetAlarmCollectionResourceWithHttpInfoAsync(createdFrom, createdTo, currentPage, dateFrom, dateTo, lastUpdatedFrom, lastUpdatedTo, pageSize, resolved, severity, source, status, type, withSourceAssets, withSourceDevices, withTotalElements, withTotalPages, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (AlarmCollection)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<AlarmCollection>> GetAlarmCollectionResourceWithHttpInfoAsync (DateTime? createdFrom = default(DateTime?), DateTime? createdTo = default(DateTime?), int? currentPage = default(int?), DateTime? dateFrom = default(DateTime?), DateTime? dateTo = default(DateTime?), DateTime? lastUpdatedFrom = default(DateTime?), DateTime? lastUpdatedTo = default(DateTime?), int? pageSize = default(int?), bool? resolved = default(bool?), List<string> severity = default(List<string>), string source = default(string), List<string> status = default(List<string>), List<string> type = default(List<string>), bool? withSourceAssets = default(bool?), bool? withSourceDevices = default(bool?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <param name="id">Unique identifier of the alarm.</param>
        /// <returns>Alarm</returns>
        public Alarm GetAlarmResource (string id)
        {
             ApiResponse<Alarm> localVarResponse = GetAlarmResourceWithHttpInfo(id);
             return localVarResponse.Data;
        }
        ...
        /// <param name="id">Unique identifier of the alarm.</param>
        /// <returns>ApiResponse of Alarm</returns>
        public ApiResponse<Alarm> GetAlarmResourceWithHttpInfo (string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling AlarmsApi->GetAlarmResource");

            var localVarPath = "/alarm/alarms/{id}";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("GetAlarmResource", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<Alarm>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (Alarm) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(Alarm)));
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of Alarm</returns>
        public async System.Threading.Tasks.Task<Alarm> GetAlarmResourceAsync (string id, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<Alarm> localVarResponse = await GetAlarmResourceWithHttpInfoAsync(id, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (Alarm)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Alarm>> GetAlarmResourceWithHttpInfoAsync (string id, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling AlarmsApi->GetAlarmResource");
        ...
        /// <param name="xCumulocityProcessingMode">Used to explicitly control the processing mode of the request. See [Processing mode](#processing-mode) for more details. (optional, default to PERSISTENT)</param>
        /// <returns>Alarm</returns>
        public Alarm PostAlarmCollectionResource (PostAlarmCollectionResourceRequest postAlarmCollectionResourceRequest, string accept = default(string), string xCumulocityProcessingMode = default(string))
        {
             ApiResponse<Alarm> localVarResponse = PostAlarmCollectionResourceWithHttpInfo(postAlarmCollectionResourceRequest, accept, xCumulocityProcessingMode);
             return localVarResponse.Data;
        }
        ...
        /// <param name="xCumulocityProcessingMode">Used to explicitly control the processing mode of the request. See [Processing mode](#processing-mode) for more details. (optional, default to PERSISTENT)</param>
        /// <returns>ApiResponse of Alarm</returns>
        public ApiResponse<Alarm> PostAlarmCollectionResourceWithHttpInfo (PostAlarmCollectionResourceRequest postAlarmCollectionResourceRequest, string accept = default(string), string xCumulocityProcessingMode = default(string))
        {
            // verify the required parameter 'postAlarmCollectionResourceRequest' is set
            if (postAlarmCollectionResourceRequest == null)
                throw new ApiException(400, "Missing required parameter 'postAlarmCollectionResourceRequest' when calling AlarmsApi->PostAlarmCollectionResource");
            ...
            if (xCumulocityProcessingMode != null) localVarHeaderParams.Add("X-Cumulocity-Processing-Mode", this.Configuration.ApiClient.ParameterToString(xCumulocityProcessingMode)); // header parameter
            if (postAlarmCollectionResourceRequest != null && postAlarmCollectionResourceRequest.GetType() != typeof(byte[]))
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(postAlarmCollectionResourceRequest); // http body (model) parameter
            }
            else
            {
                localVarPostBody = postAlarmCollectionResourceRequest; // byte array
            }
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("PostAlarmCollectionResource", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of Alarm</returns>
        public async System.Threading.Tasks.Task<Alarm> PostAlarmCollectionResourceAsync (PostAlarmCollectionResourceRequest postAlarmCollectionResourceRequest, string accept = default(string), string xCumulocityProcessingMode = default(string), CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<Alarm> localVarResponse = await PostAlarmCollectionResourceWithHttpInfoAsync(postAlarmCollectionResourceRequest, accept, xCumulocityProcessingMode, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="withSourceDevices">When set to &#x60;true&#x60; also alarms for related source devices will be included in the request. When this parameter is provided a &#x60;source&#x60; must be specified. (optional, default to false)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> PutAlarmCollectionResourceWithHttpInfo (PutAlarmCollectionResourceRequest putAlarmCollectionResourceRequest, string accept = default(string), string xCumulocityProcessingMode = default(string), DateTime? createdFrom = default(DateTime?), DateTime? createdTo = default(DateTime?), DateTime? dateFrom = default(DateTime?), DateTime? dateTo = default(DateTime?), bool? resolved = default(bool?), List<string> severity = default(List<string>), string source = default(string), List<string> status = default(List<string>), bool? withSourceAssets = default(bool?), bool? withSourceDevices = default(bool?))
        {
            // verify the required parameter 'putAlarmCollectionResourceRequest' is set
            if (putAlarmCollectionResourceRequest == null)
                throw new ApiException(400, "Missing required parameter 'putAlarmCollectionResourceRequest' when calling AlarmsApi->PutAlarmCollectionResource");
            ...
            if (accept != null) localVarHeaderParams.Add("Accept", this.Configuration.ApiClient.ParameterToString(accept)); // header parameter
            if (xCumulocityProcessingMode != null) localVarHeaderParams.Add("X-Cumulocity-Processing-Mode", this.Configuration.ApiClient.ParameterToString(xCumulocityProcessingMode)); // header parameter
            if (putAlarmCollectionResourceRequest != null && putAlarmCollectionResourceRequest.GetType() != typeof(byte[]))
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(putAlarmCollectionResourceRequest); // http body (model) parameter
            }
            else
            {
                localVarPostBody = putAlarmCollectionResourceRequest; // byte array
            }
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("PutAlarmCollectionResource", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        {
             await PutAlarmCollectionResourceWithHttpInfoAsync(putAlarmCollectionResourceRequest, accept, xCumulocityProcessingMode, createdFrom, createdTo, dateFrom, dateTo, resolved, severity, source, status, withSourceAssets, withSourceDevices, cancellationToken);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> PutAlarmCollectionResourceWithHttpInfoAsync (PutAlarmCollectionResourceRequest putAlarmCollectionResourceRequest, string accept = default(string), string xCumulocityProcessingMode = default(string), DateTime? createdFrom = default(DateTime?), DateTime? createdTo = default(DateTime?), DateTime? dateFrom = default(DateTime?), DateTime? dateTo = default(DateTime?), bool? resolved = default(bool?), List<string> severity = default(List<string>), string source = default(string), List<string> status = default(List<string>), bool? withSourceAssets = default(bool?), bool? withSourceDevices = default(bool?), CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'putAlarmCollectionResourceRequest' is set
            if (putAlarmCollectionResourceRequest == null)
                throw new ApiException(400, "Missing required parameter 'putAlarmCollectionResourceRequest' when calling AlarmsApi->PutAlarmCollectionResource");
        ...
        /// <param name="xCumulocityProcessingMode">Used to explicitly control the processing mode of the request. See [Processing mode](#processing-mode) for more details. (optional, default to PERSISTENT)</param>
        /// <returns>Alarm</returns>
        public Alarm PutAlarmResource (string id, PutAlarmResourceRequest putAlarmResourceRequest, string accept = default(string), string xCumulocityProcessingMode = default(string))
        {
             ApiResponse<Alarm> localVarResponse = PutAlarmResourceWithHttpInfo(id, putAlarmResourceRequest, accept, xCumulocityProcessingMode);
             return localVarResponse.Data;
        }
        ...
        /// <param name="xCumulocityProcessingMode">Used to explicitly control the processing mode of the request. See [Processing mode](#processing-mode) for more details. (optional, default to PERSISTENT)</param>
        /// <returns>ApiResponse of Alarm</returns>
        public ApiResponse<Alarm> PutAlarmResourceWithHttpInfo (string id, PutAlarmResourceRequest putAlarmResourceRequest, string accept = default(string), string xCumulocityProcessingMode = default(string))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling AlarmsApi->PutAlarmResource");
            // verify the required parameter 'putAlarmResourceRequest' is set
            if (putAlarmResourceRequest == null)
                throw new ApiException(400, "Missing required parameter 'putAlarmResourceRequest' when calling AlarmsApi->PutAlarmResource");
            ...
            if (accept != null) localVarHeaderParams.Add("Accept", this.Configuration.ApiClient.ParameterToString(accept)); // header parameter
            if (xCumulocityProcessingMode != null) localVarHeaderParams.Add("X-Cumulocity-Processing-Mode", this.Configuration.ApiClient.ParameterToString(xCumulocityProcessingMode)); // header parameter
            if (putAlarmResourceRequest != null && putAlarmResourceRequest.GetType() != typeof(byte[]))
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(putAlarmResourceRequest); // http body (model) parameter
            }
            else
            {
                localVarPostBody = putAlarmResourceRequest; // byte array
            }
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("PutAlarmResource", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of Alarm</returns>
        public async System.Threading.Tasks.Task<Alarm> PutAlarmResourceAsync (string id, PutAlarmResourceRequest putAlarmResourceRequest, string accept = default(string), string xCumulocityProcessingMode = default(string), CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<Alarm> localVarResponse = await PutAlarmResourceWithHttpInfoAsync(id, putAlarmResourceRequest, accept, xCumulocityProcessingMode, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (Alarm)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Alarm>> PutAlarmResourceWithHttpInfoAsync (string id, PutAlarmResourceRequest putAlarmResourceRequest, string accept = default(string), string xCumulocityProcessingMode = default(string), CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling AlarmsApi->PutAlarmResource");
