...
namespace kern.services.CumulocityClient.Api
{
    ...
    /// </summary>
    public interface INewDeviceRequestsApiSync : IApiAccessor
    {
        ...
        /// <returns></returns>
        void DeleteNewDeviceRequestResource(string requestId, int operationIndex = 0);
        ...
        ApiResponse<Object> DeleteNewDeviceRequestResourceWithHttpInfo(string requestId, int operationIndex = 0);
        /// <summary>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>NewDeviceRequestCollection</returns>
        NewDeviceRequestCollection GetNewDeviceRequestCollectionResource(int? currentPage = default(int?), int? pageSize = default(int?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0);
        ...
        /// <param name="withTotalPages">When set to &#x60;true&#x60;, the returned result will contain in the statistics object the total number of pages. Only applicable on [range queries](https://en.wikipedia.org/wiki/Range_query_(database)). (optional, default to false)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of NewDeviceRequestCollection</returns>
        ApiResponse<NewDeviceRequestCollection> GetNewDeviceRequestCollectionResourceWithHttpInfo(int? currentPage = default(int?), int? pageSize = default(int?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0);
        /// <summary>
        ...
        /// <param name="requestId">Unique identifier of the new device request.</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>NewDeviceRequest</returns>
        NewDeviceRequest GetNewDeviceRequestResource(string requestId, int operationIndex = 0);
        ...
        /// <param name="requestId">Unique identifier of the new device request.</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of NewDeviceRequest</returns>
        ApiResponse<NewDeviceRequest> GetNewDeviceRequestResourceWithHttpInfo(string requestId, int operationIndex = 0);
        /// <summary>
        ...
        /// </remarks>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="postNewDeviceRequestCollectionResourceRequest"></param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>NewDeviceRequest</returns>
        NewDeviceRequest PostNewDeviceRequestCollectionResource(PostNewDeviceRequestCollectionResourceRequest postNewDeviceRequestCollectionResourceRequest, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of NewDeviceRequest</returns>
        ApiResponse<NewDeviceRequest> PostNewDeviceRequestCollectionResourceWithHttpInfo(PostNewDeviceRequestCollectionResourceRequest postNewDeviceRequestCollectionResourceRequest, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0);
        /// <summary>
        ...
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="requestId">Unique identifier of the new device request.</param>
        /// <param name="putNewDeviceRequestResourceRequest"></param>
        /// <param name="accept">Advertises which content types, expressed as MIME types, the client is able to understand. (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>NewDeviceRequest</returns>
        NewDeviceRequest PutNewDeviceRequestResource(string requestId, PutNewDeviceRequestResourceRequest putNewDeviceRequestResourceRequest, string? accept = default(string?), int operationIndex = 0);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of NewDeviceRequest</returns>
        ApiResponse<NewDeviceRequest> PutNewDeviceRequestResourceWithHttpInfo(string requestId, PutNewDeviceRequestResourceRequest putNewDeviceRequestResourceRequest, string? accept = default(string?), int operationIndex = 0);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface INewDeviceRequestsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task DeleteNewDeviceRequestResourceAsync(string requestId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> DeleteNewDeviceRequestResourceWithHttpInfoAsync(string requestId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Retrieve a list of new device requests
        /// </summary>
        /// <remarks>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (NewDeviceRequestCollection)</returns>
        System.Threading.Tasks.Task<ApiResponse<NewDeviceRequestCollection>> GetNewDeviceRequestCollectionResourceWithHttpInfoAsync(int? currentPage = default(int?), int? pageSize = default(int?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Retrieve a specific new device request
        /// </summary>
        /// <remarks>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of NewDeviceRequest</returns>
        System.Threading.Tasks.Task<NewDeviceRequest> GetNewDeviceRequestResourceAsync(string requestId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (NewDeviceRequest)</returns>
        System.Threading.Tasks.Task<ApiResponse<NewDeviceRequest>> GetNewDeviceRequestResourceWithHttpInfoAsync(string requestId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Create a new device request
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of NewDeviceRequest</returns>
        System.Threading.Tasks.Task<NewDeviceRequest> PostNewDeviceRequestCollectionResourceAsync(PostNewDeviceRequestCollectionResourceRequest postNewDeviceRequestCollectionResourceRequest, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (NewDeviceRequest)</returns>
        System.Threading.Tasks.Task<ApiResponse<NewDeviceRequest>> PostNewDeviceRequestCollectionResourceWithHttpInfoAsync(PostNewDeviceRequestCollectionResourceRequest postNewDeviceRequestCollectionResourceRequest, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Update a specific new device request status
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of NewDeviceRequest</returns>
        System.Threading.Tasks.Task<NewDeviceRequest> PutNewDeviceRequestResourceAsync(string requestId, PutNewDeviceRequestResourceRequest putNewDeviceRequestResourceRequest, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (NewDeviceRequest)</returns>
        System.Threading.Tasks.Task<ApiResponse<NewDeviceRequest>> PutNewDeviceRequestResourceWithHttpInfoAsync(string requestId, PutNewDeviceRequestResourceRequest putNewDeviceRequestResourceRequest, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface INewDeviceRequestsApi : INewDeviceRequestsApiSync, INewDeviceRequestsApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class NewDeviceRequestsApi : INewDeviceRequestsApi
    {
        private kern.services.CumulocityClient.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="NewDeviceRequestsApi"/> class.
        /// </summary>
        /// <returns></returns>
        public NewDeviceRequestsApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public NewDeviceRequestsApi(string basePath)
        {
        ...
        /// <returns></returns>
        public NewDeviceRequestsApi(kern.services.CumulocityClient.Client.Configuration configuration)
        {
        ...
        public NewDeviceRequestsApi(kern.services.CumulocityClient.Client.ISynchronousClient client, kern.services.CumulocityClient.Client.IAsynchronousClient asyncClient, kern.services.CumulocityClient.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Delete a specific new device request Delete a specific new device request (by a given ID).  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_USER_MANAGEMENT_ADMIN &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="requestId">Unique identifier of the new device request.</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns></returns>
        public void DeleteNewDeviceRequestResource(string requestId, int operationIndex = 0)
        {
            DeleteNewDeviceRequestResourceWithHttpInfo(requestId);
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<Object> DeleteNewDeviceRequestResourceWithHttpInfo(string requestId, int operationIndex = 0)
        {
            // verify the required parameter 'requestId' is set
            if (requestId == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'requestId' when calling NewDeviceRequestsApi->DeleteNewDeviceRequestResource");
            }
            ...
            localVarRequestOptions.PathParameters.Add("requestId", kern.services.CumulocityClient.Client.ClientUtils.ParameterToString(requestId)); // path parameter

            localVarRequestOptions.Operation = "NewDeviceRequestsApi.DeleteNewDeviceRequestResource";
            ...
            var localVarResponse = this.Client.Delete<Object>("/devicecontrol/newDeviceRequests/{requestId}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("DeleteNewDeviceRequestResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task DeleteNewDeviceRequestResourceAsync(string requestId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await DeleteNewDeviceRequestResourceWithHttpInfoAsync(requestId, operationIndex, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<Object>> DeleteNewDeviceRequestResourceWithHttpInfoAsync(string requestId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'requestId' is set
            if (requestId == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.DeleteAsync<Object>("/devicecontrol/newDeviceRequests/{requestId}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Retrieve a list of new device requests Retrieve a list of new device requests.  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_DEVICE_CONTROL_READ &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="currentPage">The current page of the paginated results. (optional, default to 1)</param>
        /// <param name="pageSize">Indicates how many entries of the collection shall be returned. The upper limit for one page is 2,000 objects. (optional, default to 5)</param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>NewDeviceRequestCollection</returns>
        public NewDeviceRequestCollection GetNewDeviceRequestCollectionResource(int? currentPage = default(int?), int? pageSize = default(int?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<NewDeviceRequestCollection> localVarResponse = GetNewDeviceRequestCollectionResourceWithHttpInfo(currentPage, pageSize, withTotalElements, withTotalPages);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of NewDeviceRequestCollection</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<NewDeviceRequestCollection> GetNewDeviceRequestCollectionResourceWithHttpInfo(int? currentPage = default(int?), int? pageSize = default(int?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.RequestOptions localVarRequestOptions = new kern.services.CumulocityClient.Client.RequestOptions();
            ...
            localVarRequestOptions.Operation = "NewDeviceRequestsApi.GetNewDeviceRequestCollectionResource";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<NewDeviceRequestCollection>("/devicecontrol/newDeviceRequests", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetNewDeviceRequestCollectionResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of NewDeviceRequestCollection</returns>
        public async System.Threading.Tasks.Task<NewDeviceRequestCollection> GetNewDeviceRequestCollectionResourceAsync(int? currentPage = default(int?), int? pageSize = default(int?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<NewDeviceRequestCollection> localVarResponse = await GetNewDeviceRequestCollectionResourceWithHttpInfoAsync(currentPage, pageSize, withTotalElements, withTotalPages, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (NewDeviceRequestCollection)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<NewDeviceRequestCollection>> GetNewDeviceRequestCollectionResourceWithHttpInfoAsync(int? currentPage = default(int?), int? pageSize = default(int?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<NewDeviceRequestCollection>("/devicecontrol/newDeviceRequests", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Retrieve a specific new device request Retrieve a specific new device request (by a given ID).  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_DEVICE_CONTROL_READ &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="requestId">Unique identifier of the new device request.</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>NewDeviceRequest</returns>
        public NewDeviceRequest GetNewDeviceRequestResource(string requestId, int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<NewDeviceRequest> localVarResponse = GetNewDeviceRequestResourceWithHttpInfo(requestId);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of NewDeviceRequest</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<NewDeviceRequest> GetNewDeviceRequestResourceWithHttpInfo(string requestId, int operationIndex = 0)
        {
            // verify the required parameter 'requestId' is set
            if (requestId == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'requestId' when calling NewDeviceRequestsApi->GetNewDeviceRequestResource");
            }
            ...
            localVarRequestOptions.Operation = "NewDeviceRequestsApi.GetNewDeviceRequestResource";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<NewDeviceRequest>("/devicecontrol/newDeviceRequests/{requestId}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetNewDeviceRequestResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of NewDeviceRequest</returns>
        public async System.Threading.Tasks.Task<NewDeviceRequest> GetNewDeviceRequestResourceAsync(string requestId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<NewDeviceRequest> localVarResponse = await GetNewDeviceRequestResourceWithHttpInfoAsync(requestId, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (NewDeviceRequest)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<NewDeviceRequest>> GetNewDeviceRequestResourceWithHttpInfoAsync(string requestId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'requestId' is set
            if (requestId == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<NewDeviceRequest>("/devicecontrol/newDeviceRequests/{requestId}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Create a new device request Create a new device request.  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_DEVICE_CONTROL_ADMIN &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="postNewDeviceRequestCollectionResourceRequest"></param>
        /// <param name="accept">Advertises which content types, expressed as MIME types, the client is able to understand. (optional)</param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>NewDeviceRequest</returns>
        public NewDeviceRequest PostNewDeviceRequestCollectionResource(PostNewDeviceRequestCollectionResourceRequest postNewDeviceRequestCollectionResourceRequest, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<NewDeviceRequest> localVarResponse = PostNewDeviceRequestCollectionResourceWithHttpInfo(postNewDeviceRequestCollectionResourceRequest, accept, xCumulocityProcessingMode);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of NewDeviceRequest</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<NewDeviceRequest> PostNewDeviceRequestCollectionResourceWithHttpInfo(PostNewDeviceRequestCollectionResourceRequest postNewDeviceRequestCollectionResourceRequest, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'postNewDeviceRequestCollectionResourceRequest' is set
            if (postNewDeviceRequestCollectionResourceRequest == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'postNewDeviceRequestCollectionResourceRequest' when calling NewDeviceRequestsApi->PostNewDeviceRequestCollectionResource");
            }
            ...
            localVarRequestOptions.Data = postNewDeviceRequestCollectionResourceRequest;

            localVarRequestOptions.Operation = "NewDeviceRequestsApi.PostNewDeviceRequestCollectionResource";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<NewDeviceRequest>("/devicecontrol/newDeviceRequests", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PostNewDeviceRequestCollectionResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of NewDeviceRequest</returns>
        public async System.Threading.Tasks.Task<NewDeviceRequest> PostNewDeviceRequestCollectionResourceAsync(PostNewDeviceRequestCollectionResourceRequest postNewDeviceRequestCollectionResourceRequest, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<NewDeviceRequest> localVarResponse = await PostNewDeviceRequestCollectionResourceWithHttpInfoAsync(postNewDeviceRequestCollectionResourceRequest, accept, xCumulocityProcessingMode, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (NewDeviceRequest)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<NewDeviceRequest>> PostNewDeviceRequestCollectionResourceWithHttpInfoAsync(PostNewDeviceRequestCollectionResourceRequest postNewDeviceRequestCollectionResourceRequest, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'postNewDeviceRequestCollectionResourceRequest' is set
            if (postNewDeviceRequestCollectionResourceRequest == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<NewDeviceRequest>("/devicecontrol/newDeviceRequests", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Update a specific new device request status Update a specific new device request (by a given ID). You can only update its status.  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_DEVICE_CONTROL_ADMIN &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="requestId">Unique identifier of the new device request.</param>
        /// <param name="putNewDeviceRequestResourceRequest"></param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>NewDeviceRequest</returns>
        public NewDeviceRequest PutNewDeviceRequestResource(string requestId, PutNewDeviceRequestResourceRequest putNewDeviceRequestResourceRequest, string? accept = default(string?), int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<NewDeviceRequest> localVarResponse = PutNewDeviceRequestResourceWithHttpInfo(requestId, putNewDeviceRequestResourceRequest, accept);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of NewDeviceRequest</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<NewDeviceRequest> PutNewDeviceRequestResourceWithHttpInfo(string requestId, PutNewDeviceRequestResourceRequest putNewDeviceRequestResourceRequest, string? accept = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'requestId' is set
            if (requestId == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'requestId' when calling NewDeviceRequestsApi->PutNewDeviceRequestResource");
            }

            // verify the required parameter 'putNewDeviceRequestResourceRequest' is set
            if (putNewDeviceRequestResourceRequest == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'putNewDeviceRequestResourceRequest' when calling NewDeviceRequestsApi->PutNewDeviceRequestResource");
            }
            ...
            localVarRequestOptions.Data = putNewDeviceRequestResourceRequest;

            localVarRequestOptions.Operation = "NewDeviceRequestsApi.PutNewDeviceRequestResource";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Put<NewDeviceRequest>("/devicecontrol/newDeviceRequests/{requestId}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PutNewDeviceRequestResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of NewDeviceRequest</returns>
        public async System.Threading.Tasks.Task<NewDeviceRequest> PutNewDeviceRequestResourceAsync(string requestId, PutNewDeviceRequestResourceRequest putNewDeviceRequestResourceRequest, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<NewDeviceRequest> localVarResponse = await PutNewDeviceRequestResourceWithHttpInfoAsync(requestId, putNewDeviceRequestResourceRequest, accept, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (NewDeviceRequest)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<NewDeviceRequest>> PutNewDeviceRequestResourceWithHttpInfoAsync(string requestId, PutNewDeviceRequestResourceRequest putNewDeviceRequestResourceRequest, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'requestId' is set
            if (requestId == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PutAsync<NewDeviceRequest>("/devicecontrol/newDeviceRequests/{requestId}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
