...
namespace kern.services.CumulocityClient.Api
{
    ...
    /// </summary>
    public interface IIdentityAPIApiSync : IApiAccessor
    {
        ...
        /// <returns>IdentityApiResource</returns>
        IdentityApiResource GetIdentityApiResource(int operationIndex = 0);
        ...
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of IdentityApiResource</returns>
        ApiResponse<IdentityApiResource> GetIdentityApiResourceWithHttpInfo(int operationIndex = 0);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IIdentityAPIApiAsync : IApiAccessor
    {
        ...
        /// <returns>Task of IdentityApiResource</returns>
        System.Threading.Tasks.Task<IdentityApiResource> GetIdentityApiResourceAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (IdentityApiResource)</returns>
        System.Threading.Tasks.Task<ApiResponse<IdentityApiResource>> GetIdentityApiResourceWithHttpInfoAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IIdentityAPIApi : IIdentityAPIApiSync, IIdentityAPIApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class IdentityAPIApi : IIdentityAPIApi
    {
        private kern.services.CumulocityClient.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="IdentityAPIApi"/> class.
        /// </summary>
        /// <returns></returns>
        public IdentityAPIApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public IdentityAPIApi(string basePath)
        {
        ...
        /// <returns></returns>
        public IdentityAPIApi(kern.services.CumulocityClient.Client.Configuration configuration)
        {
        ...
        public IdentityAPIApi(kern.services.CumulocityClient.Client.ISynchronousClient client, kern.services.CumulocityClient.Client.IAsynchronousClient asyncClient, kern.services.CumulocityClient.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Retrieve URIs to collections of external IDs Retrieve URIs and URI templates for associating external identifiers with unique identifiers.  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_IDENTITY_READ &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>IdentityApiResource</returns>
        public IdentityApiResource GetIdentityApiResource(int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<IdentityApiResource> localVarResponse = GetIdentityApiResourceWithHttpInfo();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of IdentityApiResource</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<IdentityApiResource> GetIdentityApiResourceWithHttpInfo(int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "IdentityAPIApi.GetIdentityApiResource";
            ...
            var localVarResponse = this.Client.Get<IdentityApiResource>("/identity", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetIdentityApiResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of IdentityApiResource</returns>
        public async System.Threading.Tasks.Task<IdentityApiResource> GetIdentityApiResourceAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<IdentityApiResource> localVarResponse = await GetIdentityApiResourceWithHttpInfoAsync(operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (IdentityApiResource)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<IdentityApiResource>> GetIdentityApiResourceWithHttpInfoAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<IdentityApiResource>("/identity", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
