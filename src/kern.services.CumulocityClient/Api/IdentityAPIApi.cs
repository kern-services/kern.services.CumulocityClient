...
namespace kern.services.CumulocityClient.Api
{
    ...
    /// </summary>
    public interface IIdentityAPIApi : IApiAccessor
    {
        ...
        ApiResponse<IdentityApiResource> GetIdentityApiResourceWithHttpInfo ();
        ...
        System.Threading.Tasks.Task<IdentityApiResource> GetIdentityApiResourceAsync (CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<IdentityApiResource>> GetIdentityApiResourceWithHttpInfoAsync (CancellationToken cancellationToken = default(CancellationToken));
    ...
    public partial class IdentityAPIApi : IIdentityAPIApi
    {
        ...
        /// <returns></returns>
        public IdentityAPIApi(kern.services.CumulocityClient.Client.Configuration configuration = null)
        {
        ...
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>IdentityApiResource</returns>
        public IdentityApiResource GetIdentityApiResource ()
        {
             ApiResponse<IdentityApiResource> localVarResponse = GetIdentityApiResourceWithHttpInfo();
        ...
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of IdentityApiResource</returns>
        public ApiResponse<IdentityApiResource> GetIdentityApiResourceWithHttpInfo ()
        {
            ...
            {
                Exception exception = ExceptionFactory("GetIdentityApiResource", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<IdentityApiResource>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (IdentityApiResource) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(IdentityApiResource)));
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of IdentityApiResource</returns>
        public async System.Threading.Tasks.Task<IdentityApiResource> GetIdentityApiResourceAsync (CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<IdentityApiResource> localVarResponse = await GetIdentityApiResourceWithHttpInfoAsync(cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (IdentityApiResource)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<IdentityApiResource>> GetIdentityApiResourceWithHttpInfoAsync (CancellationToken cancellationToken = default(CancellationToken))
        {
