...
namespace kern.services.CumulocityClient.Api
{
    ...
    /// </summary>
    public interface IApplicationAPIApiSync : IApiAccessor
    {
        ...
        /// <returns>ApplicationApiResource</returns>
        ApplicationApiResource GetApplicationManagementApiResource(int operationIndex = 0);
        ...
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ApplicationApiResource</returns>
        ApiResponse<ApplicationApiResource> GetApplicationManagementApiResourceWithHttpInfo(int operationIndex = 0);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IApplicationAPIApiAsync : IApiAccessor
    {
        ...
        /// <returns>Task of ApplicationApiResource</returns>
        System.Threading.Tasks.Task<ApplicationApiResource> GetApplicationManagementApiResourceAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ApplicationApiResource)</returns>
        System.Threading.Tasks.Task<ApiResponse<ApplicationApiResource>> GetApplicationManagementApiResourceWithHttpInfoAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IApplicationAPIApi : IApplicationAPIApiSync, IApplicationAPIApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class ApplicationAPIApi : IApplicationAPIApi
    {
        private kern.services.CumulocityClient.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationAPIApi"/> class.
        /// </summary>
        /// <returns></returns>
        public ApplicationAPIApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public ApplicationAPIApi(string basePath)
        {
        ...
        /// <returns></returns>
        public ApplicationAPIApi(kern.services.CumulocityClient.Client.Configuration configuration)
        {
        ...
        public ApplicationAPIApi(kern.services.CumulocityClient.Client.ISynchronousClient client, kern.services.CumulocityClient.Client.IAsynchronousClient asyncClient, kern.services.CumulocityClient.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Retrieve URIs to collections of applications Retrieve URIs and URI templates to collections of applications.  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_APPLICATION_MANAGEMENT_READ &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApplicationApiResource</returns>
        public ApplicationApiResource GetApplicationManagementApiResource(int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<ApplicationApiResource> localVarResponse = GetApplicationManagementApiResourceWithHttpInfo();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ApplicationApiResource</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<ApplicationApiResource> GetApplicationManagementApiResourceWithHttpInfo(int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "ApplicationAPIApi.GetApplicationManagementApiResource";
            ...
            var localVarResponse = this.Client.Get<ApplicationApiResource>("/application", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetApplicationManagementApiResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApplicationApiResource</returns>
        public async System.Threading.Tasks.Task<ApplicationApiResource> GetApplicationManagementApiResourceAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<ApplicationApiResource> localVarResponse = await GetApplicationManagementApiResourceWithHttpInfoAsync(operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ApplicationApiResource)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<ApplicationApiResource>> GetApplicationManagementApiResourceWithHttpInfoAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<ApplicationApiResource>("/application", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
