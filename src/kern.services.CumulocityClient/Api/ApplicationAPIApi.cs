...
namespace kern.services.CumulocityClient.Api
{
    ...
    /// </summary>
    public interface IApplicationAPIApi : IApiAccessor
    {
        ...
        ApiResponse<ApplicationApiResource> GetApplicationManagementApiResourceWithHttpInfo ();
        ...
        System.Threading.Tasks.Task<ApplicationApiResource> GetApplicationManagementApiResourceAsync (CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<ApplicationApiResource>> GetApplicationManagementApiResourceWithHttpInfoAsync (CancellationToken cancellationToken = default(CancellationToken));
    ...
    public partial class ApplicationAPIApi : IApplicationAPIApi
    {
        ...
        /// <returns></returns>
        public ApplicationAPIApi(kern.services.CumulocityClient.Client.Configuration configuration = null)
        {
        ...
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApplicationApiResource</returns>
        public ApplicationApiResource GetApplicationManagementApiResource ()
        {
             ApiResponse<ApplicationApiResource> localVarResponse = GetApplicationManagementApiResourceWithHttpInfo();
        ...
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of ApplicationApiResource</returns>
        public ApiResponse<ApplicationApiResource> GetApplicationManagementApiResourceWithHttpInfo ()
        {
            ...
            {
                Exception exception = ExceptionFactory("GetApplicationManagementApiResource", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<ApplicationApiResource>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (ApplicationApiResource) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(ApplicationApiResource)));
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApplicationApiResource</returns>
        public async System.Threading.Tasks.Task<ApplicationApiResource> GetApplicationManagementApiResourceAsync (CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<ApplicationApiResource> localVarResponse = await GetApplicationManagementApiResourceWithHttpInfoAsync(cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (ApplicationApiResource)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ApplicationApiResource>> GetApplicationManagementApiResourceWithHttpInfoAsync (CancellationToken cancellationToken = default(CancellationToken))
        {
