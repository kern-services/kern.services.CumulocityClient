...
namespace kern.services.CumulocityClient.Api
{
    ...
    /// </summary>
    public interface IDeviceControlAPIApi : IApiAccessor
    {
        ...
        ApiResponse<DeviceControlApiResource> GetDeviceControlApiResourceWithHttpInfo ();
        ...
        System.Threading.Tasks.Task<DeviceControlApiResource> GetDeviceControlApiResourceAsync (CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<DeviceControlApiResource>> GetDeviceControlApiResourceWithHttpInfoAsync (CancellationToken cancellationToken = default(CancellationToken));
    ...
    public partial class DeviceControlAPIApi : IDeviceControlAPIApi
    {
        ...
        /// <returns></returns>
        public DeviceControlAPIApi(kern.services.CumulocityClient.Client.Configuration configuration = null)
        {
        ...
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>DeviceControlApiResource</returns>
        public DeviceControlApiResource GetDeviceControlApiResource ()
        {
             ApiResponse<DeviceControlApiResource> localVarResponse = GetDeviceControlApiResourceWithHttpInfo();
        ...
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of DeviceControlApiResource</returns>
        public ApiResponse<DeviceControlApiResource> GetDeviceControlApiResourceWithHttpInfo ()
        {

            var localVarPath = "/devicecontrol";
            ...
            {
                Exception exception = ExceptionFactory("GetDeviceControlApiResource", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<DeviceControlApiResource>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (DeviceControlApiResource) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(DeviceControlApiResource)));
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of DeviceControlApiResource</returns>
        public async System.Threading.Tasks.Task<DeviceControlApiResource> GetDeviceControlApiResourceAsync (CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<DeviceControlApiResource> localVarResponse = await GetDeviceControlApiResourceWithHttpInfoAsync(cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (DeviceControlApiResource)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<DeviceControlApiResource>> GetDeviceControlApiResourceWithHttpInfoAsync (CancellationToken cancellationToken = default(CancellationToken))
        {
