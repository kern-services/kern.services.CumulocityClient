...
namespace kern.services.CumulocityClient.Api
{
    ...
    /// </summary>
    public interface IDeviceControlAPIApiSync : IApiAccessor
    {
        ...
        /// <returns>DeviceControlApiResource</returns>
        DeviceControlApiResource GetDeviceControlApiResource(int operationIndex = 0);
        ...
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of DeviceControlApiResource</returns>
        ApiResponse<DeviceControlApiResource> GetDeviceControlApiResourceWithHttpInfo(int operationIndex = 0);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IDeviceControlAPIApiAsync : IApiAccessor
    {
        ...
        /// <returns>Task of DeviceControlApiResource</returns>
        System.Threading.Tasks.Task<DeviceControlApiResource> GetDeviceControlApiResourceAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DeviceControlApiResource)</returns>
        System.Threading.Tasks.Task<ApiResponse<DeviceControlApiResource>> GetDeviceControlApiResourceWithHttpInfoAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IDeviceControlAPIApi : IDeviceControlAPIApiSync, IDeviceControlAPIApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class DeviceControlAPIApi : IDeviceControlAPIApi
    {
        private kern.services.CumulocityClient.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceControlAPIApi"/> class.
        /// </summary>
        /// <returns></returns>
        public DeviceControlAPIApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public DeviceControlAPIApi(string basePath)
        {
        ...
        /// <returns></returns>
        public DeviceControlAPIApi(kern.services.CumulocityClient.Client.Configuration configuration)
        {
        ...
        public DeviceControlAPIApi(kern.services.CumulocityClient.Client.ISynchronousClient client, kern.services.CumulocityClient.Client.IAsynchronousClient asyncClient, kern.services.CumulocityClient.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Retrieve URIs to collections of operations Retrieve URIs to collections of operations.  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_DEVICE_CONTROL_READ &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>DeviceControlApiResource</returns>
        public DeviceControlApiResource GetDeviceControlApiResource(int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<DeviceControlApiResource> localVarResponse = GetDeviceControlApiResourceWithHttpInfo();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of DeviceControlApiResource</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<DeviceControlApiResource> GetDeviceControlApiResourceWithHttpInfo(int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "DeviceControlAPIApi.GetDeviceControlApiResource";
            ...
            var localVarResponse = this.Client.Get<DeviceControlApiResource>("/devicecontrol", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetDeviceControlApiResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of DeviceControlApiResource</returns>
        public async System.Threading.Tasks.Task<DeviceControlApiResource> GetDeviceControlApiResourceAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<DeviceControlApiResource> localVarResponse = await GetDeviceControlApiResourceWithHttpInfoAsync(operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DeviceControlApiResource)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<DeviceControlApiResource>> GetDeviceControlApiResourceWithHttpInfoAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<DeviceControlApiResource>("/devicecontrol", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
