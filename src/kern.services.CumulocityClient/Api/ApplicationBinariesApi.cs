...
namespace kern.services.CumulocityClient.Api
{
    ...
    /// </summary>
    public interface IApplicationBinariesApiSync : IApiAccessor
    {
        ...
        /// <returns></returns>
        void DeleteBinaryApplicationContentResourceById(string id, string binaryId, int operationIndex = 0);
        ...
        ApiResponse<Object> DeleteBinaryApplicationContentResourceByIdWithHttpInfo(string id, string binaryId, int operationIndex = 0);
        /// <summary>
        ...
        /// <param name="id">Unique identifier of the application.</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApplicationBinaries</returns>
        ApplicationBinaries GetBinaryApplicationContentResource(string id, int operationIndex = 0);
        ...
        /// <param name="id">Unique identifier of the application.</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ApplicationBinaries</returns>
        ApiResponse<ApplicationBinaries> GetBinaryApplicationContentResourceWithHttpInfo(string id, int operationIndex = 0);
        /// <summary>
        ...
        System.IO.Stream GetBinaryApplicationContentResourceById(string id, string binaryId, int operationIndex = 0);
        ...
        ApiResponse<System.IO.Stream> GetBinaryApplicationContentResourceByIdWithHttpInfo(string id, string binaryId, int operationIndex = 0);
        /// <summary>
        ...
        Application PostBinaryApplicationContentResource(string id, System.IO.Stream file, string? accept = default(string?), int operationIndex = 0);
        ...
        ApiResponse<Application> PostBinaryApplicationContentResourceWithHttpInfo(string id, System.IO.Stream file, string? accept = default(string?), int operationIndex = 0);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IApplicationBinariesApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task DeleteBinaryApplicationContentResourceByIdAsync(string id, string binaryId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> DeleteBinaryApplicationContentResourceByIdWithHttpInfoAsync(string id, string binaryId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Retrieve all application attachments
        /// </summary>
        /// <remarks>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApplicationBinaries</returns>
        System.Threading.Tasks.Task<ApplicationBinaries> GetBinaryApplicationContentResourceAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ApplicationBinaries)</returns>
        System.Threading.Tasks.Task<ApiResponse<ApplicationBinaries>> GetBinaryApplicationContentResourceWithHttpInfoAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Retrieve a specific application attachment
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<System.IO.Stream> GetBinaryApplicationContentResourceByIdAsync(string id, string binaryId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<System.IO.Stream>> GetBinaryApplicationContentResourceByIdWithHttpInfoAsync(string id, string binaryId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Upload an application attachment
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<Application> PostBinaryApplicationContentResourceAsync(string id, System.IO.Stream file, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Application>> PostBinaryApplicationContentResourceWithHttpInfoAsync(string id, System.IO.Stream file, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IApplicationBinariesApi : IApplicationBinariesApiSync, IApplicationBinariesApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class ApplicationBinariesApi : IApplicationBinariesApi
    {
        private kern.services.CumulocityClient.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationBinariesApi"/> class.
        /// </summary>
        /// <returns></returns>
        public ApplicationBinariesApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public ApplicationBinariesApi(string basePath)
        {
        ...
        /// <returns></returns>
        public ApplicationBinariesApi(kern.services.CumulocityClient.Client.Configuration configuration)
        {
        ...
        public ApplicationBinariesApi(kern.services.CumulocityClient.Client.ISynchronousClient client, kern.services.CumulocityClient.Client.IAsynchronousClient asyncClient, kern.services.CumulocityClient.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Delete a specific application attachment Delete  a specific application attachment (by a given application ID and a given binary ID). This method is not supported by microservice applications.  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_APPLICATION_MANAGEMENT_ADMIN &lt;b&gt;AND&lt;/b&gt; tenant is the owner of the application &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">Unique identifier of the application.</param>
        /// <param name="binaryId">Unique identifier of the binary.</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns></returns>
        public void DeleteBinaryApplicationContentResourceById(string id, string binaryId, int operationIndex = 0)
        {
            DeleteBinaryApplicationContentResourceByIdWithHttpInfo(id, binaryId);
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<Object> DeleteBinaryApplicationContentResourceByIdWithHttpInfo(string id, string binaryId, int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'id' when calling ApplicationBinariesApi->DeleteBinaryApplicationContentResourceById");
            }

            // verify the required parameter 'binaryId' is set
            if (binaryId == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'binaryId' when calling ApplicationBinariesApi->DeleteBinaryApplicationContentResourceById");
            }
            ...
            localVarRequestOptions.PathParameters.Add("binaryId", kern.services.CumulocityClient.Client.ClientUtils.ParameterToString(binaryId)); // path parameter

            localVarRequestOptions.Operation = "ApplicationBinariesApi.DeleteBinaryApplicationContentResourceById";
            ...
            var localVarResponse = this.Client.Delete<Object>("/application/applications/{id}/binaries/{binaryId}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("DeleteBinaryApplicationContentResourceById", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task DeleteBinaryApplicationContentResourceByIdAsync(string id, string binaryId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await DeleteBinaryApplicationContentResourceByIdWithHttpInfoAsync(id, binaryId, operationIndex, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<Object>> DeleteBinaryApplicationContentResourceByIdWithHttpInfoAsync(string id, string binaryId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.DeleteAsync<Object>("/application/applications/{id}/binaries/{binaryId}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Retrieve all application attachments Retrieve all application attachments. This method is not supported by microservice applications.  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_APPLICATION_MANAGEMENT_ADMIN &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">Unique identifier of the application.</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApplicationBinaries</returns>
        public ApplicationBinaries GetBinaryApplicationContentResource(string id, int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<ApplicationBinaries> localVarResponse = GetBinaryApplicationContentResourceWithHttpInfo(id);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ApplicationBinaries</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<ApplicationBinaries> GetBinaryApplicationContentResourceWithHttpInfo(string id, int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'id' when calling ApplicationBinariesApi->GetBinaryApplicationContentResource");
            }
            ...
            localVarRequestOptions.Operation = "ApplicationBinariesApi.GetBinaryApplicationContentResource";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<ApplicationBinaries>("/application/applications/{id}/binaries", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetBinaryApplicationContentResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApplicationBinaries</returns>
        public async System.Threading.Tasks.Task<ApplicationBinaries> GetBinaryApplicationContentResourceAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<ApplicationBinaries> localVarResponse = await GetBinaryApplicationContentResourceWithHttpInfoAsync(id, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ApplicationBinaries)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<ApplicationBinaries>> GetBinaryApplicationContentResourceWithHttpInfoAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<ApplicationBinaries>("/application/applications/{id}/binaries", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Retrieve a specific application attachment Retrieve a specific application attachment (by a given application ID and a given binary ID). This method is not supported by microservice applications.  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_APPLICATION_MANAGEMENT_ADMIN &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">Unique identifier of the application.</param>
        /// <param name="binaryId">Unique identifier of the binary.</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>System.IO.Stream</returns>
        public System.IO.Stream GetBinaryApplicationContentResourceById(string id, string binaryId, int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<System.IO.Stream> localVarResponse = GetBinaryApplicationContentResourceByIdWithHttpInfo(id, binaryId);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of System.IO.Stream</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<System.IO.Stream> GetBinaryApplicationContentResourceByIdWithHttpInfo(string id, string binaryId, int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'id' when calling ApplicationBinariesApi->GetBinaryApplicationContentResourceById");
            }

            // verify the required parameter 'binaryId' is set
            if (binaryId == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'binaryId' when calling ApplicationBinariesApi->GetBinaryApplicationContentResourceById");
            }
            ...
            localVarRequestOptions.Operation = "ApplicationBinariesApi.GetBinaryApplicationContentResourceById";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<System.IO.Stream>("/application/applications/{id}/binaries/{binaryId}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetBinaryApplicationContentResourceById", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of System.IO.Stream</returns>
        public async System.Threading.Tasks.Task<System.IO.Stream> GetBinaryApplicationContentResourceByIdAsync(string id, string binaryId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<System.IO.Stream> localVarResponse = await GetBinaryApplicationContentResourceByIdWithHttpInfoAsync(id, binaryId, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (System.IO.Stream)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<System.IO.Stream>> GetBinaryApplicationContentResourceByIdWithHttpInfoAsync(string id, string binaryId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<System.IO.Stream>("/application/applications/{id}/binaries/{binaryId}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>Application</returns>
        public Application PostBinaryApplicationContentResource(string id, System.IO.Stream file, string? accept = default(string?), int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<Application> localVarResponse = PostBinaryApplicationContentResourceWithHttpInfo(id, file, accept);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Application</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<Application> PostBinaryApplicationContentResourceWithHttpInfo(string id, System.IO.Stream file, string? accept = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'id' when calling ApplicationBinariesApi->PostBinaryApplicationContentResource");
            }

            // verify the required parameter 'file' is set
            if (file == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'file' when calling ApplicationBinariesApi->PostBinaryApplicationContentResource");
            }
            ...
            localVarRequestOptions.Operation = "ApplicationBinariesApi.PostBinaryApplicationContentResource";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<Application>("/application/applications/{id}/binaries", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PostBinaryApplicationContentResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Application</returns>
        public async System.Threading.Tasks.Task<Application> PostBinaryApplicationContentResourceAsync(string id, System.IO.Stream file, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<Application> localVarResponse = await PostBinaryApplicationContentResourceWithHttpInfoAsync(id, file, accept, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Application)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<Application>> PostBinaryApplicationContentResourceWithHttpInfoAsync(string id, System.IO.Stream file, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<Application>("/application/applications/{id}/binaries", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
