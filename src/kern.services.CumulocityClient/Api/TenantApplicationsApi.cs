...
namespace kern.services.CumulocityClient.Api
{
    ...
    /// </summary>
    public interface ITenantApplicationsApiSync : IApiAccessor
    {
        ...
        /// <returns></returns>
        void DeleteTenantApplicationReferenceResource(string tenantId, string applicationId, int operationIndex = 0);
        ...
        ApiResponse<Object> DeleteTenantApplicationReferenceResourceWithHttpInfo(string tenantId, string applicationId, int operationIndex = 0);
        /// <summary>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApplicationReferenceCollection</returns>
        ApplicationReferenceCollection GetTenantApplicationReferenceCollectionResource(string tenantId, int? currentPage = default(int?), int? pageSize = default(int?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0);
        ...
        /// <param name="withTotalPages">When set to &#x60;true&#x60;, the returned result will contain in the statistics object the total number of pages. Only applicable on [range queries](https://en.wikipedia.org/wiki/Range_query_(database)). (optional, default to false)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ApplicationReferenceCollection</returns>
        ApiResponse<ApplicationReferenceCollection> GetTenantApplicationReferenceCollectionResourceWithHttpInfo(string tenantId, int? currentPage = default(int?), int? pageSize = default(int?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0);
        /// <summary>
        ...
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="tenantId">Unique identifier of a Cumulocity IoT tenant.</param>
        /// <param name="subscribedApplicationReference"></param>
        /// <param name="accept">Advertises which content types, expressed as MIME types, the client is able to understand. (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApplicationReference</returns>
        ApplicationReference PostTenantApplicationReferenceCollectionResource(string tenantId, SubscribedApplicationReference subscribedApplicationReference, string? accept = default(string?), int operationIndex = 0);
        ...
        /// <param name="accept">Advertises which content types, expressed as MIME types, the client is able to understand. (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ApplicationReference</returns>
        ApiResponse<ApplicationReference> PostTenantApplicationReferenceCollectionResourceWithHttpInfo(string tenantId, SubscribedApplicationReference subscribedApplicationReference, string? accept = default(string?), int operationIndex = 0);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ITenantApplicationsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task DeleteTenantApplicationReferenceResourceAsync(string tenantId, string applicationId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> DeleteTenantApplicationReferenceResourceWithHttpInfoAsync(string tenantId, string applicationId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Retrieve subscribed applications
        /// </summary>
        /// <remarks>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ApplicationReferenceCollection)</returns>
        System.Threading.Tasks.Task<ApiResponse<ApplicationReferenceCollection>> GetTenantApplicationReferenceCollectionResourceWithHttpInfoAsync(string tenantId, int? currentPage = default(int?), int? pageSize = default(int?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Subscribe to an application
        /// </summary>
        /// <remarks>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApplicationReference</returns>
        System.Threading.Tasks.Task<ApplicationReference> PostTenantApplicationReferenceCollectionResourceAsync(string tenantId, SubscribedApplicationReference subscribedApplicationReference, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ApplicationReference)</returns>
        System.Threading.Tasks.Task<ApiResponse<ApplicationReference>> PostTenantApplicationReferenceCollectionResourceWithHttpInfoAsync(string tenantId, SubscribedApplicationReference subscribedApplicationReference, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ITenantApplicationsApi : ITenantApplicationsApiSync, ITenantApplicationsApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class TenantApplicationsApi : ITenantApplicationsApi
    {
        private kern.services.CumulocityClient.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="TenantApplicationsApi"/> class.
        /// </summary>
        /// <returns></returns>
        public TenantApplicationsApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public TenantApplicationsApi(string basePath)
        {
        ...
        /// <returns></returns>
        public TenantApplicationsApi(kern.services.CumulocityClient.Client.Configuration configuration)
        {
        ...
        public TenantApplicationsApi(kern.services.CumulocityClient.Client.ISynchronousClient client, kern.services.CumulocityClient.Client.IAsynchronousClient asyncClient, kern.services.CumulocityClient.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns></returns>
        public void DeleteTenantApplicationReferenceResource(string tenantId, string applicationId, int operationIndex = 0)
        {
            DeleteTenantApplicationReferenceResourceWithHttpInfo(tenantId, applicationId);
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<Object> DeleteTenantApplicationReferenceResourceWithHttpInfo(string tenantId, string applicationId, int operationIndex = 0)
        {
            // verify the required parameter 'tenantId' is set
            if (tenantId == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'tenantId' when calling TenantApplicationsApi->DeleteTenantApplicationReferenceResource");
            }

            // verify the required parameter 'applicationId' is set
            if (applicationId == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'applicationId' when calling TenantApplicationsApi->DeleteTenantApplicationReferenceResource");
            }
            ...
            localVarRequestOptions.PathParameters.Add("applicationId", kern.services.CumulocityClient.Client.ClientUtils.ParameterToString(applicationId)); // path parameter

            localVarRequestOptions.Operation = "TenantApplicationsApi.DeleteTenantApplicationReferenceResource";
            ...
            var localVarResponse = this.Client.Delete<Object>("/tenant/tenants/{tenantId}/applications/{applicationId}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("DeleteTenantApplicationReferenceResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task DeleteTenantApplicationReferenceResourceAsync(string tenantId, string applicationId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await DeleteTenantApplicationReferenceResourceWithHttpInfoAsync(tenantId, applicationId, operationIndex, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<Object>> DeleteTenantApplicationReferenceResourceWithHttpInfoAsync(string tenantId, string applicationId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'tenantId' is set
            if (tenantId == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.DeleteAsync<Object>("/tenant/tenants/{tenantId}/applications/{applicationId}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Retrieve subscribed applications Retrieve the tenant subscribed applications by a given tenant ID.  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; (ROLE_TENANT_MANAGEMENT_READ &lt;b&gt;OR&lt;/b&gt; ROLE_TENANT_ADMIN) &lt;b&gt;AND&lt;/b&gt; (the current tenant is its parent &lt;b&gt;OR&lt;/b&gt; is the management tenant) &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="tenantId">Unique identifier of a Cumulocity IoT tenant.</param>
        /// <param name="currentPage">The current page of the paginated results. (optional, default to 1)</param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApplicationReferenceCollection</returns>
        public ApplicationReferenceCollection GetTenantApplicationReferenceCollectionResource(string tenantId, int? currentPage = default(int?), int? pageSize = default(int?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<ApplicationReferenceCollection> localVarResponse = GetTenantApplicationReferenceCollectionResourceWithHttpInfo(tenantId, currentPage, pageSize, withTotalElements, withTotalPages);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ApplicationReferenceCollection</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<ApplicationReferenceCollection> GetTenantApplicationReferenceCollectionResourceWithHttpInfo(string tenantId, int? currentPage = default(int?), int? pageSize = default(int?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0)
        {
            // verify the required parameter 'tenantId' is set
            if (tenantId == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'tenantId' when calling TenantApplicationsApi->GetTenantApplicationReferenceCollectionResource");
            }
            ...
            localVarRequestOptions.Operation = "TenantApplicationsApi.GetTenantApplicationReferenceCollectionResource";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<ApplicationReferenceCollection>("/tenant/tenants/{tenantId}/applications", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetTenantApplicationReferenceCollectionResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApplicationReferenceCollection</returns>
        public async System.Threading.Tasks.Task<ApplicationReferenceCollection> GetTenantApplicationReferenceCollectionResourceAsync(string tenantId, int? currentPage = default(int?), int? pageSize = default(int?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<ApplicationReferenceCollection> localVarResponse = await GetTenantApplicationReferenceCollectionResourceWithHttpInfoAsync(tenantId, currentPage, pageSize, withTotalElements, withTotalPages, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ApplicationReferenceCollection)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<ApplicationReferenceCollection>> GetTenantApplicationReferenceCollectionResourceWithHttpInfoAsync(string tenantId, int? currentPage = default(int?), int? pageSize = default(int?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'tenantId' is set
            if (tenantId == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<ApplicationReferenceCollection>("/tenant/tenants/{tenantId}/applications", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApplicationReference</returns>
        public ApplicationReference PostTenantApplicationReferenceCollectionResource(string tenantId, SubscribedApplicationReference subscribedApplicationReference, string? accept = default(string?), int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<ApplicationReference> localVarResponse = PostTenantApplicationReferenceCollectionResourceWithHttpInfo(tenantId, subscribedApplicationReference, accept);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ApplicationReference</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<ApplicationReference> PostTenantApplicationReferenceCollectionResourceWithHttpInfo(string tenantId, SubscribedApplicationReference subscribedApplicationReference, string? accept = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'tenantId' is set
            if (tenantId == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'tenantId' when calling TenantApplicationsApi->PostTenantApplicationReferenceCollectionResource");
            }

            // verify the required parameter 'subscribedApplicationReference' is set
            if (subscribedApplicationReference == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'subscribedApplicationReference' when calling TenantApplicationsApi->PostTenantApplicationReferenceCollectionResource");
            }
            ...
            localVarRequestOptions.Data = subscribedApplicationReference;

            localVarRequestOptions.Operation = "TenantApplicationsApi.PostTenantApplicationReferenceCollectionResource";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<ApplicationReference>("/tenant/tenants/{tenantId}/applications", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PostTenantApplicationReferenceCollectionResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApplicationReference</returns>
        public async System.Threading.Tasks.Task<ApplicationReference> PostTenantApplicationReferenceCollectionResourceAsync(string tenantId, SubscribedApplicationReference subscribedApplicationReference, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<ApplicationReference> localVarResponse = await PostTenantApplicationReferenceCollectionResourceWithHttpInfoAsync(tenantId, subscribedApplicationReference, accept, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ApplicationReference)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<ApplicationReference>> PostTenantApplicationReferenceCollectionResourceWithHttpInfoAsync(string tenantId, SubscribedApplicationReference subscribedApplicationReference, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'tenantId' is set
            if (tenantId == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<ApplicationReference>("/tenant/tenants/{tenantId}/applications", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
