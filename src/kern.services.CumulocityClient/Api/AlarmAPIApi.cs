...
namespace kern.services.CumulocityClient.Api
{
    ...
    /// </summary>
    public interface IAlarmAPIApi : IApiAccessor
    {
        ...
        ApiResponse<AlarmsApiResource> GetAlarmsApiResourceWithHttpInfo ();
        ...
        System.Threading.Tasks.Task<AlarmsApiResource> GetAlarmsApiResourceAsync (CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<AlarmsApiResource>> GetAlarmsApiResourceWithHttpInfoAsync (CancellationToken cancellationToken = default(CancellationToken));
    ...
    public partial class AlarmAPIApi : IAlarmAPIApi
    {
        ...
        /// <returns></returns>
        public AlarmAPIApi(kern.services.CumulocityClient.Client.Configuration configuration = null)
        {
        ...
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>AlarmsApiResource</returns>
        public AlarmsApiResource GetAlarmsApiResource ()
        {
             ApiResponse<AlarmsApiResource> localVarResponse = GetAlarmsApiResourceWithHttpInfo();
        ...
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of AlarmsApiResource</returns>
        public ApiResponse<AlarmsApiResource> GetAlarmsApiResourceWithHttpInfo ()
        {

            var localVarPath = "/alarm";
            ...
            {
                Exception exception = ExceptionFactory("GetAlarmsApiResource", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<AlarmsApiResource>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (AlarmsApiResource) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(AlarmsApiResource)));
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of AlarmsApiResource</returns>
        public async System.Threading.Tasks.Task<AlarmsApiResource> GetAlarmsApiResourceAsync (CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<AlarmsApiResource> localVarResponse = await GetAlarmsApiResourceWithHttpInfoAsync(cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (AlarmsApiResource)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<AlarmsApiResource>> GetAlarmsApiResourceWithHttpInfoAsync (CancellationToken cancellationToken = default(CancellationToken))
        {
