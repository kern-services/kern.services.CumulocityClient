...
namespace kern.services.CumulocityClient.Api
{
    ...
    /// </summary>
    public interface IAlarmAPIApiSync : IApiAccessor
    {
        ...
        /// <returns>AlarmsApiResource</returns>
        AlarmsApiResource GetAlarmsApiResource(int operationIndex = 0);
        ...
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of AlarmsApiResource</returns>
        ApiResponse<AlarmsApiResource> GetAlarmsApiResourceWithHttpInfo(int operationIndex = 0);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlarmAPIApiAsync : IApiAccessor
    {
        ...
        /// <returns>Task of AlarmsApiResource</returns>
        System.Threading.Tasks.Task<AlarmsApiResource> GetAlarmsApiResourceAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (AlarmsApiResource)</returns>
        System.Threading.Tasks.Task<ApiResponse<AlarmsApiResource>> GetAlarmsApiResourceWithHttpInfoAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IAlarmAPIApi : IAlarmAPIApiSync, IAlarmAPIApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class AlarmAPIApi : IAlarmAPIApi
    {
        private kern.services.CumulocityClient.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="AlarmAPIApi"/> class.
        /// </summary>
        /// <returns></returns>
        public AlarmAPIApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public AlarmAPIApi(string basePath)
        {
        ...
        /// <returns></returns>
        public AlarmAPIApi(kern.services.CumulocityClient.Client.Configuration configuration)
        {
        ...
        public AlarmAPIApi(kern.services.CumulocityClient.Client.ISynchronousClient client, kern.services.CumulocityClient.Client.IAsynchronousClient asyncClient, kern.services.CumulocityClient.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Retrieve URIs to collections of alarms Retrieve URIs and URI templates to collections of alarms.  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_ALARM_READ &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>AlarmsApiResource</returns>
        public AlarmsApiResource GetAlarmsApiResource(int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<AlarmsApiResource> localVarResponse = GetAlarmsApiResourceWithHttpInfo();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of AlarmsApiResource</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<AlarmsApiResource> GetAlarmsApiResourceWithHttpInfo(int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "AlarmAPIApi.GetAlarmsApiResource";
            ...
            var localVarResponse = this.Client.Get<AlarmsApiResource>("/alarm", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetAlarmsApiResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of AlarmsApiResource</returns>
        public async System.Threading.Tasks.Task<AlarmsApiResource> GetAlarmsApiResourceAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<AlarmsApiResource> localVarResponse = await GetAlarmsApiResourceWithHttpInfoAsync(operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (AlarmsApiResource)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<AlarmsApiResource>> GetAlarmsApiResourceWithHttpInfoAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<AlarmsApiResource>("/alarm", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
