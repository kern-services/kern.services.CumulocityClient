...
namespace kern.services.CumulocityClient.Api
{
    ...
    /// </summary>
    public interface IInventoryAPIApiSync : IApiAccessor
    {
        ...
        /// <returns>InventoryApiResource</returns>
        InventoryApiResource GetInventoryApiResource(int operationIndex = 0);
        ...
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of InventoryApiResource</returns>
        ApiResponse<InventoryApiResource> GetInventoryApiResourceWithHttpInfo(int operationIndex = 0);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IInventoryAPIApiAsync : IApiAccessor
    {
        ...
        /// <returns>Task of InventoryApiResource</returns>
        System.Threading.Tasks.Task<InventoryApiResource> GetInventoryApiResourceAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (InventoryApiResource)</returns>
        System.Threading.Tasks.Task<ApiResponse<InventoryApiResource>> GetInventoryApiResourceWithHttpInfoAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IInventoryAPIApi : IInventoryAPIApiSync, IInventoryAPIApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class InventoryAPIApi : IInventoryAPIApi
    {
        private kern.services.CumulocityClient.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="InventoryAPIApi"/> class.
        /// </summary>
        /// <returns></returns>
        public InventoryAPIApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public InventoryAPIApi(string basePath)
        {
        ...
        /// <returns></returns>
        public InventoryAPIApi(kern.services.CumulocityClient.Client.Configuration configuration)
        {
        ...
        public InventoryAPIApi(kern.services.CumulocityClient.Client.ISynchronousClient client, kern.services.CumulocityClient.Client.IAsynchronousClient asyncClient, kern.services.CumulocityClient.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Retrieve URIs to collections of managed objects Retrieve URIs and URI templates to collections of managed objects.  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_INVENTORY_READ &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>InventoryApiResource</returns>
        public InventoryApiResource GetInventoryApiResource(int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<InventoryApiResource> localVarResponse = GetInventoryApiResourceWithHttpInfo();
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of InventoryApiResource</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<InventoryApiResource> GetInventoryApiResourceWithHttpInfo(int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "InventoryAPIApi.GetInventoryApiResource";
            ...
            var localVarResponse = this.Client.Get<InventoryApiResource>("/inventory", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetInventoryApiResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of InventoryApiResource</returns>
        public async System.Threading.Tasks.Task<InventoryApiResource> GetInventoryApiResourceAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<InventoryApiResource> localVarResponse = await GetInventoryApiResourceWithHttpInfoAsync(operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (InventoryApiResource)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<InventoryApiResource>> GetInventoryApiResourceWithHttpInfoAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<InventoryApiResource>("/inventory", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
