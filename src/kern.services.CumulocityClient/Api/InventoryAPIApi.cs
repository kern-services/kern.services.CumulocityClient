...
namespace kern.services.CumulocityClient.Api
{
    ...
    /// </summary>
    public interface IInventoryAPIApi : IApiAccessor
    {
        ...
        ApiResponse<InventoryApiResource> GetInventoryApiResourceWithHttpInfo ();
        ...
        System.Threading.Tasks.Task<InventoryApiResource> GetInventoryApiResourceAsync (CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<InventoryApiResource>> GetInventoryApiResourceWithHttpInfoAsync (CancellationToken cancellationToken = default(CancellationToken));
    ...
    public partial class InventoryAPIApi : IInventoryAPIApi
    {
        ...
        /// <returns></returns>
        public InventoryAPIApi(kern.services.CumulocityClient.Client.Configuration configuration = null)
        {
        ...
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>InventoryApiResource</returns>
        public InventoryApiResource GetInventoryApiResource ()
        {
             ApiResponse<InventoryApiResource> localVarResponse = GetInventoryApiResourceWithHttpInfo();
        ...
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of InventoryApiResource</returns>
        public ApiResponse<InventoryApiResource> GetInventoryApiResourceWithHttpInfo ()
        {
            ...
            {
                Exception exception = ExceptionFactory("GetInventoryApiResource", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<InventoryApiResource>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (InventoryApiResource) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(InventoryApiResource)));
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of InventoryApiResource</returns>
        public async System.Threading.Tasks.Task<InventoryApiResource> GetInventoryApiResourceAsync (CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<InventoryApiResource> localVarResponse = await GetInventoryApiResourceWithHttpInfoAsync(cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (InventoryApiResource)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<InventoryApiResource>> GetInventoryApiResourceWithHttpInfoAsync (CancellationToken cancellationToken = default(CancellationToken))
        {
