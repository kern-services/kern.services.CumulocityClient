...
namespace kern.services.CumulocityClient.Api
{
    ...
    /// </summary>
    public interface ILoginOptionsApi : IApiAccessor
    {
        ...
        LoginOptionCollection GetLoginOptionCollectionResource (bool? management = default(bool?), string tenantId = default(string));
        ...
        ApiResponse<LoginOptionCollection> GetLoginOptionCollectionResourceWithHttpInfo (bool? management = default(bool?), string tenantId = default(string));
        /// <summary>
        ...
        AuthConfig PostLoginOptionCollectionResource (AuthConfig authConfig, string accept = default(string));
        ...
        ApiResponse<AuthConfig> PostLoginOptionCollectionResourceWithHttpInfo (AuthConfig authConfig, string accept = default(string));
        /// <summary>
        ...
        /// <param name="accept">Advertises which content types, expressed as MIME types, the client is able to understand. (optional)</param>
        /// <returns>AuthConfig</returns>
        AuthConfig PutAccessLoginOptionResource (string typeOrId, string targetTenant, AuthConfigAccess authConfigAccess, string accept = default(string));
        ...
        /// <param name="accept">Advertises which content types, expressed as MIME types, the client is able to understand. (optional)</param>
        /// <returns>ApiResponse of AuthConfig</returns>
        ApiResponse<AuthConfig> PutAccessLoginOptionResourceWithHttpInfo (string typeOrId, string targetTenant, AuthConfigAccess authConfigAccess, string accept = default(string));
        ...
        System.Threading.Tasks.Task<LoginOptionCollection> GetLoginOptionCollectionResourceAsync (bool? management = default(bool?), string tenantId = default(string), CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<LoginOptionCollection>> GetLoginOptionCollectionResourceWithHttpInfoAsync (bool? management = default(bool?), string tenantId = default(string), CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Create a login option
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<AuthConfig> PostLoginOptionCollectionResourceAsync (AuthConfig authConfig, string accept = default(string), CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<AuthConfig>> PostLoginOptionCollectionResourceWithHttpInfoAsync (AuthConfig authConfig, string accept = default(string), CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Update a tenant's access to the login option
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of AuthConfig</returns>
        System.Threading.Tasks.Task<AuthConfig> PutAccessLoginOptionResourceAsync (string typeOrId, string targetTenant, AuthConfigAccess authConfigAccess, string accept = default(string), CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (AuthConfig)</returns>
        System.Threading.Tasks.Task<ApiResponse<AuthConfig>> PutAccessLoginOptionResourceWithHttpInfoAsync (string typeOrId, string targetTenant, AuthConfigAccess authConfigAccess, string accept = default(string), CancellationToken cancellationToken = default(CancellationToken));
    ...
    public partial class LoginOptionsApi : ILoginOptionsApi
    {
        ...
        /// <returns></returns>
        public LoginOptionsApi(kern.services.CumulocityClient.Client.Configuration configuration = null)
        {
        ...
        /// <param name="tenantId">Unique identifier of a Cumulocity IoT tenant. (optional)</param>
        /// <returns>LoginOptionCollection</returns>
        public LoginOptionCollection GetLoginOptionCollectionResource (bool? management = default(bool?), string tenantId = default(string))
        {
             ApiResponse<LoginOptionCollection> localVarResponse = GetLoginOptionCollectionResourceWithHttpInfo(management, tenantId);
        ...
        /// <param name="tenantId">Unique identifier of a Cumulocity IoT tenant. (optional)</param>
        /// <returns>ApiResponse of LoginOptionCollection</returns>
        public ApiResponse<LoginOptionCollection> GetLoginOptionCollectionResourceWithHttpInfo (bool? management = default(bool?), string tenantId = default(string))
        {

            var localVarPath = "/tenant/loginOptions";
            ...
            if (management != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("", "management", management)); // query parameter
            ...
            {
                Exception exception = ExceptionFactory("GetLoginOptionCollectionResource", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<LoginOptionCollection>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (LoginOptionCollection) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(LoginOptionCollection)));
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of LoginOptionCollection</returns>
        public async System.Threading.Tasks.Task<LoginOptionCollection> GetLoginOptionCollectionResourceAsync (bool? management = default(bool?), string tenantId = default(string), CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<LoginOptionCollection> localVarResponse = await GetLoginOptionCollectionResourceWithHttpInfoAsync(management, tenantId, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (LoginOptionCollection)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<LoginOptionCollection>> GetLoginOptionCollectionResourceWithHttpInfoAsync (bool? management = default(bool?), string tenantId = default(string), CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <param name="accept">Advertises which content types, expressed as MIME types, the client is able to understand. (optional)</param>
        /// <returns>AuthConfig</returns>
        public AuthConfig PostLoginOptionCollectionResource (AuthConfig authConfig, string accept = default(string))
        {
             ApiResponse<AuthConfig> localVarResponse = PostLoginOptionCollectionResourceWithHttpInfo(authConfig, accept);
             return localVarResponse.Data;
        }
        ...
        /// <param name="accept">Advertises which content types, expressed as MIME types, the client is able to understand. (optional)</param>
        /// <returns>ApiResponse of AuthConfig</returns>
        public ApiResponse<AuthConfig> PostLoginOptionCollectionResourceWithHttpInfo (AuthConfig authConfig, string accept = default(string))
        {
            // verify the required parameter 'authConfig' is set
            if (authConfig == null)
                throw new ApiException(400, "Missing required parameter 'authConfig' when calling LoginOptionsApi->PostLoginOptionCollectionResource");
            ...
            if (authConfig != null && authConfig.GetType() != typeof(byte[]))
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(authConfig); // http body (model) parameter
            }
            else
            {
                localVarPostBody = authConfig; // byte array
            }
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("PostLoginOptionCollectionResource", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<AuthConfig>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (AuthConfig) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(AuthConfig)));
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of AuthConfig</returns>
        public async System.Threading.Tasks.Task<AuthConfig> PostLoginOptionCollectionResourceAsync (AuthConfig authConfig, string accept = default(string), CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<AuthConfig> localVarResponse = await PostLoginOptionCollectionResourceWithHttpInfoAsync(authConfig, accept, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (AuthConfig)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<AuthConfig>> PostLoginOptionCollectionResourceWithHttpInfoAsync (AuthConfig authConfig, string accept = default(string), CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'authConfig' is set
            if (authConfig == null)
                throw new ApiException(400, "Missing required parameter 'authConfig' when calling LoginOptionsApi->PostLoginOptionCollectionResource");
        ...
        /// <param name="accept">Advertises which content types, expressed as MIME types, the client is able to understand. (optional)</param>
        /// <returns>AuthConfig</returns>
        public AuthConfig PutAccessLoginOptionResource (string typeOrId, string targetTenant, AuthConfigAccess authConfigAccess, string accept = default(string))
        {
             ApiResponse<AuthConfig> localVarResponse = PutAccessLoginOptionResourceWithHttpInfo(typeOrId, targetTenant, authConfigAccess, accept);
             return localVarResponse.Data;
        }
        ...
        /// <param name="accept">Advertises which content types, expressed as MIME types, the client is able to understand. (optional)</param>
        /// <returns>ApiResponse of AuthConfig</returns>
        public ApiResponse<AuthConfig> PutAccessLoginOptionResourceWithHttpInfo (string typeOrId, string targetTenant, AuthConfigAccess authConfigAccess, string accept = default(string))
        {
            // verify the required parameter 'typeOrId' is set
            if (typeOrId == null)
                throw new ApiException(400, "Missing required parameter 'typeOrId' when calling LoginOptionsApi->PutAccessLoginOptionResource");
            // verify the required parameter 'targetTenant' is set
            if (targetTenant == null)
                throw new ApiException(400, "Missing required parameter 'targetTenant' when calling LoginOptionsApi->PutAccessLoginOptionResource");
            // verify the required parameter 'authConfigAccess' is set
            if (authConfigAccess == null)
                throw new ApiException(400, "Missing required parameter 'authConfigAccess' when calling LoginOptionsApi->PutAccessLoginOptionResource");

            var localVarPath = "/tenant/loginOptions/{type_or_id}/restrict";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (typeOrId != null) localVarPathParams.Add("type_or_id", this.Configuration.ApiClient.ParameterToString(typeOrId)); // path parameter
            if (targetTenant != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("", "targetTenant", targetTenant)); // query parameter
            if (accept != null) localVarHeaderParams.Add("Accept", this.Configuration.ApiClient.ParameterToString(accept)); // header parameter
            if (authConfigAccess != null && authConfigAccess.GetType() != typeof(byte[]))
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(authConfigAccess); // http body (model) parameter
            }
            else
            {
                localVarPostBody = authConfigAccess; // byte array
            }
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("PutAccessLoginOptionResource", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of AuthConfig</returns>
        public async System.Threading.Tasks.Task<AuthConfig> PutAccessLoginOptionResourceAsync (string typeOrId, string targetTenant, AuthConfigAccess authConfigAccess, string accept = default(string), CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<AuthConfig> localVarResponse = await PutAccessLoginOptionResourceWithHttpInfoAsync(typeOrId, targetTenant, authConfigAccess, accept, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (AuthConfig)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<AuthConfig>> PutAccessLoginOptionResourceWithHttpInfoAsync (string typeOrId, string targetTenant, AuthConfigAccess authConfigAccess, string accept = default(string), CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'typeOrId' is set
            if (typeOrId == null)
                throw new ApiException(400, "Missing required parameter 'typeOrId' when calling LoginOptionsApi->PutAccessLoginOptionResource");
