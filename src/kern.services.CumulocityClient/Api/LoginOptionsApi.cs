...
namespace kern.services.CumulocityClient.Api
{
    ...
    /// </summary>
    public interface ILoginOptionsApiSync : IApiAccessor
    {
        ...
        /// <param name="management">If this is set to &#x60;true&#x60;, the management tenant login options will be returned.  &gt; **&amp;#9432; Info:** The &#x60;tenantId&#x60; parameter must not be present in the request when using the &#x60;management&#x60; parameter, otherwise it will cause an error.  (optional, default to false)</param>
        /// <param name="tenantId">Unique identifier of a Cumulocity IoT tenant. (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>LoginOptionCollection</returns>
        LoginOptionCollection GetLoginOptionCollectionResource(bool? management = default(bool?), string? tenantId = default(string?), int operationIndex = 0);
        ...
        /// <param name="tenantId">Unique identifier of a Cumulocity IoT tenant. (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of LoginOptionCollection</returns>
        ApiResponse<LoginOptionCollection> GetLoginOptionCollectionResourceWithHttpInfo(bool? management = default(bool?), string? tenantId = default(string?), int operationIndex = 0);
        /// <summary>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>AuthConfig</returns>
        AuthConfig PostLoginOptionCollectionResource(AuthConfig authConfig, string? accept = default(string?), int operationIndex = 0);
        ...
        /// <param name="accept">Advertises which content types, expressed as MIME types, the client is able to understand. (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of AuthConfig</returns>
        ApiResponse<AuthConfig> PostLoginOptionCollectionResourceWithHttpInfo(AuthConfig authConfig, string? accept = default(string?), int operationIndex = 0);
        /// <summary>
        ...
        /// <param name="authConfigAccess"></param>
        /// <param name="accept">Advertises which content types, expressed as MIME types, the client is able to understand. (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>AuthConfig</returns>
        AuthConfig PutAccessLoginOptionResource(string typeOrId, string targetTenant, AuthConfigAccess authConfigAccess, string? accept = default(string?), int operationIndex = 0);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of AuthConfig</returns>
        ApiResponse<AuthConfig> PutAccessLoginOptionResourceWithHttpInfo(string typeOrId, string targetTenant, AuthConfigAccess authConfigAccess, string? accept = default(string?), int operationIndex = 0);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ILoginOptionsApiAsync : IApiAccessor
    {
        ...
        /// <returns>Task of LoginOptionCollection</returns>
        System.Threading.Tasks.Task<LoginOptionCollection> GetLoginOptionCollectionResourceAsync(bool? management = default(bool?), string? tenantId = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (LoginOptionCollection)</returns>
        System.Threading.Tasks.Task<ApiResponse<LoginOptionCollection>> GetLoginOptionCollectionResourceWithHttpInfoAsync(bool? management = default(bool?), string? tenantId = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Create a login option
        /// </summary>
        /// <remarks>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of AuthConfig</returns>
        System.Threading.Tasks.Task<AuthConfig> PostLoginOptionCollectionResourceAsync(AuthConfig authConfig, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (AuthConfig)</returns>
        System.Threading.Tasks.Task<ApiResponse<AuthConfig>> PostLoginOptionCollectionResourceWithHttpInfoAsync(AuthConfig authConfig, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Update a tenant&#39;s access to the login option
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of AuthConfig</returns>
        System.Threading.Tasks.Task<AuthConfig> PutAccessLoginOptionResourceAsync(string typeOrId, string targetTenant, AuthConfigAccess authConfigAccess, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (AuthConfig)</returns>
        System.Threading.Tasks.Task<ApiResponse<AuthConfig>> PutAccessLoginOptionResourceWithHttpInfoAsync(string typeOrId, string targetTenant, AuthConfigAccess authConfigAccess, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface ILoginOptionsApi : ILoginOptionsApiSync, ILoginOptionsApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class LoginOptionsApi : ILoginOptionsApi
    {
        private kern.services.CumulocityClient.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="LoginOptionsApi"/> class.
        /// </summary>
        /// <returns></returns>
        public LoginOptionsApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public LoginOptionsApi(string basePath)
        {
        ...
        /// <returns></returns>
        public LoginOptionsApi(kern.services.CumulocityClient.Client.Configuration configuration)
        {
        ...
        public LoginOptionsApi(kern.services.CumulocityClient.Client.ISynchronousClient client, kern.services.CumulocityClient.Client.IAsynchronousClient asyncClient, kern.services.CumulocityClient.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Retrieve the login options Retrieve the login options available in the tenant.
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="management">If this is set to &#x60;true&#x60;, the management tenant login options will be returned.  &gt; **&amp;#9432; Info:** The &#x60;tenantId&#x60; parameter must not be present in the request when using the &#x60;management&#x60; parameter, otherwise it will cause an error.  (optional, default to false)</param>
        /// <param name="tenantId">Unique identifier of a Cumulocity IoT tenant. (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>LoginOptionCollection</returns>
        public LoginOptionCollection GetLoginOptionCollectionResource(bool? management = default(bool?), string? tenantId = default(string?), int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<LoginOptionCollection> localVarResponse = GetLoginOptionCollectionResourceWithHttpInfo(management, tenantId);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of LoginOptionCollection</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<LoginOptionCollection> GetLoginOptionCollectionResourceWithHttpInfo(bool? management = default(bool?), string? tenantId = default(string?), int operationIndex = 0)
        {
            ...
            if (management != null)
            {
                localVarRequestOptions.QueryParameters.Add(kern.services.CumulocityClient.Client.ClientUtils.ParameterToMultiMap("", "management", management));
            }
            if (tenantId != null)
            {
                localVarRequestOptions.QueryParameters.Add(kern.services.CumulocityClient.Client.ClientUtils.ParameterToMultiMap("", "tenantId", tenantId));
            }

            localVarRequestOptions.Operation = "LoginOptionsApi.GetLoginOptionCollectionResource";
            localVarRequestOptions.OperationIndex = operationIndex;


            // make the HTTP request
            var localVarResponse = this.Client.Get<LoginOptionCollection>("/tenant/loginOptions", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetLoginOptionCollectionResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of LoginOptionCollection</returns>
        public async System.Threading.Tasks.Task<LoginOptionCollection> GetLoginOptionCollectionResourceAsync(bool? management = default(bool?), string? tenantId = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<LoginOptionCollection> localVarResponse = await GetLoginOptionCollectionResourceWithHttpInfoAsync(management, tenantId, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (LoginOptionCollection)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<LoginOptionCollection>> GetLoginOptionCollectionResourceWithHttpInfoAsync(bool? management = default(bool?), string? tenantId = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<LoginOptionCollection>("/tenant/loginOptions", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Create a login option Create an authentication configuration on your tenant.  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_TENANT_ADMIN &lt;b&gt;OR&lt;/b&gt; ROLE_TENANT_MANAGEMENT_ADMIN &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="authConfig"></param>
        /// <param name="accept">Advertises which content types, expressed as MIME types, the client is able to understand. (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>AuthConfig</returns>
        public AuthConfig PostLoginOptionCollectionResource(AuthConfig authConfig, string? accept = default(string?), int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<AuthConfig> localVarResponse = PostLoginOptionCollectionResourceWithHttpInfo(authConfig, accept);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of AuthConfig</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<AuthConfig> PostLoginOptionCollectionResourceWithHttpInfo(AuthConfig authConfig, string? accept = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'authConfig' is set
            if (authConfig == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'authConfig' when calling LoginOptionsApi->PostLoginOptionCollectionResource");
            }
            ...
            localVarRequestOptions.Data = authConfig;

            localVarRequestOptions.Operation = "LoginOptionsApi.PostLoginOptionCollectionResource";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<AuthConfig>("/tenant/loginOptions", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PostLoginOptionCollectionResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of AuthConfig</returns>
        public async System.Threading.Tasks.Task<AuthConfig> PostLoginOptionCollectionResourceAsync(AuthConfig authConfig, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<AuthConfig> localVarResponse = await PostLoginOptionCollectionResourceWithHttpInfoAsync(authConfig, accept, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (AuthConfig)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<AuthConfig>> PostLoginOptionCollectionResourceWithHttpInfoAsync(AuthConfig authConfig, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'authConfig' is set
            if (authConfig == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<AuthConfig>("/tenant/loginOptions", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Update a tenant&#39;s access to the login option Update the tenant&#39;s access to the authentication configuration.  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_TENANT_MANAGEMENT_ADMIN &lt;b&gt;AND&lt;/b&gt; is the management tenant &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="typeOrId">The type or ID of the login option. The type&#39;s value is case insensitive and can be &#x60;OAUTH2&#x60;, &#x60;OAUTH2_INTERNAL&#x60; or &#x60;BASIC&#x60;.</param>
        /// <param name="targetTenant">Unique identifier of a Cumulocity IoT tenant.</param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>AuthConfig</returns>
        public AuthConfig PutAccessLoginOptionResource(string typeOrId, string targetTenant, AuthConfigAccess authConfigAccess, string? accept = default(string?), int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<AuthConfig> localVarResponse = PutAccessLoginOptionResourceWithHttpInfo(typeOrId, targetTenant, authConfigAccess, accept);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of AuthConfig</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<AuthConfig> PutAccessLoginOptionResourceWithHttpInfo(string typeOrId, string targetTenant, AuthConfigAccess authConfigAccess, string? accept = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'typeOrId' is set
            if (typeOrId == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'typeOrId' when calling LoginOptionsApi->PutAccessLoginOptionResource");
            }

            // verify the required parameter 'targetTenant' is set
            if (targetTenant == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'targetTenant' when calling LoginOptionsApi->PutAccessLoginOptionResource");
            }

            // verify the required parameter 'authConfigAccess' is set
            if (authConfigAccess == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'authConfigAccess' when calling LoginOptionsApi->PutAccessLoginOptionResource");
            }
            ...
            localVarRequestOptions.PathParameters.Add("type_or_id", kern.services.CumulocityClient.Client.ClientUtils.ParameterToString(typeOrId)); // path parameter
            localVarRequestOptions.QueryParameters.Add(kern.services.CumulocityClient.Client.ClientUtils.ParameterToMultiMap("", "targetTenant", targetTenant));
            if (accept != null)
            {
                localVarRequestOptions.HeaderParameters.Add("Accept", kern.services.CumulocityClient.Client.ClientUtils.ParameterToString(accept)); // header parameter
            }
            localVarRequestOptions.Data = authConfigAccess;

            localVarRequestOptions.Operation = "LoginOptionsApi.PutAccessLoginOptionResource";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Put<AuthConfig>("/tenant/loginOptions/{type_or_id}/restrict", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PutAccessLoginOptionResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of AuthConfig</returns>
        public async System.Threading.Tasks.Task<AuthConfig> PutAccessLoginOptionResourceAsync(string typeOrId, string targetTenant, AuthConfigAccess authConfigAccess, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<AuthConfig> localVarResponse = await PutAccessLoginOptionResourceWithHttpInfoAsync(typeOrId, targetTenant, authConfigAccess, accept, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (AuthConfig)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<AuthConfig>> PutAccessLoginOptionResourceWithHttpInfoAsync(string typeOrId, string targetTenant, AuthConfigAccess authConfigAccess, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'typeOrId' is set
            if (typeOrId == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PutAsync<AuthConfig>("/tenant/loginOptions/{type_or_id}/restrict", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
