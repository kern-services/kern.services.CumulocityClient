...
namespace kern.services.CumulocityClient.Api
{
    ...
    /// </summary>
    public interface IRetentionRulesApiSync : IApiAccessor
    {
        ...
        /// <returns></returns>
        void DeleteRetentionRuleResource(string id, int operationIndex = 0);
        ...
        ApiResponse<Object> DeleteRetentionRuleResourceWithHttpInfo(string id, int operationIndex = 0);
        /// <summary>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>RetentionRuleCollection</returns>
        RetentionRuleCollection GetRetentionRuleCollectionResource(int? currentPage = default(int?), int? pageSize = default(int?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0);
        ...
        /// <param name="withTotalPages">When set to &#x60;true&#x60;, the returned result will contain in the statistics object the total number of pages. Only applicable on [range queries](https://en.wikipedia.org/wiki/Range_query_(database)). (optional, default to false)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of RetentionRuleCollection</returns>
        ApiResponse<RetentionRuleCollection> GetRetentionRuleCollectionResourceWithHttpInfo(int? currentPage = default(int?), int? pageSize = default(int?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0);
        /// <summary>
        ...
        RetentionRule GetRetentionRuleResource(string id, int operationIndex = 0);
        ...
        /// <param name="id">Unique identifier of the retention rule.</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of RetentionRule</returns>
        ApiResponse<RetentionRule> GetRetentionRuleResourceWithHttpInfo(string id, int operationIndex = 0);
        /// <summary>
        ...
        /// </remarks>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="postRetentionRuleCollectionResourceRequest"></param>
        /// <param name="accept">Advertises which content types, expressed as MIME types, the client is able to understand. (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>RetentionRule</returns>
        RetentionRule PostRetentionRuleCollectionResource(PostRetentionRuleCollectionResourceRequest postRetentionRuleCollectionResourceRequest, string? accept = default(string?), int operationIndex = 0);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of RetentionRule</returns>
        ApiResponse<RetentionRule> PostRetentionRuleCollectionResourceWithHttpInfo(PostRetentionRuleCollectionResourceRequest postRetentionRuleCollectionResourceRequest, string? accept = default(string?), int operationIndex = 0);
        /// <summary>
        ...
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">Unique identifier of the retention rule.</param>
        /// <param name="retentionRule"></param>
        /// <param name="accept">Advertises which content types, expressed as MIME types, the client is able to understand. (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>RetentionRule</returns>
        RetentionRule PutRetentionRuleResource(string id, RetentionRule retentionRule, string? accept = default(string?), int operationIndex = 0);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of RetentionRule</returns>
        ApiResponse<RetentionRule> PutRetentionRuleResourceWithHttpInfo(string id, RetentionRule retentionRule, string? accept = default(string?), int operationIndex = 0);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IRetentionRulesApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task DeleteRetentionRuleResourceAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> DeleteRetentionRuleResourceWithHttpInfoAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Retrieve all retention rules
        /// </summary>
        /// <remarks>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (RetentionRuleCollection)</returns>
        System.Threading.Tasks.Task<ApiResponse<RetentionRuleCollection>> GetRetentionRuleCollectionResourceWithHttpInfoAsync(int? currentPage = default(int?), int? pageSize = default(int?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Retrieve a retention rule
        /// </summary>
        /// <remarks>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of RetentionRule</returns>
        System.Threading.Tasks.Task<RetentionRule> GetRetentionRuleResourceAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (RetentionRule)</returns>
        System.Threading.Tasks.Task<ApiResponse<RetentionRule>> GetRetentionRuleResourceWithHttpInfoAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Create a retention rule
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of RetentionRule</returns>
        System.Threading.Tasks.Task<RetentionRule> PostRetentionRuleCollectionResourceAsync(PostRetentionRuleCollectionResourceRequest postRetentionRuleCollectionResourceRequest, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (RetentionRule)</returns>
        System.Threading.Tasks.Task<ApiResponse<RetentionRule>> PostRetentionRuleCollectionResourceWithHttpInfoAsync(PostRetentionRuleCollectionResourceRequest postRetentionRuleCollectionResourceRequest, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Update a retention rule
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of RetentionRule</returns>
        System.Threading.Tasks.Task<RetentionRule> PutRetentionRuleResourceAsync(string id, RetentionRule retentionRule, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (RetentionRule)</returns>
        System.Threading.Tasks.Task<ApiResponse<RetentionRule>> PutRetentionRuleResourceWithHttpInfoAsync(string id, RetentionRule retentionRule, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IRetentionRulesApi : IRetentionRulesApiSync, IRetentionRulesApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class RetentionRulesApi : IRetentionRulesApi
    {
        private kern.services.CumulocityClient.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="RetentionRulesApi"/> class.
        /// </summary>
        /// <returns></returns>
        public RetentionRulesApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public RetentionRulesApi(string basePath)
        {
        ...
        /// <returns></returns>
        public RetentionRulesApi(kern.services.CumulocityClient.Client.Configuration configuration)
        {
        ...
        public RetentionRulesApi(kern.services.CumulocityClient.Client.ISynchronousClient client, kern.services.CumulocityClient.Client.IAsynchronousClient asyncClient, kern.services.CumulocityClient.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Remove a retention rule Remove a specific retention rule by a given ID.  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_RETENTION_RULE_ADMIN &lt;b&gt;AND&lt;/b&gt; the rule is editable &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">Unique identifier of the retention rule.</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns></returns>
        public void DeleteRetentionRuleResource(string id, int operationIndex = 0)
        {
            DeleteRetentionRuleResourceWithHttpInfo(id);
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<Object> DeleteRetentionRuleResourceWithHttpInfo(string id, int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'id' when calling RetentionRulesApi->DeleteRetentionRuleResource");
            }
            ...
            localVarRequestOptions.Operation = "RetentionRulesApi.DeleteRetentionRuleResource";
            ...
            var localVarResponse = this.Client.Delete<Object>("/retention/retentions/{id}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("DeleteRetentionRuleResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task DeleteRetentionRuleResourceAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await DeleteRetentionRuleResourceWithHttpInfoAsync(id, operationIndex, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<Object>> DeleteRetentionRuleResourceWithHttpInfoAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.DeleteAsync<Object>("/retention/retentions/{id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Retrieve all retention rules Retrieve all retention rules on your tenant.  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_RETENTION_RULE_READ &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="currentPage">The current page of the paginated results. (optional, default to 1)</param>
        /// <param name="pageSize">Indicates how many entries of the collection shall be returned. The upper limit for one page is 2,000 objects. (optional, default to 5)</param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>RetentionRuleCollection</returns>
        public RetentionRuleCollection GetRetentionRuleCollectionResource(int? currentPage = default(int?), int? pageSize = default(int?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<RetentionRuleCollection> localVarResponse = GetRetentionRuleCollectionResourceWithHttpInfo(currentPage, pageSize, withTotalElements, withTotalPages);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of RetentionRuleCollection</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<RetentionRuleCollection> GetRetentionRuleCollectionResourceWithHttpInfo(int? currentPage = default(int?), int? pageSize = default(int?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.RequestOptions localVarRequestOptions = new kern.services.CumulocityClient.Client.RequestOptions();
            ...
            localVarRequestOptions.Operation = "RetentionRulesApi.GetRetentionRuleCollectionResource";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<RetentionRuleCollection>("/retention/retentions", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetRetentionRuleCollectionResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of RetentionRuleCollection</returns>
        public async System.Threading.Tasks.Task<RetentionRuleCollection> GetRetentionRuleCollectionResourceAsync(int? currentPage = default(int?), int? pageSize = default(int?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<RetentionRuleCollection> localVarResponse = await GetRetentionRuleCollectionResourceWithHttpInfoAsync(currentPage, pageSize, withTotalElements, withTotalPages, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<RetentionRuleCollection>> GetRetentionRuleCollectionResourceWithHttpInfoAsync(int? currentPage = default(int?), int? pageSize = default(int?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<RetentionRuleCollection>("/retention/retentions", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Retrieve a retention rule Retrieve a specific retention rule by a given ID.  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_RETENTION_RULE_READ &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">Unique identifier of the retention rule.</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>RetentionRule</returns>
        public RetentionRule GetRetentionRuleResource(string id, int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<RetentionRule> localVarResponse = GetRetentionRuleResourceWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of RetentionRule</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<RetentionRule> GetRetentionRuleResourceWithHttpInfo(string id, int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'id' when calling RetentionRulesApi->GetRetentionRuleResource");
            }
            ...
            localVarRequestOptions.Operation = "RetentionRulesApi.GetRetentionRuleResource";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<RetentionRule>("/retention/retentions/{id}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetRetentionRuleResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of RetentionRule</returns>
        public async System.Threading.Tasks.Task<RetentionRule> GetRetentionRuleResourceAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<RetentionRule> localVarResponse = await GetRetentionRuleResourceWithHttpInfoAsync(id, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (RetentionRule)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<RetentionRule>> GetRetentionRuleResourceWithHttpInfoAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<RetentionRule>("/retention/retentions/{id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Create a retention rule Create a retention rule on your tenant.  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_RETENTION_RULE_ADMIN &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="postRetentionRuleCollectionResourceRequest"></param>
        /// <param name="accept">Advertises which content types, expressed as MIME types, the client is able to understand. (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>RetentionRule</returns>
        public RetentionRule PostRetentionRuleCollectionResource(PostRetentionRuleCollectionResourceRequest postRetentionRuleCollectionResourceRequest, string? accept = default(string?), int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<RetentionRule> localVarResponse = PostRetentionRuleCollectionResourceWithHttpInfo(postRetentionRuleCollectionResourceRequest, accept);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of RetentionRule</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<RetentionRule> PostRetentionRuleCollectionResourceWithHttpInfo(PostRetentionRuleCollectionResourceRequest postRetentionRuleCollectionResourceRequest, string? accept = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'postRetentionRuleCollectionResourceRequest' is set
            if (postRetentionRuleCollectionResourceRequest == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'postRetentionRuleCollectionResourceRequest' when calling RetentionRulesApi->PostRetentionRuleCollectionResource");
            }
            ...
            localVarRequestOptions.Data = postRetentionRuleCollectionResourceRequest;

            localVarRequestOptions.Operation = "RetentionRulesApi.PostRetentionRuleCollectionResource";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<RetentionRule>("/retention/retentions", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PostRetentionRuleCollectionResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of RetentionRule</returns>
        public async System.Threading.Tasks.Task<RetentionRule> PostRetentionRuleCollectionResourceAsync(PostRetentionRuleCollectionResourceRequest postRetentionRuleCollectionResourceRequest, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<RetentionRule> localVarResponse = await PostRetentionRuleCollectionResourceWithHttpInfoAsync(postRetentionRuleCollectionResourceRequest, accept, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (RetentionRule)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<RetentionRule>> PostRetentionRuleCollectionResourceWithHttpInfoAsync(PostRetentionRuleCollectionResourceRequest postRetentionRuleCollectionResourceRequest, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'postRetentionRuleCollectionResourceRequest' is set
            if (postRetentionRuleCollectionResourceRequest == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<RetentionRule>("/retention/retentions", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Update a retention rule Update a specific retention rule by a given ID.  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_RETENTION_RULE_ADMIN &lt;b&gt;AND&lt;/b&gt; (the rule is editable &lt;b&gt;OR&lt;/b&gt; it&#39;s the tenant management) &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">Unique identifier of the retention rule.</param>
        /// <param name="retentionRule"></param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>RetentionRule</returns>
        public RetentionRule PutRetentionRuleResource(string id, RetentionRule retentionRule, string? accept = default(string?), int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<RetentionRule> localVarResponse = PutRetentionRuleResourceWithHttpInfo(id, retentionRule, accept);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of RetentionRule</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<RetentionRule> PutRetentionRuleResourceWithHttpInfo(string id, RetentionRule retentionRule, string? accept = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'id' when calling RetentionRulesApi->PutRetentionRuleResource");
            }

            // verify the required parameter 'retentionRule' is set
            if (retentionRule == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'retentionRule' when calling RetentionRulesApi->PutRetentionRuleResource");
            }
            ...
            localVarRequestOptions.Data = retentionRule;

            localVarRequestOptions.Operation = "RetentionRulesApi.PutRetentionRuleResource";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Put<RetentionRule>("/retention/retentions/{id}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PutRetentionRuleResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of RetentionRule</returns>
        public async System.Threading.Tasks.Task<RetentionRule> PutRetentionRuleResourceAsync(string id, RetentionRule retentionRule, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<RetentionRule> localVarResponse = await PutRetentionRuleResourceWithHttpInfoAsync(id, retentionRule, accept, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (RetentionRule)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<RetentionRule>> PutRetentionRuleResourceWithHttpInfoAsync(string id, RetentionRule retentionRule, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PutAsync<RetentionRule>("/retention/retentions/{id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
