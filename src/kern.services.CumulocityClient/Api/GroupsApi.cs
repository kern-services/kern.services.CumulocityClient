...
namespace kern.services.CumulocityClient.Api
{
    ...
    public interface IGroupsApiSync : IApiAccessor
    {
        ...
        /// <returns></returns>
        void DeleteGroupByIdResource(string tenantId, int groupId, int operationIndex = 0);
        ...
        ApiResponse<Object> DeleteGroupByIdResourceWithHttpInfo(string tenantId, int groupId, int operationIndex = 0);
        /// <summary>
        ...
        Group GetGroupByIdResource(string tenantId, int groupId, int operationIndex = 0);
        ...
        ApiResponse<Group> GetGroupByIdResourceWithHttpInfo(string tenantId, int groupId, int operationIndex = 0);
        /// <summary>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>Group</returns>
        Group GetGroupByNameResource(string tenantId, string groupName, int operationIndex = 0);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Group</returns>
        ApiResponse<Group> GetGroupByNameResourceWithHttpInfo(string tenantId, string groupName, int operationIndex = 0);
        /// <summary>
        ...
        UserGroupCollection GetGroupCollectionResource(string tenantId, int? currentPage = default(int?), int? pageSize = default(int?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0);
        ...
        /// <param name="withTotalPages">When set to &#x60;true&#x60;, the returned result will contain in the statistics object the total number of pages. Only applicable on [range queries](https://en.wikipedia.org/wiki/Range_query_(database)). (optional, default to false)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of UserGroupCollection</returns>
        ApiResponse<UserGroupCollection> GetGroupCollectionResourceWithHttpInfo(string tenantId, int? currentPage = default(int?), int? pageSize = default(int?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0);
        /// <summary>
        ...
        /// <param name="withTotalPages">When set to &#x60;true&#x60;, the returned result will contain in the statistics object the total number of pages. Only applicable on [range queries](https://en.wikipedia.org/wiki/Range_query_(database)). (optional, default to false)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>GroupReferenceCollection</returns>
        GroupReferenceCollection GetGroupReferenceCollectionResource(string tenantId, string userId, int? currentPage = default(int?), int? pageSize = default(int?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0);
        ...
        /// <param name="withTotalPages">When set to &#x60;true&#x60;, the returned result will contain in the statistics object the total number of pages. Only applicable on [range queries](https://en.wikipedia.org/wiki/Range_query_(database)). (optional, default to false)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of GroupReferenceCollection</returns>
        ApiResponse<GroupReferenceCollection> GetGroupReferenceCollectionResourceWithHttpInfo(string tenantId, string userId, int? currentPage = default(int?), int? pageSize = default(int?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0);
        /// <summary>
        ...
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="tenantId">Unique identifier of a Cumulocity IoT tenant.</param>
        /// <param name="postGroupCollectionResourceRequest"></param>
        /// <param name="accept">Advertises which content types, expressed as MIME types, the client is able to understand. (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>Group</returns>
        Group PostGroupCollectionResource(string tenantId, PostGroupCollectionResourceRequest postGroupCollectionResourceRequest, string? accept = default(string?), int operationIndex = 0);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Group</returns>
        ApiResponse<Group> PostGroupCollectionResourceWithHttpInfo(string tenantId, PostGroupCollectionResourceRequest postGroupCollectionResourceRequest, string? accept = default(string?), int operationIndex = 0);
        /// <summary>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>Group</returns>
        Group PutGroupByIdResource(string tenantId, int groupId, PostGroupCollectionResourceRequest postGroupCollectionResourceRequest, string? accept = default(string?), int operationIndex = 0);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Group</returns>
        ApiResponse<Group> PutGroupByIdResourceWithHttpInfo(string tenantId, int groupId, PostGroupCollectionResourceRequest postGroupCollectionResourceRequest, string? accept = default(string?), int operationIndex = 0);
    ...
    public interface IGroupsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task DeleteGroupByIdResourceAsync(string tenantId, int groupId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> DeleteGroupByIdResourceWithHttpInfoAsync(string tenantId, int groupId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Retrieve a specific user group for a specific tenant
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<Group> GetGroupByIdResourceAsync(string tenantId, int groupId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Group>> GetGroupByIdResourceWithHttpInfoAsync(string tenantId, int groupId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Retrieve a user group by group name for a specific tenant
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Group</returns>
        System.Threading.Tasks.Task<Group> GetGroupByNameResourceAsync(string tenantId, string groupName, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Group)</returns>
        System.Threading.Tasks.Task<ApiResponse<Group>> GetGroupByNameResourceWithHttpInfoAsync(string tenantId, string groupName, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Retrieve all user groups of a specific tenant
        /// </summary>
        /// <remarks>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (UserGroupCollection)</returns>
        System.Threading.Tasks.Task<ApiResponse<UserGroupCollection>> GetGroupCollectionResourceWithHttpInfoAsync(string tenantId, int? currentPage = default(int?), int? pageSize = default(int?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get all user groups for specific user in a specific tenant
        /// </summary>
        /// <remarks>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of GroupReferenceCollection</returns>
        System.Threading.Tasks.Task<GroupReferenceCollection> GetGroupReferenceCollectionResourceAsync(string tenantId, string userId, int? currentPage = default(int?), int? pageSize = default(int?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GroupReferenceCollection)</returns>
        System.Threading.Tasks.Task<ApiResponse<GroupReferenceCollection>> GetGroupReferenceCollectionResourceWithHttpInfoAsync(string tenantId, string userId, int? currentPage = default(int?), int? pageSize = default(int?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Create a user group for a specific tenant
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Group</returns>
        System.Threading.Tasks.Task<Group> PostGroupCollectionResourceAsync(string tenantId, PostGroupCollectionResourceRequest postGroupCollectionResourceRequest, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Group)</returns>
        System.Threading.Tasks.Task<ApiResponse<Group>> PostGroupCollectionResourceWithHttpInfoAsync(string tenantId, PostGroupCollectionResourceRequest postGroupCollectionResourceRequest, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Update a specific user group for a specific tenant
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Group</returns>
        System.Threading.Tasks.Task<Group> PutGroupByIdResourceAsync(string tenantId, int groupId, PostGroupCollectionResourceRequest postGroupCollectionResourceRequest, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Group)</returns>
        System.Threading.Tasks.Task<ApiResponse<Group>> PutGroupByIdResourceWithHttpInfoAsync(string tenantId, int groupId, PostGroupCollectionResourceRequest postGroupCollectionResourceRequest, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class GroupsApi : IGroupsApi
    {
        ...
        /// <returns></returns>
        public GroupsApi(kern.services.CumulocityClient.Client.Configuration configuration)
        {
        ...
        public GroupsApi(kern.services.CumulocityClient.Client.ISynchronousClient client, kern.services.CumulocityClient.Client.IAsynchronousClient asyncClient, kern.services.CumulocityClient.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Delete a specific user group for a specific tenant Delete a specific user group (by a given user group ID) for a specific tenant (by a given tenant ID).  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_USER_MANAGEMENT_ADMIN &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="tenantId">Unique identifier of a Cumulocity IoT tenant.</param>
        /// <param name="groupId">Unique identifier of the user group.</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns></returns>
        public void DeleteGroupByIdResource(string tenantId, int groupId, int operationIndex = 0)
        {
            DeleteGroupByIdResourceWithHttpInfo(tenantId, groupId);
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<Object> DeleteGroupByIdResourceWithHttpInfo(string tenantId, int groupId, int operationIndex = 0)
        {
            // verify the required parameter 'tenantId' is set
            if (tenantId == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'tenantId' when calling GroupsApi->DeleteGroupByIdResource");
            }
            ...
            localVarRequestOptions.Operation = "GroupsApi.DeleteGroupByIdResource";
            ...
            var localVarResponse = this.Client.Delete<Object>("/user/{tenantId}/groups/{groupId}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("DeleteGroupByIdResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task DeleteGroupByIdResourceAsync(string tenantId, int groupId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await DeleteGroupByIdResourceWithHttpInfoAsync(tenantId, groupId, operationIndex, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<Object>> DeleteGroupByIdResourceWithHttpInfoAsync(string tenantId, int groupId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'tenantId' is set
            if (tenantId == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.DeleteAsync<Object>("/user/{tenantId}/groups/{groupId}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>Group</returns>
        public Group GetGroupByIdResource(string tenantId, int groupId, int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<Group> localVarResponse = GetGroupByIdResourceWithHttpInfo(tenantId, groupId);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Group</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<Group> GetGroupByIdResourceWithHttpInfo(string tenantId, int groupId, int operationIndex = 0)
        {
            // verify the required parameter 'tenantId' is set
            if (tenantId == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'tenantId' when calling GroupsApi->GetGroupByIdResource");
            }
            ...
            localVarRequestOptions.Operation = "GroupsApi.GetGroupByIdResource";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<Group>("/user/{tenantId}/groups/{groupId}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetGroupByIdResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Group</returns>
        public async System.Threading.Tasks.Task<Group> GetGroupByIdResourceAsync(string tenantId, int groupId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<Group> localVarResponse = await GetGroupByIdResourceWithHttpInfoAsync(tenantId, groupId, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Group)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<Group>> GetGroupByIdResourceWithHttpInfoAsync(string tenantId, int groupId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'tenantId' is set
            if (tenantId == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<Group>("/user/{tenantId}/groups/{groupId}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Retrieve a user group by group name for a specific tenant Retrieve a user group by group name for a specific tenant (by a given tenant ID).  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_USER_MANAGEMENT_READ &lt;b&gt;OR&lt;/b&gt; ROLE_USER_MANAGEMENT_CREATE &lt;b&gt;AND&lt;/b&gt; has access to groups &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="tenantId">Unique identifier of a Cumulocity IoT tenant.</param>
        /// <param name="groupName">The name of the user group.</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>Group</returns>
        public Group GetGroupByNameResource(string tenantId, string groupName, int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<Group> localVarResponse = GetGroupByNameResourceWithHttpInfo(tenantId, groupName);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Group</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<Group> GetGroupByNameResourceWithHttpInfo(string tenantId, string groupName, int operationIndex = 0)
        {
            // verify the required parameter 'tenantId' is set
            if (tenantId == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'tenantId' when calling GroupsApi->GetGroupByNameResource");
            }

            // verify the required parameter 'groupName' is set
            if (groupName == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'groupName' when calling GroupsApi->GetGroupByNameResource");
            }
            ...
            localVarRequestOptions.PathParameters.Add("tenantId", kern.services.CumulocityClient.Client.ClientUtils.ParameterToString(tenantId)); // path parameter
            localVarRequestOptions.PathParameters.Add("groupName", kern.services.CumulocityClient.Client.ClientUtils.ParameterToString(groupName)); // path parameter

            localVarRequestOptions.Operation = "GroupsApi.GetGroupByNameResource";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<Group>("/user/{tenantId}/groupByName/{groupName}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetGroupByNameResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Group</returns>
        public async System.Threading.Tasks.Task<Group> GetGroupByNameResourceAsync(string tenantId, string groupName, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<Group> localVarResponse = await GetGroupByNameResourceWithHttpInfoAsync(tenantId, groupName, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Group)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<Group>> GetGroupByNameResourceWithHttpInfoAsync(string tenantId, string groupName, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'tenantId' is set
            if (tenantId == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<Group>("/user/{tenantId}/groupByName/{groupName}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Retrieve all user groups of a specific tenant Retrieve all user groups of a specific tenant (by a given tenant ID).  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_USER_MANAGEMENT_READ &lt;b&gt;OR&lt;/b&gt; ROLE_USER_MANAGEMENT_CREATE &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="tenantId">Unique identifier of a Cumulocity IoT tenant.</param>
        /// <param name="currentPage">The current page of the paginated results. (optional, default to 1)</param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>UserGroupCollection</returns>
        public UserGroupCollection GetGroupCollectionResource(string tenantId, int? currentPage = default(int?), int? pageSize = default(int?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<UserGroupCollection> localVarResponse = GetGroupCollectionResourceWithHttpInfo(tenantId, currentPage, pageSize, withTotalElements, withTotalPages);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of UserGroupCollection</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<UserGroupCollection> GetGroupCollectionResourceWithHttpInfo(string tenantId, int? currentPage = default(int?), int? pageSize = default(int?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0)
        {
            // verify the required parameter 'tenantId' is set
            if (tenantId == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'tenantId' when calling GroupsApi->GetGroupCollectionResource");
            }
            ...
            localVarRequestOptions.Operation = "GroupsApi.GetGroupCollectionResource";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<UserGroupCollection>("/user/{tenantId}/groups", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetGroupCollectionResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of UserGroupCollection</returns>
        public async System.Threading.Tasks.Task<UserGroupCollection> GetGroupCollectionResourceAsync(string tenantId, int? currentPage = default(int?), int? pageSize = default(int?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<UserGroupCollection> localVarResponse = await GetGroupCollectionResourceWithHttpInfoAsync(tenantId, currentPage, pageSize, withTotalElements, withTotalPages, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (UserGroupCollection)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<UserGroupCollection>> GetGroupCollectionResourceWithHttpInfoAsync(string tenantId, int? currentPage = default(int?), int? pageSize = default(int?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'tenantId' is set
            if (tenantId == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<UserGroupCollection>("/user/{tenantId}/groups", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Get all user groups for specific user in a specific tenant Get all user groups for a specific user (by a given user ID) in a specific tenant (by a given tenant ID).  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_USER_MANAGEMENT_READ &lt;b&gt;OR&lt;/b&gt; ROLE_USER_MANAGEMENT_CREATE &lt;b&gt;AND&lt;/b&gt; is parent of the user &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="tenantId">Unique identifier of a Cumulocity IoT tenant.</param>
        /// <param name="userId">Unique identifier of the a user.</param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>GroupReferenceCollection</returns>
        public GroupReferenceCollection GetGroupReferenceCollectionResource(string tenantId, string userId, int? currentPage = default(int?), int? pageSize = default(int?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<GroupReferenceCollection> localVarResponse = GetGroupReferenceCollectionResourceWithHttpInfo(tenantId, userId, currentPage, pageSize, withTotalElements, withTotalPages);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of GroupReferenceCollection</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<GroupReferenceCollection> GetGroupReferenceCollectionResourceWithHttpInfo(string tenantId, string userId, int? currentPage = default(int?), int? pageSize = default(int?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0)
        {
            // verify the required parameter 'tenantId' is set
            if (tenantId == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'tenantId' when calling GroupsApi->GetGroupReferenceCollectionResource");
            }

            // verify the required parameter 'userId' is set
            if (userId == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'userId' when calling GroupsApi->GetGroupReferenceCollectionResource");
            }
            ...
            localVarRequestOptions.Operation = "GroupsApi.GetGroupReferenceCollectionResource";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<GroupReferenceCollection>("/user/{tenantId}/users/{userId}/groups", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetGroupReferenceCollectionResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of GroupReferenceCollection</returns>
        public async System.Threading.Tasks.Task<GroupReferenceCollection> GetGroupReferenceCollectionResourceAsync(string tenantId, string userId, int? currentPage = default(int?), int? pageSize = default(int?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<GroupReferenceCollection> localVarResponse = await GetGroupReferenceCollectionResourceWithHttpInfoAsync(tenantId, userId, currentPage, pageSize, withTotalElements, withTotalPages, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GroupReferenceCollection)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<GroupReferenceCollection>> GetGroupReferenceCollectionResourceWithHttpInfoAsync(string tenantId, string userId, int? currentPage = default(int?), int? pageSize = default(int?), bool? withTotalElements = default(bool?), bool? withTotalPages = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'tenantId' is set
            if (tenantId == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<GroupReferenceCollection>("/user/{tenantId}/users/{userId}/groups", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Create a user group for a specific tenant Create a user group for a specific tenant (by a given tenant ID).  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_USER_MANAGEMENT_ADMIN &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="tenantId">Unique identifier of a Cumulocity IoT tenant.</param>
        /// <param name="postGroupCollectionResourceRequest"></param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>Group</returns>
        public Group PostGroupCollectionResource(string tenantId, PostGroupCollectionResourceRequest postGroupCollectionResourceRequest, string? accept = default(string?), int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<Group> localVarResponse = PostGroupCollectionResourceWithHttpInfo(tenantId, postGroupCollectionResourceRequest, accept);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Group</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<Group> PostGroupCollectionResourceWithHttpInfo(string tenantId, PostGroupCollectionResourceRequest postGroupCollectionResourceRequest, string? accept = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'tenantId' is set
            if (tenantId == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'tenantId' when calling GroupsApi->PostGroupCollectionResource");
            }

            // verify the required parameter 'postGroupCollectionResourceRequest' is set
            if (postGroupCollectionResourceRequest == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'postGroupCollectionResourceRequest' when calling GroupsApi->PostGroupCollectionResource");
            }
            ...
            localVarRequestOptions.Data = postGroupCollectionResourceRequest;

            localVarRequestOptions.Operation = "GroupsApi.PostGroupCollectionResource";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<Group>("/user/{tenantId}/groups", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PostGroupCollectionResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Group</returns>
        public async System.Threading.Tasks.Task<Group> PostGroupCollectionResourceAsync(string tenantId, PostGroupCollectionResourceRequest postGroupCollectionResourceRequest, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<Group> localVarResponse = await PostGroupCollectionResourceWithHttpInfoAsync(tenantId, postGroupCollectionResourceRequest, accept, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Group)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<Group>> PostGroupCollectionResourceWithHttpInfoAsync(string tenantId, PostGroupCollectionResourceRequest postGroupCollectionResourceRequest, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'tenantId' is set
            if (tenantId == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<Group>("/user/{tenantId}/groups", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Update a specific user group for a specific tenant Update a specific user group (by a given user group ID) for a specific tenant (by a given tenant ID).  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_USER_MANAGEMENT_ADMIN &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="tenantId">Unique identifier of a Cumulocity IoT tenant.</param>
        /// <param name="groupId">Unique identifier of the user group.</param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>Group</returns>
        public Group PutGroupByIdResource(string tenantId, int groupId, PostGroupCollectionResourceRequest postGroupCollectionResourceRequest, string? accept = default(string?), int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<Group> localVarResponse = PutGroupByIdResourceWithHttpInfo(tenantId, groupId, postGroupCollectionResourceRequest, accept);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Group</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<Group> PutGroupByIdResourceWithHttpInfo(string tenantId, int groupId, PostGroupCollectionResourceRequest postGroupCollectionResourceRequest, string? accept = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'tenantId' is set
            if (tenantId == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'tenantId' when calling GroupsApi->PutGroupByIdResource");
            }

            // verify the required parameter 'postGroupCollectionResourceRequest' is set
            if (postGroupCollectionResourceRequest == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'postGroupCollectionResourceRequest' when calling GroupsApi->PutGroupByIdResource");
            }
            ...
            localVarRequestOptions.Operation = "GroupsApi.PutGroupByIdResource";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Put<Group>("/user/{tenantId}/groups/{groupId}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PutGroupByIdResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Group</returns>
        public async System.Threading.Tasks.Task<Group> PutGroupByIdResourceAsync(string tenantId, int groupId, PostGroupCollectionResourceRequest postGroupCollectionResourceRequest, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<Group> localVarResponse = await PutGroupByIdResourceWithHttpInfoAsync(tenantId, groupId, postGroupCollectionResourceRequest, accept, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Group)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<Group>> PutGroupByIdResourceWithHttpInfoAsync(string tenantId, int groupId, PostGroupCollectionResourceRequest postGroupCollectionResourceRequest, string? accept = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'tenantId' is set
            if (tenantId == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PutAsync<Group>("/user/{tenantId}/groups/{groupId}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
