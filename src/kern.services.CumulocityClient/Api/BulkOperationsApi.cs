...
namespace kern.services.CumulocityClient.Api
{
    ...
    /// </summary>
    public interface IBulkOperationsApiSync : IApiAccessor
    {
        ...
        /// <returns></returns>
        void DeleteBulkOperationResource(string id, string? xCumulocityProcessingMode = default(string?), int operationIndex = 0);
        ...
        ApiResponse<Object> DeleteBulkOperationResourceWithHttpInfo(string id, string? xCumulocityProcessingMode = default(string?), int operationIndex = 0);
        /// <summary>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>BulkOperationCollection</returns>
        BulkOperationCollection GetBulkOperationCollectionResource(int? currentPage = default(int?), int? pageSize = default(int?), bool? withTotalElements = default(bool?), int operationIndex = 0);
        ...
        /// <param name="withTotalElements">When set to &#x60;true&#x60;, the returned result will contain in the statistics object the total number of elements. Only applicable on [range queries](https://en.wikipedia.org/wiki/Range_query_(database)). (optional, default to false)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of BulkOperationCollection</returns>
        ApiResponse<BulkOperationCollection> GetBulkOperationCollectionResourceWithHttpInfo(int? currentPage = default(int?), int? pageSize = default(int?), bool? withTotalElements = default(bool?), int operationIndex = 0);
        /// <summary>
        ...
        /// <param name="id">Unique identifier of the bulk operation.</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>BulkOperation</returns>
        BulkOperation GetBulkOperationResource(string id, int operationIndex = 0);
        ...
        /// <param name="id">Unique identifier of the bulk operation.</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of BulkOperation</returns>
        ApiResponse<BulkOperation> GetBulkOperationResourceWithHttpInfo(string id, int operationIndex = 0);
        /// <summary>
        ...
        /// </remarks>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="bulkOperation"></param>
        /// <param name="accept">Advertises which content types, expressed as MIME types, the client is able to understand. (optional)</param>
        /// <param name="xCumulocityProcessingMode">Used to explicitly control the processing mode of the request. See [Processing mode](#processing-mode) for more details. (optional, default to PERSISTENT)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>BulkOperation</returns>
        BulkOperation PostBulkOperationCollectionResource(BulkOperation bulkOperation, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of BulkOperation</returns>
        ApiResponse<BulkOperation> PostBulkOperationCollectionResourceWithHttpInfo(BulkOperation bulkOperation, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0);
        /// <summary>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>BulkOperation</returns>
        BulkOperation PutBulkOperationResource(string id, BulkOperation bulkOperation, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of BulkOperation</returns>
        ApiResponse<BulkOperation> PutBulkOperationResourceWithHttpInfo(string id, BulkOperation bulkOperation, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IBulkOperationsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task DeleteBulkOperationResourceAsync(string id, string? xCumulocityProcessingMode = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> DeleteBulkOperationResourceWithHttpInfoAsync(string id, string? xCumulocityProcessingMode = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Retrieve a list of bulk operations
        /// </summary>
        /// <remarks>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of BulkOperationCollection</returns>
        System.Threading.Tasks.Task<BulkOperationCollection> GetBulkOperationCollectionResourceAsync(int? currentPage = default(int?), int? pageSize = default(int?), bool? withTotalElements = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (BulkOperationCollection)</returns>
        System.Threading.Tasks.Task<ApiResponse<BulkOperationCollection>> GetBulkOperationCollectionResourceWithHttpInfoAsync(int? currentPage = default(int?), int? pageSize = default(int?), bool? withTotalElements = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Retrieve a specific bulk operation
        /// </summary>
        /// <remarks>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of BulkOperation</returns>
        System.Threading.Tasks.Task<BulkOperation> GetBulkOperationResourceAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (BulkOperation)</returns>
        System.Threading.Tasks.Task<ApiResponse<BulkOperation>> GetBulkOperationResourceWithHttpInfoAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Create a bulk operation
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of BulkOperation</returns>
        System.Threading.Tasks.Task<BulkOperation> PostBulkOperationCollectionResourceAsync(BulkOperation bulkOperation, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (BulkOperation)</returns>
        System.Threading.Tasks.Task<ApiResponse<BulkOperation>> PostBulkOperationCollectionResourceWithHttpInfoAsync(BulkOperation bulkOperation, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Update a specific bulk operation
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of BulkOperation</returns>
        System.Threading.Tasks.Task<BulkOperation> PutBulkOperationResourceAsync(string id, BulkOperation bulkOperation, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (BulkOperation)</returns>
        System.Threading.Tasks.Task<ApiResponse<BulkOperation>> PutBulkOperationResourceWithHttpInfoAsync(string id, BulkOperation bulkOperation, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IBulkOperationsApi : IBulkOperationsApiSync, IBulkOperationsApiAsync
    {
    ...
    public partial class BulkOperationsApi : IBulkOperationsApi
    {
        ...
        /// </summary>
        /// <returns></returns>
        public BulkOperationsApi() : this((string)null)
        {
        }
        ...
        /// <returns></returns>
        public BulkOperationsApi(kern.services.CumulocityClient.Client.Configuration configuration)
        {
        ...
        public BulkOperationsApi(kern.services.CumulocityClient.Client.ISynchronousClient client, kern.services.CumulocityClient.Client.IAsynchronousClient asyncClient, kern.services.CumulocityClient.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Delete a specific bulk operation Delete a specific bulk operation (by a given ID).  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_BULK_OPERATION_ADMIN &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">Unique identifier of the bulk operation.</param>
        /// <param name="xCumulocityProcessingMode">Used to explicitly control the processing mode of the request. See [Processing mode](#processing-mode) for more details. (optional, default to PERSISTENT)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns></returns>
        public void DeleteBulkOperationResource(string id, string? xCumulocityProcessingMode = default(string?), int operationIndex = 0)
        {
            DeleteBulkOperationResourceWithHttpInfo(id, xCumulocityProcessingMode);
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<Object> DeleteBulkOperationResourceWithHttpInfo(string id, string? xCumulocityProcessingMode = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'id' when calling BulkOperationsApi->DeleteBulkOperationResource");
            }
            ...
            localVarRequestOptions.Operation = "BulkOperationsApi.DeleteBulkOperationResource";
            ...
            var localVarResponse = this.Client.Delete<Object>("/devicecontrol/bulkoperations/{id}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("DeleteBulkOperationResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task DeleteBulkOperationResourceAsync(string id, string? xCumulocityProcessingMode = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await DeleteBulkOperationResourceWithHttpInfoAsync(id, xCumulocityProcessingMode, operationIndex, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<Object>> DeleteBulkOperationResourceWithHttpInfoAsync(string id, string? xCumulocityProcessingMode = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.DeleteAsync<Object>("/devicecontrol/bulkoperations/{id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Retrieve a list of bulk operations Retrieve a list of bulk operations.  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_BULK_OPERATION_READ &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="currentPage">The current page of the paginated results. (optional, default to 1)</param>
        /// <param name="pageSize">Indicates how many entries of the collection shall be returned. The upper limit for one page is 2,000 objects. (optional, default to 5)</param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>BulkOperationCollection</returns>
        public BulkOperationCollection GetBulkOperationCollectionResource(int? currentPage = default(int?), int? pageSize = default(int?), bool? withTotalElements = default(bool?), int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<BulkOperationCollection> localVarResponse = GetBulkOperationCollectionResourceWithHttpInfo(currentPage, pageSize, withTotalElements);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of BulkOperationCollection</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<BulkOperationCollection> GetBulkOperationCollectionResourceWithHttpInfo(int? currentPage = default(int?), int? pageSize = default(int?), bool? withTotalElements = default(bool?), int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.RequestOptions localVarRequestOptions = new kern.services.CumulocityClient.Client.RequestOptions();
            ...
            localVarRequestOptions.Operation = "BulkOperationsApi.GetBulkOperationCollectionResource";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<BulkOperationCollection>("/devicecontrol/bulkoperations", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetBulkOperationCollectionResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of BulkOperationCollection</returns>
        public async System.Threading.Tasks.Task<BulkOperationCollection> GetBulkOperationCollectionResourceAsync(int? currentPage = default(int?), int? pageSize = default(int?), bool? withTotalElements = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<BulkOperationCollection> localVarResponse = await GetBulkOperationCollectionResourceWithHttpInfoAsync(currentPage, pageSize, withTotalElements, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (BulkOperationCollection)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<BulkOperationCollection>> GetBulkOperationCollectionResourceWithHttpInfoAsync(int? currentPage = default(int?), int? pageSize = default(int?), bool? withTotalElements = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<BulkOperationCollection>("/devicecontrol/bulkoperations", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Retrieve a specific bulk operation Retrieve a specific bulk operation (by a given ID).  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_BULK_OPERATION_READ &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">Unique identifier of the bulk operation.</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>BulkOperation</returns>
        public BulkOperation GetBulkOperationResource(string id, int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<BulkOperation> localVarResponse = GetBulkOperationResourceWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of BulkOperation</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<BulkOperation> GetBulkOperationResourceWithHttpInfo(string id, int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'id' when calling BulkOperationsApi->GetBulkOperationResource");
            }
            ...
            localVarRequestOptions.Operation = "BulkOperationsApi.GetBulkOperationResource";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<BulkOperation>("/devicecontrol/bulkoperations/{id}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetBulkOperationResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of BulkOperation</returns>
        public async System.Threading.Tasks.Task<BulkOperation> GetBulkOperationResourceAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<BulkOperation> localVarResponse = await GetBulkOperationResourceWithHttpInfoAsync(id, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (BulkOperation)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<BulkOperation>> GetBulkOperationResourceWithHttpInfoAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<BulkOperation>("/devicecontrol/bulkoperations/{id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Create a bulk operation Create a bulk operation.  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_BULK_OPERATION_ADMIN &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="bulkOperation"></param>
        /// <param name="accept">Advertises which content types, expressed as MIME types, the client is able to understand. (optional)</param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>BulkOperation</returns>
        public BulkOperation PostBulkOperationCollectionResource(BulkOperation bulkOperation, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<BulkOperation> localVarResponse = PostBulkOperationCollectionResourceWithHttpInfo(bulkOperation, accept, xCumulocityProcessingMode);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of BulkOperation</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<BulkOperation> PostBulkOperationCollectionResourceWithHttpInfo(BulkOperation bulkOperation, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'bulkOperation' is set
            if (bulkOperation == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'bulkOperation' when calling BulkOperationsApi->PostBulkOperationCollectionResource");
            }
            ...
            localVarRequestOptions.Data = bulkOperation;

            localVarRequestOptions.Operation = "BulkOperationsApi.PostBulkOperationCollectionResource";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<BulkOperation>("/devicecontrol/bulkoperations", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PostBulkOperationCollectionResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of BulkOperation</returns>
        public async System.Threading.Tasks.Task<BulkOperation> PostBulkOperationCollectionResourceAsync(BulkOperation bulkOperation, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<BulkOperation> localVarResponse = await PostBulkOperationCollectionResourceWithHttpInfoAsync(bulkOperation, accept, xCumulocityProcessingMode, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (BulkOperation)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<BulkOperation>> PostBulkOperationCollectionResourceWithHttpInfoAsync(BulkOperation bulkOperation, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'bulkOperation' is set
            if (bulkOperation == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<BulkOperation>("/devicecontrol/bulkoperations", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Update a specific bulk operation Update a specific bulk operation (by a given ID).  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_BULK_OPERATION_ADMIN &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">Unique identifier of the bulk operation.</param>
        /// <param name="bulkOperation"></param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>BulkOperation</returns>
        public BulkOperation PutBulkOperationResource(string id, BulkOperation bulkOperation, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<BulkOperation> localVarResponse = PutBulkOperationResourceWithHttpInfo(id, bulkOperation, accept, xCumulocityProcessingMode);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of BulkOperation</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<BulkOperation> PutBulkOperationResourceWithHttpInfo(string id, BulkOperation bulkOperation, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'id' when calling BulkOperationsApi->PutBulkOperationResource");
            }

            // verify the required parameter 'bulkOperation' is set
            if (bulkOperation == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'bulkOperation' when calling BulkOperationsApi->PutBulkOperationResource");
            }
            ...
            localVarRequestOptions.Operation = "BulkOperationsApi.PutBulkOperationResource";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Put<BulkOperation>("/devicecontrol/bulkoperations/{id}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PutBulkOperationResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of BulkOperation</returns>
        public async System.Threading.Tasks.Task<BulkOperation> PutBulkOperationResourceAsync(string id, BulkOperation bulkOperation, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<BulkOperation> localVarResponse = await PutBulkOperationResourceWithHttpInfoAsync(id, bulkOperation, accept, xCumulocityProcessingMode, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (BulkOperation)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<BulkOperation>> PutBulkOperationResourceWithHttpInfoAsync(string id, BulkOperation bulkOperation, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PutAsync<BulkOperation>("/devicecontrol/bulkoperations/{id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
