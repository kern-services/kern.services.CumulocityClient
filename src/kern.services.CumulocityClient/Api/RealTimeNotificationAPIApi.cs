...
namespace kern.services.CumulocityClient.Api
{
    ...
    /// </summary>
    public interface IRealTimeNotificationAPIApi : IApiAccessor
    {
        ...
        RealtimeNotification PostNotificationRealtimeResource (RealtimeNotification realtimeNotification, string accept = default(string), string xCumulocityProcessingMode = default(string));
        ...
        ApiResponse<RealtimeNotification> PostNotificationRealtimeResourceWithHttpInfo (RealtimeNotification realtimeNotification, string accept = default(string), string xCumulocityProcessingMode = default(string));
        ...
        System.Threading.Tasks.Task<RealtimeNotification> PostNotificationRealtimeResourceAsync (RealtimeNotification realtimeNotification, string accept = default(string), string xCumulocityProcessingMode = default(string), CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<RealtimeNotification>> PostNotificationRealtimeResourceWithHttpInfoAsync (RealtimeNotification realtimeNotification, string accept = default(string), string xCumulocityProcessingMode = default(string), CancellationToken cancellationToken = default(CancellationToken));
    ...
    public partial class RealTimeNotificationAPIApi : IRealTimeNotificationAPIApi
    {
        ...
        /// </summary>
        /// <returns></returns>
        public RealTimeNotificationAPIApi()
        {
        ...
        /// <returns></returns>
        public RealTimeNotificationAPIApi(kern.services.CumulocityClient.Client.Configuration configuration = null)
        {
        ...
        /// <param name="xCumulocityProcessingMode">Used to explicitly control the processing mode of the request. See [Processing mode](#processing-mode) for more details. (optional, default to PERSISTENT)</param>
        /// <returns>RealtimeNotification</returns>
        public RealtimeNotification PostNotificationRealtimeResource (RealtimeNotification realtimeNotification, string accept = default(string), string xCumulocityProcessingMode = default(string))
        {
             ApiResponse<RealtimeNotification> localVarResponse = PostNotificationRealtimeResourceWithHttpInfo(realtimeNotification, accept, xCumulocityProcessingMode);
        ...
        /// <param name="xCumulocityProcessingMode">Used to explicitly control the processing mode of the request. See [Processing mode](#processing-mode) for more details. (optional, default to PERSISTENT)</param>
        /// <returns>ApiResponse of RealtimeNotification</returns>
        public ApiResponse<RealtimeNotification> PostNotificationRealtimeResourceWithHttpInfo (RealtimeNotification realtimeNotification, string accept = default(string), string xCumulocityProcessingMode = default(string))
        {
            // verify the required parameter 'realtimeNotification' is set
            if (realtimeNotification == null)
                throw new ApiException(400, "Missing required parameter 'realtimeNotification' when calling RealTimeNotificationAPIApi->PostNotificationRealtimeResource");

            var localVarPath = "/notification/realtime";
            ...
            if (realtimeNotification != null && realtimeNotification.GetType() != typeof(byte[]))
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(realtimeNotification); // http body (model) parameter
            }
            else
            {
                localVarPostBody = realtimeNotification; // byte array
            }
            ...
            {
                Exception exception = ExceptionFactory("PostNotificationRealtimeResource", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<RealtimeNotification>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (RealtimeNotification) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(RealtimeNotification)));
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of RealtimeNotification</returns>
        public async System.Threading.Tasks.Task<RealtimeNotification> PostNotificationRealtimeResourceAsync (RealtimeNotification realtimeNotification, string accept = default(string), string xCumulocityProcessingMode = default(string), CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<RealtimeNotification> localVarResponse = await PostNotificationRealtimeResourceWithHttpInfoAsync(realtimeNotification, accept, xCumulocityProcessingMode, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (RealtimeNotification)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<RealtimeNotification>> PostNotificationRealtimeResourceWithHttpInfoAsync (RealtimeNotification realtimeNotification, string accept = default(string), string xCumulocityProcessingMode = default(string), CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'realtimeNotification' is set
            if (realtimeNotification == null)
                throw new ApiException(400, "Missing required parameter 'realtimeNotification' when calling RealTimeNotificationAPIApi->PostNotificationRealtimeResource");
