...
namespace kern.services.CumulocityClient.Api
{
    ...
    /// </summary>
    public interface IRealTimeNotificationAPIApiSync : IApiAccessor
    {
        ...
        /// <param name="realtimeNotification"></param>
        ...
        /// <returns>RealtimeNotification</returns>
        RealtimeNotification PostNotificationRealtimeResource(RealtimeNotification realtimeNotification, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0);
        ...
        /// <param name="xCumulocityProcessingMode">Used to explicitly control the processing mode of the request. See [Processing mode](#processing-mode) for more details. (optional, default to PERSISTENT)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of RealtimeNotification</returns>
        ApiResponse<RealtimeNotification> PostNotificationRealtimeResourceWithHttpInfo(RealtimeNotification realtimeNotification, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IRealTimeNotificationAPIApiAsync : IApiAccessor
    {
        ...
        /// <returns>Task of RealtimeNotification</returns>
        System.Threading.Tasks.Task<RealtimeNotification> PostNotificationRealtimeResourceAsync(RealtimeNotification realtimeNotification, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (RealtimeNotification)</returns>
        System.Threading.Tasks.Task<ApiResponse<RealtimeNotification>> PostNotificationRealtimeResourceWithHttpInfoAsync(RealtimeNotification realtimeNotification, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IRealTimeNotificationAPIApi : IRealTimeNotificationAPIApiSync, IRealTimeNotificationAPIApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class RealTimeNotificationAPIApi : IRealTimeNotificationAPIApi
    {
        private kern.services.CumulocityClient.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="RealTimeNotificationAPIApi"/> class.
        /// </summary>
        /// <returns></returns>
        public RealTimeNotificationAPIApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public RealTimeNotificationAPIApi(string basePath)
        {
        ...
        /// <returns></returns>
        public RealTimeNotificationAPIApi(kern.services.CumulocityClient.Client.Configuration configuration)
        {
        ...
        public RealTimeNotificationAPIApi(kern.services.CumulocityClient.Client.ISynchronousClient client, kern.services.CumulocityClient.Client.IAsynchronousClient asyncClient, kern.services.CumulocityClient.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Responsive communication The Real-time notification API enables responsive communication from Cumulocity IoT over restricted networks towards clients such as web browser and mobile devices. All clients subscribe to so-called channels to receive messages. These channels are filled by Cumulocity IoT with the output of [Operations](#tag/Operations). In addition, particular system channels are used for the initial handshake with clients, subscription to channels, removal from channels and connection. The [Bayeux protocol](https://docs.cometd.org/current/reference/#_concepts_bayeux_protocol) over HTTPS or WSS is used as communication mechanism.
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="realtimeNotification"></param>
        /// <param name="accept">Advertises which content types, expressed as MIME types, the client is able to understand. (optional)</param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>RealtimeNotification</returns>
        public RealtimeNotification PostNotificationRealtimeResource(RealtimeNotification realtimeNotification, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<RealtimeNotification> localVarResponse = PostNotificationRealtimeResourceWithHttpInfo(realtimeNotification, accept, xCumulocityProcessingMode);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of RealtimeNotification</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<RealtimeNotification> PostNotificationRealtimeResourceWithHttpInfo(RealtimeNotification realtimeNotification, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'realtimeNotification' is set
            if (realtimeNotification == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'realtimeNotification' when calling RealTimeNotificationAPIApi->PostNotificationRealtimeResource");
            }
            ...
            localVarRequestOptions.Data = realtimeNotification;

            localVarRequestOptions.Operation = "RealTimeNotificationAPIApi.PostNotificationRealtimeResource";
            ...
            var localVarResponse = this.Client.Post<RealtimeNotification>("/notification/realtime", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PostNotificationRealtimeResource", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of RealtimeNotification</returns>
        public async System.Threading.Tasks.Task<RealtimeNotification> PostNotificationRealtimeResourceAsync(RealtimeNotification realtimeNotification, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<RealtimeNotification> localVarResponse = await PostNotificationRealtimeResourceWithHttpInfoAsync(realtimeNotification, accept, xCumulocityProcessingMode, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<RealtimeNotification>> PostNotificationRealtimeResourceWithHttpInfoAsync(RealtimeNotification realtimeNotification, string? accept = default(string?), string? xCumulocityProcessingMode = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<RealtimeNotification>("/notification/realtime", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
