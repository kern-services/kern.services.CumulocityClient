...
namespace kern.services.CumulocityClient.Api
{
    ...
    /// </summary>
    public interface IBootstrapUserApiSync : IApiAccessor
    {
        ...
        /// <returns>BootstrapUser</returns>
        BootstrapUser GetApplicationUserRepresentation(string id, int operationIndex = 0);
        ...
        /// <param name="id">Unique identifier of the application.</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of BootstrapUser</returns>
        ApiResponse<BootstrapUser> GetApplicationUserRepresentationWithHttpInfo(string id, int operationIndex = 0);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IBootstrapUserApiAsync : IApiAccessor
    {
        ...
        /// <returns>Task of BootstrapUser</returns>
        System.Threading.Tasks.Task<BootstrapUser> GetApplicationUserRepresentationAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (BootstrapUser)</returns>
        System.Threading.Tasks.Task<ApiResponse<BootstrapUser>> GetApplicationUserRepresentationWithHttpInfoAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IBootstrapUserApi : IBootstrapUserApiSync, IBootstrapUserApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class BootstrapUserApi : IBootstrapUserApi
    {
        private kern.services.CumulocityClient.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="BootstrapUserApi"/> class.
        /// </summary>
        /// <returns></returns>
        public BootstrapUserApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public BootstrapUserApi(string basePath)
        {
        ...
        /// <returns></returns>
        public BootstrapUserApi(kern.services.CumulocityClient.Client.Configuration configuration)
        {
        ...
        public BootstrapUserApi(kern.services.CumulocityClient.Client.ISynchronousClient client, kern.services.CumulocityClient.Client.IAsynchronousClient asyncClient, kern.services.CumulocityClient.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// Retrieve the bootstrap user for a specific application Retrieve the bootstrap user for a specific application (by a given ID).  This only works for microservice applications.  &lt;section&gt;&lt;h5&gt;Required roles&lt;/h5&gt; ROLE_APPLICATION_MANAGEMENT_ADMIN &lt;/section&gt; 
        /// </summary>
        /// <exception cref="kern.services.CumulocityClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">Unique identifier of the application.</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>BootstrapUser</returns>
        public BootstrapUser GetApplicationUserRepresentation(string id, int operationIndex = 0)
        {
            kern.services.CumulocityClient.Client.ApiResponse<BootstrapUser> localVarResponse = GetApplicationUserRepresentationWithHttpInfo(id);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of BootstrapUser</returns>
        public kern.services.CumulocityClient.Client.ApiResponse<BootstrapUser> GetApplicationUserRepresentationWithHttpInfo(string id, int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new kern.services.CumulocityClient.Client.ApiException(400, "Missing required parameter 'id' when calling BootstrapUserApi->GetApplicationUserRepresentation");
            }
            ...
            localVarRequestOptions.Operation = "BootstrapUserApi.GetApplicationUserRepresentation";
            ...
            var localVarResponse = this.Client.Get<BootstrapUser>("/application/applications/{id}/bootstrapUser", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetApplicationUserRepresentation", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of BootstrapUser</returns>
        public async System.Threading.Tasks.Task<BootstrapUser> GetApplicationUserRepresentationAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            kern.services.CumulocityClient.Client.ApiResponse<BootstrapUser> localVarResponse = await GetApplicationUserRepresentationWithHttpInfoAsync(id, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (BootstrapUser)</returns>
        public async System.Threading.Tasks.Task<kern.services.CumulocityClient.Client.ApiResponse<BootstrapUser>> GetApplicationUserRepresentationWithHttpInfoAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<BootstrapUser>("/application/applications/{id}/bootstrapUser", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
