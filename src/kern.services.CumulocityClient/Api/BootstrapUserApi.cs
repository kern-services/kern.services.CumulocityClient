...
namespace kern.services.CumulocityClient.Api
{
    ...
    /// </summary>
    public interface IBootstrapUserApi : IApiAccessor
    {
        ...
        ApiResponse<BootstrapUser> GetApplicationUserRepresentationWithHttpInfo (string id);
        ...
        System.Threading.Tasks.Task<BootstrapUser> GetApplicationUserRepresentationAsync (string id, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<BootstrapUser>> GetApplicationUserRepresentationWithHttpInfoAsync (string id, CancellationToken cancellationToken = default(CancellationToken));
    ...
    public partial class BootstrapUserApi : IBootstrapUserApi
    {
        ...
        /// <returns></returns>
        public BootstrapUserApi(kern.services.CumulocityClient.Client.Configuration configuration = null)
        {
        ...
        /// <param name="id">Unique identifier of the application.</param>
        /// <returns>BootstrapUser</returns>
        public BootstrapUser GetApplicationUserRepresentation (string id)
        {
             ApiResponse<BootstrapUser> localVarResponse = GetApplicationUserRepresentationWithHttpInfo(id);
        ...
        /// <param name="id">Unique identifier of the application.</param>
        /// <returns>ApiResponse of BootstrapUser</returns>
        public ApiResponse<BootstrapUser> GetApplicationUserRepresentationWithHttpInfo (string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling BootstrapUserApi->GetApplicationUserRepresentation");

            var localVarPath = "/application/applications/{id}/bootstrapUser";
            ...
            {
                Exception exception = ExceptionFactory("GetApplicationUserRepresentation", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<BootstrapUser>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (BootstrapUser) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(BootstrapUser)));
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of BootstrapUser</returns>
        public async System.Threading.Tasks.Task<BootstrapUser> GetApplicationUserRepresentationAsync (string id, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<BootstrapUser> localVarResponse = await GetApplicationUserRepresentationWithHttpInfoAsync(id, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (BootstrapUser)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<BootstrapUser>> GetApplicationUserRepresentationWithHttpInfoAsync (string id, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling BootstrapUserApi->GetApplicationUserRepresentation");
