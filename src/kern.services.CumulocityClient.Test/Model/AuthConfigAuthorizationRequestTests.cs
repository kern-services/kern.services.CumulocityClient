...
namespace kern.services.CumulocityClient.Test
{
    ...
    /// </remarks>
    public class AuthConfigAuthorizationRequestTests
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOf" AuthConfigAuthorizationRequest
            //Assert.IsInstanceOf(typeof(AuthConfigAuthorizationRequest), instance);
        }
