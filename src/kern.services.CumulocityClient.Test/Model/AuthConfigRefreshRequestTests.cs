...
namespace kern.services.CumulocityClient.Test
{
    ...
    /// </remarks>
    public class AuthConfigRefreshRequestTests
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOf" AuthConfigRefreshRequest
            //Assert.IsInstanceOf(typeof(AuthConfigRefreshRequest), instance);
        }
