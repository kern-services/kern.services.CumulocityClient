...
namespace kern.services.CumulocityClient.Test
{
    ...
    /// </remarks>
    public class PutEventResourceRequestTests
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOf" PutEventResourceRequest
            //Assert.IsInstanceOf(typeof(PutEventResourceRequest), instance);
        }
