...
namespace kern.services.CumulocityClient.Test
{
    ...
    /// </remarks>
    public class BulkNewDeviceRequestTests
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOf" BulkNewDeviceRequest
            //Assert.IsInstanceOf(typeof(BulkNewDeviceRequest), instance);
        }
