...
namespace kern.services.CumulocityClient.Test
{
    ...
    /// </remarks>
    public class InventoryApiResourceTests
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOf" InventoryApiResource
            //Assert.IsInstanceOf(typeof(InventoryApiResource), instance);
        }
