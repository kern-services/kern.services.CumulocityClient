...
namespace kern.services.CumulocityClient.Test
{
    ...
    /// </remarks>
    public class NotificationApiResourceTests
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOf" NotificationApiResource
            //Assert.IsInstanceOf(typeof(NotificationApiResource), instance);
        }
