...
namespace kern.services.CumulocityClient.Test
{
    ...
    /// </remarks>
    public class PostOptionCollectionResourceRequestTests
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOf" PostOptionCollectionResourceRequest
            //Assert.IsInstanceOf(typeof(PostOptionCollectionResourceRequest), instance);
        }
