...
namespace kern.services.CumulocityClient.Test.Model
{
    ...
    /// </remarks>
    public class ExternalIdTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsType" ExternalId
            //Assert.IsType<ExternalId>(instance);
        }

        /// <summary>
        /// Test the property 'VarExternalId'
        /// </summary>
        [Fact]
        public void VarExternalIdTest()
        {
            // TODO unit test for the property 'VarExternalId'
        }
