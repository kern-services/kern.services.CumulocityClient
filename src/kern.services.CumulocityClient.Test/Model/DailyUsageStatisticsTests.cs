...
namespace kern.services.CumulocityClient.Test
{
    ...
    /// </remarks>
    public class DailyUsageStatisticsTests
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOf" DailyUsageStatistics
            //Assert.IsInstanceOf(typeof(DailyUsageStatistics), instance);
        }
