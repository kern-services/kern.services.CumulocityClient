...
namespace kern.services.CumulocityClient.Test
{
    ...
    /// </remarks>
    public class AuditRecordChangesInnerTests
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOf" AuditRecordChangesInner
            //Assert.IsInstanceOf(typeof(AuditRecordChangesInner), instance);
        }
