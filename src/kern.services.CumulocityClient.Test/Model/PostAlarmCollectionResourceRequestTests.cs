...
namespace kern.services.CumulocityClient.Test
{
    ...
    /// </remarks>
    public class PostAlarmCollectionResourceRequestTests
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOf" PostAlarmCollectionResourceRequest
            //Assert.IsInstanceOf(typeof(PostAlarmCollectionResourceRequest), instance);
        }
