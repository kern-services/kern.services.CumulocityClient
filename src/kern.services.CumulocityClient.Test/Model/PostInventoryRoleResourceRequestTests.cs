...
namespace kern.services.CumulocityClient.Test
{
    ...
    /// </remarks>
    public class PostInventoryRoleResourceRequestTests
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOf" PostInventoryRoleResourceRequest
            //Assert.IsInstanceOf(typeof(PostInventoryRoleResourceRequest), instance);
        }
