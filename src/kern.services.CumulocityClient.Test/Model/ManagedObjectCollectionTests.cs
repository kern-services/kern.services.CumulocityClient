...
namespace kern.services.CumulocityClient.Test
{
    ...
    /// </remarks>
    public class ManagedObjectCollectionTests
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOf" ManagedObjectCollection
            //Assert.IsInstanceOf(typeof(ManagedObjectCollection), instance);
        }
