...
namespace kern.services.CumulocityClient.Test
{
    ...
    /// </remarks>
    public class WebApplicationManifestTests
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOf" WebApplicationManifest
            //Assert.IsInstanceOf(typeof(WebApplicationManifest), instance);
        }
