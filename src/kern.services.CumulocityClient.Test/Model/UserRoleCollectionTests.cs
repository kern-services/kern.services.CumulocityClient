...
namespace kern.services.CumulocityClient.Test
{
    ...
    /// </remarks>
    public class UserRoleCollectionTests
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOf" UserRoleCollection
            //Assert.IsInstanceOf(typeof(UserRoleCollection), instance);
        }
