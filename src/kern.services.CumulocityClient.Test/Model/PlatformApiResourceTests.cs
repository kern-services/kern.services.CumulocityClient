...
namespace kern.services.CumulocityClient.Test
{
    ...
    /// </remarks>
    public class PlatformApiResourceTests
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOf" PlatformApiResource
            //Assert.IsInstanceOf(typeof(PlatformApiResource), instance);
        }
