...
namespace kern.services.CumulocityClient.Test
{
    ...
    /// </remarks>
    public class C8yActiveAlarmsStatusTests
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOf" C8yActiveAlarmsStatus
            //Assert.IsInstanceOf(typeof(C8yActiveAlarmsStatus), instance);
        }
