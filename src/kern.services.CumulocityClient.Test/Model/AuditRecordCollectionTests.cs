...
namespace kern.services.CumulocityClient.Test
{
    ...
    /// </remarks>
    public class AuditRecordCollectionTests
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOf" AuditRecordCollection
            //Assert.IsInstanceOf(typeof(AuditRecordCollection), instance);
        }
