...
namespace kern.services.CumulocityClient.Test
{
    ...
    /// </remarks>
    public class AuthConfigTokenRequestTests
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOf" AuthConfigTokenRequest
            //Assert.IsInstanceOf(typeof(AuthConfigTokenRequest), instance);
        }
