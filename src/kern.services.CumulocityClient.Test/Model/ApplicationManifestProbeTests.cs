...
namespace kern.services.CumulocityClient.Test
{
    ...
    /// </remarks>
    public class ApplicationManifestProbeTests
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOf" ApplicationManifestProbe
            //Assert.IsInstanceOf(typeof(ApplicationManifestProbe), instance);
        }
