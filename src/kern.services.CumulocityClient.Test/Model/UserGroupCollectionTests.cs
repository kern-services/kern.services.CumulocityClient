...
namespace kern.services.CumulocityClient.Test
{
    ...
    /// </remarks>
    public class UserGroupCollectionTests
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOf" UserGroupCollection
            //Assert.IsInstanceOf(typeof(UserGroupCollection), instance);
        }
