...
namespace kern.services.CumulocityClient.Test
{
    ...
    /// </remarks>
    public class PostEventCollectionResourceRequestTests
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOf" PostEventCollectionResourceRequest
            //Assert.IsInstanceOf(typeof(PostEventCollectionResourceRequest), instance);
        }
