...
namespace kern.services.CumulocityClient.Test
{
    ...
    /// </remarks>
    public class InventoryAssignmentTests
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOf" InventoryAssignment
            //Assert.IsInstanceOf(typeof(InventoryAssignment), instance);
        }
