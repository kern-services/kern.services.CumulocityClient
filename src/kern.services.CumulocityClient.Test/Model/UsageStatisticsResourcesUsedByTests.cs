...
namespace kern.services.CumulocityClient.Test
{
    ...
    /// </remarks>
    public class UsageStatisticsResourcesUsedByTests
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOf" UsageStatisticsResourcesUsedBy
            //Assert.IsInstanceOf(typeof(UsageStatisticsResourcesUsedBy), instance);
        }
