...
namespace kern.services.CumulocityClient.Test.Model
{
    ...
    public class RequestRepresentationTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsType" RequestRepresentation
            //Assert.IsType<RequestRepresentation>(instance);
        }
