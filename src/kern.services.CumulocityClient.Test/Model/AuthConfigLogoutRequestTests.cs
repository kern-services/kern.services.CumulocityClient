...
namespace kern.services.CumulocityClient.Test
{
    ...
    /// </remarks>
    public class AuthConfigLogoutRequestTests
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOf" AuthConfigLogoutRequest
            //Assert.IsInstanceOf(typeof(AuthConfigLogoutRequest), instance);
        }
