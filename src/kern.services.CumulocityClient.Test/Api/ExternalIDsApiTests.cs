...
namespace kern.services.CumulocityClient.Test.Api
{
    ...
    /// </remarks>
    public class ExternalIDsApiTests : IDisposable
    {
        private ExternalIDsApi instance;

        public ExternalIDsApiTests()
        {
        ...
        {
            // TODO uncomment below to test 'IsType' ExternalIDsApi
            //Assert.IsType<ExternalIDsApi>(instance);
        }
        ...
        public void GetExternalIDCollectionResourceTest()
        {
            ...
            //Assert.IsType<ExternalIds>(response);
        }
        ...
        public void GetExternalIDResourceTest()
        {
            ...
            //Assert.IsType<ExternalId>(response);
        }
