...
namespace kern.services.CumulocityClient.Test.Api
{
    ...
    /// </remarks>
    public class ManagedObjectsApiTests : IDisposable
    {
        private ManagedObjectsApi instance;

        public ManagedObjectsApiTests()
        {
        ...
        {
            // TODO uncomment below to test 'IsType' ManagedObjectsApi
            //Assert.IsType<ManagedObjectsApi>(instance);
        }
        ...
        public void GetManagedObjectCollectionResourceTest()
        {
            ...
            //Assert.IsType<ManagedObjectCollection>(response);
        }
        ...
        public void GetManagedObjectResourceTest()
        {
            ...
            //Assert.IsType<ManagedObject>(response);
        }
        ...
        public void GetManagedObjectUserResourceTest()
        {
            ...
            //Assert.IsType<ManagedObjectUser>(response);
        }
        ...
        public void GetSupportedMeasurementsManagedObjectResourceTest()
        {
            ...
            //Assert.IsType<SupportedMeasurements>(response);
        }
        ...
        public void GetSupportedSeriesManagedObjectResourceTest()
        {
            ...
            //Assert.IsType<SupportedSeries>(response);
        }
        ...
        public void PostManagedObjectCollectionResourceTest()
        {
            ...
            //string? accept = null;
            //string? xCumulocityProcessingMode = null;
            //var response = instance.PostManagedObjectCollectionResource(managedObject, accept, xCumulocityProcessingMode);
            //Assert.IsType<ManagedObject>(response);
        }
        ...
        public void PutManagedObjectResourceTest()
        {
            ...
            //string? accept = null;
            //string? xCumulocityProcessingMode = null;
            //var response = instance.PutManagedObjectResource(id, managedObject, accept, xCumulocityProcessingMode);
            //Assert.IsType<ManagedObject>(response);
        }
