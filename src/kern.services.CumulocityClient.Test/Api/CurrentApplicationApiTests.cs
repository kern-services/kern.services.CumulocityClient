...
namespace kern.services.CumulocityClient.Test.Api
{
    ...
    /// </remarks>
    public class CurrentApplicationApiTests : IDisposable
    {
        private CurrentApplicationApi instance;

        public CurrentApplicationApiTests()
        {
        ...
        {
            // TODO uncomment below to test 'IsType' CurrentApplicationApi
            //Assert.IsType<CurrentApplicationApi>(instance);
        }
        ...
        public void GetApplicationUserCollectionRepresentationTest()
        {
            ...
            //Assert.IsType<ApplicationUserCollection>(response);
        }
        ...
        public void GetCurrentApplicationResourceSettingsTest()
        {
            ...
            //Assert.IsType<List<ApplicationSettingsInner>>(response);
        }
