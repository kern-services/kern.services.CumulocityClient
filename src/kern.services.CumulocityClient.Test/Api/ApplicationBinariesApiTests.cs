...
namespace kern.services.CumulocityClient.Test.Api
{
    ...
    /// </remarks>
    public class ApplicationBinariesApiTests : IDisposable
    {
        private ApplicationBinariesApi instance;

        public ApplicationBinariesApiTests()
        {
        ...
        {
            // TODO uncomment below to test 'IsType' ApplicationBinariesApi
            //Assert.IsType<ApplicationBinariesApi>(instance);
        }
        ...
        public void GetBinaryApplicationContentResourceTest()
        {
            ...
            //Assert.IsType<ApplicationBinaries>(response);
        }
