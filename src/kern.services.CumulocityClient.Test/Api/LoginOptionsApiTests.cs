...
namespace kern.services.CumulocityClient.Test.Api
{
    ...
    /// </remarks>
    public class LoginOptionsApiTests : IDisposable
    {
        private LoginOptionsApi instance;

        public LoginOptionsApiTests()
        {
        ...
        {
            // TODO uncomment below to test 'IsType' LoginOptionsApi
            //Assert.IsType<LoginOptionsApi>(instance);
        }
        ...
        public void GetLoginOptionCollectionResourceTest()
        {
            ...
            //Assert.IsType<LoginOptionCollection>(response);
        }
        ...
        public void PostLoginOptionCollectionResourceTest()
        {
            ...
            //Assert.IsType<AuthConfig>(response);
        }
