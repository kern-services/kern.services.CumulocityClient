...
namespace kern.services.CumulocityClient.Test.Api
{
    ...
    /// </remarks>
    public class RetentionRulesApiTests : IDisposable
    {
        private RetentionRulesApi instance;

        public RetentionRulesApiTests()
        {
        ...
        {
            // TODO uncomment below to test 'IsType' RetentionRulesApi
            //Assert.IsType<RetentionRulesApi>(instance);
        }
        ...
        public void GetRetentionRuleCollectionResourceTest()
        {
            ...
            //Assert.IsType<RetentionRuleCollection>(response);
        }
        ...
        public void GetRetentionRuleResourceTest()
        {
            ...
            //Assert.IsType<RetentionRule>(response);
        }
