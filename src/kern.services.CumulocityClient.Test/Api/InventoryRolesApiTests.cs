...
namespace kern.services.CumulocityClient.Test.Api
{
    ...
    /// </remarks>
    public class InventoryRolesApiTests : IDisposable
    {
        private InventoryRolesApi instance;

        public InventoryRolesApiTests()
        {
        ...
        {
            // TODO uncomment below to test 'IsType' InventoryRolesApi
            //Assert.IsType<InventoryRolesApi>(instance);
        }
        ...
        public void GetInventoryAssignmentResourceTest()
        {
            ...
            //Assert.IsType<InventoryAssignmentCollection>(response);
        }
        ...
        public void GetInventoryAssignmentResourceByIdTest()
        {
            ...
            //Assert.IsType<InventoryAssignment>(response);
        }
        ...
        public void GetInventoryRoleResourceTest()
        {
            ...
            //Assert.IsType<InventoryRoleCollection>(response);
        }
        ...
        public void GetInventoryRoleResourceIdTest()
        {
            ...
            //Assert.IsType<InventoryRole>(response);
        }
