...
namespace kern.services.CumulocityClient.Test
{
    ...
    public class AttachmentsApiTests
    {
        ...
        /// <summary>
        /// Test DeleteEventBinaryResource
        /// </summary>
        [Test]
        public void DeleteEventBinaryResourceTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string id = null;
            //instance.DeleteEventBinaryResource(id);
            
        }
        
        /// <summary>
        /// Test GetEventBinaryResource
        /// </summary>
        [Test]
        public void GetEventBinaryResourceTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string id = null;
            //var response = instance.GetEventBinaryResource(id);
            //Assert.IsInstanceOf(typeof(System.IO.Stream), response, "response is System.IO.Stream");
        }
        
        /// <summary>
        /// Test PostEventBinaryResource
        /// </summary>
        [Test]
        public void PostEventBinaryResourceTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string id = null;
            //System.IO.Stream body = null;
            //var response = instance.PostEventBinaryResource(id, body);
            //Assert.IsInstanceOf(typeof(EventBinary), response, "response is EventBinary");
        }
        
        /// <summary>
        /// Test PutEventBinaryResource
        /// </summary>
        [Test]
        public void PutEventBinaryResourceTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string id = null;
            //System.IO.Stream body = null;
            //var response = instance.PutEventBinaryResource(id, body);
            //Assert.IsInstanceOf(typeof(EventBinary), response, "response is EventBinary");
        }
