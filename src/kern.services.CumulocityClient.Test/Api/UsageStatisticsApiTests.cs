...
namespace kern.services.CumulocityClient.Test.Api
{
    ...
    /// </remarks>
    public class UsageStatisticsApiTests : IDisposable
    {
        private UsageStatisticsApi instance;

        public UsageStatisticsApiTests()
        {
        ...
        {
            // TODO uncomment below to test 'IsType' UsageStatisticsApi
            //Assert.IsType<UsageStatisticsApi>(instance);
        }
        ...
        public void GetSummaryAllTenantsUsageStatisticsTest()
        {
            ...
            //Assert.IsType<List<SummaryAllTenantsUsageStatistics>>(response);
        }
        ...
        public void GetSummaryUsageStatisticsTest()
        {
            ...
            //Assert.IsType<SummaryTenantUsageStatistics>(response);
        }
        ...
        public void GetTenantUsageStatisticsCollectionResourceTest()
        {
            ...
            //Assert.IsType<TenantUsageStatisticsCollection>(response);
        }
        ...
        public void GetTenantUsageStatisticsFileCollectionResourceTest()
        {
            ...
            //Assert.IsType<TenantUsageStatisticsFileCollection>(response);
        }
        ...
        public void PostGenerateStatisticsFileRequestTest()
        {
            ...
            //Assert.IsType<StatisticsFile>(response);
        }
    }
}
