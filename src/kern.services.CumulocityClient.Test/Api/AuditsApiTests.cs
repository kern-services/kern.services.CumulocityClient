...
namespace kern.services.CumulocityClient.Test.Api
{
    ...
    public class AuditsApiTests : IDisposable
    {
        ...
        public void GetAuditRecordCollectionResourceTest()
        {
            ...
            //Assert.IsType<AuditRecordCollection>(response);
        }
        ...
        public void GetAuditRecordResourceTest()
        {
            ...
            //Assert.IsType<AuditRecord>(response);
        }
        ...
        public void PostAuditRecordCollectionResourceTest()
        {
            ...
            //string? accept = null;
            //var response = instance.PostAuditRecordCollectionResource(auditRecord, accept);
            //Assert.IsType<AuditRecord>(response);
        }
    }
}
