...
namespace kern.services.CumulocityClient.Test
{
    ...
    public class AuditsApiTests
    {
        ...
        /// <summary>
        /// Test GetAuditRecordCollectionResource
        /// </summary>
        [Test]
        public void GetAuditRecordCollectionResourceTest()
        {
            ...
            //var response = instance.GetAuditRecordCollectionResource(application, currentPage, dateFrom, dateTo, pageSize, source, type, user, withTotalElements, withTotalPages);
            //Assert.IsInstanceOf(typeof(AuditRecordCollection), response, "response is AuditRecordCollection");
        }
        
        /// <summary>
        /// Test GetAuditRecordResource
        /// </summary>
        [Test]
        public void GetAuditRecordResourceTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string id = null;
            //var response = instance.GetAuditRecordResource(id);
            //Assert.IsInstanceOf(typeof(AuditRecord), response, "response is AuditRecord");
        }
        
        /// <summary>
        /// Test PostAuditRecordCollectionResource
        /// </summary>
        [Test]
        public void PostAuditRecordCollectionResourceTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //Dictionary<string, Object> requestBody = null;
            //string accept = null;
            //var response = instance.PostAuditRecordCollectionResource(requestBody, accept);
            //Assert.IsInstanceOf(typeof(AuditRecord), response, "response is AuditRecord");
        }
