...
namespace kern.services.CumulocityClient.Test.Api
{
    ...
    /// </remarks>
    public class AlarmsApiTests : IDisposable
    {
        private AlarmsApi instance;

        public AlarmsApiTests()
        {
        ...
        {
            // TODO uncomment below to test 'IsType' AlarmsApi
            //Assert.IsType<AlarmsApi>(instance);
        }
        ...
        public void GetAlarmCollectionResourceTest()
        {
            ...
            //Assert.IsType<AlarmCollection>(response);
        }
