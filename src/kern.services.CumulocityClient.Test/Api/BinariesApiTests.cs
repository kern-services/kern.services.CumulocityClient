...
{
    /// <summary>
    ///  Class for testing BinariesApi
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the API endpoint.
    /// </remarks>
    public class BinariesApiTests : IDisposable
    {
        private BinariesApi instance;

        public BinariesApiTests()
        {
            instance = new BinariesApi();
        }
        ...
        /// <summary>
        /// Test an instance of BinariesApi
        /// </summary>
        [Fact]
        public void InstanceTest()
        {
            // TODO uncomment below to test 'IsType' BinariesApi
            //Assert.IsType<BinariesApi>(instance);
        }

        /// <summary>
        /// Test DeleteBinariesResource
        /// </summary>
        [Fact]
        public void DeleteBinariesResourceTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string id = null;
            //instance.DeleteBinariesResource(id);
        }

        /// <summary>
        /// Test GetBinariesCollectionResource
        /// </summary>
        [Fact]
        public void GetBinariesCollectionResourceTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            ...
            //var response = instance.GetBinariesCollectionResource(childAdditionId, childAssetId, childDeviceId, currentPage, ids, owner, pageSize, text, type, withTotalPages);
            //Assert.IsType<BinaryCollection>(response);
        }

        /// <summary>
        /// Test GetBinariesResource
        /// </summary>
        [Fact]
        public void GetBinariesResourceTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string id = null;
            //var response = instance.GetBinariesResource(id);
            //Assert.IsType<System.IO.Stream>(response);
        }

        /// <summary>
        /// Test PostBinariesCollectionResource
        /// </summary>
        [Fact]
        public void PostBinariesCollectionResourceTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //BinaryInfo varObject = null;
            //System.IO.Stream file = null;
            //var response = instance.PostBinariesCollectionResource(varObject, file);
            //Assert.IsType<byte[]>(response);
        }

        /// <summary>
        /// Test PutBinariesResource
        /// </summary>
        [Fact]
        public void PutBinariesResourceTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string id = null;
            //System.IO.Stream body = null;
            //var response = instance.PutBinariesResource(id, body);
            //Assert.IsType<byte[]>(response);
        }
    }
}
