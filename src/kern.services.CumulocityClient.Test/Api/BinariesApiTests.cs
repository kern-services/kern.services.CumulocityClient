...
namespace kern.services.CumulocityClient.Test
{
    ...
    public class BinariesApiTests
    {
        ...
        {
            // TODO uncomment below to test 'IsInstanceOf' BinariesApi
            //Assert.IsInstanceOf(typeof(BinariesApi), instance);
        }
        ...
        public void GetBinariesCollectionResourceTest()
        {
            ...
            //Assert.IsInstanceOf(typeof(BinaryCollection), response, "response is BinaryCollection");
        }
