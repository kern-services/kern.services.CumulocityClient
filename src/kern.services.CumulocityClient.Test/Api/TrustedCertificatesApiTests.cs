...
namespace kern.services.CumulocityClient.Test.Api
{
    ...
    /// </remarks>
    public class TrustedCertificatesApiTests : IDisposable
    {
        private TrustedCertificatesApi instance;

        public TrustedCertificatesApiTests()
        {
        ...
        {
            // TODO uncomment below to test 'IsType' TrustedCertificatesApi
            //Assert.IsType<TrustedCertificatesApi>(instance);
        }
        ...
        public void GetTrustedCertificateCollectionResourceTest()
        {
            ...
            //Assert.IsType<TrustedCertificateCollection>(response);
        }
        ...
        public void GetTrustedCertificateResourceTest()
        {
            ...
            //Assert.IsType<TrustedCertificate>(response);
        }
