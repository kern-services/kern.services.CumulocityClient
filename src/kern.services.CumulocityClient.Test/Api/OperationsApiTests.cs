...
namespace kern.services.CumulocityClient.Test
{
    ...
    public class OperationsApiTests
    {
        ...
        /// <summary>
        /// Test DeleteOperationCollectionResource
        /// </summary>
        [Test]
        public void DeleteOperationCollectionResourceTest()
        {
            ...
            //string status = null;
            //instance.DeleteOperationCollectionResource(xCumulocityProcessingMode, agentId, dateFrom, dateTo, deviceId, status);
            
        }
        
        /// <summary>
        /// Test GetOperationCollectionResource
        /// </summary>
        [Test]
        public void GetOperationCollectionResourceTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string agentId = null;
            ...
            //var response = instance.GetOperationCollectionResource(agentId, bulkOperationId, currentPage, dateFrom, dateTo, deviceId, fragmentType, pageSize, revert, status, withTotalElements, withTotalPages);
            //Assert.IsInstanceOf(typeof(OperationCollection), response, "response is OperationCollection");
        }
        
        /// <summary>
        /// Test GetOperationResource
        /// </summary>
        [Test]
        public void GetOperationResourceTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string id = null;
            //var response = instance.GetOperationResource(id);
            //Assert.IsInstanceOf(typeof(Operation), response, "response is Operation");
        }
        
        /// <summary>
        /// Test PostOperationCollectionResource
        /// </summary>
        [Test]
        public void PostOperationCollectionResourceTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //PostOperationCollectionResourceRequest postOperationCollectionResourceRequest = null;
            //string accept = null;
            //string xCumulocityProcessingMode = null;
            //var response = instance.PostOperationCollectionResource(postOperationCollectionResourceRequest, accept, xCumulocityProcessingMode);
            //Assert.IsInstanceOf(typeof(Operation), response, "response is Operation");
        }
        
        /// <summary>
        /// Test PutOperationResource
        /// </summary>
        [Test]
        public void PutOperationResourceTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string id = null;
            //PutOperationResourceRequest putOperationResourceRequest = null;
            //string accept = null;
            //string xCumulocityProcessingMode = null;
            //var response = instance.PutOperationResource(id, putOperationResourceRequest, accept, xCumulocityProcessingMode);
            //Assert.IsInstanceOf(typeof(Operation), response, "response is Operation");
        }
