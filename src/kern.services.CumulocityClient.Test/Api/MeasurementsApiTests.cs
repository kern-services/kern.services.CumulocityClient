...
namespace kern.services.CumulocityClient.Test.Api
{
    ...
    /// </remarks>
    public class MeasurementsApiTests : IDisposable
    {
        private MeasurementsApi instance;

        public MeasurementsApiTests()
        {
        ...
        {
            // TODO uncomment below to test 'IsType' MeasurementsApi
            //Assert.IsType<MeasurementsApi>(instance);
        }
        ...
        public void GetMeasurementCollectionResourceTest()
        {
            ...
            //Assert.IsType<MeasurementCollection>(response);
        }
        ...
        public void GetMeasurementResourceTest()
        {
            ...
            //Assert.IsType<Measurement>(response);
        }
        ...
        public void GetMeasurementSeriesResourceTest()
        {
            ...
            //Assert.IsType<MeasurementSeries>(response);
        }
