...
namespace kern.services.CumulocityClient.Test.Api
{
    ...
    /// </remarks>
    public class NewDeviceRequestsApiTests : IDisposable
    {
        private NewDeviceRequestsApi instance;

        public NewDeviceRequestsApiTests()
        {
        ...
        {
            // TODO uncomment below to test 'IsType' NewDeviceRequestsApi
            //Assert.IsType<NewDeviceRequestsApi>(instance);
        }
        ...
        public void GetNewDeviceRequestCollectionResourceTest()
        {
            ...
            //Assert.IsType<NewDeviceRequestCollection>(response);
        }
        ...
        public void GetNewDeviceRequestResourceTest()
        {
            ...
            //Assert.IsType<NewDeviceRequest>(response);
        }
