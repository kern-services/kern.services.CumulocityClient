...
namespace kern.services.CumulocityClient.Test.Api
{
    ...
    /// </remarks>
    public class ApplicationVersionsApiTests : IDisposable
    {
        private ApplicationVersionsApi instance;

        public ApplicationVersionsApiTests()
        {
        ...
        {
            // TODO uncomment below to test 'IsType' ApplicationVersionsApi
            //Assert.IsType<ApplicationVersionsApi>(instance);
        }
        ...
        public void DeleteApplicationVersionResourceTest()
        {
            ...
            //string? tag = null;
            //instance.DeleteApplicationVersionResource(id, varVersion, tag);
        }
        ...
        public void GetApplicationVersionCollectionResourceTest()
        {
            ...
            //Assert.IsType<ApplicationVersionCollection>(response);
        }
        ...
        public void GetApplicationVersionResourceTest()
        {
            ...
            //string? varVersion = null;
            //string? tag = null;
            //var response = instance.GetApplicationVersionResource(id, accept, varVersion, tag);
            //Assert.IsType<ApplicationVersion>(response);
        }
        ...
        public void PutApplicationVersionResourceTest()
        {
            ...
            //string? accept = null;
            //var response = instance.PutApplicationVersionResource(id, varVersion, applicationVersionTag, accept);
            //Assert.IsType<ApplicationVersion>(response);
        }
    }
}
