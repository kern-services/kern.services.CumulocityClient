...
namespace kern.services.CumulocityClient.Test.Api
{
    ...
    /// </remarks>
    public class BulkOperationsApiTests : IDisposable
    {
        private BulkOperationsApi instance;

        public BulkOperationsApiTests()
        {
        ...
        {
            // TODO uncomment below to test 'IsType' BulkOperationsApi
            //Assert.IsType<BulkOperationsApi>(instance);
        }
        ...
        public void GetBulkOperationCollectionResourceTest()
        {
            ...
            //Assert.IsType<BulkOperationCollection>(response);
        }
        ...
        public void GetBulkOperationResourceTest()
        {
            ...
            //Assert.IsType<BulkOperation>(response);
        }
