...
namespace kern.services.CumulocityClient.Test.Api
{
    ...
    /// </remarks>
    public class TenantApplicationsApiTests : IDisposable
    {
        private TenantApplicationsApi instance;

        public TenantApplicationsApiTests()
        {
        ...
        {
            // TODO uncomment below to test 'IsType' TenantApplicationsApi
            //Assert.IsType<TenantApplicationsApi>(instance);
        }
        ...
        public void GetTenantApplicationReferenceCollectionResourceTest()
        {
            ...
            //Assert.IsType<ApplicationReferenceCollection>(response);
        }
        ...
        public void PostTenantApplicationReferenceCollectionResourceTest()
        {
            ...
            //Assert.IsType<ApplicationReference>(response);
        }
    }
}
