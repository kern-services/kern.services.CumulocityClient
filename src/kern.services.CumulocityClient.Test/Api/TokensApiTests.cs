...
namespace kern.services.CumulocityClient.Test
{
    ...
    public class TokensApiTests
    {
        ...
        /// <summary>
        /// Test PostNotificationTokenResource
        /// </summary>
        [Test]
        public void PostNotificationTokenResourceTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //NotificationTokenClaims notificationTokenClaims = null;
            //string accept = null;
            //string xCumulocityProcessingMode = null;
            //var response = instance.PostNotificationTokenResource(notificationTokenClaims, accept, xCumulocityProcessingMode);
            //Assert.IsInstanceOf(typeof(NotificationToken), response, "response is NotificationToken");
        }
        
        /// <summary>
        /// Test PostNotificationTokenUnsubscribeResource
        /// </summary>
        [Test]
        public void PostNotificationTokenUnsubscribeResourceTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string token = null;
            //string accept = null;
            //string xCumulocityProcessingMode = null;
            //var response = instance.PostNotificationTokenUnsubscribeResource(token, accept, xCumulocityProcessingMode);
            //Assert.IsInstanceOf(typeof(NotificationSubscriptionResult), response, "response is NotificationSubscriptionResult");
        }
