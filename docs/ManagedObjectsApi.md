...
<a id="deletemanagedobjectresource"></a>
...
<a id="getlastavailabilitymanagedobjectresource"></a>
...
<a id="getmanagedobjectcollectionresource"></a>
...
<a id="getmanagedobjectresource"></a>
...
<a id="getmanagedobjectuserresource"></a>
...
<a id="getsupportedmeasurementsmanagedobjectresource"></a>
...
<a id="getsupportedseriesmanagedobjectresource"></a>
...
<a id="postmanagedobjectcollectionresource"></a>
# **PostManagedObjectCollectionResource**
> ManagedObject PostManagedObjectCollectionResource (ManagedObject managedObject, string? accept = null, string? xCumulocityProcessingMode = null)
...
namespace Example
{
    public class PostManagedObjectCollectionResourceExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new ManagedObjectsApi(config);
            var managedObject = new ManagedObject(); // ManagedObject | 
            ...
            {
                // Create a managed object
                ManagedObject result = apiInstance.PostManagedObjectCollectionResource(managedObject, accept, xCumulocityProcessingMode);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Create a managed object
    ApiResponse<ManagedObject> response = apiInstance.PostManagedObjectCollectionResourceWithHttpInfo(managedObject, accept, xCumulocityProcessingMode);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
| Name | Type | Description | Notes |
|------|------|-------------|-------|
| **managedObject** | [**ManagedObject**](ManagedObject.md) |  |  |
...
<a id="putmanagedobjectresource"></a>
# **PutManagedObjectResource**
> ManagedObject PutManagedObjectResource (string id, ManagedObject managedObject, string? accept = null, string? xCumulocityProcessingMode = null)
...
namespace Example
{
    public class PutManagedObjectResourceExample
    {
        public static void Main()
        {
            ...
            {
                // Update a specific managed object
                ManagedObject result = apiInstance.PutManagedObjectResource(id, managedObject, accept, xCumulocityProcessingMode);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Update a specific managed object
    ApiResponse<ManagedObject> response = apiInstance.PutManagedObjectResourceWithHttpInfo(id, managedObject, accept, xCumulocityProcessingMode);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
<a id="putmanagedobjectuserresource"></a>
