...
<a id="deletemeasurementcollectionresource"></a>
...
<a id="deletemeasurementresource"></a>
...
<a id="getmeasurementcollectionresource"></a>
...
<a id="getmeasurementseriesresource"></a>
...
<a id="postmeasurementcollectionresource"></a>
# **PostMeasurementCollectionResource**
> Measurement PostMeasurementCollectionResource (Measurement measurement, string? accept = null, string? xCumulocityProcessingMode = null)
...
namespace Example
{
    public class PostMeasurementCollectionResourceExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new MeasurementsApi(config);
            var measurement = new Measurement(); // Measurement | 
            ...
            {
                // Create a measurement
                Measurement result = apiInstance.PostMeasurementCollectionResource(measurement, accept, xCumulocityProcessingMode);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Create a measurement
    ApiResponse<Measurement> response = apiInstance.PostMeasurementCollectionResourceWithHttpInfo(measurement, accept, xCumulocityProcessingMode);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
