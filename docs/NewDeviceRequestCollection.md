# kern.services.CumulocityClient.Model.NewDeviceRequestCollection

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**NewDeviceRequests** | [**List&lt;NewDeviceRequest&gt;**](NewDeviceRequest.md) | An array of new device requests. | [optional] 
